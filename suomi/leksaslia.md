...
**a** *luona (-lla, -ssa)* ← ranska:à, espanja:portugali:a, englanti:a-;ad-, venäjä:а- (a-), hausa:a + fulani:haa  
**abies** *pihta (jalokuusi)* ← espanja:portugali:abeto  
**acar** *säilyke (pikkelssi)* ← persia:آچار (âčâr), hindi:अचार (acār),tamili:அச்சாறு (accāṟu), arabia:اچار‎ (əčar), englanti:portugali:achar, suahili:achari, malaiji:acar  
...
**ade** *tapa* ← arabia: عادة (ʿāda), hindi:आदत (ādat), malaiji:adat, turkki:adet, suahili:ada, hausa:al'ada, fulani:aada  
...
**af** *anteeksi* ← arabia: مُعَاف‎ (muʿāf), hindi:माफ़ (māf), bangla:মাফ (maph), malaiji:maaf, suahili:afu, turkki:af, fulani:yaafu, hausa:yafe  
...
**akle** *järki (mieli)* ← arabia: عَقْل‎ (ʕaql), persia: عقل‎ ('aql), hindi:अक़्ल (aqla), bangla:আকল (akol), malaiji:akal, fulani:hakkille, wolof:hakilo, hausa:hankali, suahili:akili, turkki:akıl  
...
**alkol** *alkoholi* ← arabia: كُحُول‎ (kuḥūl), englanti:espanja:alcohol, ranska:alcool, portugali:álcool,  venäjä:алкоголь (alkohol), japani:アルコール (arukōru), korea:알콜 (alkol), hindi:ऐल्कोहॉल (ailkohŏl), bangla:এলকোহল (elkohôl), ind:alkohol, turkki:fulani:alkol  
...
**ama** *mutta* ← arabia: أما‎ (ʔamma), turkki:ama, persia:urdu:اما‎ (ammâ), hausa:fulani:amma, yoruba:àmọ́  
...
**amen** *luottaa (pitää varmana)* ← heb: אָמֵן‎, (ʾāmēn), arabia: آمَنَ‎ (āmana), suahili:amini, fulani:amiini, hausa:amince, turkki:amin + kreikka:ἀμήν (ámén), englanti:deu:ranska:puola:espanja:amen, yleiskiina:阿门 (āmén), kantoninkiina:阿門 (aa3mun4), korea:아멘 (amen), japani:アーメン (āmen), vietnami:a-men  
...
**amir** *käsky (komento)* ← arabia: أَمْر‎ (ʾamr), persia: امر‎ (amr), turkki:emir, suahili:amiri, hausa:umarni, fulani:amiiru + englanti:admiral, ranska:amiral, espanja:portugali:emir venäjä:эмир (emir)  
...
**ampul** *ampulli* ← ranska:englanti:ampoule, yleiskiina:安瓿 (ānbù), japani:アンプル (anpuru), venäjä:ампула (ámpula), arabia:(ʾambūla), turkki:fulani:ampul, hindi:फफोला (phapholā)  
...
**angar** *ankkuri* ← englanti:anchor, ranska:ancre, portugali:âncora, malaiji:jangkar, venäjä:якорь, arabia:(ʾanjar), hindi:लंगर (laṅgar), urdu:(laṅgar), tamili:நங்கூரம் (naṅkūram), telugu:లంగరు (laṅgaru), suahili:nanga, hausa:anga  
...
**ase** *toivoa (toivo)* ← hindi:आस (ās); आशा (āśā), telugu:ఆశ (āśa), tamili:ஆசை (āsai), malaiji:filippiini:asa  
...
**asle** *alkuperä* ← arabia:(ʾaṣl), turkki:asl, malaiji:asal, hindi:असल (asl), tamili:அசல் (acal), suahili:asili, hausa:asali, fulani:asli  
...
**babu** *luku (jakso, tarinan osa)* ← arabia:persia:urdu: بَاب‎ (bāb), malaiji:bab, suahili:babu, hausa:babi, fulani:baabuwo  
...
**badal** *vaihtaa* ← arabia:(badala), hindi:बदला (badlā), suahili:badili, hausa:badali, turkki:bedel  
...
**baki** *jäännös (loput)* ← arabia: بَقِيَّة‎ (baqiyya), persia: بقیه‎ (baqiye), hindi:बाक़ी (bāqī), malaiji:baki, turkki:bakıye, suahili:-baki, fulani:bakke  
...
**bala** *voimakas (vahva)* ← hindi:बल (bal), bangla:বল (bôl), malaiji:bala, tamili:பலவான் (palavāṉ), telugu:బలము (balamu), thai:พล (pon), พละ (pá-lá)  
**baldi** *sanko (ämpäri)* ← espanja:portugali:filippiini:balde, hindi:बाल्टी (bālṭī), bangla:বালতি (balti), malaiji:baldi, tamili:வாளி (vāḷi)  
...
**banana** *banaani* ← fulani:wolof:banaana, venäjä:банан (banan), puola:banan, ranska:deu:banane, portugali:espanja:englanti:banana, japani:バナナ (banana), korea:바나나 (banana)  
...
**bande** *sitoa (side, käärö, nauha)* ← englanti:bind; band, deu:Band, ranska:bande, espanja:venda, venäjä:бинт (bint), persia: بند‎ (band), hindi:बाँधना (bāndhnā), yleiskiina:绑 (bǎng), kantoninkiina:綁 (bong2), vietnami:băng, turkki:bant, fulani:banda; bandaas + suahili:bendeji, hausa:bandeji  
**bandera** *lippu* ← englanti:banner, ranska:bannière, espanja:bandera, portugali:bandeira, malaiji:bendera, filippiini:bandila, suahili:bendera, fulani:bandeera  
...
**banke** *tallettaa (tallentaa)* ← englanti:deu:puola:malaiji:bank, turkki:banka, venäjä:банк (bank), ranska:banque, espanja:portugali:banco, persia:(bânk), hindi:बैंक (baiṅk), urdu:(baiṅk), telugu:బ్యాంకు (byāṅku), tamili:(vaṅki), fulani:banke, hausa:banki  
...
**bar** *baari (kapakka)* ← englanti:ranska:espanja:portugali:malaiji:turkki:bar, venäjä:бар (bar), yleiskiina:酒吧 (jiǔbā), kantoninkiina:酒吧 (zau2baa1), japani:バー (bā), hindi:बार (bār), bangla:বার (bar), tamili:பார் (pār)  
...
**barke** *onnitella (siunata)* ← hausa:barka, malaiji:berkah, turkki:tebrik, persia:(tabrik), arabia:urdu:(mubārak), suahili:baraka, hau:albarka, yoruba:alubarika, fulani:(al)barka  
**barte** *intialainen* ← hindi:भारतीय (bhārtīy), urdu:(bhārtīy), marathi:(bhārtīya), telugu:(bhāratīya)  
**baru** *karhu* ← deu:Bär, englanti:bear + hindi:भालू (bhālū) bangla:ভালুক (bhaluk), tamili:பல்லுகம் (pallukam) + malaiji:beruang  
...
**basen** *allas* ← englanti:basin, ranska:bassin, venäjä:бассейн (basseyn), portugali:bacia, malaiji:besen, suahili:beseni, fulani:basin  
**baske** *kori* ← englanti:basket, malaiji:bakul, japani:バスケット (basuketto)  
**bata** *sorsa (ankka)* ← arabia: بَطَّة‎ (baṭṭa), hindi:बत्तख (battakh), tamili:வாத்து (vāttu), telugu:బాతు (bātu), suahili:bata + espanja:portugali:pato + thai:เป็ด  (pèt)  
...
**batri** *akku (paristo)* ← englanti:battery, espanja:portugali:bateria, venäjä:батарея (batareya), persia:(bātri), hindi:बैटरी (baiṭrī), bangla:ব্যাটারি (byaṭari), tamili:பத்திரி (pattiri), arabia:(baṭṭāriyya), japani:バッテリー (batterī), korea:배터리 (baeteori), malaiji:bateri, suahili:betri, hausa:baturi, fulani:baateri  
...
**benke** *penkki* ← ranska:banc, deu:Bank, espanja:portugali:banco, malaiji:bangku, fulani:baŋ + englanti:bench, suahili:benchi, hindi:बेंच (bẽc), japani:ベンチ (benchi), korea:벤치 (benchi)  
...
**bere** *baskeri (baretti)* ← ranska:béret, turkki:fulani:bere, englanti:beret, japani:ベレー帽 (berē bō), yleiskiina:贝雷帽 (bèiléimào), kantoninkiina:巴黎帽 (baalaimou), venäjä:берет (beret), ful:beere  
**beri** *marja* ← deu:Beere, englanti:berry, malaiji:beri, hindi:बेरी (berī), bangla:বেরি (beri), japani: ベリー (berī)  
**berilium** *beryllium* ← englanti:beryllium, ranska:béryllium, espanja:berilio, portugali:berílio, venäjä:бериллий, yleiskiina:铍 (pí), japani:ベリリウム, korea:베릴륨, vietnami:suahili:berili, hindi:बेरिलियम, bangla:বেরিলিয়াম, malaiji:berilium, arabia: بيريليوم  
...
**bine** *rakentaa* ← arabia: بِنَاء‎ (bināʾ), hindi: बनाना (banānā), urdu:(banānā), persia:(banā), turkki: bina, + japani:ビル (biru)  
...
**biskute** *keksi (voileipäkeksi)* ← englanti:ranska:biscut, portugali:biscoito, venäjä:бисквит (biskvit), turkki:bisküvi, suahili:biskuti, arabia:بسكويت‎ (baskawīt), hindi:बिस्कुट (biskuṭ), malaiji:biskut, japani:ビスケット (bisuketto), fulani:biskit  
...
**bol** *pallo (kuula)* ← englanti:ball, espanja:portugali:malaiji:filippiini:bola, thai:บอล (bɔl), japani:ボール (bōru), korea:볼 (bol), khmer:បាល់ (bal), bangla:বল (bôl), deu:Ball, ranska:boule; balle, turkki:may:balon, fulani:bal, hausa:balân  
**bolte** *pultti* ← englanti:bolt, ranska:boulon, venäjä:болт (bolt), hindi:बोल्ट (bolṭ), japani:ボルト (boruto), korea:볼트 (bolteu)   
**bombe** *pommi* ← puola:portugali:espanja:turkki:bomba, venäjä:бомба (bomba), deu:ranska:bombe, persia:(bomb), englanti:bomb, bangla:বোমা (boma), hindi:बम (bam), urdu:(bam), japani:ボム (bomu), korea:봄 (bom), malaiji:bom, hausa:bom  
...
**bote** *kenkä* ← hindi:बूट (būṭ), puola:but, cze:bota, yoruba:bata + englanti:boot, ranska:botte, espanja:portugali:bota, venäjä:ботинок (botinok), pol:malaiji:but, persia: بوت‎ (but), arabia: بوت‎ (bōt), japani:ブーツ (būtsu), suahili:buti  
**botel** *pullo* ← englanti:bottle, ranska:bouteille, espanja:botella, portugali:botelha, venäjä:бутылка (butylka), persia: بطری‎ (botri), hindi:बोतल (botal), bangla:বোতল (botôl), malaiji:botol, tamili:புட்டி (puṭṭi), fulani:butél  
...
**buke** *kirja* ← englanti:book, ranska:bouquin, hindi:बुक (buk), deu:Buch, malaiji:buku, fulani:suahili:buku, wolof:bukoo + venäjä:буклет (buklet)  
...
**bure** *toimisto (konttori, byroo)* ← englanti:ranska:bureau, espanja:buro-, portugali:birô, venäjä:бюро (byuro), puola:biuro, turkki:büro, fulani:biró  
...
**buton** *nappi (näppäin, kytkin, nappula)* ← englanti:button, espanja:botón, portugali:botão, ranska:bouton, hindi:बटन (baṭan), bangla:বোতাম (botam), japani:ボタン (botan), korea:버튼 (beoteun), fulani:butoŋ  
**buyu** *apinanleipäpuu (baobab)* ← suahili:mbuyu, wolof:buy, sna:muuyu, zulu:isimuhu, fulani:ɓokki  
...
**cape** *painos (leima)* ← hindi:छाप (chāp), bangla:ছাপ (chap), tamili:சாப்பா (cāppā), malaiji:cap, englanti:chop  
**car** *kärry (vaunu, auto, jne)* ← ranska:char, englanti:car; chariot, persia:چرخ (čarx), yleiskiina:车 (chē), kantoninkiina:車 (ce1), korea:차 (cha), japani:車 (sha), turkki:çark + portugali:espanja:carro, deu:Karre, telugu:కారు  (kāru), malaiji:kereta, fulani:saret  
**carme** *lumo (tenho, viehätys, hurmaavuus, šarmi)* ← englanti:charm, ranska:portugali:charme, deu:Charme, venäjä:чары (čary); шарм (šarm), japani:チャーム (chāmu)  
...
**cavi** *avain* ← portugali:chave, espanja:llave, hindi:चाबी (cābi), bangla:চাবি (cabi), tamili: சாவி (cāvi), fulani:wolof:caabi, man:caaboo, Kongo:nsapi  
...
**cerium** *cerium* ← englanti:cerium, ranska:cérium, espanja:cerio, portugali:cério, venäjä:церий, yleiskiina:铈 (shì), japani:セリウム, korea:세륨, vietnami:xeri, hindi:सेरियम, bangla:সেরিয়াম, malaiji:serium, suahili:seri, arabia: سيريوم  
...
**cini** *posliini* ← yleiskiina:瓷 (cí) + englanti:chinaware, hindi:चीनी (cīnī), bangla:চীনামাটি (cinamaṭi), arabia: صِينِيَّة‎ (ṣīniyya), suahili:sini  
...
**coklate** *suklaa* ← espanja:portugali:englanti:chocolate, ranska:chocolat, venäjä:шоколад (šokolad), yleiskiina:巧克力 (qiǎokèlì), kantoninkiina:朱古力 (zyugulik), japani:チョコレート (chokorēto), korea:초콜렛 (chokollet), hindi:चाकलेट (cāklet), bangla:চকলেট (côkleṭ), malaiji:cokelat, suahili:chokoleti, turkki:çikolata, fulani:cokolete  
...
**cung** *hyönteinen (ötökkä)* ← yleiskiina:虫 (chóng), kantoninkiina:蟲 (cung4), korea:충 (chung), vietnami:trùng  
...
**dalil** *perustella (todistaa; peruste, todiste)* ← arabia: دَلِيل (dalīl), hindi:दलील (dalīl), bangla:দলিল (dôlil), hausa:suahili:dalili, turkki:delil, fulani:daliilu  
...
**dante** *hammas* ← espanja:diente, portugali:dente, ranska:dent, englanti:dental, hindi:दाँत (dā̃t), bangla:দাঁত (dãtô), tamili:தந்தம் (tantam), malaiji:danta  
...
**darte** *maa (maaperä, maa-aines)* ← englanti:dirt, hindi:धरती (dhartī), urdu: دھرتی‎ (dhartī), malaiji:darat, vietnami:đất  
...
**din** *uskonto* ← arabia:(dīn), bangla:দীন (din), persia:(din), turkki:malaiji:din, suahili:dini, hausa:addini, fulani:wolof:diine, hindi:दीन (dīn)  
...
**dotor** *tohtori* ← portugali:doutor, italia:dottore, englanti:espanja:doctor, venäjä:доктор (doktor) + fulani:doktoor  
...
**dua** *rukous* ← arabia: دُعَاء‏  (duʿāʾ), hindi:दुआ (duā), bangla:দুয়া (dua), malaiji:doa, suahili:turkki:dua, hausa:àddu'ā̀, fulani:du'aade, yoruba:àdúrà + yleiskiina:祈祷 (dǎo), japani:禱 (tō), korea:도 (do)  
...
**dunia** *maailma* ← arabia: دُنْيَا‎ (dunyā), hindi:दुनिया (duniyā), bangla:দুনিয়া (duniya), tamili:துனியா (tuṉiyā), malaiji:suahili:dunia, turkki:dünya, persia: دنیا (donya), urdu: دنیا (duniyā), hausa:duniya, fulani:duniyaaru  
...
**e** *ja (sekä)* ← ranska:et, portugali:e, espanja:y;e, yleiskiina:和 (hé), fulani:e  
...
**energia** *energia* ← englanti:energy, espanja:energía, portugali:energia, ranska:énergie, venäjä:энергия (energiya), turkki:enerji, persia:انرژی‎ (enerži), japani:エネルギー (enerugī)  
...
**faide** *hyöty (etu)* ← arabia: فَائِدَة‎ (fāʾida), turkki:fayda, suahili:faida, hausa:fa'ida, persia: فایده‎ (fâyede), hindi:फ़ायदा (fāyadā), tamili:பாயிதா (pāyitā), malaiji:faedah  
**fake** *panna (nussia)* ← englanti:fuck + venäjä:фак (fak), yleiskiina:法克 (fǎkè), japani:ファック (fakku)  
...
**fantaze** *kuvitella* ← englanti:ranska:fantasy, espanja:fantasía, portugali:suahili:fantasia, venäjä:фантазия (fantazija), turkki:fantezi, malaiji:fantasi, japani:ファンタジー (fantajī)  
...
**fatura** *lasku (faktuura)* ← ranska:facture, espanja:factura, portugali:turkki:fatura, deu:Faktura, venäjä:фактура (faktura), persia: فاکتور‎ (fâktur), arabia: فَاتُورَة‎ (fātūra)  
**favor** *suosio (hyväntahtoisuus)* ← englanti:espanja:portugali:favor, ranska:faveur + venäjä:фаворитизм (favoritizm)  
**faxe** *nippu (kimppu)* ← italia:fascio, englanti:fasces, ranska:faisceau, portugali:faixa, espanja:faja + venäjä:фашизм (fašizm), arabia: فَاشِيَّة‎ (fāšiyya), yleiskiina:法西斯主义 (fǎxīsīzhǔyì), japani:ファシズム (fashizumu), korea:파시즘 (pasijeum), vietnami:chủ nghĩa phát xít, hindi:फ़ासीवाद (fāsīvād), malaiji:fasisme bangla:ফ্যাসিবাদ (phaśibad)  
**faze** *vaihe (etappi)* ← espanja:portugali:italia:malaiji:fase, englanti:ranska:phase, venäjä:фаза (faza), puola:faza, persia:(fāz)  
**fe** *tehdä (toimia)* ← ranska:faire, portugali:fazer, italia:fare + arabia: فَعَلَ‎ (faʿala) + suahili:fanya + kantoninkiina:化 (faa3), hakkakiina:化 (fa), yleiskiina:化 (huà), vietnami:hoá  
...
**fete** *tehdä (toimia; teko, toimenpide)* ← ranska:fait, portugali:feito, englanti:feat; fact, deu:Fakt, venäjä:факт (fakt), persia:(fâkt)  
...
**fixe** *kiinnittää* ← englanti:fix, ranska:fixer;ficher, espanja:fijar, portugali:fixar, deu:fixieren + venäjä:афиша (afiša), turkki:afìş, vietnami:áp phích  
...
**flerovium** *flerovium* ← englanti:malaiji:flerovium, ranska:flérovium, espanja:flerovio, portugali:fleróvio, venäjä:флеровий, yleiskiina: (fū), japani:フレロビウム, korea:플레로븀, vietnami:flerovi, suahili:flerovi  
...
**frem** *kehys (raamit)* ← englanti:frame, bangla:ফ্রেম (phrēma), suahili:fremu  
...
**fufu** *tahdas* ← englanti:espanja:portugali:malaiji:suahili:fufu, ranska:foufou, venäjä:фуфу (fufu), yleiskiina:富富 (fùfù), lingala:Kongo:fufú  
...
**fulan** *se ja se (niin ja niin)* ← arabia: فُلَان‎ (fulān), persia: فلان‎ (folân), bangla:ফলনা (fôlôna), suahili:fulani, espanja:portugali:fulano  
**fun** *jauhe (jauho, tomu)* ← yleiskiina:粉 (fěn), kantoninkiina:粉 (fan2), japani:粉 (fun/pun), korea:분 (bun), vietnami:phấn, hakkakiina:粉 (fun), thai:ฝุ่น (fùn), burma:ဖုန် (hpun)  
**fungu** *sieni* ← englanti:fungus, ranska:fongus, portugali:fungo, espanja:hongo + yleiskiina:菇 (gū), kantoninkiina:菇 (gu1)  
**funte** *toimia (käydä, olla toiminnassa; toiminta, käynti)* ← englanti:function, deu:Funktion, espanja:función, portugali:função, ranska:fonction, venäjä:функция (funkciya), malaiji:fungsi, turkki:fonksiyon  
**furete** *kärppä (fretti)* ← ranska:furet, englanti:ferret, portugali:furrão, italia:furetto, espanja:hurón, japani:フェレット (feretto), korea:페럿 (pereot), suahili:fereti  
**furita** *viha (suuttumus, raivo)* ← englanti:fury, espanja:puola:furia, portugali:fúria  
...
**fuze** *sulaa* ← englanti:fuse, ranska:fuser, deu:Fusion, espanja:fusión, portugali:fusão, puola:fuzja  
**ga** *mennä* ← englanti:go + hindi:जाना (jānā), bangla:যাওয়া (jaoya) + korea:가다 (gada)  
**gabre** *hauta* ← arabia:(qabr), hindi:क़ब्र (qabra), bangla:কবর (kôbôr), malaiji:kubur, hausa:kabari, suahili:kaburi, turkki:kabir + deu:Grab, puola:grób, venäjä:гроб (grob)  
**gadolinium** *gadolinium* ← englanti:gadolinium, ranska:gadolinium, espanja:gadolinio, portugali:gadolínio, venäjä:гадолиний, yleiskiina:钆 (gá), japani:ガドリニウム, korea:가돌리늄, vietnami:gađolini, hindi:ग्याडोलिनियम, bangla:গ্যাডোলিনিয়াম, malaiji:gadolinium, suahili:gadolini, arabia: جدولينيوم  
**gaja** *norsu (elefantti)* ← hindi:गज (gaj), tamili:கசம் (kacam), telugu:గజము (gajamu), kannada:ಗಜ (gaja), malaiji:gajah, filippiini:gadya  
**gala** ** ← englanti:gullet, espanja:portugali:gola, far:گلو (galu), hindi:गला (gala), bangla:গলা (galā), pan:ਗਲਾ (galā) + venäjä:горло (gorlo) + arabia:حلق (halaq)  
**galaxia** *galaksi* ← englanti:galaxy, espanja:galaxia, portugali:galáxia, ranska:galaxie, venäjä:галактика (galaktika), turkki:malaiji:galaksi, hindi:गैलेक्सी (gaileksī)  
...
**galium** *gallium* ← englanti:gallium, ranska:gallium, espanja:galio, portugali:gálio, venäjä:галлий, yleiskiina:镓 (jiā), japani:ガリウム, korea:갈륨, vietnami:gali, hindi:गैलियम, bangla:গ্যালিয়াম, malaiji:galium, suahili:gali, arabia: جاليوم  
...
**gamba** *katkarapu* ← espanja:portugali:gamba, italia:gamberetto, arabia: جَمْبَرِي‎ (jambarī) + suahili:kamba  
**gamel** *kameli* ← arabia:جَمَل‎ (jamal), heb:גָּמָל‎ (gamál) englanti:camel, deu:Kamel, espanja:camello, portugali:camelo, suahili:ngamia, oromo:gaala, wolof:geleem  
**gamia** *avioliitto* ← englanti:-gamy, ranska:-gamie, espanja:portugali:-gamia, venäjä:-гамия (-gamiya)  
...
**gana** *ruoko* ← heb: קָנֶה‎ (qané), arabia: قَنَاة‎ (qanāh) + englanti:cane, ranska:canne, espanja:caña, portugali:cana + yleiskiina:秆 (gǎn), kantoninkiina:稈 (gon2) + (sugarcane) hindi:गन्ना (gannā), pandzabi:ਗੰਨਾ (gannā)  
**gandum** *vehnä* ← persia:گندم‎(gandom), hindi:गोधूम (godhūm), bangla:গম (gom), tamili:கோதுமை (kōtumai), telugu:గోధుమ (gōdhuma), malaiji:gandum, suahili:ngano  
**gani** *laulaa (laulu)* ← arabia: غَنَّى‎ (ḡannā) + hindi:गाना (gānā), bangla:গান (gan) + yleiskiina:歌 (gē), kantoninkiina:歌 (go1), japani:歌 (ka), korea:가 (ga), vietnami:ca  
...
**garde** *vartioida (vahtia)* ← englanti:guard, ranska:garde, espanja:portugali:guarda, malaiji:garda, japani:ガード (gādo), korea:가드 (gadeu), fulani:garde  
**garma** *lämmin* ← hindi:गरम (garm), urdu:persia:گرم‎‎ (garm), kur:germ, deu:englanti:warm  
**gas** *kaasu* ← deu:englanti:espanja:malaiji:gas, portugali:gás, bangla:গ্যাস (gyas), yleiskiina:瓦斯 (wǎsī), kantoninkiina:瓦斯 (ngaa5 si1), japani:ガス (gasu), korea:가스 (gaseu), hindi:गैस (gais), ranska:turkki:gaz, venäjä:газ (gaz), arabia:(ḡāz), fulani:gaas, suahili:gesi  
**gate** *leikata (purra)* ← arabia: قَطَعَ (qaṭa’a) + yleiskiina:割 (gē), kantoninkiina:割 (got3), wu-kiina:割 (ga’), japani:割 (katsu), vietnami:cắt + hindi:काटना (kāṭnā), bangla:কাটা (kata) + tamili:கடி (kaṭi) + thai:กัด (kat) + englanti:cut + suahili:-kata  
**gati** *kova* ← telugu:గట్టి (gaṭṭi), turkki:katı, hindi:कड़ा (kaṛā), japani:硬い (katai)  
**gau di** *korkea* ← yleiskiina:高 (gāo), kantoninkiina:高 (gou1), wu-kiina:高 (kau1), japani:高 (kō), korea:고 (go), vietnami:cao  
...
**gebre** *algebra* ← englanti:deu:algebra, ranska:algèbre, espanja:portugali:álgebra, venäjä:алгебра (algebra) arabia:persia: جَبْر‎ (jabr), turkki:cebir, suahili:aljebra, malaiji:aljabar  
**gee** *maa (maaperä)* ← englanti:espanja:portugali:geo-, ranska:géo-, venäjä:гео- (geo-)  
**gei** *homo (homoseksuaali)* ← englanti:ranska:espanja:gay, portugali:guei  
**gele** *hyytelö* ← englanti:gel, ranska:gelée, venäjä:желе (žele), turkki:jel, hindi:जेल (jel), korea:젤 (jel), yleiskiina:啫哩 (zhělī)  
...
**gense** *laji (tyyppi, lajityyppi, kategoria, genre, sortti)* ← englanti:genre, ranska:genre, espanja:género, portugali:gênero, persia: جنس‎ (jens), arabia: جِنْس‎ (jins), fulani:hausa:suahili:jinsi, turkki:cins, japani:ジェンダー (jendā)  
**germanium** *germanium* ← englanti:germanium, ranska:germanium, espanja:germanio, portugali:germânio, venäjä:германий, japani:ゲルマニウム, korea:게르마늄, vietnami:gecmani, hindi:जर्मेनियम, bangla:জার্মেনিয়াম, malaiji:germanium, suahili:gerimani, arabia: جرمانيوم  
**geste** *ele* ← englanti:gesture, espanja:portugali:gesto, ranska:geste, venäjä:жест (zhest), turkki:jest, persia:ژست‎ (žest)  
**gi** *kone* ← yleiskiina:機 (jī), wu-kiina:機 (ji1), kantoninkiina:機 (gei1), japani:機 (ki), korea:기 (gi), thai:กี่ (gìi) + jpn:器 (ki)  
**gide** *opastaa (ohjata)* ← englanti:ranska:guide, espanja:guía, portugali:guia, venäjä:гид  (gid), japani:ガイド (gaido), korea:가이드 (gaideu), suahili:gaidi + arabia:قَادَ‎ (qāda)  
...
**gingam** *kumkvatti* ← kantoninkiina:柑橘 (gam1gwat1), yleiskiina:金橘 (jīnjú), japani:キンカン (kinkan), korea:금귤 (geumgyul), vietnami:kim quất, englanti:espanja:ranska:kumquat, portugali:cunquate, venäjä:кумкват (kumkvat), turkki:kumkat, arabia:كمكوات (kamakawat), malaiji:kumkuat  
**ginge** *inkivääri* ← englanti:ginger, ranska:gingembre, espanja:gengibre, portugali:jengibre, yleiskiina:姜 (jiāng), kantoninkiina:薑 (goeng1), vietnami:gừng, korea:생강 (saenggang), tamili:இஞ்சி (inji), arabia: زنجبيل‎ (zanjabīl), persia: زنجبیل‎ (zanjebil), turkki:zencefil  
**giota** *pisara (tippa)* ← thai:หยด (yòt), vietnami:giọt, + englanti:iota, venäjä:йота (yota) + espanja:portugali:gota  
**gitar** *kitara* ← englanti:guitar, ranska:guitare, espanja:portugali:guitarra, venäjä:гитара (gitara), arabia:(qīṯāra), hindi:गिटार (giṭār), bangla:গিটার (giṭar), yleiskiina:吉他 (jítā), kantoninkiina:結他 (git6taa1), japani:ギター (gitā), korea:기타 (gita), suahili:gitaa  
**glas** *lasi* ← deu:Glas, englanti:glass + persia: گیلاس‎ (gilâs), hindi:गिलास (gilās), bangla:গ্লাস (glaś), japani:グラス (gurasu), korea:글라스 (geullaseu), malaiji:gelas, suahili:glasi, hausa:gilashi + venäjä:глазурь, espanja:glasear  
...
**glute** *liima* ← englanti:glue, suahili:gluu, malaiji:glu + espanja:ranska:gluten, portugali:glúten, venäjä:глютен (glyuten), arabia: غْلُوتِين‎ (ḡlūtīn), japani:グルテン (guruten)  
**gogia** *maa (valtio)* ← yleiskiina:国家 (guójiā), kantoninkiina:國家 (gwok3 gaa1), japani:国 (koku); 国家 (kokka), korea:국가 (gukga), vietnami:quốc gia  
...
**gomu** *kumi* ← ranska:gomme, espanja:filippiini:goma, japani:ゴム (gomu), korea:고무 (gomu) + englanti:gum, deu:Gummi + hindi:गम (gam), bangla:গাম (gam)  
**gone** *kulma (nurkka)* ← hindi:कोण (koṇ), telugu:(kōnamu), suahili:kona, englanti:corner; -gon, hausa:kwana, ranska:-gone, espanja:portugali:-gono  
**gorila** *gorilla* ← englanti:gorilla, ranska:gorille, espanja:portugali:malaiji:gorila, venäjä:горилла (gorilla), arabia:غوريلا (ḡūrīlā), japani:ゴリラ (gorira), korea:고릴라 (gorilla), vietnami:gôrila, hindi:गोरिल्ला (gorillā), bangla:গরিলা (gôrila), tamili:கொரில்லா (korillā)  
...
**gram** *gramma* ← englanti:gram, deu:Gramm, ranska:gramme, espanja:gramo, portugali:grama, venäjä:грамм (gramm), persia: گرم‎ (geram), hindi:ग्राम (grām), bangla:গ্রাম (gram), arabia: غْرَام‎ (ḡrām), fulani:giram, suahili:gramu, japani:グラム (guramu), korea:그램 (geuraem), vietnami:gam, malaiji:turkki:gram  
**gran** *jyvänen (hiukkanen)* ← englanti:ranska:grain, espanja:grano, portugali:grão + venäjä:гранит (granit), turkki:vietnami:malaiji:granit, arabia:جرانيت (jaraniat), hindi:ग्रेनाइट (grenait)  
**grave** *sora* ← englanti:gravel, espanja:grava, ranska:gravire, venäjä:гравий (graviy) + suahili:changarawe  
**grese** *harpata (harppoa, käydä)* ← englanti:deu:ranska:agression, puola:agresja, venäjä:агрессия (agressiya), espanja:agresión, portugali:agressão, malaiji:agresif  
...
**gros** *karkea (karhea)* ← ranska:gros, portugali:grosso + espanja:grosero, englanti:gross  
**gros** *paksu* ← ranska:gros, portugali:grosso, espanja:grueso  
...
**gua** *luola* ← bangla:গুহা (guha), hindi:गुफ़ा (gufā), tamili:குகை (kukai), telugu:గుహ (guha), malaiji:gua, thai:คูหา (gūhā)  
**guai** *outo (kummallinen)* ← yleiskiina:怪 (guài), kantoninkiina:怪 (gwaai3), japani:怪 (kai), korea:괴 (goe), vietnami:quái  
**guan** *leveä* ← yleiskiina:宽 (kuān);  広 (guǎng), kantoninkiina:廣 (gwong2), vietnami:quảng, thai:กว้าง (kwang)  
**guan** *virka (virka-asema)* ← yleiskiina:官 (guān), kantoninkiina:官 (gun1), japani:官 (kan), korea:관 (gwan), vietnami:quan  
**Guangzou** *Guangzhou (Kanton)* ← CN  
**gubu** *virtahepo* ← fulani:ngabbu Kongo:ngubu, sot:tsw:kubu, zulu:rwa:imvubu, amharabia:ጉማሬ (gumare)  
...
**guru** *guru (opettaja)* ← hindi:गुरु (guru), bangla:গুরু (guru), tamili:குரு (kuru), filippiini:guro, thai:ครู (gruu), malaiji:englanti:portugali:guru, espanja:gurú, venäjä:гуру (guru), ranska:gourou, korea:구루 (guru), japani:グル (guru)  
...
**ha** *olla (omistaa)* ← englanti:have, ranska:avoir, espanja:hay  
**habar** *uutinen* ← arabia: خَبَر‎ (xabar), persia: خبر‎ (xabar), hindi:ख़बर (xabar), bangla:খবর (khôbôr), tamili:கபர் (kapar), malaiji:kabar, turkki:haber, suahili:habari, hausa:labari, yoruba:làbarè, fulani:kibaaru  
**hafenium** *hafnium* ← englanti:hafnium, ranska:hafnium, espanja:hafnio, portugali:háfnio, venäjä:гафний, yleiskiina:铪 (hā), japani:ハフニウム, korea:하프늄, vietnami:hafini, hindi:हाफ्नियम, bangla:হাফনিয়াম, malaiji:hafnium, suahili:hafni, arabia: هفنيوم  
**hafiz-** *säilyttää (varjella, säästää)* ← arabia:(ḥafiẓa), persia:urdu:(hāfiz), turkki:muhafaza, hindi:हाफ़िज़ (hāfīz), suahili:hifadhi  
...
**haima** *teltta* ← arabia:(xayma), hausa:laima, hindi:ख़ैमा (xEmā), suahili:hema, malaiji:kemah, may:khemah, mng:майхан (mayhan)  
**haje** *pyhiinvaellus* ← arabia: حَجّ‎ (ḥajj), persia: حج‎ (hajj), turkki:hac, suahili:hija, hausa:haji, fulani:hajju  
**hake** *oikeus (oikeutus)* ← arabia: حَقّ‎ (ḥaqq), hindi:हक़ (haq), bangla:হক (hôk), pandzabi:ਹੱਕ (hakka), telugu:హక్కు (hakku), turkki:malaiji:hak, suahili:haki, hausa:hakki, fulani:haƙƙe  
**haki** *pöly (tomu)* ← persia: خاک (xâk), hindi:ख़ाक (xāk), bangla:খাক (khâk), turkki:haki, englanti:khaki, ranska:kaki, espanja:caqui, portugali:cáqui, venäjä:хаки (haki), yleiskiina:卡其 (kǎqí), kantoninkiina:卡其色 (kaakeisik), japani:カーキ色 (kāki-iro), korea:카키색 (kakisaek), vietnami:màu kaki  
**hal** *tila (tilanne, seikka)* ← arabia:حال (ḥāl), hindi:हालत (hālat), suahili:hausa:hali, fulani:haala; alhaali, turkki:hâl  
**halal** *sallittu (hyväksytty)* ← arabia:(ḥalāl), persia:urdu:(halāl), englanti:espanja:ranska:portugali:malaiji:hausa:halal, turkki:helal, venäjä:халяльный (xaljalʹniy), hindi:हलाल (halāl), suahili:halali, korea:할랄 (hallal)  
...
**halife** *kalifi* ← arabia: خَلِيفَة‎ (ḵalīfa), englanti:caliph, ranska:calife, espanja:portugali:califa, venäjä:халиф (khalif), hindi:ख़लीफ़ा (xalīfā), bangla:খলিফা (khôlipha), tamili:கலீஃப் (kalīph), malaiji:khalifah, suahili:halifa, hausa:khalifa, yleiskiina:哈里发 (hālǐfā), japani:ハリーファ (harīfā), korea:칼리파 (kallipa), turkki:halife, fulani:kaliifa  
...
**ham di** *tärkeä* ← arabia: هَامّ (hāmm), hindi:अहम (aham), urdu: اہم (aham), suahili:muhimu, turkki:mühim, persia:(mohemm), hausa:muhimmi  
...
**harabe** *pilalla (raunioina)* ← arabia:persia:urdu:(xarāb), turkki:harap, hindi:ख़राब (xarāb), bangla:খারাপ (kharap), suahili:-haribu  
**haram** *pyhä (kielletty, tabu, haram)* ← arabia:(ḥarām), fulani:hausa:malaiji:turkki:englanti:deu:haram, hindi:हराम (harām), korea:하람 (haram), persia:urdu:(harām), suahili:haramu, yleiskiina:哈拉姆 (hālāmǔ), venäjä:харамный (xaramniy)  
...
**haste** *kiireinen (kiire)* ← deu:Hast, englanti:haste, ranska:hâte + persia:آهسته (âheste), hindi:आहिस्ता (āhistā), bangla:আস্তে (aste), turkki:aheste  
**hata** *asti (saakka)* ← portugali:até, arabia:(ḥatta), espanja:hasta, suahili:hata, hausa:hatta, fulani:haa + persia: تا‎ (tâ), hindi:तक (-tak)  
**hatar** *vaara* ← arabia: خطر‎ (xaṭar), persia: خطر‎ (xatar), urdu: خطرہ‎ (xatrā), hindi:ख़तरा (xatrā), suahili:hatari, hausa:hatsari, turkki:muhatara  
**hau** *hyvä* ← yleiskiina:好 (hǎo), kantoninkiina:好 (hou2), vietnami:hảo  
**hava** *tuuli (puhallus)* ← arabia: هَوَاء‎ (hawāʾ), persia: هوا‎ (havâ), hindi:हवा (havā), bangla:হাওয়া (hava), malaiji:hawa, suahili:hewa, turkki:hava  
**haxi** *syömäpuikot* ← japani:箸 (hashi), bangla:হাশি (haśi), gujarati:હાશી (hāśī), portugali:hashi  
**haxix** *hasis* ← arabia: حَشِيش (ḥašīš), englanti:hashish, ranska:haschich, portugali:haxixe, venäjä:гашиш (gašiš), japani:ハシシ (hashishi), korea:해시시 (haesisi), hindi:हशीश (haśīś), malaiji:hasyis  
**hazin** ** ← arabia: خَزَنَ‎ (xazana) + persia: خزینه‎ (xazine), hindi:ख़िज़ाना (xizānā), venäjä:казна (kazna), suahili:hazina + englanti:magazine, espanja:almacén, portugali:armazém, turkki:hazine; mahzen  
**he** *häh (-ko, -kö)* ← englanti:huh, ranska:hein, portugali:hã, vietnami:hả, deu:hä + yleiskiina:何 (hé)  
**hei** *hei* ← englanti:hey, ranska:hé, espanja:hey, portugali:ei, venäjä:эй (ey), yleiskiina:喂 (wèi), vietnami:ê; ơi, persia: هی‎ (hey), fulani:héé  
**helium** *helium* ← englanti:helium, ranska:hélium, espanja:helio, portugali:hélio, venäjä:гелий, yleiskiina:氦 (hài), japani:ヘリウム, korea:헬륨, vietnami:suahili:heli, hindi:हिलियम, bangla:হিলিয়াম, malaiji:helium, arabia: هيليوم  
**helix** *kierre (spiraali)* ← kreikka: ἕλιξ (helix), englanti:helix, ranska:portugali:espanja:hélice, puola:helisa, arabia:(ḥalazūn), turkki:helezon  
**heme** *veri* ← englanti:espanja:portugali:malaiji:vietnami:turkki:hemo-, ranska:hémo-, venäjä:гемо- (gemo-), japani:ヘモ- (hemo-)  
**hem…** *hmm…* ← englanti:hmm, venäjä:хм (hm), эм (em), korea:음 (eum)  
**hen** *viha (inho)* ← yleiskiina:恨 (hèn), kantoninkiina:恨 (han6), wu-kiina:恨 (hhen3), vietnami:hận, korea:한  (han) + japani:嫌 (ken) + ranska:haine  
**hena** *hennapensas* ← arabia: حِنَّاء‎ (ḥinnāʾ), englanti:henna, deu:Henna, ranska:henné, espanja:alheña, portugali:hena, venäjä:хна (hna), persia:حنا‎ (hanâ), hindi:हिना (hinā), turkki:kına  
**hepate** ** ← yleiskiina:肝 (gān), kantoninkiina:肝 (gon1), wu-kiina:肝 (koe1), korea:간 (gan), japani:肝臓 (kanzō), vietnami:gan + suahili:ini  
...
**hesium** *hassium* ← englanti:hassium, ranska:hassium, espanja:hasio, portugali:hássio, venäjä:хассий, yleiskiina: (hēi), japani:ハッシウム, korea:하슘, vietnami:hassi, hindi:हसियम, bangla:হ্যাসিয়াম, malaiji:hassium, suahili:hassi, arabia: هاسيوم  
...
**hindium** *indium* ← englanti:indium, ranska:indium, espanja:indium, portugali:índio, venäjä:индий, yleiskiina:铟 (yīn), japani:インジウム, korea:인듐, vietnami:indi, hindi:इण्डियम, bangla:ইন্ডিয়াম, malaiji:indium, suahili:indi, arabia: انديوم  
**hisabe** *laskea (lasku, laskelma)* ← arabia: حِسَاب‎ (ḥisāb), hindi:हिसाब (hisāb), bangla:হিসাব (hiśab), turkki:hesap, oromo:hisaaba, suahili:hisabu, hausa:lisafi, fulani:hiisa  
**histor** *historia (aikakirjat)* ← englanti:history, espanja:suahili:historia, portugali:história, ranska:histoire, venäjä:история (istoriya)  
...
**hotel** *hotelli* ← englanti:deu:espanja:portugali:malaiji:hotel, ranska:hôtel, hindi:होटल (hoṭal), bangla:হোটেল (hoṭel), tamili:ஹோட்டல் (hottal), japani:ホテル (hoteru), korea:호텔 (hotel), venäjä:отель (otel), suahili:hoteli, hausa:otal  
**hua** *kukka* ← yleiskiina:花 (huā), kantoninkiina:花 (faa1), vietnami:hoa, korea:화 (hwa) + suahili:ua  
**huang** *keltainen* ← yleiskiina:黄 (huáng), kantoninkiina:黃 (wong4), wu-kiina:黃 (húan), vietnami:vàng  
...
**humel** *humala* ← venäjä:хмель (hmel'), persia: خمل‎ (xemel) + ranska:houblon  
**humor** *huumori* ← venäjä:юмор (yumor), espanja:englanti:humor, ranska:humour, japani:ユーモア (yūmoa), korea:유머 (yumeo), yleiskiina:幽默 (yōumò)  
...
**hura** *hurrata (hurraa, jee, jippii, hiphei)* ← venäjä:ура (ura), italia:urrà, deu:espanja:hurra, ranska:hourra, englanti:hurrah, malaiji:hore, persia:(hurâ)  
**hure** *vapaa* ← arabia: حر (ḥurr), turkki:hür, suahili:huru, espanja:horro, portugali:forro  
...
**idee** *käsite (idea)* ← englanti:espanja:idea, ranska:idée, deu:Idee, portugali:ideia, venäjä:идея (ideya), malaiji:ide, japani:アイデア (aidea), korea:아이디어 (aidieo), vietnami:ý định  
**idiote** *typerys (idiootti)* ← englanti:deu:ranska:malaiji:idiot, espanja:portugali:idiota, venäjä:идиот (idiot)  
**ifrite** ** ← arabia:عِفْرِيت‎ (ʿifrīt), englanti:espanja:portugali:ranska:turkki:malaiji:ifrit, deu:Ifrit, venäjä:ифрит (ifrit), japani:イフリート (ifuriito)  
**iglu** *iglu* ← englanti:igloo, ranska:iglou, espanja:iglú, portugali:turkki:malaiji:iglu, venäjä:иглу (iglu), hindi:इग्लू (iglū), japani:イグルー (igurū), korea:이글루 (igeullu)  
**iha** *aasi* ← onom. englanti:heehaw, ranska:hi-han, venäjä:и-а (i-a), vietnami:hô hố, turkki:aa-i  
**ilme** *tieto* ← arabia: عِلْم‎ (ʕilm), persia: علم‎ ('elm), hindi:इल्म (ilm), bangla:এলেম (elem), malaiji:fulani:ilmu, hausa:ilmi, suahili:elimu, turkki:ilim  
**imperia** *imperium* ← englanti:ranska:empire, espanja:imperio, portugali:império, venäjä:империя (imperiya), arabia:(ʾimbirāṭūriyya), turkki:imparatorluk  
...
**intraje** *sisälmykset* ← hindi:आंत्र (åntra), bangla:অন্ত্র (antra), pan:ਆਂਦਰਾਂ (āndarā̃) + ranska:entrailles, englanti:entrails, espanja:entrañas, portugali:entranhas  
...
**jamia** *yhteisö (kokoontuminen, kollektiivi)* ← arabia: جَمَعَ‎ (jamaʿa), suahili:jamii, turkki:camia, persia: جمع (jam’), hausa:jam'iyya + hindi:जमात (jamāt)  
...
**jan** *huomio (tarkkaavaisuus)* ← hindi:ध्यान (dhyān), bangla:ধ্যান (dhyān), japani:禅 (zen), englanti:ranska:portugali:zen, venäjä:дзэн (dzen), yleiskiina:禅 (chán), korea:선 (seon), vietnami:thiền, burma:ဈာန် (jhan)  
**janela** *ikkuna* ← portugali:janela, bangla:জানালা (janala), tamili:ஜன்னல் (jaṉṉal), malaiji:jendela  
**jang suta** *kamppailulaji* ← yleiskiina:武术 (wǔshù), japani:武術 (bujutsu), vietnami:võ thuật, korea:무술 (musul), englanti:martial art  
**jang** *taistelu (sota)* ← persia: جنگ (jang), hindi:जंग (jang), bangla:জঙ্গ (jôṅg), turkki:cenk + yleiskiina:仗 (zhàng); 爭 (zhēng), kantoninkiina:争 (zang1), korea:전쟁 (jeonjaeng), vietnami:(chiến) tranh + malaiji:juang  
...
**jaru** *luuta* ← hindi:झाड़ू (jhāṛū), bangla:ঝাড়ু (jhaṛu) + korea:빗자루 (bitjaru)  
**jau** *ohra* ← hindi:जौ (jau), bangla:যব (jôb), marathi:जव (jav), gujarati:જવ (jav), persia: جو‎ (jow)  
**javabe** *vastata (vastaus)* ← arabia: جَوَاب‎ (jawāb), hindi:जवाब (javāb), malaiji:jawab, fulani:jaabaade, suahili:jibu,jawabu, turkki:cevap  
**jebe** *tasku* ← arabia: جَيْب‎ (jayb), persia: جیب‎ (jib), hindi:जेब (jeb), pandzabi:ਜੇਬ (jeb), telugu:(jēbu), turkki:cep, portugali:algebeira, fulani:jeyba, hausa:aljihu, ful:jiiba, wolof:jiba, amhara:ጅብ (ǧəb)  
**jeka na** ** ← yleiskiina:借 (jiè), kantoninkiina:借 (ze3), japani:借 (shaku), korea:적 (jeok) + englanti:check  
**jeka** ** ← yleiskiina:借 (jiè), kantoninkiina:借 (ze3), wu-kiina:借 (jia2), japani:借 (shaku), korea:적 (jeok) + englanti:check  
**jele** *vangita* ← englanti:jail, ranska:geôle, hindi:जेल (jel), bangla:জেল (jēl), telugu:జైలు (jailu), suahili:jela + espanja:portugali:jaula  
...
**jenju** *helmi* ← yleiskiina:珍珠 (zhēnzhū), kantoninkiina:珍珠 (zan1 zyu1), japani:真珠 (shinju), korea:진주 (jinju), vietnami:trân châu, venäjä:жемчуг (žemčug), turkki:inci,incü  
**jensen** *ginseng* ← yleiskiina:人蔘 (rénshēn), min-kiina:人蔘 (jîn-sam), englanti:espanja:portugali:turkki:malaiji:ginseng, venäjä:женьшень (zhen’shen’), hind:जिनसेंग (jinseṅg), japani:人参 (ninjin)  
**jete** ** ← ranska:projet, portugali:projeto, englanti:project, espanja:proyecto, venäjä:проект (proyekt), hindi:प्रोजैक्ट (projaikṭ), bangla:প্রজেক্ট (prôjekṭ), japani:プロジェクト (purojekuto), korea:프로젝트 (peurojekteu), turkki:proje  
**jihade** *kamppailu (taistelu)* ← arabia: جهاد (jihād), turkki:cihat, fulani:jihaadi, suahili:jihadi + englanti:ranska:portugali:malaiji:jihad, espanja:yihad, venäjä:джихад (džihad), japani:ジハード (jihādo), korea:지하드 (jihadeu), hindi:जिहाद (jihād)  
**jin** *henki (sielu)* ← arabia: جِنّ (jinn), fulani:wolof:jinne, suahili:jini, man:jinnoo, venäjä:джинн (džinn) + englanti:genie, ranska:génie, espanja:genio, portugali:gênio + hindi:जान (jān), bangla:জান (jan), turkki:can  
**jiva** *elää (elävä; elämä, olemassaolo)* ← hindi:जीव (jīv), bangla:জীউ (jiu), telugu:జీవము (jīvamu), malaiji:jiwa, thai:ชีวิต  (chiwit), burma:ဇီဝ (jiwa), khmer:ជីវិត (jĭvit), venäjä:живой (živoy), puola:żywy  
...
**jube** *kaapu* ← arabia: جُبَّة (jubba), suahili:juba, malaiji:jubah, espanja:aljuba, portugali:gibão, ranska:jupon, venäjä:жупан (župan)  
**judau** *judo* ← yleiskiina:柔道 (róudào), japani:柔道 (jūdō), korea:유도 (yudo), vietnami:nhu đạo, englanti:deu:ranska:espanja:portugali:malaiji:turkki:suahili:judo, venäjä:дзюдо (dzyudo), arabia: جُودُو‎ (jūdū), persia: جودو‎ (judo), hindi:जूदो (jūdo)  
**jude** *tuomita* ← englanti:judge, ranska:juge, espanja:juez, portugali:juiz, hindi:जज (jaj), bangla:জজ (jôj), suahili:jaji, fulani:juuju + venäjä:судья (sud'ya)  
**jumla** ** ← arabia:(jumla), turkki:cümle, hindi:जुमला (jumlā), yleiskiina:句 (jù)  
**jun** *nuori* ← englanti:ranska:malaiji:junior + espanja:joven, portugali:jovem, persia: جوان‎ (javân), hindi:जवान (javān) + korea:젊다 (jeomda)  
**jung** *laji* ← yleiskiina:種 (zhǒng), kantoninkiina:種 (zung2), wu-kiina:種 (tson2), japani:種 (shu), korea:종 (jong), vietnami:chủng  
...
**kabile** *heimo* ← arabia: قَبِيلَة‎ (qabīla), persia: قبیله‎ (qabile), hindi:क़बीला (qābilā), turkki:kabile, fulani:ƙabiila, suahili:hausa:kabila  
...
**kafe** *kahvi* ← deu:Kaffee, ranska:espanja:portugali:café, venäjä:кофе, yleiskiina: 咖啡 (kāfēi), kantoninkiina:咖啡 (gaa3 fe1), englanti:coffee, hindi:काफ़ी (kāfī), bangla:কফি (kôphi), turkki:kahve, hausa:kofi, fulani:kafe  
**kafir** *pakana* ← arabia:(kāfir), persia:(kāfer), turkki:ranska:kâfir, fulani:keefeero, yoruba:kaferi, suahili:hausa:kafiri, malaiji:kafir, venäjä:кафир (kafir), hindi:काफ़िर (kāfir)  
...
**kaju** *munuaispuu (cashew)* ← ranska:cajou, espanja:cajú, portugali:caju, englanti:cashew, deu:Kaschu, hindi:काजू (kājū), bangla:কাজু (kaju), arabia: كَاجُو‎ (kājū), fulani:kasu, malaiji:gajus, turkki:kaşu, japani:カシュー (kashū), korea:캐슈 (kaesyu)  
**kaka** *uloste (kakka)* ← espanja:portugali:ranska:caca, deu:Kacke, arabia:(kākā), turkki:kaka, venäjä:кака (kaka), persia:(kake)  
**kakau** *kaakao* ← portugali:cacau, arabia:(kākāw), espanja:cacao, englanti:cocoa, venäjä:какао (kakao), japani:カカオ (kakao), yleiskiina:可可 (kěkě), kantoninkiina:唂咕 (guk1gu2), vietnami:cacao, fulani:kokko, suahili:kakao  
...
**kal** *millainen* ← englanti:quality, deu:Qualität, ranska:qualité, espanja:calidad, portugali:qualidade, turkki:kalite, malaiji:kualitas  
**kala** *musta* ← hindi:काला (kālā); कारौ (kārau), bangla:কালো (kalo), pandzabi:ਕਾਲਾ (kālā) + tamili:கருப்பு (karuppu) + turkki:kara, kaz:қара (qara)  
...
**kalende** *kalenteri* ← englanti:calendar, ranska:calendrier, espanja:portugali:calendario, venäjä:календарь (kalendar’), deu:malaiji:kalender, japani:カレンダー (karendā), korea:카렌더 (karendeo), hindi:कैलेण्डर (kaileṇḍar), suahili:kalenda, hausa:kalanda  
...
**kalifornium** *kalifornium* ← englanti:californium, ranska:californium, espanja:californio, portugali:califórnio, venäjä:калифорний, yleiskiina:锎 (kāi), japani:カリホルニウム, korea:칼리포르늄, vietnami:califoni, hindi:कैलीफोर्नियम, bangla:ক্যালিফোর্নিয়াম, malaiji:kalifornium, suahili:kalifoni, arabia: كاليفورنيوم  
**kalium** *kalium* ← venäjä:калий, japani:カリウム, vietnami:kali, malaiji:kalium, suahili:kali  
**kalkul** *kalkyyli* ← ranska:calcul, espanja:cálculo, englanti:calculus, hindi:कलन (kalan)  
**kalmar** ** ← kreikka:καλαμάρι (kalamári), espanja:portugali:calamar, ranska:calmar, italia:englanti:calamari, venäjä:кальмар (kal’mar), turkki:kalamar, arabia:كلاماري‎ (klamāri)  
**kalsium** *kalsium* ← englanti:calcium (Ca), ranska:calcium, espanja:calcio, portugali:cálcio, venäjä:кальций, yleiskiina:钙 (gài), japani:カルシウム, korea:칼슘, vietnami:canxi, hindi:कैल्शियम, bangla:ক্যালসিয়াম, malaiji:kalsium, suahili:kalisi, arabia: كلسيوم  
**kam** *vähän* ← deu:kaum + persia: کم‎ (kam), hindi:कम (kam), bangla:কম (kôm) + kantoninkiina:減 (gaam2), japani:減 (-gen), korea:감 (gam), vietnami:giảm  
...
**kamisa** *paita* ← espanja:portugali:camisa, arabia:(qamīṣ), hindi:क़मीज़ (kāmīz), malaiji:kemeja + suahili:kamisi  
...
**kan** *paja (tekimö)* ← persia:خانه‎ (xâne), venäjä:-хана (-hana), hindi:ख़ाना (xānā), bangla:খানা (khana), suahili:karakana, turkki:hane + yleiskiina:馆 (guǎn), kantoninkiina:館 (gun2), korea:관 (gwan), japani:館 (-kan), vietnami:quán  
**kanal** *oja (kanava, kanaali)* ← englanti:espanja:portugali:ranska:canal, venäjä:канал (kanal), malaiji:kanal + arabia: قَنَاة‎ (qanāh) + bangla:খাল (khal)  
**kandi** *makeinen (karkki, namu)* ← englanti:candy, hindi:कैंडी (kaiṇḍī), bangla:ক্যান্ডি (kyandi), japani:キャンデー (kyandē), filippiini:kendi + arabia:persia: قند (qand), tamili:கண்டு (kaṇṭu)  
**kane** *tanko (pinna, sauva, patukka)* ← englanti:cane, ranska:canne + yleiskiina:杆 (gǎn), kantoninkiina:杆 (gon1), vietnami:cần, thai:คัน (khan)  
...
**kanse** *syöpä* ← englanti:ranska:cancer, espanja:cáncer, portugali:câncer, hindi:कैंसर (kainsar), bangla:ক্যান্সার (kênsar), turkki:kanser, suahili:kansa, japani:癌 (gan)   
...
**kapa** *pää* ← deu:Kopf, espanja:cabeza; cabo, portugali:cabeça; cabo, malaiji:kepala + hindi:कपाल (kapāl) + englanti:cape, ranska:cap + kantoninkiina:岬 (gaap3), korea:갑 (gap)  
**kape** *napata (kaapata, ottaa)* ← turkki:kapmak, unkari:kap, espanja:portugali:caber; capturar, englanti:capture  
...
**karcof** *artisokka* ← arabia: خرشوف (kharshuf), amhara:ከርቹፍ (kärčuf), espanja:alcachofa, portugali:alcachofra, malaiji:kharsyuf, puola:karczoch  
**kardon** *ohdake (takiainen)* ← espanja:portugali:cardo, ranska:chardon, englanti:cardoon, japani:カルドン (karudon)  
**karga** *kuorma (lasti, taakka)* ← espanja:portugali:carga, englanti:cargo, malaiji:kargo  
**kargadan:** *sarvikuono* ← persia: کرگدن‎ (kargadan), arabia: كَرْكَدَّن‎ (karkaddan), turkki:kergedan, hausa:karkanda, oromo:karkaarro, hindi:खड्गधेनु (khaḍgadhenu), tamili:ఖడ్గమృగం (khaḍgamr̥gaṁ), telugu:ఖడ్గమృగం (khaḍgamr̥gaṁ)  
**kari** *curry (karri)* ← englanti:ranska:portugali:curry, espanja:curri, venäjä:карри (karri), yleiskiina:咖喱 (kālǐ), kantoninkiina:咖喱 (gaa3lei1), japani:カレー (karē), korea:커리 (keori), vietnami:cà ri,hindi:करी (karī), bangla:কারি (kari), malaiji:kari, arabia: كَارِي‎ (kārī)  
...
**karote** *porkkana* ← englanti:carrot, ranska:carotte, deu:Karotte, fulani:suahili:karoti, hausa:karas, amharabia:ካሮት (karot), malaiji:karot, vietnami:cà rốt, tamili:காரட் (kāraṭ)  
**karta** *kortti* ← englanti:card, ranska:carte, espanja:portugali:carta, deu:Karte, venäjä:карта (karta), turkki:kart, fulani:kartal, suahili:kadi, hausa:karta, hindi:कार्ड (kārḍa), bangla:কার্ড (kārḍa), malaiji:kartu, yleiskiina:卡 (kǎ), kantoninkiina:卡 (kaa1), japani:カード (kādo), korea:카드 (kadeu)  
**karte** *kartta* ← englanti:chart, ranska:carte, espanja:portugali:carta, venäjä:карта (karta), arabia: خَرِيطَة‎ (ḵarīṭa), turkki:harita  
**kartux** *patruuna* ← ranska:cartouche, espanja:portugali:cartucho, hindi:कारतूस (kārtūs), arabia: خَرْطُوش‎ (ḵarṭūš), fulani:kartus, turkki:hartuç  
...
**kase** *laatikko* ← lat:capsa, deu:Kasse, englanti:case, ranska:caise, espanja:caja, portugali:caixa, venäjä:касса (kassa), suahili:kasha, fulani:keesu + arabia:(qafaṣ), hindi:क़फ़स (qafas), turkki:kafes + yleiskiina:卡式 (kǎshì), kantoninkiina:卡式 (kaa1sik1), japani:カセット (kasetto), korea:카세트 (kaseteu), hausa:kaset  
**kaska** *kuori (suojakuori, suoja)* ← ranska:casque, espanja:cáscara, portugali:casca, fulani:kaske + nan:殼 (kag4), wu-kiina:殼 (khoq4), japani:殻 (kaku)  
**kastana** *kastanja* ← deu:Kastanie, espanja:castaňa, portugali:castanha, venäjä:каштан (kaštan), persia: کستانه‎ (kastâne), arabia: كَسْتَنَاء‎ (kastanāʔ), turkki:kestane  
...
**katil** *vuode (sänky, peti)* ← tamili:கட்டில் (kaṭṭil), malaiji:katil, hindi:खाट (khāṭ), englanti:cot, espanja:portugali:catre  
**katus** *kaktus* ← englanti:espanja:portugali:ranska:cactus, deu:Kaktus, venäjä:кактус (kaktus), hindi:कैक्टस (kaikṭas), turkki:kaktüs, malaiji:kaktus  
...
**kave** *kaivaa (kuoppa)* ← espanja:portugali:cavar, englanti:excavar, ranska:excaver  
**ke** *mikä? (mitä?)* ← ranska:que, espanja:qué, portugali:o que + bangla:কে (ke) + yleiskiina:何 (hé)  
...
**ken** *tietää tai tuntea* ← deu:kennen, englanti:ken + bangla:জ্ঞান (gên) + malaiji:kenal  
...
**kerubi** *kerubi* ← heb:כְּרוּב‎ (kerúv), englanti:cherub, espanja:querubín, portugali:querubim, ranska:chérubin, venäjä:херувим (heruvim), suahili:kerubi, hausa:malaiji:kerub, yleiskiina:基路伯 (jīlùbó)  
...
**keze** *juusto* ← espanja:queso, portugali:queijo, malaiji:keju, deu:Käse, englanti:cheese, yleiskiina:起司 (qǐsī), kantoninkiina:知士 (zi1si62), japani:チーズ (chīzu), korea:치즈 (chijeu), hindi:चीज़ (cīz), suahili:chizi  
...
**kirate** *karaatti* ← arabia: قِيرَاط‎ (qīrāṭ), englanti:ranska:carat, espanja:portugali:quilate, venäjä:карат (karat), yleiskiina:克拉 (kèlā), japani:カラット (karatto), korea:캐럿 (kaereot), malaiji:hausa:karat, suahili:karati, turkki:kırat  
...
**kitabe** *kirjoittaa (kirjoitus)* ← arabia: كِتَاب‎ (kitāb), persia: کتاب‎ (ketâb), hindi:किताब (kitāb), turkki:kitap; katip, malaiji:kitab, katib, suahili:kitabu; katibu, hausa:littafi  
...
**klas** *luokka (kategoria)* ← englanti:class, espanja:clase, portugali:ranska:classe, venäjä:класс (klass), کلاس‎ (kelâs), malaiji:kelas, japani:クラス (kurasu), fulani:kalaas  
**klien** ** ← englanti:client, espanja:portugali:ranska:cliente, venäjä:клиент (klient), japani:クライアント (kuraianto), malaiji:klien  
**klike** ** ← englanti:click, espanja:clic, portugali:clicar, ranska:claquer, hindi:क्लिक (klika), bangla:ক্লিক (klika), malaiji:klik, japani:クリック (kurikku)  
...
**klon** *klooni (identtinen kopio)* ← englanti:portugali:ranska:clone, espanja:clon venäjä:клон (klon), deu:malaiji:turkki:klon, may:klon, yleiskiina:克隆 (kèlóng), japani:クローン (kurōn)  
**klor** *kloori* ← englanti:chlorine, ranska:chlore, espanja:cloro, portugali:cloro, venäjä:хлор, vietnami:clo, hindi:क्लोरीन, bangla:ক্লোরিন, malaiji:klor, suahili:klorini, arabia: كلور  
...
**kluze** *sulkea (panna kiinni)* ← englanti:ranska:espanja:portugali:-clus-, venäjä:ключить (-klyučítʹ)  
**koala** *koala* ← englanti:ranska:espanja:vietnami:malaiji:suahili:turkki:koala, portugali:coala, venäjä:коала (koala), yleiskiina:考拉 (kǎolā), kantoninkiina:考拉 (haau2laa1), japani:コアラ (koara), korea:코알라 (koalla), arabia: كُوَالَا‎ (kuwalā), hindi:कोअला (koalā), bangla:কোয়ালা (koẏala)  
**kobalte** *koboltti* ← englanti:cobalt, ranska:cobalt, espanja:cobalto, portugali:cobalto, venäjä:кобальт, yleiskiina:钴 (gǔ), japani:コバルト, korea:코발트, vietnami:coban, hindi:कोबाल्ट, bangla:কোবাল্ট, malaiji:kobalt, suahili:kobalti, arabia: كوبلت  
...
**koko** *kana* ← ranska:coq, englanti:cock, puola:kogut, hindi:कुक्कुट (kukkuṭ) + suahili:kuku, zulu:inkukhu, igbo:Ọkụkọ + (onom.) italia:coccodè, japani:コッコッ (kokko), persia:(qod-qod-qodās), venäjä:куд-куда  
**kola** *koola* ← englanti:espanja:cola, venäjä:кола (kola), hindi:कोला (kolā), japani:コラ (kora), suahili:mkola, fulani:ngoro, hausa:gworo, wolof:goro  
...
**kolone** *asuttaa* ← englanti:colony, espanja:colonia, portugali:colônia, venäjä:колония (koloniya), turkki:ma:koloni, hindi:कॉलोनी (kŏlonī), japani:コロニー  
...
**komike** *koominen (hauska)* ← englanti:comic, ranska:comique, espanja:portugali:cómico + venäjä:комедия (komedija), japani:コメディ (komedi), korea:코미디 (komidi)  
**kompani** *yritys (yhtiö)* ← englanti:company, hindi:कंपनी (kampanī), venäjä:компания (kompaniya), filippiini:kompanya, puola:kompania  
**kon** *kanssa (yhdessä; yhteinen)* ← englanti:con-; common, ranska:con-; commun, espanja:con-; común, portugali:con-; comum, venäjä:кон- (kon-) + yleiskiina:共 (gòng), kantoninkiina:共 (gung), korea:공 (gong), vietnami:cộng  
...
**konu** *kartio (keila)* ← englanti:portugali:cone, ranska:cône, espanja:cono, venäjä:конус, malaiji:kon, suahili:turkki:koni  
**kopernium** *copernicium* ← englanti:ranska:copernicium, espanja:copérnico, portugali:copernício, venäjä:коперниций, japani:コペルニシウム, korea:코페르니슘, vietnami:copernici, malaiji:copernicium, suahili:kopernici  
...
**koral** *koralli* ← englanti:espanja:portugali:coral, ranska:corail, deu:Koralle, venäjä:коралл + malaiji:karang  
...
**kosi** *ommella* ← espanja:portugali:coser + hindi:सीना (sīnā), bangla:স্যূত (syūta), marathi:शिवणे (śivṇe), gujarati:સીવવું (sīvvũ), venäjä:шить (šit'), englanti:sew  
**kosme** *avaruus (kosmos)* ← venäjä:космос (kosmos), englanti:ranska:espanja:cosmos  
**koso** *yskä* ← venäjä:кашель (kašel'), puola:kaszel, bangla:কাশা (kaśa), yleiskiina:咳嗽 (késou)  
**kote** *takki* ← englanti:coat, suahili:koti, hausa:kwat, oromo:koota, japani:コート (kōto), persia:(kot), hindi:कोट (kot)  
...
**kratia** *hallinta* ← englanti:-cracy, ranska:-cratie, espanja:portugali:-cracia, venäjä:-кратия (kratiya), arabia:(-qratiya), malaiji:suahili:-krasi  
**kree** *luoda* ← englanti:create, deu:kreieren, ranska:créer, espanja:crear, portugali:criar + malaiji:kreatif  
**krem** *kerma* ← ranska:crème, portugali:creme, espanja:crema, englanti:cream, japani:クリーム (kurīmu), yleiskiina:淇淋 (qílin), fulani:kerem  
**krepe** *lätty (räiskäle, pannukakku)* ← ranska:englanti:crêpe, portugali:crepe, espanja:crepa, turkki:krep, yleiskiina:可丽饼 (kělìbǐng)  
...
**krim di** *rikos- (rikollinen)* ← arabia: جُرْم (jurm), persia: جرم‎ (jorm), hindi:जुर्म (jurm)  
...
**krokodil** ** ← kreikka:κροκόδειλος, englanti:crocodilian, ranska:crocodilien, espanja:crocodilio, portugali:crocodiliano, venäjä:крокодил (krokodil), japani:クロコダイル, korea:크로커다일 (keulokeodail)  
**krokro** ** ← englanti:croak, ranska:croa croa, espanja:portugali:croac croac, japani:ケロケロ (kero kero), malaiji:krok krok  
**kromium** *kromi* ← englanti:chromium, ranska:chrome, espanja:cromo, portugali:crómo, venäjä:хром, japani:クロム, korea:크로뮴, vietnami:crom, hindi:क्रोमियम, bangla:ক্রোমিয়াম, malaiji:krom, suahili:kromi, arabia: كروم  
**krote** *kontiainen (maamyyrä)* ← venäjä:крот (krot), puola:kret  
**kruasan** *voisarvi (kroissantti)* ← ranska:englanti:croissant, portugali:croassã, espanja:cruasán, venäjä:круассан, yleiskiina:可颂 (kěsòng), japani:クロワッサン (kurowassan), korea:크루아상 (keruasang), hindi:क्रोइसैन (kroisain)  
...
**kuan** *kivennäinen (mineraali)* ← yleiskiina:矿 (kuàng), vietnami:khoáng, korea:광 (guang) + persia: کان‎ (kân), hindi:खान (khān), bangla:খাদ (khad)  
**kuarze** ** ← deu:Quarz, englanti:ranska:quartz, espanja:cuarzo, venäjä:кварц (kvarc), turkki:kuvars, hindi:क्वार्ट्ज (kvārtj), japani:クオーツ (kuōtsu), malaiji:kuarza  
...
**kuku** *käki* ← englanti:cuckoo, ranska:coucou, espanja:portugali:cuco, venäjä:кукушка (kukushka), persia: کوکو‎ (kuku), japani:郭公 (kakkō), yleiskiina:布谷鸟 (bùgǔniǎo), kantoninkiina:布谷鳥 (bou3 guk1 niu5), turkki:guguk, hausa:kukku  
**kule** *orja (kuli)* ← turkki:köle; kul, hindi:क़ुली (qulī), tamili:கூலி (kūli), malaiji:kuli, yleiskiina:苦力 (kǔlì), kantoninkiina:咕哩 (gu1 lei1), japani:苦力 (kūrī), korea:쿨리, vietnami:cu li, englanti:ranska:coolie, espanja:culi, portugali:cule, deu:Kuli, venäjä:кули (kuli)  
**kulte** *vaalia* ← englanti:cultivate, ranska:cultiver, espanja:portugali:cultivar, venäjä:культура (kulʹtúra), persia: کولتور‎ (kultur), turkki:kültür, japani:カルチャー (karuchā), tamili:கலாச்சாரம் (kalāccāram)  
**kume** *kumpu* ← englanti:cumulate, ranska:cumuler, espanja:portugali:cumular + turkki:kumul + arabia:كَوْمَة‎ (kawma), persia: کومه (kume)  
**Kung Fuzi** *Kungfutse* ← yleiskiina:孔夫子 (Kǒng Fūzǐ)  
**kung** *reikä* ← yleiskiina:孔 (kǒng), kantoninkiina:孔 (hung2), wu-kiina:孔 (khon2), japani:孔 (kō), korea:공 (gong), vietnami:hỏng  
**kupa** *malja (kuppi, muki, lasi)* ← englanti:cup, ranska:coupe, espanja:copa, portugali:copo, arabia: كُوب‎ (kūb), fulani:kóppu, turkki:kupa, hindi:कप (kap), japani:コップ (koppu), korea:컵 (keop) + persia:(koppe), ara:قبة (qubba), malaiji:kubah, venäjä:купол (kupol), deu:Kuppel  
...
**kupre** *kupari* ← englanti:copper, ranska:cuivre, espanja:cobre, portugali:cobre, suahili:kupri  
**kuran** *koraani* ← arabia: الْقُرْآن‎ (al-qurʔān), turkki:Kuran, suahili:Kurani, hausa:Alƙur'ani, fulani:alkur'aana, englanti:Quran, ranska:Coran, espanja:Corán, portugali:Corão, venäjä:Коран (Koran), persia: قرآن‎ (qor-ân), hindi:क़ुरान (qurān), bangla:কুরআন (kuran), malaiji:Al-Qur'an, yleiskiina:古兰经 (gǔlánjīng), japani:クルアーン (kuruān), korea:꾸란 (kkuran), vietnami:kinh Koran  
**kurban** *uhri (uhraus)* ← arabia: قُرْبَان‎ m (qurbān), hindi:कुरबानी (kurbānī), bangla:কোরবানি (korbani), malaiji:turkki:kurban  
**kurium** *curium* ← englanti:curium, ranska:curium, espanja:curio, portugali:cúrio, venäjä:кюрий, japani:キュリウム, korea:퀴륨, vietnami:curi, hindi:क्यूरियम, bangla:কুরিয়াম, malaiji:kurium, suahili:kuri, arabia: كوريوم  
**kurse** *kulkea (kulku; kurssi; reitti)* ← englanti:course, ranska:cours, espanja:portugali:curso, venäjä:курс (kurs) + hindi:कोर्स कोर्स् (kors), malaiji:kursus, korea:코스 (koseu), japani:コース (kōsu)  
**kursi** *tuoli* ← arabia:(kursiy), hindi:कुरसी (kursī), urdu:(kursī), pandzabi:ਕੁਰਸੀ (kursī), telugu:(kurcī), malaiji:som:kursi, persia:(korsi)  
**kurta** *mekko (tunika)* ← persia: کرته‎ (korte), hindi:कुरता (kurtā), bangla:কুরতা (kurôta), telugu:కుర్తా (kurtā), malaiji:kurta, venäjä:курта (kurta), englanti:kirtle  
**kurva** *mutka (kurvi)* ← englanti:curve, ranska:courbe, espanja:portugali:curva, suahili:kuruba + venäjä:кривая (krivaya)  
**kutu** ** ← malaiji:kutu, filippiini:kuto, englanti:cootie  
**kux loka** ** ← ranska:englanti:couchette, italia:cuccetta, puola:kuszetka  
**kuxen** *tyyny* ← englanti:cushion, ranska:coussin, espanja:cojín, portugali:coxim, japani:クッション (kusshon), korea:쿠션 (kusyeon), kantoninkiina:咕𠱸 (ku1 seon2), hausa:kushin, igbo:kushọn  
...
**lage** ** ← englanti:lake, espanja:portugali:italia:lago, ranska:lac  
**lai** *tulla (saapua)* ← yleiskiina:来 (lái), kantoninkiina:嚟 (lai4), japani:来 (rai), vietnami:lại  
**lake** *lakka* ← englanti:lacquer, deu:Lack, espanja:portugali:laca, ranska:laque, venäjä:лак (lak), malaiji:lak, arabia: لَكّ‎ (lakk), turkki:lake, yleiskiina:蜡克 (làkè), japani:ラッカー (rakkā), korea:래커 (raekeo)  
**lala** *tuudittaa* ← englanti:lull, puola:lulać, persia: لالا کردن‎ (lâlâ kardan) + japani:ララバイ (rarabai), filippiini:lalay + suahili:-lala  
**lampa** *lamppu* ← englanti:lamp, deu:ranska:lampe, espanja:lámpara, portugali:lâmpada, venäjä:лампа (lampa), arabia: لمبة‎(lamba), japani:ランプ (ranpu), korea:램프 (raempeu), hindi:लैंप (laimp), bangla:ল্যাম্প (lyamp), fulani:malaiji:lampu, turkki:lamba  
...
**lantan** *lantaani* ← englanti:lanthanum, ranska:lanthane, espanja:lantano, portugali:lantâno, venäjä:лантан, yleiskiina:镧 (lán), japani:ランタン, korea:란탄, vietnami:lantan, hindi:लाञ्थनम, bangla:ল্যান্থানাম, malaiji:lantanium, suahili:lanthani, arabia: لنثانوم  
**larva** *toukka* ← deu:ranska:larve, englanti:turkki:larva, hindi:लार्वा (lārvā), urdu:(lārvā), puola:larwa  
**lasa** *roska* ← yleiskiina:垃圾 (lājī / lèsè), kantoninkiina:垃圾 (laap6 saap3), hakkakiina:垃圾 (lá-sap), nan:垃圾 (lah-sap)  
**lasun** *valkosipuli* ← hindi:लहसुन (lahsun), bangla:রসুন (rôśun) + yleiskiina:大蒜 (dàsuàn), kantoninkiina:大蒜 (daai6 syun3), korea:대산 (daesan)  
**late** *sivu (kylki, puoli)* ← espanja:portugali:lado, italia:lato, englanti:lateral, ranska:latéral, venäjä:латеральный (lateral’nyy)  
**lau** ** ← yleiskiina:老 (lǎo), kantoninkiina:老 (lau2), wu-kiina:老 (lau3), japani:老 (rō), vietnami:lão  
**laurencium** *lawrencium* ← englanti:lawrencium, ranska:lawrencium, espanja:laurencio, portugali:lawrêncio, venäjä:лоуренсий, yleiskiina:铹 (láo), japani:ローレンシウム, korea:로렌슘, vietnami:lorenxi, lawrenci, hindi:लॉरेंशियम, bangla:লরেনসিয়াম, malaiji:lawrensium, suahili:lawirensi, arabia: لورنسيوم  
**laxe** *löysä (löysätä, päästää menemään)* ← englanti:(re)lax, ranska:(re)lâcher, espanja:(re)lajar, italia:lasciare, deu:lassen  
...
**le** *saavuttaa (saavutettua tilaa ilmaiseva apuverbi)* ← yleiskiina:了 (le, liǎo), wu-kiina:了 (le’), kantoninkiina:了 (liu), thai:แล้ว (lɛːw)  
**lege** *kevyt (hento, pehmeä, helppo, jne.)* ← hindi:लघु (laghu), bangla:লঘু (laghu) + englanti:light, espanja:ligero, portugali:ligeiro, ranska:léger, venäjä:лёгкий (l’ogkiy), puola:lekki  
...
**lenxi** *harjoitus* ← yleiskiina:练习 (liànxí), japani:練習 (renshū), korea:련습 (ryeonseup)  
**lete** *lukea* ← portugali:leer; leitor, espanja:ler; lector, ranska:lire; lecteur, venäjä:лектор (lektor) englanti:literature, deu:Literatur, fra:littérature, turkki:literatür  
...
**lexe** *sana* ← deu:englanti:ranska:espanja:portugali:lex-, venäjä:лекс- (leks-), malaiji:leks-  
...
**lide** *johtaa (ohjata)* ← englanti:lead, espanja:liderar + ranska:leader, portugali:líder, venäjä:лидер (lider), turkki:lider, hindi:लीडर (līdar), japani:リーダー (rīdā), korea:리더 (rideo)  
**lifafe** *kääre (kuori)* ← arabia: لِفَافَة‎ (lifāfa), persia:(lefâf), hindi:लिफ़ाफ़ा (lifāfā), bangla:লেফাফা (lephapha)  
**lige** *liittää (liitto, liittouma, liiga)* ← ranska:ligue, deu:espanja:puola:portugali:liga, englanti: league, venäjä: лига (liga), turkki:lig, suahili:ligi, japani:リーグ (rīgu)  
...
**lima** *viisi (5)* ← malaiji:filippiini:lima  
...
**limon** *sitruuna* ← persia:(limun), englanti:lemon, turkki:limon, venäjä:лимон (limon), espanja:limón, portugali:limão, hindi:नींबू (nīmbū), urdu:(nībū), yleiskiina:柠檬 (níngméng), kantoninkiina:檸檬 (ning4mung1), japani:檸檬 (remon), korea:레몬 (remon), vietnami:lêmon, suahili:ndimu; limau, fulani:leemuure, bangla:লেবু (lebu)  
...
**linke** *yhteys (suhde, side)* ← englanti:link, ranska:lien, deu:Link, persia:لینک • (link), japani:リンク (rinku) + yleiskiina:連結 (liánjié), kantoninkiina:連結 (lin4 git3), hakkakiina:連結 (lièn-kiet), vietnami:liên kết  
**linxe** *ilves* ← englanti:ranska:lynx, espanja:portugali:lince, hindi:लिंक्स (links)  
...
**litre** *litra* ← englanti:ranska:turkki:litre, deu:malaiji:liter, espanja:portugali:litro, venäjä:литр (litr), puola:litr, arabia: لتر‎(litr), hindi:लीटर (līṭar), bangla:লিটার (liṭar), japani:リットル (rittoru), korea:리터 (riteo), vietnami:lít, suahili:hausa:lita, fulani:liter  
...
**lixu** *orava* ← yleiskiina:栗鼠 (lìshǔ), japani:栗鼠 (risu)  
...
**lote** *arpa* ← englanti:ranska:lot, deu:Los, espanja:portugali:loteria, venäjä:лотерея (lotereia), persia: لاتاری‎ (lâtâri), hindi:लॉटरी (lŏṭrī), bangla:লটারি (lôṭari), yleiskiina:乐透 (lètòu)  
**lotra** ** ← englanti:otter + ranska:loutre, espanja:filippiini:lutrino, portugali:lontra + venäjä:выдра (vydra)  
**lou** *vuotaa* ← yleiskiina:漏 (lòu), kantoninkiina:漏 (lau6), japani:漏 (rō), 루 (ru)  
...
**lutesium** *lutetium* ← englanti:lutetium, ranska:lutécium, espanja:lutecio, portugali:lutécio, venäjä:лютеций, yleiskiina:镥 (lǔ), japani:ルテニウム, korea:루테튬, vietnami:lutexi, hindi:लुटेटियम, bangla:লুটেসিয়াম, malaiji:lutetium, suahili:luteti, arabia: لوتيتيوم  
...
**maina** *kottarainen* ← hindi:मैना (mainā), bangla:ময়না (môẏna), tamili:மைனா (maiṉā), deu:Maina, englanti:myna, espanja:portugali:mainá  
...
**makas** *sakset* ← arabia: مَقَص‎ (maqaṣ), turkki:makas, suahili:mkasi, oromo:maqasii, hausa:almakashi, yoruba:àlùmogàjí, fulani:almakaci  
**makin** *kone* ← englanti:ranska:machine, deu:Maschine, espanja:portugali:máquina, fulani:masin, suahili:mashine, hindi:मशीन (maśīn), bangla:মেশিন (meśin), malaiji:mesin, arabia: مَاكِينَة‎ (mākīna), turkki:makine, japani:マシン (mashin), korea:머신 (meosin)  
**mal** *omaisuus* ← arabia:persia:urdu:  مَال‎ (māl), hindi:माल (māl), bangla:মালিক, suahili:mali, hausa:mallake, malaiji:milik, turkki:mal  
...
**mame** *nisä (tissi)* ← persia: ممه‎ (mame), turkki:meme, englanti:mamma, espanja:portugali:mama + ranska:mammifère, malaiji:mamalia  
...
**mango** *mango* ← malayalam:മാങ്ങ (māṅṅa), englanti:espanja:turkki:mango, portugali:manga, venäjä:манго (mango), malaiji:mangga, japani:マンゴー (mangō), korea:망고 (manggo), fulani:mannguure  
**mania** *mania* ← englanti:portugali:mania, deu:Manie, ranska:manie, espanja:manía, venäjä:мания (maniya)  
...
**mar** *kerta (vuoro)* ← arabia: مرة (marra), suahili:mara, hausa:marra, persia: بار‎ (bâr), hindi:बार (bār), bangla:বার (bar), tamili:முறை (muṟai), deu:Mal  
...
**marke** *merkitä (merkki, jälki)* ← englanti:mark, espanja:portugali:marca, ranska:marque, korea:마크 (makeu), japani:マーク (māku), fulani:marke  
...
**masta** *masto (salko)* ← englanti:deu:mast, hindi:मस्तूल (mastūl), japani:マスト (masuto), venäjä:мачта (mačta), puola:maszt, portugali:mastro, espanja:mástil  
...
**medal** *mitali* ← englanti:medal, espanja:medalla, portugali:medalha, ranska:médaille, deu:Medaille, venäjä:меда́ль (medálʹ), persia: مدال‎ (medâl), hindi:मेडल (meḍal), bangla:মেডেল (meḍel), malaiji:medali, arabia: مِيدَالِيَة‎ (mīdāliya), turkki:madalya, japani:メダル (medaru), korea:메달 (medal), vietnami:mề đay  
**medan** *kenttä (aukio)* ← arabia: مَيْدَان‎ (maydān), persia:(meydan), hindi:मैदान (maidān), bangla:ময়দান (moidan), turkki:meydan, suahili:medani, venäjä:майдан (maydan)  
**mede** *apu* ← arabia: مَدَد‎ (madad), persia: مدد (madad), hindi:मदद (madad), bangla:মদদ (môdôd), telugu:మద్దతు (maddatu) + ranska:aider, englanti:aid + venäjä:мэдэ (mede), japani:メーデー (mēdē), korea:메이데이 (meidei)  
**medu** *hunaja* ← venäjä:мёд (myod), hindi:मधु (madhu), bangla:মধু (môdhu), malaiji:madu + portugali:mel, ranska:espanja:miel + kantoninkiina:蜜 (mat6)  
**mega** *miljoona (mega-)* ← englanti:ranska:espanja:portugali:malaiji:turkki:mega-, venäjä:мега- (mega-), japani:メガ (mega), korea:메가- (mega-)  
**megi** *pilvi* ← hindi:मेघ (megh), bangla:মেঘ (megh), tamili:மேகம் (mēgam), telugu:మేఘము (mēghamu), malaiji:mega, thai:เมฆ (mek) + arabia: غَيْمَة‎ (ḡayma) + vietnami:mây  
**mehe** *lammas* ← lingala:Kongo:meme + hindi:मेष (meṣ), persia:(miš), thai:เมษ (met) + japani:メーメー (mē mē), portugali:meh, arabia:(maa'), turkki:mee  
**mei** *kaunis (komea, sievä)* ← yleiskiina:美 (měi), kantoninkiina:美 (mei5), japani:美 (mi), korea:미 (mi), vietnami:mĩ, mỹ  
**meitnerium** *meitnerium* ← englanti:meitnerium, ranska:meitnérium, espanja:meitnerio, portugali:meitnério, venäjä:майтнерий, japani:マイトネリウム, korea:마이트너륨, vietnami:meitneri, hindi:मेइट्नेरियम, bangla:মিটনেরিয়াম, malaiji:meitnerium, suahili:meitneri, arabia: مايتنريوم  
...
**men** *moni (monta)* ← yleiskiina:们 (men), kantoninkiina:們 (mun4) + englanti:many + korea:많- (man-) + (tumen) hindi:तुम (tum), rom:tumen  
...
**mer** *jäsen (osatekijä, komponentti)* ← englanti:deu:espanja:portugali:mero-, ranska:méro-, venäjä:меро- (mero-)  
...
**mesi** *messias* ← englanti:messiah, ranska:messie, espanja:mesías, portugali:messias, venäjä:мессия (messiya), arabia: مَسِيح‎ (masīḥ), hindi:मसीह (masīh), bangla:মসিহ (môśih), malaiji:al-Masih, suahili:Masiya, turkki:Mesih, hausa:Almasihu  
**meta** *myöhempi (jälkeinen)* ← englanti:espanja:portugali:meta-, ranska:méta-, venäjä:мета- (meta-)  
**metal** *metalli* ← englanti:espanja:portugali:turkki:metal, ranska:métal, deu:Metall, venäjä:мета́лл (metáll)  
**metre** *mitta (koko, määrä)* ← englanti:-meter, ranska:-métrie, espanja:-metría, portugali:-metria, venäjä:-метрия (-metriya), hindi:मात्रा (mātrā), bangla:মাত্রা (matra), malaiji:matra, turkki:-metri  
**meza** *pöytä* ← portugali:espanja:mesa, hindi:मेज़ (mez), suahili:meza, malaiji:meja, tamili:மேசை (mesei), persia: میز‏‎ (miz), turkki:masa  
**mi** *minä* ← englanti:ranska:portugali:me, espanja:mi; me, persia: من‎ (man), hindi:मैं (mẽ), bangla:আমি (ami), fulani:mi, suahili:mimi  
**miau** *kissa* ← yleiskiina:猫 (māo), kantoninkiina:貓 (maau), vietnami:mèo, thai:แมว (mæo), suahili:nyau + englanti:miaow; meow, ranska:miaou, deu:espanja:portugali:miau, venäjä:мяу (myau), persia: میو‎ (miyu), hindi:म्याऊँ (myāū̃), tamili:மியாவ் (miyāv), turkki:miyav,   
**mide** *väli* ← englanti:mid; medium, deu:Mitte, espanja:medio, portugali:meio, hindi:मध्य (madhya), bangla:মধ্য (môddh), tamili:மத்தியம் (mattiyam) + ranska:médias, venäjä:медиа (media), yleiskiina:媒体 (méitǐ), japani:メディア (media), korea:미디어 (midieo), turkki:medya  
...
**mikro** *pikkuruinen (mikroskooppinen, mikro-)* ← englanti:ranska:espanja:portugali:micro-, venäjä:микро- (mikro-), japani:マイクロ- (maikuro-), malaiji:turkki:mikr-, yleiskiina:麦克 (mâikè)  
**milke** *maito* ← englanti:milk, deu:Milch, japani:ミルク  (miruku), korea:밀크 (milkeu), lingala:míliki, venäjä:молоко (moloko)  
**mime** *matkia (imitoida)* ← englanti:ranska:mime, espanja:portugali:mímico, venäjä:мим (mim)  
**min** *vähemmän* ← espanja:portugali:menos, ranska:moins, venäjä:ме́нее (méneje), englanti:min-  
**ming** *kirkas (selkeä)* ← yleiskiina:wu-kiina:明 (míng), kantoninkiina:明 (ming4), vietnami:minh, korea:명 (myeong)  
**minim** *vähiten* ← englanti:ranska:minimum, espanja:portugali:mínimo, deu:Minimum, venäjä:ми́нимум (mínimum)  
**minisme** *minimalismi* ← englanti:minimalism, espanja:portugali:minimalismo, ranska:minimalisme, venäjä:минимали́зм (minimalízm)  
...
**miskin** *kurja (raukka)* ← arabia:مِسْكِين (miskīn), persia:مسکین‎ (meskin), turkki:malaiji:hausa:miskin, suahili:maskini, hindi:, bangla:মিসকিন (miśkin), ranska:miskine, espanja:mezquino, portugali:mesquinho  
...
**mitre** *metri* ← englanti:turkki:metre, deu:malaiji:meter, ranska:mètre, espanja:portugali:metro, venäjä:метр (metr), arabia: متر‎ (mitr), yleiskiina:米 (mǐ), japani:メートル (mētoru), korea:미터 (miteo), vietnami:mét, hindi:मीटर (mīṭar), bangla:মিটার (miṭar), suahili:hausa:mita, fulani:meter  
**mixe** *sekoittaa* ← deu:mischen, venäjä:мешать (měšat'), puola:mieszać, englanti:mix, italia:miscelare, + hindi:मिश्रण (miśrān)  
**mode** *tapa (malli, tyyli, moodi)* ← ranska:englanti:mode, deu:Mode; Modus, espanja:portugali:modo, venäjä:мода (moda), turkki:mod, malaiji:mode, korea:모드 (modeu) + yleiskiina:模 (mó), kantoninkiina:模 (mou4), japani:模 (mo); モード (mōdo)  
...
**mole** *jauhaa* ← yleiskiina:磨 (mò), kantoninkiina:磨 (mo4) thai:โม่ (mo), ranska:moulin, espanja:molino, venäjä:молоть  (molot’)  
...
**moliden** *molybdeeni* ← englanti:molybdenum, ranska:molybdène, espanja:molibdeno, portugali:molibdénio, venäjä:молибден, yleiskiina:钼 (mù), japani:モリブデン, korea:몰리브덴, vietnami:molypđen, hindi:मोलिब्डेनम, bangla:মলিবডেনাম, malaiji:molibden, suahili:molibdeni, arabia: مولبيدنيوم  
...
**mone** *ainoa* ← deu:englanti:ranska:espanja:portugali:malaiji:mono-, venäjä:моно- (mono-)  
**moral** *moraali* ← englanti:espanja:portugali:malaiji:moral, ranska:morale, venäjä:мораль (moral’)  
**mos** *sammal* ← englanti:moss, espanja:portugali:musgo, ranska:mousse, deu:Moos, venäjä:мох (mox), hindi:मॉस (mosa)  
**mosim** *vuodenaika* ← arabia: موسم (mawsim), hindi:मौसम (mausam), malaiji:musim, turkki:mevsim, suahili:msimu + englanti:monsoon, ranska:mousson, portugali:monção, venäjä:муссон (musson)  
...
**mote** *liikuttaa (siirtää; liikkua)* ← englanti:move; motion, ranska:mouvoir, espanja:portugali:mover + venäjä:мотор (motor), turkki:malaiji:motor, arabia:(mutūr), yleiskiina:摩托 (mótuō), kantoninkiina:摩打 (mo1daa2), japani:モーター (mōtā), korea:모터 (moteo), vietnami:mô-tơ, hindi:मोटर (moṭar), bangla:মোটর (moṭôr), suahili:hausa:mota  
...
**mum** *vaha* ← hindi:मोम (mom), bangla:মোম (mom), persia: موم‎ (mum), turkki:mum + arabia: مومياء (mumiya), englanti:mummy, ranska:momie, espanja:momia, portugali:múmia, venäjä:мумия (mumiya), yleiskiina:木乃伊 (mùnǎiyī), malaiji:mumia  
...
**muringa** *moringa* ← englanti:portugali:moringa, tamili:முருங்கை (muruṅkai), malayalam:മുരിങ്ങ (muriṅṅa), malaiji:merunggai, filippiini:malunggay, thai:มะรุม (má-rum)  
...
**muxmula** *mispeli* ← venäjä:мушмула́ (mušmula), turkki:muşmula, arabia: مَشْمَلَة‎ (mašmala)  
...
**nadir** *harvinainen* ← arabia: نَادِر‎ (nādir), persia: نادر (nâder), hindi:नादिर (nādir), suahili:nadra, turkki:nadir, hausa:nadiri  
...
**nam lexe** *substantiivi (nimisana)* ← yleiskiina:名词 (míngcí), kantoninkiina:名詞 (ming4 ci4), japani:名詞 (meishi), korea:명사 (myeongsa), hindi:नाम (nām), ranska:nom, espanja:nombre, portugali:nome, venäjä:имя (imya), arabia:(ism), per:(esm), suahili:nomino  
**nam** *nimi* ← deu:englanti:name, ranska:nom, hindi:नाम (nām), bangla:নাম (nam), malaiji:nama, thai:นาม (naam) + japani:名前 (namae)  
...
**natre** *natrium* ← englanti:sodium, ranska:sodium, espanja:sodio, portugali:sódio, venäjä:натрий, yleiskiina:钠 (nà), japani:ナトリウム, korea:나트륨, vietnami:natri, hindi:सोडियम, bangla:সোডিয়াম, malaiji:natrium, suahili:natiri  
...
**ne** ** ← portugali:né, hindi:न (na), yleiskiina:呢 (ne), kantoninkiina:呢 (ne1), japani:ね (ne), vietnami:nhé  
...
**nelu** *neljä (4)* ← korea:넷 (net) + suahili:nne, zulu:ne, fulani:nay + tamili:நான்கு (nāṉku), malayalam:നാലു (nālu), telugu:నాలుగు (nālugu), kannada:ನಾಲ್ಕು (nālku) + fin:neljä, est:neli, unkari:négy  
**nen mes den** *päivämäärä* ← yleiskiina:年月日 (niányuèrì), kantoninkiina:年月日 (ninyutyat), japani:年月日 (nengappi), korea:연월일 (yeonworil)  
...
**neodimium** *neodyymi* ← englanti:neodymium, ranska:néodyme, espanja:neodimio, portugali:neodímio, venäjä:неодим, yleiskiina:钕 (nǚ), japani:ネオジム, korea:네오디뮴, vietnami:neođim, hindi:नियोडाइमियम, bangla:নিওডিমিয়াম, malaiji:neodinium, suahili:neodimi, arabia: نيودميوم  
**neon** *neon* ← englanti:neon, ranska:néon, espanja:neón, portugali:néon, venäjä:неон, yleiskiina:氖 (nǎi), japani:ネオン, korea:네온, vietnami:neon, nê-ông, hindi:नियोन, bangla:নিয়ন, malaiji:neon, suahili:neoni, arabia: نيون  
**neputunium** *neptunium* ← englanti:neptunium, ranska:neptunium, espanja:neptunio, portugali:neptúnio, venäjä:нептуний, yleiskiina:镎 (ná), japani:ネプツニウム, korea:넵투늄, vietnami:neptuni, hindi:नेप्ट्यूनियम, bangla:নেপচুনিয়াম, malaiji:neptunium, suahili:neptuni, arabia: نبتونيوم  
**nere** ** ← man:nɛrɛ, wolof:nere, ranska:néré, fulani:nɛtɛ  
**nese** *saari* ← kreikka:νήσος (nēsos), englanti:espanja:malaiji:-nesia, portugali:-nésia, ranska:-nésie, venäjä:-незия (-nezija), turkki:-nezya, yleiskiina:-尼西亚 (níxīyà), japani:ネシア (neshia) + may:nusa, mlg:nosy  
**nete** ** ← englanti:net(work), deu:Netz(werk), japani:ネット(ワーク) (nettowāku), korea:네트워크 (neteuwokeu) + ranska:connecter, espanja:portugali:connectar  
...
**nia** *aie (aikomus, tarkoitus)* ← arabia: نِيَّة‎ (niyya), hindi:नीयत (niyat), malaiji:niat, suahili:nia, hausa:niyya, fulani:anniya, turkki:niyet  
...
**nil** *sininen* ← bangla:নীল (nīl), hindi:नीला (nīlā), urdu:(nīlā), tamili:நீலம் (nīlam), malaiji:nilam  
...
**nobelium** *nobelium* ← englanti:nobelium, ranska:nobélium, espanja:nobelio, portugali:nobélio, venäjä:нобелий, yleiskiina:锘 (nuò), japani:ノーベリウム, korea:노벨륨, vietnami:nobeli, hindi:नोबेलियम, bangla:নোবেলিয়াম, malaiji:nobelium, suahili:nobeli, arabia: نوبليوم  
**noce** *yö* ← espanja:noche, portugali:noite, venäjä:ночь (nočʹ), puola:noc  
**node** *solmu* ← englanti:node, espanja:nudo, portugali:nó, ranska:nœud + vietnami:nút  
**nomi** *hallinto (hallinnointi)* ← englanti:-nomy, deu:ranska:-nomie, espanja:portugali:-nomia, venäjä:-номия (-nomiya), malaiji:-nomi  
**norde** *pohjoinen* ← englanti:north, espanja:portugali:norte, deu:Nord, ranska:nord, venäjä:норд (nord)  
**norma** *normi* ← englanti:espanja:portugali:ranska:deu:normal, venäjä:нормальный (normalʹnyj), persia:نرمال‎ (normâl)  
...
**note** *huomata (hoksata)* ← deu:englanti:ranska:note, espanja:portugali:nota, turkki:not, japani:ノート (nōto), korea:노트 (noteu), persia:(not)  
**nu** *no* ← venäjä:ну (nu) + englanti:now, deu:na, yleiskiina:那 (nà)  
**nude** *alaston (paljas, naku)* ← englanti:nude, espanja:desnudo, portugali:ranska:nu + venäjä:нудизм (nudizm), turkki:nudizm, japani:ヌーディズム (nūdizumu), korea:  
...
**ope** *teos* ← englanti:opus, espanja:portugali:obra, venäjä:опус (opus)  
...
**ordu** *armeija (sotajoukko)* ← mon:ᠣᠷᠳᠤ (ordu), turkki:ordu, arabia: عُرْضِيّ‎ (ʿurḍiyy), persia: اردو (ordu), hindi:उर्दू (urdū) + englanti:ranska:horde, espanja:portugali:horda, venäjä:орда (orda), yleiskiina:斡耳朵 (wò'ěrduǒ), japani:オルド (orudo), korea:오르도 (oreudo)  
...
**orto** *suora* ← englanti:ranska:ortho-, espanja:portugali:orto-, venäjä:орто- (orto-)  
**oselote** ** ← nah:tlālocēlōtl, englanti:ocelot, espanja:portugali:ocelote, venäjä:оцелот (ocelot), turkki:oselo, arabia:أصلوت ('aslut), hindi:ऑसेलॉट (ŏsēlŏṭa), japani:オセロット (oserotto)  
**osidian** ** ← englanti:malaiji:obsidian, espanja:portugali:obsidiana, italia:ossidiana, venäjä:обсидиан (obsidian), suahili:obsidiyen, hindi:ऑब्सिडियन (obsidiyan)  
**oskur** *pimeä (hämärä)* ← englanti:obscure, espanja:oscuro, portugali:escuro, ranska:obscur  
**osmium** *osmium* ← englanti:osmium, ranska:osmium, espanja:osmio, portugali:ósmio, venäjä:осмий, japani:オスミウム, korea:오스뮴, vietnami:osimi, hindi:अस्मियम, bangla:অসমিয়াম, malaiji:osmium, suahili:osmi, arabia: ازميوم  
...
**ote** *suosia (pitää parempana)* ← englanti:opt, ranska:opter, espanja:portugali:optar + venäjä:опция (opciya)  
...
**pa** *isä* ← englanti:ranska:papa, espanja:papá, portugali:pai, venäjä:папа (papa), arabia:(bābā), yleiskiina:爸 (bà), kantoninkiina:爸 (baa1), japani:パパ (papa), korea:아빠 (appa), hindi:बाप (bāp), bangla:বাবা (baba), malaiji:bapa, hausa:suahili:turkki:baba, fulani:ba; baaba  
**pace** *rauha* ← italia:pace, englanti:peace, espanja:portugali:paz, ranska:paix, venäjä:пац- (pac-), malaiji:turkki:pas-  
...
**paka** *pakko* ← yleiskiina:迫 (pò), kantoninkiina:迫 (baak1), wu-kiina:迫 (paq4), japani:迫 (haku), vietnami:bách  
**pake** *pakata* ← englanti:pack, venäjä:пакет (paket), hindi:पैकेट (pækeṭ), deu:turkki:paket, ranska:paquet, espanja:paquete, portugali:pacote, fulani:pakɛt, hausa:fakiti  
**palaba** *pulina (hälinä)* ← englanti:palaver, deu:Palaver, ranska:palabre, krio:plabah, Kongo:palaba  
...
**palma** *palmu* ← deu:Palme, englanti:palm, portugali:espanja:palma, venäjä:пальма (palma), turkki:palmiye, malaiji:palem, thai:ปาล์ม (pām)  
**pan** *kaikki* ← englanti:ranska:espanja:portugali:pan-, venäjä:пан- (pan-) + yleiskiina:泛 (fàn), kantoninkiina:泛 (faan3), japani:汎 (han), korea:범 (beom)  
...
**panka** *siipi* ← hindi:पंखा (paṅkhā) + (fan) burma:ပန်ကာ (panka), persia:(panke), + englanti:punkah, ranska:panka, deu:Pankha  
**pankreas** *haima* ← englanti:ranska:espanja:portugali:pancreas, deu:malaiji:turkki:pankreas  
**pante** *housut* ← englanti:pants, ranska:pantalon, espanja:pantalón, hindi:पैंट (paiṇṭ), bangla:প্যান্ট (pyanṭ), telugu:ప్యాంటు (pyāṇṭu), arabia:بنطلون‎ (banṭalōn), turkki:pantolon + japani:パンツ (pantsu), korea:팬티 (paenti)  
**papagai** *papukaija* ← arabia: بَبَغَاء‎ (babaḡāʾ), turkki:papağan, deu:Papagei, espanja:papagayo, portugali:papagaio, venäjä:попугай (popugay), jin:八哥 (bāgē)  
...
**para** *vieri (oheis-, para-)* ← englanti:ranska:espanja:portugali:para-, persia: پیرا‎ (pīrā-)  
...
**pari** *keiju* ← persia: پری‎ (pari), hindi:परी (parī), bangla:পরী (pôri), malaiji:turkki:peri, hausa:fari, englanti:fairy; peri, ranska:péri, deu:Peri, venäjä:пери (peri)  
...
**parte** *palanen (murunen, riekale, sirpale)* ← englanti:part, portugali:espanja:parte + persia: پارچه (pârče), hindi:पारचा (pārcā), turkki:parça  
**pas** *mennä ohi tai läpi* ← englanti:past, espanja:pasado, portugali:passado, ranska: passé + fulani:pasaas, man:pasaasoo  
**pasporte** *passi* ← englanti:passport, ranska:passeport, espanja:pasaporte, portugali:passaporte, venäjä:паспорт (pasport), hindi:पासपोर्ट (pāsporṭ), bangla:পাসপোর্ট (pasporṭ), malaiji:paspor, suahili:paspoti, japani:パスポート pasupōto), hausa:fasfo  
**pasta** *tahna (tahdas)* ← englanti:deu:paste, venäjä:паста (pasta), espanja:portugali:pasta  
**pata** ** ← englanti:path, deu:Pfad, venäjä:путь (putʹ), hindi:पथ (path), bangla:পথ (pôth), telugu:పథము (pathamu),   
...
**pate** *kärsiä (potea; kärsimys, sairaus)* ← deu:englanti:ranska:patho-, espanja:portugali:puola:turkki:malaiji:pato-, venäjä:пато- (pato-)  
**pau gi** *pyssy* ← yleiskiina:炮 (pâo), kantoninkiina:炮 (paau3), vietnami:pháo, korea:포 (po), mon:буу (buu)  
**pauze** *tauko (keskeytys, paussi)* ← deu:Pause, englanti:deu:ranska:pause, espanja:portugali:pausa, venäjä:пауза (pauza)  
**payace** *pelle (klovni)* ← italia:pagliaccio, ranska:paillassa, espanja:payaso, portugali:palhaço, venäjä:паяц (payac), turkki:palyaço  
...
**pente** *maalata* ← englanti:paint, espanja:portugali:pintura, ranska:peinture, nld:pek, japani:ペンキ (penki), hindi:पेंट (penṭa), fulani:pentur, hausa:fenti  
...
**perde** *pieru* ← bangla:পাদ (pad), hindi:पाद (pād), espanja:pedo, portugali:peido, ranska:pet, venäjä:пердение (perdeniye)  
...
**petra** *kallio (kivi)* ← hindi:पत्थर (patthar), urdu:(patthar), italia:pietra, portugali:pedra, espanja:piedra, ranska:pierre  
**pexe** *kala* ← espanja:pez, portugali:peixe, italia:pesce + englanti:fish, deu:Fisch  
...
**pigu** *pylly (takapuoli, pakarat)* ← filippiini:pigi, yleiskiina:屁股 (pìgu), kantoninkiina:屁股 (pei3 gu2)  
...
**pilau** *pilahvi* ← englanti:ranska:espanja:portugali:pilaf, deu:Pilaw, venäjä:плов (plov), persia: پلو‎ (polou), hindi:पुलाव (pulav), bangla:পোলাও (polao), tamili:புழுக்கு (puḻukku), telugu:పులావ్ (pulāv), arabia: بِيلَاو‎ (bilāw), turkki:pilav, japani:ピラフ (pirafu), korea:필라프 (pillapeu)  
**pilote** *ohjaaja (pilotti, luotsi)* ← englanti:portugali:pilot, espanja:piloto, ranska:pilote, deu:Pilot, venäjä:пило́т (pilót), japani:パイロット (pairotto)  
**pin** *piikki (pistin, neula)* ← englanti:pin, japani:ピン (pin), korea:핀 (pin), hindi:पिन (pin), fulani:pingu, wolof:ping  
...
**pinse gi** *pihdit* ← englanti:pincers, ranska:pinces, turkki:pense, japani:ペンチ (penchi)  
**pipa** *luuttu* ← yleiskiina:琵琶 (pípa), kantoninkiina:琵琶 (pei4 paa4), japani: 琵琶 (biba), korea:비파 (bipa), vietnami:tì bà  
**pipe** *piippu* ← englanti:ranska:pipe, deu:Pfeife, espanja:malaiji:pipa, persia: پیپ‎ (pip), hindi:पाइप (pāip), bangla:পাইপ (paip), japani:パイプ (paipu), vietnami:píp, turkki:pipo, arabia: بِيبَة‎‎ (bība)  
...
**pirate** *kaapata* ← englanti:ranska:pirate, espanja:portugali:pirata, deu:Pirat, venäjä:пират (pirat), japani:パイレーシ  
**pisea** ** ← espanja:portugali:pícea, ranska:Épicéa  
...
**ple** *kerta (kerros, monikerta)* ← englanti:ply, ranska:pli, espanja:plegar + portugali:aplicação  
**plumbe** *lyijy* ← ranska:plomb, espanja:plomo, portugali:chumbo, suahili:plumbi  
**plutonium** *plutonium* ← englanti:plutonium, ranska:plutonium, espanja:plutonio, portugali:plutónio, venäjä:плутоний, yleiskiina:钚 (bù), japani:プルトニウム, korea:플루토늄, vietnami:plutoni, hindi:प्लूटोनियम, bangla:প্লুটোনিয়াম, malaiji:plutonium, suahili:plutoni, arabia: بلوتونيوم  
**poke** *pokeri* ← englanti:ranska:turkki:poker, espanja:portugali:póquer, venäjä:покер (poker), arabia:بُوكَر‎ (būkar), hindi:पोकर (pokar), yleiskiina:扑克 (pūkè), japani:ポーカー (pōkā), korea:포커 (pokeo)  
**pole** *kaupunki* ← englanti:espanja:-polis, deu:ranska:portugali:-pole, venäjä:-поль (-pol'), malaiji:turkki:-pol  
**poli** *paljon (monta)* ← kreikka:πολλοί (polloí), englanti:ranska:deu:poly-, espanja:portugali:poli-, venäjä:поли- (poli-) + tamili:பல (pala)  
**polis** *poliisi* ← englanti:ranska:police, portugali:polícia, espanja:policía, venäjä:полиция (policija), fulani:turkki:malaiji:polis, suahili:polisi, arabia:بُولِيس‎ (būlīs), hindi:पोलिस (polis), bangla:পুলিশ (puliś)  
...
**polskium** *polonium* ← englanti:polonium, ranska:polonium, espanja:polonio, portugali:polónio, venäjä:полоний, yleiskiina:钋 (pō), japani:ポロニウム, korea:폴로늄, vietnami:poloni, hindi:पोलोनियम, bangla:পোলনিয়াম, malaiji:polonium, suahili:poloni, arabia: بولونيوم  
**pompe** *pumppu* ← englanti:pump, espanja:portugali:bomba, ranska:fulani:pompe, deu:Pumpe, venäjä:помпа (pompa), persia: پمپ‎ (pomp), hindi:पंप (pamp), bangla:পাম্প (pamp), telugu:పంపు (pampu), turkki:malaiji:pompa, hausa:famfo, yleiskiina:泵 (bèng), kantoninkiina:泵 (bam1), japani:ポンプ (ponpu), korea:펌프 (peompeu), vietnami:bơm  
**pope** *väestö (rahvas)* ← englanti:people, ranska:peuple, espanja:pueblo, portugali:povo + deu:populär, venäjä:популярный (populyarnïy), malaiji:populer, turkki:popüler  
**pore** *huokonen* ← englanti:ranska:deu:pore, espanja:portugali:poro, venäjä:пора (pora)  
**porei** *purjo* ← deu:Porree, ranska:poireau, espanja:puerro, portugali:porro, venäjä:порей (porey), malaiji:perai + turkki:pırasa  
**porno** *porno* ← englanti:porn, espanja:turkki:malaiji:porno, portugali:pornô, deu:Pornografie, venäjä:порно (porno), japani:ポルノ (poruno)  
...
**porto** *asema (satama, lentokenttä)* ← englanti:port, ranska:porte, espanja:puerto, portugali:porto, venäjä:порт (port), hindi:पोर्ट (porṭ), urdu:(porṭ), bangla:পোর্ট (porṭ), thai:พอร์ต (phot)  
**pos** *seuraus* ← englanti:ranska:post-, espanja:pos, portugali:pós-, venäjä:после- (posle-) + persia: پس (pas)  
**poste** *posti (postilähetys)* ← englanti:post, portugali:postagem, ranska:poste, venäjä:почта (pochta), turkki:posta, arabia:بوسطة‎ (busṭa), suahili:posta, malaiji:pos, persia:پست‎ (post)  
**pote** *pata* ← englanti:ranska:pot, espanja:portugali:pote, malaiji:poci, japani:ポット (potto), korea:포트 (poteu), fulani:pooti; fotiire  
**poto** *muta (kura, lieju)* ← pcm:Kongo:lingala:poto-poto  
**poze** *panna (asettaa; asetelma)* ← englanti:espanja:portugali:ranska:pose, deu:Pose, venäjä:поза (poza), japani:ポーズ (pōzu)  
...
**prazedimium** *praseodyymi* ← englanti:praseodymium, ranska:praséodyme, espanja:praseodimio, portugali:praseodímio, venäjä:празеодим, japani:プラセオジム, korea:프라세오디뮴, vietnami:prazeođim, hindi:प्रासियोडाइमियम, bangla:প্র্যাসেওডিমিয়াম, malaiji:praseodinium, suahili:praseodimi, arabia: براسوديميوم  
**pre** *ennen (aikaisemmin, aiemmin; aikaisempi, edellinen)* ← englanti:ranska:espanja:portugali:pre-, hindi:प्र- (pra-), bangla:প্র- (prô-), malaiji:pra-  
**prese** *puristaaa (puristus, paine)* ← ranska:pression, espanja:presión, portugali:pressão, venäjä:пресс (press), japani:プレス (puresu)  
**presidente** *presidentti* ← englanti:president, deu:Präsident, ranska:président, espanja:portugali:presidente, venäjä:президент (prezident), persia: پرزیدنت‎ (perezident), malaiji:presiden  
...
**pro** *kohti (päin)* ← deu:englanti:ranska:espanja:portugali:pro-, hindi:प्र- (pra-), bangla:প্র- (prô-), malaiji:pro-; pra-  
...
**prote** ** ← deu:englanti:ranska:espanja:portugali:malaiji:turkki:proto-, venäjä:прото- (proto-)  
**proxe** *läheinen* ← englanti:proximal, ranska:proche, espanja:portugali:próximo  
**puding** *vanukas* ← englanti:ranska:deu:pudding, espanja:pudín, portugali:pudim, venäjä:пудинг (puding), turkki:malaiji:puding, suahili:pudini, arabia:بودنغ (budingh), yleiskiina:布丁 (bùdīng), japani:プディング (pudingu), korea:푸딩 (puding)  
**puje** *palvonta* ← hindi:पूजा (pūjā), urdu: پوجا‎ (pūjā), tamili:பூசை (pūcai), telugu:పూజ (pūja), malaiji:puja, thai:บูชา (bucha)  
**pul** *täysi* ← hindi:पूर्ण (pūrn), bangla:পূর্ণ (pūrṇa), pandzabi:ਪੂਰਾ (pūrā), persia:(por), espanja:pleno, ranska:plein, englanti:full, venäjä:полный (polnyj), puola:pełny  
**pulmon** *keuhko* ← espanja:pulmón, ranska:poumon, portugali:pulmão, englanti:pulmonic  
**pulse** *työntää (puskea)* ← englanti:push; pulse, ranska:pousser + espanja:portugali:impulso, venäjä:импульс (impul's)  
**puma** ** ← englanti:espanja:ranska:portugali:suahili:malaiji:turkki:puma, venäjä:пума (puma), japani:ピューマ (pyūma), hindi:पूमा (pooma), pan:ਪੂਮਾ (pūmā), marathi:प्युमा (pyumā)  
**punte** *piste (täplä)* ← englanti:point, deu:Punkt, espanja:punto, venäjä:пункт (punkt)  
...
**pute** *käsitellä tietoja (laskelmoida)* ← englanti:put + espanja:computadora, portugali:computador, venäjä:компьютер (komp’uter), arabia:كَمْبْيُوتَر‎ (kambyūtar), suahili:kompyuta, hindi:कंप्यूटर (kampyūṭar), bangla:কম্পিউটার (kômpiuṭar), malaiji:komputer, japani:コンピューター (konpyūtā)  
**pute** *mätä* ← englanti:putrid, espanja:portugali:podre, ranska:putride + yleiskiina:腐 (fǔ), japani:腐 (fu) + thai:ผุ (phu)  
**putong** *yleinen (universaali)* ← yleiskiina:普通 (pǔtōng), kantoninkiina:普通 (pou2tung1), vietnami:phổ thông, korea:보통 (botong)  
**rade** *säde* ← englanti:ranska:radiation, espanja:radiación, portugali:radiação, malaiji:radiasi, venäjä:радио (radio), turkki:radyo, suahili:redio, hindi:रेडियो (reḍiyo), bangla:রেডিও (reḍio), japani:ラジオ (rajio), korea:라디오 (radio)  
**radio** ** ← deu:englanti:ranska:espanja:portugali:radio, venäjä:радио (radio), fulani:turkki:radyo, suahili:redio, hausa:rediyo, hindi:रेडियो (reḍiyo), bangla:রেডিও (reḍio), japani:ラジオ (rajio), korea:라디오 (radio)  
**radium** *radium* ← englanti:radium, ranska:radium, espanja:radio, portugali:rádio, venäjä:радий, yleiskiina:镭 (léi), japani:ラジウム, korea:라듐, vietnami:rađi, hindi:रेडियम, bangla:রেডিয়াম, malaiji:radium, suahili:radi, arabia: راديوم  
...
**rande** *höylä* ← persia: رنده‎ (rande), hindi:रंदा, (randā), turkki:rende, suahili:randa  
**rang** *väri* ← bangla:রং (rông), hindi:रंग (raṅg), urdu:(raṅg), persia:(rang), telugu:రంగు (raṅgu), suahili:rangi, lingala:lángi, turkki:renk  
**rase** *rotu* ← englanti:ranska:race, espanja:raza, portugali:raça, venäjä:раса (rasa), malaiji:ras  
**rate** *järkeillä (käydä järkeen)* ← lat:ratio, englanti:rational, ranska:rationnel, espanja:portugali:racional + deu:Rat, venäjä:рада (rada), puola:rada  
...
**reger** *monarkki (kuningas, kuningatar)* ← hindi:राजा (rājā), রাজা (raja), malaiji:raja, telugu:రాజు (rāju) + englanti:rajah, espanja:portugali:rajá, venäjä:раджа  
...
**reporte** *raportti (selostus, selonteko)* ← englanti:report, espanja:reporte, ranska:rapport, venäjä:рапорт (raport), turkki:rapor, suahili:ripoti, hindi:रिपोर्ट (riporṭ), japani:レポート (repōto), hausa:rahoto  
**reseta** *resepti (ohje)* ← italia:ricetta, venäjä:рецепт (retsept), deu:Rezept, espanja:receta, portugali:receita, ranska:recette, malaiji:resep, turkki:reçete  
**reside** *kuitti (kuittaus)* ← persia: رسید‎ (resid), hindi:रसीद (rasīd), bangla:রসিদ (rôśid), tamili:ரசீது (racītu), telugu:రసీదు (rasīdu) + englanti:receipt, japani:レシート (reshīto), malaiji:resit, suahili:resiti, yoruba:rìsíìtì  
...
**rime** *säe (riimi)* ← espanja:portugali:rima, ranska:rime, englanti:rhyme, puola:rym, deu:Reim  
...
**rite** *tapa (keino, menetelmä, menettely, metodi)* ← hindi:रीति (rīti), bangla:রীতি (rīti) + englanti:ranska:rite, espanja:portugali:rito, venäjä:ритуал (ritual), malaiji:ritus  
...
**rivo** *joki (virta)* ← espanja:portugali:rio, englanti:river, ranska:rivière  
...
**rode** *ruusu* ← kreikka:ῥόδον (rhódon), ranska:englanti:rose, espanja:portugali:rosa, venäjä:роза (roza), malaiji:ros, filippiini:rosas + arabia: وَرْد‎ (ward), suahili:waridi  
...
**rupe** *ilmiasu (hahmo, ulkomuoto, ulkonäkö)* ← hindi:रूप (rūp), urdu: روپ‎ (rūp), bangla:রূপ (rup), tamili:ரூபம் (rūpam), malaiji: rupa, thai: รูป (rūp), khmer:រូប (rūp)  
**rute** *polku (reitti, kurssi)* ← englanti:ranska:route, espanja:ruta, portugali:rota, deu:Route, japani:ルート (rūto), venäjä:маршрут (maršrut); рутина (rutina) + persia:روتین‎ (rutin)  
...
**sabun** *saippua* ← ranska:savon, espanja:jabón, portugali:sabão, arabia: صَابُون‎ (ṣābūn), persia: صابون‎ (sâbun), hindi:साबुन (sābun), bangla:সাবান (śaban), telugu:సబ్బు (sabbu), malaiji:turkki:sabun, suahili:sabuni, fulani:saabunde, hausa:sabulu, japani:シャボン (shabon), vietnami:xà bông  
**sade** *pelkkä (koruton, tavanomainen, vain)* ← turkki:sade, persia:(sāde), hindi:सादा (sādā), bangla:সাদা (śada), arabia: سَاذَج (sāḏaj)  
**safar** *matkustaa (matka, reissu)* ← arabia:(safar), hindi:सफ़र (safar), turkki:sefer, suahili:safari, hausa:safara, englanti:ranska:espanja:portugali:deu:malaiji:safari  
...
**sahi** *oikea (paikkansapitävä)* ← arabia: صَحِيح‎ (ṣaḥīḥ), persia: صحیح‎ (sahih), hindi:सही (sahī), malaiji:sah, hausa:suahili:sahihi  
**saide** *pyynti (metsästys, kalastus)* ← arabia:(ṣayd), turkki:seyd, urdu:صید‎ (said), persia:صید‎ (seyd), heb:ציד‎ (tsayid)  
**sake** *pussi (säkki, kassi, laukku)* ← deu:englanti:sack, ranska:sac, espanja:portugali:saco, malaiji:Kongo:saku, fulani:saakuuru  
**sal** *terve (hei)* ← arabia:persia: سلام‎ (salâm), hindi:सलाम (salām), bangla: সালাম (salam), malaiji:selamat, suahili:salamu, fulani:salaam, hausa:salam, turkki:selam + englanti:salute, ranska:salut, espanja:salude, portugali:saúde + korea:잘 (jal)  
...
**salade** *salaatti* ← ranska:salade, malaiji:salad, deu:Salat, venäjä:салат (salat), turkki:salata, persia:urdu:(salād), hindi:सलाद (salād), kantoninkiina:沙律 (saa1 leot62),  yleiskiina:沙拉 (shālā), portugali:salada, espanja:ensalado, korea:샐러드 (saelleodeu), japani:サラダ (sarada), thai:สลัด (salat), fulani:salati  
...
**sama** *taivas* ← arabia: سَمَاء‎ (samāʾ), suahili:samawati, amhara:ሰማይ (sämay), hausa:sama, yoruba:sanma, turkki:sema, oromo:samii + fulani:asamaan, hindi:आसमान (āsmān), bangla:আসমান (aśman)  
...
**sanzi** *viuhka (tuuletin)* ← yleiskiina:扇子 (shànzi), kantoninkiina:扇子 (sin3zi2), japani:扇子 (sensu), korea:선 (seon), mon:шанз (šanz)  
**sari** *sari* ← englanti:deu:ranska:espanja:portugali:malaiji:sari, venäjä:сари (sari), hindi:साड़ी (sāṛī), bangla:শাড়ি (śaṛi), yleiskiina:莎丽 (shālì), japani:サリー (sarī), korea:사리 (sari), arabia: سَارِي‎ (sārī), persia: ساری‎ (sâri)  
**sau** *sisarus (veli tai sisko)* ← hindi:सहोदर (sahodar), bangla:সহোদর (śôhodôr), tamili:சகோதரன் (sahōdaraṉ), malaiji:saudara  
...
**saur** *lisko* ← kreikka:σαύρα (saura), englanti:-saur, ranska:-saure, espanja:-saurio, portugali:-sauro, venäjä:-завр (-zavr), hindi:bangla: malaiji:-saur(us) + hin:सरट (saraṭ)  
**saye** *varjo* ← persia: سایه‎ (sāye), hindi:साया (sāyā); छाया (chāyā), bangla:ছায়া (chaya), turkki:saye, thai:ฉายา (chāyā), burma:ဆာယာ (sʰaya)  
**seku** *kivi (hippu)* ← yleiskiina: 石 (shí), kantoninkiina:石 (sek3), japani:石 (seki), korea:석 (seok)  
...
**sekur** *turvallinen (varma)* ← englanti:secure, deu:sicher, espanja:portugali:seguro  
**sel** *neuvo* ← arabia: صَلَاح‎ (ṣalāḥ), hindi:सलाह (salāh), telugu:సలహా (salahā), turkki:salık + englanti:counsel, ranska:conseil, espanja:consejo, portugali:conselho  
**selenium** *seleeni* ← englanti:selenium, ranska:sélénium, espanja:selenio, portugali:selénio, venäjä:селен, yleiskiina:硒 (xī), japani:セレン, korea:셀렌, vietnami:selen, hindi:सेलेनियम, bangla:সেলেনিয়াম, malaiji:selenium, suahili:seleni, arabia: سيلينيوم  
...
**semente** *sementti* ← englanti:cement, malaiji:semen, espanja:cemento, suahili:sementi, hausa:siminti, fulani:siment, turkki:çimento, vietnami:xi măng, hindi:सीमेंट (siment), venäjä:цемент (tsement), arabia:(ʾasmant), korea:시멘트 (simenteu)  
...
**serve** *palvelu (palvelus)* ← englanti:ranska:service, portugali:serviço, venäjä:сервис (servis), turkki:servis + hindi:सेवा (sevâ), bangla:সেবা  (seba)  
**sesam** *seesami* ← englanti:sesame, venäjä:сезам (sezam), espanja:sésamo, arabia:(simsim), suahili:simsim, turkki:susam  
**sexu** *seksi (sukupuolisuhde)* ← englanti:sex, ranska:sexe, espanja:portugali:sexo, venäjä:секс (seks), turkki:seks, hindi:सेक्स (seks), japani:セックス (sekkusu), korea:섹스 (sekseu)  
**si** *jos (olettaa)* ← ranska:espanja:si, portugali:se, turkki:ise, yleiskiina:使 (shǐ); 要是 (yàoshǐ), kantoninkiina:使 (si2); 要是 (jiu3si6), fulani:si; se  
...
**sifa** *laatu (ominaisuus, ominaispiirre, määrite)* ← arabia:صفة (ṣifa), persia:صفت (sefat), hindi:सिफ़त (sifat), fulani:siifa, suahili:hausa:sifa, turkki:sıfat, malaiji:sifat  
**sigare** *sikari* ← englanti:ranska:cigarette, espanja:cigarillo, portugali:cigarro, venäjä:сигарета (sigarteta), arabia:(sījāra), yleiskiina:雪茄 (xǔejiā), wu-kiina:雪茄 (xi'gá), hindi:सिगरेट (sigreṭ), bangla:সিগারেট (śigareṭ), suahili:turkki:sigara, hausa:sigari, fulani:sigaari, amhara:ሲጃራ (siǧara)  
...
**sine** *merkki (signaali)* ← englanti:sign, espanja:señal, portugali:sinal, ranska:signe  
**sine** *rinta* ← persia: سینه‎ (sine) turkki:sine, hindi:सीना (sīnā), bangla:সিনা (sinā), espanja:seno, ranska:sein, latina:sinus  
...
**sir** *salainen* ← arabia: سِرّ (sirr), hindi:सेर (ser), malaiji:sir, suahili:siri, hausa:asiri, fulani:sirri, yoruba:àṣírí, turkki:sır, persia:(serr)  
**sirke** *ympyrä (piiri)* ← englanti:circle, ranska:cercle, espanja:portugali:círculo + deu:Zirkus, venäjä:цирк (cirk), persia: سیرک‎ (sirk), hindi:सर्कस (sarkas), bangla:সার্কাস (sarkas), arabia: سِيرْك‎ (sirk), japani:サーカス (sākasu), korea:서커스 (seokeoseu), vietnami:xiếc, malaiji:sirkus, turkki:sirk  
...
**sis** *sihistä (sähistä)* ← englanti:hiss, deu:zischen, espanja:sisear, yleiskiina:咝 (sī), kantoninkiina:噝 (si1)  
...
**site** *lainata (siteerata)* ← englanti:cite, espanja:portugali:citar, ranska:citer, deu:zitieren, venäjä:цитировать (citirovat’)  
**sivil** *sivistynyt* ← englanti:civil, portugali:civil, hindi:सिविल (sivil), malaiji:sipil  
**skandium** *skandium* ← englanti:scandium, ranska:scandium, espanja:escandio, portugali:escândio, venäjä:скандий, yleiskiina:钪 (kàng), japani:スカンジウム, korea:스칸듐, vietnami:scandi, hindi:स्काण्डियम, bangla:স্ক্যান্ডিয়াম, malaiji:skandium, suahili:skandi, arabia: سكانديوم  
...
**skuter** ** ← englanti:ranska:espanja:scooter, venäjä:скутер (skuter), yleiskiina:速克达 (sùkèdá), japani:スクーター (sukūtā), korea:스쿠터 (seukuteo), hindi:स्कूटर (skūṭar), bangla:স্কুটার (śkuṭar), malaiji:skuter  
**sofa** *sohva* ← englanti:ranska:sofa, espanja:portugali:sofá, venäjä:софа (sofa), yleiskiina:沙发 (shāfā), kantoninkiina:梳化 (so1faa32), japani:ソファ (sofa), korea:소파 (sopa), hindi:सोफ़ा (sofā)  
...
**soki** ** ← yleiskiina:搜 (sōu), kantoninkiina:搜 (sau1), wu-kiina:搜 (seu1), japani:捜索 (sōsaku) + englanti:seek, deu:suchen + venäjä:искать (iskat’)  
**sol** *aurinko* ← espanja:portugali:sol, ranska:soleil, + hindi:सौर (sOr), telugu:(saur)  
**son** *poika* ← englanti:son, deu:Sohn, venäjä:сын (syn), sanskriitti:सूनु (sūnu)  
...
**songi** *mänty* ← yleiskiina:松 (sōng), wu-kiina:(son), thai:สน (sǒn), korea:솔 (sol), vietnami:thông, + venäjä:сосна (sosna)  
...
**sorbe** *ryystää (hörpätä, ryypätä)* ← espanja:sorber, portugali:sorver, venäjä:сёрбать (syorbatʹ), englanti:absorb, ranska:absorber  
**sos** *kastike (soosi)* ← englanti:ranska:sauce, deu:Soße, venäjä:соус (sous), persia: سس‎ (sos), hindi:सॉस (sos), bangla:সস (śôś), japani:ソース (sōsu), korea:소스 (soseu), vietnami:xốt, malaiji:saus, turkki:sos  
**sosia** *seura* ← venäjä:социум (socium), englanti:society, ranska:société, espanja:sociedad, portugali:sociedade, deu:sozial, malaiji:sosial  
...
**stan** *alue (seutu)* ← hindi:स्थान (sthān), venäjä:стан (stan), persia:ـستان (-estān)  
**state** *seistä (seisoa)* ← englanti:stand; static, deu:stehen; statisch, ranska:statique, espanja:portugali:estático, venäjä:стоять (stoyat'); статический (statičeskiy), malaiji:statis, turkki:istasyon, hindi:स्टेशन (sṭeśan), bangla:স্টেশন (śṭeśôn)  
**stude** *opiskella (tutkia)* ← englanti:study, ranska:étudier, espanja:estudiar, portugali:estudar, venäjä:студент (student), hindi:स्टूडेंट (sṭūḍeṇṭ)  
**su** *-n (oma)* ← englanti:’s, deu:ned:-s, afr:se + ranska:son;sa, espanja:su, portugali:seu  
**sual** *kysymys* ← arabia: سؤال (su'āl), persia: سؤال‎ (so'âl), hindi:सवाल (savāl), bangla:সওয়াল (śôwal), malaiji:soal, suahili:swali, turkki:sual + khmer:សួរ (suə)  
**suan** *hapan (kirpeä)* ← yleiskiina:酸 (suān), kantoninkiina:酸 (syun1), wu-kiina:酸 (soe1), japani:酸 (san), korea:산 (san), vietnami:toan  
**suba** *aamu* ← arabia:(ṣabāḥ), turkki:sabah, persia:(sobh), urdu:(subah), hindi:सुबह (subah), suahili:asubuhi, hausa:asuba, fulani:subaka  
**sude** *etelä* ← deu:Süden, ranska:sud, espanja:sur, portugali:sul, englanti:south, venäjä:зюйд (zyuyd)  
**sueda** *hiki* ← englanti:sweat, espanja:sudor, portugali:suor, ranska:sueur, hindi:स्वेद (sveda), telugu:స్వేదం (svēdaṃ)  
**suga** *nopea (pikainen, vauhdikas)* ← yleiskiina:速 (sù), kantoninkiina:速 (cuk4), japani:速 (soku), korea:속 (sok), vietnami:tốc + hindi:शीघ्र (śīghra) + arabia: سُرْعَة‎ (surʿa)  
**sui kaboga** ** ← portugali:abóbora-d'água, turkki:su kabağı  
**sui** *vesi* ← yleiskiina:水 (shuǐ), kantoninkiina:水 (seoi2), japani:水 (sui), korea:수 (su), vietnami:thuỷ + turkki:su  
**sukar** *sokeri* ← englanti:sugar, ranska:sucre, espanja:azúcar, portugali:açúcar, arabia: سُكَّر (sukkar), hindi:शक्कर (śakkar), bangla:শর্করা (śôrkôra), malaiji:sakar, hausa:suahili:sukari, fulani:sukar, turkki:şeker, tamili:சக்கரை (cakkarai)  
**suke** *tykätä (pitää, olla tyytyväinen jstkn; tyytyväinen, iloinen)* ← hindi:सुख (sukha), bangla:সুখ (śukh), telugu:సుఖము (sukhamu), malaiji:suka, thai:สุข (suk), khmer:សុខ (sok), nan:舒合 (su-kah) + japani:好く (suku)  
**sulfe** *rikki* ← englanti:sulfur, ranska:soufre, espanja:azufre, portugali:enxofre, suahili:sulfuri  
**sultaner** ** ← arabia:سلطة (sulṭa), englanti:turkki:malaiji:sultan, espanja:sultán, venäjä: султан (sultan), persia:سلطان‎ (soltân), hindi:सुल्तान (sultān), bangla:সুলতান (śultan), suahili:sultani  
**sum** *summa* ← englanti:sum, espanja:suma, portugali:soma, ranska:somme, deu:Summe, venäjä:сумма (summa)  
**suna** *tapa (perinne)* ← arabia: سُنَّة (sunna), hindi:सुन्नत (sunnat), bangla:সুন্নাহ (śunnah), suahili:suna + englanti:malaiji:sunnah, ranska:espanja:sunna, portugali:suna, venäjä:сунна, turkki:sünnet  
...
**susan** *lilja* ← arabia: سَوْسَن‎ (sawsan), espanja:azucena + englanti:Susan, portugali:Susana, ranska:Suzanne, puola:Zuzana, venäjä:Сусанна (Susanna)  
**sute** *taito* ← yleiskiina:术 (shù), kantoninkiina:術 (seot6), japani:術 (jutsu), korea:술 (sul)  
**sutur** *sauma (ommel)* ← ranska:englanti:suture, portugali:espanja:sutura  
**suxi** *sushi* ← japani:寿司 (sushi), yleiskiina:寿司 (shòusī), kantoninkiina:壽司 (sau6si1), korea:스시 (seusi), deu:englanti:ranska:espanja:portugali:sushi, venäjä:суши (sushi), persia: سوشی‎ (suši), hindi:सुशी (suśī), bangla:সুশি (śuśi), turkki:suşi, arabia: سُوشِي‎ (sūšī)  
...
**tabe** *luonto (luonteenpiirre)* ← arabia:طبيعة (ṭabīʿa), persia:طبیعت‎ (tabi'at), hindi:तबीयत (tabīyat), bangla:তবিয়ত (tôbiyôt), suahili:tabia, fulani:dabia, hausa:tsabi'a, turkki:tabiat  
**table** *laatta (levy)* ← englanti:table, ranska:tableau, espanja:tabla, venäjä:табличка (tablichka), malaiji:tabel, turkki:tablo, fulani:wolof:taabal  
...
**tala** *lukko* ← hindi:ताला (tālā), bangla:তালা (tala), telugu:తాళము (tāḷamu)  
**talium** *tallium* ← englanti:thallium, ranska:thallium, espanja:talio, portugali:tálio, venäjä:таллий, yleiskiina:铊 (tā), japani:タリウム, korea:탈륨, vietnami:tali, hindi:थैलियम, bangla:থ্যালিয়াম, malaiji:tallium, suahili:tali, arabia: ثاليوم  
...
**tanke** *tankki (säiliö)* ← englanti:tank, deu:Tank, espanja:tanque, hindi:टंकी (ṭaṅkī), malaiji:tangki, suahili:tangi, japani:タンク (tanku), korea:탱크 (taengkeu), vietnami:tăng  
**tantalium** *tantaali* ← englanti:tantalum, ranska:tantale, espanja:tántalo, portugali:tântalo, venäjä:тантал, yleiskiina:钽 (tǎn), japani:タンタル, korea:탄탈, vietnami:tantali, hindi:टाण्टलम, bangla:ট্যান্টালাম, malaiji:tantalum, suahili:tantali, arabia: تنتالم  
**tanur** *uuni* ← persia:heb:tanur, arabia:(tannūr), englanti:tandoor, athanor, turkki:tandır, hindi:तनूर (tanūr), urdu:(tanūr), pandzabi:ਤੰਦੂਰ (tandūr), suahili:tanuri, hausa:tanda  
**tape** *tulppa (tappi, korkki)* ← englanti:tap, deu:Zapfen, espanja:turkki:tapa, portugali:tampa, kreikka:τάπα (tapa), bul:тапа (tapa)  
...
**tasa** *astia (kulho)* ← arabia: طَاس (ṭās), hausa:taasaa, suahili:tasa, fulani:taasal, turkki:tas, ranska:tasse, espanja:taza, venäjä:таз, hindi:तश्तरी (tashtarī)  
**tatu** *tatuointi* ← sam:tah:tatau, haw:kākau, malaiji:filippiini:tato, englanti:tattoo, ranska:tatouage, espanja:tatuaje, portugali:tatuagem, venäjä:тату (tatu)  
**tava** *pannu (paistinpannu)* ← persia: تاوه‎ (tâve), hindi:तवा (tavā), arabia: طاوة‎ (ṭāwa), turkki:scr:tava  
**taxe** ** ← englanti:deu:espanja:taxo-, ranska:portugali:taxi-, venäjä:-таксис (-taksis), persia: تاکتیک‎ (tâktik), malaiji:taktik  
...
**taza** *tuore (raikas)* ← persia: تازه (tâze), hindi:ताज़ा (tāzā), bangla:তাজা (taja), turkki:taze, arabia: طَازَج (ṭāzaj)  
...
**tela** *kangas* ← espanja:portugali:filippiini:tela, ranska:toile + englanti:towel, hindi:तौलिया (tauliyā), tamili:துவாலை (tuvālai), suahili:taulo, hausa:tawul, japani:タオル (taoru), malaiji:tuala  
**tele** *kaukainen* ← englanti:espanja:portugali:malaiji:tele-, ranska:télé-, venäjä:теле- (tele-)  
...
**tene** *pitää (pitää kiinni, pitää hallussa)* ← ranska:tener, espanja:tenir, portugali:ter, englanti:-tain  
**tenesium** *tennessine* ← englanti:ranska:portugali:malaiji:tennessine, espanja:teneso, venäjä:теннессин, japani:テネシン, korea:우눈셉튬  
**tense** *kireä (tiukka, jännittynyt)* ← englanti:tense, ranska:tendu, espanja:portugali:tenso  
**tenta** *houkutella* ← englanti:tempt, espanja:portugali:tentar, ranska:tenter  
**teori** *teoria* ← englanti:theory, espanja:teoría, portugali:teoria, ranska:téorie, venäjä:теория (teoriya), persia:تئوری‎ (teori), malaiji:teori  
**tera** *biljoona (tera-)* ← englanti:ranska:espanja:portugali:malaiji:turkki:tera-, venäjä:тера- (tera-), japani:テラ (tera), korea:테라- (tera-)  
**terbium** *terbium* ← englanti:terbium, ranska:terbium, espanja:terbio, portugali:térbio, venäjä:тербий, yleiskiina:铽 (tè), japani:テルビウム, korea:테르븀, 2터븀, vietnami:tecbi, hindi:टर्बियम, bangla:টার্বিয়াম, malaiji:terbium, suahili:taribi, arabia: تربيوم  
**terca** *vino* ← espanja:torcido, portugali:torto, hindi:तिरछा (tirachha), bangla:তেরছা (tērachā), pan:तिरकस (tirakasa)  
**tere** *pelko (kauhu, terrori)* ← englanti:espanja:portugali:terror, ranska:terreur + venäjä:терроризм (terrorizm), japani:テロリズム (terorizumu), korea:테러리즘 (tereorijeum), malaiji:terorisme  
**terme** *lämpötila* ← deu:englanti:ranska:thermo-, espanja:portugali:termo-, venäjä:термо- (termo-)  
**teste** *koettaa (haastaa, koetella, testata; koe, testi)* ← deu:englanti:ranska:turkki:test, portugali:teste, venäjä:тест (test), persia: تست‎ (test), japani:テスト (tesuto), korea:테스트 (teseuteu)  
**teza** *kiihkeä (väkevä, voimakas, vahva, kova)* ← hindi:तेज़ (tez), urdu:(tez), persia:(tiz)  
**teze** *väite (teesi)* ← englanti:thesis, ranska:thèse, espanja:tesis, portugali:tese, venäjä:тезис (tezis), persia: تز‎ (tez), turkki:tez, japani:テーゼ (tēze), korea:테제 (teje)  
...
**tole** *sietää (kestää, sallia)* ← englanti:tolerate, espanja:portugali:tolerar, ranska:tolérer, deu:tolerieren, sve:tåla, dan:nor:tåle  
...
**ton** *sävel (sävy)* ← englanti:tone, deu:Ton, ranska:ton, espanja:tono, portugali:tom, venäjä:тон (ton), hindi:तान (tān), suahili:kitone  
...
**tope** *seutu (maa, alue)* ← englanti:ranska:espanja:portugali:turkki:malayalam:topo-, venäjä:топо- (topo-)  
**tore** *torni* ← englanti:tower, ranska:tour, espanja:portugali:torre, deu:Turm, hindi:टावर (ṭāvar) + japani:塔 (tō), yleiskiina:塔 (tǎ)  
...
**torso** *vartalo (varsi, torso)* ← ranska:torse, venäjä:торс (tors), deu:englanti:espanja:malaiji:torso  
**tortuga** *kilpikonna* ← englanti:tortoise, espanja:tortuga, portugali:tartaruga, ranska:tortue  
**toxe** *myrkky* ← englanti:toxic, ranska:toxique, espanja:portugali:tóxico, venäjä:токсичний (toksicniy), malaiji:toksik + yleiskiina:毒 (dú), kantoninkiina:毒 (duk6), wu-kiina:毒 (do’), japani:毒 (doku/toku), korea:독 (dok), vietnami:độc  
**tra** *läpi* ← italia:tra, englanti:through, espanja:tras, portugali:(a)trás, ranska:deu:malaiji:trans-, venäjä:транс- (trans-)  
**tragike** *murheellinen (traaginen)* ← englanti:tragic, ranska:tragique, espanja:portugali:trágico, venäjä:трагический (tragičeskij)  
**trate** *vetää (kiskoa, raahata)* ← espanja:traer + englanti:tractor, ranska:tracteur, portugali:trator, venäjä:трактор (traktor), arabia: تَرَاكْتُور‎ (tarāktūr), japani:トラクター (torakutā), korea:트랙타 (teuraekta), hindi:ट्रैक्टर (ṭraikṭar), bangla:ট্র্যাক্টর (ṭrækṭôr), malaiji:traktor, suahili:trekta, turkki:traktör  
**trati** *sopimus* ← englanti:treaty, ranska:traité, espanja:portugali:tratado, venäjä:контракт (kontrakt), turkki:kontrat, malaiji:kontrak  
**tren** *juna* ← englanti:ranska:train, espanja:turkki:tren, portugali:trem, persia: ترن‎ (tran), hindi:ट्रेन (ṭren), bangla:ট্রেন (ṭren), suahili:treni  
**trepe** *portaat (rappuset, tikkaat)* ← deu:Treppe, ned:trap, venäjä:трап (trap), malaiji:terap, japani:タラップ (tarappu) + espanja:portugali:trepar  
**tri** *kolme (3)* ← englanti:three, ranska:trois, espanja:tres, portugali:três, venäjä:три (tri), hindi:त्रि-  (tri-), bangla:ত্রি- (tri-), malaiji:tri-  
...
**tu** *sinä* ← deu:du, ranska:portugali:tu, espanja:tú, venäjä:ты (ty), persia: تو‎ (to), hindi:तू (tū), bangla:তুই (tui)  
...
**tube** *putki (johto, tuubi)* ← espanja:portugali:tubo, englanti:ranska:tube, japani:チューブ (chūbu), zulu:ithumbu, xho:íthumbu  
...
**tuh** *sylkeä* ← hindi: थूकना (thūknā), yleiskiina: 吐 (tǔ), turkki:tükürmek, fulani:tuutde  
...
**tulpan** *tulppaani* ← englanti:malaiji:tulip, ranska:tulipe, deu:Tulpe, espanja:tulipá, portugali:túlipa, nld:tulp, venäjä:тюльпан (t’ul’pan), arabia:توليب (tūlīb), hindi:ट्यूलिप (ṭyūlip), may:tulip, japani:チューリップ (chūrippu), korea:튤립 (tyullip)  
...
**tung** *tungpuu* ← yleiskiina:油桐 (yóutóng), kantoninkiina:油桐 (yau4tung4), englanti:tung tree, ranska:tung, portugali:tungue, venäjä:тунг  
**tupi** *lakki (hattu)* ← malaiji:topi, hindi: टोपी (ṭopī), bangla:টুপি (ṭupi), tamili:தொப்பி (toppi)  
**tur** *reissu (retki)* ← englanti:deu:espanja:tour, ranska:tournée, portugali:turnê, venäjä:турне (turne), malaiji:tur, japani:ツアー (tsuā), korea:투어 (tueo), yleiskiina:旅途 (lǚtú)  
...
**umur** *ikä* ← arabia: عُمُر‎ (ʿumur), persia: عمر (omr), hindi:उमर (umar), bangla:ওমর (omôr), suahili:umri, malaiji:umur, turkki:ömür  
**un** *yksi (1)* ← ranska:un, espanja:uno, portugali:um,una, englanti:one  
**unabe** *jujube* ← arabia: عُنَّاب‎ (ʕunnāb), persia: عناب‎ ('annâb), venäjä:унаби (unabi), turkki:hünnap  
**uranium** *uraani* ← englanti:uranium, ranska:uranium, espanja:uranio, portugali:urânio, venäjä:уран, japani:ウラン, korea:우라늄, vietnami:urani (uran), hindi:युरेनियम, bangla:ইউরেনিয়াম, malaiji:uranium, suahili:urani, arabia: يورانيوم  
**uze** *käyttää* ← englanti:use, ranska:user, espanja:portugali:usar, puola:używać  
**va** *oho (vau)* ← englanti:wow, ranska:ouah, yleiskiina:哇 (wā), kantoninkiina:嘩 (waa1), japani:わあ (wā), korea:와 (wa), hindi:वाह (vāh), malaiji:wah, fulani:wai  
**vaf** *koira* ← englanti:woof, ranska:ouaf, venäjä:гав (gav), turkki:hav, yleiskiina:汪 (wāng), japani:ワン (wan)  
**vafle** *vohveli* ← englanti:waffle, deu:Waffel, venäjä:вафля (vaflya), yleiskiina:窝夫 (wōfū), kantoninkiina:華夫 (waa4fu1), japani:ワッフル (waffuru), korea:와플 (wapeul)  
...
**valve** *hana (venttiili, kraana)* ← englanti:ranska:valve, espanja:portugali:válvula, hindi:वाल्व (vālv), japani:バルブ (barubu), korea:밸브 (baelbeu), kantoninkiina:嘩佬 (waa1 lou2), suahili:valvu, turkki:valf  
...
**vanadium** *vanadiini* ← englanti:vanadium, ranska:vanadium, espanja:vanadio, portugali:vanádio, venäjä:ванадий, yleiskiina:钒 (fán), japani:バナジウム, korea:바나듐, vietnami:vanađi, hindi:वनेडियम, bangla:ভ্যানাডিয়াম, malaiji:vanadium, suahili:vanadi, arabia: فناديوم  
**vanila** *vanilja* ← englanti:vanilla, espanja:vainilla, portugali:baunilha, ranska:vanille, venäjä:ваниль (vanil’), kantoninkiina:云呢拿 (wan4 ni1 laa4-2), japani:バニラ (banira), korea:바닐라 (banilla), vietnami:vani, turkki:vanilya  
**vanu** *huvi (hauskuus)* ← yleiskiina:玩 (wán), kantoninkiina:玩 (waan4), cjy:玩 (van1), korea:완 (wan)  
**vari** *monenlainen* ← englanti:various, espanja:vario, portugali:vário, ranska:varier, deu:variieren  
**varis** *riisi* ← tamili:அரிசி (arisi), telugu: వరి (vari), malayalam:vary, malaiji:beras, otb:འབྲས ('bras), persia: برنج‎ (berenj), arabia: أَرُزّ‎ (ʾaruzz), espanja:portugali:arroz, ranska:riz, englanti:rice, deu:Reis, venäjä:рис (ris), oromo:ruuzii  
**varite** *perintö* ← arabia: وَرَثَ‎ (waraṯa), persia: وارث‎ (vâres), hindi:वारिस (vāris), malaiji:waris, suahili:-rithi, turkki:vâris + englanti:inherit, ranska:hériter, espanja:heredar  
**vasin** *rokote* ← englanti:vaccine, espanja:vacuna, portugali:vacina, venäjä:вакцина (vakcina), hindi:वैक्सीन (vaiksīn), japani:ワクチン (wakuchin), malaiji:vaksin  
...
**vaxi** *pestä* ← englanti:wash, deu:waschen, yleiskiina:洗 (xǐ)  
**vazir** *ministeri* ← arabia: وَزِير‎ (wazīr), persia: وَزیر‎ (vazir), hindi:वज़ीर (vazīr), bangla:উজির (ujir), turkki:vezir, suahili:malaiji:wazir + englanti:vizier, deu:Wesir, ranska:portugali:vizir, espanja:visir, venäjä:визирь (vizir')  
**vei** *vaakatasossa* ← yleiskiina:纬 (wěi), kantoninkiina:緯 (wai6), korea:위 (wi), vietnami:vĩ  
**vel** *verho (peite)* ← eng;veil, ranska:voile, espanja:velo, portugali:véu, japani:ベール (bêru), korea:베일 (beil), suahili:veli  
...
**veranda** *kuisti (terassi, veranta, parveke)* ← hindi:बरामदा (barāmd), tamili:வராந்தா (varāntā), portugali:varanda, malaiji:beranda, englanti:veranda, venäjä:веранда (veranda), japani:ベランダ (beranda), korea:베란다 (beranda), suahili:varanda  
**verme** *mato* ← englanti:worm, espanja:portugali:verme, ranska:ver, deu:Wurm  
**verse** *kääntää jtkn päin (kohti, päin)* ← englanti:versus, ranska:verse, espanja:portugali:versar + venäjä:версия (versiya), malaiji:versi  
**veruke** *syylä* ← englanti:verruca, ranska:verrue, espanja:portugali:verruga  
...
**vidua** *leski* ← englanti:widow, espanja:viudo, portugali:viúvo, ranska:veuve, deu:Witwe, venäjä:вдова (vdova), hindi:विधवा (vidhavā), bangla:বিধবা (bidhabā), telugu:విధవ (vidhava)  
**vijing** *natriumglutamaatti* ← yleiskiina:味精 (wèijīng), kantoninkiina:味精 (mei6 zing1), vietnami:mì chính, malaiji:vetsin,micin, filippiini:bitsin  
...
**vilde** *villi (kesytön)* ← deu:englanti:ned:wild, sve:vild  
...
**vote** *ääni (äänestyksessä)* ← englanti:ranska:vote, espanja:portugali:voto, deu:Votum, venäjä:вотум (votum), hindi:वोट (voṭ), bangla:ভোট (bhōṭ)  
...
**xakal** *šakaali* ← persia: شغال‎ (šağâl), turkki:çakal, englanti:jackal, ranska:espanja:portugali:chacal, venäjä:шакал (šakal), bangla:শৃগাল (śrigal), malaiji:jakal, japani:ジャッカル (jakkaru), korea:자칼 (jakal), hausa:jakkali  
**xake** *luulla (epäillä; luulo, epäily)* ← arabia: شَكَّ‎ (šakka), persia: شک‎ (šak), hindi:शक (śak); शंका (śankā), malaiji:syak; sangka, turkki:şek, suahili:shaka; -shuku, hausa:shakka  
...
**xatan** *saatana (sielunvihollinen)* ← heb: שָׂטָן‎ (śaṭan), arabia:(šayṭān), englanti:ranska:deu:vietnami:Satan, espanja:Satán, portugali:Satã, venäjä:Сатана (Satana), yleiskiina:撒但 (Sādàn), kantoninkiina:撒但 (saat3daan6), korea:사탄 (satan), japani:サタン (satan), hindi:शैतान (śaitān), tamili:சயித்தான் (cayittāṉ), malaiji:Setan, turkki:şeytan, suahili:Shetani, hausa:shaidan  
...
**xe hal** *tilanne (asiaintila)* ← yleiskiina:事态 (shìtài), kantoninkiina:事態 (si6taai3), japani:事態 (jitai), englanti:state of affairs, ranska:état des choses  
**xe** *asia* ← arabia:(šayʾ), turkki:şey, + yleiskiina:事 (shì), kantoninkiina:事 (si6)  
**xefe** *päällikkö (pomo)* ← ranska:chef, portugali:chefe, espanja:jefe, venäjä:шеф (šef), englanti:chief, suahili:chifu, japani:チーフ (chīfu) + arabia: شَيْخ‎ (šayx), swa:shehe, bangla:শেখ (śekh), turkki:şeyh  
...
**xirope** *siirappi* ← arabia:(šarāb), portugali:xarope, englanti:syrup, deu:Sirup, ranska:sirop, espanja:jarabe; sirope, venäjä:сироп (sirop), persia: شیره‎ (fa) (šire), hindi:शर्बत (śarbat), bangla:শীরা (śira), turkki:şurup, japani:シロップ (shiroppu), korea:시럽 (sireop), vietnami:xi-rô, suahili:shira  
**xite** *paska (sonta)* ← englanti:shit, yleiskiina:屎 (shǐ), kantoninkiina:屎 (si2)  
**xiti bai** *epäonnistuminen* ← yleiskiina:失败 (shībài), japani:失敗 (shippai), korea:실패 (šilpæ), vietnami:thất bại  
**xiti** ** ← yleiskiina:失 (shī), japani:失 (shitsu), korea:실 (šil), vietnami:thất  
**xiu** *pieni* ← yleiskiina:小 (xiǎo), kantoninkiina:小 (siu2), japani:小 (shō), korea:소 (so), vietnami:tiểu  
**xix** *varras* ← turkki:şiş + englanti:shish-, venäjä:шиш- (šiš-)  
**xixa** *puteli* ← persia: شیشه (šiše), hindi:शीशा (śīśā), telugu:సీసా (sīsā), turkki:şişe, arabia: شيشة‎ (šīša) + englanti:shisha, deu:Schischa, ranska:chicha, portugali:xixa  
...
**xou** *näytös (esitys, show)* ← englanti:deu:ranska:espanja:portugali:show, venäjä:шоу (šou), turkki:şov, suahili:shoo, korea:쇼 (syo), japani:ショー (shō), yleiskiina:秀 (xiù), kantoninkiina:騷 (sou1)  
**xukre** *kiitos* ← arabia: شُكْر‎ m (šukr), hindi:शुक्र (śukr), bangla:শোকর (śokôr), suahili:-shukuru, turkki:şükür  
**xulekan** *koulu (opisto)* ← yleiskiina:学 (xué) + deu:Schule, suahili:shule + englanti:school, ranska:école, espanja:escuela, portugali:escola, venäjä:школа (škola), bangla:স্কুল (śkul), malaiji:sekolah + hindi:पाठशाला (pāṭhśālā), marathi:शाळा (śāḷā), tamili:பாடசாலை (pāṭasālai)  
...
**ya** *kyllä* ← englanti:yeah, deu:ja, korea:예 (ye), malaiji:ya  
**yake** *noin (arviolta, suunnilleen, likimäärin)* ← korea:약 (yak), japani:約 (yaku), kantoninkiina:約 (yœk), turkki:yaklaşık, yleiskiina:约 (yuē)  
**yaku** *jakki* ← tib:གཡག (g-yag), englanti:deu:ranska:espanja:turkki:yak, portugali:iaque, venäjä:як (iak), hindi:याक (yāk)  
**yam** *nauttia (syödä, juoda)* ← khmer:ញ៉ាំ (nyam), fulani:nyaamude + espanja:ñam, venäjä:ням (nyam), italia:gnam, englanti:yum, korea:냠냠 (nyamnyam), unkari:nyam  
...
**yatim** *orpo* ← arabia: يَتِيم‎ (yatīm), persia: یتیم‎ (yatim), turkki:yetim, malaiji:yatim, suahili:yatima, hindi:यतीम (yatīm), bangla:এতিম (etim), tamili:எத்தீம் (ettīm), fulani:alyatiimu  
...
**yogur** *jogurtti* ← englanti:malaiji:yogurt, ranska:yogourt, espanja:yogur, portugali:iogurte, venäjä:йогурт (yogurt), yleiskiina:优格 (yōugé), japani:ヨーグルト (yōguruto), korea:요구르트 (yogureuteu), turkki:yoğurt   
**yoke** *jade* ← yleiskiina:玉 (yù), kantoninkiina:玉 (yuk6), nan:玉 (gio̍k), japani:玉 (gyoku), vietnami:ngọc (玉), korea:옥 (ok), malaiji:giok, thai:หยก (yok), khmer:យក់ (yuək)  
**yota** *kvadriljoona (jotta-)* ← englanti:ranska:espanja:portugali:yotta, malaiji:yota-, yleiskiina:尧它- (yáotā-), japani:ヨタ- (yota-), korea:요타- (yota-)  
...
**yuge** *nivel (liitos)* ← englanti:yoke, espanja:yugo, portugali:jugo, ranska:joug, venäjä:иго (igo), persia:  یوغ‎ (yuğ) + deu:Junktion + kantoninkiina:軛 (aak1), vietnami:ách  
...
**zai** *olla olemassa* ← yleiskiina:在 (zài), kantoninkiina:在 (zoi6), japani:在 (zai), vietnami:tại  
...
**zaman** *kausi (aikakausi, ajanjakso, periodi)* ← malaiji:jam, arabia: زَمَن‎ (zaman), hausa:suahili:zamani, fulani:jamaanu, turkki:zaman, persia: زمان‎ (zamân), hindi:समय (samay), bangla:সময় (sômyô)  
**zange** *kasvaa* ← yleiskiina:长 (zhǎng); 增加 (zēng), kantoninkiina:增 (zang1), korea:장 (jang), vietnami:tăng  
...
**zete** *öljy* ← arabia: زَيْت‎ (zayt), espanja:portugali:aceite  
**zetun** *oliivi* ← arabia: زَيْتُون‎ (zaitūn), espanja:aceituna, malaiji:zaitun, suahili:zeituni, turkki:zeytin, hausa:swa:zaituni, persia: زیتون‎ (zeytun), hindi: ज़ैतून (zaitūn), bangla:জয়তূন (zôẏtūn), tamili:சைதூண் (caitūṇ)  
...
**zi** *kirjoitusmerkki* ← yleiskiina:字 (zì), kantoninkiina:字 (zi6), japani:字 (ji), korea:자 (ja)  
...
**zina** *haureus (uskottomuus)* ← arabia: زِنَاء‎ (zināʾ), malaiji:turkki:hausa:zina, fulani:jinaa, suahili:zinaa, persia: زنا‎ (zenā)  
...
**zirafa** *kirahvi* ← persia: زرناپا‎ (zornâpâ), arabia: زَرَافَة (zarāfa), turkki:zürafa, deu:englanti:ranska:giraffe, portugali:girafa, espanja:jirafa, venäjä:жираф (žiraf),malaiji:zirafah; jerapah, korea:지라프 (jirapeu), hindi: जिराफ़ (jirāf), bangla:জরৈফ (jôrôph)  
...
**zoku** *jatkaa (jatkua)* ← wu-kiina:续 (zoq), kantoninkiina:續 (zuk6), japani:続 (zoku), korea:속 (sok), vietnami:kế tục  
...
**zukam** *nuhakuume (vilustuminen, flunssa)* ← arabia:زُكَام‎ (zukām), hindi:ज़ुकाम (zukām) + yleiskiina:感(冒) (gǎn(mào)), kantoninkiina:感冒 (gam2mou6), japani:感(冒) (kan(bō)), korea:감(기) (gam(gi)), vietnami:cảm  
