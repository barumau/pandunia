...
|----------|----------|----------|
|**-i**|pääte: adjektiivi tai adverbi|arabia:(-i), persia:(-i), hindi:-ई (-ī), bangla:-ই (-i), englanti:-y, japani:-i, unkari:-i|
|**-ia**|ajattelun, olemisen tai ihmisten ala tai alue|espanja:portugali:englanti:-ia, venäjä:-ия (-iya), arabia: ية (-iya), japani:屋 (-ya)|
|**-u**|pääte: OVS-sanajärjestyksen verbi|hausa:wol:-u, suahili:-wa|
|**a**|mutta|venäjä:а (a), puola:a, + yleiskiina:啊 (ā), + englanti:ah|
|**abace**|aakkoset (ABC)|gre:(alphabētos), espanja:abecedario, persia:(alefbâ), arabia:(abjad), unkari:ábécé|
|**abla**|voida (osata, pystyä)|englanti:able, espanja:hábil, ranska:habile, ron:abil|
|**acion**|toiminta|ranska:englanti:action, espanja:acción, portugali:ação, malaiji:aksi|
...
|**afrike**|Afrikka|arabia:(ʾafrīqiyā), wol:Afrig, ful:Afirik, amhara:(ʾäfriḳa), hausa:Afirka, yoruba:Afirika, oromo:Afrikaa, suahili:Afrika|
|**agres**|hyökkäys (aggressio)|englanti:deu:ranska:agression, puola:agresja, venäjä:агрессия (agressiya), espanja:agresión, portugali:agressão, malaiji:agresif|
|**aha**|oivaltaa (tajuta)|venäjä:ага (aha), korea: 아하 (aha), englanti: uh-huh, puola:aha|
|**air**|ilma|englanti:ranska:espanja:air, portugali:ar|
|**airia**|Irlanti|gle:Éire, englanti:Ireland|
|**ais**|jää|englanti:ice, deu:Eis, malaiji:és|
|**aisokrem**|jäätelö|englanti:ice cream, japani:アイスクリーム (aisukurīmu), korea:아이스크림 (aiseukeurim), hindi:आइसक्रीम (āisakrīm), urdu:(āisakrīm), bangla:আইসক্রীম (aisôkrīm), thai:ไอศกรีม (ai-sà-griim), malaiji:es krim, suahili:aiskrimu, tamili:ஐஸ் கிரீம் (ais kirīm), telugu:(ais krīm)|
...
|**altar**|alttari|englanti:portugali:espanja:malaiji:altar, venäjä: алтарь (altar'), suahili:altare, puola:ołtarz|
|**am**|rakkaus (tykkääminen)|ranska:amour, espanja:portugali:amor|
|**ampul**|ampulli|ranska:englanti:ampoule, yleiskiina:安瓿 (ānbù), japani:アンプル (anpuru), venäjä:ампула (ámpula), arabia:(ʾambūla)|
|**analis**|analyysi|englanti:analysis, ranska:analyse, portugali:análise, espanja:análisis, venäjä:анализ (analiz), turkki:analiz|
|**ande**|muna|hindi:अंडा (aṇḍā), bangla:আণ্ডা (aṇḍa), urdu:(aṇḍā), pandzabi:ਆਂਡਾ (āṇḍā), telugu:(aṇḍamu), zul:xho:iqanda, mon:өндөг (öndög)|
...
|**antonam**|vastakohta (antonyymi)|englanti:deu:antonym, ranska:antonyme, espanja:portugali:antónimo, venäjä:антоним (antonim), malaiji:turkki:antonim|
|**aple**|omena|englanti:apple, deu:Apfel, malaiji:apel, bangla:আেপল (apôl), zul:ihhabhula|
...
|**arbe**|puu|ranska:arbre, espanja:árbol, portugali:árvore|
...
|**awakate**|avokado|nah:ahuakatl, espanja:aguacate, portugali:abacate, filippiini:abokado, japani:アボカド (abokado), korea:아보카도 (abokado), ranska:avocat, puola:awokado, kon:zavoká|
...
|**babuce**|tohveli|arai: بَابُوج‎ (bābūj), espanja:babucha, ranska:babouche, englanti:babouche|
...
|**badan**|keho (ruumis)|arabia:(badan), hindi:बदन (badan), persia:urdu:(badan), turkki:beden, englanti:body|
...
|**bal**|kahdeksan (8)|yleiskiina:八 (bā), korea:팔 (pal), filippiini:walo, haw:walu|
...
|**ban**|kerta (vuoro)|korea:번 (beon), vietnami:bận, japani:番 (ban), yleiskiina:遍 (biàn), + hindi:बार (bār), urdu:persia:(bār), bangla:বার (bar)|
|**banan**|banaani|wol:banaana, venäjä:банан (banan), puola:banan, ranska:deu:banane, portugali:espanja:englanti:banana, japani:バナナ (banana), korea:바나나 (banana)|
...
|**baton**|tanko (sauva, patukka)|englanti:baton, ranska:bâton, yleiskiina:棒 (bàng), japani:棒 (bō)|
...
|**baw**|lehti (sanomalehti)|yleiskiina:报 (bào), vietnami:báo, + thai: ป่าว (bpàao)|
|**bax**|kieli (kommunikaatio)|hindi:भाषा (bhāṣā), urdu:(bhāṣā), bangla:ভাষা (bhaṣa), pandzabi:ਭਾਸ਼ਾ (bhāshā), telugu:భాష (bhāṣa), tamili:பாசை (pāsai), thai:ภาษา (phasa), malaiji:bahasa, jav:basa|
...
|**bede**|vuode (sänky, peti)|englanti:bed, deu:Bett, japani:ベッド (beddo), zul:umbhede|
|**bedinjan**|munakoiso|hindi:बैंगन (bEngān), arabia:(bādinjān), portugali:berinjela, ranska:aubergine, espanja:berenjena, turkki:badincan, patlıcan, venäjä:баклажан (baklažan), suahili:mbilingani|
...
|**biye**|biologinen elämä|englanti:ranska:espanja:portugali:malaiji:bio-, venäjä:био- (bio-), turkki:biyo-|
|**biyolojia**|biologia|turkki:biyoloji, ranska:biologie, englanti:biology|
|**bizari**|outo (kummallinen)|englanti:ranska:bizarre, portugali:bizarro, deu:bizarr|
|**bizi**|kiireinen|englanti:busy|
|**biznes**|liiketoiminta (bisnes)|englanti:business, venäjä:бизнес (biznes)|
...
|**bon rupi**|hyvännäköinen|yleiskiina:好看 (hǎokàn), englanti:good-looking|
...
|**botol**|pullo|englanti:bottle, malaiji:botol|
|**boton**|nappi|englanti:button, espanja:botón, portugali:botão, ranska:bouton, japani:ボタン (botan), filippiini:butones, hindi:बटन (baṭan), urdu:(baṭan), ben;বোতাম (botam)|
...
|**bubul**|kupla|englanti:bubble, unkari:buborék, hindi:बुल्ला (bullā), filippiini:bula, ranska:bulle, pandzabi:ਬੁਲਬੁਲਾ (bulabulā)|
...
|**bulu**|kiehua|englanti:boil, ranska:bouillir, italia:bollire, zul:-bila, sot:-bela, hindi:उबालना (ubālnā)|
|**bum**|pylly (takapuoli, pakarat)|englanti:bum, portugali:bumbum|
|**bunduke**|pyssy|arabia:(bunduqiyya), hindi:बंदूक (bandūk), suahili:bunduki|
|**bung**|maha (vatsa)|vietnami:bụng, khmer:ពុង (pung), thai:พุง (pung)|
...
|**buton**|nappi (näppäin, kytkin, nappula)|englanti:button, hindi:बटन (baṭan), bangla:বোতাম (botam), japani:ボタン (botan), korea:버튼 (beoteun)|
|**buy**|apinanleipäpuu (baobab)|suahili:mbuyu, wol:buy, sna:muuyu, zul:isimuhu|
|**buze**|vuohi|suahili:mbuzi, sna:mbudzi, zul:imbuzi, tsw:bodi, portugali:bode, taj:буз (buz), persia:(boz)|
|**ca**|lähtien (-sta, -lta)|yleiskiina:从 (cóng),出于 (chū), kantoninkiina:從 (cung4)|
|**cabe**|avain|portugali:chave, hindi:(cābi), kon:nsapi|
...
|**cay**|tee|yleiskiina: 茶 (chá), japani: (cha), turkki:çay, suahili:chai, venäjä:чай (čay), hindi:चाय (cāy), arabia:(šāy)|
|**ceng**|kerros|yleiskiina:层 (céng), kantoninkiina:層 (cang4), korea:층 (chŭng), vietnami:tầng|
...
|**cis**|juusto|englanti: cheese, yleiskiina: 起司 (qǐsī), suahili: chizi, japani:チーズ (chīzu), korea:치즈 (chijeu)|
...
|**darte**|maa (multa)|englanti:dirt, hindi:धरती (dhartī), urdu:(dhartī), vietnami:đất|
...
|**day**|iso (suuri)|kantoninkiina:大 (daai), yleiskiina:大 (dá), vietnami:đại, japani:(dai,tai), korea:대— (dae-)|
|**dayosamude**|valtameri|vietnami:đại dương, korea:대양 (daeyang), japani:大洋 (taiyō), yleiskiina:大洋 (dàyáng), thai:มหาสมุทร (mahasamut), hindi:महासागर (mahāsāgar)|
...
|**destin**|määrä (päämäärä, kohtalo)|englanti:destination, destiny, ranska:destin, espanja:portugali:destino|
|**dew**|jumala|portugali:deus, malaiji:dewa, hindi:देवता (devtā), kannada:(dēva)|
...
|**dokum**|asiakirja (dokumentti, tiedosto)|englanti:ranska:document, venäjä:документ (dokument)|
...
|**dul**|kaksi (2)|korea:둘 (dul), bangla:দুই (dui), malaiji:dua, + englanti:ranska:portugali:espanja:dual|
...
|**dux**|suihku|ranska: douche, deu:Dusche, turkki:duş, venäjä:душ (duš), arabia:(duš), espanja:portugali:ducha|
|**e**|ja|ranska:et, portugali:e, yleiskiina:和 (hé)|
|**egal**|tasapuolinen (reilu)|ranska:égal, espanja:portugali:igual, englanti:equal|
...
|**esten**|tina|espanja:estaño, portugali:estanho, ranska:étain, italia:stagno, englanti:tin|
...
|**faide**|hyöty (etu)|arabia:(fāʾida), turkki:fayda|
|**fajan**|kehitys|yleiskiina:发展 (fāzhǎn), vietnami:phát triển, korea:발전 (bajjeon)|
...
|**fan**|huvi (hauskuus)|englanti:fun|
...
|**fata**|tehdä (valmistaa)|italia:fare, ranska:faire, portugali:fazer, + arabia:(faʿala), + suahili:kufanya|
...
|**fete**|rasva (öljy)|suahili:mafuta, rwa:mavuta, kon:mafuta|
...
|**fix**|kala|englanti:fish, deu:Fisch|
...
|**ful**|täysi|englanti:full, deu:voll|
...
|**funocuper**|pölynimuri|yleiskiina:吸尘器 (xīchénqì), deu:Staubsauger|
...
|**futaw**|kirves|filippiini:puthaw, yleiskiina:斧头 (fǔtóu), kantoninkiina:斧頭 (futau), nan:斧頭 (pú-thâu)|
|**futobol**|jalkapallo|englanti:ranska:football, espanja:fútbol, portugali:futebol, deu:Fußball, hindi:फ़ुटबॉल (fuṭbŏl), urdu:(fuṭ bāl), bangla:ফুটবল (phuṭbôl), venäjä:футбол (futbol), thai:ฟุตบอล (th) (fút-bɔn), japani:フットボール (futtobōru), zul:ibhola|
|**gabre**|hauta|arabia:(qabr), hindi:क़ब्र (qabra), malaiji:kubur, deu:Grab, puola:grób, venäjä:гроб (grob)|
...
|**gar**|jos (olettaa)|persia:urdu:اگر‎‎ (agar), hindi:अगर (agar), turkki:eğer, + kantoninkiina:假 (gaa1), wu-kiina:假 (ga)|
...
|**gey**|homo (homoseksuaali)|englanti:ranska:espanja:gay, portugali:guei|
...
|**gon**|kulma (nurkka)|hindi:कोण (koṇ), telugu:(kōnamu), suahili:kona, englanti:corner, hausa:kwana|
|**goton**|puuvilla|arabia:(quṭun), espanja:algodón, portugali:algodão, ranska:coton, englanti:cotton|
|**graf**|piirros (graafi)|englanti:graphic, ranska:graphique|
|**gras**|ruoho|englanti:grass, hindi:घास (ghās)|
|**grom**|jyrinä (ukkonen)|venäjä:гром (grom), puola:grom|
...
|**gubuh**|virtahepo|ful:ngabu sot:kubu lub:gubu kon:ngubu/mvubu, gan:envubu zul:rwa:imvubu, sna:mvuu, amharabia:gumarre|
...
|**gunden**|palatsi|yleiskiina:宫殿 (gōngdiàn), vietnami:cung điện, japani:宮殿 (jyūden), korea:궁전 (gungjeon)|
...
|**gunodarme**|hyve|thai:คุณธรรม (gunnadam), hindi: urdu: tamili: telugu: burma: malaiji:|
|**gur**|guru (opettaja)|hindi:गुरु (guru), bangla:গুরু (guru), gujarati:ગુરુ (guru), pandzabi:ਗੁਰੂ (gurū), filippiini:guro, thai:ครู (gruu), malaiji:englanti:portugali:guru, espanja:gurú, venäjä:гуру (guru), ranska:gourou, korea:구루 (guru), japani:グル (guru)|
|**gurube**|sika (possu)|rwa:gurube, sna:guruve, suahili:guruwe zul:ingulube, kon:ngulu espanja:guarro,gorrino, kat:ღორი (ğori), + (onom,) japani:(gorogoro) englanti:grunt|
|**gute**|polvi|suahili:goti, gujarati:ઘૂંટણ (ghū̃ṭaṇ), Hin:घुटना (ghuṭnā), marathi:गुडघा (guḍghā)|
|**guy**|peikko|yleiskiina:鬼 (guǐ), vietnami:quỷ, + thai:กุ๊ย (gui)|
...
|**hakim**|tuomio|arabia:(qāḍin), hausa:alƙali, persia:(qāzi), englanti:qadi, suahili:kadhi|
...
|**hamir**|hiiva|arabia:(xamīra), hindi:ख़मीर (xamīr), turkki:hamur, persia:(moxammer), + korea:효모 (hyomo)|
...
|**hatar**|vaara|arabia:(xaṭar), persia:(xatar), urdu:(xatra), hindi:ख़तरा (xatrā), suahili:hatari, turkki:muhatara|
...
|**hay**|elämä|arabia:حياة‎ (ḥaya), suahili:uhai, hindi:हयात (hayāt), malaiji:hayat|
|**hay**|vielä (yhä)|yleiskiina:还 (hai)|
...
|**huy**|tuhka|yleiskiina:灰 (huĭ), kantoninkiina:灰 (fui), japani:灰 (hai), + korea:회색 (hoesaeg)|
|**ice**|tahto|vietnami:ý chí, yleiskiina:意志 (yìzhì), korea:(uiji), japani:(ishi), + hindi:इच्छा (icchā), telugu:ఇచ్చ (icca)|
|**idey**|käsite (idea)|ranska:idée, deu:Idee, hat:malaiji:ide, persia:(ide), portugali:ideia, venäjä:идея (ideya), vietnami:ý định|
...
|**jan**|tieto (tietämys)|hindi:जान (jān), bangla:জ্ঞান (gyan), জানা (jana), pandzabi:ਜਾਣ (jāṇ), thai:ญาณ (yaan)|
|**janel**|ikkuna|portugali:janela, tamili:சன்னல் (sannal), bangla:জানালা (janala), malaiji:jendela, nya:zenera, kon:nêla|
|**jangal**|metsä (viidakko)|hindi:जंगल (jangal), bangla:জঙ্গল (jônggôl), urdu:(jangal), portugali:jângal, englanti:jungle, venäjä: джу́нгли (džúngli), deu:Dschungel|
...
|**je**|joka|hindi:जो (jo), urdu:(jo)|
|**jebe**|tasku|hindi:जेब (jeb), pandzabi:ਜੇਬ (jeb), urdu:(jeb), telugu:(jēbu), arabia:(jayb), turkki:cep, wol:jiba|
...
|**jiraf**|kirahvi|arabia:(zarāfa), Eng:ranska:giraffe, portugali:girafa, espanja:jirafa, venäjä:жираф (žiraf),malaiji:jerapah, turkki:zürafa, korea:지라프 (jirapeu), hindi: जिराफ़ (jirāf), bangla:জরৈফ (jôrôph)|
...
|**kagaze**|paperi|yleiskiina:榖纸 (gǔzhǐ), kantoninkiina:榖紙 (guk1zi2), japani:榖紙 (kokushi), + persia:(kâğaz), hindi:काग़ज़ (kāġaz), bangla:কাগজ (kagôj), turkki:kâğıt, arabia:(kāḡid), kannada:ಕಾಗದ (kāgada), telugu:కాగితము (kāgitamu), tamili:காகிதம் (kākitam), wol:keyit, uig:(qeghez)|
|**kakaw**|kaakao|portugali:cacau, arabia:(kākāw), espanja:cacao, englanti:cocoa, vietnami:cacao, japani:カカオ (kakao), yleiskiina:可可 (kěkě), venäjä:какао (kakao)|
...
|**kamis**|paita|espanja:portugali:camisa, arabia:(qamīṣ), hindi:क़मीज़ (kāmīz), malaiji:kemeja|
|**kamote**|bataatti|espanja:camote, filippiini:kamote|
|**kan**|silmä|tamili:கண் (kaṇ), telugu:(kannu), kannada:(kaṇṇu), malayalam:കണ്ണ് (kaṇṇu)|
...
|**kanon**|tykki (pyssy)|englanti:cannon, espanja:cañón, yleiskiina:加农 (jiānóng), japani:(kyanon), korea:캐넌 (kaeneon)|
...
|**kar**|kärry (vaunu, auto, jne)|englanti:car, portugali:espanja:carro, deu:Karre, telugu:(kāru), + hindi:गाड़ी (gāṛī), suahili:gari|
...
|**karite**|voipuu|wol:kaarite, jul:karite, ranska:espanja:karité, pul:kaare, ful:kareje, hausa:kaɗanya|
|**karme**|toiminta (tekeminen, karma)|hindi:कर्म (karma), urdu:(karm), pandzabi:ਕਰਮ (karm), kannada:tamili:telugu:(karma), englanti:deu:ranska:espanja:portugali:karma, khmer:កម្ម (kam), burma:ကံ (kam), thai:กรรม (kam), venäjä:карма (karma)|
|**karte**|kartta|deu:Karte, venäjä:карта (karta), ranska:carte, italia:portugali:carta, arabia:(xarīṭa), turkki:harita, persia:(xarite), som:khariiddo|
|**kartun**|sarjakuva|englanti:cartoon, portugali:cartum, yleiskiina:卡通 (kǎtōng)|
...
|**kaxe**|kassa|deu:Kasse, venäjä:(kassa), englanti:case,cash, suahili:kasha, portugali:caixa, espanja:caja|
|**kay**|auki (avoin)|yleiskiina:开 (kāi), vietnami:-khai-|
...
|**kelele**|meteli|suahili:kon:makelele|
...
|**kokode**|kana|ranska:coq, englanti:cock, puola:kogut, gujarati:કૂકડો (kūkḍo), + suahili:kuku, zul:inkukhu, + (onom,) italia:coccodè, japani:コッコッ (kokko), persia:(qod-qod-qodās), venäjä:куд-куда, hindi:कुटकुटा (kutkutā)|
...
|**konson**|konsonantti|ranska:consonne, englanti:consonant|
|**kontra**|vastaan (vasten)|espanja:portugali:contra, ranska:contre, englanti:counter-, gre:κόντρα (kontra)|
|**kope**|kopio|englanti:copy, yleiskiina:拷貝 (kǎobèi)|
|**kor**|kuoro|espanja:coro, turkki:koro, englanti:chorus, hindi:कोरस (koras), arabia:(korāl)|
...
|**kos**|yskä|venäjä:кашель (kašel'), puola:kaszel, bangla:কাশা (kaśa), yleiskiina:咳嗽 (késou)|
...
|**krus**|risti|englanti:cross, portugali:espanja:cruz, deu:Kreuz, ranska:croix, japani:クロス (kurosu), venäjä:крест (krest), kon:kuluzi, hindi:क्रूश (krūś)|
...
|**kupe**|kuppi (muki)|ranska:coupe, turkki:kupa, arabia:(kūb), espanja:copa, englanti:cup, hindi:कप (kap), japani:コップ (koppu), korea:컵 (keop)|
|**kupol**|kupoli (holvikatto)|persia:(koppe), arabia:(qubba), turkki:kubbe, malaiji:kubah, venäjä:купол (kupol), espanja:cúpula, deu:Kuppel|
...
|**lanten**|lyhty|englanti:lantern, hindi:लालटेन (lālṭen), japani:ランタン (rantan), korea:랜턴 (raenteon), + yleiskiina:灯笼 (dēnglóng), vietnami:đèn lồng, malaiji:tanglung|
...
|**lekin**|kuitenkin|arabia: لكن (lākin), hindi:लेकिन (lekin), suahili:lakini|
...
|**lew**|jo (tehty teko)|thai:แล้ว /lɛːw/, yleiskiina:了 (le), wu-kiina:了 (lə'), hakkakiina:了 (le), kantoninkiina:了 (liu)|
...
|**lil**|pieni (pienesti, vähän)|englanti:little|
...
|**loge**|puhe (sanat)|kreikka:λόγος (logos), englanti:-logue, persia:(loğat), arabia:(luğa), suahili:lugha, turkki:lügat, malaiji:logat|
|**logike**|logiikka|englanti:logic, espanja:portugali:lógica, venäjä:логика (logika), yleiskiina:逻辑 (luóji)|
|**lojia**|tiede (tutkimus)|englanti:-ology, espanja:-ología, ranska:-ologie, venäjä:(-logiya), turkki:-loji|
|**loke**|paikka (sija, sijainti)|englanti:location, espanja:lugar, ranska:localisation, + deu:turkki:lokal, puola:lokalny|
|**lon**|väittely (debatti)|yleiskiina:论 (lùn), japani:論 (ron), vietnami:luận, korea:논 (non)|
|**lona**|keskustelu (debatti)|yleiskiina:论 (lùn), kantoninkiina:論 (lœn6), korea:론 (ron), japani:論 (ron), vietnami:luận|
|**long**|pitkä|englanti:ranska:long, deu:lang, Por:longo|
|**lose**|ruuvi|yleiskiina:螺丝 (luòsī), kantoninkiina:螺絲 (lo4 si1)|
|**lote**|erä (satsi)|portugali:espanja:lote, englanti:ranska:lot|
|**lote**|tontti (maakaistale)|portugali:lote, englanti:ranska:lot, espanja:loteo|
...
|**lul**|helmi|amharabia:ሉል (lul), ara:(luʾluʾa), suahili:lulu, oromo:lu'ulu'a, hausa:lu'ulu'u, ful:luuluuri, persia:(lo'lo')|
...
|**maidan**|kenttä (aukio)|arabia:(maydān), persia:(meydan), hindi:मैदान (maidān), turkki:meydan, suahili:medani, venäjä:майдан (maydan)|
...
|**malorupi**|ruma (pahannäköinen)|yleiskiina:难看 (nánkàn), hindi:बदसूरत (badsūrat)|
...
|**mari**|naimisissa|englanti:married, ranska:marié, espanja:portugali:marido|
|**marke**|merkki (jälki)|englanti:mark, espanja:portugali:marca, ranska:marque, korea:마크 (makeu), japani:マーク (māku)|
|**marmar**|marmori|hindi:संगमरमर (saṅgmarmar), espanja:marmól, portugali:mármore, Rus:мрамор (mramor), malaiji:marmer, Tur:mermer|
|**masal**|mauste|hindi:मसाला (masālā), urdu:(masālā), bangla:মসলা (môsla), bur:(masʰala)|
|**maske**|naamio (maski)|englanti:mask, ranska:masque, espanja:portugali:máscara, venäjä:маска (maska), hindi:मास्क (māsk), japani:マスク (masuku), korea:마스크 (maseukeu), malaiji:masker, Tur:maske|
...
|**matike**|matematiikka (matikka)|deu:Mathe(matik), englanti:math(ematics), espanja:matemática, venäjä:(matika)|
...
|**max**|enemmän|espanja:mas, portugali:mais, englanti: max-|
...
|**maxor**|enemmistö-|ranska: majeur, englanti: major, espanja: mayor|
...
|**megam**|pilvi|hindi:मेघ (megh), bangla:মেঘ (megh), tamili:மேகம் (mēgam), telugu:మేఘము (mēghamu), malaiji:mega, thai:เมฆ (mek)|
|**meh**|lammas|kur:mî,mîh, hindi:मेष (meṣ), persia:(miš), thai:เมษ (met), + lin:kon:meme, + (onom,) japani:メーメー (mē mē), portugali:meh, arabia:(maa'), turkki:mee|
...
|**mes**|kuukausi|portugali:mês, espanja:mez, venäjä:месяц (mesyats), bangla:মাস (mas), suahili:mwezi|
...
|**mey**|joka (jokainen)|yleiskiina:每 (měi), wu-kiina:每 (me), vietnami:mọi, korea:매 (mae)|
...
|**migan**|mandariini|japani:蜜柑 (mikan), yleiskiina:蜜柑 (mìgān)|
|**migre**|muutto (migraatio)|ranska:englanti:migration, espanja:migración, portugali:migração, venäjä:миграция (migratsiya)|
|**milke**|maito|englanti:milk, deu:Milch, japani:ミルク  (miruku), korea:밀크 (milkeu), lin:míliki, venäjä:молоко (moloko)|
...
|**moke**|puu (puutavara)|yleiskiina:木 (mù), kantoninkiina:木 (muk), vietnami:mục, japani:木 (-moku), korea:목 (mok)|
...
|**mon**|vain (ainoastaan)|kreikka:μόνος (monos), englanti:deu:ranska:portugali:espanja:mono-|
...
|**mosim**|vuodenaika|hindi:urdu:(mOsam), malaiji:musim, arabia:(mawsim), turkki:mevsim, suahili:msimu|
|**mote**|liike|italia:moto, englanti:motion|
|**motokar**|auto (automobiili)|englanti:motorcar, sna:motokari, sot:motokara, suahili:motokaa, zul:imoto, hausa:mota|
...
|**mul**|alku|hindi:मूल (mūl), malaiji:filippiini:mula, khmer:មូល (mul)|
|**multi**|moni (usea)|portugali:muito, Eng:ranska:espanja:multi-, venäjä:мульти- (mulʹti-)|
...
|**namolekse**|substantiivi (nimisana)|yleiskiina:名词 (míngcí), kantoninkiina:名詞 (ming4 ci4), japani:名詞 (meishi), korea:명사 (myeongsa), hindi:नाम (nām), ranska:nom, espanja:nombre, portugali:nome, venäjä:имя (imya), arabia:(ism), per:(esm), suahili:nomino|
...
|**naw**|yhdeksän|hindi:नौ (nau), urdu:(nau)|
...
|**nenomesoden**|päivämäärä|yleiskiina:年月日 (niányuèrì), japani:年月日 (nengappi), korea:연월일 (yeonworil)|
|**nes**|saari|kreikka:νήσος (nēsos), malaiji:nusa, mlg:nosy|
|**nete**|verkko|englanti: net, deu: Netz|
|**niama**|nauttia (syödä, juoda)|khmer:ញ៉ាំ (nyam), jam:nyam, srn:nyan, ful:nyami, + espanja:ñam, venäjä:ням (nyam), italia:gnam, englanti:yum, korea:냠냠 (nyamnyam), unkari:nyam|
...
|**nol**|nolla (ei yhtään)|venäjä:ноль (nol'), malaiji:nol, deu:null, englanti:null|
...
|**nur**|valo|arabia:persia:(nūr), suahili:nuru|
...
|**onor**|kunnioitus (arvostus)|englanti:puola:espanja:honor, ranska:honneur, portugali:honra, italia:onore, turkki:onur|
|**or**|korva|yleiskiina:耳 (ěr), englanti:ear, deu:Ohr, ranska:oreille, portugali:orelha, espanja:oreja|
|**oranje**|appelsiini|englanti:orange, espanja:naranja, portugali:laranja, hindi:नारंगी (narangi), japani:(orenji), + ranska:orange, Rus:оранжевый (oranževiy)|
...
|**oton**|syksy (syys)|ranska:automne, espanja:otoño, portugali:outono, englanti:autumn|
...
|**papagay**|papukaija|arabia:(babbaḡāʾ), turkki:papağan, espanja:papagayo, portugali:papagaio, deu:Papagei, unkari:papagáj, venäjä:попугай (popugay)|
|**papay**|papaija|englanti:espanja:turkki:papaya, ranska:papaye, suahili:papai, portugali:papaia, venäjä:папайя (papayya), japani:パパイヤ (papaiya), korea:파파야 (papaya), Hin:पपीता (papītā), bangla:পেঁপে (pẽpe)|
...
|**pasporte**|passi|englanti:passport, ranska:passeport, espanja:pasaporte, Por:passaporte, venäjä:паспорт (pasport), hindi:पासपोर्ट (pāsporṭ), bangla:পাসপোর্ট (pasporṭ), malaiji:paspor, suahili:paspoti, Jpn:パスポート pasupōto)|
|**paste**|tahna (tahdas)|englanti:deu:paste, venäjä:(pasta), espanja:portugali:pasta|
...
|**paxia**|kipu (tuska)|kon:mpasi, portugali:paixão, englanti:passion|
...
|**pelpel**|perhonen|kat:პეპელა (ṗeṗela), mao:pēpepe, suahili:kipepeo, bul:пеперуда (peperuda), yoruba:labalábá|
...
|**petre**|kivi (murikka)|hindi:पत्थर (patthar), urdu:(patthar), italia:pietra, portugali:pedra, espanja:piedra|
|**pexe**|ammatti|persia:(piše), hindi:पेशा (peśā), bangla:পেশা (peśa)|
|**pey**|maksu|englanti:pay, ranska:paye, + yleiskiina:费 (fèi)|
...
|**pin**|neula|englanti:pin, japani:ピン (pin), korea:핀 (pin), hindi:पिन (pin)|
|**ping**|litteä|yleiskiina:平 (píng)|
...
|**pir**|tuli|englanti:ranska:pyro-, portugali:espanja:piro-, venäjä:пиро- (piro-)|
|**piram**|pyramidi|englanti:pyramid, + arabia:(haram)|
...
|**pol**|paljon (monta)|kreikka:πολλοί (polloí), englanti:ranska:deu:poly-, espanja:portugali:poli-, venäjä:поли- (poli-)|
|**polaw**|pilahvi|persia:(polou), hindi:पुलाव (pulav), turkki:pilav, venäjä:плов (plov)|
...
|**pote**|muta (kura, lieju)|ijo:pọtọ, igbo:potọ potọ, Lin:pɔtɔpɔ́tɔ, kon:pcm:ranska:poto-poto|
...
|**preda**|edeltää (tulla ennen)|venäjä:п(е)ред (p(e)red), puola:przed, englanti:espanja:portugali:pre-, ranska:pré-|
...
|**projete**|hanke (projekti)|ranska:projet, portugali:projeto, englanti:project, espanja:proyecto, venäjä:проект (proyekt), hindi:प्रोजैक्ट (projaikṭ), Ben:প্রজেক্ট (prôjekṭ), japani:プロジェクト (purojekuto), korea:프로젝트 (peurojekteu), turkki:proje|
|**puding**|vanukas|englanti:pudding, yleiskiina:布丁 (bùdīng)|
|**puje**|palvonta|hindi:पूजा (pūjā), urdu:(pūjā), thai:บูชา (bucha), malaiji:puja|
|**pul**|kukka|hindi:फूल (phul), bangla:ফুল (phul)|
|**pulmon**|keuhko|espanja:pulmón, ranska:poumon, portugali:pulmão, englanti:pulmonic|
|**pulte**|silta|hindi:पुल (pul), bangla:পুল (pul), urdu:(pul), persia:(pol), portugali:ponte, ranska:pont, espanja:puente|
...
|**pute**|lapsi (jälkeläinen)|thai:บุตร (but), hindi:पूत (pūt), पुत्र (putra), bangla:পুত্র (putr), Pnb:ਪੁੱਤ (putt), ਪੁੱਤਰ (puttar), malaiji:putera, telugu:పుత్రుడు (putruḍu)|
...
|**rang**|väri|bangla:রং (rông), hindi:रंग (raṅg), urdu:(raṅg), persia:(rang), telugu:రంగు (raṅgu), suahili:rangi, lin:lángi, turkki:renk|
...
|**ray**|mielipide (näkemys)|arabia:(raʾy), persia:(ra'y), hindi:राय (rāy), turkki:rey|
...
|**rize**|juuri|kreikka:ρίζα (riza), englanti:ranska:rhizo-, portugali:espanja:rizo-, venäjä:ризо- (rizo-)|
|**robote**|robotti|englanti:robot;robo-, portugali:robô, ranska:robot, tamili:ரோபோ (rōpō), venäjä:робот (robot)|
...
|**ruholojia**|psykologia|turkki:ruh bilimi, hindi:मनोविज्ञान (manovigyān), bangla:মনোবিজ্ঞান (mônobiggan), malaiji:ilmu jiwa, arabia:(ʿilm an-nafs), deu:Seelenkunde, englanti:psychology, espanja:psicológia|
...
|**sa**|kanssa (luona, -lla, -ssa)|suahili:na, lin:kon:na, venäjä:на (na)|
|**sabe**|syy|heb:(sibá), hausa:sabo;sababi, kon:sambu, arabia:urdu:(sabab), turkki:sebep, malaiji:sebab, suahili:sababu|
...
|**safar**|matka (reissu)|arabia:(safar), hindi:सफ़र (safar), Tur:sefer, suahili:safari, englanti:ranska:espanja:portugali:deu:safari|
...
|**sake**|pussi (säkki, kassi, laukku)|deu:englanti:sack, ranska:sac, espanja:portugali:saco, malaiji:kon:saku|
|**sal**|suola|portugali:espanja:sal, englanti:salt, venäjä:соль (solʹ)|
|**salade**|salaatti|ranska:salade, end:malaiji:salad, deu:Salat, venäjä:салат (salat), turkki:salata, persia:urdu:(salād), hindi:सलाद (salād), kantoninkiina:沙律 (saa1 leot62),  yleiskiina:沙拉 (shālā), portugali:salada, espanja:ensalado, korea:샐러드 (saelleodeu), japani:サラダ (sarada), thai:สลัด (salat), khmer:សាលាដ (saalaat)|
...
|**saman**|taivas|arabia:(samāʾ), amhara:ሰማይ (sämay), oromo:samii, hausa:sama, yoruba:sánmà, hindi:आसमान (āsmān), persia:pandzabi:urdu:(āsmān)|
|**sami**|sama|malaiji:sama, hindi:सम (sam), englanti:same, venäjä:самый (samyy), ranska:semblable|
|**samude**|meri|khmer:សមុទ្រ (saʾmot), thai:สมุทร (samut), hindi:समुद्र (samudra), urdu:(samandar), malaiji:samudra, bangla:সমুদ্র (sômudr), gujarati:સમુદ્ર (samudra), telugu:సముద్రము (samudramu), burma:သမုဒ္ဒရာ (samuddara)|
...
|**santi**|pyhä|portugali:espanja:santo, englanti:ranska:saint, kon:santu, yleiskiina:圣 (shèng)|
|**sapate**|kenkä|espanja:zapato, portugali:sapato, malaiji:sepatu, suahili:sapatu|
|**sar**|pää|persia:(sar), hindi:सिर (sir), arabia:(raʾs)|
...
|**sel**|solu|malaiji:sel, persia:sellul, thai:เซลล์ (seel), suahili:seli, filippiini:selula, englanti:cell, ranska:cellule, espanja:célula|
|**sem**|seitsemän (7)|venäjä:семь (semʹ)|
|**seman**|viikko|espanja:portugali:semana, ranska:semaine|
...
|**sen**|lava (näyttämö)|ranska:scène, espanja:escena, venäjä:сцена (scena), deu:Szene, turkki:sahne, persia:(sahne)|
...
|**sihate**|terveys|arabia:صحة (siha), hindi:सेहत (sehata), bangla:সুস্থ (sustha), pan:ਸਿਹਤ (sihata), turkki:sıhhat, malaiji:sihat|
...
|**silsil**|ketju|hindi:सिलसिला (silsilā), arabia:(silsila), turkki:silsile, suahili:silisili|
...
|**soke**|sukka|deu:Socke, englanti:sock, suahili:soksi, zul:isokisi, japani:ソックス (sokkusu), venäjä:носок (nosok)|
...
|**sos**|kastike (soosi)|englanti:ranska:sauce, venäjä:соус (sous), hindi:सॉस (sos), deu:Soße, vietnami:xốt, japani:ソース (sōsu), that:ซอส (soot), korea:소스 (soseu), malaiji:saus|
...
|**suan**|hapan (kirpeä)|yleiskiina:酸 (suān)|
...
|**supris**|yllätys|englanti:surprise, turkki:sürpriz, persia:(surpris), venäjä::сюрприз (siurpriz), portugali:surpresa, espanja:sorpresa|
...
|**suy**|vesi|yleiskiina:水 (shuǐ), japani:(sui), vietnami:thuỷ, + turkki:su|
...
|**tafun**|myrsky|yleiskiina:大风 (dàfēng), kantoninkiina:大風 (daai6fung1), korea:태풍 (taepung), japani:台風 (taifuu), thai:ไต้ฝุ่น (taifun), arabia:(ṭūfān), persia:urdu:(tufān), hindi:तूफ़ान (tūfān), pandzabi:ਤੂਫ਼ਾਨ (tūfān), portugali:tufão, espanja:tifón, ranska:typhon, englanti:typhoon, venäjä:тайфун (tayfun)|
|**takse**|taksa (vero)|englanti:tax, portugali:taxa, espanja:tasa, hindi:टैक्स (ṭEks)|
|**tamar**|taateli|portugali:tamara, arabia:(tamar)|
|**tambur**|rumpu|suahili:sna:kon:ngoma, nya:ng'oma, + yleiskiina:鼓 (gǔ)|
|**tami**|ahne|arabia: طَمَّاع‎ (ṭammāʿ), yleiskiina:贪 (tān), korea:탐욕 (tamyok), vietnami:tham|
|**tan**|itse|hindi:marathi:तन (tan), persia:urdu:(tan), taj:тан (tan), thai:ตน (ton), vietnami:thân, kantoninkiina:親 (can3)|
...
|**tataw**|tatuointi|sam:tah:tatau, haw:kākau, malaiji:tato, englanti:tattoo, ranska:tatouage, espanja:tatuaje, venäjä:тату (tatu)|
...
|**tin**|kolme (3)|hindi:तीन (tīn), bangla:তিন (tin), urdu:(tīn)|
|**ting**|pysähdys|yleiskiina:停 (tíng), kantoninkiina:停 (ting4)|
...
|**totol**|kalkkuna|nah:totolin, espanja:totol, yoruba:tòlótòló, igbo:torotoro|
|**towal**|pyyhe|englanti:towel, espanja:toalla, portugali:toalha, hindi:तौलिया (tauliyā), bangla:তোয়ালে (toyale), filippiini:tuwalya, japani:タオル (taoru)|
...
|**tube**|putki (tuubi)|espanja:portugali:tubo, englanti:ranska:tube, japani:チューブ (chūbu), zul:ithumbu|
...
|**vejetoniamiste**|kasvissyöjä|englanti:vegetarian, ranska:végétarien, portugali:espanja:vegetariano, venäjä:вегетарианец  (vegetarianets), turkki:vejetaryen, japani:ベジタリアン (bejitarian)|
...
|**vin**|viini|ranska:vin, espanja:vino, venäjä:вино (vino), englanti:wine, deu:Wein, hindi:वाइन (vāin), japani:ワイン (wain)|
...
|**virusolojia**|virologia|puola:wirusologia, venäjä:вирусология (virusologiya)|
...
|**vokal**|vokaali|espanja:vocal, portugali:vogal, malaiji:vokal|
...
|**wal**|seinä (muuri)|englanti:wall, venäjä:вал (val), portugali:valo|
|**wan**|halu (toive)|englanti:want, korea:원하다 (wonhada)|
...
|**wayodexi**|ulkomaalainen|hindi:(videśī), telugu:(vidēśi), yleiskiina:外国的 (wàiguóde)|
...
|**win**|voitto|englanti:win, deu:gewinnen|
...
|**xam**|ilta|hindi: शाम (śām), persia:(šām), turkki:akşam|
|**xaman**|šamaani|venäjä:шаман (šaman), englanti:shaman|
|**xan**|vuori (mäki)|yleiskiina: 山 (shān), korea: 산 (san), vietnami:sơn|
...
|**xatan**|paholainen (saatana, piru)|arabia:(šayṭān), hindi:शैतान (śaitān), turkki:şeytan, persia:(šaytān), suahili:Shetani, englanti:ranska:deu:vietnami:Satan, espanja:Satán, portugali:Satã, venäjä:Сатана (Satana), yleiskiina:撒但 (Sādàn), thai:ซาตาน (satan), korea:사탄 (satan), japani:サタン (satan), malaiji:Setan|
...
|**xey**|asia|arabia:(šayʾ), turkki:şey, + yleiskiina:事 (shì), kantoninkiina:事 (si6)|
|**xeyohal**|tilanne (asiaintila)|yleiskiina:事态 (shìtài), japani:事態 (jitai), englanti:state of affairs, ranska:état des choses|
|**xibay**|epäonnistuminen|yleiskiina:失败 (shībài), japani:失敗 (shippai), korea:실패 (šilpæ), vietnami:thất bại|
...
|**xix**|hiljainen (hys, shhh)|englanti:shh, yleiskiina: (xū), venäjä:ш-ш-ш, turkki:sus|
...
|**xow**|näytös (esitys, show)|englanti:deu:ranska:espanja:portugali:show, venäjä:шоу (šou), turkki:şov, suahili:shoo, thai:โชว์ (choo), korea:쇼 (syo), japani:ショー (shō), yleiskiina:秀 (xiù)|
|**xudu**|pitäisi|englanti:should|
|**xukar**|sokeri|arabia:(sukkar), suahili:sukari, portugali:açúcar, espanja:azúcar, Hin:शक्कर (śakkar), bangla:শর্করা (śôrkôra), turkki:şeker, Tam:சக்கரை (cakkarai)|
...
|**zay**|kuluva (tämänhetkinen)|yleiskiina:在 (zài), japani:在 (zai), vietnami:tại|
...
|**zeze**|kärpänen|tsw:sot:tsetse, lin:kon:nzinzi, suahili:nzi, ber:izi, sna:nhunzi, igbo:ijiji, yoruba:eṣinṣin|
|**zikur**|zikkurat|arabia:(ziqqūra), deu:Zikkurat, venäjä:зиккурат (zikkurat)|
...
|**ziran**|juustokumina (jeera)|bangla:জিরা (zīra), hindi:ज़ीरा (zīrā), tamili:சீரகம் (sīrakam), suahili:mjira, persia:(zire), yleiskiina:孜然 (zīrán)|
|**ziza**|sihistä|yleiskiina:zizi englanti:sizzle|
|**zombe**|zombi|kon:nzambi, Por:zumbi, englanti:zombi, malaiji:zombi, hindi:ज़ोंबी (zombī)|
