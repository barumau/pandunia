...
|**abace**|aakkoset (ABC)|kreikka:(alphabētos), espanja:abecedario, persia:(alefbâ), arabia:(abjad), unkari:ábécé|
...
|**aciy**|atsii|espanja:achís, yleiskiina: 阿嚏 (ātì), korea:에취 (echwi), venäjä:апчхи, vietnami:hắt xì, englanti:achoo, ranska:atchoum|
...
|**aksente**|painotus (aksentti)|italia:accento, espanja:portugali:acento, puola:akcent, englanti:ranska:accent|
|**alge**|levä|deu:Alge, ranska:algue, turkki:alg, persia:(âlg), englanti:espanja:portugali:puola:alga|
|**ali**|muu (toinen)|kreikka:άλλος (állos), latina:alius, englanti:allo-, portugali:espanja:alo-|
|**alkole**|alkoholi|ranska:alcool portugali:álcool espanja:alcohol englanti:alcohol hindi: arabia:(kuhul), venäjä:алкоголь (alkohol), puola:alkohol|
|**almare**|kaappi|hindi:अलमारी (almārī), bangla:আলমারি (almari), malaiji:lemari, espanja:armario, portugali:armário|
...
|**atlanti mare**|Atlantin valtameri|englanti:Atlantic, espanja:Atlántico, portugali:Atlântico, venäjä:Атлантический океан (Atlanticheskyy okean), suahili:Atlantiki|
...
|**ban (bane)**|kerta (vuoro)|korea:번 (beon), vietnami:bận, japani:番 (ban), yleiskiina:遍 (biàn), + hindi:बार (bār), urdu:persia:(bār), bangla:বার (bar)|
...
|**barya**|estää kulku|englanti:bar|
...
|**daymare**|valtameri|vietnami:đại dương, korea:대양 (daeyang), japani:大洋 (taiyō), yleiskiina:大洋 (dàyáng), thai:มหาสมุทร (mahasamut), hindi:महासागर (mahāsāgar)|
...
|**eskulta**|veistää kuvaa|englanti:sculpt, espanja:esculpir, ranska:sculpter|
...
|**filia**|tykkääminen|englanti:ranska:philia, portugali:espanja:filia, venäjä:филия (filiya)|
...
|**garda**|vartioida (vahtia)|englanti:guard, espanja:portugali:guardar, ranska:garder|
...
|**gida**|ohjata (ohjastaa)|englanti:guide, espanja:portugali:guiar + arabia:قَادَ‎ (qāda)|
...
|**guhe**|luola|bangla:গুহা (guha), thai:คูหา (gūhā), telugu:గుహ (tguha), hindi:गुफ़ा (gufā), malaiji:gua|
...
|**gundarme**|hyve|thai:คุณธรรม (gunnadam), hindi: urdu: tamili: telugu: burma: malaiji:|
|**gundene**|palatsi|yleiskiina:宫殿 (gōngdiàn), vietnami:cung điện, japani:宮殿 (jyūden), korea:궁전 (gungjeon)|
|**gune**|laatu (laadukkuus, erinomaisuus, hyvyys)|hindi:गुण (guṇ), bangla:গুণ (guṇ), telugu:(guṇamu), burma:ဂုဏ် (gun), malaiji:guna, thai:คุณ (kun)|
...
|**haye**|elämä|arabia:حياة‎ (ḥaya), suahili:uhai, hindi:हयात (hayāt), malaiji:hayat|
...
|**jengxute**|kamppailulaji|yleiskiina:武术 (wǔshù), japani:武術 (bujutsu), vietnami:võ thuật, korea:무술 (musul), englanti:martial art|
...
|**jive**|biologinen elämä|hindi:marathi:जीव (jīv), bangla:জীউ (jiu), pan:ਜੀਓ (jīo), gujarati:જીવ (jīv), malaiji:jiwa, thai:ชีว (chiiu)|
...
|**karawe**|kumina|arabia:(karāwiya), englanti:caraway, ranska:carvi, espanja:alcaravea, portugali:alcaravia|
|**karde**|kortti|englanti:card, japani: カード (kādo), suahili: kadi, yleiskiina:卡 (kǎ), deu:Karte, malaiji:kartu, ranska:carte|
|**kare**|työ (tehtävä)|malaiji:karya, hindi:कर्म (karma), urdu:(karm), pandzabi:ਕਰਮ (karm), kannada:tamili:telugu:(karma), englanti:deu:ranska:espanja:portugali:karma, khmer:កម្ម (kam), burma:ကံ (kam), thai:กรรม (kam), venäjä:карма (karma) |
...
|**karite**|voipuu|wolof:kaarite, ranska:espanja:karité, fulani:kaare, kareje, hausa:kaɗanya|
|**karlekse**|verbi (teonsana)|hindi:क्रिया (kriyā), bangla:ক্রিয়া (kriya), telugu:క్రియ (kriya), khmer:កិរិយា (keriyaa), thai:กริยา (grì-yaa), malaiji:kata kerja|
|**karote**|porkkana|englanti:carrot, ranska:carotte, deu:Karotte, suahili:karoti, malaiji:karot|
|**karvane**|karavaani (saattue)|persia:urdu:(kârvân), turkki:kervan, hindi:कारवाँ (kārvā̃), englanti:caravan, deu:Karawane, ranska:caraven, espanja:portugali:caravana, puola:karawana, venäjä:караван (karavan), filippiini:karabana, japani:キャラバン (kyaraban), korea:카라반 (karaban)|
|**kase**|tapaus (seikka)|englanti:case, ranska:cas, espanja:portugali:caso, deu:Kasus|
|**kastane**|kastanja|espanja:castaňa, arabia:(kastanāʾ), turkki:kestane, venäjä:каштан (kaštan)|
|**kastore**|majava|ranska:portugali:espanja:castor, filippiini:turkki:kastor|
...
|**kawayi**|söpö (suloinen)|japani:可愛い (kawaii), korea:카와이 (kawai), englanti:kawaii|
|**kaxe**|kassa|deu:Kasse, venäjä:касса (kassa), englanti:case,cash, suahili:kasha, portugali:caixa, espanja:caja|
|**kayi**|auki (avoin)|yleiskiina:开 (kāi), vietnami:-khai-|
|**ke**|mikä? (mitä?)|espanja:qué, portugali:ranska:que, + bangla:কে  (ke)|
...
|**keke**|kakku (keksi)|suahili:keki, japani:ケーキ (kēki), englanti:cake, arabia:(kaʿka), turkki:kek, hindi:केक (kek), deu:Keks, venäjä:кекс (keks)|
|**kele**|urheilu|hindi:खेल (khel), bangla:খেলা (khela), thai:กีฬา (kīlā), khmer:កីឡា (keila)|
|**kelele**|meteli|suahili:Kongo:makelele|
|**kenare**|reuna (ääri)|turkki:kenar, hindi:किनारा (kinārā), urdu:(kanārā)|
...
|**ketele**|kattila|englanti:kettle, venäjä:котёл (kot’ol), hindi:केतली (ketlī), bangla:কেতলি (ketli), malaiji:ketel|
|**kexe**|hius (karva, tukka, hiukset)|japani:毛 (ke), hindi:केश (keś), urdu:(keś), pandzabi:ਕੇਸ਼ (keś), telugu:(kēśamu), kannada:(kēśa)|
|**kimia**|kemia|arabia:(kīmiyāʾ), malaiji:kimia, suahili:kemia, turkki:kimya, ranska:chimie, espanja:portugali:química, venäjä:химия (himiya)|
...
|**kirmi**|punainen|arm:կարմիր (karmir), turkki: kırmızı, fas(qermez), arabia:(qirmiz), + englanti:crimson, ranska:carmin, portugali:carmim, espanja:carmín, hindi:क़िरमिज़ (qirmiz)|
|**kitabe**|kirjoitus (teksti)|arabia:urdu:(kitāb), persia:(ketâb), turkki:kitap, malaiji:kitab, suahili:kitabu, hindi:किताब (kitāb)|
|**kiwe**|kiivi|englanti:kiwi|
|**klari**|selvä (selkeä)|deu:klar, espanja:portugali:claro, englanti:clear, ranska:clair|
|**klase**|luokka (kategoria)|englanti:class, espanja:clase, portugali:ranska:classe, venäjä:класс (klass), کلاس‎ (kelâs), malaiji:kelas, japani:クラス (kurasu)|
|**klime**|ilmasto|kreikka:κλίμα (eklíma), espanja:portugali:clima, arabia:(ʾiqlīm), malaiji:turkki:iklim, englanti:climate, venäjä:климат (klimat)|
|**klone**|klooni (identtinen kopio)|en:portugali:ranska:clone, espanja:clon venäjä:клон (klon), malaiji:klon, japani:クローン (kurōn)|
...
|**kolume**|pylväs (pilari)|englanti:column, espanja:columna, portugali:coluna, ranska:colonne, venäjä:колонна (kolonna), puola:kolumna|
|**komali**|pehmeä|hindi:कोमल (komal), telugu:కోమలము (kōmalamu), khmer:កោមល (kaomɑl)|
|**komande**|käsky (komento)|englanti:command, ranska:commandement, venäjä:команда (komanda), espanja:mandato|
...
|**koncunge**|hyönteinen (ötökkä)|yleiskiina:昆蟲 (kūnchóng), kantoninkiina:昆蟲 (kwan1 cung4), nan:昆蟲 (khun-thiông), japani:昆蟲 (konchū)|
|**konfuze**|Kungfutse|yleiskiina:孔夫子 (Kǒng Fūzǐ)|
|**konge**|reikä|yleiskiina:孔 (kǒng), kantoninkiina:孔 (hung2), wu-kiina:孔 (khon2), japani:孔 (kō), korea:공 (gong), vietnami:hỏng|
...
|**konuse**|kartio (keila)|englanti:portugali:cone, espanja:cono, ranska:conique, venäjä:ко́нус (kónus), turkki:koni, malaiji:kon|
|**kope**|kuppi (muki)|ranska:coupe, turkki:kupa, arabia:(kūb), espanja:copa, englanti:cup, hindi:कप (kap), japani:コップ (koppu), korea:컵 (keop)|
|**kopiye**|kopio|englanti:copy, yleiskiina:拷貝 (kǎobèi)|
|**kore**|kuoro|espanja:coro, turkki:koro, englanti:chorus, hindi:कोरस (koras), arabia:(korāl)|
|**korne**|sarvi|ranska:corne, portugali:corno, englanti:horn, arabia:(qarn)|
|**korone**|kruunu|ranska:couronne, englanti:crown, espanja:corona, japani:クラウン (kuraun), venäjä:корона (korona), portugali:coroa|
...
|**koy (koyi)**|jokin (joku)|hindi:कोई (koī), urdu:(koī), venäjä:кое- (koye-)|
...
|**kulture**|kulttuuri|englanti:ranska:culture, espanja:portugali:cultura, venäjä:культу́ра (kulʹtúra), turkki:kültür, japani:カルチャー (karuchā)|
|**kunane**|vaikeus (hankaluus)|yleiskiina:困难 (kùnnán), japani:困難 (konan), vietnami:khốn nạn, korea:곤란 (gollan)|
|**kupe**|kupoli (holvikatto)|persia:(koppe), arabia:(qubba), turkki:kubbe, malaiji:kubah, venäjä:купол (kupol), espanja:cúpula, deu:Kuppel|
|**kupone**|kuponki|englanti:ranska:coupon, espanja:cupón, portugali:cupom, venäjä:купо́н (kupón), malaiji:kupon, japani:クーポン (kūpon), korea:쿠폰 (kupon)|
|**kura**|hoitaa (pitää huolta)|englanti:cure, espanja:portugali:curar, ranska:guérir, deu:kurieren|
|**kurbe**|mutka (kurvi)|ranska:courbe espanja:portugali:curva, englanti:curve, eus:kurba|
|**kurse**|tuoli|arabia:(kursiy), hindi:कुरसी (kursī), urdu:(kursī), pandzabi:ਕੁਰਸੀ (kursī), telugu:(kurcī), malaiji:som:kursi, persia:(korsi)|
|**kuxi**|mukava (kiva, miellyttävä)|bangla:খুশি (khuśi), hindi:ख़ुश (xuś), englanti:cushy|
...
|**lala**|maata (makoilla)|suahili:-lala|
|**lampe**|lamppu|ranska:deu:lampe, englanti:lamp, malaiji:lampu|
|**lanca**|heittää (paiskata)|englanti:launch, italia:lanciare, portugali:lançar, ranska:lancer, espanja:lanzar, deu:lancieren|
|**langane**|kaide (reelinki)|yleiskiina:栏杆 (lángān), japani:欄干 (rankan), korea:난간 (nan-gan)|
...
|**lasune**|valkosipuli|hindi:लहसुन (lahsun), bangla:রসুন (rôśun), yleiskiina:大蒜 (dàsuàn)|
...
|**laya**|tulla|vietnami: lại, yleiskiina: 来 (lái), japani:来 (rai)|
...
|**lekin (lekino)**|kuitenkin|arabia: لكن (lākin), hindi:लेकिन (lekin), suahili:lakini|
...
|**lete**|kesä (suvi)|ranska:l'été, venäjä:лето (leto)|
|**letise**|lehtisalaatti|englanti:lettuce, japani:レタス (retasu), hausa:latas, hindi:लेटिष (leṭiṣ), bangla:লেটুস (leṭus), ranska:laitue|
|**lewo**|jo (tehty teko)|thai:แล้ว (lɛːw), yleiskiina:了 (le), wu-kiina:了 (lə'), hakkakiina:了 (le), kantoninkiina:了 (liu)|
...
|**lida**|johtaa|englanti:lead, portugali:liderar|
...
|**lifafe**|kääre (kuori)|arabia:(lifāfa), persia:(lefâf), hindi:लिफ़ाफ़ा (lifāfā)|
...
|**lil (lili)**|pieni (pienesti, vähän)|englanti:little|
...
|**loge**|puhe (sanat)|kreikka:λόγος (logos), englanti:-logue, persia:(loğat), arabia:(luğa), hindi:लुग़त (luġat), suahili:lugha, turkki:lügat, malaiji:logat|
...
|**lone**|väittely (debatti)|yleiskiina:论 (lùn), kantoninkiina:論 (lœn6), korea:론 (ron), japani:論 (ron), vietnami:luận|
|**longi**|pitkä|englanti:ranska:long, deu:lang, portugali:longo|
|**lose**|ruuvi|yleiskiina:螺丝 (luòsī), kantoninkiina:螺絲 (lo4 si1)|
|**lote**|erä (satsi)|portugali:espanja:lote, englanti:ranska:lot|
|**lowa**|vuotaa|yleiskiina:漏 (lòu)|
|**lugi**|vihreä|yleiskiina:绿 (lǜ), kantoninkiina:綠 (luk6), vietnami:lục, korea:록/녹 (rok/nok), japani: 緑色 (ryokushoku)|
|**lule**|helmi|amharabia:ሉል (lul), ara:(luʾluʾa), suahili:lulu, oromo:lu'ulu'a, hausa:lu'ulu'u, fulani:luuluuri, persia:(lo'lo')|
|**lune**|kuu|ranska:lune, espanja:luna, englanti:lunar, venäjä:луна (luná)|
|**lunge**|itämainen lohikäärme|yleiskiina:龙 (lóng), kantoninkiina:龍 (lung4), vietnami:rồng,long, korea:용 (yong), 룡 (ryong), jon:竜 (ryū)|
...
|**luza**|hävitä (kärsiä tappio)|englanti:lose, pon:luhs|
|**maca**|sopia|englanti:match, sve:matcha, korea:맞다 (matda)|
...
|**maidane**|kenttä (aukio)|arabia:(maydān), persia:(meydan), hindi:मैदान (maidān), turkki:meydan, suahili:medani, venäjä:майдан (maydan)|
|**maise**|maissi|englanti:maize, espanja:maíz, ranska:maïs, venäjä:маи́с (maís)|
|**makale**|artikkeli (kirjoitus)|arabia:مَقَال‎ (maqāl), turkki:makale, suahili:makala, persia:مقاله‎ (maqâle), malaiji:makalah|
|**makane**|voi|hindi:मक्खन (makkhan), bangla:মাখন (makhôn), pan:ਮੱਖਣ (makhaṇa), marathi:माखण (mākhaṇ), gujarati:માખણ (mākhaṇ)|
|**makase**|sakset|arabia:(maqaṣ), turkki:makas, suahili:mkasi, oromo:maqasii, hausa:almakashi, yoruba:àlùmogàjí|
...
|**mamale**|nisäkäs|englanti:mammal, espanja:portugali:mamífero, ranska:mammifère, turkki:memeli, malaiji:mamalia|
|**mame**|äiti (emä)|espanja:mamá, ranska:maman, englanti:suahili:mama, venäjä:мама (mama), yleiskiina: 妈妈 (māma), japani:ママ (mama), korea:엄마 (eomma), vietnami:má, bangla:মা (ma), hindi:मां (mã)|
|**man (mane)**|uros (mies)|englanti:man, deu:Mann, hindi:मानुस (mānus), bangla:মানুষ (manuś), pan:ਮਨੁੱਖ (manukh), marathi:माणूस (māṇūs), tamili:மனிதன் (maṉitaṉ) + yleiskiina:男 (nán), japani:男 (nan)|
|**mandire**|temppeli|hindi:मन्दिर (mandir), bangla:মন্দির (môndir), gujarati:મંદિર (mandir)|
|**mange**|mango|malaiji:mangga, portugali:manga, englanti:mango|
|**manioke**|kassava (maniokki)|englanti:ranska:manioc, espanja:portugali:mandioca, venäjä:манио́ка (manióka)|
|**manire**|käytös (käyttäytyminen, tapa, tavat)|ranska:manière, englanti:manner, venäjä:манера (manyera), japani:マナー (manā), espanja:manera, portugali:maneira, deu:Manieren|
...
|**maratone**|maratoni|englanti:marathon, espanja:maratón, portugali:maratona, venäjä:марафо́н (marafón), turkki:maraton, arabia:مَارَاثُون‎ (mārāṯūn), hindi:मैराथन (mairāthan), bangla:ম্যারাথন (mjarathôn), yleiskiina:马拉松 (mǎlāsōng), japani:マラソン (marason)|
|**marca**|kävely (marssi)|englanti:march, ranska:marche, espanja:marcha, venäjä:марш (marš)|
|**mare**|meri|italia:mare, espanja:portugali:mar, ranska:mer, deu:Meer, venäjä:море (more), puola:morze|
...
|**marmare**|marmori|hindi:संगमरमर (saṅgmarmar), espanja:marmól, portugali:mármore, venäjä:мрамор (mramor), malaiji:marmer, turkki:mermer|
...
|**masle**|asia (juttu)|arabia:(masʾala), hausa:matsala, hindi:मसला (maslā), malaiji:masalah|
...
|**mate**|aine (materia)|englanti:matter, espanja:portugali:materia, ranska:matière, venäjä:материя (materiya), deu:Materie, malaiji:materi, + arabia:(mādda), urdu:(māda), turkki:madde, persia:(mādde), + kantoninkiina:物 (mat), vietnami:vật|
|**matike**|matematiikka (matikka)|deu:Mathe(matik), englanti:math(ematics), espanja:matemática, venäjä:математика (matematika)|
|**maturi**|kypsä (aikuinen)|englanti:ranska:mature, espanja:portugali:maduro|
|**maw (mawe)**|kissa|yleiskiina:猫 (māo), kantoninkiina:貓 (maau), vietnami:mèo, suahili:nyau|
|**max (maxo)**|enemmän|espanja:mas, portugali:mais, englanti: max-|
|**maxime**|maksimi (enimmäismäärä)|englanti:ranska:maximum, portugali:espanja:máximo, venäjä:максимум (maksimum), malaiji:maksimum|
|**maxine**|kone|ranska: machine, englanti: machine, deu: Maschine, malaiji: mesin|
|**maxori**|enemmistö-|ranska: majeur, englanti: major, espanja: mayor|
|**maxoria**|enemmistö|espanja: mayoría|
|**maye**|muurahainen|yleiskiina:蚂蚁 (mǎyǐ), kantoninkiina:螞蟻 (maa5 ngai5)|
...
|**medale**|mitali|englanti:medal, espanja:medalla, portugali:medalha, ranska:médaille, venäjä:меда́ль (medálʹ), hindi:मेडल (meḍal), bangla:মেডেল (meḍel), turkki:madalya, japani:メダル (medaru)|
...
|**megame**|pilvi|hindi:मेघ (megh), bangla:মেঘ (megh), tamili:மேகம் (mēgam), telugu:మేఘము (mēghamu), malaiji:mega, thai:เมฆ (mek)|
|**mehe**|lammas|hindi:मेष (meṣ), persia:(miš), thai:เมษ (met), + lingala:Kongo:meme, japani:メーメー (mē mē), portugali:meh, arabia:(maa'), turkki:mee|
|**mele**|hunaja|portugali:mel, ranska:espanja:miel, kreikka:μέλι (méli)|
...
|**migane**|mandariini|japani:蜜柑 (mikan), yleiskiina:蜜柑 (mìgān)|
...
|**minare**|torni|suahili: mnara, turkki: minare, + englanti:minaret|
...
|**minimalistia**|minimalismi|englanti:minimalism, espanja:portugali:minimalismo, ranska:minimalisme, venäjä:минимали́зм (minimalízm)|
...
|**modele**|malli|englanti:model, espanja:portugali:modelo, ranska:modèle, deu:Modell, venäjä:моде́ль (modelʹ)|
...
|**molia**|mylly|yleiskiina:磨 (mò), ranska:moulin, espanja:molino|
...
|**mono**|vain (ainoastaan)|kreikka:μόνος (monos), englanti:deu:ranska:portugali:espanja:mono-|
...
|**mose**|sammal|englanti:moss, espanja:portugali:musgo, ranska:mousse, deu:Moos, venäjä:мох (mox), hindi:मॉस (mosa)|
|**mosime**|vuodenaika|hindi:urdu:(mOsam), malaiji:musim, arabia:(mawsim), turkki:mevsim, suahili:msimu|
...
|**motogare**|auto (automobiili)|englanti:motorcar, sna:motokari, sot:motokara, suahili:motokaa, zulu:imoto, hausa:mota|
|**motosikle**|moottoripyörä|turkki:motosiklet, espanja:motocicleta, ranska:motocyclette, englanti:motorcycle, venäjä:мотоцикл (mototsikl), yleiskiina:摩托车 (mótuōchē)|
|**mudane**|pioni|yleiskiina:牡丹 (mǔdān), korea:모란 (moran), japani:(botan), vietnami:mẫu đơn|
|**muhe**|nauta (lehmä)|(onom,) englanti:moo, deu:muh, venäjä:му (mu), thai:มอ (mo), hindi:(mū), japani:モーモー (mō mō), yleiskiina:哞 (mōu), turkki:mö|
|**muke**|kasvot (naama)|bangla:মুখ (mukh), hindi:मुख (mukh), tamili:முகம் (mukam), telugu:(mukhamu), malaiji:muka, filippiini:mukha|
|**mule**|juuri|hindi:marathi:मूल (mūl), bangla:মূল (mūl), telugu:మూలము (mūlamu), malaiji:filippiini:mula, khmer:មូល (mul), burma:မူလ (mula), thai:มูล (mun)|
|**multi**|moni (usea)|portugali:muito, englanti:ranska:espanja:multi-, venäjä:мульти- (mulʹti-)|
|**mume**|vaha|turkki:mum, persia:(mum), hindi:मोम (mom), bangla:মোম (mom)|
...
|**muxe**|hiiri|puola:mysz, venäjä:мышь (myś), persia:(muš)|
|**muxing**|Jupiter|yleiskiina:木星 (mùxīng), kantoninkiina:木星 (muk6 sing1), japani:木星 (mokusei)|
|**naber**|profeetta|arabia:(nabiy), hindi:नबी (nabī), malaiji:nabi, suahili:nabii, hausa:annabi, turkki:nebi|
|**naciste**|natsi|venäjä:нацист (natsist), japani:ナチ (nachi), korea:나치 (nachi), portugali:italia:nazista|
|**nade**|joki (virta)|hindi:marathi:नदी (nadī) (nadī), urdu:(nadī), bangla:নদী (nôdī), pandzabi:ਨਦੀ (nadī), gujarati:નદી (nadī), kannada:ನದಿ (nadi), telugu:నది (nadi), tamili:நதி (nati)|
|**nafase**|hengitys (henkäys)|arabia:persia:(nafas), malaiji:napas, turkki:nefes, hausa:numfashi|
...
|**nahune**|kynsi|persia:ناخن‎ (nâxon), hindi:नाख़ुन m (nāxun), bangla:নখ (nôkh), pan:नख (nakh), venäjä:нога́ (nogá)|
|**nam (name)**|nimi|hindi:नाम (nām), persia:pandzabi:urdu:(nām), thai:นาม (naam), malaiji:nama, deu:englanti:name, japani:名前 (namae), ranska:nom|
|**namlekse**|substantiivi (nimisana)|yleiskiina:名词 (míngcí), kantoninkiina:名詞 (ming4 ci4), japani:名詞 (meishi), korea:명사 (myeongsa), hindi:नाम (nām), ranska:nom, espanja:nombre, portugali:nome, venäjä:имя (imya), arabia:(ism), per:(esm), suahili:nomino|
...
|**nen (nene)**|vuosi|japani:年 (nen), yleiskiina:年 (nián), kantoninkiina:年 (nin4), korea:년 (nyeon), vietnami:năm,niên|
|**nenmesdene**|päivämäärä|yleiskiina:年月日 (niányuèrì), japani:年月日 (nengappi), korea:연월일 (yeonworil)|
|**nenufare**|lumme|englanti:nenuphar, espanja:portugali:nenúfar, ranska:nénufar, venäjä:ненюфа́р (nenjufár), persia:نیلوفر آبی‎ (nilufar-e âbi)|
|**nese**|saari|kreikka:νήσος (nēsos), malaiji:nusa, mlg:nosy|
...
|**nixe**|alkovi|ranska:englanti:niche, portugali:nicho, venäjä:ниша (niša)|
...
|**nose**|nenä|englanti:nose, espanja:portugali:nariz, deu:Nase, venäjä:нос (nos), hindi:marathi:नासिका (nāsikā), bangla:নাক (nak), persia:نس‎ (nos)|
...
|**okey (okeyi)**|kelpo (okei)|englanti:okay, espanja:turkki:malaiji:okey, portugali:OK, venäjä:окей (okej), arabia:أُوكِي‎‎‎ (ʾokey), hindi:ओके (oke), yleiskiina:OK (ōukèi), japani:オーケー (ōkē)|
|**onde**|aalto (laine)|espanja:portugali:italia:onda, ranska:onde, malaiji:ombak|
|**onore**|kunnioitus (arvostus)|englanti:puola:espanja:honor, ranska:honneur, portugali:honra, italia:onore, turkki:onur|
...
|**osme**|osmoosi|kreikka:ώσμωση (ósmosi), englanti:malaiji:osmosis, espanja:ósmosis, portugali:ranska:osmose, venäjä:осмос (osmos), persia:تَراران (osmoz)|
|**oste**|luu|englanti:deu:osteo-, venäjä:остео- (osteo-), italia:portugali:osso, ranska:os, hindi:अस्थि (asthi-)|
|**otone**|syksy (syys)|ranska:automne, espanja:otoño, portugali:outono, englanti:autumn|
...
|**pale**|hedelmä|hindi:फल (phal), pandzabi:ਫਲ (phal), bangla:ফল (phal), tamili: பழம் (palam), telugu:(phalamu), thai:ผน-ละ- (phon-la)|
...
|**pang (pange)**|leipä|thai:ปัง (pang), korea:빵 (ppang), khmer:នំប៉័ង (numpang), japani:パン (pan), portugali:pão, espanja:pan, ranska:pain|
...
|**panire**|rahka|hindi:पनीर (panīr), pandzabi:ਪਨੀਰ (panīr), bangla:পনির (pônir), turkki:peynir, englanti:paneer|
...
|**pantalone**|housut|espanja:pantalón, ranska:pantalon, arabia:بنطلون‎ (banṭalōn), hindi:पैंट  (paiṇṭ)|
|**papagaye**|papukaija|arabia:(babbaḡāʾ), turkki:papağan, espanja:papagayo, portugali:papagaio, deu:Papagei, unkari:papagáj, venäjä:попугай (popugay)|
|**papaye**|papaija|englanti:espanja:turkki:papaya, ranska:papaye, suahili:papai, portugali:papaia, venäjä:папайя (papayya), japani:パパイヤ (papaiya), korea:파파야 (papaya), hindi:पपीता (papītā), bangla:পেঁপে (pẽpe)|
|**pape**|isä|englanti:ranska:papa, espanja:papá, venäjä:папа (papa), arabia:(bābā), yleiskiina:爸爸 (bàba), japani:パパ (papa), korea:아빠 (appa), hindi:बाप (bāp),  bangla:বাবা (baba), malaiji:bapa, suahili:turkki:baba|
|**parame**|parametri (argumentti)|englanti:parameter, ranska:paramètre, espanja:portugali:parametro, japani:パラメーター (paramētā), korea:파라미터 (paramiteo)|
...
|**pauze**|tauko (paussi)|englanti:deu:ranska:pause, espanja:portugali:pausa, venäjä:пауза (pauza)|
|**pawe**|pyssy|yleiskiina:炮 (pâo), kantoninkiina:炮 (paau3), vietnami:pháo, korea:포 (po), mon:буу (buu)|
|**paxia**|kipu (tuska)|Kongo:mpasi, portugali:paixão, englanti:passion|
|**pay (paye)**|piirakka (piiras)|englanti:pie, espanja:pay, malaiji:pai, hindi:पाई (pāī), urdu:(pāī), bangla:পাই (pai), japani:パイ (pai), korea:파이 (pai), yleiskiina:排 (pái), kantoninkiina:批 (pai1), persia:(pây)|
|**pedale**|poljin (pedaali)|deu:englanti:espanja:portugali:turkki:pedal, ranska:pédale, venäjä:педаль (pedal'), puola:pedał, japani:ペダル (pedaru), korea:페달 (pedal)|
|**pede**|pieru|bangla:পাদ (pad), hindi:पाद (pād), espanja:pedo, portugali:peido, ranska:pet, venäjä:пердение (perdeniye)|
|**pelmene**|myky (pelmeni, ravioli)|venäjä:пельмень (pel'men'), puola:pielmeni, englanti:pelmeni|
|**pelpele**|perhonen|kat:პეპელა (ṗeṗela), mao:pēpepe, suahili:kipepeo, bul:пеперуда (peperuda), yoruba:labalábá|
|**penda**|roikuttaa|englanti:pendant, portugali:ranska:pender|
|**penise**|siitin (penis)|englanti:turkki:malaiji:penis, espanja:pene, portugali:ranska:pénis, venäjä:пенис (penis)|
|**penta**|maalata|englanti:paint, ranska:peintre|
|**pepine**|kurkku|espanja:portugali:pepino, filippiini:pipino, sin:පිපිඤ්ඤා (pipiññā)|
|**pere**|sulka|hindi:पर (par), persia:urdu:(par), kur:perr, venäjä:перо (pero)|
...
|**petre**|kivi (kallio, murikka)|hindi:पत्थर (patthar), urdu:(patthar), italia:pietra, portugali:pedra, espanja:piedra, ranska:pierre|
|**pexe**|ammatti|persia:(piše), hindi:पेशा (peśā), bangla:পেশা (peśa)|
|**peye**|maksu|englanti:pay, ranska:paye, + yleiskiina:费 (fèi)|
|**piane**|piano|englanti:espanja:portugali:ranska:suahili:malaiji:piano, venäjä:пианино (pianino), turkki:piyano, arabia:بيانو‎ (biyānō), hindi:पियानो (piyāno), bangla:পিয়ানো (piẏano), japani:ピアノ (piano)|
...
|**pijine**|kontaktikieli (pidgin)|englanti:espanja:portugali:ranska:pidgin, venäjä:пиджин (pidzhin), suahili:pijini, yleiskiina:皮欽語 (píqīnyǔ), japani:ピジン (pijin)|
...
|**pinguine**|pingviini|englanti:malaiji:penguin, espanja:pingüino, portugali:pinguim, venäjä:пингвин (pingvin), turkki:penguen, hindi:पेंगुइन (peṅguin), bangla:পেঙ্গুইন (peṅguin), japani:ペンギン (pingin)|
...
|**pistole**|pistooli|englanti:pistol, espanja:portugali:pistola, ranska:pistolet, venäjä:пистолет (pitolet), hindi:पिस्तौल (pistaul), bangla:পিস্তল (piśtôl)|
...
|**plan (plane)**|suunnitelma|englanti:espanja:ranska:plan, portugali:plano, venäjä:план (plan), persia:پلان‎ (plân), hindi:प्लैन (plain), japani:プラン (puran)|
...
|**plume**|luumu|englanti:plum, deu:Pflaume, japani:プラム (pulamu), thai:พลัม (plam)|
|**plus (pluso)**|myös (lisäksi, plus)|englanti:ranska:plus, venäjä:плюс (pl’us)|
|**podia**|Tiibet|tib:བོད (bod, phØ)|
|**poke**|pokeri|englanti:poker, yleiskiina:扑克 (pūkè), japani:ポーカー (pōkā), korea:포커 (pokeo)|
|**polave**|pilahvi|persia:(polou), hindi:पुलाव (pulav), turkki:pilav, venäjä:плов (plov)|
|**poli**|paljon (monta)|kreikka:πολλοί (polloí), englanti:ranska:deu:poly-, espanja:portugali:poli-, venäjä:поли- (poli-)|
|**polise**|poliisi|englanti:ranska:police, portugali:polícia, espanja:policía, venäjä:полиция (policija), turkki:malaiji:polis, suahili:polisi, arabia:بُولِيس‎ (būlīs), hindi:पोलिस (polis), bangla:পুলিশ (puliś)|
...
|**poste**|posti (postilähetys)|englanti:post, portugali:postagem, ranska:poste, venäjä:почта (pochta), arabia:بوسطة‎ (busṭa), persia:پست‎ (post), malaiji:pos|
|**pote**|muta (kura, lieju)|igbo:potọ potọ, lingala:pɔtɔpɔ́tɔ, Kongo:ranska:poto-poto|
...
|**prizone**|vankeus|englanti:ranska:prison, espanja:prisión, portugali:prisão|
|**probleme**|ongelma|englanti:problem, ranska:problème, espanja:portugali:problema, venäjä:проблема (problema), bangla:প্রব্লেম (prôblem)|
...
|**programe**|ohjelma|englanti:malaiji:turkki:program, ranska:programme, portugali:espanja:programa, venäjä:программа (programma), japani:プログラム (puroguramu), korea:프로그램 (peurogeuraem), hindi:प्रोग्राम (progrām), suahili:programu|
...
|**prosese**|prosessi (proseduuri)|englanti:process, espanja:proceso, portugali:processo, venäjä:процесс (process), persia:پروسه‎ (prose), malaiji:proses, japani:プロセス (purosesu), korea:프로세스 (peuroseseu)|
|**pudinge**|vanukas|englanti:pudding, yleiskiina:布丁 (bùdīng)|
|**puje**|palvonta|hindi:पूजा (pūjā), urdu:(pūjā), thai:บูชา (bucha), malaiji:puja|
|**pule**|silta|hindi:पुल (pul), bangla:পুল (pul), urdu:(pul), persia:(pol)|
|**pulmone**|keuhko|espanja:pulmón, ranska:poumon, portugali:pulmão, englanti:pulmonic|
...
|**purani**|vanha (muinainen)|hindi:पुराना (purānā), urdu:(purānā), bangla:পুৰণা (puron), pandzabi:ਪੁਰਾਣਾ (purāṇā)|
|**puri**|täysi|hindi:पूर्ण (pūrn), bangla:পূর্ণ (pūrṇa), pandzabi:ਪੂਰਾ (pūrā), persia:(por)|
|**putawe**|viinirypäle|yleiskiina:葡萄 (pútáo), kantoninkiina:葡萄 (pou4 tou4), wu-kiina:葡萄 (bu dau3), japani:葡萄 (budō), korea:포도 (podo), vietnami:bồ đào|
...
|**putong (putongi)**|yleinen (universaali)|yleiskiina:普通 (pǔtōng), kantoninkiina:普通 (pou2tung1), vietnami:phổ thông, korea:보통 (botong)|
...
|**rander**|höylä|turkki:rende, bul:ренде (rende), ron:rindea, hindi:रंदा, (randâ), persia:(rande), suahili:(randa)|
|**rang (range)**|väri|bangla:রং (rông), hindi:रंग (raṅg), urdu:(raṅg), persia:(rang), telugu:రంగు (raṅgu), suahili:rangi, lingala:lángi, turkki:renk|
...
|**rasme**|tapa (perinne)|arabia:(rasm), hindi:रस्म (rasma), malaiji:resmi|
|**rastu**|kasvaa|ranska:croîter, venäjä:выраста́ть (vyrastat’), bel:расці́ (rascí), persia:رستن‎ (rostan)|
|**ratiba**|järjestää (järjestellä)|arabia:رتب (rattaba)|
|**raye**|mielipide (näkemys)|arabia:(raʾy), persia:(ra'y), hindi:राय (rāy), turkki:rey|
|**razone**|järki (järkeily, päättely)|englanti:reason, espanja:razón, portugali:razão, ranska:raison venäjä:разум (razum)|
|**rebele**|kapina|englanti:rebel, espanja:portugali:rebelde ranska:rebelle|
|**recete**|resepti (ohje)|italia:ricetta, venäjä:рецепт (retsept), deu:Rezept, espanja:receta, portugali:receita, ranska:recette, malaiji:resep|
|**redi**|valmis|englanti:ready, ranska:prêt, mao:reri|
|**rege**|hiekka|persia:(rig), hindi:रेग (reg), urdu:(reg)|
|**ren (rene)**|henkilö|yleiskiina: 人 (rén)|
|**repe**|toisto|englanti:rep(etition), espanja:repetición, + vietnami:lặp|
...
|**rezine**|pihka (hartsi)|englanti:resin, ranska:résine, persia:(rezin), portugali:espanja:resina, turkki:reçine|
|**rezulte**|tulos|englanti:result, espanja:portugali:resultado, ranska:résultat, deu:Resultat, venäjä:результат (rezul’tat)|
...
|**rise**|riisi|tamili:அரிசி (arisi), arabia:(ʾaruzz), espanja:portugali:arroz, oromo:ruuzii, ranska:riz, venäjä:рис (ris), englanti:rice, deu:Reis|
|**riske**|riski|ranska:risque, englanti:turkki:risk, portugali:risco, venäjä:риск (risk), japani:リスク (ja) (risuku), deu:malaiji:risiko|
|**rite**|riitti (rituaali, seremonia)|englanti:ranska:rite, espanja:portugali:rito, bangla:রীতি (rīti), hindi:urdu:(rīti)|
|**ritime**|rytmi|turkki:ritim, englanti:rhythm, ranska:rhythme, espanja:portugali:ritmo, venäjä:ритм (ritm), korea:리듬 (rideum), malaiji:ritme|
|**robote**|robotti|englanti:ranska:espanja:robot, portugali:robô, tamili:ரோபோ (rōpō), venäjä:робот (robot)|
...
|**role**|rooli (osa)|englanti:role, ranska:rôle, deu:Rolle, venäjä:роль (rol’), turkki:rol, kat:როლი (roli), persia:رل‎ (rol)|
|**romansia**|lempi (romanssi, rakkaus)|ranska:englanti:espanja:portugali:romance, turkki:romans, japani:ロマンス (romansu), korea:로맨스 (romaenseu), venäjä:роман (roman)|
...
|**ruhe**|henki (sielu, mieli, psyyke)|arabia:(rūħ), malaiji:ruh, turkki:ruh, hindi:रूह (rūh), suahili:roho, hausa:ruhu, som:ruux, + venäjä:дух (duh)|
...
|**rume**|rommi|englanti:rum, espanja:ron, hindi:रम (ram), venäjä:ром (rom)|
|**rupe**|ilmiasu (ulkonäkö)|hindi:रूप (rūp), malaiji: rupa, thai: รูป (rūp), khmer:រូប (rūp)|
|**rupoboni**|hyvännäköinen|yleiskiina:好看 (hǎokàn), englanti:good-looking|
...
|**rutine**|tapa (rutiini)|englanti:ranska:routine, espanja:rutina, portugali:rotina, deu:Routine, persia:روتین‎ (rutin), venäjä:рутина (rutina)|
|**sabe**|syy|heb:(sibá), hausa:sabo;sababi, Kongo:sambu, arabia:urdu:(sabab), turkki:sebep, malaiji:sebab, suahili:sababu|
|**sabune**|saippua|arabia:(ṣābūn), turkki:sabun, suahili:sabuni, hindi:साबुन (sābun), portugali:sabão, espanja:jabón, ranska:savon|
|**sadi**|koruton (tavanomainen, pelkkä)|turkki:sade, persia:(sāde), hindi:सादा (sādā)|
|**safare**|matka (reissu)|arabia:(safar), hindi:सफ़र (safar), turkki:sefer, suahili:safari, englanti:ranska:espanja:portugali:deu:safari|
|**safi**|puhdas (siivo, siisti)|suahili:safi, hindi:साफ़ (sāf), urdu:(sāf), bangla:চাফা (sapha)|
|**safrane**|sahrami|arabia:(zaʿfarān), suahili:zafarani, persia:(za'ferân), ranska:turkki:safran, englanti:saffron, espanja:azafrán, portugali:açafrão, venäjä:шафран (šafran)|
...
|**sare**|pää|persia:(sar), hindi:सिर (sir), arabia:(raʾs)|
|**sate**|hetki (kotva)|arabia:(sāʿa), persia:(sâ'at), malaiji:turkki:saat, suahili:saa|
|**saudare**|sisarus (veli tai sisko)|malaiji:saudara, hindi:सहोदर (sahodar), bangla:সহোদর (sôhodôr)|
...
|**semane**|viikko|espanja:portugali:semana, ranska:semaine|
|**seme**|siemen|ranska:semence, portugali:semente, espanja:semilla, venäjä:семя (semya), englanti:semen|
|**semente**|sementti|englanti:cement, malaiji:semen, espanja:cemento, turkki:çimento, vietnami:xi măng, hindi:सीमेंट (siment), venäjä:цемент (tsement), arabia:(ʾasmant), korea:시멘트 (simenteu)|
|**sene**|lava (näyttämö)|ranska:scène, espanja:escena, venäjä:сцена (scena), deu:Szene, turkki:sahne, persia:(sahne)|
...
|**sole**|aurinko|espanja:portugali:sol, ranska:soleil, + hindi:सौर (sOr), telugu:(saur)|
|**sonde**|ääni|englanti:sound,sonic, ranska:son, espanja:son,sonido, italia:suono, + korea:소리 (sori)|
|**sone**|nukkuminen (uni)|venäjä:сон (son), portugali:sono, hindi:सोना (sonā), bangla:শোয়া (śoya)|
|**songe**|mänty|yleiskiina:松 (sōng), wu-kiina:(son), thai:สน (sǒn), korea:솔 (sol), vietnami:thông, + venäjä:сосна (sosna)|
|**sose**|kastike (soosi)|englanti:ranska:sauce, venäjä:соус (sous), hindi:सॉस (sos), deu:Soße, vietnami:xốt, japani:ソース (sōsu), that:ซอส (soot), korea:소스 (soseu), malaiji:saus|
|**sosise**|makkara|ranska:saucisse, turkki:malaiji:sosis, persia:(sosis), venäjä:сосиска  (sosiska), japani:ソーセージ (sosēji), hindi:सॉसेज (sosej), bangla:সসেজ (sôsej), englanti:sausage|
|**suani**|hapan (kirpeä)|yleiskiina:酸 (suān)|
...
|**suki**|iloinen (tyytyväinen)|hindi:सुखी (sukhī), japani:好き (suki), thai:สุข (suk)|
|**suku**|pitää (tykätä)|japani:好く (suku), malaiji: suka|
|**sume**|summa|englanti:sum, espanja:suma, portugali:soma, ranska:somme, deu:Summe, venäjä:сумма (summa)|
...
|**supra**|ylittää (yllä, päällä)|englanti:super, espanja:portugali:sobre, italia:sopra|
...
|**susane**|lilja|persia:sousan, arabia:(sawsan), heb:(šōšān), + englanti:Susan, portugali:espanja:Susana, ranska:Suzanne, puola:Zuzana, venäjä:Сусанна (Susanna)|
|**suta**|ommella|hindi:सीना (sīnā), venäjä:шить (šit'), englanti:sew|
|**suture**|sauma (ommel)|ranska:englanti:suture, portugali:espanja:sutura|
|**suxe**|sushi|japani:寿司 (sushi)|
|**suy (suye)**|vesi|yleiskiina:水 (shuǐ), japani:(sui), vietnami:thuỷ, + turkki:su|
...
|**table**|taulukko|englanti:table, ranska:tableau, espanja:tabla, venäjä:таблица (tablitsa), malaiji:tabel|
|**tafune**|myrsky|yleiskiina:大风 (dàfēng), kantoninkiina:大風 (daai6fung1), korea:태풍 (taepung), japani:台風 (taifuu), thai:ไต้ฝุ่น (taifun), arabia:(ṭūfān), persia:urdu:(tufān), hindi:तूफ़ान (tūfān), pandzabi:ਤੂਫ਼ਾਨ (tūfān), portugali:tufão, espanja:tifón, ranska:typhon, englanti:typhoon, venäjä:тайфун (tayfun)|
...
|**tamare**|taateli|portugali:tamara, arabia:(tamar)|
...
|**tanure**|uuni|persia:heb:tanur, arabia:(tannūr), englanti:tandoor, athanor, turkki:tandır, hindi:तनूर (tanūr), urdu:(tanūr), pandzabi:ਤੰਦੂਰ (tandūr)|
|**tape**|tulppa (tappi, korkki)|espanja:turkki:tapa, portugali:tampa, kreikka:τάπα (tapa), bul:тапа (tapa), englanti:tap|
|**tarife**|taksa (tariffi)|englanti:tariff, espanja:portugali:tarifa, deu:ranska:turkki:tarif, arabia:(taʿrīf), venäjä:тариф (tarif), hindi:टैरिफ़ (ṭairif)|
|**tarje**|käännös (tulkinta)|arabia:(tarjama), hindi:तर्जुमा (tarjuma), urdu:(tarjuma), bangla:তর্জমা (tôrjôma), malaiji:terjemah, turkki:tercüme|
|**tase**|astia (kulho)|venäjä:таз, arabia:طشت‎ (ṭašt)|
|**tatawe**|tatuointi|sam:tah:tatau, haw:kākau, malaiji:tato, englanti:tattoo, ranska:tatouage, espanja:tatuaje, venäjä:тату (tatu)|
|**tatike**|taktiikka|portugali:tática, italia:tattica, englanti:tactic, venäjä:тактика (taktika), deu:Taktik|
|**tawe**|pannu (paistinpannu)|hindi:तवा (tavā), turkki:tava, persia:(tābe)|
...
|**teme**|aihe (teema)|ranska: thème, espanja: tema, venäjä: тема (tema), deu:Thema|
|**tena**|pitää (pitää hallussa)|espanja:tener, ranska:tenir, englanti:contain|
|**tenke**|sää|yleiskiina:天气 (tiǎnqì), japani:天気 (tenki)|
...
|**terore**|kauhu (terrori)|englanti:espanja:portugali:terror, ranska:terreur|
...
|**ticine**|jousisoitin|yleiskiina:提琴 (tíqín), kantoninkiina:提琴 (tai4 kam4), uu:提琴 (di jin3), japani:提琴 (teikin)|
...
|**time**|joukkue (tiimi)|englanti:team, deu:Team, suahili:timu, hindi:टीम (ṭīm), japani:チーム (chīmu), korea:팀 (tim)|
|**ting (tinge)**|pysähdys|yleiskiina:停 (tíng), kantoninkiina:停 (ting4)|
|**tini**|kolme (3)|hindi:तीन (tīn), bangla:তিন (tin), urdu:(tīn)|
...
|**towale**|pyyhe|englanti:towel, espanja:toalla, portugali:toalha, hindi:तौलिया (tauliyā), bangla:তোয়ালে (toyale), filippiini:tuwalya, japani:タオル (taoru)|
|**transe**|läpikulku|englanti:ranska:espanja:portugali:deu:malaiji:trans-, venäjä:транс- (trans-)|
|**tren (trene)**|juna|englanti:ranska:train, espanja:turkki:tren, hindi:ट्रेन (ṭren), portugali:trem|
|**tribe**|heimo|ranska:espanja:tribu, portugali:filippiini:tribo, englanti:tribe|
|**tuale**|vessa|ranska:toilettes, englanti:malaiji:toilet, portugali:toalete, venäjä:туалет (tualet), turkki:tuvalet, persia:توالت‎ (tuâlet), hindi:टॉयलेट (ṭŏyaleṭ), japani:トイレ (toire)|
...
|**tulpane**|tulppaani|englanti:tulip, espanja:tulipá, portugali:túlipa, nld:tulp, venäjä:тюльпан (t’ul’pan), arabia:توليب (tūlīb), hindi:ट्यूलिप (ṭyūlip), malaiji:tulip, japani:チューリップ (chūrippu)|
...
|**tunele**|tunneli|englanti:ranska:tunnel, espanja:portugali:túnel, venäjä:тоннель (tonnel’), turkki:tünel, japani:トンネル (tonneru), 터널 (teoneol)|
...
|**unale**|toisiaan (keskenään)|englanti:one another, italia:l’una, l’altra, ranska: l'un l'autre, espanja:el uno al otro, portugali:um ao outro, turkki:birbirine, yleiskiina:彼此 (bǐcǐ)|
...
|**vejete**|kasvis|englanti:vegetable, espanja:portugali:vegetal, ranska:végétal|
|**vejetyamiste**|kasvissyöjä|englanti:vegetarian, ranska:végétarien, portugali:espanja:vegetariano, venäjä:вегетарианец  (vegetarianets), turkki:vejetaryen, japani:ベジタリアン (bejitarian)|
...
|**versione**|versio|englanti:ranska:version, portugali:versão, venäjä:версия (versiya), malaiji:versi|
...
|**vimane**|lentokone|hindi:marathi:विमान (vimān), bangla:বিমান (biman), gujarati:વિમાન (vimān), telugu:విమానము (vimānamu), tamili:விமானம் (vimāṉam)|
|**vine**|viini|ranska:vin, espanja:vino, venäjä:вино (vino), englanti:wine, deu:Wein, hindi:वाइन (vāin), japani:ワイン (wain)|
|**vinile**|vinyyli|englanti:vinyl, espanja:vinilo, portugali:vinil, ranska:vinyle, venäjä:винил (vinil), japani:ビニル (viniru)|
|**vire**|sankari (urho)|hindi:वीर (vīr), urdu:(vīr), bangla:বীর (bīr), tamili:வீரன் (vīraṉ), telugu:వీరుడు (vīruḍu), malaiji:wira, thai:วีร (wi-ra), + ranska:portugali:espanja:viril, englanti:virile|
|**virus (viruse)**|virus|englanti:virus, venäjä:вирус (virus)|
...
|**wane**|halu (toive)|englanti:want, korea:원하다 (wonhada)|
|**warise**|perintö|malaiji:waris, arabia:(wariþ), suahili:urithi, turkki:varis,miras|
|**warke**|lehti (arkki, levy)|arabia:(waraqa), hausa:warƙa, turkki:varak, persia:(varaqe), taj:варақа (varaqa), suahili:waraka, + burma:အရွက် (arwak)|
|**wase**|keidas|arabia:(wāḥa), turkki:vaha, persia:(vāhe), espanja:oasis|
|**waw**|oho (vau)|yleiskiina:哇 (wā), englanti:wow|
|**waxa**|pestä|englanti:wash, deu:waschen, yleiskiina:洗 (xǐ)|
|**waydexi**|ulkomaalainen|hindi:(videśī), telugu:(vidēśi), yleiskiina:外国的 (wàiguóde)|
|**waye**|ulkopuoli|yleiskiina:外 (wài)|
|**weki**|olla hereillä|englanti:awake, deu:wach|
|**weste**|länsi|englanti:west, deu:West, ranska:ouest, espanja:portugali:oeste, venäjä:вест (vest)|
|**wi**|tuo (nuo)|hindi:वह (wo), bangla:ওই (oi)|
|**wikia**|wiki|englanti:ranska:espanja:portugali:malaiji:wiki, turkki:viki, arabia:وِيكي‎ (wikī), persia:ویکی‎ (viki), hindi:विकि (viki), bangla:উইকি (uiki), yleiskiina:维基 (wéijī), kantoninkiina:維基 (wai4 gei1), japani:ウィキ (wiki), korea:위키 (wiki)|
|**wildi**|villi (kesytön)|deu:englanti:ned:wild, sve:vild|
|**wile**|tulevaisuus|englanti:will + wu-kiina:未来 (víle), yleiskiina:未来 (wèilái), korea:미래 (miræ), japani:未来 (mirai)|
|**wine**|voitto|englanti:win, deu:gewinnen|
|**winge**|siipi|englanti:wing, deu:Schwinge|
|**wolfe**|susi (hukka)|deu:ned:englanti:wolf, venäjä:волк (volk)|
|**xakale**|šakaali|persia:شغال‎ (šağâl), englanti:jackal, espanja:portugali:chacal, venäjä:шака́л (šakál), turkki:çakal, bangla:শৃগাল (śrigal), malaiji:jakal, thai:แจ็กคัล (jɛ̀k-kal), japani:ジャッカル (jakkaru)|
|**xake**|oksa (haara)|bangla:শাখা (śakha), hindi:शाखा (śākhā), urdu:(śāx), persia:(šax)|
|**xale**|huivi (šaali)|ranska:châle, venäjä:шаль (šal), portugali:xaile, englanti:shawl, turkki:şal|
|**xamane**|šamaani|venäjä:шаман (šaman), englanti:shaman|
|**xame**|ilta|hindi: शाम (śām), persia:(šām), turkki:akşam|
|**xane**|vuori (mäki)|yleiskiina:山 (shān), japani:山 (san), korea:산 (san), vietnami:sơn|
|**xanti**|rauhallinen (tyyni)|hindi:शांति (shānti), bangla:শান্তি (shānti), pan:ਸ਼ਾਂਤੀ (shāntī), marathi:शांत (shānta), telugu:శాంతి (shānti), gujarati:શાંતિ (shānti), khmer:សន្តិ (sɑnte’), englanti:portugali:shanti, venäjä:шанти (shanti), japani:シャンティ (shanti)|
|**xarme**|häpeä|persia:(šarm),  urdu:(śarma), hindi:शर्म (śarma), deu:Scham, englanti:shame, venäjä:срам (sram)|
|**xarnire**|sarana|ranska:charnière, espanja:charnela, deu:Scharnier, venäjä:шарнир (šarnir)|
...
|**xawi**|vähän|yleiskiina:少 (shǎo), kantoninkiina:少 (siu2), japani:少 (shō), korea:소 (so)|
|**xaxu**|kahista|yleiskiina:(shasha)|
...
|**xey (xeye)**|asia|arabia:(šayʾ), turkki:şey, + yleiskiina:事 (shì), kantoninkiina:事 (si6)|
|**xeyhale**|tilanne (asiaintila)|yleiskiina:事态 (shìtài), japani:事態 (jitai), englanti:state of affairs, ranska:état des choses|
|**xibaye**|epäonnistuminen|yleiskiina:失败 (shībài), japani:失敗 (shippai), korea:실패 (šilpæ), vietnami:thất bại|
...
|**xime**|sydän|korea: 심 (shim), yleiskiina:心 (xīn), japani:心 (shin), kantoninkiina:心 (sam1), hakkakiina:心 (sîm), vietnami:tim|
|**xindawistia**|sintolaisuus|japani:神道 (shintō), korea:신도 (sindo), yleiskiina:神道 (shéndào)|
|**xine**|usko (luottamus)|yleiskiina:信 (xìn), kantoninkiina:信 (seon3), japani:信 (shin), vietnami:tin|
|**xinge**|tähti|yleiskiina:星 (xīng), wu-kiina:星 (xing), kantoninkiina:星 (sing1), japani:星 (sei), korea:성 (seong)|
|**xire**|runo|heb:שיר (šir), arabia:(šiʿr), turkki:şiir, persia:(še'r), suahili:shairi, yleiskiina:诗 (shī), kantoninkiina:詩 (si1), japani:詩 (shi), korea:시 (shi)|
|**xirope**|siirappi|arabia:(šarāb), portugali:xarope, englanti:syrup, turkki:şurup, japani:シロップ (shiroppu)|
|**xite**|paska (sonta)|englanti:shit, yleiskiina:屎 (shǐ), kantoninkiina:屎 (si2)|
|**xixo**|hiljainen (hys, shhh)|englanti:shh, yleiskiina: (xū), venäjä:ш-ш-ш, turkki:sus|
...
|**xowe**|näytös (esitys, show)|englanti:deu:ranska:espanja:portugali:show, venäjä:шоу (šou), turkki:şov, suahili:shoo, thai:โชว์ (choo), korea:쇼 (syo), japani:ショー (shō), yleiskiina:秀 (xiù)|
|**xudu**|pitäisi|englanti:should|
|**xukare**|sokeri|arabia:(sukkar), suahili:sukari, portugali:açúcar, espanja:azúcar, hindi:शक्कर (śakkar), bangla:শর্করা (śôrkôra), turkki:şeker, tamili:சக்கரை (cakkarai)|
|**xule**|korjaus|yleiskiina:修理 (xiūlǐ), japani:修理 (shūri), korea:수리 (suri)|
|**xute**|taito|yleiskiina:术 (shù), kantoninkiina:術 (seot6), japani:術 (jutsu), korea:술 (sul)|
|**xuxe**|lepo|yleiskiina:休息 (xiūxí), korea:휴식 (hyusig)|
...
|**yange**|laji (tyyppi, tyyli)|yleiskiina: 样 (yàng), thai: อย่าง (yàang), khmer: យ៉ាង (yaang)|
|**yatime**|orpo|arabia:persia:(yatim), turkki:yetim, suahili:yatima, hindi:यतीम (yatīm)|
|**yexo**|vielä (yhä)|venäjä:ещё (yeščo), puola:jeszcze|
|**yey**|jee! (hurraa!)|englanti:yay, puola:jej, japani:イエイ (iei)|
|**yeze**|kookos|yleiskiina:椰子 (yēzi), kantoninkiina:椰子 (ye4zi2), korea:야자 (yaja), japani:椰子 (yashi)|
|**yi**|tämä (nämä)|hindi:यह (ye), bangla:এই (ei), telugu:ఈ (ī), tamili:இது (itu), korea:이 (i),|
...
|**yuke**|jade|yleiskiina:玉 (yù), kantoninkiina:玉 (yuk6), malaiji:giok|
|**yumore**|huumori|venäjä:юмор (yumor), espanja:englanti:humor, ranska:humour, japani:ユーモア (yūmoa), korea:유머 (yumeo), yleiskiina:幽默 (yōumò)|
|**zaitune**|oliivi|arabia:(zaitūn), espanja:aceituna, malaiji:zaitun, suahili:zaituni, hindi:urdu:(zaitūn)|
|**zalimi**|ilkeä (julma)|arabia:(ẓālim), turkki:zalim, urdu:hindi:(zālim), persia:(zālem), suahili:dhalimu|
|**zamane**|aikakausi|turkki:zaman, malaiji:jaman, suahili:zamani, arabia:(zaman), persia:(zamān), + hindi:समय (samay)|
|**zare**|sattuma (onni)|arabia:(zahr), + englanti:hazard, espanja:portugali:azar, + turkki:zar, kreikka:ζάρι (zári), bul:зар (zar)|
|**zay (zayi)**|kuluva (tämänhetkinen)|yleiskiina:在 (zài), japani:在 (zai), vietnami:tại|
...
|**zeme**|maa (maaperä)|puola:ziemia, venäjä:земля (zemlya), persia:urdu:(zamīn), hindi:ज़मीन (zamīn)|
|**zemgrafe**|kartta|yleiskiina:地图 (dìtú), kantoninkiina:地圖 (dei6 tou4), japani:地図 (chizu), korea:지도 (jido), vietnami:địa đồ, hindi:मानचित्र (māncitra), bangla: মানচিত্র (mancitr)|
|**zeyile**|syylä|persia:زگیل (zegil), turkki:siğil, aze:ziyil, fin:syylä|
|**zeze**|kärpänen|lingala:Kongo:nzinzi, suahili:nzi, igbo:ijiji, yoruba:eṣinṣin|
...
|**zime**|talvi|venäjä:зима (zima), puola:zima, persia:(zemestân), urdu:(zimastān)|
...
|**zipa**|sulkea vetoketjulla|englanti:zip|
|**ziper**|vetoketju|englanti:zipper, bangla:জিপার (jipar), hindi:ज़िपर (zipar), japani:ジッパー (jippā), korea:지퍼 (jipeo), thai:ซิป (síp), persia:urdu:(zip)|
...
|**zombe**|zombi|Kongo:nzambi, portugali:zumbi, englanti:zombi, malaiji:zombi, hindi:ज़ोंबी (zombī)|
