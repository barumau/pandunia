...
**a** *a (dans, en, chez)* ← fra:à, spa:por:a, eng:a-;ad-, rus:а- (a-), hau:a + ful:haa  
...
**agibe** *merveille* ← ara: عَجَب‎ (ʿajab), swa:ajabu, hau:al'ajabi + fas: عجب‎ ('ajab), hin:अजीब (ajīb), ben:আজব (ajôb), tur:acayip  
...
**ais krem** *crème glacée* ← eng:ice cream, jpn:アイスクリーム (aisukurīmu), kor:아이스크림 (aiseukeurim), hin:आइसक्रीम (āisakrīm), ben:আইসক্রীম (aisôkrīm), may:es krim, swa:aiskrimu, zho:冰淇淋 (bīngqílín), yue:冰淇淋 (bing1 kei4 lam4)  
...
**almari** *placard* ← spa:armario, por:armário, hin:अलमारी (almārī), ben:আলমারি (almari), tam:அலமாரி (alamāri), may:lemari, swa:almari  
...
**ama** *mais* ← ara: أما‎ (ʔamma), tur:ama, fas:urd:اما‎ (ammâ), hau:ful:amma, yor:àmọ́  
**ame** *amour (affection)* ← deu:Liebe, rus:любовь (lyubov), ara: حُبّ (ḥubb), swa:hibu: huba, tur:muhabbet, fas: محبت (mohabbat), hin: मुहब्बत (muhabbat); लुभ् (lubh), hmn:hlub  
**amen** *faire confiance (espérer, croire qqn./qqch., avoir la foi)* ← heb: אָמֵן‎, (ʾāmēn), ara: آمَنَ‎ (āmana), swa:amini, ful:amiini, hau:amince, tur:amin + ell:ἀμήν (ámén), eng:deu:fra:pol:spa:amen, zho:阿门 (āmén), yue:阿門 (aa3mun4), kor:아멘 (amen), jpn:アーメン (āmen), vie:a-men  
...
**ampe** *ampère* ← eng:deu:spa:por:may:ampere, fra:ampère, rus:ампер (amper), hin:एम्पेयर (empeyar), zho:安培 (ānpéi), jpn:アンペア (anpea), kor:암페어 (ampeeo), vie:ampe, tur:amper, أَمْبِير‎ (ʔambīr)  
**ampul** *ampoule (fiole)* ← fra:eng:ampoule, zho:安瓿 (ānbù), jpn:アンプル (anpuru), rus:ампула (ámpula), ara:(ʾambūla), tur:ful:ampul, hin:फफोला (phapholā)  
**an-** *inverse (négatif, in-)* ← ell:ἀν- (an-), eng:un-, hin:अन- (an-), fra:spa:por:in-  
**ananas** *ananas* ← deu:Ananas, fra:tur:ananas, por:ananás, rus:ананас (ananas), fas: آناناس‎ (ânânâs), hin:अनन्नास (anānnas), tam:அன்னாசிப் பழம் (aṉṉācip paḻam), ara: أَنَانَاس‎ (ʾanānās), may:nanas, swa:nanasi  
...
**angar** *ancre* ← eng:anchor, fra:ancre, por:âncora, may:jangkar, rus:якорь, ara:(ʾanjar), hin:लंगर (laṅgar), urd:(laṅgar), tam:நங்கூரம் (naṅkūram), tel:లంగరు (laṅgaru), swa:nanga, hau:anga  
...
**are** *aire (superficie)* ← eng:area, por:spa:área, pol:areał, fra:aire  
...
**Asia** *Asie* ← eng:spa:Asia, rus:Азия (Aziya), tur:Asya, ara:آسيا (ʾāsiyā), fas:آسیا‎ (âsiyâ), hin:एशिया (eśiyā), ben:এশিয়া (eśiẏa), tam:ஆசியா (āsiyā), may:Asia, zho:亞洲 (yàzhōu), yue:亚洲 (aa3 zau1), wuu:亚洲 (ia tseu), jpn:アジア (ajia), kor:아시아 (asia), hau:Asiya  
**askete** *ascète* ← eng:ascetic, spa:por:asceta, fra:ascéte, rus:аскет (asket)  
**asle** *origine* ← ara:(ʾaṣl), tur:asl, may:asal, hin:असल (asl), tam:அசல் (acal), swa:asili, hau:asali, ful:asli  
...
**axe** *axe* ← eng:axis, fra:axe, por:eixo, fas: آسه‎ (âse), hin:अक्ष (akṣ), ben:অক্ষ (ôkṣô), tam:அச்சு (accu), tel:అక్షము (akṣamu), may:as, tur:eksen  
...
**babu** *chapitre* ← ara:fas:urd: بَاب‎ (bāb), may:bab, swa:babu, hau:babi, ful:baabuwo  
...
**badam** *amande* ← may:badam, tur:badem, hin:बादाम (bādām), ben:বাদাম (badam), tam:வாதுமை (vātumai), zho:巴旦木 (bādànmù)  
**badan** *corps* ← eng:body + ara:  بَدَن‎ (badan), fas: بدن‎ (badan), hin:बदन (badan), may:badan, tur:beden, swa:badani  
**bagage** *bagage* ← eng:baggage, fra:bagage, por:bagagem, rus:багаж (bagazh), tur:bagaj, ben:ব্যাগেজ (bjagej), may:bagasi  
**bage** *sac* ← eng:bag; baggage, hin:बैग (bæg), jpn:バッグ (baggu) + fra:bagage, por:bagagem, rus:багаж (bagazh), ben:ব্যাগেজ (byagej), may:beg; bagasi, tur:bagaj  
...
**bala** *fort* ← hin:बल (bal), ben:বল (bôl), may:bala, tam:பலவான் (palavāṉ), tel:బలము (balamu), tha:พล (pon), พละ (pá-lá)  
**baldi** *seau* ← spa:por:tgl:balde, hin:बाल्टी (bālṭī), ben:বালতি (balti), may:baldi, tam:வாளி (vāḷi)  
...
**banana** *banane* ← ful:wol:banaana, rus:банан (banan), pol:banan, fra:deu:banane, por:spa:eng:banana, jpn:バナナ (banana), kor:바나나 (banana)  
...
**bande** *ruban (bande)* ← eng:bind; band, deu:Band, fra:bande, spa:venda, rus:бинт (bint), fas: بند‎ (band), hin:बाँधना (bāndhnā), zho:绑 (bǎng), yue:綁 (bong2), vie:băng, tur:bant + swa:bendeji, hau:bandeji  
**bandera** *drapeau* ← eng:banner, fra:bannière, spa:bandera, por:bandeira, may:bendera, tgl:bandila, swa:bendera, ful:bandeera  
**bang** *masse d'armes* ← zho:棒 (bàng), yue:棒 (paang5), jpn:棒 (bō), kor:봉 (bong), tha:ตะบอง (ta-bong), khm:ដំបង (dɑmbɑɑng)  
...
**bare** *bloquer* ← eng:barrier, fra:barrière, por:barreira, spa:barrera, rus:барьер (baryer), hin:बाड़ (bāṛ), ben:বেড়া (beṛa)  
...
**barke** *féliciter (benir)* ← hau:barka, may:berkah, tur:tebrik, fas:(tabrik), ara:urd:(mubārak), swa:baraka, hau:albarka, yor:alubarika, ful:barka  
**barte** *indien* ← hin:भारतीय (bhārtīy), urd:(bhārtīy), mar:(bhārtīya), tel:(bhāratīya)  
**baru** *ours* ← deu:Bär, eng:bear + hin:भालू (bhālū) ben:ভালুক (bhaluk), tam:பல்லுகம் (pallukam) + may:beruang  
...
**basen** *bassin* ← eng:basin, fra:bassin, rus:бассейн (basseyn), por:bacia, may:besen, swa:beseni, ful:basin  
...
**batri** *pile (batterie)* ← eng:battery, spa:por:bateria, rus:батарея (batareya), fas:(bātri), hin:बैटरी (baiṭrī), ben:ব্যাটারি (byaṭari), tam:பத்திரி (pattiri), ara:(baṭṭāriyya), jpn:バッテリー (batterī), kor:배터리 (baeteori), may:bateri, swa:betri, hau:baturi, ful:baateri  
...
**bazar** *marché (bazar)* ← fas:urd: بازار (bāzār), hin:बाज़ार (bāzār), tam:பசார் (pasār), fra:spa:por:bazar, eng:bazaar, rus:базар (bazar), may: pasar, zho:巴扎 (bāzhā); 巴剎 (bāshā)  
...
**benke** *banc* ← fra:banc, deu:Bank, spa:por:banco, may:bangku, ful:baŋ + eng:bench, swa:benchi, hin:बेंच (bẽc), jpn:ベンチ (benchi), kor:벤치 (benchi)  
...
**berklium** *berkélium* ← eng:berkelium, fra:berkélium, spa:berkelio, por:berqueélio, rus:берклий, zho:锫 (péi), jpn:バークリウム, kor:버클륨, vie:beckeli, hin:बर्केलियम, ben:বার্কেলিয়াম, may:berkelium, swa:berkeli, ara: بركليوم  
...
**bikini** *bikini* ← eng:deu:fra:may:tur:vie:bikini, spa:por:biquini, rus:бикини (bikini), fas: بیکینی‎ (bikini), hin:बिकिनी (bikinī), ben:বিকিনি (bikini), ara: بِيكِينِي‎ (bīkīnī), zho:比基尼 (bǐjīní), jpn: ビキニ (bikini), kor:비키니 (bikini)  
**biku** *moine ou nonne* ← hin:भिक्षु (bhikṣu), ben:ভিক্ষু (bhikkhu), tam:பிக்ஷு (pikṣu), may:biku; biksu, zho:比丘 (bǐqiū), jpn:比丘 (biku), kor:비구 (bigu), tha:ภิกษุ (pík-sù), mya:ဘိက္ခု (bhikhku)  
...
**bine** *construire* ← ara: بِنَاء‎ (bināʾ), hin: बनाना (banānā), urd:(banānā), fas:(banā), tur: bina, + jpn:ビル (biru)  
...
**biskute** *biscuit* ← eng:fra:biscut, por:biscoito, rus:бисквит (biskvit), tur:bisküvi, swa:biskuti, ara:بسكويت‎ (baskawīt), hin:बिस्कुट (biskuṭ), may:biskut, jpn:ビスケット (bisuketto), ful:biskit  
...
**bol** *balle (boule, sphère)* ← eng:ball, spa:por:may:tgl:bola, tha:บอล (bɔl), jpn:ボール (bōru), kor:볼 (bol), khm:បាល់ (bal), ben:বল (bôl), deu:Ball, fra:boule; balle, tur:may:balon, hau:balân  
**bolte** *boulon* ← eng:bolt, fra:boulon, rus:болт (bolt), hin:बोल्ट (bolṭ), jpn:ボルト (boruto), kor:볼트 (bolteu)   
**bombe** *bombe* ← pol:por:spa:tur:bomba, rus:бомба (bomba), deu:fra:bombe, fas:(bomb), eng:bomb, ben:বোমা (boma), hin:बम (bam), urd:(bam), jpn:ボム (bomu), kor:봄 (bom), may:bom, hau:bom  
...
**bote** *chaussure* ← hin:बूट (būṭ), pol:but, cze:bota, yor:bata + eng:boot, fra:botte, spa:por:bota, rus:ботинок (botinok), pol:may:but, fas: بوت‎ (but), ara: بوت‎ (bōt), jpn:ブーツ (būtsu), swa:buti  
**botel** *bouteille* ← eng:bottle, fra:bouteille, spa:botella, por:botelha, rus:бутылка (butylka), fas: بطری‎ (botri), hin:बोतल (botal), ben:বোতল (botôl), may:botol, tam:புட்டி (puṭṭi), ful:butaleeru  
...
**buke** *livre* ← eng:book, fra:bouquin, hin:बुक (buk), deu:Buch, may:buku, ful:swa:buku, wol:bukoo + rus:буклет (buklet)  
...
**bus** *bus* ← deu:fra:eng:spa:bus, rus:автобус (avtobus), hin:बस (bas), urd:(bas), jpn:バス (basu), kor:버스 (beoseu), fas:(otobus), tur:otobüs, swa:basi, hau:bas, zho:巴士 (bāshì), yue:巴士 (baasi)  
...
**cai** *thé* ← zho:茶 (chá), yue:茶 (caa4), jpn:茶 (cha), kor:차 (cha), vie:trà, tur:çay, swa:chai, rus:чай (čay), hin:चाय (cāy), ara:(šāy), hau:shayi, por:chá  
...
**carme** *charme* ← eng:charm, fra:por:charme, deu:Charme, rus:чары (čary); шарм (šarm), jpn:チャーム (chāmu)  
...
**cavi** *clé (clef)* ← por:chave, spa:llave, hin:चाबी (cābi), ben:চাবি (cabi), tam: சாவி (cāvi), ful:wol:caabi, man:caaboo, kon:nsapi  
...
**cerium** *cérium* ← eng:cerium, fra:cérium, spa:cerio, por:cério, rus:церий, zho:铈 (shì), jpn:セリウム, kor:세륨, vie:xeri, hin:सेरियम, ben:সেরিয়াম, may:serium, swa:seri, ara: سيريوم  
...
**coklate** *chocolat* ← spa:por:eng:chocolate, fra:chocolat, rus:шоколад (šokolad), zho:巧克力 (qiǎokèlì), yue:朱古力 (zyugulik), jpn:チョコレート (chokorēto), kor:초콜렛 (chokollet), hin:चाकलेट (cāklet), ben:চকলেট (côkleṭ), may:cokelat, swa:chokoleti, tur:çikolata, ful:sokola  
...
**cule** *traiter (traitement, processe)* ← zho:处理 (chǔlǐ), yue:處理 (cyu2lei5), jpn:処理 (shori), kor:처리 (cheori), vie:xử lí  
**cun** ** ← hin:चुनना (cunnā) + vie:chọn + eng:choose + zho:选 (xuǎn), yue:選 (syun2)  
**cung** *insecte* ← zho:虫 (chóng), yue:蟲 (cung4), kor:충 (chung), vie:trùng  
...
**dake** *couvrir* ← hin:ढकना (dhaknā), ben:ঢাকা (ḍhaka), pnb:ਢੱਕਣਾ (ḍhakṇā), deu:decken, eng:deck  
...
**darmestadium** *darmstadtium* ← eng:darmstadtium, fra:darmstadtium, spa:darmstatio, por:darmstádio, rus:дармштадтий, zho: (dá), jpn:ダームスタチウム, kor:다름슈타튬, vie:darmstadti, hin:डार्म्स्टेडशियम, ben:ডারমস্টাডটিয়াম, may:darmstadtium, swa:darmstadti, ara: دارمشتاتيوم  
...
**debe** *devoir (obligation)* ← eng:debt, fra:devoir, spa:deber, por:dever, rus:дебет (debet) + ara: دَيْن‎ (dayn), fas: دین‎ (deyn), swa:deni  
...
**din** *religion* ← ara:(dīn), ben:দীন (din), fas:(din), tur:may:din, swa:dini, ful:diina, hau:addini, wol:diine, hin:दीन (dīn)  
...
**doste** *amie* ← hin:दोस्त (dost), ben:দোস্ত (dośt), zho:朵斯提 (duǒsītí), fas: دوست (dost), tur:dost  
...
**dunia** *monde* ← ara: دُنْيَا‎ (dunyā), hin:दुनिया (duniyā), ben:দুনিয়া (duniya), tam:துனியா (tuṉiyā), may:swa:dunia, tur:dünya, fas: دنیا (donya), urd: دنیا (duniyā), hau:duniya, ful:duniyaaru  
**dure** *durée* ← eng:duration, fra:durée, spa:por:durar + ara: دَوْرَة (dawra), fas: دُوره (dowre), ben:ধরে (dhôre), hin:दौरान (daurān)  
...
**e** *et* ← fra:et, por:e, spa:y;e, zho:和 (hé), ful:e  
...
**estibium** *antimoine* ← zho:锑 (tī), swa:stibi  
...
**fatura** *addition (facture)* ← fra:facture, spa:factura, por:tur:fatura, deu:Faktura, rus:фактура (faktura), fas: فاکتور‎ (fâktur), ara: فَاتُورَة‎ (fātūra)  
**favor** ** ← eng:spa:por:favor, fra:faveur + rus:фаворитизм (favoritizm)  
**faxe** *faisceau* ← ita:fascio, eng:fasces, fra:faisceau, por:faixa, spa:faja + rus:фашизм (fašizm), ara: فَاشِيَّة‎ (fāšiyya), zho:法西斯主义 (fǎxīsīzhǔyì), jpn:ファシズム (fashizumu), kor:파시즘 (pasijeum), vie:chủ nghĩa phát xít, hin:फ़ासीवाद (fāsīvād), may:fasisme ben:ফ্যাসিবাদ (phaśibad)  
**faze** *phase* ← spa:por:ita:may:fase, eng:fra:phase, rus:фаза (faza), pol:faza, fas:(fāz)  
**fe** *faire* ← fra:faire, por:fazer, ita:fare + ara: فَعَلَ‎ (faʿala) + swa:fanya + yue:化 (faa3), hak:化 (fa), zho:化 (huà), vie:hoá  
...
**fete** *faire (fait)* ← fra:fait, por:feito, eng:feat; fact, deu:Fakt, rus:факт (fakt), fas:(fâkt)  
...
**frem** *cadre* ← eng:frame, ben:ফ্রেম (phrēma), swa:fremu  
...
**fuze** *melt* ← eng:fuse, fra:fuser, deu:Fusion, spa:fusión, por:fusão, pol:fuzja  
...
**gamel** *chameau* ← ara:جَمَل‎ (jamal), heb:גָּמָל‎ (gamál) eng:camel, deu:Kamel, spa:camello, por:camelo, swa:ngamia, orm:gaala, wol:geleem  
...
**gavabe** *réponse* ← ara: جَوَاب‎ (jawāb), hin:जवाब (javāb), ben:জবাব (jobab), may:jawab, ful:jaabaade, swa:jibu,jawabu, tur:cevap  
...
**gide** *guider* ← eng:fra:guide, spa:guía, por:guia, rus:гид  (gid), jpn:ガイド (gaido), kor:가이드 (gaideu), swa:gaidi + ara:قَادَ‎ (qāda)  
**giga** ** ← eng:fra:spa:por:may:tur:giga-, rus:гига- (giga-), jpn:ギガ (giga), kor:기가- (giga-)  
**gihade** *lutte* ← ara: جهاد (jihād), tur:cihat, swa:jihadi + eng:fra:por:may:jihad, spa:yihad, rus:джихад (džihad), jpn:ジハード (jihādo), kor:지하드 (jihadeu), hin:जिहाद (jihād)  
**gin** *esprit (génie)* ← ara: جِنّ (jinn), ful:wol:jinne, swa:jini, man:jinnoo, rus:джинн (džinn) + eng:genie, fra:génie, spa:genio, por:gênio + hin:जान (jān), ben:জান (jan), tur:can  
...
**ginge** *gingembre* ← eng:ginger, fra:gingembre, spa:gengibre, por:jengibre, zho:姜 (jiāng), yue:薑 (goeng1), vie:gừng, kor:생강 (saenggang), tam:இஞ்சி (inji), ara: زنجبيل‎ (zanjabīl), fas: زنجبیل‎ (zanjebil), tur:zencefil  
**giota** ** ← tha:หยด (yòt), vie:giọt, + eng:iota, rus:йота (yota) + spa:por:gota  
**gitar** *guitare* ← eng:guitar, fra:guitare, spa:por:guitarra, rus:гитара (gitara), ara:(qīṯāra), hin:गिटार (giṭār), ben:গিটার (giṭar), zho:吉他 (jítā), yue:結他 (git6taa1), jpn:ギター (gitā), kor:기타 (gita), swa:gitaa  
**glas** *verre* ← deu:Glas, eng:glass + fas: گیلاس‎ (gilâs), hin:गिलास (gilās), ben:গ্লাস (glaś), jpn:グラス (gurasu), kor:글라스 (geullaseu), may:gelas, swa:glasi, hau:gilashi + rus:глазурь, spa:glasear  
...
**gorila** *gorille* ← eng:gorilla, fra:gorille, spa:por:may:gorila, rus:горилла (gorilla), ara:غوريلا (ḡūrīlā), jpn:ゴリラ (gorira), kor:고릴라 (gorilla), vie:gôrila, hin:गोरिल्ला (gorillā), ben:গরিলা (gôrila), tam:கொரில்லா (korillā)  
**goro** ** ← swa:guruwe zul:ingulube, kon:ngulu spa:guarro,gorrino, jpn:(gorogoro) eng:grunt  
**goton** *coton* ← ara: قُطُن‎ (quṭun), spa:algodón, por:algodão, fra:coton, eng:cotton, may:katun, jpn:コットン (kotton), kor:코튼 (koteun) + hin:गुड (guḍ)  
...
**grese** *marcher* ← eng:deu:fra:agression, pol:agresja, rus:агрессия (agressiya), spa:agresión, por:agressão, may:agresif  
...
**Guangzou** ** ← CN  
**gubu** *hippopotame * ← ful:ngabbu kon:ngubu, sot:tsw:kubu, zul:rwa:imvubu, amh:ጉማሬ (gumare)  
...
**gule** *goule* ← ara:الغول (ghūl), fas:غول‎ (ğul), eng:por:ghoul, spa:gul, rus:гуль (gul′), tur:kulbastı, may:ghul, jpn:グール (gūru), hau:gwal  
...
**hafenium** *hafnium* ← eng:hafnium, fra:hafnium, spa:hafnio, por:háfnio, rus:гафний, zho:铪 (hā), jpn:ハフニウム, kor:하프늄, vie:hafini, hin:हाफ्नियम, ben:হাফনিয়াম, may:hafnium, swa:hafni, ara: هفنيوم  
**hafiz-** ** ← ara:(ḥafiẓa), fas:urd:(hāfiz), tur:muhafaza, hin:हाफ़िज़ (hāfīz), swa:hifadhi  
**hage** *pèlerinage* ← ara: حَجّ‎ (ḥajj), fas: حج‎ (hajj), tur:hac, swa:hija, hau:haji  
...
**haima** *tente* ← ara:(xayma), hau:laima, hin:ख़ैमा (xEmā), swa:hema, may:kemah, may:khemah, mng:майхан (mayhan)  
**haki** *poussière* ← fas: خاک (xâk), hin:ख़ाक (xāk), ben:খাক (khâk), tur:haki, eng:khaki, fra:kaki, spa:caqui, por:cáqui, rus:хаки (haki), zho:卡其 (kǎqí), yue:卡其色 (kaakeisik), jpn:カーキ色 (kāki-iro), kor:카키색 (kakisaek), vie:màu kaki  
**haku** *droit* ← ara: حَقّ‎ (ḥaqq), hin:हक़ (haq), ben:হক (hôk), pnb:ਹੱਕ (hakka), tel:హక్కు (hakku), tur:may:hak, swa:haki, hau:hakki  
**hal** *état* ← ara:حال (ḥāl), hin:हालत (hālat), swa:hau:hali, ful:haala, tur:hâl  
...
**halife** *calife* ← ara: خَلِيفَة‎ (ḵalīfa), eng:caliph, fra:calife, spa:por:califa, rus:халиф (khalif), hin:ख़लीफ़ा (xalīfā), ben:খলিফা (khôlipha), tam:கலீஃப் (kalīph), may:khalifah, swa:halifa, hau:khalifa, zho:哈里发 (hālǐfā), jpn:ハリーファ (harīfā), kor:칼리파 (kallipa), tur:halife  
...
**ham di** *important* ← ara: هَامّ (hāmm), hin:अहम (aham), urd: اہم (aham), swa:muhimu, tur:mühim, fas:(mohemm), hau:muhimmi  
...
**haste** *hâte (précipitation)* ← deu:Hast, eng:haste, fra:hâte + fas:آهسته (âheste), hin:आहिस्ता (āhistā), ben:আস্তে (aste), tur:aheste  
**hata** *jusque (jusqu’à)* ← por:até, ara:(ḥatta), spa:hasta, swa:hata, hau:hatta, ful:haa + fas: تا‎ (tâ), hin:तक (-tak)  
**hatar** *danger* ← ara: خطر‎ (xaṭar), fas: خطر‎ (xatar), urd: خطرہ‎ (xatrā), hin:ख़तरा (xatrā), swa:hatari, hau:hatsari, tur:muhatara  
**hau** *bon* ← zho:好 (hǎo), yue:好 (hou2), vie:hảo  
**hava** ** ← ara: هَوَاء‎ (hawāʾ), fas: هوا‎ (havâ), hin:हवा (havā), ben:হাওয়া (hava), may:hawa, swa:hewa, tur:hava  
**haxi** *baguettes* ← jpn:箸 (hashi), ben:হাশি (haśi), guj:હાશી (hāśī), por:hashi  
...
**he** *hein?* ← eng:huh, fra:hein, por:hã, vie:hả, deu:hä + zho:何 (hé)  
**hei** *hé* ← eng:hey, fra:hé, spa:hey, por:ei, rus:эй (ey), zho:喂 (wèi), vie:ê; ơi, fas: هی‎ (hey)  
**helium** *hélium* ← eng:helium, fra:hélium, spa:helio, por:hélio, rus:гелий, zho:氦 (hài), jpn:ヘリウム, kor:헬륨, vie:swa:heli, hin:हिलियम, ben:হিলিয়াম, may:helium, ara: هيليوم  
**helix** ** ← ell: ἕλιξ (helix), eng:helix, fra:por:spa:hélice, pol:helisa, ara:(ḥalazūn), tur:helezon  
**heme** *sang* ← eng:spa:por:may:vie:tur:hemo-, fra:hémo-, rus:гемо- (gemo-), jpn:ヘモ- (hemo-)  
...
**hena** *henné* ← ara: حِنَّاء‎ (ḥinnāʾ), eng:henna, deu:Henna, fra:henné, spa:alheña, por:hena, rus:хна (hna), fas:حنا‎ (hanâ), hin:हिना (hinā), tur:kına  
**hepate** *foie* ← zho:肝 (gān), yue:肝 (gon1), wuu:肝 (koe1), kor:간 (gan), jpn:肝臓 (kanzō), vie:gan + swa:ini  
...
**hevan** *animal (bête)* ← ara: حَيَوَان‎ (ḥayawān), fas: حیوان‎ (heyvân), hin:हैवान (haivān), may:kewan, tur:hayvan, swa:hayawani, ful:hayawan  
**hibride** ** ← eng:hybrid, spa:por:híbrido, fra:hybride, rus:гибрид (gibrid)  
**hidrargente** *mercure* ← swa:hidrajiri  
**hidre** *hydrogène* ← eng:fra:hydro-, spa:por:may:swa:hidro-, vie:hyđrô, ara: هيدروجين  
**higabu** *voile* ← ara:(ḥijāb), fas:(hejâb), swa:hijabu, hau:hijabi, hin:हिजाब (hijāb), ben:হিজাব (hijab), eng:por:hijab, fra:hidjab, spa:hiyab, rus:хиджаб (xidžab)  
...
**hisabe** *calculer* ← ara: حِسَاب‎ (ḥisāb), hin:हिसाब (hisāb), ben:হিসাব (hiśab), tur:hesap, orm:hisaaba, swa:hisabu, hau:lisafi, ful:hiisa  
...
**hotel** *hôtel* ← eng:deu:spa:por:may:hotel, fra:hôtel, hin:होटल (hoṭal), ben:হোটেল (hoṭel), tam:ஹோட்டல் (hottal), jpn:ホテル (hoteru), kor:호텔 (hotel), rus:отель (otel), swa:hoteli, hau:otal  
...
**humel** *houblon* ← rus:хмель (hmel'), fas: خمل‎ (xemel) + fra:houblon  
...
**hura** *hourra* ← rus:ура (ura), ita:urrà, deu:spa:hurra, fra:hourra, eng:hurrah, may:hore, fas:(hurâ)  
**hure** *libre* ← ara: حر (ḥurr), tur:hür, swa:huru, spa:horro, por:forro  
...
**iglu** *iglou* ← eng:igloo, fra:iglou, spa:iglú, por:tur:may:iglu, rus:иглу (iglu), hin:इग्लू (iglū), jpn:イグルー (igurū), kor:이글루 (igeullu)  
...
**intrage** *intestin (entrailles, ventre, boyau)* ← hin:आंत्र (åntra), ben:অন্ত্র (antra), pan:ਆਂਦਰਾਂ (āndarā̃) + fra:entrailles, eng:entrails, spa:entrañas, por:entranhas  
...
**kable** *corde* ← eng:spa:cable, por:cabo fra:câble, rus:кабель (kabel'), jpn:ケーブル (kēburu), kor:까벨 (kkabel), may:kabel, tur:kablo + ara:حَبْل‎ (ḥabl)  
**kaboga** *citrouille* ← tur:kabak, swa:boga, jpn:カボチャ (kabocha)  
**kadimium** *cadmium* ← eng:cadmium, fra:cadmium, spa:cadmio, por:cádmio, rus:кадмий, zho:镉 (gé), jpn:カドミウム, kor:카드뮴, vie:catmi, hin:काडमियम, ben:ক্যাডমিয়াম, may:kadmium, swa:kadimi, ara: كادميوم  
...
**kafur** *camphre* ← may:kapur, ara: كَافُور‎ (kāfūr), swa:kafuri, fas: کافور‎ (kâfur), hin:कपूर (kapūr), tam:கற்பூரம் (kaṟpūram), eng:camphor, fra:camphre, deu:Kampfer, spa:alcanfor, por:cânfora, rus:камфора (kamfora), jpn:カンフル (kanfuru)  
**kaguzi** *papier* ← zho:榖纸 (gǔzhǐ), yue:榖紙 (guk1zi2), jpn:榖紙 (kokushi), + fas:(kâğaz), hin:काग़ज़ (kāġaz), ben:কাগজ (kagôj), tur:kâğıt, ara:(kāḡid), kan:ಕಾಗದ (kāgada), tel:కాగితము (kāgitamu), tam:காகிதம் (kākitam), wol:keyit, uig:(qeghez)  
...
**kaki** *kaki* ← jpn:柿 (kaki), min:柿 (khī), deu:Kaki, eng:fra:kaki, spa:por:caqui, ara: كَاكَا‎ (kākā), swa:mjoho kaki  
**kal** ** ← eng:quality, deu:Qualität, fra:qualité, spa:calidad, por:qualidade, tur:kalite, may:kualitas  
**kala** *noir* ← hin:काला (kālā); कारौ (kārau), ben:কালো (kalo), pnb:ਕਾਲਾ (kālā) + tam:கருப்பு (karuppu) + tur:kara, kaz:қара (qara)  
...
**kalende** *calendrier* ← eng:calendar, fra:calendrier, spa:por:calendario, rus:календарь (kalendar’), deu:may:kalender, jpn:カレンダー (karendā), kor:카렌더 (karendeo), hin:कैलेण्डर (kaileṇḍar), swa:kalenda, hau:kalanda  
**kali** *base (alcali; basique)* ← ara: قلي (qily), swa:-kali + eng:alkali, fra:alcali, spa:por:álcali, jpn:アルカリ (arukari), kor:알칼리 (alkalli), may:alkali  
...
**kalsium** *calcium* ← eng:calcium (Ca), fra:calcium, spa:calcio, por:cálcio, rus:кальций, zho:钙 (gài), jpn:カルシウム, kor:칼슘, vie:canxi, hin:कैल्शियम, ben:ক্যালসিয়াম, may:kalsium, swa:kalisi, ara: كلسيوم  
**kam** *peu* ← deu:kaum + fas: کم‎ (kam), hin:कम (kam), ben:কম (kôm) + yue:減 (gaam2), jpn:減 (-gen), kor:감 (gam), vie:giảm  
...
**kamisa** *chemise* ← spa:por:camisa, ara:(qamīṣ), hin:क़मीज़ (kāmīz), may:kemeja + swa:kamisi  
...
**kanal** *fossé (canal, tranchée)* ← eng:spa:por:fra:canal, rus:канал (kanal), may:kanal + ara: قَنَاة‎ (qanāh) + ben:খাল (khal)  
**kandi** *bonbon* ← eng:candy, hin:कैंडी (kaiṇḍī), ben:ক্যান্ডি (kyandi), jpn:キャンデー (kyandē), tgl:kendi + ara:fas: قند (qand), tam:கண்டு (kaṇṭu)  
...
**kanse** *cancer* ← eng:fra:cancer, spa:cáncer, por:câncer, hin:कैंसर (kainsar), ben:ক্যান্সার (kênsar), tur:kanser, swa:kansa, jpn:癌 (gan)   
...
**kanu** *canoë* ← eng:canoe, fra:canoë, spa:por:canoa, rus:каноэ (kanoe), jpn:カヌー (kanū), kor:카누 (kanu), tur:kano  
...
**kapa** *tête* ← deu:Kopf, spa:cabeza; cabo, por:cabeça; cabo, may:kepala + hin:कपाल (kapāl) + eng:cape, fra:cap + yue:岬 (gaap3), kor:갑 (gap)  
**kape** *saisir* ← tur:kapmak, hun:kap, spa:por:caber; capturar, eng:capture  
**kar** *travailler* ← fas: کار (kâr), hin:कार (kār), कार्य (kārya), ben:কাজ (kaj), may:karya,kerja + swa:kazi  
...
**karne** *viande* ← spa:por:carne, eng:carnal + fra:charnel; incarnation, deu:Inkarnation  
**karote** *carotte* ← eng:carrot, fra:carotte, deu:Karotte, ful:swa:karoti, hau:karas, amh:ካሮት (karot), may:karot, vie:cà rốt, tam:காரட் (kāraṭ)  
**karta** *carte* ← eng:card, fra:carte, spa:por:carta, deu:Karte, rus:карта (karta), tur:kart, swa:kadi, hau:karta, hin:कार्ड (kārḍa), ben:কার্ড (kārḍa), may:kartu, zho:卡 (kǎ), yue:卡 (kaa1), jpn:カード (kādo), kor:카드 (kadeu)  
**karte** *carte (plan)* ← eng:chart, fra:carte, spa:por:carta, rus:карта (karta), ara: خَرِيطَة‎ (ḵarīṭa), tur:harita  
**kartux** *cartouche* ← fra:cartouche, spa:por:cartucho, hin:कारतूस (kārtūs), ara: خَرْطُوش‎ (ḵarṭūš), ful:kartus, tur:hartuç  
...
**kaska** *carapace (coquille, coquillage, croûte)* ← spa:cáscara, por:casca + nan:殼 (kag4), wuu:殼 (khoq4), jpn:殻 (kaku)  
**kastana** ** ← spa:castaňa, ara:(kastanāʾ), tur:kestane, rus:каштан (kaštan)  
**kasu** ** ← eng:case, fra:cas, spa:por:caso, deu:Kasus  
**kasu** *cajou* ← fra:cajou, spa:cajú, por:caju, eng:cashew, deu:Kaschu, hin:काजू (kājū), ben:কাজু (kaju), ara: كَاجُو‎ (kājū), ful:kasu, may:gajus, tur:kaşu, jpn:カシュー (kashū), kor:캐슈 (kaesyu)  
...
**katil** *lit* ← tam:கட்டில் (kaṭṭil), may:katil, hin:खाट (khāṭ), eng:cot, spa:por:catre  
...
**kave** *creuser (fosse)* ← spa:por:cavar, eng:excavar, fra:excaver  
**ke** *que (quoi)* ← fra:que, spa:qué, por:o que + ben:কে (ke) + zho:何 (hé)  
...
**ken** *connaître ou savoir* ← deu:kennen, eng:ken + ben:জ্ঞান (gên) + may:kenal  
**kentaur** *centaure* ← eng:centaur, fra:centaure, spa:por:centauro, rus:кентавр (kentavr), hin:सेंटूर (seṇṭūr), ara: قَنْطُور‎ (qanṭūr), tur:kentaur, swa:kentauro, jpn:ケンタウロス (Kentaurosu), kor:켄타우로스 (kentauroseu)  
**kerne vuki** *arme nucléaire* ← eng:nucleus, spa:por:núcleo, may:nuklir  
**kerne** *coeur* ← deu:Kern, eng:kernel, fra:coeur, por:cerne + hin:केंद्र (kendr), ben:কেন্দ্ৰ (kendrô), tam:கேந்திரம் (kēntiram)  
...
**keze** *fromage* ← spa:queso, por:queijo, may:keju, deu:Käse, eng:cheese, zho:起司 (qǐsī), yue:知士 (zi1si62), jpn:チーズ (chīzu), kor:치즈 (chijeu), hin:चीज़ (cīz), swa:chizi  
...
**kime** *substance* ← eng:chemistry, fra:chimie, spa:por:química, rus:химия (himiya), ara:(kīmiyāʾ), may:kimia, swa:kemia, hau:kimiyya, tur:kimya  
...
**kioske** *pavillon* ← fas:کوشک‎ (kôšk), tur:köşk; kiosk, eng:kiosk, spa:quiosco, por:quiosque, rus:киоск (kiosk), hin:कीओस्क (kīosk), may:kios, jpn:キオスク (kiosuku)  
**kira** ** ← ara:(kirāʾ), tur:kira, hin:किराया (kirāyā), urd:(kirāyā), fas:(kerāya), spa:alquiler  
**kirate** *carat* ← ara: قِيرَاط‎ (qīrāṭ), eng:fra:carat, spa:por:quilate, rus:карат (karat), zho:克拉 (kèlā), jpn:カラット (karatto), kor:캐럿 (kaereot), may:hau:karat, swa:karati, tur:kırat  
**kisma** *destin* ← ara: قِسْمَة‎ (qisma), hin:क़िस्मत (qismat), ben:কিসমত (kiśmôt), eng:kismet, rus:кисмет (kismet), tur:kısmet  
**kitabe** *écrire* ← ara: كِتَاب‎ (kitāb), fas: کتاب‎ (ketâb), hin:किताब (kitāb), tur:kitap; katip, may:kitab, katib, swa:kitabu; katibu, hau:littafi  
**kivi frute** *kiwi* ← eng:fra:spa:may:swa:kiwi, por:quivi, jpn:キーウィ (kīwi), kor:키위 (kiwi), hin:कीवी (kīvī), tur:kivi, ara: كِيوِي‎ (kiwī)  
...
**klin** *tendance* ← eng:-cline, fra:-cliner, por:spa:-clinar, rus:склонить (sklonit’)  
...
**koda** *queue* ← eng:coda, spa:coda,cola, por:cauda, fra:côté, jpn:コーダ (kōda)  
...
**koli** *chou* ← deu:Kohl, spa:col, may:kol, zho:高丽菜 (gāolícài) + eng:cauliflower; broccoli, fra:brocoli, spa:coliflor; brócoli, por:brócolis, rus:брокколи (brokkoli), may:tur:brokoli, tgl:koliplor, ara: بْرُوكُلِي‎ (brūkulī), jpn:ブロッコリ (burokkori), kor:브로콜리 (beurokolli)  
...
**koma** *virgule* ← eng:comma, deu:Komma, hin:कामा (kāmā), jpn:コンマ (konma), kor:콤마 (komma), may:koma  
**komike** *comique* ← eng:comic, fra:comique, spa:por:cómico + rus:комедия (komedija), jpn:コメディ (komedi), kor:코미디 (komidi)  
**kompani** ** ← eng:company, hin:कंपनी (kampanī), rus:компания (kompaniya), tgl:kompanya, pol:kompania  
**kon** *avec (commun)* ← eng:con-; common, fra:con-; commun, spa:con-; común, por:con-; comum, rus:кон- (kon-) + zho:共 (gòng), yue:共 (gung), kor:공 (gong), vie:cộng  
...
**konu** *cône* ← eng:por:cone, fra:cône, spa:cono, rus:конус, may:kon, swa:tur:koni  
**kopernium** *copernicium* ← eng:fra:copernicium, spa:copérnico, por:copernício, rus:коперниций, jpn:コペルニシウム, kor:코페르니슘, vie:copernici, may:copernicium, swa:kopernici  
**kopi** *copie* ← eng:copy, fra:copie, spa:por:copia, rus:копия (kopiya), hin:कापी (kāpī), tur:kopya, may:kopi, zho:拷貝 (kǎobèi), jpn:コピー (kopī)  
**koral** *corail* ← eng:spa:por:coral, fra:corail, deu:Koralle, rus:коралл + may:karang  
...
**kosme** *cosmos* ← rus:космос (kosmos), eng:fra:spa:cosmos  
...
**kotumbar** *coriandre* ← tam: கொத்துமல்லி (kottumalli), tel:కొత్తిమీర (kottimīra), may:ketumbar, scr:कुस्तुम्बरी (kustumbarī), hin:कोथमीर (kothmīr), mar:कोथिंबीर (kothimbīr), ara: كُزْبَرَة‎ (kuzbara)  
...
**krepe** *crêpe* ← fra:eng:crêpe, por:crepe, spa:crepa, tur:krep, zho:可丽饼 (kělìbǐng)  
...
**kromium** *chrome* ← eng:chromium, fra:chrome, spa:cromo, por:crómo, rus:хром, jpn:クロム, kor:크로뮴, vie:crom, hin:क्रोमियम, ben:ক্রোমিয়াম, may:krom, swa:kromi, ara: كروم  
**krote** *taupe* ← rus:крот (krot), pol:kret  
**kruasan** *croissant* ← fra:eng:croissant, por:croassã, spa:cruasán, rus:круассан, zho:可颂 (kěsòng), jpn:クロワッサン (kurowassan), kor:크루아상 (keruasang), hin:क्रोइसैन (kroisain)  
...
**kuku** *coucou* ← eng:cuckoo, fra:coucou, spa:por:cuco, rus:кукушка (kukushka), fas: کوکو‎ (kuku), jpn:郭公 (kakkō), zho:布谷鸟 (bùgǔniǎo), yue:布谷鳥 (bou3 guk1 niu5), tur:guguk, hau:kukku  
**kule** *esclave (serf)* ← tur:köle; kul, hin:क़ुली (qulī), tam:கூலி (kūli), may:kuli, zho:苦力 (kǔlì), yue:咕哩 (gu1 lei1), jpn:苦力 (kūrī), kor:쿨리, vie:cu li, eng:fra:coolie, spa:culi, por:cule, deu:Kuli, rus:кули (kuli)  
**kulte** *cultiver* ← eng:cultivate, fra:cultiver, spa:por:cultivar, rus:культура (kulʹtúra), fas: کولتور‎ (kultur), tur:kültür, jpn:カルチャー (karuchā), tam:கலாச்சாரம் (kalāccāram)  
**kume** *accumuler* ← eng:cumulate, fra:cumuler, spa:por:cumular + tur:kumul + ara:كَوْمَة‎ (kawma), fas: کومه (kume)  
**kundi** *jarre (carafe, cruche)* ← zho:罐子 (guànzi), yue:罐子 (gun3zi2), kor:관 (guan) + may:kendi, tha:กุณฑี (gundii)  
...
**kuran** *Coran* ← ara: الْقُرْآن‎ (al-qurʔān), tur:Kuran, swa:Kurani, hau:Alƙur'ani, ful:alkur'aana, eng:Quran, fra:Coran, spa:Corán, por:Corão, rus:Коран (Koran), fas: قرآن‎ (qor-ân), hin:क़ुरान (qurān), ben:কুরআন (kuran), may:Al-Qur'an, zho:古兰经 (gǔlánjīng), jpn:クルアーン (kuruān), kor:꾸란 (kkuran), vie:kinh Koran  
...
**lake** *laque* ← eng:lacquer, deu:Lack, spa:por:laca, fra:laque, rus:лак (lak), may:lak, ara: لَكّ‎ (lakk), tur:lake, zho:蜡克 (làkè), jpn:ラッカー (rakkā), kor:래커 (raekeo)  
**lala** ** ← eng:lull, pol:lulać, fas: لالا کردن‎ (lâlâ kardan) + jpn:ララバイ (rarabai), tgl:lalay + swa:-lala  
**lampa** *lampe* ← eng:lamp, deu:fra:lampe, spa:lámpara, por:lâmpada, rus:лампа (lampa), ara: لمبة‎(lamba), jpn:ランプ (ranpu), kor:램프 (raempeu), hin:लैंप (laimp), ben:ল্যাম্প (lyamp), ful:may:lampu, tur:lamba  
...
**lasa** *ordures* ← zho:垃圾 (lājī / lèsè), yue:垃圾 (laap6 saap3), hak:垃圾 (lá-sap), nan:垃圾 (lah-sap)  
**lasun** *ail* ← hin:लहसुन (lahsun), ben:রসুন (rôśun) + zho:大蒜 (dàsuàn), yue:大蒜 (daai6 syun3), kor:대산 (daesan)  
...
**laurencium** *lawrencium* ← eng:lawrencium, fra:lawrencium, spa:laurencio, por:lawrêncio, rus:лоуренсий, zho:铹 (láo), jpn:ローレンシウム, kor:로렌슘, vie:lorenxi, lawrenci, hin:लॉरेंशियम, ben:লরেনসিয়াম, may:lawrensium, swa:lawirensi, ara: لورنسيوم  
**laxe** *lâcher (laisser)* ← eng:(re)lax, fra:(re)lâcher, spa:(re)lajar, ita:lasciare, deu:lassen  
...
**lete** *lire* ← por:leer; leitor, spa:ler; lector, fra:lire; lecteur, rus:лектор (lektor) eng:literature, deu:Literatur, fra:littérature, tur:literatür  
...
**lexe** *mot* ← deu:eng:fra:spa:por:lex-, rus:лекс- (leks-), may:leks-  
...
**lige** *ligue (alliance)* ← fra:ligue, deu:spa:pol:por:liga, eng: league, rus: лига (liga), tur:lig, swa:ligi, jpn:リーグ (rīgu)  
...
**limon** *citron* ← fas:(limun), eng:lemon, tur:limon, rus:лимон (limon), spa:limón, por:limão, hin:नींबू (nīmbū), urd:(nībū), zho:柠檬 (níngméng), yue:檸檬 (ning4mung1), jpn:檸檬 (remon), kor:레몬 (remon), vie:lêmon, swa:ndimu; limau, ful:leemuure, ben:লেবু (lebu)  
...
**linxe** *lynx* ← eng:fra:lynx, spa:por:lince, hin:लिंक्स (links)  
...
**litre** *litre* ← eng:fra:tur:litre, deu:may:liter, spa:por:litro, rus:литр (litr), pol:litr, ara: لتر‎(litr), hin:लीटर (līṭar), ben:লিটার (liṭar), jpn:リットル (rittoru), kor:리터 (riteo), vie:lít, swa:hau:lita, ful:liter  
...
**lixu** *écureuil* ← zho:栗鼠 (lìshǔ), jpn:栗鼠 (risu)  
...
**lote** *lot* ← eng:fra:lot, deu:Los, spa:por:loteria, rus:лотерея (lotereia), fas: لاتاری‎ (lâtâri), hin:लॉटरी (lŏṭrī), ben:লটারি (lôṭari), zho:乐透 (lètòu)  
**lotra** *loutre* ← eng:otter + fra:loutre, spa:tgl:lutrino, por:lontra + rus:выдра (vydra)  
**lou** ** ← zho:漏 (lòu), yue:漏 (lau6), jpn:漏 (rō), 루 (ru)  
**luga** *vert* ← zho:绿 (lǜ), yue:綠 (luk6), vie:lục, kor:록/녹 (rok/nok), jpn: 緑色 (ryokushoku)  
...
**lutesium** *lutécium* ← eng:lutetium, fra:lutécium, spa:lutecio, por:lutécio, rus:лютеций, zho:镥 (lǔ), jpn:ルテニウム, kor:루테튬, vie:lutexi, hin:लुटेटियम, ben:লুটেসিয়াম, may:lutetium, swa:luteti, ara: لوتيتيوم  
...
**makin** *machine* ← eng:fra:machine, deu:Maschine, spa:por:máquina, ful:masin, swa:mashine, hin:मशीन (maśīn), ben:মেশিন (meśin), may:mesin, ara: مَاكِينَة‎ (mākīna), tur:makine, jpn:マシン (mashin), kor:머신 (meosin)  
**mal** *propriété (possession, bien)* ← ara:fas:urd:  مَال‎ (māl), hin:माल (māl), ben:মালিক, swa:mali, hau:mallake, may:milik, tur:mal  
...
**mame** *sein* ← fas: ممه‎ (mame), tur:meme, eng:mamma, spa:por:mama + fra:mammifère, may:mamalia  
...
**mangan** *manganèse* ← eng:manganese, fra:manganèse, spa:manganeso, por:manganésio, rus:марганец, zho:锰 (měng), jpn:マンガン, kor:망가니즈, vie:mangan, hin:मैंगनीज, ben:ম্যাঙ্গানিজ, may:manggan, swa:manganisi, ara: منجنيز  
**mango** ** ← mal:മാങ്ങ (māṅṅa), eng:spa:tur:mango, por:manga, rus:манго (mango), may:mangga, jpn:マンゴー (mangō), kor:망고 (manggo), ful:mannguure  
**mania** *manie* ← eng:por:mania, deu:Manie, fra:manie, spa:manía, rus:мания (maniya)  
**manioka** *manioc* ← eng:fra:manioc, spa:por:mandioca, rus:маниока (manioka), kor:마니옥 (maniok), lin:manyɔ́kɔ, kon:mandioko  
**manite** *aimant* ← eng:magnet, fra:magnétique, spa:magnete, rus:магнит (magnit), tur:mıknatıs, ara: مَغْنَاطِيس‎ (maḡnāṭīs), may:maknit  
...
**mantu** *quenelle (ravioli)* ← rus:манты (manty), zho:馒头 (mántóu), jpn;饅頭 (manjū), kor:만두 (mandu), fas:urd: منتو‎ (mantu), tur:mantı, rus:манты (manty)  
**mar** *fois* ← ara: مرة (marra), swa:mara, hau:marra, fas: بار‎ (bâr), hin:बार (bār), ben:বার (bar), tam:முறை (muṟai), deu:Mal  
...
**margarin** *margarine* ← eng:fra:margarine, spa:por:margarina, rus:маргарин (margarín), tur:margarin, hin:मार्जरीन (mārjarīn), may:marjerin, zho:麦淇淋 (màiqílín), jpn:マーガリン (māgarin)  
**margarita** ** ← spa:por:margarita, fra:marguerite, deu:Margerite, rus:маргаритка (margaritka)  
**Maris** *Mars* ← ell:Άρης (Áris), eng:fra:tur:Mars, spa:por:Marte, rus:Марс (Mars) + ara: اَلْمِرِّيخ‎ (al-mirrīkh), swa:Mirihi, may:Mars; Marikh  
**marke** *trace* ← eng:mark, spa:por:marca, fra:marque, kor:마크 (makeu), jpn:マーク (māku), ful:marke  
...
**master** *maître* ← por:mestre, fra:maître, pol:mistrz, eng:master, rus:мастер (master), spa:maestro, deu:Meister, hin:(mistrī)  
...
**matras** *matelas* ← eng:mattress, deu:Matratze, fra:matelas, rus:матрас (matras), may:matras, jpn:マットレス (mattoresu), kor:매트리스 (maeteuriseu)  
**max** *plus* ← spa:mas; máximo, por:mais; máximo, + eng:fra:maximum, rus:максимум (maksimum), may:maksimum, fas: ماکسیمم‎ (mâksimom)  
**mayur** *paon* ← hin:मयूर (mayūr), ben:ময়ূর (môyūr), tam:மயில் (mayil) + may:merak  
**mazang** *mah-jong* ← eng:spa:por:mahjong, fra:mah-jong, rus:маджонг (madžong), may:mahjung, zho:麻将 (májiàng), yue:麻将 (maa4zoeng3), jpn:麻雀 (mājan), kor:마작 (majang), vie:mạt chược  
...
**medal** *médaille* ← eng:medal, spa:medalla, por:medalha, fra:médaille, deu:Medaille, rus:меда́ль (medálʹ), fas: مدال‎ (medâl), hin:मेडल (meḍal), ben:মেডেল (meḍel), may:medali, ara: مِيدَالِيَة‎ (mīdāliya), tur:madalya, jpn:メダル (medaru), kor:메달 (medal), vie:mề đay  
**medan** *place* ← ara: مَيْدَان‎ (maydān), fas:(meydan), hin:मैदान (maidān), ben:ময়দান (moidan), tur:meydan, swa:medani, rus:майдан (maydan)  
**mede** *aide (secours)* ← ara: مَدَد‎ (madad), fas: مدد (madad), hin:मदद (madad), ben:মদদ (môdôd), tel:మద్దతు (maddatu) + fra:aider, eng:aid + rus:мэдэ (mede), jpn:メーデー (mēdē), kor:메이데이 (meidei)  
...
**mei** *beau* ← zho:美 (měi), yue:美 (mei5), jpn:美 (mi), kor:미 (mi), vie:mĩ, mỹ  
**meitnerium** *meitnérium* ← eng:meitnerium, fra:meitnérium, spa:meitnerio, por:meitnério, rus:майтнерий, jpn:マイトネリウム, kor:마이트너륨, vie:meitneri, hin:मेइट्नेरियम, ben:মিটনেরিয়াম, may:meitnerium, swa:meitneri, ara: مايتنريوم  
...
**memo** *mémoire* ← eng:memory, fra:mémoire, spa:memoria, por:memória  
**men** ** ← zho:们 (men), yue:們 (mun4) + eng:many + kor:많- (man-) + (tumen) hin:तुम (tum), rom:tumen  
**mendelevium** *mendélévium* ← eng:mendelevium, fra:mendélévium, spa:mendelevio, por:mendelévio, rus:менделевий, zho:钔 (mén), jpn:メンデレビウム, kor:멘델레븀, vie:menđelevi, hin:मेण्डेलीवियम, ben:মেন্ডেলিভিয়াম, may:mendelevium, swa:mendelevi, ara: مندلفيوم  
...
**mesi** *messie* ← eng:messiah, fra:messie, spa:mesías, por:messias, rus:мессия (messiya), ara: مَسِيح‎ (masīḥ), hin:मसीह (masīh), ben:মসিহ (môśih), may:al-Masih, swa:Masiya, tur:Mesih, hau:Almasihu  
...
**mi** *je (me)* ← eng:fra:por:me, spa:mi; me, fas: من‎ (man), hin:मैं (mẽ), ben:আমি (ami), ful:mi, swa:mimi  
**miau** *chat* ← zho:猫 (māo), yue:貓 (maau), vie:mèo, tha:แมว (mæo), swa:nyau + eng:miaow; meow, fra:miaou, deu:spa:por:miau, rus:мяу (myau), fas: میو‎ (miyu), hin:म्याऊँ (myāū̃), tam:மியாவ் (miyāv), tur:miyav,   
...
**mime** *imiter* ← eng:fra:mime, spa:por:mímico, rus:мим (mim)  
...
**minte** *menthe* ← eng:mint, spa:por:menta, fra:menthe, rus:мята (m’ata), jpn:ミント (minto)  
**minute** ** ← eng:minute, spa:por:minuto, rus:мину́та (minúta), hin:मिनट (minaṭ), ben:মিনিট (miniṭ), may:minit  
**mirde** *faible* ← eng:mild, pol:mierny, hin:मृदु (mridu), wuu:微 (mi3), yue:微 (mei4)  
**mire** *mirer* ← fra:mirer, spa:por:mirar + jpn:見る (miru) + ara:مِرْآة‎ (mirʾāh)  
...
**Misre** *Égypte* ← ara:(miṣr), tur:Mısır, swa:Misri, hin:मिस्र (misra), ben:মিশর (miśôr), hau:Masar  
**mite** ** ← eng:myth, deu:Mythos, fra:mythe, spa:por:mito, rus:миф (mif), hin:मिथक (mithak), tur:mit  
**mitre** *mètre* ← eng:tur:metre, deu:may:meter, fra:mètre, spa:por:metro, rus:метр (metr), ara: متر‎ (mitr), zho:米 (mǐ), jpn:メートル (mētoru), kor:미터 (miteo), vie:mét, hin:मीटर (mīṭar), ben:মিটার (miṭar), swa:hau:mita, ful:meter  
**mixe** ** ← deu:mischen, rus:мешать (měšat'), pol:mieszać, eng:mix, ita:miscelare, + hin:मिश्रण (miśrān)  
**mode** *mode (manière, façon)* ← fra:eng:mode, deu:Mode; Modus, spa:por:modo, rus:мода (moda), tur:mod, may:mode, kor:모드 (modeu) + zho:模 (mó), yue:模 (mou4), jpn:模 (mo); モード (mōdo)  
...
**mole** *moudre* ← zho:磨 (mò), yue:磨 (mo4) tha:โม่ (mo), fra:moulin, spa:molino, rus:молоть  (molot’)  
...
**moliden** *molybdène* ← eng:molybdenum, fra:molybdène, spa:molibdeno, por:molibdénio, rus:молибден, zho:钼 (mù), jpn:モリブデン, kor:몰리브덴, vie:molypđen, hin:मोलिब्डेनम, ben:মলিবডেনাম, may:molibden, swa:molibdeni, ara: مولبيدنيوم  
...
**mote** *mouvoir (bouger)* ← eng:move; motion, fra:mouvoir, spa:por:mover + rus:мотор (motor), tur:may:motor, ara:(mutūr), zho:摩托 (mótuō), yue:摩打 (mo1daa2), jpn:モーター (mōtā), kor:모터 (moteo), vie:mô-tơ, hin:मोटर (moṭar), ben:মোটর (moṭôr), swa:hau:mota  
**mudan** *pivoine* ← zho:牡丹 (mǔdān), yue:牡丹 (maau5 daan1), jpn:牡丹 (botan), kor:모란 (moran), vie:mẫu đơn  
**muka** *visage* ← ben:মুখ (mukh), hin:मुख (mukh), tam:முகம் (mukam), tel:(mukhamu), may:muka, tgl:mukha  
**mula** *racine* ← hin:mar:मूल (mūl), ben:মূল (mūl), tel:మూలము (mūlamu), may:tgl:mula, khm:មូល (mul), mya:မူလ (mula), tha:มูล (mun)  
...
**murmeke** *fourmi* ← fas: مور‎ (mur), rus:муравей (muravei), eng:myrmeco-, deu:myrmeko-, fra:myrméco-  
**mus** *devoir* ← eng:must, deu:müssen, ukr:мусити (musiti), pol:musieć, cze:musit  
...
**Muxin** *Jupiter* ← zho:木星 (Mùxīng), yue:木星 (muk6 sing1), kor:목성 (mokseong), vie:Mộc tinh, jpn:木星 (Mokusei) + ara: اَلْمُشْتَرِي‎ (al-muštarī), swa:Mshtarii, may:Musytar  
**muxmula** *néflier* ← rus:мушмула́ (mušmula), tur:muşmula, ara: مَشْمَلَة‎ (mašmala)  
**muxu** *souris* ← rus:мышь (myś), pol:mysz, fas: موش‎ (muš) + zho:鼠 (shǔ)  
...
**nabi** *prophétiser* ← ara: نَبِيّ‎ (nabiy), fas: نبی‎ (nabi), hin:नबी (nabī), ben:নবী (nôbi), may:nabi, tur:nebi, swa:nabii, ful:hau:annabi, amh:ነቢይ (näbiy), som:nebi  
**nadir** *rare* ← ara: نَادِر‎ (nādir), fas: نادر (nâder), hin:नादिर (nādir), swa:nadra, tur:nadir, hau:nadiri  
**nafas** ** ← ara:fas:(nafas), may:napas, tur:nefes, hau:numfashi  
**nagis** *pollution* ← ara:نجس (najis), may:najis, swa:najisi, fas:نجس (najes) + eng:najis, rus:наджаса (nadžasa)  
...
**nam** *nom* ← deu:eng:name, fra:nom, hin:नाम (nām), ben:নাম (nam), may:nama, tha:นาม (naam) + jpn:名前 (namae)  
...
**narke** *drogue (narcotique, dope)* ← eng:narcotic, fra:narcotique, spa:por:narcótico, rus:наркотик (narkotik), may:narkotik  
**nas** ** ← ara:(nās) + eng:fra:nation, deu:Nazion, por:nação, spa:nación, pol:nacja, rus:нация (natsiya)  
**nate** *naître (naissance)* ← fra:naître, spa:por:nato, eng:-nate + deu:Nazion, pol:nacja, rus:нация (natsiya) + ara:(nās)  
...
**nege** *nier* ← eng:negate, deu:negieren, fra:nier; négatif, spa:por:negar, rus:негативный (negativniy)  
**nekre** *cadavre (corps)* ← eng:spa:por:necro-, fra:nécro-, deu:nekro-, rus:некро- (nekro-)  
**nelu** *quatre (4)* ← kor:넷 (net) + swa:nne, zul:ne, ful:nay + mal:നാലു (nālu), tel:నాలుగు (nālugu), kan:ನಾಲ್ಕು (nālku) + fin:neljä, est:neli, hun:négy  
**nen mes den** ** ← zho:年月日 (niányuèrì), yue:年月日 (ninyutyat), jpn:年月日 (nengappi), kor:연월일 (yeonworil)  
**nen** *an (année)* ← zho:年 (nián), yue:年 (nin4), jpn:年 (nen), kor:년 (nyeon), vie:năm,niên  
...
**nere** *néré* ← man:nɛrɛ, wol:nere, fra:néré, ful:nɛtɛ  
...
**nia** *intention* ← ara: نِيَّة‎ (niyya), hin:नीयत (niyat), may:niat, swa:nia, hau:niyya, tur:niyet  
...
**nil** *bleu* ← ben:নীল (nīl), hin:नीला (nīlā), urd:(nīlā), tam:நீலம் (nīlam), may:nilam  
...
**nobelium** *nobélium* ← eng:nobelium, fra:nobélium, spa:nobelio, por:nobélio, rus:нобелий, zho:锘 (nuò), jpn:ノーベリウム, kor:노벨륨, vie:nobeli, hin:नोबेलियम, ben:নোবেলিয়াম, may:nobelium, swa:nobeli, ara: نوبليوم  
...
**nume** *nombre (numéro; contar)* ← eng:number, fra:nombre, spa:por:número, rus:номер (nomer), deu:Nummer, jpn:ナンバー (nanbā), hin:नंबर (nambar), ben:নম্বর (nômbôr), tur:numara, may:nombor, swa:namba(ri)  
...
**ope** *œuvre (travail)* ← eng:opus, spa:por:obra, rus:опус (opus)  
**orange** *orange (fruit)* ← eng:orange, spa:naranja, por:laranja, hin:नारंगी (narangi), jpn:(orenji), + fra:orange, rus:оранжевый (oranževiy)  
**ordu** *armée* ← mon:ᠣᠷᠳᠤ (ordu), tur:ordu, ara: عُرْضِيّ‎ (ʿurḍiyy), fas: اردو (ordu), hin:उर्दू (urdū) + eng:fra:horde, spa:por:horda, rus:орда (orda), zho:斡耳朵 (wò'ěrduǒ), jpn:オルド (orudo), kor:오르도 (oreudo)  
...
**pa** *pere (papa)* ← eng:fra:papa, spa:papá, por:pai, rus:папа (papa), ara:(bābā), zho:爸 (bà), yue:爸 (baa1), jpn:パパ (papa), kor:아빠 (appa), hin:बाप (bāp), ben:বাবা (baba), may:bapa, hau:swa:tur:baba, ful:ba; baaba  
...
**pake** *paquet* ← eng:pack, rus:пакет (paket), hin:पैकेट (pækeṭ), deu:tur:paket, fra:paquet, spa:paquete, por:pacote, ful:pakɛt, hau:fakiti  
**palaba** *querelle (dispute, palabre)* ← eng:palaver, deu:Palaver, fra:palabre, krio:plabah, kon:palaba  
...
**papagai** *perroquet* ← ara: بَبَغَاء‎ (babaḡāʾ), tur:papağan, deu:Papagei, spa:papagayo, por:papagaio, rus:попугай (popugay), jin:八哥 (bāgē)  
...
**pari** *fée* ← fas: پری‎ (pari), hin:परी (parī), ben:পরী (pôri), may:tur:peri, hau:fari, eng:fairy; peri, fra:péri, deu:Peri, rus:пери (peri)  
...
**pas** *passer* ← eng:past, spa:pasado, por:passado, fra: passé + ful:pasaas, man:pasaasoo  
**pasporte** *passeport* ← eng:passport, fra:passeport, spa:pasaporte, por:passaporte, rus:паспорт (pasport), hin:पासपोर्ट (pāsporṭ), ben:পাসপোর্ট (pasporṭ), may:paspor, swa:paspoti, jpn:パスポート pasupōto), hau:fasfo  
...
**pauze** *pause* ← deu:Pause, eng:deu:fra:pause, spa:por:pausa, rus:пауза (pauza)  
**payace** *clown (paillasse)* ← ita:pagliaccio, fra:paillassa, spa:payaso, por:palhaço, rus:паяц (payac), tur:palyaço  
...
**pena** *plume* ← por:pena, fas: پر‎ (par), hin:पर (par), rus:перо (pero) + jpn:ペン (pen), kor:펜 (pen), tam:பேனா (pēṉā)  
**pende** ** ← eng:pendant, por:fra:pender  
**penis** ** ← eng:tur:may:penis, spa:pene, por:fra:pénis, rus:пенис (penis)  
**pente** *peinture* ← eng:paint, spa:por:pintura, fra:peinture, nld:pek, jpn:ペンキ (penki), hin:पेंट (penṭa), ful:pentur, hau:fenti  
**per** *paire* ← deu:Paar, eng:pair, fra:paire, spa:por:par, rus:пара (para), yue:啤 (pe1), jpn:ペア (pea), kor:페어 (peeo), swa:pea  
**pera** *poire* ← eng:pear, fra:poire, spa:por:pera, may:pir, swa:pea + kor:배 (bae)  
**perde** *pet (vesse)* ← ben:পাদ (pad), hin:पाद (pād), spa:pedo, por:peido, fra:pet, rus:пердение (perdeniye)  
**perex** ** ← eng:perish, fra:périr, spa:por:perecer + fas: پریش‎ (parêš), tur:perişan, hin:परेशान (pareśan), ben:পেরেশান (pereśan)  
**pesa** *argent* ← hin:पैसा (paisā), mar:पैसा (paisā), pnb:ਪੈਸਾ (pēsā), guj:પૈસો (paiso), ara:(bēzāt), swa:pesa + spa:peso  
...
**petra** *roche (pierre)* ← hin:पत्थर (patthar), urd:(patthar), ita:pietra, por:pedra, spa:piedra, fra:pierre  
**pexe** *poisson* ← spa:pez, por:peixe, ita:pesce + eng:fish, deu:Fisch  
...
**pin** *épingle* ← eng:pin, jpn:ピン (pin), kor:핀 (pin), hin:पिन (pin), ful:pingu, wol:ping  
...
**pipa** *luth* ← zho:琵琶 (pípa), yue:琵琶 (pei4 paa4), jpn: 琵琶 (biba), kor:비파 (bipa), vie:tì bà  
**pipe** *pipe* ← eng:fra:pipe, deu:Pfeife, spa:may:pipa, fas: پیپ‎ (pip), hin:पाइप (pāip), ben:পাইপ (paip), jpn:パイプ (paipu), vie:píp, tur:pipo, ara: بِيبَة‎‎ (bība)  
...
**pisea** *Épicéa* ← spa:por:pícea, fra:Épicéa  
...
**pole** *ville* ← eng:spa:-polis, deu:fra:por:-pole, rus:-поль (-pol'), may:tur:-pol  
...
**pompe** *pompe* ← eng:pump, spa:por:bomba, fra:ful:pompe, deu:Pumpe, rus:помпа (pompa), fas: پمپ‎ (pomp), hin:पंप (pamp), ben:পাম্প (pamp), tel:పంపు (pampu), tur:may:pompa, hau:famfo, zho:泵 (bèng), yue:泵 (bam1), jpn:ポンプ (ponpu), kor:펌프 (peompeu), vie:bơm  
**pope** *peuple* ← eng:people, fra:peuple, spa:pueblo, por:povo + deu:populär, rus:популярный (populyarnïy), may:populer, tur:popüler  
...
**pote** *pot (vase)* ← eng:fra:pot, spa:por:pote, may:poci, jpn:ポット (potto), kor:포트 (poteu), ful:pooti; fotiire  
...
**pro** *en avant* ← deu:eng:fra:spa:por:pro-, hin:प्र- (pra-), ben:প্র- (prô-), may:pro-; pra-  
...
**profesor** *professeur* ← eng:deu:por:professor, fra:professeur, spa:profesor, rus:профессор (professor), ara: بروفيسور‎ (brofesōr), tur:profesör, swa:profesa, hau:farfesa, fas:پروفسور‎ (profesor), hin:प्रोफ़ेसर (profesar)  
...
**pute** *pourri* ← eng:putrid, spa:por:podre, fra:putride + zho:腐 (fǔ), jpn:腐 (fu) + tha:ผุ (phu)  
...
**ragbi** *럭비* ← 橄榄球  
**rage** *ferveur* ← hin:राग (rāg), ben:রাগ (rag), tam:ராகம் (rāgam) + eng:fra:rage, deu:Rage  
...
**rai** *avis (opinion)* ← ara:(raʾy), swa:rai, hau:ra'ayi, hin:राय (rāy), fas:(ra'y), tur:rey  
...
**rakun** *raton laveur* ← eng:raccoon, ara: رَاكُون‎ m (rākūn), hin:रैकून (raikūn), fas: راکون‎ (râkon), may:tur:rakun  
...
**rase** *race* ← eng:fra:race, spa:raza, por:raça, rus:раса (rasa), may:ras  
...
**reseta** *recette* ← ita:ricetta, rus:рецепт (retsept), deu:Rezept, spa:receta, por:receita, fra:recette, may:resep, tur:reçete  
...
**rime** *rime* ← spa:por:rima, fra:rime, eng:rhyme, pol:rym, deu:Reim  
...
**rite** *procédé (rite)* ← hin:रीति (rīti), ben:রীতি (rīti) + eng:fra:rite, spa:por:rito, rus:ритуал (ritual), may:ritus  
**ritim** *rhythme* ← tur:ritim, eng:rhythm, fra:rhythme, spa:por:ritmo, rus:ритм (ritm), kor:리듬 (rideum), may:ritme  
**rivo** *rivière (fleuve)* ← spa:por:rio, eng:river, fra:rivière  
...
**rode** *rose* ← ell:ῥόδον (rhódon), fra:eng:rose, spa:por:rosa, rus:роза (roza), may:ros, tgl:rosas + ara: وَرْد‎ (ward), swa:waridi  
...
**roke** *secouer* ← eng:fra:spa:por:rock, rus:рок (rok), hin:रॉक (rŏk), ben:রক (rôk), jpn:ロック (rokku), kor:록 (rok), ara: رُوك‎ (rūk)  
...
**rul** *rouleau* ← eng:roll, deu:Rolle, fra:rouleau, spa:rollo, por:rolo, rus:рулон (rulon), tur:rulo, jpn:ローラー (rōrā)  
...
**sake** *sac* ← deu:eng:sack, fra:sac, spa:por:saco, may:kon:saku, ful:saakuuru  
**sal** *salut* ← ara:fas: سلام‎ (salâm), hin:सलाम (salām), ben: সালাম (salam), may:selamat, swa:salamu, ful:salaam, hau:salam, tur:selam + eng:salute, fra:salut, spa:salude, por:saúde + kor:잘 (jal)  
**sala** *salle* ← fra:salle, spa:salón, por:salão, deu:Saal, rus:зал (zal), hin:साल (sāl); शाला (śālā), ara: صَالَة‎ (ṣāla), tel:శాల (śāla), khm:សាលា (saalaa)  
...
**sam** *égal (même)* ← eng:same, fra:semblable, rus:самый (samyy), fas:هم‎ (ham), hin:सम (sam), may:sama + ara: سَوَاء (sawāʾ), swa:sawa  
**sama** *ciel* ← ara: سَمَاء‎ (samāʾ), swa:samawati, amh:ሰማይ (sämay), hau:sama, yor:sanma, tur:sema, orm:samii + ful:asamaan, hin:आसमान (āsmān), ben:আসমান (aśman)  
**samarium** *samarium* ← eng:samarium, fra:samarium, spa:samario, por:samário, rus:самарий, zho:钐 (shān), jpn:サマリウム, kor:사마륨, vie:samari, hin:सैमरियम, ben:সামারিয়াম, may:samarium, swa:hau:samari, ara: ساماريوم  
**sanduice** *sandwich* ← eng:fra:spa:sandwich, por:sanduíche, rus:сандвич (sandvič), ara:(sandawitš), zho: (sānwénzhì), jpn:サンドイッチ (sandoichi), hin:सैंडविच (saiṇḍvic), may:sandwic, hau:sanwici  
...
**sanga** *ordre* ← hin:संघ (saṅgh), ben:সঙ্ঘ (śôṅgh), tam:சங்கம் (saṅgam), may:sangha, zho:僧伽 (sēngjiā), kor:승가 (seungga), vie:tăng già, tha:สงฆ์ (sǒng), khm:សង្ឃ (sɑng), mya:သံဃာ (samgha)  
...
**seku** *pierre* ← zho: 石 (shí), yue:石 (sek3), jpn:石 (seki), kor:석 (seok)  
**sekunde** ** ← eng:second, spa:por:segundo, rus:секунда (sekunda), swa:sekunde, hin:सैकण्ड (saikaṇḍ), ben:সেকেন্ড (śekenḍ)  
**sekur** *sûr* ← eng:secure, deu:sicher, spa:por:seguro  
**sel** *conseil* ← ara: صَلَاح‎ (ṣalāḥ), hin:सलाह (salāh), tel:సలహా (salahā), tur:salık + eng:counsel, fra:conseil, spa:consejo, por:conselho  
**selenium** *sélénium* ← eng:selenium, fra:sélénium, spa:selenio, por:selénio, rus:селен, zho:硒 (xī), jpn:セレン, kor:셀렌, vie:selen, hin:सेलेनियम, ben:সেলেনিয়াম, may:selenium, swa:seleni, ara: سيلينيوم  
...
**semen** *semence* ← fra:semence, por:semente, spa:semilla, rus:семя (semya), eng:semen  
...
**sen** *aîné (senior, supérieur)* ← eng:fra:may:senior, spa:señor, por:sênior + zho:先辈 (xiānbèi), jpn:先輩 (senpai), kor:선배 (seonbae)  
...
**sento** *cent (100)* ← fra:cent, spa:cien, por:cem, ita:cento, eng:cent-, hin:शत (śat), ben:শত (śôt)  
**ser** *maillon (chaînon)* ← eng:series, fra:série, spa:serie, rus:серия (seriya), tur:seri + ara:(silsila), fas: سلسله‎ (selsele), hin:सिलसिला (silsilā), tur:silsile, swa:silisili, hau:sasari + zho:系列 (xìliè) + kor:사슬 (saseul)  
...
**si** *si* ← fra:spa:si, por:se, tur:ise, zho:使 (shǐ); 要是 (yàoshǐ), yue:使 (si2); 要是 (jiu3si6), ful:si; se  
...
**silike** *silicium* ← eng:silicon, fra:silicium, spa:silicio, por:silício, vie:silic, hin:सिलिकॉन, ben:সিলিকন, may:silikon, swa:silikoni, hau:siliki, ara: سيلكون (silikōn)  
...
**sine** *signe* ← eng:sign, spa:señal, por:sinal, fra:signe  
...
**sirke** *cercle (rond)* ← eng:circle, fra:cercle, spa:por:círculo + deu:Zirkus, rus:цирк (cirk), fas: سیرک‎ (sirk), hin:सर्कस (sarkas), ben:সার্কাস (sarkas), ara: سِيرْك‎ (sirk), jpn:サーカス (sākasu), kor:서커스 (seokeoseu), vie:xiếc, may:sirkus, tur:sirk  
**siro** *zéro* ← ara: صِفْر‎ (ṣifr), swa:sifuri, hau:sifili, hin:सिफ़र (sifar), may:sifar, eng:por:zero, fra:zéro, spa:cero, rus:зеро (zero), jpn:ゼロ (zero), kor:제로 (jero), vie:zêrô  
**sis** *sœur* ← eng:sister, deu:Schwester, rus:сестра (sestra)  
...
**skuter** *trottinette* ← eng:fra:spa:scooter, rus:скутер (skuter), zho:速克达 (sùkèdá), jpn:スクーター (sukūtā), kor:스쿠터 (seukuteo), hin:स्कूटर (skūṭar), ben:স্কুটার (śkuṭar), may:skuter  
**sofa** *canapé (sofa)* ← eng:fra:sofa, spa:por:sofá, rus:софа (sofa), zho:沙发 (shāfā), yue:梳化 (so1faa32), jpn:ソファ (sofa), kor:소파 (sopa), hin:सोफ़ा (sofā)  
...
**son** *fils* ← eng:son, deu:Sohn, rus:сын (syn), san:सूनु (sūnu)  
**sona papi** *pavot somnifère* ← eng:poppy, spa:amapola, por:papoula, swa:mpopi, hin:पॉपी (pŏpī), ben:পপি (papi), jpn:ポピー (popī)  
...
**sos** *sauce* ← eng:fra:sauce, deu:Soße, rus:соус (sous), fas: سس‎ (sos), hin:सॉस (sos), ben:সস (śôś), jpn:ソース (sōsu), kor:소스 (soseu), vie:xốt, may:saus, tur:sos  
**sosia** *société* ← rus:социум (socium), eng:society, fra:société, spa:sociedad, por:sociedade, deu:sozial, may:sosial  
...
**sponge** *éponge* ← eng:sponge, spa:por:esponja, ara:إسفنج (ʾisfanj), fas:اسفنج‎ (esfanj), hin:स्पंज (spanja), jpn:スポンジ (suponji), may:spon, swa:sponji  
...
**state** *estar debout* ← eng:stand; static, deu:stehen; statisch, fra:statique, spa:por:estático, rus:стоять (stoyat'); статический (statičeskiy), may:statis, tur:istasyon, hin:स्टेशन (sṭeśan), ben:স্টেশন (śṭeśôn)  
**stude** *étudier* ← eng:study, fra:étudier, spa:estudiar, por:estudar, rus:студент (student), hin:स्टूडेंट (sṭūḍeṇṭ)  
**su** ** ← eng:’s, deu:ned:-s, afr:se + fra:son;sa, spa:su, por:seu  
**sual** *question* ← ara: سؤال (su'āl), fas: سؤال‎ (so'âl), hin:सवाल (savāl), ben:সওয়াল (śôwal), may:soal, swa:swali, tur:sual + khm:សួរ (suə)  
...
**suga** *vite (rapide)* ← zho:速 (sù), yue:速 (cuk4), jpn:速 (soku), kor:속 (sok), vie:tốc + hin:शीघ्र (śīghra) + ara: سُرْعَة‎ (surʿa)  
**sui kaboga** ** ← por:abóbora-d'água, tur:su kabağı  
**sui** *eau* ← zho:水 (shuǐ), yue:水 (seoi2), jpn:水 (sui), kor:수 (su), vie:thuỷ + tur:su  
**sukar** *sucre* ← eng:sugar, fra:sucre, spa:azúcar, por:açúcar, ara: سُكَّر (sukkar), hin:शक्कर (śakkar), ben:শর্করা (śôrkôra), may:sakar, hau:swa:sukari, ful:sukar, tur:şeker, tam:சக்கரை (cakkarai)  
**suke** *heureux (se plaire)* ← hin:सुख (sukha), ben:সুখ (śukh), tel:సుఖము (sukhamu), may:suka, tha:สุข (suk), khm:សុខ (sok), nan:舒合 (su-kah) + jpn:好く (suku)  
**sulfe** *soufre* ← eng:sulfur, fra:soufre, spa:azufre, por:enxofre, swa:sulfuri  
...
**supa** *soupe* ← eng:soup, fra: soupe, spa:por:sopa, deu: Suppe, rus:суп (sup), jpn:スープ (sūpu), kor:수프 (supeu), hin:सूप (sūp), may:sup, swa:supu  
...
**susan** *lys* ← ara: سَوْسَن‎ (sawsan), spa:azucena + eng:Susan, por:Susana, fra:Suzanne, pol:Zuzana, rus:Сусанна (Susanna)  
**sute** *art* ← zho:术 (shù), yue:術 (seot6), jpn:術 (jutsu), kor:술 (sul)  
...
**tana** *tige* ← fas: تنه‎ (tane), hin:तना (tanā), tam:தண்டு (taṇṭu), vie:thân, tha:ต้น (ton), may:tangkai  
**tanke** ** ← eng:tank, deu:Tank, spa:tanque, hin:टंकी (ṭaṅkī), may:tangki, swa:tangi, jpn:タンク (tanku), kor:탱크 (taengkeu), vie:tăng  
**tantalium** *tantale* ← eng:tantalum, fra:tantale, spa:tántalo, por:tântalo, rus:тантал, zho:钽 (tǎn), jpn:タンタル, kor:탄탈, vie:tantali, hin:टाण्टलम, ben:ট্যান্টালাম, may:tantalum, swa:tantali, ara: تنتالم  
...
**tava** *poêle* ← fas: تاوه‎ (tâve), hin:तवा (tavā), ara: طاوة‎ (ṭāwa), tur:scr:tava  
...
**tela** *tissu* ← spa:por:tgl:tela, fra:toile + eng:towel, hin:तौलिया (tauliyā), tam:துவாலை (tuvālai), swa:taulo, hau:tawul, jpn:タオル (taoru), may:tuala  
**tele** ** ← eng:spa:por:may:tele-, fra:télé-, rus:теле- (tele-)  
**telurium** *tellure* ← eng:tellurium, fra:tellure, spa:telurio, por:telúrio, rus:теллур, zho:碲 (dì), jpn:テルル, kor:텔루르, vie:telu, hin:टेलुरियम, ben:টেলুরিয়াম, may:telurium, swa:teluri, ara: تيلوريوم  
**tema** *sujet (thème)* ← fra: thème, spa: tema, rus: тема (tema), deu:Thema + zho:题目 (tímù)  
**tene** *tenir* ← fra:tener, spa:tenir, por:ter, eng:-tain  
**tenesium** *tennessine* ← eng:fra:por:may:tennessine, spa:teneso, rus:теннессин, jpn:テネシン, kor:우눈셉튬  
**tense** *tendu* ← eng:tense, fra:tendu, spa:por:tenso  
...
**tim** *équipe* ← eng:team, deu:Team, swa:timu, fas: تیم‎ (tim), hin:टीम (ṭīm), ben:টীম (ṭim), jpn:チーム (chīmu), kor:팀 (tim)  
...
**tisa** *neuf (9)* ← ara: تِسْعَة‎ (tisʿa), swa:tisa  
**titanium** *titane* ← eng:titanium, fra:titane, spa:titanio, por:titânio, rus:титан, zho:钛 (tài), jpn:チタン, kor:타이타늄, vie:titan, hin:टाइटानियम, ben:টাইটেনিয়াম, may:titanium, swa:titani, ara: تيتانيوم  
...
**tortuga** *tortue* ← eng:tortoise, spa:tortuga, por:tartaruga, fra:tortue  
...
**tragike** *tragique* ← eng:tragic, fra:tragique, spa:por:trágico, rus:трагический (tragičeskij)  
**trate** *traîner* ← spa:traer + eng:tractor, fra:tracteur, por:trator, rus:трактор (traktor), ara: تَرَاكْتُور‎ (tarāktūr), jpn:トラクター (torakutā), kor:트랙타 (teuraekta), hin:ट्रैक्टर (ṭraikṭar), ben:ট্র্যাক্টর (ṭrækṭôr), may:traktor, swa:trekta, tur:traktör  
**trati** *contract (traité)* ← eng:treaty, fra:traité, spa:por:tratado, rus:контракт (kontrakt), tur:kontrat, may:kontrak  
**tren** *train* ← eng:fra:train, spa:tur:tren, por:trem, fas: ترن‎ (tran), hin:ट्रेन (ṭren), ben:ট্রেন (ṭren), swa:treni  
**trepe** *escalier (traper)* ← deu:Treppe, ned:trap, rus:трап (trap), may:terap, jpn:タラップ (tarappu) + spa:por:trepar  
**tri** *trois (3)* ← eng:three, fra:trois, spa:tres, por:três, rus:три (tri), hin:त्रि-  (tri-), ben:ত্রি- (tri-), may:tri-  
...
**tuale** *serviette* ← eng:towel, fra:touaille, spa:toalla, por:toalha, jpn:タオル (taoru), kor:타월 (tawol), hin:तौलिया (tauliyā), ben:তোয়ালে (toẏale), tam:துவாலை (tuvālai), may:tuala + deu:Toilette, rus:туалет (tualet), ara: تْوَالِيتّ‎ (twālitt), fas: توالت‎ (tuâlet), vie:toa-lét, tur:tuvalet  
...
**tulpan** *tulipe* ← eng:may:tulip, fra:tulipe, deu:Tulpe, spa:tulipá, por:túlipa, nld:tulp, rus:тюльпан (t’ul’pan), ara:توليب (tūlīb), hin:ट्यूलिप (ṭyūlip), may:tulip, jpn:チューリップ (chūrippu), kor:튤립 (tyullip)  
**tuna** *thon* ← eng:tuna, fra:thon, spa:atún, rus:тунец (tunec), jpn:ツナ (tsuna), hin:टूना (tuna), ara: تُونَة (tuna)  
...
**tung** *tung* ← zho:油桐 (yóutóng), yue:油桐 (yau4tung4), eng:tung tree, fra:tung, por:tungue, rus:тунг  
**tupi** ** ← may:topi, hin: टोपी (ṭopī), ben:টুপি (ṭupi), tam:தொப்பி (toppi)  
**tur** *excursion (tournée)* ← eng:deu:spa:tour, fra:tournée, por:turnê, rus:турне (turne), may:tur, jpn:ツアー (tsuā), kor:투어 (tueo), zho:旅途 (lǚtú)  
...
**tuta** *mûrier* ← rus:тута (tuta), ara: تُوت‎ (tūt), hin:तूत (tūt), tur:dut  
**tuzi** *lapin (lièvre)* ← zho:兔子 (tùzi), yue:兔仔 (tou3zai2), kor:토끼 (tokki), vie:thỏ, tha:เถาะ (tho)  
...
**umur** *âge* ← ara: عُمُر‎ (ʿumur), fas: عمر (omr), hin:उमर (umar), ben:ওমর (omôr), swa:umri, may:umur, tur:ömür  
...
**va** *ouah* ← eng:wow, fra:ouah, zho:哇 (wā), yue:嘩 (waa1), jpn:わあ (wā), kor:와 (wa), hin:वाह (vāh), may:wah, ful:wai  
**vaf** *chien* ← eng:woof, fra:ouaf, rus:гав (gav), tur:hav, zho:汪 (wāng), jpn:ワン (wan)  
**vafle** *gaufre* ← eng:waffle, deu:Waffel, rus:вафля (vaflya), zho:窝夫 (wōfū), yue:華夫 (waa4fu1), jpn:ワッフル (waffuru), kor:와플 (wapeul)  
...
**vari** *divers (plusieurs)* ← eng:various, spa:vario, por:vário, fra:varier, deu:variieren  
**varis** *riz* ← tam:அரிசி (arisi), tel: వరి (vari), mal:vary, may:beras, otb:འབྲས ('bras), fas: برنج‎ (berenj), ara: أَرُزّ‎ (ʾaruzz), spa:por:arroz, fra:riz, eng:rice, deu:Reis, rus:рис (ris), orm:ruuzii  
...
**vel** *voile* ← eng;veil, fra:voile, spa:velo, por:véu, jpn:ベール (bêru), kor:베일 (beil), swa:veli  
**ventur** *aventure* ← deu:Abenteuer, spa:aventura, fra:aventure, rus:авантюра (avantyura), tur:avantür, eng:adventure  
**ver** *vrai* ← eng:very, ita:vero, rus:верный (verniy), spa:verdadero, por:verdadeiro, deu:wahr, fra:vrai  
**veranda** *balcon* ← hin:बरामदा (barāmd), tam:வராந்தா (varāntā), por:varanda, may:beranda, eng:veranda, rus:веранда (veranda), jpn:ベランダ (beranda), kor:베란다 (beranda), swa:varanda  
**verme** *ver* ← eng:worm, spa:por:verme, fra:ver, deu:Wurm  
**verse** *verser (verse, face á)* ← eng:versus, fra:verse, spa:por:versar + rus:версия (versiya), may:versi  
**veruke** *verrue* ← eng:verruca, fra:verrue, spa:por:verruga  
**vespa** *abeille ou guêpe* ← spa:avispa, por:ita:vespa, eng:wasp, deu:Wespe  
...
**vita** *vis* ← fra:vis, rus:винт (vint), tur:vida, vie:vít  
**vitamin** *vitamine* ← eng:may:vitamin, fra:vitamine, spa:por:vitamina, rus:витамин (vitamin), zho:维他命 (wéitāmìng), jpn:ビタミン (bitamin), kor:비타민 (bitamin), vie:vi ta min, hin:विटामिन (viṭāmin), ben:ভিটামিন (bhiṭamin), ara: فِيتَامِين‎ (fitamīn), hau:bitamin  
...
**volfram** *tungstène* ← eng:wolfram, spa:wolframio, rus:вольфрам, zho:钨 (wū), vie:vonfam, may:wolfram, swa:wolframi  
**vote** *voix (vote)* ← eng:fra:vote, spa:por:voto, deu:Votum, rus:вотум (votum), hin:वोट (voṭ), ben:ভোট (bhōṭ)  
**vuki** *arme* ← zho:武器 (wǔqì), yue:武器 (mou5 hei3), jpn:武器 (buki), kor:무기 (mugi), vie:vũ khí  
...
**Xani** *Saturne* ← hin:शनि (śani), ben:শনি (śôni), tam:சனி (saṉi), tha:เสาร์ (sǎo)  
...
**xatan** *Satan* ← heb: שָׂטָן‎ (śaṭan), ara:(šayṭān), eng:fra:deu:vie:Satan, spa:Satán, por:Satã, rus:Сатана (Satana), zho:撒但 (Sādàn), yue:撒但 (saat3daan6), kor:사탄 (satan), jpn:サタン (satan), hin:शैतान (śaitān), tam:சயித்தான் (cayittāṉ), may:Setan, tur:şeytan, swa:Shetani, hau:shaidan  
...
**xe hal** *situation (état de choses)* ← zho:事态 (shìtài), yue:事態 (si6taai3), jpn:事態 (jitai), eng:state of affairs, fra:état des choses  
**xe** *chose* ← ara:(šayʾ), tur:şey, + zho:事 (shì), yue:事 (si6)  
**xefe** *chef* ← fra:chef, por:chefe, spa:jefe, rus:шеф (šef), eng:chief, swa:chifu, jpn:チーフ (chīfu) + ara: شَيْخ‎ (šayx), swa:shehe, ben:শেখ (śekh), tur:şeyh  
...
**xia** *faction (clique)* ← ara: شِيعَة (šīʿa), heb: סִיעָה (si'á) + zho:系 (xì)  
**xigu** ** ← zho:事故 (shìgù), yue:事故 (si6gu3), jpn:事故 (jiko), kor:사고 (sago), vie:sự cố + ara: شِقْوَة (šiqwa)  
**xikaye** *plainte (lamentation)* ← ara: شِكَايَة‎ (šikāya), hin:शिकायत (śikāyat), fas: شکایت‎ (šekâyat), tur:şikayet + fra:chicaya, spa:achaque  
...
**xirope** *sirop* ← ara:(šarāb), por:xarope, eng:syrup, deu:Sirup, fra:sirop, spa:jarabe; sirope, rus:сироп (sirop), fas: شیره‎ (fa) (šire), hin:शर्बत (śarbat), ben:শীরা (śira), tur:şurup, jpn:シロップ (shiroppu), kor:시럽 (sireop), vie:xi-rô, swa:shira  
**xite** *merde* ← eng:shit, zho:屎 (shǐ), yue:屎 (si2)  
**xiti bai** *échec* ← zho:失败 (shībài), jpn:失敗 (shippai), kor:실패 (šilpæ), vie:thất bại  
**xiti** *perder* ← zho:失 (shī), jpn:失 (shitsu), kor:실 (šil), vie:thất  
**xiu** *petit* ← zho:小 (xiǎo), yue:小 (siu2), jpn:小 (shō), kor:소 (so), vie:tiểu  
...
**xukre** *merci* ← ara: شُكْر‎ m (šukr), hin:शुक्र (śukr), ben:শোকর (śokôr), swa:-shukuru, tur:şükür  
**xulekan** *école (collège)* ← zho:学 (xué) + deu:Schule, swa:shule + eng:school, fra:école, spa:escuela, por:escola, rus:школа (škola), ben:স্কুল (śkul), may:sekolah + hin:पाठशाला (pāṭhśālā), mar:शाळा (śāḷā), tam:பாடசாலை (pāṭasālai)  
...
**ya** *oui* ← eng:yeah, deu:ja, kor:예 (ye), may:ya  
**yai** *vaincre* ← hin:जय (jay), ben:জয় (jôy), tel:జయ (jaya), may:jaya, tha:ชัย (chai), khm:ជ័យ (cɨy), mya:ဇေယျ (jeyya)  
**yain din** *jaïnisme* ← hin:mar:जैन (jain), tha:เชน (chen), eng:jainism, fra:jaïnisme, rus:джайнизм (džaynizm)  
...
**yama** *lin* ← zho:亚麻 (yàmá), yue:亞麻 (aa3maa4), jpn:亜麻 (ama), kor:아마 (ama), hin:उमा (umā)  
**yanela** *fenêtre* ← por:janela, ben:জানালা (janala), tam:ஜன்னல் (jaṉṉal), may:jendela  
...
**yen** *personne* ← zho:人 (rén), wuu人 (zén), jpn:人 (jin) + fra:gens, spa:por:gente + hin:जन (jan), ben:-জন (-jôn), may:-jana, tha:ชน (chon), khm:ជន (jon)  
...
**you** *infantile (immature)* ← zho:幼 (yòu), yue:幼 (yau3), jpn:幼 (yõ), kor:유 (yu) + hin:युवा (yuvā), tam:யுவன் (yuvaṉ), tel:యువ (yuva) + spa:joven, por:jovem, fra:juvénile  
**yube** *robe* ← ara: جُبَّة (jubba), swa:juba, may:jubah, spa:aljuba, por:gibão, fra:jupon, rus:жупан (župan)  
...
**yuge** *joug* ← eng:yoke, spa:yugo, por:jugo, fra:joug, rus:иго (igo), fas:  یوغ‎ (yuğ) + yue:軛 (aak1), vie:ách  
**yumla** ** ← ara:(jumla), tur:cümle, hin:जुमला (jumlā), zho:句 (jù)  
**yun** *jeune (junior)* ← eng:fra:may:junior + spa:joven, por:jovem, fas: جوان‎ (javân), hin:जवान (javān) + kor:젊다 (jeomda)  
**yunte** ** ← eng:joint, fra:jonction, spa:por:junta, deu:Junktion  
**yurta** *yourte* ← tur:eng:yurt, deu:Jurte, fra:yourte, spa:yurta, por:iurte, rus:юрта (yurta), hin:युर्त (yurt), kor:유르트 (yureuteu)  
**yus** *jus* ← eng:juice, swa:jusi, tam:ஜூஸ் (jūs), jpn:ジュース (jūsu), kor:주스 (juseu)  
**yuste** *justo (exact, précis)* ← eng:just, fra:juste, spa:justo, ita:giusto, jpn:ジャスト (jasto)  
**yuterbium** *ytterbium* ← eng:ytterbium, fra:ytterbium, spa:iterbio, por:itérbio, rus:иттербий, zho:镱 (yì), jpn:イッテルビウム, kor:이테르븀, vie:ytecbi, hin:यिट्टरबियम, ben:ইটারবিয়াম, may:iterbium, swa:yitebi, ara: يتربيوم  
...
**zaman** *temps (ère)* ← may:jam, ara: زَمَن‎ (zaman), hau:swa:zamani, ful:jamaanu, tur:zaman, fas: زمان‎ (zamân), hin:समय (samay), ben:সময় (sômyô)  
...
**zamul** *prune de Java* ← hin:जामुन (jāmun), eng:jambul, por:jambolão, ara:جَمُّون (jammūn), swa:zambarau  
...
**zangal** *forêt (jungle)* ← eng:fra:jungle, spa:jungla, por:jângal, rus:джунгли (džungli), hin:जंगल (jangal), ben:জঙ্গল (jônggôl), may:jenggela, jpn:ジャングル (janguru), kor:정글 (jeonggeul), tur:cengel  
...
**zaru** *balai* ← hin:झाड़ू (jhāṛū), ben:ঝাড়ু (jhaṛu) + kor:빗자루 (bitjaru)  
**zau** *orge* ← hin:जौ (jau), ben:যব (jôb), mar:जव (jav), guj:જવ (jav), fas: جو‎ (jow)  
**zebe** *poche* ← ara: جَيْب‎ (jayb), fas: جیب‎ (jib), hin:जेब (jeb), pnb:ਜੇਬ (jeb), tel:(jēbu), tur:cep, por:algebeira, hau:aljihu, ful:jiiba, wol:jiba, amh:ጅብ (ǧəb)  
**zebra** *zèbre* ← eng:deu:por:tur:may:zebra, fra:zèbre, spa:cebra, rus:зебра (zebra), hin:ज़ेब्रा (zebrā), ben:জেবরা (jebra), jpn:ゼブラ (zebura)  
**zeka na** *empruntre* ← zho:借 (jiè), yue:借 (ze3), jpn:借 (shaku), kor:적 (jeok) + eng:check  
**zeka** *prêter (empruntre)* ← zho:借 (jiè), yue:借 (ze3), wuu:借 (jia2), jpn:借 (shaku), kor:적 (jeok) + eng:check  
...
**zete** *huile (pétrole)* ← ara: زَيْت‎ (zayt), spa:por:aceite  
**zetun** *olive* ← ara: زَيْتُون‎ (zaitūn), spa:aceituna, may:zaitun, swa:zeituni, tur:zeytin, hau:swa:zaituni, fas: زیتون‎ (zeytun), hin: ज़ैतून (zaitūn), ben:জয়তূন (zôẏtūn), tam:சைதூண் (caitūṇ)  
...
**zi** *caractère* ← zho:字 (zì), yue:字 (zi6), jpn:字 (ji), kor:자 (ja)  
**zikura** *ziggourat* ← ara: زِقُّورَة‎ (ziqqūra), eng:tur:ziggurat, deu:Zikkurat, fra:ziggourat, spa:zigurat, por:zigurate, rus:зиккурат (zikkurat), zho:金字形神塔, jpn:ジッグラト (jiggurato), kor:지구라트 (jigurateu)  
...
**zira** *cumin* ← fas: زیره‎ (zire), hin:ज़ीरा (zīrā), ben:জিরা (zīra), tam:சீரகம் (sīrakam), rus:зира (zira), zho:孜然 (zīrán), swa:mjira  
**zirafa** *giraffe* ← fas: زرناپا‎ (zornâpâ), ara: زَرَافَة (zarāfa), tur:zürafa, deu:eng:fra:giraffe, por:girafa, spa:jirafa, rus:жираф (žiraf),may:zirafah; jerapah, kor:지라프 (jirapeu), hin: जिराफ़ (jirāf), ben:জরৈফ (jôrôph)  
...
**ziva** *vivre (vivant; vie)* ← hin:जीव (jīv), ben:জীউ (jiu), tel:జీవము (jīvamu), may:jiwa, tha:ชีวิต  (chiwit), mya:ဇီဝ (jiwa), khm:ជីវិត (jĭvit), rus:живой (živoy), pol:żywy  
...
**zong** *centre* ← zho:中 (zhōng), yue:中 (zung1), kor:중 (jung), jpn:中 (chuu-), vie:trung  
**zovar** *sorgho* ← fas: جواری‎ (jovâri), hin:ज्वार (jvār), ben:জোয়ার (joyār), ara: جَاوَرْس (jāwaras), eng:jawar  
**zukam** *rhume* ← ara:زُكَام‎ (zukām), hin:ज़ुकाम (zukām) + zho:感(冒) (gǎn(mào)), yue:感冒 (gam2mou6), jpn:感(冒) (kan(bō)), kor:감(기) (gam(gi)), vie:cảm  
...
**zuku** *ethnie* ← zho:族 (zú), yue:族 (zuk6), jpn:族 (zoku), kor:족 (jok), vie:tộc  
