...
**ange** ** ← hindia:अंग (aṅg), bengala:অঙ্গ (ôṅg), panĝaba:ਅੰਗ (aṅga), teluga:అంగము (aṅgamu), kmera: អង្គ (ʔɑŋ), taja: องค์ (ong)  
...
**arme** *armilo* ← angla:arms, franca:arme, hispana:portugala:arma + rusa:армия (armiya), hindia:आर्मी (ārmī)  
...
**Atlante Hai** ** ← angla:Atlantic, hispana:Atlántico, portugala:Atlântico, rusa:Атлантический океан (Atlanticheskyy okean), svahila:Atlantiki  
...
**bale** *forta* ← hindia:बल (bal), bengala:বল (bôl), malaja:bala, teluga:బలము (balamu), taja:พล (pon), พละ (pá-lá)  
...
**bana** ** ← hindia:बाण (bāṇ), teluga:బాణము (bāṇamu), malaja:panah  
...
**bandir** *flago* ← angla:banner, franca:bannière, hispana:bandera, portugala:bandeira, malaja:svahila:bendera, filipina:bandila  
...
**barxe** *pluvo* ← persa: باران‎ (bârân), hindia:बारिश (bāriś), bengala:বৃষ্টি (briśṭi), turka:baran  
...
**bing** ** ← mandarena:瓶 (píng), kantona:瓶 (ping4), vua:瓶 (bín), japana:瓶 (bin), korea:병 (byeong), vjetnama:bình  
...
**brun** *bruna* ← angla:brown, franca:brun + araba: بُنِّيّ‎ (bunniyy) + hindia:भूरा (bhūrā)  
**bu!** ** ← angla:boo, franca:bouh, portugala:hispana:bu, rusa:бу (bu), korea:부 (bu)  
**buce** *buĉi* ← angla:butcher, franca:boucher, itala:beccaio, hindia:बूचड़ (būcaṛ) + korea:푸주한 (pujuhan)  
**bude** *kompreni (konscii)* ← sanskrita:बोधि (bodhi), hindia:बुद्धि (buddhi), japana:菩提 (bodai), mandarena:菩提 (pútí), mon:бодь (bodʹ), korea:보리 (bori), vjetnama:Bụt, taja:โพธิ (potí) + rusa:будить  
...
**bufon** *pajaco* ← hispana:portugala:bobo, korea:바보 (babo)  
...
**cang** ** ← mandarena:层 (céng), kantona:層 (cang4), korea:층 (cheung), vjetnama:tầng + mina:棧 (chàn) + kmera:ជាន់ (cŏən) , taja:ชั้น (chan)  
...
**cante** *kanto* ← franca:chanter, angla:chant, portugala:hispana:cantar, + mandarena:唱 (chàng), kantona:唱 (coeng3), korea:창 (chang)  
...
**catre** *kvar (4)* ← rusa:четыре (chetyre), hindia:चार (cār), bengala:চার (car), malaja:catur + franca:quatre, hispana:cuatro, quatro  
...
**cin** ** ← mandarena:亲 (qīn), kantona:親 (can1)  
**cina** *hana* ← hindia:चीनी (cīnī), turka:Çin, araba:(ṣiniy), hispana:chino, angla:Chinese, taja:จีน (chin), mandarena:秦 (qín)  
...
**cope** ** ← mandarena:锄 (chú), kantona:鋤 (co4), taja:จอบ (chop), turka:çapa + angla:chop  
...
**cuke** *tuŝi* ← mandarena: 触 (chù), kantona:觸 (cuk1), japana:触 (shoku), korea:촉 (chok) + hindia: छूना (chūnā), panĝaba:ਛੂਹਣਾ (chūhṇā)  
**cum** *kiso* ← hindia:चूमना (cūmnā), urdua:(cūmnā), malajala:ചുംബനം (cumbanaṃ), malaja:cium, japana:チュー (chū), taja:จูบ (cup)  
**cupe** *suĉi* ← hispana:portugala:chupar, kmera:ជប់ (cup) + hindia:चूसना (cūsnā)  
...
**dane** *semo* ← persa: دانه‎ (dāna), hindia:दाना (dānā), turka:tane + japana:種 (tane) + mandarena:弹 (dàn), vjetnama:đạn, korea:탄알 (tanal)  
...
**dar** ** ← hindia:धारा (dhārā), teluga:ధార (dhāra) + persa: دریا‎ (daryâ), hin:दर्या (daryā), bengala:দরিয়া (dôriẏa), turka:derya  
**darge** ** ← araba:(daraja), hindia:दर्जा (darjā), svahila:daraja, turka:derece, persa:(dareje), malaja:derajat, + mandarena:阶 (jiē)  
**darmesitium** ** ← angla:darmstadtium, franca:darmstadtium, hispana:darmstatio, portugala:darmstádio, rusa:дармштадтий, mandarena: (dá), japana:ダームスタチウム, korea:다름슈타튬, vjetnama:darmstadti, hindia:डार्म्स्टेडशियम, bengala:ডারমস্টাডটিয়াম, malaja:darmstadtium, svahila:darmstadti, araba: دارمشتاتيوم  
...
**den** *tago (periodo de 24 horoj)* ← rusa:день (deń), hindia:दिन (din), bengala:দিন (din) + mandarena:天 (tiān), kantona:天 (tin1) + hispana:día, portugala:dia  
...
**din** *religio* ← araba: دِين‎ (dīn), hindia:दीन (dīn), bengala:দীন (din), turka:malaja:din, svahila:dini, haŭsa:addini  
...
**dite** ** ← angla:dicate, franca:dicter, hispana:dictar, portugala:ditar + deu:malaja:diktator, rusa:диктатор (diktator), turka:diktatör, araba:(diktatūr)  
...
**dunjia aventur** ** ← angla:dungeon, franca:donjon, japana:ダンジョン (danjon)  
...
**duxe** *duŝo* ← franca:douche, hispana:portugala:ducha, deu:Dusche, rusa:душ (duš), araba: دوش (dūš), malaja:dus, turka:duş  
**e** *esti* ← franca:est (ɛ), portugala:é, persa: است (ast/e), hindia:है (ɦɛ:), itala:è, ukr:є (ye) + filipina:ay (ay/e)  
...
**eme** *elemento (ero)* ← angla:-eme, hispana:portugala:-ema, franca:-ème, rusa:-ема (-ema), malaja:-em  
**emote** *emocii* ← angla:emotion, franca:émotion, hispana:emoción, portugala:emoção, rusa:эмоция (emociya), malaja:emosi, filipina:emosyon  
...
**file** ** ← angla:franca:-phile, portugala:hispana:-filo  
...
**fizike** *fiziko* ← angla:physics, hispana:portugala:física, rusa:физика (fizika), turka:malaja:fizik, araba:فِيزِيقَا‎ (fīzīqā), svahila:fizikia, hindia:फ़िज़िक्स (fiziks)  
...
**fobe** *timo (timi; timigi)* ← angla:-phobia, hispana:portugala:malaja:-fobia, franca:deu:-phobie, rusa:-фобия (-fobiya), turka:-fobi  
**fokus** *koncentri* ← angla:focus, hispana:portugala:foco, deu:Fokus, rusa:фо́кус, persa:فوکوس‎ (fokus)  
**folia** *frenezeco* ← angla:folly, franca:folie, itala:follia  
**fone** ** ← angla:franca:phone, hispana:fono, portugala:fone, rusa:фона (fona), malaja:fon  
...
**futau** *hakilo* ← mandarena:斧头 (fǔtóu), kantona:斧頭 (fu2tau4), vua:斧头 (fu déu), filipina:puthaw  
**fute** *piedo* ← angla:foot, deu:Pfote  
**futebol** *piedpilko* ← angla:franca:football, hispana:fútbol, portugala:futebol, deu:Fußball, hindia:फ़ुटबॉल (fuṭbŏl), urdua:(fuṭ bāl), bengala:ফুটবল (phuṭbôl), rusa:футбол (futbol), taja:ฟุตบอล (th) (fút-bɔn), japana:フットボール (futtobōru), zulua:ibhola  
...
**gas** *gaso* ← deu:angla:hispana:malaja:gas, portugala:gás, bengala:গ্যাস (gyas), mandarena:瓦斯 (wǎsī), kantona:瓦斯 (ngaa5 si1), japana:ガス (gasu), korea:가스 (gaseu), hindia:गैस (gais), franca:turka:gaz, rusa:газ (gaz), araba:(ḡāz)  
**gate** *malmola* ← teluga:గట్టి (gaṭṭi), hindia:कड़ा (kaṛā) + japana:硬い (katai) + turka:katı  
...
**gele** *ĝelo* ← angla:gel, franca:gelée, rusa:желе (žele), hindia:जेल (jel), korea:젤 (jel), mandarena:啫哩 (zhělī), vjetnama:chất gien, turka:jel  
...
**glas** *vitro* ← dei:Glas, angla:glass, + persa: گیلاس‎ (gilâs), hindia:गिलास (gilās), bengala:গ্লাস (glaś), japana:グラス (gurasu), korea:글라스 (geullaseu), malaja:gelas, svahila:glasi + rusa:глазурь, hispana:glasear  
...
**gogia** *lando* ← mandarena:国家 (guójiā), kantona:國家 (gwok3 gaa1), japana:国家 (kokka), korea:국가(gukga), vjetnama:quốc gia  
...
**grane** ** ← angla:franca:grain, hispana:grano, portugala:grão + rusa:гранит (granit), turka:vjetnama:malaja:granit, araba:جرانيت (jaraniat), hindia:ग्रेनाइट (grenait)  
...
**gulgui** ** ← araba:الغول (ghūl), persa:غول‎ (ğul), angla:portugala:ghoul, hispana:gul, rusa:гуль (gul′), turka:kulbastı, malaja:ghul, japana:グール (gūru)  
...
**hamile** *graveda* ← araba:(ḥāmil), malaja:hamil, svahila:himila, turka:hamile, urdua:(hāmila), persa:(hâmele)  
...
**hape** *taŭga* ← mandarena:合 (hé), kantona:合 (hap6), korea:합 (hap), vjetnama:hợp + angla:apt, franca:apte, hispana:portugala:apto  
**harabe** *ruinigita* ← araba:persa:urdua:(xarāb), turka:harap, hindia:ख़राब (xarāb), bengala:খারাপ (kharap), svahila:-haribu  
**harame** ** ← araba:(ḥarām), haŭsa:malaja:turka:angla:deu:haram, hindia:हराम (harām), korea:하람 (haram), persa:urdua:(harām), svahila:haramu, mandarena:哈拉姆 (hālāmǔ), rusa:харамный (xaramniy)  
**harfe** *litero* ← araba:(ḥarf), turka:harf, persa:urdua:(harf), haŭsa:harafi, svahila:herufi, malaja:huruf  
**harmone** *harmonia* ← angla:harmony, hispana:armonía, portugala:harmonia, franca:harmonie, rusa:гармония (garmoniya)  
...
**hate** *ĝis* ← portugala:até, araba:(ḥatta), hispana:hasta, svahila:hata + persa: تا‎ (tâ), hindia:तक (-tak)  
**hatre** *danĝero* ← araba: خطر‎ (xaṭar), persa: خطر‎ (xatar), urdua: خطرہ‎ (xatrā), hindia:ख़तरा (xatrā), svahila:hatari, turka:muhatara  
**have** *aero* ← araba: هَوَاء‎ (hawāʾ), hindia:हवा (havā), bengala:হাওয়া (haowa), malaja:hawa, svahila:hewa, turka:hava  
...
**he** *ĉu?* ← deu:hä, franca:portugala:hein, japana:e + angla:huh, vjetnama:hả + mandarena:啊 (à, a)  
**hei** ** ← angla:hey, franca:hé, hispana:hey, portugala:ei, rusa:эй (ey), mandarena:喂 (wèi), persa: هی‎ (hey)  
...
**hijabe** ** ← araba:(ḥijāb), persa:(hejâb), svahila:hijabu, haŭsa:hijabi, hindia:हिजाब (hijāb), bengala:হিজাব (hijab), angla:portugala:hijab, franca:hidjab, hispana:hiyab, rusa:хиджаб (xidžab)  
...
**histore** *historio* ← angla:history, hispana:svahila:historia, portugala:história, franca:histoire, rusa:история (istoriya)  
...
**hole** ** ← angla:whole, hispana:portugala:holo-  
...
**hura** ** ← angla:hurrah, deu:hispana:hurra, franca:hourra, rusa:ура (ura), malaja:hore, persa:(hurâ)  
**hurargente** ** ← svahila:hidrajiri  
**hure** *libera* ← araba: حر (ḥurr), turka:hür, svahila:huru, hispana:horro, portugala:forro  
**hux** *agrabla* ← persa: خوش‎ (xoš), hindia:ख़ुश (xuś), bengala:খুশি (khuśi), turka:hoş, angla:cushy  
**i** *kaj* ← hispana:y, portugala:e, rusa:и (i)  
...
**ide** *ideo* ← franca:idée, deu:Idee, hat:malaja:ide, persa:(ide), portugala:ideia, rusa:идея (ideya), vjetnama:ý định  
...
**ike** ** ← angla:-ic, franca:-ique, hispana:portugala:-ico, hindia:-इक (-ika)  
**impere** ** ← angla:empire, hispana:imperio, portugala:império, rusa:империя (imperiya), araba:إِمْبِرَاطُورِيَّة‎ (ʾimbirāṭūriyya), persa:امپراطوری‎ (emperâturi), malaja:empayar  
...
**ironia** ** ← angla:irony, hispana:ironía, portugala:ironia, franca:ironie, rusa:иро́ния (ironija), japana:アイロニー (aironī)  
...
**jainisme** *Ĝajnismo* ← hindia:marataja:जैन (jain), tha:เชน (chen), angla:jainism, franca:jaïnisme, rusa:джайнизм (džaynizm)  
...
**jebre** ** ← araba:persa:(jabr), turka:cebir, urdua:(aljabrā), angla:algebra, franca:algèbre, svahila:aljebra  
**jeke** ** ← mandarena:借 (jiè), kantona:借 (ze3), japana:借 (shaku), korea:적 (jeok) + angla:check  
**jele** *malliberigi* ← angla:jail, franca:geôle, hindia:जेल (jel), bengala:জেল (jēl), teluga:జైలు (jailu), urdua: جیل‎ (jēl), svahila:jela + hispana:portugala:jaula  
**jen** *persono* ← mandarena:人 (rén), wuu人 (zén), japana:人 (jin) + hindia:जन (jan), bengala:-জন (-jôn), malaja:-jana, taja:ชน (chon), kmera:ជន (jon) + franca:gens, portugala:gente  
**jenje** *zingibro* ← angla:ginger, franca:gingembre, hispana:gengibre, portugala:jengibre, mandarena:姜 (jiāng), tamila:இஞ்சி (inji), araba: زنجبيل‎ (zanjabīl), turka:zencefil  
...
**jense** *sekso* ← angla:gender, portugala:gênero, japana:ジェンダー (jendā) + araba:urdua:(jins), persa:(jens), svahila:jinsi, turka:cins  
...
**kalam** *plumo* ← araba:persa:urdua: قلم‎ (qalam), haŭsa:alƙalami, joruba:svahila:kalamu, turka:kalem, hindia:क़लम (qalam), bengala:কলম (kôlôm), hispana:portugala:cálamo  
**kale** *malplena* ← bengala:খালি (khali), hindia:ख़ाली (xālī), teluga:ఖాళీ (khāḷī), tamila:(kali), urdua:(xālī), persa:خالی (xāli), araba:خَالٍ‎ (xāliy), japana:空 (kara)  
...
**kalkulia** ** ← franca:calcul, hispana:cálculo, angla:calculus, hindia:कलन (kalan)  
...
**kama** ** ← hindia:काम (kām), bengala:কাম (kam), taja:กาม (gaam), angla:kama  
...
**kanal** *kanalo* ← angla:hispana:portugala:franca:canal, rusa:канал (kanal), malaja:kanal + araba: قَنَاة‎ (qanāh) + bengala:খাল (khal)  
**kanape** *sofo* ← franca:portugala:hispana:canapé, deu:Kanapee, rusa:канапе (kanape), turka:kanepe, persa:(kânâpe), araba:(kanaba)  
**kande** *bombono* ← angla:candy, hindia:कैंडी (kaiṇḍī), bengala:ক্যান্ডি (kyandi), japana:キャンデー (kyandē), filipina:kendi + araba:persa: قند (qand)  
**kang** ** ← hindia:कंघी (kaṅghī), urdua:(kaṅghī), marataja:कंगवा (kaṅgvā), panĝaba:ਕੰਘਾ (kaṅghā)  
...
**kankuate** ** ← kantona:柑橘 (gam1gwat1), mandarena:金橘 (jīnjú), japana:キンカン (kinkan), korea:금귤 (geumgyul), vjetnama:kim quất, angla:hispana:franca:kumquat, portugala:cunquate, rusa:кумкват (kumkvat), turka:kumkat, araba:كمكوات (kamakawat), malaja:kumkuat  
**kantalupomelon** ** ← angla:cantaloupe, hispana:portugala:cantalupo, franca:cantaloup, deu:Cantaloup, rusa:канталупа (kantalupa), japana:カンタロープ (kantarōpu)  
...
**kara** *nigra* ← hindia:काला (kālā); कारौ (kārau), bengala:কালো (kalo), panĝaba:ਕਾਲਾ (kālā) + tamila:கருப்பு (karuppu) + turka:kara, kaz:қара (qara)  
**karave** *karvio* ← araba:(karāwiya), angla:caraway, franca:carvi, hispana:alcaravea, portugala:alcaravia  
...
**karube** ** ← araba: خَرُّوب‎ (ḵarrūb), angla:carob, franca:caroube, hispana:algarrobo, portugala:alfarroba  
...
**kaslan** *pigra (mallaborema)* ← araba: كَسْلَان‎ (kaslān) + mandarena:懒 (lǎn), kantona:懶 (laan5) + आलसी (ālsī)  
...
**kate** *mordi* ← hindia:काटना (kāṭnā), bengala:কাটা (kata) + tamila:கடி (kaṭi) + taja:กัด (kat) + angla:cut + araba:(qaṭa’a) + svahila:-kata + vjetnama:cắt, mandarena:割 (gē), kantona:割 (got3), vua:割 (ga’), japana:割 (katsu)  
...
**kerube** ** ← heb:כְּרוּב‎ (kerúv), angla:cherub, hispana:querubín, portugala:querubim, franca:chérubin, rusa:херувим (heruvim), svahila:kerubi, malaja:kerub, mandarena:基路伯 (jīlùbó)  
**ketle** ** ← angla:kettle, rusa:котёл (kot’ol), hindia:केतली (ketlī), bengala:কেতলি (ketli), malaja:ketel  
**kex** *haro* ← japana:毛 (ke) + hindia:केश (keś), urdua:(keś), panĝaba:ਕੇਸ਼ (keś), teluga:(kēśamu)  
...
**kine** ** ← angla:kinetic, hispana:portugala:cinético, franca:cinétique, deu:kinetisch, rusa:кинетический (kineticheskyy)  
...
**kire** ** ← araba:(kirāʾ), turka:kira, hindia:किराया (kirāyā), urdua:(kirāyā), persa:(kerāya), hispana:alquiler  
...
**klame** ** ← angla:-claim, franca:-clamer, hispana:portugala:-clamar  
**klare** *klara (klare, kompreneble)* ← deu:klar, hispana:portugala:claro, angla:clear, franca:clair  
...
**kola** ** ← angla:hispana:cola, rusa:кола (kola), hindia:कोला (kolā), japana:コラ (kora)  
**kolonia** ** ← angla:colony, hispana:colonia, portugala:colônia, rusa:колония (koloniya), turka:ma:koloni, hindia:कॉलोनी (kŏlonī), japana:コロニー  
**kolum** *kolono* ← angla:column, hispana:columna, portugala:coluna, franca:colonne, rusa:колонна (kolonna), polona:kolumna  
**koma** ** ← angla:comma, deu:Komma, japana:コンマ (konma), korea:콤마 (komma), malaja:koma  
**kome** ** ← angla:comic, franca:comique, hispana:portugala:cómico + rusa:комедия (komedija), japana:コメディ (komedi), korea:코미디 (komidi)  
...
**kopernikium** *kopernicio* ← angla:franca:copernicium, hispana:copérnico, portugala:copernício, rusa:коперниций, japana:コペルニシウム, korea:코페르니슘, vjetnama:copernici, malaja:copernicium, svahila:kopernici  
**kor** *kerno (koro)* ← angla:core, franca:coeur  
...
**kosmia** ** ← rusa:космос (kosmos), angla:franca:hispana:cosmos  
**koste** ** ← angla:cost, hispana:costar, portugala:custar, franca:coûter, deu:kosten  
...
**krevete** ** ← angla:franca:crevette, itala:gamberetto, rusa:креветка (krevetka)  
**krim** *krimo* ← angla:franca:portugala:crime, hispana:crimen, filipina:krimen  
**kristejen** *kristnasko* ← greka:Χριστούγεννα (Christoúgenna)  
...
**krokroke** ** ← angla:croak, deu:gribbit, hispana:croac croac, fin:kurr kurr, japana:ケロケロ (kero kero), turka:vrak vrak, malaja:krok krok, filipina:kokak kokak  
...
**kuane** ** ← mandarena:宽 (kuān), taja:กว้าง (kwang), vjetnama:quảng  
**kuang** ** ← mandarena:矿 (kuàng), vjetnama:khoáng, korea:광 (guang)  
...
**kuke** ** ← angla:cook, deu:Kock, itala:cuoco, malaja:koki, taja:กุ๊ก (kuk), sango:kuku  
**kuker** ** ← angla:cook, rusa:кухар (kuhar), polona:kucharz, taja:กุ๊ก (gúk), malaja:koki, deu:Koch  
...
**kumar** ** ← hindia:कुमार (kumār), teluga:కుమారుడు (kumāruḍu), kmera:កុមារ (ko’maa), taja:กุมาร (kuman)  
**kume** ** ← angla:cumulate, franca:cumuler, hispana:portugala:cumular + turka:kumul + araba:كَوْمَة‎ (kawma), persa: کومه (kume)  
**kupe** *taso* ← angla:cup, franca:coupe, hispana:copa, portugala:copo, araba: كُوب‎ (kūb), turka:kupa, hindia:कप (kap), japana:コップ (koppu), korea:컵 (keop) + persa:(koppe), malaja:kubah, rusa:купол (kupol), deu:Kuppel  
...
**kuxloke** ** ← franca:angla:couchette, itala:cuccetta, polona:kuszetka  
**la** ** ← franca:hispana:la + araba: (al) + svahila:-le  
...
**lale** *ruĝa* ← hindia:लाल (lāl), bengala:লাল (lal), turka:al  
...
**lantanium** ** ← angla:lanthanum, franca:lanthane, hispana:lantano, portugala:lantâno, rusa:лантан, mandarena:镧 (lán), japana:ランタン, korea:란탄, vjetnama:lantan, hindia:लाञ्थनम, bengala:ল্যান্থানাম, malaja:lantanium, svahila:lanthani, araba: لنثانوم  
**larve** ** ← deu:franca:larve, angla:turka:larva, hindia:लार्वा (lārvā), urdua:(lārvā), polona:larwa  
**lasa** *rubo* ← mandarena:垃圾 (lājī / lèsè), kantona:垃圾 (laap6 saap3), hakaa:垃圾 (lá-sap), nan:垃圾 (lah-sap)  
**laste** ** ← angla:elastic, hispana:portugala:elástico, gla:lastaig, rusa:эласти́чный (elastíčnyj), turka:malaja:elastik, japana:エラスティック (erasutikku)  
...
**laurensium** *laŭrencio* ← angla:lawrencium, franca:lawrencium, hispana:laurencio, portugala:lawrêncio, rusa:лоуренсий, mandarena:铹 (láo), japana:ローレンシウム, korea:로렌슘, vjetnama:lorenxi, lawrenci, hindia:लॉरेंशियम, bengala:লরেনসিয়াম, malaja:lawrensium, svahila:lawirensi, araba: لورنسيوم  
...
**lazurite** ** ← persa:لاجورد (lājevard), angla:lazuli, hispana:lapislázuli, rusa:лазурит (lazurit), araba:لازورد (lāzaward), hindia:लाजवर्द (lājavarda), japana:ラピスラズリ (rapisurazuri), malaja:lazuardi, turka:lazur taşı  
**le** ** ← mandarena:了 (liǎo), kantona:了 (liu5), taja:แล้ว (lɛw) + japana:了 (ryō)  
...
**leve** ** ← latina:laevus, angla:left; levo-, franca:lévo-, hispana:portugala:levo-, rusa:левый (levyy), polona:lewy  
...
**libu** ** ← mandarena:立 (lì), kantona:(lip), vjetnama:lập, korea:립 (rib), japana:立 (ritsu)  
...
**lige** ** ← franca:ligue, deu:hispana:polona:portugala:liga, angla: league, rusa: лига (liga), turka:lig, svahila:ligi, japana:リーグ (rīgu)  
**lila** ** ← turka:leylak, araba:(laylak), angla:lilac, franca:lilas, portugala:lilás, hispana:filipina:lila, japana:ライラック (rairakku)  
**lime** ** ← angla:limit, hispana:límite, franca:portugala:limite, rusa:лимит (limit) + hindia:सीमा (sīmā)  
**limfa** ** ← angla:lymph, hispana:portugala:linfa, rusa:лимфа (límfa), malaja:limfa, japana:リンパ (rinpa), mandarena:淋巴 (línbā)  
...
**line** *lineo (ŝnuro)* ← angla:line, franca:ligne, hispana:línea, portugala:linha, rusa:линия (liniya), polona:linia  
**lisan** *lango* ← araba: لِسَان‎ (lisān), hindia:लिसान (lisān), svahila:lisani, malaja:turka:lisan, amhara:ልሳን (ləsan)  
**lise** *glata* ← franca:lisse, hispana:portugala:liso, persa:(liz), malaja:licin  
...
**loge** *paroli* ← greka:λόγος (logos), angla:franca:-logue, hispana:portugala:-logo, rusa:-лог (-log) + araba:(luğa), hindia:लुग़त (luġat), svahila:lugha, malaja:logat, turka:lügat, persa:(loğat)  
**loje** ** ← angla:-ology, hispana:-ología, franca:-ologie, rusa:ология (-ologiya), turka:-loji  
**loke** *loko (lokigi)* ← angla:location, hispana:lugar, franca:localisation, + deu:turka:lokal, polona:lokalny  
**lon** ** ← mandarena:论 (lùn), kantona:論 (lœn6), korea:론 (ron), japana:論 (ron), vjetnama:luận  
**longe** *longa* ← angla:franca:long, deu:lang, portugala:longo  
**lontre** ** ← hispana:filipina:lutrino, franca:loutre, portugala:lontra, itala:lontra  
...
**luke** *verda* ← mandarena:绿 (lǜ), kantona:綠 (luk6), vjetnama:lục, korea:록/녹 (rok/nok), japana: 緑色 (ryokushoku)  
**lumbe** ** ← franca:lombes, hispana:lomo, portugala:lombo + angla:lumbago, rusa:люмбаго (lyumbago)  
...
**lute** *rabi* ← hindia:लूटना (lūṭnā), urdua:(lūṭnā), bengala:লুটা (luṭā), panĝaba:ਲੁੱਟ (luṭ), angla:loot, + mandarena:掠夺 (lüèduó), kantona:掠 (loek6)  
**lutetium** *lutecio* ← angla:lutetium, franca:lutécium, hispana:lutecio, portugala:lutécio, rusa:лютеций, mandarena:镥 (lǔ), japana:ルテニウム, korea:루테튬, vjetnama:lutexi, hindia:लुटेटियम, bengala:লুটেসিয়াম, malaja:lutetium, svahila:luteti, araba: لوتيتيوم  
**luxe** ** ← angla:lush, franca:luxe, hispana:lujo, portugala:luxo, rusa:люкс (lyuks), turka:lüks  
**ma** *patrino* ← mandarena:妈 (mā), vjetnama:má, bengala:মা (ma), hindia:मां (mã) + angla:svahila:mama, franca:maman, hispana:mamá, portugala:por:mãe, rusa:мама (mama), japana:ママ (mama), korea:엄마 (eomma)  
**mace** ** ← angla:franca:match, hindia:मैच (mɛc), svahila:meci, polona:mecz, rusa:матч (matč), turka:maç  
**madu** *mielo* ← rusa:мёд (myod), hindia:मधु (madhu), bengala:মধু (môdhu), malaja:madu + portugala:mel, franca:hispana:miel + kantona:蜜 (mat6)  
**maf** *pardono* ← araba: مُعَاف‎ (muʿāf), hindia:माफ़ (māf), bengala:মাফ (maph), malaja:maaf, svahila:afu, turka:af, haŭsa:yafe  
**magente** ** ← angla:magenta, hispana:magenta, rusa:маджента (madzhenta), araba:ماجنتي (majinati), hindia:मैजेंटा (maijenta), japana:マゼンタ (mazenta), malaja:magenta  
**magesium** *magnezio* ← angla:magnesium, franca:magnésium, hispana:magnesio, portugala:magnésio, rusa:магний, mandarena:镁 (měi), japana:マグネシウム, korea:마그네슘, vjetnama:magiê, hindia:मैग्नेशियम, bengala:ম্যাগনেসিয়াম, malaja:magnesium, svahila:magnesi, araba: مغنيسيوم  
...
**maitnerium** *mejtnerio* ← angla:meitnerium, franca:meitnérium, hispana:meitnerio, portugala:meitnério, rusa:майтнерий, japana:マイトネリウム, korea:마이트너륨, vjetnama:meitneri, hindia:मेइट्नेरियम, bengala:মিটনেরিয়াম, malaja:meitnerium, svahila:meitneri, araba: مايتنريوم  
**makal** ** ← araba:مَقَال‎ (maqāl), turka:makale, svahila:makala, persa:مقاله‎ (maqâle), malaja:makalah  
**makan** *butero* ← hindia:मक्खन (makkhan), bengala:মাখন (makhôn)  
...
**male** ** ← araba:persa:urdua: مَال‎ (māl), hindia:माल (māl), bengala:মালিক, svahila:mali, malaja:milik, turka:mal  
**malika** *jasmeno* ← kanara:(mallige), tamila:(mallikai), teluga:(malla), malaja:melati, korea:말리 (malli), taja:มะลิ (mali), mandarena:茉莉 (mòlì)  
**mam** *mamo* ← angla:mamma, franca:mamelle, hispana:portugala:mama, turka:meme + malaja:mamalia  
...
**manioke** ** ← angla:franca:manioc, hispana:portugala:mandioca, rusa:манио́ка (manióka)  
...
**margarite** ** ← hispana:portugala:margarita, franca:marguerite, deu:Margerite, rusa:маргаритка (margaritka)  
...
**master** *magistro* ← angla:franca:master, portugala:mestre, rusa:магистр (magistr), malaja:magister  
...
**membe** ** ← angla:member, hispana:miembro, portugala:membro, franca:membre, japana:メンバー (menbā)  
...
**menu** ** ← angla:franca:portugala:menu, hispana:menú, rusa:меню (menyu), japana:メニュー (menyū), korea:메뉴 (menyu), hindia:मेनू (menū), turka:menü  
**merante** ** ← malaja:angla:portugala:meranti  
...
**mikre** ** ← angla:franca:hispana:portugala:micro-, rusa:микро- (mikro-), japana:マイクロ- (maikuro-), malaja:turka:mikr-  
...
**mire** *speguli* ← hispana:mirar, angla:admire, franca:admirer + araba:mirʾāh, turka:mirat  
**misal** *ekzemplo* ← hindia:मिसाल (misāl), araba:(mithāl), persa:(mesâl), malaja:misal, svahila:mathalani, turka:mesela  
**mise** ** ← angla:franca:mission, deu:Mission, hispana:misión, portugala:missão, rusa:миссия, malaja:misi, filipina:misyon + turka:mesaj, japana:メッセージ (messēji), korea:메시지 (mesiji)  
...
**mone** *mono* ← angla:money + franca:monnaie, hispana:portugala:moneda, rusa:монета  
...
**moskovium** *moskovio* ← angla:franca:moscovium, hispana:moscovio, portugala:moscovio, rusa:московий, japana:モスコビウム, korea:우눈펜튬, vjetnama:moscovi, malaja:moskovium, svahila:moscovi  
**motegar** ** ← angla:motorcar, sna:motokari, sot:motokara, svahila:motokaa, zulua:imoto, haŭsa:mota  
**motesikle** ** ← angla:motorcycle, hispana:motocicleta, franca:motocyclette, rusa:мотоцикл (mototsikl), turka:motosiklet, hindia:मोटरसाइकिल (moṭarasāikila), malaja:motosikal, mandarena:摩托车 (mótuōchē), japana:モーターサイクル (mōtāsaikuru)  
...
**multe** ** ← portugala:muito, angla:franca:hispana:multi-, rusa:мульти- (mulʹti-)  
...
**muze** *amuzi* ← angla:amuse, franca:amuser, deu:amüsieren + persa: مزه (maze), hindia:मज़ा (mazā), bengala:মজা (môja)  
...
**narme** *mola* ← persa: نرم‎ (narm), hindia:नरम (naram), bengala:নরম (nôrôm) + araba: نَاعِم‎ (nāʿim) + taja:นุ่ม (num)  
**nasibe** ** ← araba:نَصِيب (naṣīb), persa:نصیب‎ (nasib), turka:nasip, svahila:nasibu, malaja:nasib, hindia:नसीब (nasīb), bengala:নসীব (nôśib), pan:ਕਿਸਮਤ (nasīb)  
**nate** ** ← angla:franca:nature, deu:Natur, portugala:natureza, hispana:naturaleza  
**natrium** *natrio* ← angla:sodium, franca:sodium, hispana:sodio, portugala:sódio, rusa:натрий, mandarena:钠 (nà), japana:ナトリウム, korea:나트륨, vjetnama:natri, hindia:सोडियम, bengala:সোডিয়াম, malaja:natrium, svahila:natiri  
...
**nege** ** ← hispana:portugala:negar, angla:negate  
...
**nepe** ** ← greka:νέφος (nephos), scr:नभस् (nábhas), tamila:நபம் (napam) + angla:nepho-, franca:népho- + hispana:nube, portugala:nuvem + rusa:небо (nebo)  
**nepotunium** *neptunio* ← angla:neptunium, franca:neptunium, hispana:neptunio, portugala:neptúnio, rusa:нептуний, mandarena:镎 (ná), japana:ネプツニウム, korea:넵투늄, vjetnama:neptuni, hindia:नेप्ट्यूनियम, bengala:নেপচুনিয়াম, malaja:neptunium, svahila:neptuni, araba: نبتونيوم  
**nes** ** ← greka:νήσος (nēsos), malaja:nusa, mlg:nosy  
...
**neu** *nova* ← deu:neu, angla:new; neo-, franca:nouveau; néo-, hispana:nuevo; neo-, portugala:novo; neo-, rusa:новый (novyy); нео- (neo-), hindia:नव (nav), bengala:নয় (nôy); নও- (nôo-), malaja:nawa  
...
**nis** ** ← franca:angla:niche, portugala:nicho, rusa:ниша (niša)  
...
**nome** ** ← angla:-nomy, deu:franca:-nomie, hispana:portugala:-nomia, rusa:-номия (-nomiya), malaja:-nomi  
**norde** *nordo* ← angla:north, hispana:portugala:norte, deu:Nord, franca:nord, rusa:норд (nord)  
**norme** ** ← angla:hispana:portugala:franca:deu:normal, rusa:нормальный (normalʹnyj), persa:نرمال‎ (normâl)  
**noste** ** ← ← angla:portugala:hispana:nostalgia, franca:nostalgie, deu:Nostalgie, rusa:ностальгия (nostalʹgiya), japana:ノスタルジー (nosutarujī), persa:(nostâlži)  
...
**nove** *naŭ (9)* ← franca:neuf, hispana:nueve, portugala:nove, persa: نُه‎ (noh), hindia:नौ (nau), bengala:নয় (nôy), malaja:nawa  
**nude** ** ← angla:nude, hispana:desnudo, portugala:franca:nu + rusa:нудизм (nudizm), japana:ヌーディズム (nūdizumu)  
**nuke** ** ← angla:neck, hispana:portugala:nuca, franca:nuque, spa:por:nuca + araba:عُنُق‎ (ʿunuq)  
...
**ofisia** ** ← angla:franca:office, hispana:oficina, rusa:офис (ofis), turka:ofis, svahila:afisi, bengala:অফিস (ôphiś), malaja:opis, japana:オフィス (ofisu)  
...
**onor** *honoro (respekto)* ← angla:polona:hispana:honor, franca:honneur, portugala:honra, turka:onur + rusa:гонор (gonor)  
...
**orde** *armeo* ← turka:ordu, persa: اردو (ordu) + angla:franca:horde, hispana:portugala:horda, rusa:орда (orda), mandarena:斡耳朵 (wò'ěrduǒ), zho:オルド (orudo), korea:오르도 (oreudo) + araba: عُرْضِيّ‎ (ʿurḍiyy)  
...
**orte** *rekta* ← angla:franca:ortho-, hispana:portugala:orto-, rusa:орто- (orto-)  
**ose** ** ← angla:franca:-s + hispana:portugala:-oso  
...
**ove** *ovo* ← franca:oeuf, hispana:huevo, portugala:ovo + angla:turka:oval, rusa:овал (oval)  
...
**pa** *paĉjo* ← angla:franca:papa, hispana:papá, rusa:папа (papa), araba:(bābā), mandarena:爸爸 (bàba), japana:パパ (papa), korea:아빠 (appa), vjetnama:ba/bố, hindia:बाप (bāp), bengala:বাবা (baba), malaja:bapa, svahila:turka:baba  
**pace** *paco* ← itala:pace, angla:peace, hispana:portugala:paz, franca:paix  
**pade** ** ← rusa:падать (padat') + hindia: पड़ना (paṛnā), bengala:পড়া (pôŗa), teluga:పడు (paḍu)  
**pagre** ** ← hindia:marataja:पगड़ी (pagṛī), urdua:(pagṛī), bengala:পাগড়ি (pagri)  
...
**pakse** *birdo* ← hindia:पक्षी (pakṣī), bengala:পাখী (pakhī), teluga:(pakṣi), kmera:បក្សី (baksəy), taja:ปักษา (pak-sa)  
...
**panke** *flugilo* ← hindia:पंखा (paṅkhā) + (fan) birma:ပန်ကာ (panka), persa:(panke), + angla:punkah, franca:panka, deu:Pankha  
...
**paraye** ** ← hindia:पराया (parāyā), angla:pariah, rusa:пария (pariya), hispana:paria  
...
**pende** ** ← portugala:franca:pender + angla:pendant, japana:ペンダント (pendanto), korea:펜던트 (pendeonteu), turka:pandantif  
**penis** *peniso* ← angla:turka:malaja:penis, hispana:pene, portugala:franca:pénis, rusa:пенис (penis)  
**pente** *kvin (5)* ← persa: پنج‎ (panj), rusa:пять (pyat'), hindia:पाँच (pā̃c), bengala:পাঁচ (pãcô) + greka:πέντε (pente), angla:franca:hispana:portugala:penta-  
**pente** *pentri* ← angla:paint, hispana:portugala:pintura, franca:peinture, nld:pek, japana:ペンキ (penki), hindia:पेंट (penṭa)  
**perde** *furzo* ← angla:fart + franca:pet, hispana:pedo, portugala:peido, rusa:пердение (perdeniye), bengala:পাদ (pad), hindia:पाद (pād)  
**peresa** ** ← franca:paresseux, hispana:perezoso  
...
**pexe** *fiŝo* ← portugala:peixe, hispana:pez + deu:Fisch, angla:fish  
...
**picea** ** ← hispana:portugala:pícea, franca:épicéa  
...
**piloter** ** ← angla:portugala:pilot, hispana:piloto, franca:pilote, deu:Pilot, rusa:пило́т (pilót), japana:パイロット (pairotto)  
...
**plasme** ** ← angla:plasma, hispana:plasma, rusa:плазма (plazma), araba:بلازما (balazima), hindia:प्लाज़्मा (plaazma), japana:プラズマ (purazuma), malaja:plasma  
...
**platinium** *plateno* ← angla:platinum, franca:platine, hispana:platino, portugala:platina, rusa:платина, mandarena:铂 (bó), vjetnama:platin, hindia:प्लाटिनम, bengala:প্লাটিনাম, malaja:platina, svahila:platini, araba: بلاتين  
**ploze** ** ← angla:franca:explosion, hispana:explosión, portugala:exploção, rusa:имплозия (imploziya), malaja:eksplosi  
**plum** *pruno* ← angla:plum, deu:Pflaume, japana:プラム (pulamu) + franca:prune, hispana:pruna  
...
**poke** *pokero* ← angla:poker, mandarena:扑克 (pūkè), japana:ポーカー (pōkā), korea:포커 (pokeo), vjetnama:pôke  
...
**porne** ** ← angla:porn, hispana:turka:malaja:porno, portugala:pornô, deu:Pornografie, rusa:порно (porno), japana:ポルノ (poruno)  
**porta** *haveno* ← angla:port, franca:porte, hispana:puerto, portugala:porto, rusa:порт (port), hindia:पोर्ट (porṭ), urdua:(porṭ), bengala:পোর্ট (porṭ), taja:พอร์ต (phot)  
...
**poste** ** ← angla:post, portugala:postagem, franca:poste, rusa:почта (pochta), araba:بوسطة‎ (busṭa), svahila:posta, malaja:pos  
**pote** *kruĉo* ← angla:franca:pot, hispana:portugala:pote, malaja:poci, japana:ポット (potto), korea:포트 (poteu)  
...
**prasedium** ** ← angla:praseodymium, franca:praséodyme, hispana:praseodimio, portugala:praseodímio, rusa:празеодим, japana:プラセオジム, korea:프라세오디뮴, vjetnama:prazeođim, hindia:प्रासियोडाइमियम, bengala:প্র্যাসেওডিমিয়াম, malaja:praseodinium, svahila:praseodimi, araba: براسوديميوم  
...
**probe** ** ← deu:Probe, angla:prove; probe, hispana:probar, portugala:provar, rusa:проба  
...
**projete** ** ← franca:projet, portugala:projeto, angla:project, hispana:proyecto, rusa:проект (proyekt), hindia:प्रोजैक्ट (projaikṭ), bengala:প্রজেক্ট (prôjekṭ), japana:プロジェクト (purojekuto), korea:프로젝트 (peurojekteu), turka:proje  
...
**proses** ** ← angla:process, hispana:proceso, portugala:processo, rusa:процесс (process), persa:پروسه‎ (prose), malaja:proses, japana:プロセス (purosesu), korea:프로세스 (peuroseseu)  
...
**pude** ** ← angla:putrid, hispana:portugala:podre, franca:putride + mandarena:腐 (fǔ), japana:腐 (fu) + taja:ผุ (phu)  
...
**puje** ** ← hindia:पूजा (pūjā), urdua:(pūjā), taja:บูชา (bucha), malaja:puja  
...
**pure** *plena* ← hindia:पूर्ण (pūrn), bengala:পূর্ণ (pūrṇa), panĝaba:ਪੂਰਾ (pūrā), persa:(por)  
**putau** *vinbero* ← mandarena:葡萄 (pútáo), kantona:葡萄 (pou4 tou4), vua:葡萄 (bu dau3), japana:葡萄 (budō), korea:포도 (podo), vjetnama:bồ đào  
**putavorange** ** ← angla:grapefruit, mandarena:葡萄柚  
**pute** ** ← angla:computer, hispana:computadora, portugala:computador, rusa:компьютер (komp’uter), araba:كَمْبْيُوتَر‎ (kambyūtar), svahila:kompyuta, hindia:कंप्यूटर (kampyūṭar), bengala:কম্পিউটার (kômpiuṭar), malaja:komputer, japana:コンピューター (konpyūtā)  
**putonge** *generala* ← mandarena:普通 (pǔtōng), kantona:普通 (pou2tung1), vjetnama:phổ thông, korea:보통 (botong)  
**radia** ** ← angla:franca:radiation, hispana:radiación, portugala:radiação, malaja:radiasi, rusa:радио (radio), turka:radyo, svahila:redio, hindia:रेडियो (reḍiyo), bengala:রেডিও (reḍio), japana:ラジオ (rajio), korea:라디오 (radio)  
...
**rate** ** ← lat:ratio, angla:rational, franca:rationnel, hispana:portugala:racional + deu:Rat, polona:rada, rusa:рада (rada)  
**ratibe** ** ← araba: رَتَّبَ (rattaba), svahila:ratibu, haŭsa:rattaba, persa: ترتيب (tartīb), hindia:तरतीब (taratība), malaja:tertib, turka:tertip  
**reje** ** ← angla:reign, franca:régner, hispana:portugala:reinar + hindia:राजा (rājā), bengala:রাজা (raja), tamila:ராஜா (rājā), malaja:raja  
**rel** *reala* ← angla:hispana:portugala:real, franca:réel, rusa:реальный  
...
**rentogenium** *rentgenio* ← angla:roentgenium, franca:roentgenium, hispana:roentgenio, portugala:roentgênio, rusa:рентгений, mandarena: (lún), japana:レントゲニウム, korea:뢴트게늄, vjetnama:roentgeni, hindia:रॉन्टजैनियम, bengala:রোয়েন্টজেনিয়াম, malaja:roentgenium, svahila:roentgeni, araba: رونتجينيوم  
**resete** ** ← itala:ricetta, rusa:рецепт (retsept), deu:Rezept, hispana:receta, portugala:receita, franca:recette, malaja:resep  
...
**ri-** *ripetado* ← angla:franca:portugala:hispana:re-, rusa:ре- (re-)  
**rice** ** ← angla:rich, franca:riche, portugala:hispana:rico  
...
**rite** ** ← hindia:रीति (rīti), bengala:রীতি (rīti) + angla:franca:rite, hispana:portugala:rito  
...
**romante** ** ← franca:angla:hispana:portugala:romance, rusa:роман (roman), turka:romans, malaja:roman, japana:ロマンス (romansu), korea:로맨스 (romaenseu)  
**rose** *roso* ← franca:rosée, hispana:rocío, rusa:роса (rosa)  
**roste** ** ← franca:rôtir, angla:roast, deu:rösten, itala:arrostare  
**rote** ** ← hispana:portugala:malaja:roda + angla:rotate, deu:rotieren, franca:rotationner, turka:rotasyon  
**rototope** ** ← angla:top, franca:toupie  
**roze** *rozo* ← franca:angla:rose, hispana:portugala:rosa, rusa:роза (roza), persa:(roz, gol-e sorx), filipina:rosas  
**rubidium** *rubidio* ← angla:rubidium, franca:rubidium, hispana:rubidio, portugala:rubídio, rusa:рубидий, mandarena:铷 (rú), japana:ルビジウム, korea:루비듐, vjetnama:rubiđi, hindia:रुबिडियम, bengala:রুবিডিয়াম, malaja:rubidium, svahila:rubidi, araba: روبيديوم  
...
**rukosake** ** ← deu:angla:rucksack, rusa:рюкзак (rjukzak), japana: リュックサック (ryukkusakku), korea:륙색 (ryuksaek)  
**rul** ** ← angla:roll, franca:rouler, deu:aufrollen  
**rum** ** ← angla:rum, hispana:ron, hindia:रम (ram), rusa:ром (rom)  
**rupe** *aspekto* ← hindia:रूप (rūp), malaja: rupa, taja: รูป (rūp), kmera:រូប (rūp)  
**rute** ** ← angla:franca:rupture, hispana:rotura, portugala:rutura + rusa:банкрот (bankrot), malaja:bangkrut  
...
**sababe** *kialo* ← heb:(sibá), haŭsa:sabo;sababi, konga:sambu, araba:urdua:(sabab), turka:sebep, malaja:sebab, svahila:sababu  
**sabe** *scii (koni)* ← franca:savoir, hispana:portugala:saber, angla:savvy, pcm:sabi  
...
**sade** ** ← turka:sade, persa:(sāde), hindia:सादा (sādā)  
**safar** *vojaĝi* ← araba:(safar), hindia:सफ़र (safar), turka:sefer, svahila:safari, angla:franca:hispana:portugala:deu:safari  
**safe** *pura* ← svahila:safi, hindia:साफ़ (sāf), urdua:(sāf), bengala:চাফা (sapha)  
...
**sahe** *ĝusta (prava)* ← hindia:सही (sahī), urdua:(sahī), persa:(sahih), araba:(ṣaḥīḥ), svahila:sahihi, malaja:sah  
...
**sanduke** *skatolo (kesto)* ← rusa:сундук (sunduk), araba: صُنْدُوق‎ (ṣundūq), persa:urdua:صندوق‎ (sanduq), svahila:sanduku, turka:sandık  
...
**sel** ** ← araba: صَلَاح‎ (ṣalāḥ), hindia:सलाह (salāh), teluga:సలహా (salahā), turka:salık + angla:counsel, franca:conseil, hispana:consejo, portugala:conselho + rusa:консультант (konsultant)  
...
**sere** *serio* ← angla:series, franca:série, hispana:serie, rusa:серия (seriya), turka:seri + hindia:सिलसिला (silsilā), araba:(silsila), tur:silsile, svahila:silisili, persa: سلسله‎ (selsele) + mandarena:系列 (xìliè)  
...
**serve** ** ← angla:franca:service, portugala:serviço, rusa:сервис (servis), turka:servis, hindia:(sevâ)  
...
**side** *sidi* ← rusa:сидеть (sidet'), angla:sit, deu:sitzen, itala:sedere + hispana:portugala:presidente, persa: پرزیدنت‎ (perezident), malaja:presiden  
**sife** ** ← hindia:गुण (guṇ), bengala:গুণ (guṇ), teluga:గుణము (guṇamu), birma:ဂုဏ် (gun), malaja:guna, taja:คุณ (kun), kmera:គុណ (kun)  
**sigare** *cigaredo* ← angla:franca:cigarette, hispana:cigarillo, portugala:cigarro, rusa:сигарета (sigarteta), araba:(sījāra), mandarena:雪茄 (xǔejiā), vua:雪茄 (xi'gá), hindia:सिगरेट (sigreṭ), bengala:সিগারেট (śigareṭ), svahila:turka:sigara, amhara:ሲጃራ (siǧara)  
...
**sive** ** ← angla:franca:hispana:portugala:civil, por:civil, hindia:सिविल (sivil), malaja:sipil  
**sixe** *sis* ← angla:franca:six, hispana:portugala:seis, deu:sechs, rusa:шесть (shest’), persa: شِش‎ (šeš) + araba:ستة‎ (sitta), svahila:sita, haŭsa:shidà  
**skale** *ŝtuparo* ← hispana:portugala:escalar + franca:escalier + angla:scale, deu:Skale, rusa:шкала (škala)   
...
**skerte** *jupo* ← angla:skirt, hindia:स्कर्ट (skarṭ), bengala:স্কার্ট (śkarṭ), japana:スカート (sukāto), korea:스커트 (seukeoteu), svahila:sketi, haŭsa:siket  
**skope** ** ← angla:franca:-scope, hispana:portugala:-scopio, rusa:-скоп (skop), japana:スコープ (sukōpu), hindia:स्कोप (-skop), malaja:turka:-skop  
**skulte** *skulti (statuo, skultaĵo)* ← angla:sculpt, hispana:esculpir, franca:sculpteur, portugala:escultor, rusa:скульптор (skulptor)  
**skute** ** ← angla:franca:hispana:scooter, rusa:скутер (skuter), mandarena:速克达 (sùkèdá), japana:スクーター (sukūtā), korea:스쿠터 (seukuteo), vjetnama:xe xcutơ, hindia:स्कूटर (skūṭar), bengala:স্কুটার (śkuṭar), malaja:skuter  
**soce** ** ← angla:socialize + hispana:sociedad, rusa:социум (socium)  
**sofa** *sofo* ← angla:franca:sofa, hispana:portugala:sofá, rusa:софа (sofa), mandarena:沙发 (shāfā), japana:ソファ (sofa), korea:소파 (sopa), vjetnama:xô pha, hindia:सोफ़ा (sofā)  
**sofe** *saĝa* ← greka:σοφία (sofía) + angla:philosophy, franca:philosophie, hispana:filosofia, rusa:философия (filosofiya), malaja:filsafat, araba:(falsafa), svahila:falsafa, turka:felsefe, hindia:फ़लसफ़ा (falasfā)  
**soge** *serĉi* ← mandarena:搜 (sōu), kantona:索 (sok3), vua:搜 (seu1), japana:捜索 (sōsaku) + angla:seek, deu:suchen, polona:szukać, ukr:шукати (šukati) + rusa:искать (iskat’)  
...
**sore** ** ← mandarena:锁 (suǒ), kantona:鎖 (so2), vua:鎖 (su2), japana:錠 (jō), kmera:សោ (sao) + hispana:cierre, franca:serrure + hungara:zár  
...
**sponje** ** ← angla:sponge, hispana:portugala:esponja, araba:إسفنج (ʾisfanj), persa:اسفنج‎ (esfanj), hindia:स्पंज (spanja), japana:スポンジ (suponji), malaja:spon, svahila:sponji  
...
**state** ** ← turka:istasyon, portugala:estação, hispana:estación, filipina:estasyon, urdua:(isṭeśan), angla:franca:station, hindia:स्टेशन (sṭeśan), rusa:станция (stantsiya)  
...
**suikaboge** ** ← portugala:abóbora-d'água, turka:su kabağı  
...
**suke** *feliĉa* ← hindia:सुखी (sukhī), japana:好き (suki), taja:สุข (suk) + jpn:好く (suku), malaja: suka  
**sulfe** *sulfuro* ← angla:sulfur, franca:soufre, hispana:azufre, portugala:enxofre, svahila:sulfuri  
**sultan** ** ← araba:سلطة (sulṭa), angla:turka:malaja:sultan, hispana:sultán, rusa:султан (sultan), persa:سلطان‎ (soltân), hindia:सुल्तान (sultān), bengala:সুলতান (śultan), svahila:sultani  
...
**supre** ** ← angla:super, franca:super, hispana:portugala:sobre, itala:sopra, japana:スーパー (sūpā)  
**suprize** *surprizo* ← angla:surprise, turka:sürpriz, persa:(surpris), rusa::сюрприз (siurpriz), portugala:surpresa, hispana:sorpresa  
**sus** *lakrico* ← araba: سُوس (sus), hispana:alcazus, portugala:alcaçuz, svahila:susi  
**susan** *lilio* ← araba: سَوْسَن‎ (sawsan), hispana:azucena + angla:Susan, portugala:Susana, franca:Suzanne, polona:Zuzana, rusa:Сусанна (Susanna)  
**sute** ** ← hindia:सीना (sīnā), rusa:шить (šit') + franca:angla:suture, portugala:hispana:sutura  
**sutre** ** ← hindia:सूत्र (sūtra), malaja:sutera, angla:franca:hispana:portugala:sutra, rusa:сутра, japana:スートラ (sūtora), korea:수트라 (suteura)  
**suxi** *suŝio* ← japana:寿司 (sushi), angla:hispana:sushi, rusa:су́ши (sushi), turka:suşi  
**ta** *al (ĝis, por)* ← angla:to + hindia:-तक (-tak) + persa: تا‎ (tâ)  
...
**talbe** ** ← araba: طلب (talaba), hindia:तलब (talab), bengala:তলব (tôlôb), turka:talep  
...
**tame** *avida* ← araba: طَمَّاع‎ (ṭammāʿ), mandarena:贪 (tān), korea:탐욕 (tamyok), vjetnama:tham  
**tan** ** ← persa: تنه‎ (tane), hindia:तना (tanā), tamila:தண்டு (taṇṭu), vjetnama:thân, taja:ต้น (ton), malaja:tangkai  
...
**tanur** *forno* ← araba: تَنُّور‎ (tannūr), persa: تنور (tannūr), hindia:तनूर (tanūr), bengala:তন্দুর (tôndur), svahila:tanuri, turka:tandır + angla:tandoor  
**tape** ** ← hispana:turka:tapa, portugala:tampa, greka:τάπα (tapa), bul:тапа (tapa), angla:tap  
**tarif** ** ← angla:tariff, hispana:portugala:tarifa, deu:franca:turka:tarif, araba:(taʿrīf), rusa:тариф (tarif), hindia:टैरिफ़ (ṭairif)  
**tas** *plado* ← araba: طَاس (ṭās), svahila:tasa, turka:tas, franca:tasse, hispana:taza, rusa:таз + hindia:तश्तरी (tashtarī)  
**tate** *tuŝi* ← angla:franca:tact, hispana:tacto, portugala:tato  
**tatike** ** ← portugala:tática, itala:tattica, angla:tactic, rusa:тактика (taktika), deu:Taktik  
**tato** *tatuo* ← sam:tah:tatau, haw:kākau, malaja:filipina:tato, angla:tattoo, franca:tatouage, hispana:tatuaje, portugala:tatuagem, rusa:тату (tatu)  
**tave** *pato* ← hindia:तवा (tavā), turka:tava, persa:(tābe)  
**taxe** ** ← angla:tax, portugala:taxa, hispana:tasa, hindia:टैक्स (ṭEks)  
**taze** *freŝa* ← persa: تازه (tâze), hindia:ताज़ा (tāzā), bengala:তাজা (taja), turka:taze, araba: طَازَج (ṭāzaj)  
...
**tehnium** *teknecio* ← angla:technetium, franca:technétium, hispana:tecnetio, portugala:tecnécio, rusa:технеций, mandarena:锝 (dé), japana:テクネチウム, korea:테크네튬, vjetnama:tecnexi, hindia:टेक्निशियम, bengala:টেকনিসিয়াম, malaja:teknetium, svahila:tekineti, araba: تكنيتيوم  
...
**tente** ** ← angla:tempt, franca:tenter, hispana:portugala:tentar  
...
**tepe** *bendo* ← angla:tape, hindia:टेप (ṭep), svahila:tepu, japana:テープ (tēpu), korea:테이프 (teipeu), turka:teyp  
...
**terce** ** ← hispana:torcido, portugala:torto, hindia:तिरछा (tirachha), bengala:তেরছা (tērachā), pan:तिरकस (tirakasa)  
**tere** ** ← angla:hispana:portugala:terror, franca:terreur + rusa:терроризм (terrorizm), japana:テロリズム (terorizumu), korea:테러리즘 (tereorijeum), malaja:terorisme  
...
**tire** ** ← franca:tirer, hispana:portugala:tirar + persa: تیر (tir), hindia:तीर (tīr), bengala:তীর (tir)  
...
**tize** ** ← persa: تیز (tiz), hindia:तेज़ (tez), turka:tez  
...
**trage** ** ← angla:tragic, franca:tragique, hispana:portugala:trágico, rusa:трагический (tragičeskij)  
...
**trete** ** ← angla:treaty, franca:traité, hispana:portugala:tratado, rusa:контракт (kontrakt), turka:kontrat, malaja:kontrak  
...
**trompe** ** ← hispana:portugala:trompa, angla:trumpet, franca:trompette, japana:ランペット (torampetto), korea:트럼펫 (teureompet), turka:trompet, svahila:tarumbeta  
**truke** ** ← angla:trick, deu:Trick, franca:truc, hispana:truco, portugala:truque, hungara:trükk, rusa:трюк (tr’uk)  
**tu** *vi (ci)* ← franca:portugala:hispana:tu, hindia:तू (tū), rusa:ты (ty)  
...
**tuhe** *sputi* ← hindia: थूकना (thūknā), mandarena: 吐 (tǔ), turka:tükürmek  
...
**tulpe** ** ← angla:tulip, hispana:tulipá, portugala:túlipa, nld:tulp, rusa:тюльпан (t’ul’pan), araba:توليب (tūlīb), hindia:ट्यूलिप (ṭyūlip), malaja:tulip, japana:チューリップ (chūrippu)  
...
**tunge** ** ← mandarena:痛 (tòng), kantona:痛 (tung3), korea:통 (tong)  
...
**vare** ** ← angla:various, hispana:vario, portugala:vário  
**varis** ** ← malaja:waris, araba:(wariþ), svahila:urithi, turka:varis, miras  
**varke** ** ← araba:(waraqa), haŭsa:warƙa, turka:varak, persa:(varaqe), taj:варақа (varaqa), svahila:waraka, + birma:အရွက် (arwak)  
...
**vere** *vera* ← angla:very, itala:vero, rusa:верный (verniy), hispana:verdadero, portugala:verdadeiro, deu:wahr, franca:vrai  
**verme** *vermo* ← angla:worm, franca:ver, hispana:portugala:verme + japana:ワーム (wāmu)  
...
**viole** *violono* ← angla:violin, franca:violon, hispana:violín, portugala:violino, malaja:biola, hindia:वायलिन (vāylin), japana:バイオリン (baiorin), korea:바이올린 (baiollin) + rusa:виолончель (violončel’)  
**violete** ** ← angla:portugala:franca:violet, hispana:violeta, deu:violett, rusa:фиолетовый (fioletovyy), japana:バイオレット (baioretto), korea:보라 (bola)  
...
**viruslojia** ** ← polona:wirusologia, rusa:вирусология (virusologiya)  
...
**vite** ** ← franca:vis, itala:vite, rusa:винт (vint), turka:vida  
**vize** ** ← turka:vize, angla:visa, rusa:виза (viza), hindia:वीज़ा (vīzā)  
**vizin** ** ← mandarena:味精 (wèijīng), kantona:味精 (mei6 zing1), vjetnama:mì chính, malaja:vetsin, micin, filipina:bitsin  
**vode** *promesi* ← franca:vœu, hispana:portugala:voto, araba:وعد (waʿd), hindia:वादा (vādā), turka:vaat, persa:وعده (va'deh)  
...
**xam:** *vespero* ← persa: شام‎ (šâm), hindia:शाम (śām), bengala:শাম (śam), turka:akşam  
...
**xante** *trankvila (serena)* ← hindia:शांति (shānti), bengala:শান্তি (shānti), pan:ਸ਼ਾਂਤੀ (shāntī), marataja:शांत (shānta), teluga:శాంతి (shānti), guĝarata:શાંતિ (shānti), kmera:សន្តិ (sɑnte’), angla:portugala:shanti, rusa:шанти (šanti), japana:シャンティ (shanti)  
...
**xe** ** ← araba: شيء (šayʾ), turka:şey, persa: شیء‎ (šeyʼ) + mandarena:事 (shì), kantona:事 (si6), vjetnama:sự  
...
**xehal** *situacio (aferstato)* ← mandarena:事态 (shìtài), japana:事態 (jitai), angla:state of affairs, franca:état des choses  
...
**xir** *poemo* ← heb:שיר (šir), araba: شِعْر‎ (šiʿr), turka:şiir, persa: شعر‎ (še'r), svahila:shairi, malaja:syair+ mandarena:诗 (shī), kantona:詩 (si1), japana:詩 (shi), korea:시 (shi)  
...
**xofe** *konduki* ← franca:angla:deu:chauffeur, hispana:portugala:chofer, rusa:шофёр (šofjor), polona:szofer, taja: โชเฟอร์ (chofoe), turka:şoför, persa:(šofer)  
...
**xope** *aĉeti* ← angla:franca:hispana:shopping, japana:ショッピング (shoppingu), korea:쇼핑 (syoping), taja:ชอปปิ้ง (chop-bing), rusa:шоппинг (šopping), mandarena:血拼 (xuèpīn)  
...
**xukre** *danki (dankon)* ← araba: شُكْر‎ (šukr), hindia:शुक्रिया (śukriyā), bengala:শুকরিয়া (śukriẏa), svahila:shukrani, turka:şũkür  
**xule** *lerni (studi)* ← mandarena:学 (xué) + deu:Schule, svahila:shule + angla:school, franca:école, hispana:escuela, portugala:escola, rusa:школа (škola), hindia:स्कूल (skūl), bengala:স্কুল (śkul), malaja:sekolah  
...
**zigzage** ** ← angla:franca:hispana:zigzag, portugala:ziguezague, rusa:зигзаг (zigzag), japana:ジグザグ (jiguzagu)  
**zikure** ** ← araba:(ziqqūra), deu:Zikkurat, rusa:зиккурат (zikkurat)  
...
**zor** ** ← hindia:ज़ोर (zor), bengala:জোর (zor), persa: زور (zur)  
...
**• karekan** *laborejo* ← angla:workshop, persa:کارخانه‎ (kârxâne), hindia:कारख़ाना (kārxānā), bengala:কারখানা (karôkhana), mandarena:工厂 (gōngchǎng)  
**• konike** *komuna* ← angla:common, hispana:común, portugala:comum, franca:commun, rusa:коммунальный (kommunal’nyy)  
**• kopiaje** *kopio* ← angla:copy, franca:copie, hispana:portugala:copia, rusa:копия (kopiya), hindia:कापी (kāpī), turka:kopya, malaja:kopi, mandarena:拷貝 (kǎobèi), japana:コピー (kopī)  
...
**• nasia** ** ← araba:(nās) + angla:franca:nation, deu:Nazion, portugala:nação, hispana:nación, polona:nacja, rusa:нация (natsiya)  
