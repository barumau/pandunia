...
**a** *ĉe (en, sur)* ← franca:à, hispana:portugala:a, angla:a-;ad-, rusa:а- (a-), haŭsa:a + fula:haa  
...
**ade** *kutimo* ← araba: عادة (ʿāda), hindia:आदत (ādat), malaja:adat, turka:adet, svahila:ada, haŭsa:al'ada, fula:aada  
...
**af** *pardono* ← araba: مُعَاف‎ (muʿāf), hindia:माफ़ (māf), bengala:মাফ (maph), malaja:maaf, svahila:afu, turka:af, fula:yaafu, haŭsa:yafe  
...
**akle** ** ← araba: عَقْل‎ (ʕaql), persa: عقل‎ ('aql), hindia:अक़्ल (aqla), bengala:আকল (akol), malaja:akal, fula:hakkille, volofa:hakilo, haŭsa:hankali, svahila:akili, turka:akıl  
...
**alkol** *alkoholo* ← araba: كُحُول‎ (kuḥūl), angla:hispana:alcohol, franca:alcool, portugala:álcool,  rusa:алкоголь (alkohol), japana:アルコール (arukōru), korea:알콜 (alkol), hindia:ऐल्कोहॉल (ailkohŏl), bengala:এলকোহল (elkohôl), ind:alkohol, turka:fula:alkol  
...
**ama** *sed* ← araba: أما‎ (ʔamma), turka:ama, persa:urdua:اما‎ (ammâ), haŭsa:fula:amma, joruba:àmọ́  
...
**amen** ** ← heb: אָמֵן‎, (ʾāmēn), araba: آمَنَ‎ (āmana), svahila:amini, fula:amiini, haŭsa:amince, turka:amin + greka:ἀμήν (ámén), angla:deu:franca:polona:hispana:amen, mandarena:阿门 (āmén), kantona:阿門 (aa3mun4), korea:아멘 (amen), japana:アーメン (āmen), vjetnama:a-men  
**Amerike** *Ameriko* ← angla:America, hispana:portugala:América, rusa:Америка (Amerika), turka:svahila:malaja:Amerika, araba:أمريكا‎ (ʾamrīkā), hindia:अमेरिका (amerikā), bengala:আমেরিকা (amerika), japana:アメリカ (amerika), haŭsa:Amurka  
...
**amir** *ordono* ← araba: أَمْر‎ (ʾamr), persa: امر‎ (amr), turka:emir, svahila:amiri, haŭsa:umarni, fula:amiiru + angla:admiral, franca:amiral, hispana:portugala:emir rusa:эмир (emir)  
...
**ampul** ** ← franca:angla:ampoule, mandarena:安瓿 (ānbù), japana:アンプル (anpuru), rusa:ампула (ámpula), araba:(ʾambūla), turka:fula:ampul, hindia:फफोला (phapholā)  
...
**are** *areo* ← angla:area, portugala:hispana:área, polona:areał, franca:aire  
...
**asle** *origino* ← araba:(ʾaṣl), turka:asl, malaja:asal, hindia:असल (asl), tamila:அசல் (acal), svahila:asili, haŭsa:asali, fula:asli  
...
**babu** *ĉapitro* ← araba:persa:urdua: بَاب‎ (bāb), malaja:bab, svahila:babu, haŭsa:babi, fula:baabuwo  
...
**badal** *interŝanĝi* ← araba:(badala), hindia:बदला (badlā), svahila:badili, haŭsa:badali, turka:bedel  
...
**baki** ** ← araba: بَقِيَّة‎ (baqiyya), persa: بقیه‎ (baqiye), hindia:बाक़ी (bāqī), malaja:baki, turka:bakıye, svahila:-baki, fula:bakke  
...
**banana** *banano* ← fula:volofa:banaana, rusa:банан (banan), polona:banan, franca:deu:banane, portugala:hispana:angla:banana, japana:バナナ (banana), korea:바나나 (banana)  
...
**bande** *ligi (bendo)* ← angla:bind; band, deu:Band, franca:bande, hispana:venda, rusa:бинт (bint), persa: بند‎ (band), hindia:बाँधना (bāndhnā), mandarena:绑 (bǎng), kantona:綁 (bong2), vjetnama:băng, turka:bant, fula:banda; bandaas + svahila:bendeji, haŭsa:bandeji  
**bandera** *flago* ← angla:banner, franca:bannière, hispana:bandera, portugala:bandeira, malaja:bendera, filipina:bandila, svahila:bendera, fula:bandeera  
**bang** ** ← mandarena:棒 (bàng), kantona:棒 (paang5), japana:棒 (bō), korea:봉 (bong), taja:ตะบอง (ta-bong), kmera:ដំបង (dɑmbɑɑng)  
**banke** ** ← angla:deu:polona:malaja:bank, turka:banka, rusa:банк (bank), franca:banque, hispana:portugala:banco, persa:(bânk), hindia:बैंक (baiṅk), urdua:(baiṅk), teluga:బ్యాంకు (byāṅku), tamila:(vaṅki), fula:banke, haŭsa:banki  
...
**barke** *gratuli* ← haŭsa:barka, malaja:berkah, turka:tebrik, persa:(tabrik), araba:urdua:(mubārak), svahila:baraka, hau:albarka, joruba:alubarika, fula:(al)barka  
...
**basen** *baseno* ← angla:basin, franca:bassin, rusa:бассейн (basseyn), portugala:bacia, malaja:besen, svahila:beseni, fula:basin  
**baske** *korbo* ← angla:basket, malaja:bakul, japana:バスケット (basuketto)  
**bata** *anaso* ← araba: بَطَّة‎ (baṭṭa), hindia:बत्तख (battakh), tamila:வாத்து (vāttu), teluga:బాతు (bātu), svahila:bata + hispana:portugala:pato + taja:เป็ด  (pèt)  
**bati** *ok (8)* ← mandarena:八 (bā), kantona:八 (baat3), vua:八 (baʔ), japana:八 (hachi), korea:팔 (pal), taja:แปด (pæt) + hindia:आठ (āṭh), bengala:আট (aṭ)  
**batri** *baterio (pilo)* ← angla:battery, hispana:portugala:bateria, rusa:батарея (batareya), persa:(bātri), hindia:बैटरी (baiṭrī), bengala:ব্যাটারি (byaṭari), tamila:பத்திரி (pattiri), araba:(baṭṭāriyya), japana:バッテリー (batterī), korea:배터리 (baeteori), malaja:bateri, svahila:betri, haŭsa:baturi, fula:baateri  
...
**benke** *benko* ← franca:banc, deu:Bank, hispana:portugala:banco, malaja:bangku, fula:baŋ + angla:bench, svahila:benchi, hindia:बेंच (bẽc), japana:ベンチ (benchi), korea:벤치 (benchi)  
...
**bere** *bereto* ← franca:béret, turka:fula:bere, angla:beret, japana:ベレー帽 (berē bō), mandarena:贝雷帽 (bèiléimào), kantona:巴黎帽 (baalaimou), rusa:берет (beret), ful:beere  
...
**biku** *monaĥo aŭ monaĥino* ← hindia:भिक्षु (bhikṣu), bengala:ভিক্ষু (bhikkhu), tamila:பிக்ஷு (pikṣu), malaja:biku; biksu, mandarena:比丘 (bǐqiū), japana:比丘 (biku), korea:비구 (bigu), taja:ภิกษุ (pík-sù), birma:ဘိက္ခု (bhikhku)  
...
**bine** *konstrui* ← araba: بِنَاء‎ (bināʾ), hindia: बनाना (banānā), urdua:(banānā), persa:(banā), turka: bina, + japana:ビル (biru)  
...
**biskute** *biskvito* ← angla:franca:biscut, portugala:biscoito, rusa:бисквит (biskvit), turka:bisküvi, svahila:biskuti, araba:بسكويت‎ (baskawīt), hindia:बिस्कुट (biskuṭ), malaja:biskut, japana:ビスケット (bisuketto), fula:biskit  
...
**bol** *pilko* ← angla:ball, hispana:portugala:malaja:filipina:bola, taja:บอล (bɔl), japana:ボール (bōru), korea:볼 (bol), kmera:បាល់ (bal), bengala:বল (bôl), deu:Ball, franca:boule; balle, turka:may:balon, fula:bal, haŭsa:balân  
...
**bote** *ŝuo* ← hindia:बूट (būṭ), polona:but, cze:bota, joruba:bata + angla:boot, franca:botte, hispana:portugala:bota, rusa:ботинок (botinok), pol:malaja:but, persa: بوت‎ (but), araba: بوت‎ (bōt), japana:ブーツ (būtsu), svahila:buti  
**botel** *botelo* ← angla:bottle, franca:bouteille, hispana:botella, portugala:botelha, rusa:бутылка (butylka), persa: بطری‎ (botri), hindia:बोतल (botal), bengala:বোতল (botôl), malaja:botol, tamila:புட்டி (puṭṭi), fula:butél  
...
**buke** *libro* ← angla:book, franca:bouquin, hindia:बुक (buk), deu:Buch, malaja:buku, fula:svahila:buku, volofa:bukoo + rusa:буклет (buklet)  
...
**bure** ** ← angla:franca:bureau, hispana:buro-, portugala:birô, rusa:бюро (byuro), polona:biuro, turka:büro, fula:biró  
...
**buton** *klavo (butono)* ← angla:button, hispana:botón, portugala:botão, franca:bouton, hindia:बटन (baṭan), bengala:বোতাম (botam), japana:ボタン (botan), korea:버튼 (beoteun), fula:butoŋ  
**buyu** *baobabo* ← svahila:mbuyu, volofa:buy, sna:muuyu, zulua:isimuhu, fula:ɓokki  
...
**car** *aŭto (ĉaro)* ← franca:char, angla:car; chariot, persa:چرخ (čarx), mandarena:车 (chē), kantona:車 (ce1), korea:차 (cha), japana:車 (sha), turka:çark + portugala:hispana:carro, deu:Karre, teluga:కారు  (kāru), malaja:kereta, fula:saret  
**carme** *ĉarmo* ← angla:charm, franca:portugala:charme, deu:Charme, rusa:чары (čary); шарм (šarm), japana:チャーム (chāmu)  
...
**cavi** *ŝlosilo* ← portugala:chave, hispana:llave, hindia:चाबी (cābi), bengala:চাবি (cabi), tamila: சாவி (cāvi), fula:volofa:caabi, man:caaboo, konga:nsapi  
...
**cerium** *cerio* ← angla:cerium, franca:cérium, hispana:cerio, portugala:cério, rusa:церий, mandarena:铈 (shì), japana:セリウム, korea:세륨, vjetnama:xeri, hindia:सेरियम, bengala:সেরিয়াম, malaja:serium, svahila:seri, araba: سيريوم  
...
**coklate** *ĉokolado* ← hispana:portugala:angla:chocolate, franca:chocolat, rusa:шоколад (šokolad), mandarena:巧克力 (qiǎokèlì), kantona:朱古力 (zyugulik), japana:チョコレート (chokorēto), korea:초콜렛 (chokollet), hindia:चाकलेट (cāklet), bengala:চকলেট (côkleṭ), malaja:cokelat, svahila:chokoleti, turka:çikolata, fula:cokolete  
...
**cung** *insekto* ← mandarena:虫 (chóng), kantona:蟲 (cung4), korea:충 (chung), vjetnama:trùng  
...
**dake** *kovrilo* ← angla:deck, deu:Deckel, hindia:ढक्कन (ḍhakkan), bengala:ঢাকনা (ḍhakna)  
**dalil** ** ← araba: دَلِيل (dalīl), hindia:दलील (dalīl), bengala:দলিল (dôlil), haŭsa:svahila:dalili, turka:delil, fula:daliilu  
...
**din** *religio* ← araba:(dīn), bengala:দীন (din), persa:(din), turka:malaja:din, svahila:dini, haŭsa:addini, fula:volofa:diine, hindia:दीन (dīn)  
...
**dingi** *najlo* ← mandarena:钉 (dīng), kantona:釘 (ding1), vjetnama:đinh  
...
**dotor** *doktoro* ← portugala:doutor, itala:dottore, angla:hispana:doctor, rusa:доктор (doktor) + fula:doktoor  
...
**dua** *preĝo* ← araba: دُعَاء‏  (duʿāʾ), hindia:दुआ (duā), bengala:দুয়া (dua), malaja:doa, svahila:turka:dua, haŭsa:àddu'ā̀, fula:du'aade, joruba:àdúrà + mandarena:祈祷 (dǎo), japana:禱 (tō), korea:도 (do)  
...
**dunia** *mondo* ← araba: دُنْيَا‎ (dunyā), hindia:दुनिया (duniyā), bengala:দুনিয়া (duniya), tamila:துனியா (tuṉiyā), malaja:svahila:dunia, turka:dünya, persa: دنیا (donya), urdua: دنیا (duniyā), haŭsa:duniya, fula:duniyaaru  
...
**e** *kaj* ← franca:et, portugala:e, hispana:y;e, mandarena:和 (hé), fula:e  
...
**fake** *fiki* ← angla:fuck + rusa:фак (fak), mandarena:法克 (fǎkè), japana:ファック (fakku)  
...
**fantaze** *fantaci* ← angla:franca:fantasy, hispana:fantasía, portugala:svahila:fantasia, rusa:фантазия (fantazija), turka:fantezi, malaja:fantasi, japana:ファンタジー (fantajī)  
...
**fatura** *kalkulo (fakturo)* ← franca:facture, hispana:factura, portugala:turka:fatura, deu:Faktura, rusa:фактура (faktura), persa: فاکتور‎ (fâktur), araba: فَاتُورَة‎ (fātūra)  
...
**fe** *fari* ← franca:faire, portugala:fazer, itala:fare + araba: فَعَلَ‎ (faʿala) + svahila:fanya + kantona:化 (faa3), hakaa:化 (fa), mandarena:化 (huà), vjetnama:hoá  
...
**fete** *fari (faro, fakto)* ← franca:fait, portugala:feito, angla:feat; fact, deu:Fakt, rusa:факт (fakt), persa:(fâkt)  
...
**fixe** *fiksi* ← angla:fix, franca:fixer;ficher, hispana:fijar, portugala:fixar, deu:fixieren + rusa:афиша (afiša), turka:afìş, vjetnama:áp phích  
...
**furita** *kolero (furiozo)* ← angla:fury, hispana:polona:furia, portugala:fúria  
...
**gabre** *tombo (enterigi)* ← araba:(qabr), hindia:क़ब्र (qabra), bengala:কবর (kôbôr), malaja:kubur, haŭsa:kabari, svahila:kaburi, turka:kabir + deu:Grab, polona:grób, rusa:гроб (grob)  
...
**gaja** *elefanto* ← hindia:गज (gaj), tamila:கசம் (kacam), teluga:గజము (gajamu), kanara:ಗಜ (gaja), malaja:gajah, filipina:gadya  
**gala** ** ← angla:gullet, hispana:portugala:gola, far:گلو (galu), hindia:गला (gala), bengala:গলা (galā), pan:ਗਲਾ (galā) + rusa:горло (gorlo) + araba:حلق (halaq)  
**galaxia** *galaksio* ← angla:galaxy, hispana:galaxia, portugala:galáxia, franca:galaxie, rusa:галактика (galaktika), turka:malaja:galaksi, hindia:गैलेक्सी (gaileksī)  
...
**gamba** *salikoko* ← hispana:portugala:gamba, itala:gamberetto, araba: جَمْبَرِي‎ (jambarī) + svahila:kamba  
**gamel** *kamelo* ← araba:جَمَل‎ (jamal), heb:גָּמָל‎ (gamál) angla:camel, deu:Kamel, hispana:camello, portugala:camelo, svahila:ngamia, oroma:gaala, volofa:geleem  
**gamia** *geedzeco* ← angla:-gamy, franca:-gamie, hispana:portugala:-gamia, rusa:-гамия (-gamiya)  
**gamo** *emocio* ← mandarena:感 (gǎn), kantona:感 (gam3), japana:感 (kan), korea:감 (gam), vjetnama:cảm  
**gan putau** *sekvinbero* ← korea:건포도 (geonpodo), mandarena:葡萄干 (pútáogān)  
**gan** *seka* ← mandarena:干 (gān), kantona:乾 (gon1), japana:乾 (kan), korea:건 (geon)  
...
**gandum** *tritiko* ← persa:گندم‎(gandom), hindia:गोधूम (godhūm), bengala:গম (gom), tamila:கோதுமை (kōtumai), teluga:గోధుమ (gōdhuma), malaja:gandum, svahila:ngano  
**gani** *kanto* ← araba: غَنَّى‎ (ḡannā) + hindia:गाना (gānā), bengala:গান (gan) + mandarena:歌 (gē), kantona:歌 (go1), japana:歌 (ka), korea:가 (ga), vjetnama:ca  
**ganja** *kanabo* ← hindia:गांजा (gāñjā), urdua:(gānjā), panĝaba:ਗਾਂਜਾ (gāñjā), bengala:গাঁজা (gañja), teluga:గంజాయి (gañjāyi), tamila:கஞ்சா (kañcā), kmera:កញ្ឆា (kɑñchaa), taja:กัญชา (gan-chaa), vjetnama:cần sa, angla:portugala:malaja:ganja, japana:ガンジャ (gānjya)  
...
**garde** *gardi* ← angla:guard, franca:garde, hispana:portugala:guarda, malaja:garda, japana:ガード (gādo), korea:가드 (gadeu), fula:garde  
**garma** *varma* ← hindia:गरम (garm), urdua:persa:گرم‎‎ (garm), kur:germ, deu:angla:warm  
**gas** *gaso* ← deu:angla:hispana:malaja:gas, portugala:gás, bengala:গ্যাস (gyas), mandarena:瓦斯 (wǎsī), kantona:瓦斯 (ngaa5 si1), japana:ガス (gasu), korea:가스 (gaseu), hindia:गैस (gais), franca:turka:gaz, rusa:газ (gaz), araba:(ḡāz), fula:gaas, svahila:gesi  
**gate** ** ← araba: قَطَعَ (qaṭa’a) + mandarena:割 (gē), kantona:割 (got3), vua:割 (ga’), japana:割 (katsu), vjetnama:cắt + hindia:काटना (kāṭnā), bengala:কাটা (kata) + tamila:கடி (kaṭi) + taja:กัด (kat) + angla:cut + svahila:-kata  
**gati** *malmola* ← teluga:గట్టి (gaṭṭi), turka:katı, hindia:कड़ा (kaṛā), japana:硬い (katai)  
**gau di** *alta* ← mandarena:高 (gāo), kantona:高 (gou1), vua:高 (kau1), japana:高 (kō), korea:고 (go), vjetnama:cao  
...
**gebre** *algebro* ← angla:deu:algebra, franca:algèbre, hispana:portugala:álgebra, rusa:алгебра (algebra) araba:persa: جَبْر‎ (jabr), turka:cebir, svahila:aljebra, malaja:aljabar  
**gee** ** ← angla:hispana:portugala:geo-, franca:géo-, rusa:гео- (geo-)  
**gei** *samseksema* ← angla:franca:hispana:gay, portugala:guei  
**gele** *ĝelo* ← angla:gel, franca:gelée, rusa:желе (žele), turka:jel, hindia:जेल (jel), korea:젤 (jel), mandarena:啫哩 (zhělī)  
...
**gense** ** ← angla:genre, franca:genre, hispana:género, portugala:gênero, persa: جنس‎ (jens), araba: جِنْس‎ (jins), fula:haŭsa:svahila:jinsi, turka:cins, japana:ジェンダー (jendā)  
...
**ging** ** ← mandarena:經 (jīng), kantona:經 (ging1), japana:經 (kei), korea:경 (gyeong), vjetnama:kinh  
**gingam** ** ← kantona:柑橘 (gam1gwat1), mandarena:金橘 (jīnjú), japana:キンカン (kinkan), korea:금귤 (geumgyul), vjetnama:kim quất, angla:hispana:franca:kumquat, portugala:cunquate, rusa:кумкват (kumkvat), turka:kumkat, araba:كمكوات (kamakawat), malaja:kumkuat  
**ginge** *zingibro* ← angla:ginger, franca:gingembre, hispana:gengibre, portugala:jengibre, mandarena:姜 (jiāng), kantona:薑 (goeng1), vjetnama:gừng, korea:생강 (saenggang), tamila:இஞ்சி (inji), araba: زنجبيل‎ (zanjabīl), persa: زنجبیل‎ (zanjebil), turka:zencefil  
**giota** ** ← taja:หยด (yòt), vjetnama:giọt, + angla:iota, rusa:йота (yota) + hispana:portugala:gota  
**gitar** *gitaro* ← angla:guitar, franca:guitare, hispana:portugala:guitarra, rusa:гитара (gitara), araba:(qīṯāra), hindia:गिटार (giṭār), bengala:গিটার (giṭar), mandarena:吉他 (jítā), kantona:結他 (git6taa1), japana:ギター (gitā), korea:기타 (gita), svahila:gitaa  
**glas** *vitro* ← deu:Glas, angla:glass + persa: گیلاس‎ (gilâs), hindia:गिलास (gilās), bengala:গ্লাস (glaś), japana:グラス (gurasu), korea:글라스 (geullaseu), malaja:gelas, svahila:glasi, haŭsa:gilashi + rusa:глазурь, hispana:glasear  
**glis** ** ← franca:glisser, itala:glissare + angla:glacier,glissando, hispana:portugala:glaciar,glisando, rusa:глиссандо (glissando), araba:غليساندو (ghlysandw), japana:グリッサンド (gurissando) + malaja:gelangsar  
**glute** *gluo* ← angla:glue, svahila:gluu, malaja:glu + hispana:franca:gluten, portugala:glúten, rusa:глютен (glyuten), araba: غْلُوتِين‎ (ḡlūtīn), japana:グルテン (guruten)  
**gogia** *lando* ← mandarena:国家 (guójiā), kantona:國家 (gwok3 gaa1), japana:国 (koku); 国家 (kokka), korea:국가 (gukga), vjetnama:quốc gia  
...
**gomu** *kaŭĉuko* ← franca:gomme, hispana:filipina:goma, japana:ゴム (gomu), korea:고무 (gomu) + angla:gum, deu:Gummi + hindia:गम (gam), bengala:গাম (gam)  
**gone** *angulo* ← hindia:कोण (koṇ), teluga:(kōnamu), svahila:kona, angla:corner; -gon, haŭsa:kwana, franca:-gone, hispana:portugala:-gono  
**gorila** ** ← angla:gorilla, franca:gorille, hispana:portugala:malaja:gorila, rusa:горилла (gorilla), araba:غوريلا (ḡūrīlā), japana:ゴリラ (gorira), korea:고릴라 (gorilla), vjetnama:gôrila, hindia:गोरिल्ला (gorillā), bengala:গরিলা (gôrila), tamila:கொரில்லா (korillā)  
...
**grafe** *bildo (desegnaĵo)* ← angla:graphic, deu:Grafik, franca:graphique, hispana:portugala:gráfico, rusa:графика (grafika), japana:グラフィック (gurafikku), korea:그래픽 (geuraepik)  
**gram** *gramo* ← angla:gram, deu:Gramm, franca:gramme, hispana:gramo, portugala:grama, rusa:грамм (gramm), persa: گرم‎ (geram), hindia:ग्राम (grām), bengala:গ্রাম (gram), araba: غْرَام‎ (ḡrām), fula:giram, svahila:gramu, japana:グラム (guramu), korea:그램 (geuraem), vjetnama:gam, malaja:turka:gram  
**gran** ** ← angla:franca:grain, hispana:grano, portugala:grão + rusa:гранит (granit), turka:vjetnama:malaja:granit, araba:جرانيت (jaraniat), hindia:ग्रेनाइट (grenait)  
...
**gros** ** ← franca:gros, portugala:grosso + hispana:grosero, angla:gross  
...
**gua** *kaverno* ← bengala:গুহা (guha), hindia:गुफ़ा (gufā), tamila:குகை (kukai), teluga:గుహ (guha), malaja:gua, taja:คูหา (gūhā)  
**guai** *stranga* ← mandarena:怪 (guài), kantona:怪 (gwaai3), japana:怪 (kai), korea:괴 (goe), vjetnama:quái  
**guan** ** ← mandarena:官 (guān), kantona:官 (gun1), japana:官 (kan), korea:관 (gwan), vjetnama:quan  
**guan** ** ← mandarena:宽 (kuān);  広 (guǎng), kantona:廣 (gwong2), vjetnama:quảng, taja:กว้าง (kwang)  
**Guangzou** ** ← CN  
**gubu** *hipopotamo* ← fula:ngabbu konga:ngubu, sot:tsw:kubu, zulua:rwa:imvubu, amharaba:ጉማሬ (gumare)  
**gui** *ogro (trolo)* ← mandarena:鬼 (guǐ), vjetnama:quỷ, + taja:กุ๊ย (gui)  
**guku hua** ** ← mandarena:菊 (jú), kantona:菊 (guk1), japana:キク (kiku), korea:국화 (gukhwa), vjetnama:cúc đại đóa, taja:เก๊กฮวย (gék-huai), malaja:kekwa, araba:قحوان (quḥwān)  
**gul** *gluti* ← bengala:গেলা (gela), portugala:engolir, rusa:глотать (glotat'), taja:กลืน (glʉʉn), hispana:deglutir, franca:déglutir  
**gule** ** ← araba:الغول (ghūl), persa:غول‎ (ğul), angla:portugala:ghoul, hispana:gul, rusa:гуль (gul′), turka:kulbastı, malaja:ghul, japana:グール (gūru), haŭsa:gwal  
**guma** *tamburo* ← svahila:ngoma, rwa:ingoma + mandarena:鼓 (gǔ)  
**guru** *guruo (instruisto)* ← hindia:गुरु (guru), bengala:গুরু (guru), tamila:குரு (kuru), filipina:guro, taja:ครู (gruu), malaja:angla:portugala:guru, hispana:gurú, rusa:гуру (guru), franca:gourou, korea:구루 (guru), japana:グル (guru)  
...
**ha** *havi* ← angla:have, franca:avoir, hispana:hay  
**habar** *novaĵoj* ← araba: خَبَر‎ (xabar), persa: خبر‎ (xabar), hindia:ख़बर (xabar), bengala:খবর (khôbôr), tamila:கபர் (kapar), malaja:kabar, turka:haber, svahila:habari, haŭsa:labari, joruba:làbarè, fula:kibaaru  
**hafenium** *hafnio* ← angla:hafnium, franca:hafnium, hispana:hafnio, portugala:háfnio, rusa:гафний, mandarena:铪 (hā), japana:ハフニウム, korea:하프늄, vjetnama:hafini, hindia:हाफ्नियम, bengala:হাফনিয়াম, malaja:hafnium, svahila:hafni, araba: هفنيوم  
**hafiz-** ** ← araba:(ḥafiẓa), persa:urdua:(hāfiz), turka:muhafaza, hindia:हाफ़िज़ (hāfīz), svahila:hifadhi  
...
**haima** *tendo* ← araba:(xayma), haŭsa:laima, hindia:ख़ैमा (xEmā), svahila:hema, malaja:kemah, may:khemah, mng:майхан (mayhan)  
**haje** *pilgrimo* ← araba: حَجّ‎ (ḥajj), persa: حج‎ (hajj), turka:hac, svahila:hija, haŭsa:haji, fula:hajju  
**hake** *rajto* ← araba: حَقّ‎ (ḥaqq), hindia:हक़ (haq), bengala:হক (hôk), panĝaba:ਹੱਕ (hakka), teluga:హక్కు (hakku), turka:malaja:hak, svahila:haki, haŭsa:hakki, fula:haƙƙe  
**haki** *polvo* ← persa: خاک (xâk), hindia:ख़ाक (xāk), bengala:খাক (khâk), turka:haki, angla:khaki, franca:kaki, hispana:caqui, portugala:cáqui, rusa:хаки (haki), mandarena:卡其 (kǎqí), kantona:卡其色 (kaakeisik), japana:カーキ色 (kāki-iro), korea:카키색 (kakisaek), vjetnama:màu kaki  
**hal** *stato* ← araba:حال (ḥāl), hindia:हालत (hālat), svahila:haŭsa:hali, fula:haala; alhaali, turka:hâl  
**halal** ** ← araba:(ḥalāl), persa:urdua:(halāl), angla:hispana:franca:portugala:malaja:haŭsa:halal, turka:helal, rusa:халяльный (xaljalʹniy), hindia:हलाल (halāl), svahila:halali, korea:할랄 (hallal)  
**halela** ** ← heb:(hal'lu yah), angla:hallelujah, mandarena:哈利路亚 (hālìlùyà), araba:(hallilūyā), portugala:franca:alléluia, rusa:аллилуйя (alliluyya), hispana:aleluya, svahila:malaja:haleluya, filipina:aleluya, japana:ハレルヤ (hareruya), korea:할렐루야 (hallelluya)  
...
**halife** *kalifo* ← araba: خَلِيفَة‎ (ḵalīfa), angla:caliph, franca:calife, hispana:portugala:califa, rusa:халиф (khalif), hindia:ख़लीफ़ा (xalīfā), bengala:খলিফা (khôlipha), tamila:கலீஃப் (kalīph), malaja:khalifah, svahila:halifa, haŭsa:khalifa, mandarena:哈里发 (hālǐfā), japana:ハリーファ (harīfā), korea:칼리파 (kallipa), turka:halife, fula:kaliifa  
...
**halte** *halto* ← deu:angla:halt, franca:halte, hispana:portugala:alto, malaja:halte  
**ham di** *grava* ← araba: هَامّ (hāmm), hindia:अहम (aham), urdua: اہم (aham), svahila:muhimu, turka:mühim, persa:(mohemm), haŭsa:muhimmi  
...
**harabe** *ruinigita* ← araba:persa:urdua:(xarāb), turka:harap, hindia:ख़राब (xarāb), bengala:খারাপ (kharap), svahila:-haribu  
**haram** ** ← araba:(ḥarām), fula:haŭsa:malaja:turka:angla:deu:haram, hindia:हराम (harām), korea:하람 (haram), persa:urdua:(harām), svahila:haramu, mandarena:哈拉姆 (hālāmǔ), rusa:харамный (xaramniy)  
...
**hata** *ĝis* ← portugala:até, araba:(ḥatta), hispana:hasta, svahila:hata, haŭsa:hatta, fula:haa + persa: تا‎ (tâ), hindia:तक (-tak)  
...
**hau** *bona* ← mandarena:好 (hǎo), kantona:好 (hou2), vjetnama:hảo  
**hava** *vento* ← araba: هَوَاء‎ (hawāʾ), persa: هوا‎ (havâ), hindia:हवा (havā), bengala:হাওয়া (hava), malaja:hawa, svahila:hewa, turka:hava  
**haxi** *haŝio (kvajzo)* ← japana:箸 (hashi), bengala:হাশি (haśi), guĝarata:હાશી (hāśī), portugala:hashi  
**haxix** ** ← araba: حَشِيش (ḥašīš), angla:hashish, franca:haschich, portugala:haxixe, rusa:гашиш (gašiš), japana:ハシシ (hashishi), korea:해시시 (haesisi), hindia:हशीश (haśīś), malaja:hasyis  
**hazin** ** ← araba: خَزَنَ‎ (xazana) + persa: خزینه‎ (xazine), hindia:ख़िज़ाना (xizānā), rusa:казна (kazna), svahila:hazina + angla:magazine, hispana:almacén, portugala:armazém, turka:hazine; mahzen  
**he** *ĉu?* ← angla:huh, franca:hein, portugala:hã, vjetnama:hả, deu:hä + mandarena:何 (hé)  
**hei** ** ← angla:hey, franca:hé, hispana:hey, portugala:ei, rusa:эй (ey), mandarena:喂 (wèi), vjetnama:ê; ơi, persa: هی‎ (hey), fula:héé  
**helium** *helio* ← angla:helium, franca:hélium, hispana:helio, portugala:hélio, rusa:гелий, mandarena:氦 (hài), japana:ヘリウム, korea:헬륨, vjetnama:svahila:heli, hindia:हिलियम, bengala:হিলিয়াম, malaja:helium, araba: هيليوم  
**helix** ** ← greka: ἕλιξ (helix), angla:helix, franca:portugala:hispana:hélice, polona:helisa, araba:(ḥalazūn), turka:helezon  
**heme** *sango* ← angla:hispana:portugala:malaja:vjetnama:turka:hemo-, franca:hémo-, rusa:гемо- (gemo-), japana:ヘモ- (hemo-)  
**hem…** *hm…* ← angla:hmm, rusa:хм (hm), эм (em), korea:음 (eum)  
**hen** *malamo* ← mandarena:恨 (hèn), kantona:恨 (han6), vua:恨 (hhen3), vjetnama:hận, korea:한  (han) + japana:嫌 (ken) + franca:haine  
**hena** ** ← araba: حِنَّاء‎ (ḥinnāʾ), angla:henna, deu:Henna, franca:henné, hispana:alheña, portugala:hena, rusa:хна (hna), persa:حنا‎ (hanâ), hindia:हिना (hinā), turka:kına  
**hepate** ** ← mandarena:肝 (gān), kantona:肝 (gon1), vua:肝 (koe1), korea:간 (gan), japana:肝臓 (kanzō), vjetnama:gan + svahila:ini  
...
**hesium** *hasio* ← angla:hassium, franca:hassium, hispana:hasio, portugala:hássio, rusa:хассий, mandarena: (hēi), japana:ハッシウム, korea:하슘, vjetnama:hassi, hindia:हसियम, bengala:হ্যাসিয়াম, malaja:hassium, svahila:hassi, araba: هاسيوم  
**hevan** *besto* ← araba: حَيَوَان‎ (ḥayawān), persa: حیوان‎ (heyvân), hindia:हैवान (haivān), malaja:kewan, turka:hayvan, svahila:hayawani, fula:hayawan  
**hibride** *miksulo* ← angla:hybrid, hispana:portugala:híbrido, franca:hybride, rusa:гибрид (gibrid)  
**hidrargente** ** ← svahila:hidrajiri  
**hidre** *hidrogeno* ← angla:franca:hydro-, hispana:portugala:malaja:svahila:hidro-, vjetnama:hyđrô, araba: هيدروجين  
**hijabu** ** ← araba:(ḥijāb), persa:(hejâb), svahila:hijabu, haŭsa:hijabi, hindia:हिजाब (hijāb), bengala:হিজাব (hijab), angla:portugala:hijab, franca:hidjab, hispana:hiyab, rusa:хиджаб (xidžab)  
**hima** *neĝo* ← hindia:हिमपात (himpāt), taja:หิมะ (hima), teluga:(himamu)  
**hin** *sen (manki)* ← hindia:-हीन (hīn), bengala:-হীন (-hin), guĝarata:-હીન (-hīn)  
**hindium** *indio* ← angla:indium, franca:indium, hispana:indium, portugala:índio, rusa:индий, mandarena:铟 (yīn), japana:インジウム, korea:인듐, vjetnama:indi, hindia:इण्डियम, bengala:ইন্ডিয়াম, malaja:indium, svahila:indi, araba: انديوم  
**hisabe** *kalkuli* ← araba: حِسَاب‎ (ḥisāb), hindia:हिसाब (hisāb), bengala:হিসাব (hiśab), turka:hesap, oroma:hisaaba, svahila:hisabu, haŭsa:lisafi, fula:hiisa  
**histor** *historio* ← angla:history, hispana:svahila:historia, portugala:história, franca:histoire, rusa:история (istoriya)  
...
**hol** ** ← angla:whole; all; holo-, deu:franca:hispana:portugala:holo-, rusa:голо- (golo-); хол- (hol-), japana:ホログ- (holo-), korea:홀로- (hollo-) + araba: كُلّ‎ (kull)  
**holera** ** ← angla:cholera, hispana:portugala:cólera, franca:choléra, rusa:холера (holera), turka:kolera, araba:كُولِيرَا‎ (kōlīrā), hindia:कॉलरा (kŏlrā), mandarena:虎列拉 (hǔlièlā), japana:コレラ (korera), haŭsa:kwalara  
**holmium** *holmio* ← angla:holmium, franca:holmium, hispana:holmio, portugala:hólmio, rusa:гольмий, mandarena:钬 (huǒ), japana:ホルミウム, korea:홀뮴, vjetnama:honmi, hindia:होल्मियम, bengala:হলমিয়াম, malaja:holmium, svahila:homi, araba: هلميوم  
**hore** ** ← angla:hispana:portugala:horror, franca:horreur, japana:ホラー (horā), korea:호러 (horeo)  
...
**hotel** *hotelo* ← angla:deu:hispana:portugala:malaja:hotel, franca:hôtel, hindia:होटल (hoṭal), bengala:হোটেল (hoṭel), tamila:ஹோட்டல் (hottal), japana:ホテル (hoteru), korea:호텔 (hotel), rusa:отель (otel), svahila:hoteli, haŭsa:otal  
**hua** *floro* ← mandarena:花 (huā), kantona:花 (faa1), vjetnama:hoa, korea:화 (hwa) + svahila:ua  
**huang** *flava* ← mandarena:黄 (huáng), kantona:黃 (wong4), vua:黃 (húan), vjetnama:vàng  
...
**humel** *lupolo* ← rusa:хмель (hmel'), persa: خمل‎ (xemel) + franca:houblon  
...
**hura** ** ← rusa:ура (ura), itala:urrà, deu:hispana:hurra, franca:hourra, angla:hurrah, malaja:hore, persa:(hurâ)  
**hure** *libera* ← araba: حر (ḥurr), turka:hür, svahila:huru, hispana:horro, portugala:forro  
...
**idee** *ideo* ← angla:hispana:idea, franca:idée, deu:Idee, portugala:ideia, rusa:идея (ideya), malaja:ide, japana:アイデア (aidea), korea:아이디어 (aidieo), vjetnama:ý định  
**idiote** ** ← angla:deu:franca:malaja:idiot, hispana:portugala:idiota, rusa:идиот (idiot)  
**ifrite** ** ← araba:عِفْرِيت‎ (ʿifrīt), angla:hispana:portugala:franca:turka:malaja:ifrit, deu:Ifrit, rusa:ифрит (ifrit), japana:イフリート (ifuriito)  
**iglu** *iglo* ← angla:igloo, franca:iglou, hispana:iglú, portugala:turka:malaja:iglu, rusa:иглу (iglu), hindia:इग्लू (iglū), japana:イグルー (igurū), korea:이글루 (igeullu)  
**iha** *azeno* ← onom. angla:heehaw, franca:hi-han, rusa:и-а (i-a), vjetnama:hô hố, turka:aa-i  
**ilme** ** ← araba: عِلْم‎ (ʕilm), persa: علم‎ ('elm), hindia:इल्म (ilm), bengala:এলেম (elem), malaja:fula:ilmu, haŭsa:ilmi, svahila:elimu, turka:ilim  
**imperia** *keisarikunta* ← angla:franca:empire, hispana:imperio, portugala:império, rusa:империя (imperiya), araba:(ʾimbirāṭūriyya), turka:imparatorluk  
...
**intraje** ** ← hindia:आंत्र (åntra), bengala:অন্ত্র (antra), pan:ਆਂਦਰਾਂ (āndarā̃) + franca:entrailles, angla:entrails, hispana:entrañas, portugala:entranhas  
...
**jamia** ** ← araba: جَمَعَ‎ (jamaʿa), svahila:jamii, turka:camia, persa: جمع (jam’), haŭsa:jam'iyya + hindia:जमात (jamāt)  
**jampe** *salti* ← angla:jump, japana:ジャンプ (janpu), korea:점프 (jŏmp), bengala:ঝাঁপ (jhãpô), ass:জাঁপ (zãp)  
**jamul** ** ← hindia:जामुन (jāmun), angla:jambul, portugala:jambolão, araba:جَمُّون (jammūn), svahila:zambarau  
**jan** ** ← hindia:ध्यान (dhyān), bengala:ধ্যান (dhyān), japana:禅 (zen), angla:franca:portugala:zen, rusa:дзэн (dzen), mandarena:禅 (chán), korea:선 (seon), vjetnama:thiền, birma:ဈာန် (jhan)  
**janela** *fenestro* ← portugala:janela, bengala:জানালা (janala), tamila:ஜன்னல் (jaṉṉal), malaja:jendela  
**jang suta** ** ← mandarena:武术 (wǔshù), japana:武術 (bujutsu), vjetnama:võ thuật, korea:무술 (musul), angla:martial art  
**jang** *milito (batalo)* ← persa: جنگ (jang), hindia:जंग (jang), bengala:জঙ্গ (jôṅg), turka:cenk + mandarena:仗 (zhàng); 爭 (zhēng), kantona:争 (zang1), korea:전쟁 (jeonjaeng), vjetnama:(chiến) tranh + malaja:juang  
**jangal** *arbaro* ← angla:franca:jungle, hispana:jungla, portugala:jângal, rusa:джунгли (džungli), hindia:जंगल (jangal), bengala:জঙ্গল (jônggôl), malaja:jenggela, japana:ジャングル (janguru), korea:정글 (jeonggeul), turka:cengel  
**jara** *kruĉo* ← araba: جَرَة‎ (jara), angla:jar, franca:jarre, hispana:portugala:jarra  
**jaru** *balailo* ← hindia:झाड़ू (jhāṛū), bengala:ঝাড়ু (jhaṛu) + korea:빗자루 (bitjaru)  
**jau** *hordeo* ← hindia:जौ (jau), bengala:যব (jôb), marataja:जव (jav), guĝarata:જવ (jav), persa: جو‎ (jow)  
**javabe** *respondi* ← araba: جَوَاب‎ (jawāb), hindia:जवाब (javāb), malaja:jawab, fula:jaabaade, svahila:jibu,jawabu, turka:cevap  
**jebe** *poŝo* ← araba: جَيْب‎ (jayb), persa: جیب‎ (jib), hindia:जेब (jeb), panĝaba:ਜੇਬ (jeb), teluga:(jēbu), turka:cep, portugala:algebeira, fula:jeyba, haŭsa:aljihu, ful:jiiba, volofa:jiba, amhara:ጅብ (ǧəb)  
**jeka na** ** ← mandarena:借 (jiè), kantona:借 (ze3), japana:借 (shaku), korea:적 (jeok) + angla:check  
**jeka** ** ← mandarena:借 (jiè), kantona:借 (ze3), vua:借 (jia2), japana:借 (shaku), korea:적 (jeok) + angla:check  
**jele** *malliberigi* ← angla:jail, franca:geôle, hindia:जेल (jel), bengala:জেল (jēl), teluga:జైలు (jailu), svahila:jela + hispana:portugala:jaula  
**jen** *persono* ← mandarena:人 (rén), wuu人 (zén), japana:人 (jin) + franca:gens, hispana:portugala:gente + hindia:जन (jan), bengala:-জন (-jôn), malaja:-jana, taja:ชน (chon), kmera:ជន (jon)  
**jenju** *perlo* ← mandarena:珍珠 (zhēnzhū), kantona:珍珠 (zan1 zyu1), japana:真珠 (shinju), korea:진주 (jinju), vjetnama:trân châu, rusa:жемчуг (žemčug), turka:inci,incü  
**jensen** ** ← mandarena:人蔘 (rénshēn), mina:人蔘 (jîn-sam), angla:hispana:portugala:turka:malaja:ginseng, rusa:женьшень (zhen’shen’), hind:जिनसेंग (jinseṅg), japana:人参 (ninjin)  
...
**jihade** ** ← araba: جهاد (jihād), turka:cihat, fula:jihaadi, svahila:jihadi + angla:franca:portugala:malaja:jihad, hispana:yihad, rusa:джихад (džihad), japana:ジハード (jihādo), korea:지하드 (jihadeu), hindia:जिहाद (jihād)  
**jin** ** ← araba: جِنّ (jinn), fula:volofa:jinne, svahila:jini, man:jinnoo, rusa:джинн (džinn) + angla:genie, franca:génie, hispana:genio, portugala:gênio + hindia:जान (jān), bengala:জান (jan), turka:can  
**jiva** *vivi (viva; vivo)* ← hindia:जीव (jīv), bengala:জীউ (jiu), teluga:జీవము (jīvamu), malaja:jiwa, taja:ชีวิต  (chiwit), birma:ဇီဝ (jiwa), kmera:ជីវិត (jĭvit), rusa:живой (živoy), polona:żywy  
...
**jube** *robo* ← araba: جُبَّة (jubba), svahila:juba, malaja:jubah, hispana:aljuba, portugala:gibão, franca:jupon, rusa:жупан (župan)  
**judau** *ĵudo* ← mandarena:柔道 (róudào), japana:柔道 (jūdō), korea:유도 (yudo), vjetnama:nhu đạo, angla:deu:franca:hispana:portugala:malaja:turka:svahila:judo, rusa:дзюдо (dzyudo), araba: جُودُو‎ (jūdū), persa: جودو‎ (judo), hindia:जूदो (jūdo)  
**jude** *juĝi* ← angla:judge, franca:juge, hispana:juez, portugala:juiz, hindia:जज (jaj), bengala:জজ (jôj), svahila:jaji, fula:juuju + rusa:судья (sud'ya)  
**jumla** ** ← araba:(jumla), turka:cümle, hindia:जुमला (jumlā), mandarena:句 (jù)  
**jun** *juna* ← angla:franca:malaja:junior + hispana:joven, portugala:jovem, persa: جوان‎ (javân), hindia:जवान (javān) + korea:젊다 (jeomda)  
**jung** ** ← mandarena:種 (zhǒng), kantona:種 (zung2), vua:種 (tson2), japana:種 (shu), korea:종 (jong), vjetnama:chủng  
...
**kabile** *tribo* ← araba: قَبِيلَة‎ (qabīla), persa: قبیله‎ (qabile), hindia:क़बीला (qābilā), turka:kabile, fula:ƙabiila, svahila:haŭsa:kabila  
...
**kafe** *kafo* ← deu:Kaffee, franca:hispana:portugala:café, rusa:кофе, mandarena: 咖啡 (kāfēi), kantona:咖啡 (gaa3 fe1), angla:coffee, hindia:काफ़ी (kāfī), bengala:কফি (kôphi), turka:kahve, haŭsa:kofi, fula:kafe  
**kafir** ** ← araba:(kāfir), persa:(kāfer), turka:franca:kâfir, fula:keefeero, joruba:kaferi, svahila:haŭsa:kafiri, malaja:kafir, rusa:кафир (kafir), hindia:काफ़िर (kāfir)  
...
**kaju** *akaĵuo* ← franca:cajou, hispana:cajú, portugala:caju, angla:cashew, deu:Kaschu, hindia:काजू (kājū), bengala:কাজু (kaju), araba: كَاجُو‎ (kājū), fula:kasu, malaja:gajus, turka:kaşu, japana:カシュー (kashū), korea:캐슈 (kaesyu)  
**kaka** *feko* ← hispana:portugala:franca:caca, deu:Kacke, araba:(kākā), turka:kaka, rusa:кака (kaka), persa:(kake)  
**kakau** *kakao* ← portugala:cacau, araba:(kākāw), hispana:cacao, angla:cocoa, rusa:какао (kakao), japana:カカオ (kakao), mandarena:可可 (kěkě), kantona:唂咕 (guk1gu2), vjetnama:cacao, fula:kokko, svahila:kakao  
...
**kal** *kia* ← angla:quality, deu:Qualität, franca:qualité, hispana:calidad, portugala:qualidade, turka:kalite, malaja:kualitas  
**kala** *nigra* ← hindia:काला (kālā); कारौ (kārau), bengala:কালো (kalo), panĝaba:ਕਾਲਾ (kālā) + tamila:கருப்பு (karuppu) + turka:kara, kaz:қара (qara)  
...
**kalende** *kalendaro* ← angla:calendar, franca:calendrier, hispana:portugala:calendario, rusa:календарь (kalendar’), deu:malaja:kalender, japana:カレンダー (karendā), korea:카렌더 (karendeo), hindia:कैलेण्डर (kaileṇḍar), svahila:kalenda, haŭsa:kalanda  
**kali** *alkala* ← araba: قلي (qily), svahila:-kali + angla:alkali, franca:alcali, hispana:portugala:álcali, japana:アルカリ (arukari), korea:알칼리 (alkalli), malaja:alkali  
**kalifornium** *kaliforniumo* ← angla:californium, franca:californium, hispana:californio, portugala:califórnio, rusa:калифорний, mandarena:锎 (kāi), japana:カリホルニウム, korea:칼리포르늄, vjetnama:califoni, hindia:कैलीफोर्नियम, bengala:ক্যালিফোর্নিয়াম, malaja:kalifornium, svahila:kalifoni, araba: كاليفورنيوم  
**kalium** *kalio* ← rusa:калий, japana:カリウム, vjetnama:kali, malaja:kalium, svahila:kali  
**kalkul** ** ← franca:calcul, hispana:cálculo, angla:calculus, hindia:कलन (kalan)  
**kalmar** ** ← greka:καλαμάρι (kalamári), hispana:portugala:calamar, franca:calmar, itala:angla:calamari, rusa:кальмар (kal’mar), turka:kalamar, araba:كلاماري‎ (klamāri)  
**kalsium** *kalcio* ← angla:calcium (Ca), franca:calcium, hispana:calcio, portugala:cálcio, rusa:кальций, mandarena:钙 (gài), japana:カルシウム, korea:칼슘, vjetnama:canxi, hindia:कैल्शियम, bengala:ক্যালসিয়াম, malaja:kalsium, svahila:kalisi, araba: كلسيوم  
**kam** *malmulte* ← deu:kaum + persa: کم‎ (kam), hindia:कम (kam), bengala:কম (kôm) + kantona:減 (gaam2), japana:減 (-gen), korea:감 (gam), vjetnama:giảm  
**kama** ** ← hindia:काम (kām), bengala:কাম (kam), taja:กาม (gaam)  
**kamar** *ĉambro* ← malaja:kamar, portugala:câmara, hindia:कमरा, (kamrā), deu:Kammer, rusa:камера (kamera)  
**kamil** ** ← deu:Kamille, angla:camomile, portugala:camomila, franca:camomille, japana:カモミール (kamomīru), malaja:kamomil  
...
**kan** *farejo* ← persa:خانه‎ (xâne), rusa:-хана (-hana), hindia:ख़ाना (xānā), bengala:খানা (khana), svahila:karakana, turka:hane + mandarena:馆 (guǎn), kantona:館 (gun2), korea:관 (gwan), japana:館 (-kan), vjetnama:quán  
...
**kanse** *kancero* ← angla:franca:cancer, hispana:cáncer, portugala:câncer, hindia:कैंसर (kainsar), bengala:ক্যান্সার (kênsar), turka:kanser, svahila:kansa, japana:癌 (gan)   
...
**kapa** ** ← deu:Kopf, hispana:cabeza; cabo, portugala:cabeça; cabo, malaja:kepala + hindia:कपाल (kapāl) + angla:cape, franca:cap + kantona:岬 (gaap3), korea:갑 (gap)  
**kape** *kapti* ← turka:kapmak, hungara:kap, hispana:portugala:caber; capturar, angla:capture  
**kar** ** ← persa: کار (kâr), hindia:कार (kār), कार्य (kārya), bengala:কাজ (kaj), malaja:karya,kerja + svahila:kazi  
**karavi** *karvio* ← araba:(karāwiya), angla:caraway, franca:carvi, hispana:alcaravea, portugala:alcaravia  
**karbau** ** ← hispana:carabao, malaja:kerbau, jav:kebo, kmera:ក្របី (krɑbəy)  
**karbe** *karbono* ← angla:carbon, franca:carbone, hispana:carbón, portugala:carbono, vjetnama:cacbon, hindia:कार्बन, bengala:কার্বন, malaja:karbon, svahila:kaboni, araba: كربون  
**karcof** ** ← araba: خرشوف (kharshuf), amhara:ከርቹፍ (kärčuf), hispana:alcachofa, portugala:alcachofra, malaja:kharsyuf, polona:karczoch  
**kardon** ** ← hispana:portugala:cardo, franca:chardon, angla:cardoon, japana:カルドン (karudon)  
**karga** ** ← hispana:portugala:carga, angla:cargo, malaja:kargo  
...
**kari** *kareo* ← angla:franca:portugala:curry, hispana:curri, rusa:карри (karri), mandarena:咖喱 (kālǐ), kantona:咖喱 (gaa3lei1), japana:カレー (karē), korea:커리 (keori), vjetnama:cà ri,hindia:करी (karī), bengala:কারি (kari), malaja:kari, araba: كَارِي‎ (kārī)  
...
**karote** *karoto* ← angla:carrot, franca:carotte, deu:Karotte, fula:svahila:karoti, haŭsa:karas, amharaba:ካሮት (karot), malaja:karot, vjetnama:cà rốt, tamila:காரட் (kāraṭ)  
**karta** *karto* ← angla:card, franca:carte, hispana:portugala:carta, deu:Karte, rusa:карта (karta), turka:kart, fula:kartal, svahila:kadi, haŭsa:karta, hindia:कार्ड (kārḍa), bengala:কার্ড (kārḍa), malaja:kartu, mandarena:卡 (kǎ), kantona:卡 (kaa1), japana:カード (kādo), korea:카드 (kadeu)  
**karte** *mapo* ← angla:chart, franca:carte, hispana:portugala:carta, rusa:карта (karta), araba: خَرِيطَة‎ (ḵarīṭa), turka:harita  
**kartux** ** ← franca:cartouche, hispana:portugala:cartucho, hindia:कारतूस (kārtūs), araba: خَرْطُوش‎ (ḵarṭūš), fula:kartus, turka:hartuç  
**karuba** ** ← araba: خَرُّوب‎ (ḵarrūb), angla:carob, franca:caroube, hispana:algarrobo, portugala:alfarroba  
...
**kase** ** ← lat:capsa, deu:Kasse, angla:case, franca:caise, hispana:caja, portugala:caixa, rusa:касса (kassa), svahila:kasha, fula:keesu + araba:(qafaṣ), hindia:क़फ़स (qafas), turka:kafes + mandarena:卡式 (kǎshì), kantona:卡式 (kaa1sik1), japana:カセット (kasetto), korea:카세트 (kaseteu), haŭsa:kaset  
**kaska** ** ← franca:casque, hispana:cáscara, portugala:casca, fula:kaske + nan:殼 (kag4), vua:殼 (khoq4), japana:殻 (kaku)  
**kastana** *kaŝtano* ← deu:Kastanie, hispana:castaňa, portugala:castanha, rusa:каштан (kaštan), persa: کستانه‎ (kastâne), araba: كَسْتَنَاء‎ (kastanāʔ), turka:kestane  
...
**katil** *lito* ← tamila:கட்டில் (kaṭṭil), malaja:katil, hindia:खाट (khāṭ), angla:cot, hispana:portugala:catre  
**katus** *kaktuso* ← angla:hispana:portugala:franca:cactus, deu:Kaktus, rusa:кактус (kaktus), hindia:कैक्टस (kaikṭas), turka:kaktüs, malaja:kaktus  
...
**kavai** *ĉarma* ← japana:可愛い (kawaii), korea:카와이 (kawai), angla:kawaii  
**kave** *fosi* ← hispana:portugala:cavar, angla:excavar, franca:excaver  
**ke** *kio?* ← franca:que, hispana:qué, portugala:o que + bengala:কে (ke) + mandarena:何 (hé)  
**kecape** *keĉupo* ← kantona:茄汁 (kezap), angla:franca:hispana:ketchup, portugala:catchup, rusa:кетчуп (ketčup), japana:ケチャップ (kechappu), korea:케첩 (kecheop), hindia:केचप (kecap), bengala:কেচাপ (kecap), araba: كَتْشَب‎ (katšab)  
**keci** *ĝentila* ← mandarena:客气 (kèqì), kantona:客氣 (haak3 hei3), vua:客氣 (khaq qi4)  
**keke** *kuko* ← angla:cake, rusa:кекс (keks), araba:(kaʿka), hindia:केक (kek), japana:ケーキ (kēki), svahila:keki, turka:haŭsa:kek  
**kelele** ** ← svahila:konga:makelele  
**ken** *scii aŭ koni* ← deu:kennen, angla:ken + bengala:জ্ঞান (gên) + malaja:kenal  
...
**kerubi** ** ← heb:כְּרוּב‎ (kerúv), angla:cherub, hispana:querubín, portugala:querubim, franca:chérubin, rusa:херувим (heruvim), svahila:kerubi, haŭsa:malaja:kerub, mandarena:基路伯 (jīlùbó)  
...
**keze** *fromaĝo* ← hispana:queso, portugala:queijo, malaja:keju, deu:Käse, angla:cheese, mandarena:起司 (qǐsī), kantona:知士 (zi1si62), japana:チーズ (chīzu), korea:치즈 (chijeu), hindia:चीज़ (cīz), svahila:chizi  
...
**kirate** ** ← araba: قِيرَاط‎ (qīrāṭ), angla:franca:carat, hispana:portugala:quilate, rusa:карат (karat), mandarena:克拉 (kèlā), japana:カラット (karatto), korea:캐럿 (kaereot), malaja:haŭsa:karat, svahila:karati, turka:kırat  
...
**kitabe** *skribo* ← araba: كِتَاب‎ (kitāb), persa: کتاب‎ (ketâb), hindia:किताब (kitāb), turka:kitap; katip, malaja:kitab, katib, svahila:kitabu; katibu, haŭsa:littafi  
...
**klas** ** ← angla:class, hispana:clase, portugala:franca:classe, rusa:класс (klass), کلاس‎ (kelâs), malaja:kelas, japana:クラス (kurasu), fula:kalaas  
**klien** ** ← angla:client, hispana:portugala:franca:cliente, rusa:клиент (klient), japana:クライアント (kuraianto), malaja:klien  
**klike** ** ← angla:click, hispana:clic, portugala:clicar, franca:claquer, hindia:क्लिक (klika), bengala:ক্লিক (klika), malaja:klik, japana:クリック (kurikku)  
...
**klon** *klono* ← angla:portugala:franca:clone, hispana:clon rusa:клон (klon), deu:malaja:turka:klon, may:klon, mandarena:克隆 (kèlóng), japana:クローン (kurōn)  
...
**kluze** ** ← angla:franca:hispana:portugala:-clus-, rusa:ключить (-klyučítʹ)  
**koala** *koalo* ← angla:franca:hispana:vjetnama:malaja:svahila:turka:koala, portugala:coala, rusa:коала (koala), mandarena:考拉 (kǎolā), kantona:考拉 (haau2laa1), japana:コアラ (koara), korea:코알라 (koalla), araba: كُوَالَا‎ (kuwalā), hindia:कोअला (koalā), bengala:কোয়ালা (koẏala)  
...
**koko** *koko* ← franca:coq, angla:cock, polona:kogut, hindia:कुक्कुट (kukkuṭ) + svahila:kuku, zulua:inkukhu, igba:Ọkụkọ + (onom.) itala:coccodè, japana:コッコッ (kokko), persa:(qod-qod-qodās), rusa:куд-куда  
**kola** ** ← angla:hispana:cola, rusa:кола (kola), hindia:कोला (kolā), japana:コラ (kora), svahila:mkola, fula:ngoro, haŭsa:gworo, volofa:goro  
...
**kolone** ** ← angla:colony, hispana:colonia, portugala:colônia, rusa:колония (koloniya), turka:ma:koloni, hindia:कॉलोनी (kŏlonī), japana:コロニー  
...
**komike** ** ← angla:comic, franca:comique, hispana:portugala:cómico + rusa:комедия (komedija), japana:コメディ (komedi), korea:코미디 (komidi)  
**kompani** *kompanio (firmao)* ← angla:company, hindia:कंपनी (kampanī), rusa:компания (kompaniya), filipina:kompanya, polona:kompania  
**kon** *kun (kuna, komuna)* ← angla:con-; common, franca:con-; commun, hispana:con-; común, portugala:con-; comum, rusa:кон- (kon-) + mandarena:共 (gòng), kantona:共 (gung), korea:공 (gong), vjetnama:cộng  
...
**konu** *konuso* ← angla:portugala:cone, franca:cône, hispana:cono, rusa:конус, malaja:kon, svahila:turka:koni  
**kopernium** *kopernicio* ← angla:franca:copernicium, hispana:copérnico, portugala:copernício, rusa:коперниций, japana:コペルニシウム, korea:코페르니슘, vjetnama:copernici, malaja:copernicium, svahila:kopernici  
**kopi** *kopio* ← angla:copy, franca:copie, hispana:portugala:copia, rusa:копия (kopiya), hindia:कापी (kāpī), turka:kopya, malaja:kopi, mandarena:拷貝 (kǎobèi), japana:コピー (kopī)  
...
**korona** *krono* ← franca:couronne, angla:crown, hispana:corona, japana:クラウン (kuraun), rusa:корона (korona), portugala:coroa  
**korte** *mallonga* ← hispana:corto, rusa:короткий (korotkiy), portugala:curto, franca:court, deu:kurz, angla:short  
**kosi** ** ← hispana:portugala:coser + hindia:सीना (sīnā), bengala:স্যূত (syūta), marataja:शिवणे (śivṇe), guĝarata:સીવવું (sīvvũ), rusa:шить (šit'), angla:sew  
**kosme** ** ← rusa:космос (kosmos), angla:franca:hispana:cosmos  
**koso** *tuso* ← rusa:кашель (kašel'), polona:kaszel, bengala:কাশা (kaśa), mandarena:咳嗽 (késou)  
**kote** *palto* ← angla:coat, svahila:koti, haŭsa:kwat, oroma:koota, japana:コート (kōto), persa:(kot), hindia:कोट (kot)  
...
**kratia** *regado* ← angla:-cracy, franca:-cratie, hispana:portugala:-cracia, rusa:-кратия (kratiya), araba:(-qratiya), malaja:svahila:-krasi  
**kree** *krei* ← angla:create, deu:kreieren, franca:créer, hispana:crear, portugala:criar + malaja:kreatif  
**krem** *kremo* ← franca:crème, portugala:creme, hispana:crema, angla:cream, japana:クリーム (kurīmu), mandarena:淇淋 (qílin), fula:kerem  
**krepe** *krepo (patkuko)* ← franca:angla:crêpe, portugala:crepe, hispana:crepa, turka:krep, mandarena:可丽饼 (kělìbǐng)  
...
**krim di** *krima* ← araba: جُرْم (jurm), persa: جرم‎ (jorm), hindia:जुर्म (jurm)  
...
**krokodil** ** ← greka:κροκόδειλος, angla:crocodilian, franca:crocodilien, hispana:crocodilio, portugala:crocodiliano, rusa:крокодил (krokodil), japana:クロコダイル, korea:크로커다일 (keulokeodail)  
**krokro** ** ← angla:croak, franca:croa croa, hispana:portugala:croac croac, japana:ケロケロ (kero kero), malaja:krok krok  
**kromium** *kromo* ← angla:chromium, franca:chrome, hispana:cromo, portugala:crómo, rusa:хром, japana:クロム, korea:크로뮴, vjetnama:crom, hindia:क्रोमियम, bengala:ক্রোমিয়াম, malaja:krom, svahila:kromi, araba: كروم  
**krote** ** ← rusa:крот (krot), polona:kret  
**kruasan** *korna bulko* ← franca:angla:croissant, portugala:croassã, hispana:cruasán, rusa:круассан, mandarena:可颂 (kěsòng), japana:クロワッサン (kurowassan), korea:크루아상 (keruasang), hindia:क्रोइसैन (kroisain)  
...
**kuan** ** ← mandarena:矿 (kuàng), vjetnama:khoáng, korea:광 (guang) + persa: کان‎ (kân), hindia:खान (khān), bengala:খাদ (khad)  
**kuarze** ** ← deu:Quarz, angla:franca:quartz, hispana:cuarzo, rusa:кварц (kvarc), turka:kuvars, hindia:क्वार्ट्ज (kvārtj), japana:クオーツ (kuōtsu), malaja:kuarza  
...
**kuku** *kukolo* ← angla:cuckoo, franca:coucou, hispana:portugala:cuco, rusa:кукушка (kukushka), persa: کوکو‎ (kuku), japana:郭公 (kakkō), mandarena:布谷鸟 (bùgǔniǎo), kantona:布谷鳥 (bou3 guk1 niu5), turka:guguk, haŭsa:kukku  
**kule** *sklavo* ← turka:köle; kul, hindia:क़ुली (qulī), tamila:கூலி (kūli), malaja:kuli, mandarena:苦力 (kǔlì), kantona:咕哩 (gu1 lei1), japana:苦力 (kūrī), korea:쿨리, vjetnama:cu li, angla:franca:coolie, hispana:culi, portugala:cule, deu:Kuli, rusa:кули (kuli)  
**kulte** ** ← angla:cultivate, franca:cultiver, hispana:portugala:cultivar, rusa:культура (kulʹtúra), persa: کولتور‎ (kultur), turka:kültür, japana:カルチャー (karuchā), tamila:கலாச்சாரம் (kalāccāram)  
**kume** ** ← angla:cumulate, franca:cumuler, hispana:portugala:cumular + turka:kumul + araba:كَوْمَة‎ (kawma), persa: کومه (kume)  
**Kung Fuzi** *Konfuceo* ← mandarena:孔夫子 (Kǒng Fūzǐ)  
**kung** ** ← mandarena:孔 (kǒng), kantona:孔 (hung2), vua:孔 (khon2), japana:孔 (kō), korea:공 (gong), vjetnama:hỏng  
**kupa** *taso* ← angla:cup, franca:coupe, hispana:copa, portugala:copo, araba: كُوب‎ (kūb), fula:kóppu, turka:kupa, hindia:कप (kap), japana:コップ (koppu), korea:컵 (keop) + persa:(koppe), ara:قبة (qubba), malaja:kubah, rusa:купол (kupol), deu:Kuppel  
**kupon** ** ← angla:franca:coupon, hispana:cupón, portugala:cupom, rusa:купо́н (kupón), malaja:kupon, japana:クーポン (kūpon), korea:쿠폰 (kupon), svahila:kuponi  
**kupre** *kupro* ← angla:copper, franca:cuivre, hispana:cobre, portugala:cobre, svahila:kupri  
**kuran** ** ← araba: الْقُرْآن‎ (al-qurʔān), turka:Kuran, svahila:Kurani, haŭsa:Alƙur'ani, fula:alkur'aana, angla:Quran, franca:Coran, hispana:Corán, portugala:Corão, rusa:Коран (Koran), persa: قرآن‎ (qor-ân), hindia:क़ुरान (qurān), bengala:কুরআন (kuran), malaja:Al-Qur'an, mandarena:古兰经 (gǔlánjīng), japana:クルアーン (kuruān), korea:꾸란 (kkuran), vjetnama:kinh Koran  
**kurban** *ofero* ← araba: قُرْبَان‎ m (qurbān), hindia:कुरबानी (kurbānī), bengala:কোরবানি (korbani), malaja:turka:kurban  
**kurium** *kuriumo* ← angla:curium, franca:curium, hispana:curio, portugala:cúrio, rusa:кюрий, japana:キュリウム, korea:퀴륨, vjetnama:curi, hindia:क्यूरियम, bengala:কুরিয়াম, malaja:kurium, svahila:kuri, araba: كوريوم  
**kurse** ** ← angla:course, franca:cours, hispana:portugala:curso, rusa:курс (kurs) + hindia:कोर्स कोर्स् (kors), malaja:kursus, korea:코스 (koseu), japana:コース (kōsu)  
**kursi** *seĝo* ← araba:(kursiy), hindia:कुरसी (kursī), urdua:(kursī), panĝaba:ਕੁਰਸੀ (kursī), teluga:(kurcī), malaja:som:kursi, persa:(korsi)  
**kurta** *robo* ← persa: کرته‎ (korte), hindia:कुरता (kurtā), bengala:কুরতা (kurôta), teluga:కుర్తా (kurtā), malaja:kurta, rusa:курта (kurta), angla:kirtle  
**kurva** *kurbo* ← angla:curve, franca:courbe, hispana:portugala:curva, svahila:kuruba + rusa:кривая (krivaya)  
**kutu** ** ← malaja:kutu, filipina:kuto, angla:cootie  
**kux loka** ** ← franca:angla:couchette, itala:cuccetta, polona:kuszetka  
**kuxen** ** ← angla:cushion, franca:coussin, hispana:cojín, portugala:coxim, japana:クッション (kusshon), korea:쿠션 (kusyeon), kantona:咕𠱸 (ku1 seon2), haŭsa:kushin, igba:kushọn  
**la** *la* ← franca:la, hispana:la, araba: الـ‎ (al-)  
**laba** ** ← mandarena:喇叭 (lǎbā), kantona:喇叭 (laa3baa1), japana:喇叭 (rappa)  
**labi** *lipo* ← hispana:labio, portugala:lábio, persa:urdua:(lab), hindia:लब (lab), filipina:labi  
**lage** ** ← angla:lake, hispana:portugala:itala:lago, franca:lac  
**lai** *veni* ← mandarena:来 (lái), kantona:嚟 (lai4), japana:来 (rai), vjetnama:lại  
**lake** ** ← angla:lacquer, deu:Lack, hispana:portugala:laca, franca:laque, rusa:лак (lak), malaja:lak, araba: لَكّ‎ (lakk), turka:lake, mandarena:蜡克 (làkè), japana:ラッカー (rakkā), korea:래커 (raekeo)  
**lala** *luli* ← angla:lull, polona:lulać, persa: لالا کردن‎ (lâlâ kardan) + japana:ララバイ (rarabai), filipina:lalay + svahila:-lala  
**lampa** *lampo* ← angla:lamp, deu:franca:lampe, hispana:lámpara, portugala:lâmpada, rusa:лампа (lampa), araba: لمبة‎(lamba), japana:ランプ (ranpu), korea:램프 (raempeu), hindia:लैंप (laimp), bengala:ল্যাম্প (lyamp), fula:malaja:lampu, turka:lamba  
**langan** ** ← mandarena:栏杆 (lángān), japana:欄干 (rankan), korea:난간 (nan-gan)  
**lanse** *ĵeti (lanĉi)* ← angla:launch, itala:lanciare, portugala:lançar, franca:lancer, hispana:lanzar, deu:lancieren  
**lantan** ** ← angla:lanthanum, franca:lanthane, hispana:lantano, portugala:lantâno, rusa:лантан, mandarena:镧 (lán), japana:ランタン, korea:란탄, vjetnama:lantan, hindia:लाञ्थनम, bengala:ল্যান্থানাম, malaja:lantanium, svahila:lanthani, araba: لنثانوم  
**larva** ** ← deu:franca:larve, angla:turka:larva, hindia:लार्वा (lārvā), urdua:(lārvā), polona:larwa  
**lasa** *rubo* ← mandarena:垃圾 (lājī / lèsè), kantona:垃圾 (laap6 saap3), hakaa:垃圾 (lá-sap), nan:垃圾 (lah-sap)  
**lasun** *ajlo* ← hindia:लहसुन (lahsun), bengala:রসুন (rôśun) + mandarena:大蒜 (dàsuàn), kantona:大蒜 (daai6 syun3), korea:대산 (daesan)  
**late** *flanko (latero)* ← hispana:portugala:lado, itala:lato, angla:lateral, franca:latéral, rusa:латеральный (lateral’nyy)  
**lau** ** ← mandarena:老 (lǎo), kantona:老 (lau2), vua:老 (lau3), japana:老 (rō), vjetnama:lão  
**laurencium** *laŭrencio* ← angla:lawrencium, franca:lawrencium, hispana:laurencio, portugala:lawrêncio, rusa:лоуренсий, mandarena:铹 (láo), japana:ローレンシウム, korea:로렌슘, vjetnama:lorenxi, lawrenci, hindia:लॉरेंशियम, bengala:লরেনসিয়াম, malaja:lawrensium, svahila:lawirensi, araba: لورنسيوم  
**laxe** ** ← angla:(re)lax, franca:(re)lâcher, hispana:(re)lajar, itala:lasciare, deu:lassen  
**lazanya** ** ← franca:lasagne, angla:lasagna, hispana:lasaña, portugala:lasanha, rusa:лазанья (lazanya), araba:(lazanyā), japana:ラザニア (razania), korea:라자냐 (lajanya), hindia:लज़ैन्या (lazenyā)  
**lazur petra** ** ← persa:لاجورد (lājevard), angla:lazuli, hispana:lapislázuli, rusa:лазурит (lazurit), araba:لازورد (lāzaward), hindia:लाजवर्द (lājavarda), japana:ラピスラズリ (rapisurazuri), malaja:lazuardi, turka:lazur taşı  
**le** ** ← mandarena:了 (le, liǎo), vua:了 (le’), kantona:了 (liu), taja:แล้ว (lɛːw)  
**lege** ** ← hindia:लघु (laghu), bengala:লঘু (laghu) + angla:light, hispana:ligero, portugala:ligeiro, franca:léger, rusa:лёгкий (l’ogkiy), polona:lekki  
...
**lenxi** *ekzerco* ← mandarena:练习 (liànxí), japana:練習 (renshū), korea:련습 (ryeonseup)  
**lete** *legi* ← portugala:leer; leitor, hispana:ler; lector, franca:lire; lecteur, rusa:лектор (lektor) angla:literature, deu:Literatur, fra:littérature, turka:literatür  
...
**lexe** *vorto* ← deu:angla:franca:hispana:portugala:lex-, rusa:лекс- (leks-), malaja:leks-  
...
**lide** ** ← angla:lead, hispana:liderar + franca:leader, portugala:líder, rusa:лидер (lider), turka:lider, hindia:लीडर (līdar), japana:リーダー (rīdā), korea:리더 (rideo)  
**lifafe** ** ← araba: لِفَافَة‎ (lifāfa), persa:(lefâf), hindia:लिफ़ाफ़ा (lifāfā), bengala:লেফাফা (lephapha)  
**lige** *ligi (aligi; ligo)* ← franca:ligue, deu:hispana:polona:portugala:liga, angla: league, rusa: лига (liga), turka:lig, svahila:ligi, japana:リーグ (rīgu)  
**lila** ** ← angla:lilac, franca:lilas, portugala:lilás, hispana:filipina:lila, japana:ライラック (rairakku), turka:leylak, araba:(laylak)  
**lima** *kvin (5)* ← malaja:filipina:lima  
**limfa** ** ← angla:lymph, hispana:portugala:linfa, rusa:ли́мфа (límfa), malaja:limfa, japana:リンパ (rinpa), mandarena:淋巴 (línbā)  
**limite** ** ← angla:limit, hispana:límite, franca:portugala:limite, rusa:лимит (limit)  
**limon** *citrono* ← persa:(limun), angla:lemon, turka:limon, rusa:лимон (limon), hispana:limón, portugala:limão, hindia:नींबू (nīmbū), urdua:(nībū), mandarena:柠檬 (níngméng), kantona:檸檬 (ning4mung1), japana:檸檬 (remon), korea:레몬 (remon), vjetnama:lêmon, svahila:ndimu; limau, fula:leemuure, bengala:লেবু (lebu)  
**lin** *lineo (ŝnuro)* ← angla:line, franca:ligne, hispana:línea, portugala:linha, rusa:линия (liniya), polona:linia  
**linke** *rilato* ← angla:link, franca:lien, deu:Link, persa:لینک • (link), japana:リンク (rinku) + mandarena:連結 (liánjié), kantona:連結 (lin4 git3), hakaa:連結 (lièn-kiet), vjetnama:liên kết  
**linxe** *linko* ← angla:franca:lynx, hispana:portugala:lince, hindia:लिंक्स (links)  
...
**litre** *litro* ← angla:franca:turka:litre, deu:malaja:liter, hispana:portugala:litro, rusa:литр (litr), polona:litr, araba: لتر‎(litr), hindia:लीटर (līṭar), bengala:লিটার (liṭar), japana:リットル (rittoru), korea:리터 (riteo), vjetnama:lít, svahila:haŭsa:lita, fula:liter  
...
**lixu** *sciuro* ← mandarena:栗鼠 (lìshǔ), japana:栗鼠 (risu)  
...
**lote** *loto* ← angla:franca:lot, deu:Los, hispana:portugala:loteria, rusa:лотерея (lotereia), persa: لاتاری‎ (lâtâri), hindia:लॉटरी (lŏṭrī), bengala:লটারি (lôṭari), mandarena:乐透 (lètòu)  
**lotra** ** ← angla:otter + franca:loutre, hispana:filipina:lutrino, portugala:lontra + rusa:выдра (vydra)  
**lou** *liki* ← mandarena:漏 (lòu), kantona:漏 (lau6), japana:漏 (rō), 루 (ru)  
...
**lutesium** *lutecio* ← angla:lutetium, franca:lutécium, hispana:lutecio, portugala:lutécio, rusa:лютеций, mandarena:镥 (lǔ), japana:ルテニウム, korea:루테튬, vjetnama:lutexi, hindia:लुटेटियम, bengala:লুটেসিয়াম, malaja:lutetium, svahila:luteti, araba: لوتيتيوم  
...
**maina** ** ← hindia:मैना (mainā), bengala:ময়না (môẏna), tamila:மைனா (maiṉā), deu:Maina, angla:myna, hispana:portugala:mainá  
**mais** ** ← angla:maize, hispana:maíz, franca:maïs, rusa:маи́с (maís)  
**majang** *maĝango* ← angla:hispana:portugala:mahjong, franca:mah-jong, rusa:маджонг (madžong), malaja:mahjung, mandarena:麻将 (májiàng), kantona:麻将 (maa4zoeng3), japana:麻雀 (mājan), korea:마작 (majang), vjetnama:mạt chược  
**makas** *tondilo* ← araba: مَقَص‎ (maqaṣ), turka:makas, svahila:mkasi, oroma:maqasii, haŭsa:almakashi, joruba:àlùmogàjí, fula:almakaci  
**makin** *maŝino* ← angla:franca:machine, deu:Maschine, hispana:portugala:máquina, fula:masin, svahila:mashine, hindia:मशीन (maśīn), bengala:মেশিন (meśin), malaja:mesin, araba: مَاكِينَة‎ (mākīna), turka:makine, japana:マシン (mashin), korea:머신 (meosin)  
**mal** ** ← araba:persa:urdua:  مَال‎ (māl), hindia:माल (māl), bengala:মালিক, svahila:mali, haŭsa:mallake, malaja:milik, turka:mal  
**malaria** ** ← angla:hispana:franca:svahila:malaja:malaria, portugala:malária, rusa:малярия (mal′arija), turka:malarya, araba:مَلَارِيَا‎ (malāriyā), hindia:मलेरिया (maleriyā), japana:マラリア (mararia)  
**malte** ** ← angla:franca:turka:malt, deu:Malz, hispana:malta, portugala:malte, persa: مالت‎ (mâlt), araba: مَلْت‎ (malt)  
**mame** *mamo* ← persa: ممه‎ (mame), turka:meme, angla:mamma, hispana:portugala:mama + franca:mammifère, malaja:mamalia  
...
**mango** ** ← malajala:മാങ്ങ (māṅṅa), angla:hispana:turka:mango, portugala:manga, rusa:манго (mango), malaja:mangga, japana:マンゴー (mangō), korea:망고 (manggo), fula:mannguure  
**mania** ** ← angla:portugala:mania, deu:Manie, franca:manie, hispana:manía, rusa:мания (maniya)  
**manioka** ** ← angla:franca:manioc, hispana:portugala:mandioca, rusa:маниока (manioka), korea:마니옥 (maniok), lingala:manyɔ́kɔ, konga:mandioko  
**manite** *magneto* ← angla:magnet, franca:magnétique, hispana:magnete, rusa:магнит (magnit), turka:mıknatıs, araba: مَغْنَاطِيس‎ (maḡnāṭīs), malaja:maknit  
...
**mar** *fojo* ← araba: مرة (marra), svahila:mara, haŭsa:marra, persa: بار‎ (bâr), hindia:बार (bār), bengala:বার (bar), tamila:முறை (muṟai), deu:Mal  
...
**marke** ** ← angla:mark, hispana:portugala:marca, franca:marque, korea:마크 (makeu), japana:マーク (māku), fula:marke  
...
**masta** *masto* ← angla:deu:mast, hindia:मस्तूल (mastūl), japana:マスト (masuto), rusa:мачта (mačta), polona:maszt, portugala:mastro, hispana:mástil  
**master** ** ← portugala:mestre, franca:maître, polona:mistrz, angla:master, rusa:мастер (master), hispana:maestro, deu:Meister, hindia:(mistrī)  
**mata** *morti (morto; morta)* ← malaja:mati + araba: مَوْت‎ (mawt), amhara:ሞት (mot), svahila:mauti + hispana:portugala:matar + angla:matte, franca:mat, rusa:матовый (matovyj), persa: مات‎ (mât)  
**mate** ** ← angla:maté, franca:hispana:portugala:mate, rusa:матэ (mate), mandarena:马黛茶, japana:マテ茶 (matecha), korea:마테차 (matecha)  
**matras** ** ← angla:mattress, deu:Matratze, franca:matelas, rusa:матрас (matras), malaja:matras, japana:マットレス (mattoresu), korea:매트리스 (maeteuriseu)  
**max** *pli* ← hispana:mas; máximo, portugala:mais; máximo, + angla:franca:maximum, rusa:максимум (maksimum), malaja:maksimum, persa: ماکسیمم‎ (mâksimom)  
...
**mece** ** ← angla:franca:match, hindia:मैच (mɛc), svahila:meci, polona:mecz, rusa:матч (matč), turka:maç  
**medal** *medalo* ← angla:medal, hispana:medalla, portugala:medalha, franca:médaille, deu:Medaille, rusa:меда́ль (medálʹ), persa: مدال‎ (medâl), hindia:मेडल (meḍal), bengala:মেডেল (meḍel), malaja:medali, araba: مِيدَالِيَة‎ (mīdāliya), turka:madalya, japana:メダル (medaru), korea:메달 (medal), vjetnama:mề đay  
**medan** ** ← araba: مَيْدَان‎ (maydān), persa:(meydan), hindia:मैदान (maidān), bengala:ময়দান (moidan), turka:meydan, svahila:medani, rusa:майдан (maydan)  
...
**mehe** *ŝafo* ← lingala:konga:meme + hindia:मेष (meṣ), persa:(miš), taja:เมษ (met) + japana:メーメー (mē mē), portugala:meh, araba:(maa'), turka:mee  
**mei** *bela* ← mandarena:美 (měi), kantona:美 (mei5), japana:美 (mi), korea:미 (mi), vjetnama:mĩ, mỹ  
**meitnerium** *mejtnerio* ← angla:meitnerium, franca:meitnérium, hispana:meitnerio, portugala:meitnério, rusa:майтнерий, japana:マイトネリウム, korea:마이트너륨, vjetnama:meitneri, hindia:मेइट्नेरियम, bengala:মিটনেরিয়াম, malaja:meitnerium, svahila:meitneri, araba: مايتنريوم  
...
**men** ** ← mandarena:们 (men), kantona:們 (mun4) + angla:many + korea:많- (man-) + (tumen) hindia:तुम (tum), rom:tumen  
...
**mer** *membro* ← angla:deu:hispana:portugala:mero-, franca:méro-, rusa:меро- (mero-)  
...
**mesi** ** ← angla:messiah, franca:messie, hispana:mesías, portugala:messias, rusa:мессия (messiya), araba: مَسِيح‎ (masīḥ), hindia:मसीह (masīh), bengala:মসিহ (môśih), malaja:al-Masih, svahila:Masiya, turka:Mesih, haŭsa:Almasihu  
**meta** ** ← angla:hispana:portugala:meta-, franca:méta-, rusa:мета- (meta-)  
...
**mi** *mi* ← angla:franca:portugala:me, hispana:mi; me, persa: من‎ (man), hindia:मैं (mẽ), bengala:আমি (ami), fula:mi, svahila:mimi  
**miau** *kato* ← mandarena:猫 (māo), kantona:貓 (maau), vjetnama:mèo, taja:แมว (mæo), svahila:nyau + angla:miaow; meow, franca:miaou, deu:hispana:portugala:miau, rusa:мяу (myau), persa: میو‎ (miyu), hindia:म्याऊँ (myāū̃), tamila:மியாவ் (miyāv), turka:miyav,   
**mide** ** ← angla:mid; medium, deu:Mitte, hispana:medio, portugala:meio, hindia:मध्य (madhya), bengala:মধ্য (môddh), tamila:மத்தியம் (mattiyam) + franca:médias, rusa:медиа (media), mandarena:媒体 (méitǐ), japana:メディア (media), korea:미디어 (midieo), turka:medya  
...
**mikro** *mikro-* ← angla:franca:hispana:portugala:micro-, rusa:микро- (mikro-), japana:マイクロ- (maikuro-), malaja:turka:mikr-, mandarena:麦克 (mâikè)  
**milke** *lakto* ← angla:milk, deu:Milch, japana:ミルク  (miruku), korea:밀크 (milkeu), lingala:míliki, rusa:молоко (moloko)  
**mime** ** ← angla:franca:mime, hispana:portugala:mímico, rusa:мим (mim)  
**min** *malpli* ← hispana:portugala:menos, franca:moins, rusa:ме́нее (méneje), angla:min-  
**ming** ** ← mandarena:vua:明 (míng), kantona:明 (ming4), vjetnama:minh, korea:명 (myeong)  
**minim** *malplej* ← angla:franca:minimum, hispana:portugala:mínimo, deu:Minimum, rusa:ми́нимум (mínimum)  
**minisme** ** ← angla:minimalism, hispana:portugala:minimalismo, franca:minimalisme, rusa:минимали́зм (minimalízm)  
...
**miskin** *mizera* ← araba:مِسْكِين (miskīn), persa:مسکین‎ (meskin), turka:malaja:haŭsa:miskin, svahila:maskini, hindia:, bengala:মিসকিন (miśkin), franca:miskine, hispana:mezquino, portugala:mesquinho  
...
**mitre** *metro* ← angla:turka:metre, deu:malaja:meter, franca:mètre, hispana:portugala:metro, rusa:метр (metr), araba: متر‎ (mitr), mandarena:米 (mǐ), japana:メートル (mētoru), korea:미터 (miteo), vjetnama:mét, hindia:मीटर (mīṭar), bengala:মিটার (miṭar), svahila:haŭsa:mita, fula:meter  
**mixe** *miksi* ← deu:mischen, rusa:мешать (měšat'), polona:mieszać, angla:mix, itala:miscelare, + hindia:मिश्रण (miśrān)  
**mode** ** ← franca:angla:mode, deu:Mode; Modus, hispana:portugala:modo, rusa:мода (moda), turka:mod, malaja:mode, korea:모드 (modeu) + mandarena:模 (mó), kantona:模 (mou4), japana:模 (mo); モード (mōdo)  
...
**mole** ** ← mandarena:磨 (mò), kantona:磨 (mo4) taja:โม่ (mo), franca:moulin, hispana:molino, rusa:молоть  (molot’)  
...
**moliden** *molibdeno* ← angla:molybdenum, franca:molybdène, hispana:molibdeno, portugala:molibdénio, rusa:молибден, mandarena:钼 (mù), japana:モリブデン, korea:몰리브덴, vjetnama:molypđen, hindia:मोलिब्डेनम, bengala:মলিবডেনাম, malaja:molibden, svahila:molibdeni, araba: مولبيدنيوم  
...
**mone** ** ← deu:angla:franca:hispana:portugala:malaja:mono-, rusa:моно- (mono-)  
**moral** ** ← angla:hispana:portugala:malaja:moral, franca:morale, rusa:мораль (moral’)  
...
**mote** *movi* ← angla:move; motion, franca:mouvoir, hispana:portugala:mover + rusa:мотор (motor), turka:malaja:motor, araba:(mutūr), mandarena:摩托 (mótuō), kantona:摩打 (mo1daa2), japana:モーター (mōtā), korea:모터 (moteo), vjetnama:mô-tơ, hindia:मोटर (moṭar), bengala:মোটর (moṭôr), svahila:haŭsa:mota  
...
**mum** ** ← hindia:मोम (mom), bengala:মোম (mom), persa: موم‎ (mum), turka:mum + araba: مومياء (mumiya), angla:mummy, franca:momie, hispana:momia, portugala:múmia, rusa:мумия (mumiya), mandarena:木乃伊 (mùnǎiyī), malaja:mumia  
...
**muringa** ** ← angla:portugala:moringa, tamila:முருங்கை (muruṅkai), malajala:മുരിങ്ങ (muriṅṅa), malaja:merunggai, filipina:malunggay, taja:มะรุม (má-rum)  
...
**muxmula** *mespilujo* ← rusa:мушмула́ (mušmula), turka:muşmula, araba: مَشْمَلَة‎ (mašmala)  
...
**nadir** *malofta* ← araba: نَادِر‎ (nādir), persa: نادر (nâder), hindia:नादिर (nādir), svahila:nadra, turka:nadir, haŭsa:nadiri  
...
**nam lexe** *substantivo* ← mandarena:名词 (míngcí), kantona:名詞 (ming4 ci4), japana:名詞 (meishi), korea:명사 (myeongsa), hindia:नाम (nām), franca:nom, hispana:nombre, portugala:nome, rusa:имя (imya), araba:(ism), per:(esm), svahila:nomino  
...
**natre** *natrio* ← angla:sodium, franca:sodium, hispana:sodio, portugala:sódio, rusa:натрий, mandarena:钠 (nà), japana:ナトリウム, korea:나트륨, vjetnama:natri, hindia:सोडियम, bengala:সোডিয়াম, malaja:natrium, svahila:natiri  
...
**ne** ** ← portugala:né, hindia:न (na), mandarena:呢 (ne), kantona:呢 (ne1), japana:ね (ne), vjetnama:nhé  
...
**nelu** *kvar (4)* ← korea:넷 (net) + svahila:nne, zulua:ne, fula:nay + tamila:நான்கு (nāṉku), malajala:നാലു (nālu), teluga:నాలుగు (nālugu), kanara:ನಾಲ್ಕು (nālku) + fin:neljä, est:neli, hungara:négy  
**nen mes den** *dato* ← mandarena:年月日 (niányuèrì), kantona:年月日 (ninyutyat), japana:年月日 (nengappi), korea:연월일 (yeonworil)  
**nen** *jaro* ← mandarena:年 (nián), kantona:年 (nin4), japana:年 (nen), korea:년 (nyeon), vjetnama:năm,niên  
**nenufar** ** ← angla:nenuphar, hispana:portugala:nenúfar, franca:nénufar, rusa:ненюфа́р (nenjufár), persa:نیلوفر آبی‎ (nilufar-e âbi)  
**neodimium** ** ← angla:neodymium, franca:néodyme, hispana:neodimio, portugala:neodímio, rusa:неодим, mandarena:钕 (nǚ), japana:ネオジム, korea:네오디뮴, vjetnama:neođim, hindia:नियोडाइमियम, bengala:নিওডিমিয়াম, malaja:neodinium, svahila:neodimi, araba: نيودميوم  
...
**neputunium** *neptunio* ← angla:neptunium, franca:neptunium, hispana:neptunio, portugala:neptúnio, rusa:нептуний, mandarena:镎 (ná), japana:ネプツニウム, korea:넵투늄, vjetnama:neptuni, hindia:नेप्ट्यूनियम, bengala:নেপচুনিয়াম, malaja:neptunium, svahila:neptuni, araba: نبتونيوم  
**nere** ** ← man:nɛrɛ, volofa:nere, franca:néré, fula:nɛtɛ  
**nese** *insulo* ← greka:νήσος (nēsos), angla:hispana:malaja:-nesia, portugala:-nésia, franca:-nésie, rusa:-незия (-nezija), turka:-nezya, mandarena:-尼西亚 (níxīyà), japana:ネシア (neshia) + may:nusa, mlg:nosy  
**nete** ** ← angla:net(work), deu:Netz(werk), japana:ネット(ワーク) (nettowāku), korea:네트워크 (neteuwokeu) + franca:connecter, hispana:portugala:connectar  
...
**nia** *celo* ← araba: نِيَّة‎ (niyya), hindia:नीयत (niyat), malaja:niat, svahila:nia, haŭsa:niyya, fula:anniya, turka:niyet  
...
**nil** *blua* ← bengala:নীল (nīl), hindia:नीला (nīlā), urdua:(nīlā), tamila:நீலம் (nīlam), malaja:nilam  
...
**nobelium** *nobelio* ← angla:nobelium, franca:nobélium, hispana:nobelio, portugala:nobélio, rusa:нобелий, mandarena:锘 (nuò), japana:ノーベリウム, korea:노벨륨, vjetnama:nobeli, hindia:नोबेलियम, bengala:নোবেলিয়াম, malaja:nobelium, svahila:nobeli, araba: نوبليوم  
**noce** *nokto* ← hispana:noche, portugala:noite, rusa:ночь (nočʹ), polona:noc  
**node** *nodo* ← angla:node, hispana:nudo, portugala:nó, franca:nœud + vjetnama:nút  
**nomi** ** ← angla:-nomy, deu:franca:-nomie, hispana:portugala:-nomia, rusa:-номия (-nomiya), malaja:-nomi  
**norde** *nordo* ← angla:north, hispana:portugala:norte, deu:Nord, franca:nord, rusa:норд (nord)  
**norma** ** ← angla:hispana:portugala:franca:deu:normal, rusa:нормальный (normalʹnyj), persa:نرمال‎ (normâl)  
**nos** ** ← angla:nose, hispana:portugala:nariz, deu:Nase, rusa:нос (nos), hindia:marataja:नासिका (nāsikā), bengala:নাক (nak), persa:نس‎ (nos)  
**note** *rimarki* ← deu:angla:franca:note, hispana:portugala:nota, turka:not, japana:ノート (nōto), korea:노트 (noteu), persa:(not)  
**nu** *nu* ← rusa:ну (nu) + angla:now, deu:na, mandarena:那 (nà)  
**nude** ** ← angla:nude, hispana:desnudo, portugala:franca:nu + rusa:нудизм (nudizm), turka:nudizm, japana:ヌーディズム (nūdizumu), korea:  
**nuka** ** ← angla:neck, hispana:portugala:nuca, franca:nuque + araba:عُنُق‎ (ʿunuq)  
**nume** *nombro* ← angla:number, franca:nombre, hispana:portugala:número, rusa:номер (nomer), deu:Nummer, japana:ナンバー (nanbā), hindia:नंबर (nambar), bengala:নম্বর (nômbôr), turka:numara, malaja:nombor, svahila:namba(ri)  
...
**ope** ** ← angla:opus, hispana:portugala:obra, rusa:опус (opus)  
...
**ordu** *armeo* ← mon:ᠣᠷᠳᠤ (ordu), turka:ordu, araba: عُرْضِيّ‎ (ʿurḍiyy), persa: اردو (ordu), hindia:उर्दू (urdū) + angla:franca:horde, hispana:portugala:horda, rusa:орда (orda), mandarena:斡耳朵 (wò'ěrduǒ), japana:オルド (orudo), korea:오르도 (oreudo)  
...
**oselote** ** ← nah:tlālocēlōtl, angla:ocelot, hispana:portugala:ocelote, rusa:оцелот (ocelot), turka:oselo, araba:أصلوت ('aslut), hindia:ऑसेलॉट (ŏsēlŏṭa), japana:オセロット (oserotto)  
**osidian** ** ← angla:malaja:obsidian, hispana:portugala:obsidiana, itala:ossidiana, rusa:обсидиан (obsidian), svahila:obsidiyen, hindia:ऑब्सिडियन (obsidiyan)  
**oskur** ** ← angla:obscure, hispana:oscuro, portugala:escuro, franca:obscur  
**osmium** *osmio* ← angla:osmium, franca:osmium, hispana:osmio, portugala:ósmio, rusa:осмий, japana:オスミウム, korea:오스뮴, vjetnama:osimi, hindia:अस्मियम, bengala:অসমিয়াম, malaja:osmium, svahila:osmi, araba: ازميوم  
...
**ote** *preferi* ← angla:opt, franca:opter, hispana:portugala:optar + rusa:опция (opciya)  
**oxe** *oksigeno* ← angla:oxygen, franca:oxygène, hispana:oxígeno, portugala:oxigénio, rusa:кислород, vjetnama:oxy, oxi, hindia:ऑक्सीजन, bengala:অক্সিজেন, malaja:oksigen, svahila:oksijeni, araba: أكسجين  
**pa** *patro* ← angla:franca:papa, hispana:papá, portugala:pai, rusa:папа (papa), araba:(bābā), mandarena:爸 (bà), kantona:爸 (baa1), japana:パパ (papa), korea:아빠 (appa), hindia:बाप (bāp), bengala:বাবা (baba), malaja:bapa, haŭsa:svahila:turka:baba, fula:ba; baaba  
**pace** *paco* ← itala:pace, angla:peace, hispana:portugala:paz, franca:paix, rusa:пац- (pac-), malaja:turka:pas-  
**paci** *birdo* ← hindia:marataja:पक्षी (pakṣī), bengala:পাখী (pakhī), tamila:பட்சி (paṭci), teluga:(pakṣi), kh:បក្សី (baksəy), tha:ปักษา (pak-sa)  
**pada** ** ← teluga:(paḍu), rusa:падать (padat'), hindia: पड़ना (paṛnā)  
**pagri** ** ← hindia:marataja:पगड़ी (pagṛī), urdua:(pagṛī), bengala:পাগড়ি (pagri)  
...
**paka** ** ← mandarena:迫 (pò), kantona:迫 (baak1), vua:迫 (paq4), japana:迫 (haku), vjetnama:bách  
**pake** *pako* ← angla:pack, rusa:пакет (paket), hindia:पैकेट (pækeṭ), deu:turka:paket, franca:paquet, hispana:paquete, portugala:pacote, fula:pakɛt, haŭsa:fakiti  
**palaba** ** ← angla:palaver, deu:Palaver, franca:palabre, krio:plabah, konga:palaba  
...
**palma** *palmo* ← deu:Palme, angla:palm, portugala:hispana:palma, rusa:пальма (palma), turka:palmiye, malaja:palem, taja:ปาล์ม (pām)  
**pan** *ĉiu* ← angla:franca:hispana:portugala:pan-, rusa:пан- (pan-) + mandarena:泛 (fàn), kantona:泛 (faan3), japana:汎 (han), korea:범 (beom)  
**panda** *pando* ← angla:hispana:portugala:franca:malaja:panda, rusa:панда (panda), hindia:पांडा (pāṇḍā), japana:パンダ (panda)  
**panir** ** ← hindia:पनीर (panīr), panĝaba:ਪਨੀਰ (panīr), bengala:পনির (pônir), turka:peynir, angla:paneer  
**panka** *flugilo* ← hindia:पंखा (paṅkhā) + (fan) birma:ပန်ကာ (panka), persa:(panke), + angla:punkah, franca:panka, deu:Pankha  
**pankreas** *pankreato* ← angla:franca:hispana:portugala:pancreas, deu:malaja:turka:pankreas  
**pante** *pantalonoj* ← angla:pants, franca:pantalon, hispana:pantalón, hindia:पैंट (paiṇṭ), bengala:প্যান্ট (pyanṭ), teluga:ప్యాంటు (pyāṇṭu), araba:بنطلون‎ (banṭalōn), turka:pantolon + japana:パンツ (pantsu), korea:팬티 (paenti)  
**papagai** *papago* ← araba: بَبَغَاء‎ (babaḡāʾ), turka:papağan, deu:Papagei, hispana:papagayo, portugala:papagaio, rusa:попугай (popugay), jin:八哥 (bāgē)  
...
**para** ** ← angla:franca:hispana:portugala:para-, persa: پیرا‎ (pīrā-)  
...
**pari** *feo* ← persa: پری‎ (pari), hindia:परी (parī), bengala:পরী (pôri), malaja:turka:peri, haŭsa:fari, angla:fairy; peri, franca:péri, deu:Peri, rusa:пери (peri)  
...
**parte** *ero* ← angla:part, portugala:hispana:parte + persa: پارچه (pârče), hindia:पारचा (pārcā), turka:parça  
**pas** *pasi* ← angla:past, hispana:pasado, portugala:passado, franca: passé + fula:pasaas, man:pasaasoo  
**pasporte** *pasporto* ← angla:passport, franca:passeport, hispana:pasaporte, portugala:passaporte, rusa:паспорт (pasport), hindia:पासपोर्ट (pāsporṭ), bengala:পাসপোর্ট (pasporṭ), malaja:paspor, svahila:paspoti, japana:パスポート pasupōto), haŭsa:fasfo  
**pasta** ** ← angla:deu:paste, rusa:паста (pasta), hispana:portugala:pasta  
**pata** ** ← angla:path, deu:Pfad, rusa:путь (putʹ), hindia:पथ (path), bengala:পথ (pôth), teluga:పథము (pathamu),   
...
**pate** ** ← deu:angla:franca:patho-, hispana:portugala:polona:turka:malaja:pato-, rusa:пато- (pato-)  
**pau gi** *fusilo* ← mandarena:炮 (pâo), kantona:炮 (paau3), vjetnama:pháo, korea:포 (po), mon:буу (buu)  
**pauze** ** ← deu:Pause, angla:deu:franca:pause, hispana:portugala:pausa, rusa:пауза (pauza)  
**payace** *klaŭno* ← itala:pagliaccio, franca:paillassa, hispana:payaso, portugala:palhaço, rusa:паяц (payac), turka:palyaço  
...
**pei** ** ← angla:pay, franca:paye, + mandarena:费 (fèi)  
...
**pena** *plumo* ← portugala:pena, persa: پر‎ (par), hindia:पर (par), rusa:перо (pero) + japana:ペン (pen), korea:펜 (pen), tamila:பேனா (pēṉā)  
...
**pente** *pentri* ← angla:paint, hispana:portugala:pintura, franca:peinture, nld:pek, japana:ペンキ (penki), hindia:पेंट (penṭa), fula:pentur, haŭsa:fenti  
...
**perde** *furzo* ← bengala:পাদ (pad), hindia:पाद (pād), hispana:pedo, portugala:peido, franca:pet, rusa:пердение (perdeniye)  
...
**pexe** *fiŝo* ← hispana:pez, portugala:peixe, itala:pesce + angla:fish, deu:Fisch  
...
**pigu** *kulo* ← filipina:pigi, mandarena:屁股 (pìgu), kantona:屁股 (pei3 gu2)  
...
**pike** ** ← angla:peak, franca:pic, hispana:portugala:pico, rusa:пик (pik), que:pikchu  
**pil** *haŭto* ← angla:peel, hispana:piel, portugala:pele, mandarena:皮 (pí), vua:皮 (bí), kantona:皮 (pei4)  
**pilau** *pilafo* ← angla:franca:hispana:portugala:pilaf, deu:Pilaw, rusa:плов (plov), persa: پلو‎ (polou), hindia:पुलाव (pulav), bengala:পোলাও (polao), tamila:புழுக்கு (puḻukku), teluga:పులావ్ (pulāv), araba: بِيلَاو‎ (bilāw), turka:pilav, japana:ピラフ (pirafu), korea:필라프 (pillapeu)  
**pilote** ** ← angla:portugala:pilot, hispana:piloto, franca:pilote, deu:Pilot, rusa:пило́т (pilót), japana:パイロット (pairotto)  
**pin** *nadlo (pinglo, pikilo)* ← angla:pin, japana:ピン (pin), korea:핀 (pin), hindia:पिन (pin), fula:pingu, volofa:ping  
...
**pipa** *liuto* ← mandarena:琵琶 (pípa), kantona:琵琶 (pei4 paa4), japana: 琵琶 (biba), korea:비파 (bipa), vjetnama:tì bà  
**pipe** *pipo* ← angla:franca:pipe, deu:Pfeife, hispana:malaja:pipa, persa: پیپ‎ (pip), hindia:पाइप (pāip), bengala:পাইপ (paip), japana:パイプ (paipu), vjetnama:píp, turka:pipo, araba: بِيبَة‎‎ (bība)  
...
**pirate** ** ← angla:franca:pirate, hispana:portugala:pirata, deu:Pirat, rusa:пират (pirat), japana:パイレーシ  
**pisea** ** ← hispana:portugala:pícea, franca:Épicéa  
...
**piza** *pico* ← angla:deu:franca:hispana:turka:vjetnama:pizza, rusa:пицца (pitsa), persa: پیتزا‎ (pitzâ), hindia:पिज़ा (pizā), bengala:পিৎজা (pitja), tamila:பீத்சா (pītcā), malaja:piza, mandarena:比萨 (bǐsà), japana:ピザ (piza), korea:피자 (pija), araba: بِيتْزَا‎ (bītzā)  
**plan** ** ← angla:hispana:franca:plan, portugala:plano, rusa:план (plan), persa:پلان‎ (plân), hindia:प्लैन (plain), japana:プラン (puran)  
**planeta** ** ← angla:turka:malaja:planet, hispana:portugala:planeta, franca:planète, rusa:планета (planeta)  
**plaste** ** ← angla:plastic, hispana:portugala:plástico, rusa:пластик (plastik), turka:malaja:plastik, svahila:plastiki, haŭsa:filastik, araba:بلاستيك (blastīk), hindia:प्लास्टिक (plāsṭik), japana:プラスチック (purasuchikku), korea:플라스틱 (peullaseutik)  
**plate** ** ← angla:plate, hispana:portugala:placa, deu:Platte, rusa:пластина (plastina)  
**platin** *plateno* ← angla:platinum, franca:platine, hispana:platino, portugala:platina, rusa:платина, mandarena:铂 (bó), vjetnama:platin, hindia:प्लाटिनम, bengala:প্লাটিনাম, malaja:platina, svahila:platini, araba: بلاتين  
**plazma** ** ← angla:plasma, hispana:plasma, rusa:плазма (plazma), araba:بلازما (balazima), hindia:प्लाज़्मा (plaazma), japana:プラズマ (purazuma), malaja:plasma  
**ple** ** ← angla:ply, franca:pli, hispana:plegar + portugala:aplicação  
**plumbe** *plumbo* ← franca:plomb, hispana:plomo, portugala:chumbo, svahila:plumbi  
**plutonium** *plutonio* ← angla:plutonium, franca:plutonium, hispana:plutonio, portugala:plutónio, rusa:плутоний, mandarena:钚 (bù), japana:プルトニウム, korea:플루토늄, vjetnama:plutoni, hindia:प्लूटोनियम, bengala:প্লুটোনিয়াম, malaja:plutonium, svahila:plutoni, araba: بلوتونيوم  
**poke** *pokero* ← angla:franca:turka:poker, hispana:portugala:póquer, rusa:покер (poker), araba:بُوكَر‎ (būkar), hindia:पोकर (pokar), mandarena:扑克 (pūkè), japana:ポーカー (pōkā), korea:포커 (pokeo)  
**pole** *urbo* ← angla:hispana:-polis, deu:franca:portugala:-pole, rusa:-поль (-pol'), malaja:turka:-pol  
**poli** *multe* ← greka:πολλοί (polloí), angla:franca:deu:poly-, hispana:portugala:poli-, rusa:поли- (poli-) + tamila:பல (pala)  
**polis** ** ← angla:franca:police, portugala:polícia, hispana:policía, rusa:полиция (policija), fula:turka:malaja:polis, svahila:polisi, araba:بُولِيس‎ (būlīs), hindia:पोलिस (polis), bengala:পুলিশ (puliś)  
**polite** ** ← greka:πολιτική (politikē), malaja:politik, turka:politika, angla:politics, portugala:hispana:política, franca:politique, rusa:политика (politika)  
**polskium** *polonio* ← angla:polonium, franca:polonium, hispana:polonio, portugala:polónio, rusa:полоний, mandarena:钋 (pō), japana:ポロニウム, korea:폴로늄, vjetnama:poloni, hindia:पोलोनियम, bengala:পোলনিয়াম, malaja:polonium, svahila:poloni, araba: بولونيوم  
**pompe** *pumpilo* ← angla:pump, hispana:portugala:bomba, franca:fula:pompe, deu:Pumpe, rusa:помпа (pompa), persa: پمپ‎ (pomp), hindia:पंप (pamp), bengala:পাম্প (pamp), teluga:పంపు (pampu), turka:malaja:pompa, haŭsa:famfo, mandarena:泵 (bèng), kantona:泵 (bam1), japana:ポンプ (ponpu), korea:펌프 (peompeu), vjetnama:bơm  
**pope** *popolo* ← angla:people, franca:peuple, hispana:pueblo, portugala:povo + deu:populär, rusa:популярный (populyarnïy), malaja:populer, turka:popüler  
**pore** *poro* ← angla:franca:deu:pore, hispana:portugala:poro, rusa:пора (pora)  
**porei** *poreo* ← deu:Porree, franca:poireau, hispana:puerro, portugala:porro, rusa:порей (porey), malaja:perai + turka:pırasa  
**porno** ** ← angla:porn, hispana:turka:malaja:porno, portugala:pornô, deu:Pornografie, rusa:порно (porno), japana:ポルノ (poruno)  
**porte** ** ← franca:porter, hispana:portugala:portar, angla:(trans)port, deu:-portieren, rusa:-портация (-portaciya) + hindia:रिपोर्ट (riporṭ), svahila:ripoti, turka:rapor, japana:レポート (repōto)  
**porto** *haveno* ← angla:port, franca:porte, hispana:puerto, portugala:porto, rusa:порт (port), hindia:पोर्ट (porṭ), urdua:(porṭ), bengala:পোর্ট (porṭ), taja:พอร์ต (phot)  
**pos** *sekvo* ← angla:franca:post-, hispana:pos, portugala:pós-, rusa:после- (posle-) + persa: پس (pas)  
**poste** ** ← angla:post, portugala:postagem, franca:poste, rusa:почта (pochta), turka:posta, araba:بوسطة‎ (busṭa), svahila:posta, malaja:pos, persa:پست‎ (post)  
**pote** ** ← angla:franca:pot, hispana:portugala:pote, malaja:poci, japana:ポット (potto), korea:포트 (poteu), fula:pooti; fotiire  
**poto** *koto* ← pcm:konga:lingala:poto-poto  
**poze** ** ← angla:hispana:portugala:franca:pose, deu:Pose, rusa:поза (poza), japana:ポーズ (pōzu)  
**prate** ** ← angla:practice, franca:pratique, portugala:prática, turka:pratik, polona:praktyka, hindia:प्रथा (prathā)  
**prazedimium** ** ← angla:praseodymium, franca:praséodyme, hispana:praseodimio, portugala:praseodímio, rusa:празеодим, japana:プラセオジム, korea:프라세오디뮴, vjetnama:prazeođim, hindia:प्रासियोडाइमियम, bengala:প্র্যাসেওডিমিয়াম, malaja:praseodinium, svahila:praseodimi, araba: براسوديميوم  
**pre** *antaŭe (pasinte)* ← angla:franca:hispana:portugala:pre-, hindia:प्र- (pra-), bengala:প্র- (prô-), malaja:pra-  
**prese** *premo* ← franca:pression, hispana:presión, portugala:pressão, rusa:пресс (press), japana:プレス (puresu)  
**presidente** *prezidento* ← angla:president, deu:Präsident, franca:président, hispana:portugala:presidente, rusa:президент (prezident), persa: پرزیدنت‎ (perezident), malaja:presiden  
**prive** ** ← angla:private, deu:privat, franca:privé, hispana:portugala:privado, rusa:прива́тный (privatnyi), malaja:pribadi  
**pro** ** ← deu:angla:franca:hispana:portugala:pro-, hindia:प्र- (pra-), bengala:প্র- (prô-), malaja:pro-; pra-  
...
**profesor** *profesoro* ← angla:deu:portugala:professor, franca:professeur, hispana:profesor, rusa:профессор (professor), araba: بروفيسور‎ (brofesōr), turka:profesör, svahila:profesa, haŭsa:farfesa, persa:پروفسور‎ (profesor), hindia:प्रोफ़ेसर (profesar)  
**prometium** *prometio* ← angla:promethium, franca:prométhium, hispana:prometio, portugala:promécio, rusa:прометий, mandarena:钷 (pǒ), japana:プロメチウム, korea:프로메튬, vjetnama:prometi, hindia:प्रोमेथियम, bengala:প্রমিথিয়াম, malaja:prometium, svahila:promethi, araba: بروميثيوم  
**protacinium** *protaktinio* ← angla:protactinium, franca:protactinium, hispana:proactinio, portugala:protacnídio, rusa:протактиний, mandarena:镤 (pú), japana:プロトアクチニウム, korea:프로트악티늄, vjetnama:protactini, hindia:प्रोटैक्टीनियम, bengala:প্রোটেক্টিনিয়াম, malaja:protaktinium, svahila:protaktini, araba: بروتكتنيوم  
**prote** ** ← deu:angla:franca:hispana:portugala:malaja:turka:proto-, rusa:прото- (proto-)  
**proxe** *proksima* ← angla:proximal, franca:proche, hispana:portugala:próximo  
**puding** ** ← angla:franca:deu:pudding, hispana:pudín, portugala:pudim, rusa:пудинг (puding), turka:malaja:puding, svahila:pudini, araba:بودنغ (budingh), mandarena:布丁 (bùdīng), japana:プディング (pudingu), korea:푸딩 (puding)  
**puje** ** ← hindia:पूजा (pūjā), urdua: پوجا‎ (pūjā), tamila:பூசை (pūcai), teluga:పూజ (pūja), malaja:puja, taja:บูชา (bucha)  
...
**pulse** ** ← angla:push; pulse, franca:pousser + hispana:portugala:impulso, rusa:импульс (impul's)  
**puma** ** ← angla:hispana:franca:portugala:svahila:malaja:turka:puma, rusa:пума (puma), japana:ピューマ (pyūma), hindia:पूमा (pooma), pan:ਪੂਮਾ (pūmā), marataja:प्युमा (pyumā)  
**punte** *punkto* ← angla:point, deu:Punkt, hispana:punto, rusa:пункт (punkt)  
**pupe** ** ← franca:poupée, deu:Puppe, angla:puppet, vjetnama:búp bê, ktu:popi, heb:(bubá)  
**putau** *vinbero* ← mandarena:葡萄 (pútáo), kantona:葡萄 (pou4 tou4), vua:葡萄 (bu dau3), japana:葡萄 (budō), korea:포도 (podo), vjetnama:bồ đào  
**pute** ** ← angla:put + hispana:computadora, portugala:computador, rusa:компьютер (komp’uter), araba:كَمْبْيُوتَر‎ (kambyūtar), svahila:kompyuta, hindia:कंप्यूटर (kampyūṭar), bengala:কম্পিউটার (kômpiuṭar), malaja:komputer, japana:コンピューター (konpyūtā)  
**pute** ** ← angla:putrid, hispana:portugala:podre, franca:putride + mandarena:腐 (fǔ), japana:腐 (fu) + taja:ผุ (phu)  
**putong** *generala* ← mandarena:普通 (pǔtōng), kantona:普通 (pou2tung1), vjetnama:phổ thông, korea:보통 (botong)  
**rade** ** ← angla:franca:radiation, hispana:radiación, portugala:radiação, malaja:radiasi, rusa:радио (radio), turka:radyo, svahila:redio, hindia:रेडियो (reḍiyo), bengala:রেডিও (reḍio), japana:ラジオ (rajio), korea:라디오 (radio)  
**radio** ** ← deu:angla:franca:hispana:portugala:radio, rusa:радио (radio), fula:turka:radyo, svahila:redio, haŭsa:rediyo, hindia:रेडियो (reḍiyo), bengala:রেডিও (reḍio), japana:ラジオ (rajio), korea:라디오 (radio)  
**radium** *radiumo* ← angla:radium, franca:radium, hispana:radio, portugala:rádio, rusa:радий, mandarena:镭 (léi), japana:ラジウム, korea:라듐, vjetnama:rađi, hindia:रेडियम, bengala:রেডিয়াম, malaja:radium, svahila:radi, araba: راديوم  
...
**ragbi** ** ← 橄榄球  
**rage** ** ← hindia:राग (rāg), bengala:রাগ (rag), tamila:ராகம் (rāgam) + angla:franca:rage, deu:Rage  
...
**rai** *opinio* ← araba:(raʾy), svahila:rai, haŭsa:ra'ayi, hindia:राय (rāy), persa:(ra'y), turka:rey  
**rakete** ** ← angla:rocket, deu:Rokete, rusa:ракета (raketa), turka:malaja:roket, svahila:roketi, persa:راکت‎ (râket), hindia:राकेट (rākeṭ), bengala:রকেট (rôkeṭ), japana:ロケット (roketto), korea:로켓 (roket)  
...
**rande** ** ← persa: رنده‎ (rande), hindia:रंदा, (randā), turka:rende, svahila:randa  
...
**rase** *raco* ← angla:franca:race, hispana:raza, portugala:raça, rusa:раса (rasa), malaja:ras  
**rate** ** ← lat:ratio, angla:rational, franca:rationnel, hispana:portugala:racional + deu:Rat, rusa:рада (rada), polona:rada  
...
**reger** *reĝo aŭ reĝino* ← hindia:राजा (rājā), রাজা (raja), malaja:raja, teluga:రాజు (rāju) + angla:rajah, hispana:portugala:rajá, rusa:раджа  
...
**reporte** ** ← angla:report, hispana:reporte, franca:rapport, rusa:рапорт (raport), turka:rapor, svahila:ripoti, hindia:रिपोर्ट (riporṭ), japana:レポート (repōto), haŭsa:rahoto  
**reseta** ** ← itala:ricetta, rusa:рецепт (retsept), deu:Rezept, hispana:receta, portugala:receita, franca:recette, malaja:resep, turka:reçete  
**reside** ** ← persa: رسید‎ (resid), hindia:रसीद (rasīd), bengala:রসিদ (rôśid), tamila:ரசீது (racītu), teluga:రసీదు (rasīdu) + angla:receipt, japana:レシート (reshīto), malaja:resit, svahila:resiti, joruba:rìsíìtì  
...
**rime** ** ← hispana:portugala:rima, franca:rime, angla:rhyme, polona:rym, deu:Reim  
...
**rite** *metodo* ← hindia:रीति (rīti), bengala:রীতি (rīti) + angla:franca:rite, hispana:portugala:rito, rusa:ритуал (ritual), malaja:ritus  
...
**rode** *rozo* ← greka:ῥόδον (rhódon), franca:angla:rose, hispana:portugala:rosa, rusa:роза (roza), malaja:ros, filipina:rosas + araba: وَرْد‎ (ward), svahila:waridi  
...
**rupe** *aspekto* ← hindia:रूप (rūp), urdua: روپ‎ (rūp), bengala:রূপ (rup), tamila:ரூபம் (rūpam), malaja: rupa, taja: รูป (rūp), kmera:រូប (rūp)  
**rute** ** ← angla:franca:route, hispana:ruta, portugala:rota, deu:Route, japana:ルート (rūto), rusa:маршрут (maršrut); рутина (rutina) + persa:روتین‎ (rutin)  
...
**sabun** *sapo* ← franca:savon, hispana:jabón, portugala:sabão, araba: صَابُون‎ (ṣābūn), persa: صابون‎ (sâbun), hindia:साबुन (sābun), bengala:সাবান (śaban), teluga:సబ్బు (sabbu), malaja:turka:sabun, svahila:sabuni, fula:saabunde, haŭsa:sabulu, japana:シャボン (shabon), vjetnama:xà bông  
**sade** ** ← turka:sade, persa:(sāde), hindia:सादा (sādā), bengala:সাদা (śada), araba: سَاذَج (sāḏaj)  
**safar** *vojaĝi* ← araba:(safar), hindia:सफ़र (safar), turka:sefer, svahila:safari, haŭsa:safara, angla:franca:hispana:portugala:deu:malaja:safari  
...
**sahi** *ĝusta (prava)* ← araba: صَحِيح‎ (ṣaḥīḥ), persa: صحیح‎ (sahih), hindia:सही (sahī), malaja:sah, haŭsa:svahila:sahihi  
**saide** *ĉasado* ← araba:(ṣayd), turka:seyd, urdua:صید‎ (said), persa:صید‎ (seyd), heb:ציד‎ (tsayid)  
**sake** ** ← deu:angla:sack, franca:sac, hispana:portugala:saco, malaja:konga:saku, fula:saakuuru  
**sal** *saluton!* ← araba:persa: سلام‎ (salâm), hindia:सलाम (salām), bengala: সালাম (salam), malaja:selamat, svahila:salamu, fula:salaam, haŭsa:salam, turka:selam + angla:salute, franca:salut, hispana:salude, portugala:saúde + korea:잘 (jal)  
...
**salade** ** ← franca:salade, malaja:salad, deu:Salat, rusa:салат (salat), turka:salata, persa:urdua:(salād), hindia:सलाद (salād), kantona:沙律 (saa1 leot62),  mandarena:沙拉 (shālā), portugala:salada, hispana:ensalado, korea:샐러드 (saelleodeu), japana:サラダ (sarada), taja:สลัด (salat), fula:salati  
...
**sam** *sama* ← angla:same, franca:semblable, rusa:самый (samyy), persa:هم‎ (ham), hindia:सम (sam), malaja:sama + araba: سَوَاء (sawāʾ), svahila:sawa  
**sama** *ĉielo* ← araba: سَمَاء‎ (samāʾ), svahila:samawati, amhara:ሰማይ (sämay), haŭsa:sama, joruba:sanma, turka:sema, oroma:samii + fula:asamaan, hindia:आसमान (āsmān), bengala:আসমান (aśman)  
**samarium** *samario* ← angla:samarium, franca:samarium, hispana:samario, portugala:samário, rusa:самарий, mandarena:钐 (shān), japana:サマリウム, korea:사마륨, vjetnama:samari, hindia:सैमरियम, bengala:সামারিয়াম, malaja:samarium, svahila:haŭsa:samari, araba: ساماريوم  
**sanduice** ** ← angla:franca:hispana:sandwich, portugala:sanduíche, rusa:сандвич (sandvič), araba:(sandawitš), mandarena: (sānwénzhì), japana:サンドイッチ (sandoichi), hindia:सैंडविच (saiṇḍvic), malaja:sandwic, haŭsa:sanwici  
**sanduku** *skatolo (kesto)* ← rusa:сундук (sunduk), araba: صُنْدُوق‎ (ṣundūq), persa: صندوق‎ (sanduq), svahila:sanduku, haŭsa:sàndūƙī̀, oroma:saanduqa, turka:sandık swa:lingala:sanduku, tur:sandık  
**sanga** ** ← hindia:संघ (saṅgh), bengala:সঙ্ঘ (śôṅgh), tamila:சங்கம் (saṅgam), malaja:sangha, mandarena:僧伽 (sēngjiā), korea:승가 (seungga), vjetnama:tăng già, taja:สงฆ์ (sǒng), kmera:សង្ឃ (sɑng), birma:သံဃာ (samgha)  
**sante** *sankta* ← portugala:hispana:santo, angla:franca:saint, konga:santu, mandarena:圣 (shèng)  
**sanzi** *ventumilo* ← mandarena:扇子 (shànzi), kantona:扇子 (sin3zi2), japana:扇子 (sensu), korea:선 (seon), mon:шанз (šanz)  
**sari** *sario* ← angla:deu:franca:hispana:portugala:malaja:sari, rusa:сари (sari), hindia:साड़ी (sāṛī), bengala:শাড়ি (śaṛi), mandarena:莎丽 (shālì), japana:サリー (sarī), korea:사리 (sari), araba: سَارِي‎ (sārī), persa: ساری‎ (sâri)  
**sau** *gefrato* ← hindia:सहोदर (sahodar), bengala:সহোদর (śôhodôr), tamila:சகோதரன் (sahōdaraṉ), malaja:saudara  
...
**saye** *ombro* ← persa: سایه‎ (sāye), hindia:साया (sāyā); छाया (chāyā), bengala:ছায়া (chaya), turka:saye, taja:ฉายา (chāyā), birma:ဆာယာ (sʰaya)  
...
**sekur** ** ← angla:secure, deu:sicher, hispana:portugala:seguro  
**sel** ** ← araba: صَلَاح‎ (ṣalāḥ), hindia:सलाह (salāh), teluga:సలహా (salahā), turka:salık + angla:counsel, franca:conseil, hispana:consejo, portugala:conselho  
**selenium** *seleno* ← angla:selenium, franca:sélénium, hispana:selenio, portugala:selénio, rusa:селен, mandarena:硒 (xī), japana:セレン, korea:셀렌, vjetnama:selen, hindia:सेलेनियम, bengala:সেলেনিয়াম, malaja:selenium, svahila:seleni, araba: سيلينيوم  
...
**semente** ** ← angla:cement, malaja:semen, hispana:cemento, svahila:sementi, haŭsa:siminti, fula:siment, turka:çimento, vjetnama:xi măng, hindia:सीमेंट (siment), rusa:цемент (tsement), araba:(ʾasmant), korea:시멘트 (simenteu)  
...
**sexu** *sekso* ← angla:sex, franca:sexe, hispana:portugala:sexo, rusa:секс (seks), turka:seks, hindia:सेक्स (seks), japana:セックス (sekkusu), korea:섹스 (sekseu)  
**si** *se* ← franca:hispana:si, portugala:se, turka:ise, mandarena:使 (shǐ); 要是 (yàoshǐ), kantona:使 (si2); 要是 (jiu3si6), fula:si; se  
...
**sifa** ** ← araba:صفة (ṣifa), persa:صفت (sefat), hindia:सिफ़त (sifat), fula:siifa, svahila:haŭsa:sifa, turka:sıfat, malaja:sifat  
**sigare** ** ← angla:franca:cigarette, hispana:cigarillo, portugala:cigarro, rusa:сигарета (sigarteta), araba:(sījāra), mandarena:雪茄 (xǔejiā), vua:雪茄 (xi'gá), hindia:सिगरेट (sigreṭ), bengala:সিগারেট (śigareṭ), svahila:turka:sigara, haŭsa:sigari, fula:sigaari, amhara:ሲጃራ (siǧara)  
...
**silike** *silicio* ← angla:silicon, franca:silicium, hispana:silicio, portugala:silício, vjetnama:silic, hindia:सिलिकॉन, bengala:সিলিকন, malaja:silikon, svahila:silikoni, haŭsa:siliki, araba: سيلكون (silikōn)  
...
**sine** *brusto* ← persa: سینه‎ (sine) turka:sine, hindia:सीना (sīnā), bengala:সিনা (sinā), hispana:seno, franca:sein, latina:sinus  
...
**sir** ** ← araba: سِرّ (sirr), hindia:सेर (ser), malaja:sir, svahila:siri, haŭsa:asiri, fula:sirri, joruba:àṣírí, turka:sır, persa:(serr)  
**sirke** *cirklo* ← angla:circle, franca:cercle, hispana:portugala:círculo + deu:Zirkus, rusa:цирк (cirk), persa: سیرک‎ (sirk), hindia:सर्कस (sarkas), bengala:সার্কাস (sarkas), araba: سِيرْك‎ (sirk), japana:サーカス (sākasu), korea:서커스 (seokeoseu), vjetnama:xiếc, malaja:sirkus, turka:sirk  
**siro** *nul* ← araba: صِفْر‎ (ṣifr), svahila:sifuri, haŭsa:sifili, hindia:सिफ़र (sifar), malaja:sifar, angla:portugala:zero, franca:zéro, hispana:cero, rusa:зеро (zero), japana:ゼロ (zero), korea:제로 (jero), vjetnama:zêrô  
**sis** *fratino* ← angla:sister, deu:Schwester, rusa:сестра (sestra)  
**sis** *sibli* ← angla:hiss, deu:zischen, hispana:sisear, mandarena:咝 (sī), kantona:噝 (si1)  
**sisme** ** ← greka:σεισμός (seismós), angla:seism, hispana:sismo, franca:séisme, turka:sismik  
...
**site** *citi* ← angla:cite, hispana:portugala:citar, franca:citer, deu:zitieren, rusa:цитировать (citirovat’)  
**sivil** ** ← angla:civil, portugala:civil, hindia:सिविल (sivil), malaja:sipil  
**skandium** *skandio* ← angla:scandium, franca:scandium, hispana:escandio, portugala:escândio, rusa:скандий, mandarena:钪 (kàng), japana:スカンジウム, korea:스칸듐, vjetnama:scandi, hindia:स्काण्डियम, bengala:স্ক্যান্ডিয়াম, malaja:skandium, svahila:skandi, araba: سكانديوم  
**skope** ** ← angla:franca:-scope, hispana:portugala:-scopio, rusa:-скоп (skop), japana:スコープ (sukōpu), hindia:स्कोप (-skop), malaja:turka:-skop  
**skuter** ** ← angla:franca:hispana:scooter, rusa:скутер (skuter), mandarena:速克达 (sùkèdá), japana:スクーター (sukūtā), korea:스쿠터 (seukuteo), hindia:स्कूटर (skūṭar), bengala:স্কুটার (śkuṭar), malaja:skuter  
**sofa** *sofo* ← angla:franca:sofa, hispana:portugala:sofá, rusa:софа (sofa), mandarena:沙发 (shāfā), kantona:梳化 (so1faa32), japana:ソファ (sofa), korea:소파 (sopa), hindia:सोफ़ा (sofā)  
...
**soki** ** ← mandarena:搜 (sōu), kantona:搜 (sau1), vua:搜 (seu1), japana:捜索 (sōsaku) + angla:seek, deu:suchen + rusa:искать (iskat’)  
**sol** *suno* ← hispana:portugala:sol, franca:soleil, + hindia:सौर (sOr), teluga:(saur)  
**son** *filo* ← angla:son, deu:Sohn, rusa:сын (syn), sanskrita:सूनु (sūnu)  
**sona papi** ** ← angla:poppy, hispana:amapola, portugala:papoula, svahila:mpopi, hindia:पॉपी (pŏpī), bengala:পপি (papi), japana:ポピー (popī)  
**sona** *dormo* ← franca:sommeil, portugala:sono, rusa:сон (son), hindia:सोना (sonā), bengala:শোয়া (śoya) + araba: سِنَة (sina)  
**songi** *pino* ← mandarena:松 (sōng), vua:(son), taja:สน (sǒn), korea:솔 (sol), vjetnama:thông, + rusa:сосна (sosna)  
**soni** *sono* ← angla:sonic, franca:son, hispana:son,sonido, portugala:som, itala:suono, + korea:소리 (sori) + mandarena:声 (shēng), vua:声 (sən)  
**sorbe** ** ← hispana:sorber, portugala:sorver, rusa:сёрбать (syorbatʹ), angla:absorb, franca:absorber  
**sos** *saŭco* ← angla:franca:sauce, deu:Soße, rusa:соус (sous), persa: سس‎ (sos), hindia:सॉस (sos), bengala:সস (śôś), japana:ソース (sōsu), korea:소스 (soseu), vjetnama:xốt, malaja:saus, turka:sos  
**sosia** *socio* ← rusa:социум (socium), angla:society, franca:société, hispana:sociedad, portugala:sociedade, deu:sozial, malaja:sosial  
...
**stan** ** ← hindia:स्थान (sthān), rusa:стан (stan), persa:ـستان (-estān)  
**state** *stacio* ← angla:stand; static, deu:stehen; statisch, franca:statique, hispana:portugala:estático, rusa:стоять (stoyat'); статический (statičeskiy), malaja:statis, turka:istasyon, hindia:स्टेशन (sṭeśan), bengala:স্টেশন (śṭeśôn)  
**stude** ** ← angla:study, franca:étudier, hispana:estudiar, portugala:estudar, rusa:студент (student), hindia:स्टूडेंट (sṭūḍeṇṭ)  
**su** *propra (poseda partiklo)* ← angla:’s, deu:ned:-s, afr:se + franca:son;sa, hispana:su, portugala:seu  
**sual** *demando* ← araba: سؤال (su'āl), persa: سؤال‎ (so'âl), hindia:सवाल (savāl), bengala:সওয়াল (śôwal), malaja:soal, svahila:swali, turka:sual + kmera:សួរ (suə)  
**suan** *acida* ← mandarena:酸 (suān), kantona:酸 (syun1), vua:酸 (soe1), japana:酸 (san), korea:산 (san), vjetnama:toan  
**suba** *mateno* ← araba:(ṣabāḥ), turka:sabah, persa:(sobh), urdua:(subah), hindia:सुबह (subah), svahila:asubuhi, haŭsa:asuba, fula:subaka  
...
**sukar** *sukero* ← angla:sugar, franca:sucre, hispana:azúcar, portugala:açúcar, araba: سُكَّر (sukkar), hindia:शक्कर (śakkar), bengala:শর্করা (śôrkôra), malaja:sakar, haŭsa:svahila:sukari, fula:sukar, turka:şeker, tamila:சக்கரை (cakkarai)  
...
**suna** ** ← araba: سُنَّة (sunna), hindia:सुन्नत (sunnat), bengala:সুন্নাহ (śunnah), svahila:suna + angla:malaja:sunnah, franca:hispana:sunna, portugala:suna, rusa:сунна, turka:sünnet  
...
**super** *bonega* ← angla:franca:super, hispana:portugala:súper, japana:スーパー (sūpā)  
**supriza** *surprizo* ← angla:surprise, turka:sürpriz, persa:(surpris), rusa::сюрприз (siurpriz), portugala:surpresa, hispana:sorpresa  
**susan** ** ← araba: سَوْسَن‎ (sawsan), hispana:azucena + angla:Susan, portugala:Susana, franca:Suzanne, polona:Zuzana, rusa:Сусанна (Susanna)  
**sute** ** ← mandarena:术 (shù), kantona:術 (seot6), japana:術 (jutsu), korea:술 (sul)  
**sutur** ** ← franca:angla:suture, portugala:hispana:sutura  
**suxi** *suŝio* ← japana:寿司 (sushi), mandarena:寿司 (shòusī), kantona:壽司 (sau6si1), korea:스시 (seusi), deu:angla:franca:hispana:portugala:sushi, rusa:суши (sushi), persa: سوشی‎ (suši), hindia:सुशी (suśī), bengala:সুশি (śuśi), turka:suşi, araba: سُوشِي‎ (sūšī)  
**ta** ** ← rusa:-та (-ta), hindia:-ता (-tā) + franca:-ité, hispana:-idad, portugala:-idade, itala:-ità, malaja:-itas  
**tabake** *tabako* ← deu:Tabak, rusa:табак (tabak), franca:tabac, hispana:portugala:tabaco, japana:タバコ (tabako), angla:tobacco, araba:تَبْغ‎ (tabḡ), persa:تنباکو‎ (tanbâku), turka:tömbeki, hindia:तंबाकू (tambākū), bengala:তামাকু (tāmāku), malaja:tembakau, svahila:mtubaku, haŭsa:taba  
**tabe** ** ← araba:طبيعة (ṭabīʿa), persa:طبیعت‎ (tabi'at), hindia:तबीयत (tabīyat), bengala:তবিয়ত (tôbiyôt), svahila:tabia, fula:dabia, haŭsa:tsabi'a, turka:tabiat  
**table** ** ← angla:table, franca:tableau, hispana:tabla, rusa:табличка (tablichka), malaja:tabel, turka:tablo, fula:volofa:taabal  
**tai** ** ← mandarena:台 (tái), kantona:臺 (toi4), japana:台 (dai), vjetnama:đài, korea:대 (dae) + angla:dais  
...
**tala** *fermilo (seruro)* ← hindia:ताला (tālā), bengala:তালা (tala), teluga:తాళము (tāḷamu)  
**talium** *talio* ← angla:thallium, franca:thallium, hispana:talio, portugala:tálio, rusa:таллий, mandarena:铊 (tā), japana:タリウム, korea:탈륨, vjetnama:tali, hindia:थैलियम, bengala:থ্যালিয়াম, malaja:tallium, svahila:tali, araba: ثاليوم  
...
**tanke** ** ← angla:tank, deu:Tank, hispana:tanque, hindia:टंकी (ṭaṅkī), malaja:tangki, svahila:tangi, japana:タンク (tanku), korea:탱크 (taengkeu), vjetnama:tăng  
**tantalium** *tantalo* ← angla:tantalum, franca:tantale, hispana:tántalo, portugala:tântalo, rusa:тантал, mandarena:钽 (tǎn), japana:タンタル, korea:탄탈, vjetnama:tantali, hindia:टाण्टलम, bengala:ট্যান্টালাম, malaja:tantalum, svahila:tantali, araba: تنتالم  
**tanur** *forno* ← persa:heb:tanur, araba:(tannūr), angla:tandoor, athanor, turka:tandır, hindia:तनूर (tanūr), urdua:(tanūr), panĝaba:ਤੰਦੂਰ (tandūr), svahila:tanuri, haŭsa:tanda  
**tape** ** ← angla:tap, deu:Zapfen, hispana:turka:tapa, portugala:tampa, greka:τάπα (tapa), bul:тапа (tapa)  
**tarif** ** ← angla:tariff, hispana:portugala:tarifa, deu:franca:turka:tarif, araba:(taʿrīf), rusa:тариф (tarif), hindia:टैरिफ़ (ṭairif)  
**tasa** *plado* ← araba: طَاس (ṭās), haŭsa:taasaa, svahila:tasa, fula:taasal, turka:tas, franca:tasse, hispana:taza, rusa:таз, hindia:तश्तरी (tashtarī)  
**tatu** *tatuo* ← sam:tah:tatau, haw:kākau, malaja:filipina:tato, angla:tattoo, franca:tatouage, hispana:tatuaje, portugala:tatuagem, rusa:тату (tatu)  
**tava** *pato* ← persa: تاوه‎ (tâve), hindia:तवा (tavā), araba: طاوة‎ (ṭāwa), turka:scr:tava  
**taxe** ** ← angla:deu:hispana:taxo-, franca:portugala:taxi-, rusa:-таксис (-taksis), persa: تاکتیک‎ (tâktik), malaja:taktik  
...
**taza** *freŝa* ← persa: تازه (tâze), hindia:ताज़ा (tāzā), bengala:তাজা (taja), turka:taze, araba: طَازَج (ṭāzaj)  
...
**tege** *briko* ← lat:tegula, itala:tegola, angla:tile, deu:Ziegel, franca:tuile, hispana:teja, portugala:telha, hindia:टाइल (ṭāila), bengala:টালি (ṭali), japana:タイル (tairu), korea:타일 (tail), araba: طَجِين‎  (ṭajīn), turka:tuğla; tajine  
...
**tehnetium** *teknecio* ← angla:technetium, franca:technétium, hispana:tecnetio, portugala:tecnécio, rusa:технеций, mandarena:锝 (dé), japana:テクネチウム, korea:테크네튬, vjetnama:tecnexi, hindia:टेक्निशियम, bengala:টেকনিসিয়াম, malaja:teknetium, svahila:tekineti, araba: تكنيتيوم  
**tela** ** ← hispana:portugala:filipina:tela, franca:toile + angla:towel, hindia:तौलिया (tauliyā), tamila:துவாலை (tuvālai), svahila:taulo, haŭsa:tawul, japana:タオル (taoru), malaja:tuala  
**tele** *malproksima* ← angla:hispana:portugala:malaja:tele-, franca:télé-, rusa:теле- (tele-)  
**telurium** *teluro* ← angla:tellurium, franca:tellure, hispana:telurio, portugala:telúrio, rusa:теллур, mandarena:碲 (dì), japana:テルル, korea:텔루르, vjetnama:telu, hindia:टेलुरियम, bengala:টেলুরিয়াম, malaja:telurium, svahila:teluri, araba: تيلوريوم  
...
**tenesium** *teneso* ← angla:franca:portugala:malaja:tennessine, hispana:teneso, rusa:теннессин, japana:テネシン, korea:우눈셉튬  
**tense** ** ← angla:tense, franca:tendu, hispana:portugala:tenso  
**tenta** ** ← angla:tempt, hispana:portugala:tentar, franca:tenter  
...
**tera** ** ← angla:franca:hispana:portugala:malaja:turka:tera-, rusa:тера- (tera-), japana:テラ (tera), korea:테라- (tera-)  
**terbium** *terbio* ← angla:terbium, franca:terbium, hispana:terbio, portugala:térbio, rusa:тербий, mandarena:铽 (tè), japana:テルビウム, korea:테르븀, 2터븀, vjetnama:tecbi, hindia:टर्बियम, bengala:টার্বিয়াম, malaja:terbium, svahila:taribi, araba: تربيوم  
**terca** ** ← hispana:torcido, portugala:torto, hindia:तिरछा (tirachha), bengala:তেরছা (tērachā), pan:तिरकस (tirakasa)  
**tere** *timo (teroro)* ← angla:hispana:portugala:terror, franca:terreur + rusa:терроризм (terrorizm), japana:テロリズム (terorizumu), korea:테러리즘 (tereorijeum), malaja:terorisme  
**terme** ** ← deu:angla:franca:thermo-, hispana:portugala:termo-, rusa:термо- (termo-)  
...
**titanium** *titanio* ← angla:titanium, franca:titane, hispana:titanio, portugala:titânio, rusa:титан, mandarena:钛 (tài), japana:チタン, korea:타이타늄, vjetnama:titan, hindia:टाइटानियम, bengala:টাইটেনিয়াম, malaja:titanium, svahila:titani, araba: تيتانيوم  
...
**tole** ** ← angla:tolerate, hispana:portugala:tolerar, franca:tolérer, deu:tolerieren, sve:tåla, dan:nor:tåle  
...
**ton** *tono* ← angla:tone, deu:Ton, franca:ton, hispana:tono, portugala:tom, rusa:тон (ton), hindia:तान (tān), svahila:kitone  
...
**tope** *regiono* ← angla:franca:hispana:portugala:turka:malajala:topo-, rusa:топо- (topo-)  
...
**tortuga** ** ← angla:tortoise, hispana:tortuga, portugala:tartaruga, franca:tortue  
**toxe** ** ← angla:toxic, franca:toxique, hispana:portugala:tóxico, rusa:токсичний (toksicniy), malaja:toksik + mandarena:毒 (dú), kantona:毒 (duk6), vua:毒 (do’), japana:毒 (doku/toku), korea:독 (dok), vjetnama:độc  
**tra** ** ← itala:tra, angla:through, hispana:tras, portugala:(a)trás, franca:deu:malaja:trans-, rusa:транс- (trans-)  
**tragike** ** ← angla:tragic, franca:tragique, hispana:portugala:trágico, rusa:трагический (tragičeskij)  
**trate** *treni* ← hispana:traer + angla:tractor, franca:tracteur, portugala:trator, rusa:трактор (traktor), araba: تَرَاكْتُور‎ (tarāktūr), japana:トラクター (torakutā), korea:트랙타 (teuraekta), hindia:ट्रैक्टर (ṭraikṭar), bengala:ট্র্যাক্টর (ṭrækṭôr), malaja:traktor, svahila:trekta, turka:traktör  
**trati** ** ← angla:treaty, franca:traité, hispana:portugala:tratado, rusa:контракт (kontrakt), turka:kontrat, malaja:kontrak  
**tren** *trajno (vagonaro)* ← angla:franca:train, hispana:turka:tren, portugala:trem, persa: ترن‎ (tran), hindia:ट्रेन (ṭren), bengala:ট্রেন (ṭren), svahila:treni  
**trepe** *ŝtuparo* ← deu:Treppe, ned:trap, rusa:трап (trap), malaja:terap, japana:タラップ (tarappu) + hispana:portugala:trepar  
**tri** *tri (3)* ← angla:three, franca:trois, hispana:tres, portugala:três, rusa:три (tri), hindia:त्रि-  (tri-), bengala:ত্রি- (tri-), malaja:tri-  
**truke** ** ← angla:trick, deu:Trick, franca:truc, hispana:truco, portugala:truque, hungara:trükk, rusa:трюк (tr’uk)  
**tu** *vi (ci)* ← deu:du, franca:portugala:tu, hispana:tú, rusa:ты (ty), persa: تو‎ (to), hindia:तू (tū), bengala:তুই (tui)  
...
**tube** *tubo* ← hispana:portugala:tubo, angla:franca:tube, japana:チューブ (chūbu), zulua:ithumbu, xho:íthumbu  
...
**tuh** *sputi* ← hindia: थूकना (thūknā), mandarena: 吐 (tǔ), turka:tükürmek, fula:tuutde  
**tulium** *tulio* ← angla:thulium, franca:thulium, hispana:tulio, portugala:túlio, rusa:тулий, mandarena:铥 (diū), japana:ツリウム, korea:툴륨, vjetnama:tuli, hindia:थुलियम, bengala:থুলিয়াম, malaja:tulium, svahila:thuri, araba: ثليوم  
**tulpan** ** ← angla:malaja:tulip, franca:tulipe, deu:Tulpe, hispana:tulipá, portugala:túlipa, nld:tulp, rusa:тюльпан (t’ul’pan), araba:توليب (tūlīb), hindia:ट्यूलिप (ṭyūlip), may:tulip, japana:チューリップ (chūrippu), korea:튤립 (tyullip)  
**tuna** ** ← angla:tuna, franca:thon, hispana:atún, rusa:тунец (tunec), japana:ツナ (tsuna), hindia:टूना (tuna), araba: تُونَة (tuna)  
...
**tung** ** ← mandarena:油桐 (yóutóng), kantona:油桐 (yau4tung4), angla:tung tree, franca:tung, portugala:tungue, rusa:тунг  
**tupi** *ĉapelo* ← malaja:topi, hindia: टोपी (ṭopī), bengala:টুপি (ṭupi), tamila:தொப்பி (toppi)  
**tur** ** ← angla:deu:hispana:tour, franca:tournée, portugala:turnê, rusa:турне (turne), malaja:tur, japana:ツアー (tsuā), korea:투어 (tueo), mandarena:旅途 (lǚtú)  
...
**tuzi** ** ← mandarena:兔子 (tùzi), kantona:兔仔 (tou3zai2), korea:토끼 (tokki), vjetnama:thỏ, taja:เถาะ (tho)  
...
**umami** ** ← japana:旨味 (umami), korea:우마미 (umami), angla:franca:portugala:hispana:malaja:umami, rusa:умами (umami)  
**umur** *aĝo* ← araba: عُمُر‎ (ʿumur), persa: عمر (omr), hindia:उमर (umar), bengala:ওমর (omôr), svahila:umri, malaja:umur, turka:ömür  
**un** *unu (1)* ← franca:un, hispana:uno, portugala:um,una, angla:one  
**unabe** ** ← araba: عُنَّاب‎ (ʕunnāb), persa: عناب‎ ('annâb), rusa:унаби (unabi), turka:hünnap  
...
**va** *ŭaŭ!* ← angla:wow, franca:ouah, mandarena:哇 (wā), kantona:嘩 (waa1), japana:わあ (wā), korea:와 (wa), hindia:वाह (vāh), malaja:wah, fula:wai  
**vaf** *hundo* ← angla:woof, franca:ouaf, rusa:гав (gav), turka:hav, mandarena:汪 (wāng), japana:ワン (wan)  
**vafle** *vaflo* ← angla:waffle, deu:Waffel, rusa:вафля (vaflya), mandarena:窝夫 (wōfū), kantona:華夫 (waa4fu1), japana:ワッフル (waffuru), korea:와플 (wapeul)  
...
**vakil** ** ← araba: وكيل‎ (wakīl), persa: وکیل‎ (vakil), hindia:वकील (vakīl), bengala:উকিল (ukil), tamila:வக்கீல் (vakkīl), malaja:wakil, turka:vekil, svahila:haŭsa:wakili, amhara:ወኪል (wäkil)  
...
**valve** *krano (valvo)* ← angla:franca:valve, hispana:portugala:válvula, hindia:वाल्व (vālv), japana:バルブ (barubu), korea:밸브 (baelbeu), kantona:嘩佬 (waa1 lou2), svahila:valvu, turka:valf  
...
**vanadium** ** ← angla:vanadium, franca:vanadium, hispana:vanadio, portugala:vanádio, rusa:ванадий, mandarena:钒 (fán), japana:バナジウム, korea:바나듐, vjetnama:vanađi, hindia:वनेडियम, bengala:ভ্যানাডিয়াম, malaja:vanadium, svahila:vanadi, araba: فناديوم  
**vanila** ** ← angla:vanilla, hispana:vainilla, portugala:baunilha, franca:vanille, rusa:ваниль (vanil’), kantona:云呢拿 (wan4 ni1 laa4-2), japana:バニラ (banira), korea:바닐라 (banilla), vjetnama:vani, turka:vanilya  
**vanu** *amuzo* ← mandarena:玩 (wán), kantona:玩 (waan4), cjy:玩 (van1), korea:완 (wan)  
**vari** ** ← angla:various, hispana:vario, portugala:vário, franca:varier, deu:variieren  
**varis** *rizo* ← tamila:அரிசி (arisi), teluga: వరి (vari), malajala:vary, malaja:beras, otb:འབྲས ('bras), persa: برنج‎ (berenj), araba: أَرُزّ‎ (ʾaruzz), hispana:portugala:arroz, franca:riz, angla:rice, deu:Reis, rusa:рис (ris), oroma:ruuzii  
**varite** ** ← araba: وَرَثَ‎ (waraṯa), persa: وارث‎ (vâres), hindia:वारिस (vāris), malaja:waris, svahila:-rithi, turka:vâris + angla:inherit, franca:hériter, hispana:heredar  
**vasin** ** ← angla:vaccine, hispana:vacuna, portugala:vacina, rusa:вакцина (vakcina), hindia:वैक्सीन (vaiksīn), japana:ワクチン (wakuchin), malaja:vaksin  
...
**vaxi** *lavi* ← angla:wash, deu:waschen, mandarena:洗 (xǐ)  
**vazir** *ministro* ← araba: وَزِير‎ (wazīr), persa: وَزیر‎ (vazir), hindia:वज़ीर (vazīr), bengala:উজির (ujir), turka:vezir, svahila:malaja:wazir + angla:vizier, deu:Wesir, franca:portugala:vizir, hispana:visir, rusa:визирь (vizir')  
**vei** ** ← mandarena:纬 (wěi), kantona:緯 (wai6), korea:위 (wi), vjetnama:vĩ  
**vel** ** ← eng;veil, franca:voile, hispana:velo, portugala:véu, japana:ベール (bêru), korea:베일 (beil), svahila:veli  
...
**veranda** *verando (balkono)* ← hindia:बरामदा (barāmd), tamila:வராந்தா (varāntā), portugala:varanda, malaja:beranda, angla:veranda, rusa:веранда (veranda), japana:ベランダ (beranda), korea:베란다 (beranda), svahila:varanda  
**verme** ** ← angla:worm, hispana:portugala:verme, franca:ver, deu:Wurm  
**verse** ** ← angla:versus, franca:verse, hispana:portugala:versar + rusa:версия (versiya), malaja:versi  
**veruke** *veruko* ← angla:verruca, franca:verrue, hispana:portugala:verruga  
...
**vidua** *vidvo* ← angla:widow, hispana:viudo, portugala:viúvo, franca:veuve, deu:Witwe, rusa:вдова (vdova), hindia:विधवा (vidhavā), bengala:বিধবা (bidhabā), teluga:విధవ (vidhava)  
**vijing** ** ← mandarena:味精 (wèijīng), kantona:味精 (mei6 zing1), vjetnama:mì chính, malaja:vetsin,micin, filipina:bitsin  
**viki** ** ← angla:franca:hispana:portugala:malaja:wiki, turka:viki, araba:وِيكي‎ (wikī), persa:ویکی‎ (viki), hindia:विकि (viki), bengala:উইকি (uiki), mandarena:维基 (wéijī), kantona:維基 (wai4 gei1), japana:ウィキ (wiki), korea:위키 (wiki)  
**vilde** ** ← deu:angla:ned:wild, sve:vild  
...
**vote** ** ← angla:franca:vote, hispana:portugala:voto, deu:Votum, rusa:вотум (votum), hindia:वोट (voṭ), bengala:ভোট (bhōṭ)  
...
**xakal** *ŝakalo* ← persa: شغال‎ (šağâl), turka:çakal, angla:jackal, franca:hispana:portugala:chacal, rusa:шакал (šakal), bengala:শৃগাল (śrigal), malaja:jakal, japana:ジャッカル (jakkaru), korea:자칼 (jakal), haŭsa:jakkali  
**xake** *dubo* ← araba: شَكَّ‎ (šakka), persa: شک‎ (šak), hindia:शक (śak); शंका (śankā), malaja:syak; sangka, turka:şek, svahila:shaka; -shuku, haŭsa:shakka  
...
**xatan** *diablo (Satano)* ← heb: שָׂטָן‎ (śaṭan), araba:(šayṭān), angla:franca:deu:vjetnama:Satan, hispana:Satán, portugala:Satã, rusa:Сатана (Satana), mandarena:撒但 (Sādàn), kantona:撒但 (saat3daan6), korea:사탄 (satan), japana:サタン (satan), hindia:शैतान (śaitān), tamila:சயித்தான் (cayittāṉ), malaja:Setan, turka:şeytan, svahila:Shetani, haŭsa:shaidan  
**xava** ** ← araba: شَوَى‎ (šawā) + mandarena:烧 (shāo), kantona:燒, (siu1)  
**xaxa** ** ← mandarena:(shasha), rusa:шуршать (shurshat’), svahila:-chakacha  
**xayu** *ŝarko* ← mandarena:鲨鱼 (shāyú), kantona: 鯊魚  (saa1 jyu4-2), korea:상어 (sang'eo), japana:鮫 (same) + malaja:hiu; yu  
**xe hal** *situacio (aferstato)* ← mandarena:事态 (shìtài), kantona:事態 (si6taai3), japana:事態 (jitai), angla:state of affairs, franca:état des choses  
**xe** ** ← araba:(šayʾ), turka:şey, + mandarena:事 (shì), kantona:事 (si6)  
**xefe** *estro (ĉefulo)* ← franca:chef, portugala:chefe, hispana:jefe, rusa:шеф (šef), angla:chief, svahila:chifu, japana:チーフ (chīfu) + araba: شَيْخ‎ (šayx), swa:shehe, bengala:শেখ (śekh), turka:şeyh  
...
**xipi** ** ← mandarena:濕 (shī), kantona:濕 (sap1), vua:濕 (seq4), japana:濕 (shitsu), korea:습 (seup)  
...
**xirope** *siropo* ← araba:(šarāb), portugala:xarope, angla:syrup, deu:Sirup, franca:sirop, hispana:jarabe; sirope, rusa:сироп (sirop), persa: شیره‎ (fa) (šire), hindia:शर्बत (śarbat), bengala:শীরা (śira), turka:şurup, japana:シロップ (shiroppu), korea:시럽 (sireop), vjetnama:xi-rô, svahila:shira  
**xite** *merdo* ← angla:shit, mandarena:屎 (shǐ), kantona:屎 (si2)  
**xiti bai** *malsukceso* ← mandarena:失败 (shībài), japana:失敗 (shippai), korea:실패 (šilpæ), vjetnama:thất bại  
**xiti** ** ← mandarena:失 (shī), japana:失 (shitsu), korea:실 (šil), vjetnama:thất  
**xiu** *malgranda* ← mandarena:小 (xiǎo), kantona:小 (siu2), japana:小 (shō), korea:소 (so), vjetnama:tiểu  
**xix** ** ← turka:şiş + angla:shish-, rusa:шиш- (šiš-)  
**xixa** ** ← persa: شیشه (šiše), hindia:शीशा (śīśā), teluga:సీసా (sīsā), turka:şişe, araba: شيشة‎ (šīša) + angla:shisha, deu:Schischa, franca:chicha, portugala:xixa  
...
**xope** ** ← angla:franca:hispana:shopping, japana:ショッピング (shoppingu), korea:쇼핑 (syoping), taja:ชอปปิ้ง (chop-bing), rusa:шоппинг (šopping), mandarena:血拼 (xuèpīn)  
**xou** *montri (ekspozicii)* ← angla:deu:franca:hispana:portugala:show, rusa:шоу (šou), turka:şov, svahila:shoo, korea:쇼 (syo), japana:ショー (shō), mandarena:秀 (xiù), kantona:騷 (sou1)  
**xukre** *danko* ← araba: شُكْر‎ m (šukr), hindia:शुक्र (śukr), bengala:শোকর (śokôr), svahila:-shukuru, turka:şükür  
**xulekan** *lernejo* ← mandarena:学 (xué) + deu:Schule, svahila:shule + angla:school, franca:école, hispana:escuela, portugala:escola, rusa:школа (škola), bengala:স্কুল (śkul), malaja:sekolah + hindia:पाठशाला (pāṭhśālā), marataja:शाळा (śāḷā), tamila:பாடசாலை (pāṭasālai)  
...
**ya** *jes* ← angla:yeah, deu:ja, korea:예 (ye), malaja:ya  
**yake** ** ← korea:약 (yak), japana:約 (yaku), kantona:約 (yœk), turka:yaklaşık, mandarena:约 (yuē)  
**yaku** ** ← tib:གཡག (g-yag), angla:deu:franca:hispana:turka:yak, portugala:iaque, rusa:як (iak), hindia:याक (yāk)  
**yam** *manĝi (trinki)* ← kmera:ញ៉ាំ (nyam), fula:nyaamude + hispana:ñam, rusa:ням (nyam), itala:gnam, angla:yum, korea:냠냠 (nyamnyam), hungara:nyam  
...
**yatim** ** ← araba: يَتِيم‎ (yatīm), persa: یتیم‎ (yatim), turka:yetim, malaja:yatim, svahila:yatima, hindia:यतीम (yatīm), bengala:এতিম (etim), tamila:எத்தீம் (ettīm), fula:alyatiimu  
...
**yoke** *jado* ← mandarena:玉 (yù), kantona:玉 (yuk6), nan:玉 (gio̍k), japana:玉 (gyoku), vjetnama:ngọc (玉), korea:옥 (ok), malaja:giok, taja:หยก (yok), kmera:យក់ (yuək)  
...
**yuge** ** ← angla:yoke, hispana:yugo, portugala:jugo, franca:joug, rusa:иго (igo), persa:  یوغ‎ (yuğ) + deu:Junktion + kantona:軛 (aak1), vjetnama:ách  
...
**zai** ** ← mandarena:在 (zài), kantona:在 (zoi6), japana:在 (zai), vjetnama:tại  
**zalime** ** ← araba: ظَالِم‎ (ẓālim), persa: ظالم‎ (zâlem), hindia:ज़ालिम (zālim), turka:malaja:zalim, svahila:dhalimu, haŭsa:zalumci  
**zaman** *tempo* ← malaja:jam, araba: زَمَن‎ (zaman), haŭsa:svahila:zamani, fula:jamaanu, turka:zaman, persa: زمان‎ (zamân), hindia:समय (samay), bengala:সময় (sômyô)  
**zange** *kreski* ← mandarena:长 (zhǎng); 增加 (zēng), kantona:增 (zang1), korea:장 (jang), vjetnama:tăng  
**zar** *hazardo* ← araba: زَهْر (zahr), turka:zar, persa: زار (zâr) + angla:hazard, hispana:portugala:azar, haŭsa:hazari  
**zebra** *zebro* ← angla:deu:portugala:turka:malaja:zebra, franca:zèbre, hispana:cebra, rusa:зебра (zebra), hindia:ज़ेब्रा (zebrā), bengala:জেবরা (jebra), japana:ゼブラ (zebura)  
**zelo** ** ← greka:ζῆλος (zêlos), angla:zeal; jealous, franca:jaloux, hispana:celos, portugala:zelo  
**zeta** ** ← angla:franca:hispana:portugala:zetta-, malaja:zeta-, japana:ゼタ- (zeta-), korea:제타- (jeta-), mandarena:泽它- (zétā-)  
**zete** *oleo* ← araba: زَيْت‎ (zayt), hispana:portugala:aceite  
**zetun** *olivo* ← araba: زَيْتُون‎ (zaitūn), hispana:aceituna, malaja:zaitun, svahila:zeituni, turka:zeytin, haŭsa:swa:zaituni, persa: زیتون‎ (zeytun), hindia: ज़ैतून (zaitūn), bengala:জয়তূন (zôẏtūn), tamila:சைதூண் (caitūṇ)  
**zeze** ** ← svahila:nzi, sot:ntsintsi, lingala:konga:nzinzi, igba:ijiji, joruba:eṣinṣin + angla:tsetse, franca:portugala:tsé-tsé, rusa:цеце (tsetse), turka:çeçe, mandarena:采采蝇 (cǎicǎiyíng)  
**zi** ** ← mandarena:字 (zì), kantona:字 (zi6), japana:字 (ji), korea:자 (ja)  
**zikura** ** ← araba: زِقُّورَة‎ (ziqqūra), angla:turka:ziggurat, deu:Zikkurat, franca:ziggourat, hispana:zigurat, portugala:zigurate, rusa:зиккурат (zikkurat), mandarena:金字形神塔, japana:ジッグラト (jiggurato), korea:지구라트 (jigurateu)  
**zina** *malfideleco* ← araba: زِنَاء‎ (zināʾ), malaja:turka:haŭsa:zina, fula:jinaa, svahila:zinaa, persa: زنا‎ (zenā)  
...
**zira** *kumino* ← persa: زیره‎ (zire), hindia:ज़ीरा (zīrā), bengala:জিরা (zīra), tamila:சீரகம் (sīrakam), rusa:зира (zira), mandarena:孜然 (zīrán), svahila:mjira  
**zirafa** *ĝirafo* ← persa: زرناپا‎ (zornâpâ), araba: زَرَافَة (zarāfa), turka:zürafa, deu:angla:franca:giraffe, portugala:girafa, hispana:jirafa, rusa:жираф (žiraf),malaja:zirafah; jerapah, korea:지라프 (jirapeu), hindia: जिराफ़ (jirāf), bengala:জরৈফ (jôrôph)  
...
**zoku** ** ← vua:续 (zoq), kantona:續 (zuk6), japana:続 (zoku), korea:속 (sok), vjetnama:kế tục  
...
**zukam** *malvarmumo* ← araba:زُكَام‎ (zukām), hindia:ज़ुकाम (zukām) + mandarena:感(冒) (gǎn(mào)), kantona:感冒 (gam2mou6), japana:感(冒) (kan(bō)), korea:감(기) (gam(gi)), vjetnama:cảm  
