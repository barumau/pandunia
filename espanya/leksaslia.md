...
|----------|----------|----------|
|**a**|el (la)|por:a, ara:a(l), tel:ఆ (ā), tam:அது (atu)|
...
|**ai ja**|amante (enamorado)|ara: حُبّ (ḥubb), swa:huba, hin:मुहब्बत (muhabbat), ben:মহব্বত (môhôbbôt)|
|**ai**|amor|zho:爱 (ài), yue:愛 (oi3), jpn:愛 (ai), vie:ái, kor:애 (ae)|
...
|**au**|ay!|eng:ow, spa:ay, por:ai, fra:aïe, zho:哎 (ai), kor:아야 (aya), fas:(ây), rus:ай (ay)|
|**audi**|oír (escuchar)|eng:spa:fra:audio, por:áudio|
|**auro**|oro|ltn:aurum, por:ouro, spa:oro, fra:or, rus:аурум (aurum), may:aurum|
...
|**ba**|padre (papá)|por:pai + zho:爸 (bà)  + eng:fra:papa, spa:papá, rus:папа (papa), ara:(bābā), jpn:パパ (papa), kor:아빠 (appa), hin:बाप (bāp),  ben:বাবা (baba), may:bapa, swa:tur:baba|
...
|**brauza gi**|navegador|eng:browser, deu:Browsre, rus:браузер (brauzer), hin:ब्राउज़र (brauzar), ben:ব্রাউজার (brā'ujāra), jpn:ブラウザ (burauzā)|
|**brauza program**|explorador|eng:browser, deu:Browsre, rus:браузер (brauzer), hin:ब्राउज़र (brauzar), ben:ব্রাউজার (brā'ujāra), jpn:ブラウザ (burauzā)|
...
|**chatre**|cuatro (4)|rus:четыре (chetyre), hin:चार (cār), ben:চার (car), may:catur + fra:quatre, spa:cuatro, por:quatro|
|**chau**|césped (hierba)|zho:草 (cǎo), yue:草 (cou2), wuu:草 (tshau2), jpn:草 (sō), vie:tháu|
...
|**duka ta**|pena (tristeza)|hin:दुःख (duḥkh), ben:দুঃখ (dukhô), tha:ทุกข์ (tuk), may:duka, eng:dukkha|
|**duku**|leer|zho:读 (dú), yue:讀 (duk6), vie:đọc, zha:dog, jpn:(doku-)|
...
|**feru**|hierro|spa:hierro, por:ferro, fra:fer, may:ferum|
...
|**icha**|voluntad|vie:ý chí, zho:意志 (yìzhì), kor:(uiji), jpn:(ishi), + hin:इच्छा (icchā), tel:ఇచ్చ (icca)|
...
|**kane**|barra (vara, palo)|eng:cane, fra:canne, zho:杆 (gǎn),|
...
|**kasha**|caja (caja registradora)|deu:Kasse, rus:касса (kassa), eng:case,cash, swa:kasha, por:caixa, spa:caja|
...
|**kirate**|quilate|ara: قِيرَاط‎ (qīrāṭ), eng:fra:carat, spa:por:quilate, rus:карат (karat), zho:克拉 (kèlā), jpn:カラット (karatto), kor:캐럿 (kaereot), may:karat, tur:kırat|
...
|**lal**|rojo|hin:लाल (lāl), ben:লাল (lal), tur:al|
...
|**lezi**|pera|zho:梨子 (lízi), yue:梨 (lei42), vie:lê,|
...
|**manioka**|yuca (mandioca)|eng:fra:manioc, spa:por:mandioca, rus:манио́ка (manióka)|
|**manira**|comportamiento (conducta)|fra:manière, eng:manner, rus:манера (manyera), jpn:マナー (manā), spa:manera, por:maneira, deu:Manieren|
...
|**name**|nombre|hin:नाम (nām), fas:pnb:urd:(nām), tha:นาม (naam), may:nama, deu:eng:name, jpn:名前 (namae), fra:nom|
...
|**pase**|paz|ita:pace, eng:peace, spa:por:paz, fra:paix|
...
|**perisha**|perecer|eng:perish, fra:périr, spa:por:perecer + fas: پریش‎ (parêš), tur:perişan, hin:परेशान (pareśan)|
...
|**sen**|cien (100)|fra:cent, spa:cien, por:cem|
...
|**serebro**|cerebro|eng:cerebrum, spa:cerebro, por:cérebro, fra:cerveau|
...
|**sete**|siete (7)|spa:siete, por:sete, fra:sept, hin:सात (sāt), ben:সাত (sat)|
...
|**siro**|cero (ninguno)|ara: صِفْر‎ (ṣifr), swa:sifuri, hin:सिफ़र (sifar), eng:por:zero, fra:zéro, spa:cero|
|**sis**|seis (6)|zho:六 (liù), jpn:六 (roku), kor:육/륙 (六, yuk/ryuk), vie:lục|
...
|**unike**|único (únicamente, solo)|eng:fra:unique, spa:por:único, rus:уникальный (unikal’nyj)|
...
|**use**|usar (aplicar)|eng:use, fra:user, spa:por:usar, pol:używać|
