...
**fun cupa gi** *aspiradora* ← zho:吸尘器 (xīchénqì), deu:Staubsauger  
...
**mesaje** *mensagem* ← eng:deu:fra:message, spa:mensaje, por:mensagem, tur:mesaj, jpn:メッセージ (messēji), kor:메시지 (mesiji), rus:месседж (messedzh), may:mesej  
...
**miti** *enviar (transmitar)* ← eng:emit, fra:émettre, spa:por:remitir, may:emisi, deu:Mission, rus:миссия (missiya) + tur:komisyon, hin:कमीशन (kamīśan), ben:কমিশন (kômiśôn)  
