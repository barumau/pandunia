...
**a kon** *juntos* ← zho:共 (gòng), yue:共 (gung4), kor:공 (gong), vie:cộng, jpn:共 (kyō-), eng:fra:spa:por:con-  
**a** *en (a)* ← fra:à, spa:por:a, eng:a-,ad-, rus:а-  
**abe** ** ← eng:fra:spa:por:ab- + rus:апо- (apo-)  
**abete** *abeto* ← spa:por:abeto  
**acar** *encurtir* ← fas:آچار (âčâr), hin:अचार (acār), ara:اچار‎ (əčar), eng:por:achar, swa:achari, may:acar  
...
**Atlante Hai** *océano Atlántico* ← eng:Atlantic, spa:Atlántico, por:Atlântico, rus:Атлантический океан (Atlanticheskyy okean), swa:Atlantiki  
...
**bade** *cuerpo (corporal, corpóreo)* ← eng:body + ara:  بَدَن‎ (badan), fas: بدن‎ (badan), hin:बदन (badan), may:badan, tur:beden, swa:badani  
...
**bana** *flecha* ← hin:बाण (bāṇ), tel:బాణము (bāṇamu), may:panah  
...
**bandir** *bandera* ← eng:banner, fra:bannière, spa:bandera, por:bandeira, may:swa:bendera, tgl:bandila  
...
**barkoke** *albaricoque* ← ara:(barqūq), eng:apricot, fra:abricot, spa:albaricoque, por:abricó, rus:абрикос (abrikos), tgl:albarikoke, swa:aprikoti  
...
**barxe** *llover (lluvia)* ← fas: باران‎ (bârân), hin:बारिश (bāriś), ben:বৃষ্টি (briśṭi), tur:baran  
...
**baxe** *lengua (idioma)* ← hin:भाषा (bhāṣā), ben:ভাষা (bhaṣa), tel:భాష (bhāṣa), may:bahasa, jav:basa, tha:ภาษา (phasa)  
...
**baze** *base (fondo, básico; fundar, basar)* ← eng:fra:por:spa:base, deu:Basis, rus:база (baza)  
...
**bil** *poder (posible)* ← tur:bilmek + eng:-bility, fra:-bilité, spa:-bilidad, por:-bilidade  
...
**brun** *marrón* ← eng:brown, fra:brun + ara: بُنِّيّ‎ (bunniyy) + hin:भूरा (bhūrā)  
...
**bufon** *bufón* ← spa:por:bobo, kor:바보 (babo)  
...
**burge** *castillo (fortaleza)* ← deu:Burg, ara:urd: بُرْج‎ (burj), hin:बुर्ज (burj), ben:বুরুজ (buruj), tel:బురుజు (buruju), may:puri  
...
**buzi** *cabra* ← swa:mbuzi, sna:mbudzi, zul:imbuzi, tsw:bodi, por:bode, taj:буз (buz), fas:(boz)  
...
**cang** *capa (piso, planta, estrato)* ← zho:层 (céng), yue:層 (cang4), kor:층 (cheung), vie:tầng + min:棧 (chàn) + khm:ជាន់ (cŏən) , tha:ชั้น (chan)  
**canse** *oportunidad (chance)* ← fra:eng:spa:por:chance, jpn:チャンス (chansu), kor:찬스 (chanseu), rus:шанс (šans), tur:şans, hin:चांस (cāns)  
**cante** *cantar (canción)* ← fra:chanter, eng:chant, por:spa:cantar, + zho:唱 (chàng), yue:唱 (coeng3), kor:창 (chang)  
...
**catre** *cuatro (4)* ← rus:четыре (chetyre), hin:चार (cār), ben:চার (car), may:catur + fra:quatre, spa:cuatro, quatro  
...
**cin** *parente (madre o padre)* ← zho:亲 (qīn), yue:親 (can1)  
**cina** *chinés (de los Han)* ← hin:चीनी (cīnī), tur:Çin, ara:(ṣiniy), spa:chino, eng:Chinese, tha:จีน (chin), zho:秦 (qín)  
...
**cope** *azada* ← zho:锄 (chú), yue:鋤 (co4), tha:จอบ (chop), tur:çapa + eng:chop  
...
**cuke** *tocar (rozar)* ← zho: 触 (chù), yue:觸 (cuk1), jpn:触 (shoku), kor:촉 (chok) + hin: छूना (chūnā), pnb:ਛੂਹਣਾ (chūhṇā)  
**cum** *beso* ← hin:चूमना (cūmnā), urd:(cūmnā), mal:ചുംബനം (cumbanaṃ), may:cium, jpn:チュー (chū), tha:จูบ (cup)  
**cupe** *chupar (succionar)* ← spa:por:chupar, khm:ជប់ (cup) + hin:चूसना (cūsnā)  
...
**dane** *semilla* ← fas: دانه‎ (dāna), hin:दाना (dānā), tur:tane + jpn:種 (tane) + zho:弹 (dàn), vie:đạn, kor:탄알 (tanal)  
**dang** *campana (cencerro)* ← eng:dong + fas: زنگ‎ (zang), tur:çan + zho:钟 (zhōng), yue:鐘 (zung1), kor:종 (jong), vie:chuông, khm:ចួង (cuəng) + rus:звон (zvon)  
...
**dar** *fluir* ← hin:धारा (dhārā), tel:ధార (dhāra) + fas: دریا‎ (daryâ), hin:दर्या (daryā), ben:দরিয়া (dôriẏa), tur:derya  
...
**darmesitium** *darmstatio* ← eng:darmstadtium, fra:darmstadtium, spa:darmstatio, por:darmstádio, rus:дармштадтий, zho: (dá), jpn:ダームスタチウム, kor:다름슈타튬, vie:darmstadti, hin:डार्म्स्टेडशियम, ben:ডারমস্টাডটিয়াম, may:darmstadtium, swa:darmstadti, ara: دارمشتاتيوم  
...
**dunjia aventur** *juego de mazmorras* ← eng:dungeon, fra:donjon, jpn:ダンジョン (danjon)  
...
**emote** *sentir* ← eng:emotion, fra:émotion, spa:emoción, por:emoção, rus:эмоция (emociya), may:emosi, tgl:emosyon  
...
**fe** *hacer* ← fra:faire, por:fazer, ita:fare + ara: فَعَلَ‎ (faʿala) + swa:fanya  
...
**fixe** *fijar (pegar, asegurar)* ← eng:fix, fra:fixer;ficher, spa:fijar, por:fixar, deu:fixieren  
...
**fokus** *concentrar (enfocarse; concentración)* ← eng:focus, spa:por:foco, deu:Fokus, rus:фо́кус, fas:فوکوس‎ (fokus)  
...
**futebol** *fútbol* ← eng:fra:football, spa:fútbol, por:futebol, deu:Fußball, hin:फ़ुटबॉल (fuṭbŏl), urd:(fuṭ bāl), ben:ফুটবল (phuṭbôl), rus:футбол (futbol), tha:ฟุตบอล (th) (fút-bɔn), jpn:フットボール (futtobōru), zul:ibhola  
...
**gan** *seco (árido; secar)* ← zho:干 (gān), yue:乾 (gon1), jpn:乾 (kan), kor:건 (geon), vie:cạn  
**gana** *barra (vara, palo)* ← heb: קָנֶה‎ (qané), ara: قَنَاة‎ (qanāh) + eng:cane, fra:canne, spa:caña, por:cana + zho:秆 (gǎn), yue:稈 (gon2), vie:cần, tha:คัน (khan) + (sugarcane) hin:गन्ना (gannā), pnb:ਗੰਨਾ (gannā)  
...
**gas** *gas (gaseoso)* ← deu:eng:spa:may:gas, por:gás, ben:গ্যাস (gyas), zho:瓦斯 (wǎsī), yue:瓦斯 (ngaa5 si1), jpn:ガス (gasu), kor:가스 (gaseu), hin:गैस (gais), fra:tur:gaz, rus:газ (gaz), ara:(ḡāz)  
...
**glas** *vidrio (cristal)* ← dei:Glas, eng:glass, + fas: گیلاس‎ (gilâs), hin:गिलास (gilās), ben:গ্লাস (glaś), jpn:グラス (gurasu), kor:글라스 (geullaseu), may:gelas, swa:glasi + rus:глазурь, spa:glasear  
...
**grane** *grano (partícula)* ← eng:fra:grain, spa:grano, por:grão + rus:гранит (granit), tur:vie:may:granit, ara:جرانيت (jaraniat), hin:ग्रेनाइट (grenait)  
...
**gulgui** *gul* ← ara:الغول (ghūl), fas:غول‎ (ğul), eng:por:ghoul, spa:gul, rus:гуль (gul′), tur:kulbastı, may:ghul, jpn:グール (gūru)  
...
**halte** *parar (parada, alto)* ← deu:eng:halt, fra:halte, spa:por:alto, may:halte  
...
**harmone** *armonioso* ← eng:harmony, spa:armonía, por:harmonia, fra:harmonie, rus:гармония (garmoniya)  
...
**hate** *hasta* ← por:até, ara:(ḥatta), spa:hasta, swa:hata + fas: تا‎ (tâ), hin:तक (-tak)  
**hatre** *peligro (peligroso)* ← ara: خطر‎ (xaṭar), fas: خطر‎ (xatar), urd: خطرہ‎ (xatrā), hin:ख़तरा (xatrā), swa:hatari, tur:muhatara  
...
**he** *cómo? (eh?)* ← deu:hä, fra:por:hein, jpn:e + eng:huh, vie:hả + zho:啊 (à, a)  
**hei** *oye (hey)* ← eng:hey, fra:hé, spa:hey, por:ei, rus:эй (ey), zho:喂 (wèi), fas: هی‎ (hey)  
...
**hima** *nieve (nevar)* ← hin:हिमपात (himpāt), tha:หิมะ (hima), tel:(himamu)  
...
**histore** *historia (pasado)* ← eng:history, spa:swa:historia, por:história, fra:histoire, rus:история (istoriya)  
...
**hole** *entero (todo)* ← eng:whole, spa:por:holo-  
...
**hura** *hurra (yupi)* ← eng:hurrah, deu:spa:hurra, fra:hourra, rus:ура (ura), may:hore, fas:(hurâ)  
...
**impere** *reinar (reinar como emperador)* ← eng:empire, spa:imperio, por:império, rus:империя (imperiya), ara:إِمْبِرَاطُورِيَّة‎ (ʾimbirāṭūriyya), fas:امپراطوری‎ (emperâturi), may:empayar  
...
**islam** *sumisión (rendición; someterse, rendirse, ceder)* ← ara:(ʾislām), fas:(taslim), tur:teslim  
...
**jainisme** *jainismo* ← hin:mar:जैन (jain), tha:เชน (chen), eng:jainism, fra:jaïnisme, rus:джайнизм (džaynizm)  
...
**javabe** *responder (contestar; repuesta)* ← ara: جَوَاب‎ (jawāb), hin:जवाब (javāb), may:jawab, swa:jibu, jawabu, tur:cevap  
**jebe** *bolsillo* ← hin:जेब (jeb), pnb:ਜੇਬ (jeb), urd:(jeb), tel:(jēbu), ara:(jayb), tur:cep, wol:jiba  
**jebre** *álgebra* ← ara:fas:(jabr), tur:cebir, urd:(aljabrā), eng:algebra, fra:algèbre, swa:aljebra  
**jeke** *prestar (pedir prestado)* ← zho:借 (jiè), yue:借 (ze3), jpn:借 (shaku), kor:적 (jeok) + eng:check  
**jele** *encarcelar (aprisionar)* ← eng:jail, fra:geôle, hin:जेल (jel), ben:জেল (jēl), tel:జైలు (jailu), urd: جیل‎ (jēl), swa:jela + spa:por:jaula  
**jen** *persona* ← zho:人 (rén), wuu人 (zén), jpn:人 (jin) + hin:जन (jan), ben:-জন (-jôn), may:-jana, tha:ชน (chon), khm:ជន (jon) + fra:gens, por:gente  
**jenje** *gengibre* ← eng:ginger, fra:gingembre, spa:gengibre, por:jengibre, zho:姜 (jiāng), tam:இஞ்சி (inji), ara: زنجبيل‎ (zanjabīl), tur:zencefil  
**jenju** *perla* ← zho:珍珠 (zhēnzhū), yue:珍珠 (zan1 zyu1), jpn:真珠 (shinju), kor:진주 (jinju), vie:trân châu, rus:жемчуг (žemčug), tur:inci,incü  
**jense** *sexo (género)* ← eng:gender, por:gênero, jpn:ジェンダー (jendā) + ara:urd:(jins), fas:(jens), swa:jinsi, tur:cins  
...
**kable** *cable* ← eng:spa:cable, fra:câble, por:cabo, rus:кабель (kabel'), jpn:ケーブル (kēburu), kor:까벨 (kkabel), may:kabel, tur:kablo + ara:حَبْل‎ (ḥabl)  
**kaboge** *calabaza* ← tur:kabak, swa:boga, jpn:カボチャ (kabocha)  
**kadium** *cadmio* ← eng:cadmium, fra:cadmium, spa:cadmio, por:cádmio, rus:кадмий, zho:镉 (gé), jpn:カドミウム, kor:카드뮴, vie:catmi, hin:काडमियम, ben:ক্যাডমিয়াম, may:kadmium, swa:kadimi, ara: كادميوم  
...
**kai** *abierto (abrir; abrirse)* ← zho:开 (kāi), wuu:開 (khe1), jpn:開 (kai), kor:개 (gae), vie:khai, tha:ไข (kǎi), lao:ໄຂ (khai)  
**kaka** *caca (defecar)* ← spa:por:fra:caca, deu:Kacke, ara:(kākā), tur:kaka, rus:кака (kaka), fas:(kake)  
**kakau** *cacao* ← por:cacau, ara:(kākāw), spa:cacao, eng:cocoa, rus:какао (kakao), jpn:カカオ (kakao), zho:可可 (kěkě), vie:cacao, swa:kakao  
**kalam** *bolígrafo* ← ara:fas:urd: قلم‎ (qalam), hau:alƙalami, yor:swa:kalamu, tur:kalem, hin:क़लम (qalam), ben:কলম (kôlôm), spa:por:cálamo  
**kale** *vacío (desocupado)* ← ben:খালি (khali), hin:ख़ाली (xālī), tel:ఖాళీ (khāḷī), tam:(kali), urd:(xālī), fas:خالی (xāli), ara:خَالٍ‎ (xāliy), jpn:空 (kara)  
...
**kama** *lujuria (deseo)* ← hin:काम (kām), ben:কাম (kam), tha:กาม (gaam), eng:kama  
...
**kanal** *canal (cauce, acequia)* ← eng:spa:por:fra:canal, rus:канал (kanal), may:kanal + ara: قَنَاة‎ (qanāh) + ben:খাল (khal)  
**kanape** *sofá* ← fra:por:spa:canapé, deu:Kanapee, rus:канапе (kanape), tur:kanepe, fas:(kânâpe), ara:(kanaba)  
**kande** *caramelo* ← eng:candy, hin:कैंडी (kaiṇḍī), ben:ক্যান্ডি (kyandi), jpn:キャンデー (kyandē), tgl:kendi + ara:fas: قند (qand)  
...
**kara** *negro* ← hin:काला (kālā); कारौ (kārau), ben:কালো (kalo), pnb:ਕਾਲਾ (kālā) + tam:கருப்பு (karuppu) + tur:kara, kaz:қара (qara)  
...
**karde** *tarjeta (carta)* ← eng:card, fra:carte, spa:por:carta, deu:Karte, rus:карта (karta), tur:kart, swa:kadi, hin:कार्ड (kārḍa), ben:কার্ড (kārḍa), may:kartu, zho:卡 (kǎ), jpn:カード (kādo), kor:카드 (kadeu) deu:Karte, may:kartu, fra:carte  
**kardon** *cardo* ← spa:por:cardo, fra:chardon, eng:cardoon, jpn:カルドン (karudon)  
**kare** *trabajar* ← fas: کار (kâr), hin:कार (kār), कार्य (kārya), ben:কাজ (kaj), may:karya,kerja + swa:kazi  
...
**karge** *carga (pesa)* ← spa:por:carga, eng:cargo, may:kargo  
...
**karime** *generoso (dadivoso, caritativo)* ← ara:(karīm), swa:-karimu, tur:kerim, spa:por:caritativo  
...
**karube** *algarrobo* ← ara: خَرُّوب‎ (ḵarrūb), eng:carob, fra:caroube, spa:algarrobo, por:alfarroba  
...
**kase** *caja* ← lat:capsa, deu:Kasse, eng:fra:case, spa:caja, por:caixa, rus:касса (kassa), swa:kasha + ara:(qafaṣ), hin:क़फ़स (qafas), tur:kafes + zho:卡式 (kǎshì), jpn:カセット (kasetto), kor:카세트 (kaseteu)  
**kaske** *carapacho (cáscara, concha, corteza, capa)* ← spa:cáscara, por:casca + nan:殼 (kag4), wuu:殼 (khoq4), jpn:殻 (kaku)  
**kaslan** *perezoso (flojo)* ← ara: كَسْلَان‎ (kaslān) + zho:懒 (lǎn), yue:懶 (laan5) + आलसी (ālsī)  
...
**kave** *cavar (excavar)* ← spa:por:cavar, eng:excavar, fra:excaver  
**ke** *qué (cuál)* ← fra:que, spa:qué, por:o que + ben:কে  (ke) + zho:何 (hé)  
...
**kex** *pelo* ← jpn:毛 (ke) + hin:केश (keś), urd:(keś), pnb:ਕੇਸ਼ (keś), tel:(kēśamu)  
...
**kine** *cinético* ← eng:kinetic, spa:por:cinético, fra:cinétique, deu:kinetisch, rus:кинетический (kineticheskyy)  
...
**kitabe** *escribir (escritura)* ← ara:urd:(kitāb), fas:(ketâb), tur:kitap, may:kitab, swa:kitabu, hin:किताब (kitāb)  
**kivi** *kiwi fruta* ← eng:fra:spa:may:swa:kiwi, por:quivi, jpn:キーウィ (kīwi), kor:키위 (kiwi), hin:कीवी (kīvī), tur:kivi  
**klame** *gritar* ← eng:-claim, fra:-clamer, spa:por:-clamar  
...
**kopernikium** *copérnico* ← eng:fra:copernicium, spa:copérnico, por:copernício, rus:коперниций, jpn:コペルニシウム, kor:코페르니슘, vie:copernici, may:copernicium, swa:kopernici  
**kor** *corazón (núcleo)* ← eng:core, fra:coeur  
**koral** *coral* ← eng:spa:por:coral, fra:corail, deu:Koralle, rus:коралл + may:karang  
**korne** *cuerno* ← fra:corne, spa:cuerno, por:corno, eng:horn, deu:Horn + ara: قَرْن‎ (qarn)  
**koron** *corona* ← fra:couronne, eng:crown, spa:corona, jpn:クラウン (kuraun), rus:корона (korona), por:coroa  
**korse** *silla* ← ara:(kursiy), hin:कुरसी (kursī), urd:(kursī), pnb:ਕੁਰਸੀ (kursī), tel:(kurcī), may:som:kursi, fas:(korsi)  
...
**kristejen** *Navidad* ← ell:Χριστούγεννα (Christoúgenna)  
...
**kuane** *ancho* ← zho:宽 (kuān), tha:กว้าง (kwang), vie:quảng  
...
**kuke** *cocinar (preparar)* ← eng:cook, deu:Kock, ita:cuoco, may:koki, tha:กุ๊ก (kuk), sango:kuku  
...
**kupe** *vaso (taza, copa)* ← eng:cup, fra:coupe, spa:copa, por:copo, ara: كُوب‎ (kūb), tur:kupa, hin:कप (kap), jpn:コップ (koppu), kor:컵 (keop) + fas:(koppe), may:kubah, rus:купол (kupol), deu:Kuppel  
...
**kuxen** *almohada (cojín)* ← eng:cushion, fra:coussin, spa:cojín, por:coxim, jpn:クッション (kusshon), kor:쿠션 (kusyeon), yue:咕𠱸 (ku1 seon2), hau:kushin, ibo:kushọn  
**kuxloke** ** ← fra:eng:couchette, ita:cuccetta, pol:kuszetka  
**la** *el (la)* ← fra:spa:la + ara: (al) + swa:-le  
...
**lale** *rojo* ← hin:लाल (lāl), ben:লাল (lal), tur:al  
...
**lantanium** *lantano* ← eng:lanthanum, fra:lanthane, spa:lantano, por:lantâno, rus:лантан, zho:镧 (lán), jpn:ランタン, kor:란탄, vie:lantan, hin:लाञ्थनम, ben:ল্যান্থানাম, may:lantanium, swa:lanthani, ara: لنثانوم  
...
**laste** *elástico (flexible)* ← eng:elastic, spa:por:elástico, gla:lastaig, rus:эласти́чный (elastíčnyj), tur:may:elastik, jpn:エラスティック (erasutikku)  
...
**laurensium** *laurencio* ← eng:lawrencium, fra:lawrencium, spa:laurencio, por:lawrêncio, rus:лоуренсий, zho:铹 (láo), jpn:ローレンシウム, kor:로렌슘, vie:lorenxi, lawrenci, hin:लॉरेंशियम, ben:লরেনসিয়াম, may:lawrensium, swa:lawirensi, ara: لورنسيوم  
...
**lazurite** *lapislázuli* ← fas:لاجورد (lājevard), eng:lazuli, spa:lapislázuli, rus:лазурит (lazurit), ara:لازورد (lāzaward), hin:लाजवर्द (lājavarda), jpn:ラピスラズリ (rapisurazuri), may:lazuardi, tur:lazur taşı  
...
**lifafe** *envolver (envoltura)* ← ara: لِفَافَة‎ (lifāfa), fas:(lefâf), hin:लिफ़ाफ़ा (lifāfā), ben:লেফাফা (lephapha)  
**lige** *liga (asociación, federación)* ← fra:ligue, deu:spa:pol:por:liga, eng: league, rus: лига (liga), tur:lig, swa:ligi, jpn:リーグ (rīgu)  
**lila** *lila* ← tur:leylak, ara:(laylak), eng:lilac, fra:lilas, por:lilás, spa:tgl:lila, jpn:ライラック (rairakku)  
**lime** *límite (frontera, linde)* ← eng:limit, spa:límite, fra:por:limite, rus:лимит (limit) + hin:सीमा (sīmā)  
**limfa** *linfa* ← eng:lymph, spa:por:linfa, rus:лимфа (límfa), may:limfa, jpn:リンパ (rinpa), zho:淋巴 (línbā)  
...
**line** *linea (hilo, cordel, raya)* ← eng:line, fra:ligne, spa:línea, por:linha, rus:линия (liniya), pol:linia  
**lisan** *lengua* ← ara: لِسَان‎ (lisān), hin:लिसान (lisān), swa:lisani, may:tur:lisan, amh:ልሳን (ləsan)  
**lise** *suave (liso)* ← fra:lisse, spa:por:liso, fas:(liz), may:licin  
...
**live** *dejar* ← eng:leave + zho:留 (liú), jpn:留 (ryū), kor:류 (ryu), vie:lưu  
...
**loge** *decir (hablar; habla)* ← ell:λόγος (logos), eng:fra:-logue, spa:por:-logo, rus:-лог (-log) + ara:(luğa), hin:लुग़त (luġat), swa:lugha, may:logat, tur:lügat, fas:(loğat)  
**loje** *estudiar (investigar)* ← eng:-ology, spa:-ología, fra:-ologie, rus:ология (-ologiya), tur:-loji  
**loke** *lugar (colocar, poner)* ← eng:location, spa:lugar, fra:localisation, + deu:tur:lokal, pol:lokalny  
**lon** *discusión (debate, discurso)* ← zho:论 (lùn), yue:論 (lœn6), kor:론 (ron), jpn:論 (ron), vie:luận  
**longe** *largo* ← eng:fra:long, deu:lang, por:longo  
...
**luge** *registro (archivo; registrar, recordar, anotar)* ← eng:log + zho:录 (lù), yue:錄 (luk6), jpn:録 (roku), kor:록 (rok), vie:lục  
**luke** *verde* ← zho:绿 (lǜ), yue:綠 (luk6), vie:lục, kor:록/녹 (rok/nok), jpn: 緑色 (ryokushoku)  
**lumbe** *lomo* ← fra:lombes, spa:lomo, por:lombo + eng:lumbago, rus:люмбаго (lyumbago)  
...
**lutetium** *lutecio* ← eng:lutetium, fra:lutécium, spa:lutecio, por:lutécio, rus:лютеций, zho:镥 (lǔ), jpn:ルテニウム, kor:루테튬, vie:lutexi, hin:लुटेटियम, ben:লুটেসিয়াম, may:lutetium, swa:luteti, ara: لوتيتيوم  
**luxe** ** ← eng:lush, fra:luxe, spa:lujo, por:luxo, rus:люкс (lyuks), tur:lüks  
**ma** *mamá* ← zho:妈 (mā), vie:má, ben:মা (ma), hin:मां (mã) + eng:swa:mama, fra:maman, spa:mamá, por:por:mãe, rus:мама (mama), jpn:ママ (mama), kor:엄마 (eomma)  
**mace** *competir (partido)* ← eng:fra:match, hin:मैच (mɛc), swa:meci, pol:mecz, rus:матч (matč), tur:maç  
...
**magente** *magenta (fucsia)* ← eng:magenta, spa:magenta, rus:маджента (madzhenta), ara:ماجنتي (majinati), hin:मैजेंटा (maijenta), jpn:マゼンタ (mazenta), may:magenta  
**magesium** *magnesio* ← eng:magnesium, fra:magnésium, spa:magnesio, por:magnésio, rus:магний, zho:镁 (měi), jpn:マグネシウム, kor:마그네슘, vie:magiê, hin:मैग्नेशियम, ben:ম্যাগনেসিয়াম, may:magnesium, swa:magnesi, ara: مغنيسيوم  
...
**maitnerium** *meitnerio* ← eng:meitnerium, fra:meitnérium, spa:meitnerio, por:meitnério, rus:майтнерий, jpn:マイトネリウム, kor:마이트너륨, vie:meitneri, hin:मेइट्नेरियम, ben:মিটনেরিয়াম, may:meitnerium, swa:meitneri, ara: مايتنريوم  
**makal** *artículo (texto)* ← ara:مَقَال‎ (maqāl), tur:makale, swa:makala, fas:مقاله‎ (maqâle), may:makalah  
**makan** *mantequilla* ← hin:मक्खन (makkhan), ben:মাখন (makhôn)  
...
**male** *poseer (tener, ser dueño de; propiedad)* ← ara:fas:urd: مَال‎ (māl), hin:माल (māl), ben:মালিক, swa:mali, may:milik, tur:mal  
**malika** *jazmín* ← kan:(mallige), tam:(mallikai), tel:(malla), may:melati, kor:말리 (malli), tha:มะลิ (mali), zho:茉莉 (mòlì)  
**mam** *seno (teta)* ← eng:mamma, fra:mamelle, spa:por:mama, tur:meme + may:mamalia  
...
**manto** *capa (manto)* ← eng:mantle, spa:manto, fra:manteau, rus:манто (manto), jpn:マント (manto), kor:망토 (mangto), may:mantel  
...
**marce** *marcha (caminar, marchar)* ← eng:march, fra:marche, spa:por:marcha, rus:марш (marš), hin:मार्च (mārc), tur:marş, swa:machi  
...
**masaje** *masaje (amasar, masajear)* ← eng:fra:massage, spa:masaje, por:massagem, rus:массаж (massaž), tur:masaj, ara:مَسَاج‎ (masāj), fas:ماساژ‎ (mâsâž), ben:ম্যাসেজ (myaśej), zho:马杀鸡 (mǎshājī), jpn:マッサージ (massāji)  
...
**mede** *ayudar (asistar; ayuda, asistencia)* ← ara: مَدَد‎ (madad), fas: مدد (madad), hin:मदद (madad), ben:মদদ (môdôd), tel:మద్దతు (maddatu) + fra:aider, eng:aid + rus:мэдэ (mede), jpn:メーデー (mēdē), kor:메이데이 (meidei)  
...
**medite** *meditar (reflexionar)* ← eng:meditate, spa:meditar, fra:méditer, rus:медитировать (meditirovatʹ)  
...
**membe** *pertenecer (ser miembro de)* ← eng:member, spa:miembro, por:membro, fra:membre, jpn:メンバー (menbā)  
...
**menu** *menú (carta)* ← eng:fra:por:menu, spa:menú, rus:меню (menyu), jpn:メニュー (menyū), kor:메뉴 (menyu), hin:मेनू (menū), tur:menü  
...
**migre** *migración (migrarse, mudarse, trasladarse)* ← fra:eng:migration, spa:migración, por:migração, rus:миграция (migratsiya)  
...
**mime** *imitar* ← eng:fra:mime, por:mímico, rus:мим (mim)  
**min** *menos* ← spa:por:menos, fra:moins, rus:менее (méneje), eng:min- + deu:Minimum  
...
**minute** *minuto* ← eng:minute, spa:por:minuto, rus:минута (minuta), hin:मिनट (minaṭ), ben:মিনিট (miniṭ), may:minit  
**mire** *reflejar* ← spa:mirar, eng:admire, fra:admirer + ara:mirʾāh, tur:mirat  
**misal** *ejemplo* ← hin:मिसाल (misāl), ara:(mithāl), fas:(mesâl), may:misal, swa:mathalani, tur:mesela  
**mise** *enviar (transmitar)* ← eng:fra:mission, deu:Mission, spa:misión, por:missão, rus:миссия, may:misi, tgl:misyon + tur:mesaj, jpn:メッセージ (messēji), kor:메시지 (mesiji)  
...
**mone** *dinero (plata)* ← eng:money + fra:monnaie, spa:por:moneda, rus:монета  
...
**motegar** *automóvil (coche)* ← eng:motorcar, sna:motokari, sot:motokara, swa:motokaa, zul:imoto, hau:mota  
**motesikle** *motocicleta* ← eng:motorcycle, spa:motocicleta, fra:motocyclette, rus:мотоцикл (mototsikl), tur:motosiklet, hin:मोटरसाइकिल (moṭarasāikila), may:motosikal, zho:摩托车 (mótuōchē), jpn:モーターサイクル (mōtāsaikuru)  
...
**multe** *muchos* ← por:muito, eng:fra:spa:multi-, rus:мульти- (mulʹti-)  
...
**mute** *cambiar* ← spa:mudar, eng:mutate, fra:muter  
**mux** *ratón* ← pol:mysz, rus:мышь (myś), fas:(muš)  
**muze** *divertir (entretener; diversión)* ← eng:amuse, fra:amuser, deu:amüsieren + fas: مزه (maze), hin:मज़ा (mazā), ben:মজা (môja)  
**muzike** *música (tocar música)* ← eng:music, fra:musique, spa:por:música, rus:музика (muzika), ara:(mūsīqā), swa:muziki, tur:müzik, may:musik  
...
**namelexe** *sustantivo* ← zho:名词 (míngcí), yue:名詞 (ming4 ci4), jpn:名詞 (meishi), kor:명사 (myeongsa), hin:नाम (nām), fra:nom, spa:nombre, por:nome, rus:имя (imya), ara:(ism), per:(esm), swa:nomino  
...
**narme** *blando (mullido)* ← fas: نرم‎ (narm), hin:नरम (naram), ben:নরম (nôrôm) + ara: نَاعِم‎ (nāʿim) + tha:นุ่ม (num)  
...
**natrium** *sodio* ← eng:sodium, fra:sodium, spa:sodio, por:sódio, rus:натрий, zho:钠 (nà), jpn:ナトリウム, kor:나트륨, vie:natri, hin:सोडियम, ben:সোডিয়াম, may:natrium, swa:natiri  
...
**nege** *rechazar (negar)* ← spa:por:negar, eng:negate  
...
**nepe** *nube* ← ell:νέφος (nephos), scr:नभस् (nábhas), tam:நபம் (napam) + eng:nepho-, fra:népho- + spa:nube, por:nuvem + rus:небо (nebo)  
**nepotunium** *neptunio* ← eng:neptunium, fra:neptunium, spa:neptunio, por:neptúnio, rus:нептуний, zho:镎 (ná), jpn:ネプツニウム, kor:넵투늄, vie:neptuni, hin:नेप्ट्यूनियम, ben:নেপচুনিয়াম, may:neptunium, swa:neptuni, ara: نبتونيوم  
**nes** *isla* ← ell:νήσος (nēsos), may:nusa, mlg:nosy  
**nete** *nexo (red)* ← eng:net(work), deu:Netz(werk), jpn:ネット(ワーク) (nettowāku), kor:네트워크 (neteuwokeu) + fra:connecter, spa:por:connectar  
**neu** *nuevo* ← deu:neu, eng:new; neo-, fra:nouveau; néo-, spa:nuevo; neo-, por:novo; neo-, rus:новый (novyy); нео- (neo-), hin:नव (nav), ben:নয় (nôy); নও- (nôo-), may:nawa  
**neure** *nervio (neural)* ← eng:spa:por:fra:deu:neuro-, rus:невро- (nevro-)  
...
**nis** *hornacina* ← fra:eng:niche, por:nicho, rus:ниша (niša)  
...
**node** *nudo (hacer un nudo)* ← eng:node, spa:nudo, por:nó, fra:nœud + vie:nút  
**nome** *organizar (gestionar)* ← eng:-nomy, deu:fra:-nomie, spa:por:-nomia, rus:-номия (-nomiya), may:-nomi  
**norde** *norte (norteño)* ← eng:north, spa:por:norte, deu:Nord, fra:nord, rus:норд (nord)  
...
**note** *notar (observar; nota)* ← deu:eng:fra:note, spa:por:nota, tur:not, jpn:ノート (nōto), kor:노트 (noteu), fas:(not)  
**nove** *nueve (9)* ← fra:neuf, spa:nueve, por:nove, fas: نُه‎ (noh), hin:नौ (nau), ben:নয় (nôy), may:nawa  
**nude** *desnudo* ← eng:nude, spa:desnudo, por:fra:nu + rus:нудизм (nudizm), jpn:ヌーディズム (nūdizumu)  
**nuke** *cuello (nuca, pescuezo)* ← eng:neck, spa:por:nuca, fra:nuque, spa:por:nuca + ara:عُنُق‎ (ʿunuq)  
...
**onor** *respeto (honor)* ← eng:pol:spa:honor, fra:honneur, por:honra, tur:onur + rus:гонор (gonor)  
...
**orde** *ejército* ← tur:ordu, fas: اردو (ordu) + eng:fra:horde, spa:por:horda, rus:орда (orda), zho:斡耳朵 (wò'ěrduǒ), zho:オルド (orudo), kor:오르도 (oreudo) + ara: عُرْضِيّ‎ (ʿurḍiyy)  
...
**orte** *recto* ← eng:fra:ortho-, spa:por:orto-, rus:орто- (orto-)  
...
**ove** *huevo* ← fra:oeuf, spa:huevo, por:ovo + eng:tur:oval, rus:овал (oval)  
...
**pa** *papá* ← eng:fra:papa, spa:papá, rus:папа (papa), ara:(bābā), zho:爸爸 (bàba), jpn:パパ (papa), kor:아빠 (appa), vie:ba/bố, hin:बाप (bāp), ben:বাবা (baba), may:bapa, swa:tur:baba  
**pace** *paz* ← ita:pace, eng:peace, spa:por:paz, fra:paix  
**pade** *caer* ← rus:падать (padat') + hin: पड़ना (paṛnā), ben:পড়া (pôŗa), tel:పడు (paḍu)  
...
**pake** *embalar (llevar; paquete)* ← eng:pack, rus:пакет (paket), hin:पैकेट (pækeṭ), deu:tur:paket, fra:paquet, spa:paquete, por:pacote  
**pakse** *pájaro (ave)* ← hin:पक्षी (pakṣī), ben:পাখী (pakhī), tel:(pakṣi), khm:បក្សី (baksəy), tha:ปักษา (pak-sa)  
...
**pan** *todo* ← eng:spa:por:deu:may:pan-, rus:пан- (pan-) + zho:泛 (fàn), jpn:汎 (han-)  
...
**panke** *ala* ← hin:पंखा (paṅkhā) + (fan) mya:ပန်ကာ (panka), fas:(panke), + eng:punkah, fra:panka, deu:Pankha  
...
**parce** *romper (hacer pedazos; pedazo, fragmento)* ← fas:(parče), tur:parça, hin:पारचा (pārcā), eng:part, por:spa:parte  
**pare** *equilibrado (par)* ← eng:peer, fra:pair, spa:por:par, deu:Pere, hin:बराबर (barābar), fas:urd: برابر‎ (barâbar)  
...
**pas** *pasar* ← eng:pass, spa:pasar, por:passar, fra: passer + rus:паспорт (pasport), hin:पासपोर्ट (pāsporṭ), ben:পাসপোর্ট (pasporṭ), may:paspor, swa:paspoti, jpn:パスポート pasupōto)  
...
**pate** *enfermo* ← deu:eng:fra:patho-, spa:por:pol:tur:may:pato-, rus:пато- (pato-)  
...
**pende** *colgar* ← por:fra:pender + eng:pendant, jpn:ペンダント (pendanto), kor:펜던트 (pendeonteu), tur:pandantif  
...
**perde** *pedo (peer)* ← eng:fart + fra:pet, spa:pedo, por:peido, rus:пердение (perdeniye), ben:পাদ (pad), hin:पाद (pād)  
**peresa** *perezoso (pereza)* ← fra:paresseux, spa:perezoso  
...
**pexe** *pez (pescado)* ← por:peixe, spa:pez + deu:Fisch, eng:fish  
...
**picea** *pícea* ← spa:por:pícea, fra:épicéa  
...
**plasme** *plasma (gas ionizado)* ← eng:plasma, spa:plasma, rus:плазма (plazma), ara:بلازما (balazima), hin:प्लाज़्मा (plaazma), jpn:プラズマ (purazuma), may:plasma  
**plaste** *moldear (modelar)* ← eng:plastic, spa:por:plástico, rus:пластик (plastik), tur:may:plastik, swa:plastiki, ara:بلاستيك (blastīk), hin:प्लास्टिक (plāsṭik), jpn:プラスチック (purasuchikku), kor:플라스틱 (peullaseutik)  
**plate** *plano (placa)* ← eng:plate, spa:por:placa, deu:Platte, rus:пластина (plastina)  
**platinium** *platino* ← eng:platinum, fra:platine, spa:platino, por:platina, rus:платина, zho:铂 (bó), vie:platin, hin:प्लाटिनम, ben:প্লাটিনাম, may:platina, swa:platini, ara: بلاتين  
**ploze** ** ← eng:fra:explosion, spa:explosión, por:exploção, rus:имплозия (imploziya), may:eksplosi  
**plum** *ciruela (pruna)* ← eng:plum, deu:Pflaume, jpn:プラム (pulamu) + fra:prune, spa:pruna  
...
**poke** *póquer* ← eng:poker, zho:扑克 (pūkè), jpn:ポーカー (pōkā), kor:포커 (pokeo), vie:pôke  
**polau** *pilaf (pulaw)* ← fas:(polou), hin:पुलाव (pulav), tur:pilav, rus:плов (plov)  
**poli** *mucho (muchos; poli-, multi-)* ← ell:πολλοί (polloí), eng:fra:deu:poly-, spa:por:poli-, rus:поли- (poli-)  
...
**poste** *eviar por correo* ← eng:post, por:postagem, fra:poste, rus:почта (pochta), ara:بوسطة‎ (busṭa), swa:posta, may:pos  
**pote** *jarra* ← eng:fra:pot, spa:por:pote, may:poci, jpn:ポット (potto), kor:포트 (poteu)  
**poyu** *piojo* ← fra:pou, por:piolho, spa:piojo  
**poze** *posar (pose, postura)* ← eng:spa:por:fra:pose, deu:Pose, rus:поза (poza), jpn:ポーズ (pōzu)  
**prasedium** *praseodimio* ← eng:praseodymium, fra:praséodyme, spa:praseodimio, por:praseodímio, rus:празеодим, jpn:プラセオジム, kor:프라세오디뮴, vie:prazeođim, hin:प्रासियोडाइमियम, ben:প্র্যাসেওডিমিয়াম, may:praseodinium, swa:praseodimi, ara: براسوديميوم  
...
**probe** *intentar (probar)* ← deu:Probe, eng:prove; probe, spa:probar, por:provar, rus:проба  
...
**pude** *podrido (cariado)* ← eng:putrid, spa:por:podre, fra:putride + zho:腐 (fǔ), jpn:腐 (fu) + tha:ผุ (phu)  
...
**puje** *adorar (venerar; adoración, veneración, culto)* ← hin:पूजा (pūjā), urd:(pūjā), tha:บูชา (bucha), may:puja  
...
**pure** *lleno (completo)* ← hin:पूर्ण (pūrn), ben:পূর্ণ (pūrṇa), pnb:ਪੂਰਾ (pūrā), fas:(por)  
**putau** *uva* ← zho:葡萄 (pútáo), yue:葡萄 (pou4 tou4), wuu:葡萄 (bu dau3), jpn:葡萄 (budō), kor:포도 (podo), vie:bồ đào  
**putavorange** *pomelo (toronja)* ← eng:grapefruit, zho:葡萄柚  
...
**putonge** *general (common)* ← zho:普通 (pǔtōng), yue:普通 (pou2tung1), vie:phổ thông, kor:보통 (botong)  
...
**rate** *tener sentido* ← lat:ratio, eng:rational, fra:rationnel, spa:por:racional + deu:Rat, pol:rada, rus:рада (rada)  
**ratibe** *ordenar (arreglar)* ← ara: رَتَّبَ (rattaba), swa:ratibu, hau:rattaba, fas: ترتيب (tartīb), hin:तरतीब (taratība), may:tertib, tur:tertip  
...
**rentogenium** *roentgenio* ← eng:roentgenium, fra:roentgenium, spa:roentgenio, por:roentgênio, rus:рентгений, zho: (lún), jpn:レントゲニウム, kor:뢴트게늄, vie:roentgeni, hin:रॉन्टजैनियम, ben:রোয়েন্টজেনিয়াম, may:roentgenium, swa:roentgeni, ara: رونتجينيوم  
**resete** *instrucciones (receta)* ← ita:ricetta, rus:рецепт (retsept), deu:Rezept, spa:receta, por:receita, fra:recette, may:resep  
**reside** *reconocimiento (recibo; reconocer)* ← fas:(resid), hin:रसीद (rasīd), urd:(rasīd), guj:રસીદ (rasīd), tel:రసీదు (rasīdu), + eng:receipt, swa:resiti, may:resit  
...
**ri-** *repetición* ← eng:fra:por:spa:re-, rus:ре- (re-)  
**rice** *rico* ← eng:rich, fra:riche, por:spa:rico  
...
**rite** *costumbre (tradición, convención; traditional, convencional)* ← hin:रीति (rīti), ben:রীতি (rīti) + eng:fra:rite, spa:por:rito  
...
**romante** *romance (amar románticamente)* ← fra:eng:spa:por:romance, rus:роман (roman), tur:romans, may:roman, jpn:ロマンス (romansu), kor:로맨스 (romaenseu)  
...
**rubidium** *rubidio* ← eng:rubidium, fra:rubidium, spa:rubidio, por:rubídio, rus:рубидий, zho:铷 (rú), jpn:ルビジウム, kor:루비듐, vie:rubiđi, hin:रुबिडियम, ben:রুবিডিয়াম, may:rubidium, swa:rubidi, ara: روبيديوم  
...
**rul** *rollo* ← eng:roll, fra:rouler, deu:aufrollen  
**rum** *ron* ← eng:rum, spa:ron, hin:रम (ram), rus:ром (rom)  
**rupe** *aspecto (parecer)* ← hin:रूप (rūp), may: rupa, tha: รูป (rūp), khm:រូប (rūp)  
...
**sababe** *razón (causa)* ← heb:(sibá), hau:sabo;sababi, kon:sambu, ara:urd:(sabab), tur:sebep, may:sebab, swa:sababu  
**sabe** *saber (sabiduría)* ← fra:savoir, spa:por:saber, eng:savvy, pcm:sabi  
...
**sade** *sencillo (liso)* ← tur:sade, fas:(sāde), hin:सादा (sādā)  
**safar** *viaje (viajar)* ← ara:(safar), hin:सफ़र (safar), tur:sefer, swa:safari, eng:fra:spa:por:deu:safari  
**safe** *limpio (limpiar)* ← swa:safi, hin:साफ़ (sāf), urd:(sāf), ben:চাফা (sapha)  
...
**sage** *historia (cuento, relato, leyenda; relatar, narrar)* ← eng:spa:por:may:saga, deu:Sage, rus:сага (saga)  
...
**sahe** *correcto (justo)* ← hin:सही (sahī), urd:(sahī), fas:(sahih), ara:(ṣaḥīḥ), swa:sahihi, may:sah  
...
**salade** *ensalada* ← fra:salade, may:salad, rus:салат (salat), hin:सलाद (salād), yue:沙律 (saa1 leot62), zho:沙拉 (shālā), por:salada, spa:ensalado, jpn:サラダ (sarada), kor:샐러드 (saelleodeu), vie:xà lách  
...
**sanduke** *caja (baúl, cofre, estuche)* ← rus:сундук (sunduk), ara: صُنْدُوق‎ (ṣundūq), fas:urd:صندوق‎ (sanduq), swa:sanduku, tur:sandık  
**sante** *sagrado (santo)* ← por:spa:santo, eng:fra:saint, kon:santu, zho:圣 (shèng), hin:संत (sant), kon:santu  
**sanze** *abanico (ventilador)* ← zho:扇子 (shànzi), yue:扇子  (sin3zi2), jpn:扇子 (sensu), kor:선 (seon), mon:шанз (šanz)  
**sapate** *zapato* ← spa:zapato, por:sapato, may:sepatu, swa:sapatu  
**sar** *cabeza* ← fas:(sar), hin:सिर (sir) + ara:(raʾs), swa:rasi  
**sate** *hora (hora del día, momento)* ← ara: سَاعَة‎ (sāʿa), may:tur:saat, swa:saa, hau:sa’a, wol:yor:saa, fas:(sâ'at)  
...
**sekure** *seguro (proteger, asegurar, guardar)* ← eng:secure, deu:sicher, spa:por:seguro  
**sel** *consejo (aconsejar)* ← ara: صَلَاح‎ (ṣalāḥ), hin:सलाह (salāh), tel:సలహా (salahā), tur:salık + eng:counsel, fra:conseil, spa:consejo, por:conselho + rus:консультант (konsultant)  
...
**sere** *serie* ← eng:series, fra:série, spa:serie, rus:серия (seriya), tur:seri + hin:सिलसिला (silsilā), ara:(silsila), tur:silsile, swa:silisili, fas: سلسله‎ (selsele) + zho:系列 (xìliè)  
...
**serve** *servir (servicio)* ← eng:fra:service, por:serviço, rus:сервис (servis), tur:servis, hin:(sevâ)  
...
**side** *sentarse* ← rus:сидеть (sidet'), eng:sit, deu:sitzen, ita:sedere + spa:por:presidente, fas: پرزیدنت‎ (perezident), may:presiden  
...
**sigare** *cigarro (cigarillo)* ← eng:fra:cigarette, spa:cigarillo, por:cigarro, rus:сигарета (sigarteta), ara:(sījāra), zho:雪茄 (xǔejiā), wuu:雪茄 (xi'gá), hin:सिगरेट (sigreṭ), ben:সিগারেট (śigareṭ), swa:tur:sigara, amh:ሲጃራ (siǧara)  
**sikle** *bicicleta* ← eng:bicycle, fra:bicyclette, tur:bisiklet, spa:bicicleta, tgl:bisikleta, ben:সাইকেল (saikel), hin:साइकिल (sāikil)  
**silike** *silicio* ← eng:silicon, fra:silicium, spa:silicio, por:silício, rus:кремний, vie:silic, hin:सिलिकॉन, ben:সিলিকন, may:silikon, swa:silikoni, ara: سيلكون  
...
**sina** *pecho (seno, tórax)* ← fas:(sine), tur:sine, hin:सीना (sīnā), spa:seno, fra:sein, ltn:sinus  
...
**sir** *secreto (ocultar, esconder)* ← ara: سِرّ (sirr), hin:सेर (ser), may:sir, swa:siri, hau:ful:asiri, yor:àṣírí, tur:sır, fas:(serr)  
...
**sisme** *agitar (sacudir)* ← ell:σεισμός (seismós), eng:seism, spa:sismo, fra:séisme, tur:sismik  
...
**skale** *escalera* ← spa:por:escalar + fra:escalier + eng:scale, deu:Skale, rus:шкала (škala)   
...
**skerte** *falda* ← eng:skirt, hin:स्कर्ट (skarṭ), ben:স্কার্ট (śkarṭ), jpn:スカート (sukāto), kor:스커트 (seukeoteu), swa:sketi, hau:siket  
**skope** ** ← eng:fra:-scope, spa:por:-scopio, rus:-скоп (skop), jpn:スコープ (sukōpu), hin:स्कोप (-skop), may:tur:-skop  
**skulte** *esculpir (escultura, estatua)* ← eng:sculpt, spa:esculpir, fra:sculpteur, por:escultor, rus:скульптор (skulptor)  
...
**soce** *alternar (interactuar)* ← eng:socialize + spa:sociedad, rus:социум (socium)  
**sofa** *sofá* ← eng:fra:sofa, spa:por:sofá, rus:софа (sofa), zho:沙发 (shāfā), jpn:ソファ (sofa), kor:소파 (sopa), vie:xô pha, hin:सोफ़ा (sofā)  
**sofe** *sabio* ← ell:σοφία (sofía) + eng:philosophy, fra:philosophie, spa:filosofia, rus:философия (filosofiya), may:filsafat, ara:(falsafa), swa:falsafa, tur:felsefe, hin:फ़लसफ़ा (falasfā)  
**soge** *buscar* ← zho:搜 (sōu), yue:索 (sok3), wuu:搜 (seu1), jpn:捜索 (sōsaku) + eng:seek, deu:suchen, pol:szukać, ukr:шукати (šukati) + rus:искать (iskat’)  
...
**some** *dormir (sueño)* ← fra:sommeil, por:sono, rus:сон (son), hin:सोना (sonā), ben:শোয়া (śoya) + ara: سِنَة (sina)  
**somopapil** *adormidera (amapola real)* ← eng:poppy, spa:amapola, por:papoula, swa:mpopi, ben:পপি (papi), jpn:ポピー (popī)  
**son** *sonido (audio; sonar)* ← eng:sonic, fra:son, spa:son, sonido, por:som, ita:suono + zho:声 (shēng), yue:聲 (seng1), wuu:声 (sən), jpn:声 (sei), kor:성 (seong)  
...
**state** *pararse (detenerse)* ← tur:istasyon, por:estação, spa:estación, tgl:estasyon, urd:(isṭeśan), eng:fra:station, hin:स्टेशन (sṭeśan), rus:станция (stantsiya)  
...
**sual** *preguntar (inquirir; pregunta)* ← ara: سؤال (su'āl), fas: سؤال‎ (so'âl), hin:सवाल (savāl), ben:সওয়াল (śôwal), may:soal, swa:swali, tur:sual + khm:សួរ (suə)  
...
**sum** *suma (total; sumar)* ← eng:sum, spa:suma, por:soma, fra:somme, deu:Summe, rus:сумма (summa)  
**supe** *sopa* ← spa:sopa, eng: soup, fra: soupe, deu: Suppe, swa: supu, rus:суп (sup), may:sup, jpn:スープ (sūpu)  
**supre** *superior (más alto)* ← eng:super, fra:super, spa:por:sobre, ita:sopra, jpn:スーパー (sūpā)  
**suprize** *sorpresa* ← eng:surprise, tur:sürpriz, fas:(surpris), rus::сюрприз (siurpriz), por:surpresa, spa:sorpresa  
**sus** *regaliz (alcazuz, orozuz)* ← ara: سُوس (sus), spa:alcazus, por:alcaçuz, swa:susi  
**susan** *lirio (azucena)* ← ara: سَوْسَن‎ (sawsan), spa:azucena + eng:Susan, por:Susana, fra:Suzanne, pol:Zuzana, rus:Сусанна (Susanna)  
**sute** *coser* ← hin:सीना (sīnā), rus:шить (šit') + fra:eng:suture, por:spa:sutura  
...
**ta** *a (hacia)* ← eng:to + hin:-तक (-tak) + fas: تا‎ (tâ)  
...
**tame** *codicioso (avaro)* ← ara: طَمَّاع‎ (ṭammāʿ), zho:贪 (tān), kor:탐욕 (tamyok), vie:tham  
...
**tanur** *horno* ← ara: تَنُّور‎ (tannūr), fas: تنور (tannūr), hin:तनूर (tanūr), ben:তন্দুর (tôndur), swa:tanuri, tur:tandır + eng:tandoor  
**tape** *tapón (tapa; taponar, bloquear, obstruir)* ← spa:tur:tapa, por:tampa, ell:τάπα (tapa), bul:тапа (tapa), eng:tap  
**tarif** *impuesto (tributo, tarifa)* ← eng:tariff, spa:por:tarifa, deu:fra:tur:tarif, ara:(taʿrīf), rus:тариф (tarif), hin:टैरिफ़ (ṭairif)  
**tas** *plato* ← ara: طَاس (ṭās), swa:tasa, tur:tas, fra:tasse, spa:taza, rus:таз + hin:तश्तरी (tashtarī)  
**tate** *tocar (tacto)* ← eng:fra:tact, spa:tacto, por:tato  
**tatike** *táctica (estrategia)* ← por:tática, ita:tattica, eng:tactic, rus:тактика (taktika), deu:Taktik  
**tato** *tatuaje* ← sam:tah:tatau, haw:kākau, may:tgl:tato, eng:tattoo, fra:tatouage, spa:tatuaje, por:tatuagem, rus:тату (tatu)  
**tave** *sartén* ← hin:तवा (tavā), tur:tava, fas:(tābe)  
**taxe** *tasa (precio, cuota, tarifa)* ← eng:tax, por:taxa, spa:tasa, hin:टैक्स (ṭEks)  
**taze** *fresco* ← fas: تازه (tâze), hin:ताज़ा (tāzā), ben:তাজা (taja), tur:taze, ara: طَازَج (ṭāzaj)  
**tehne** *técnica* ← ell:τεχνική (tehniki), rus:техника (tehnika), fra:eng:technique, spa:por:técnica, hin:तकनीक (taknīk), may:teknik  
**tehnium** *tecnetio* ← eng:technetium, fra:technétium, spa:tecnetio, por:tecnécio, rus:технеций, zho:锝 (dé), jpn:テクネチウム, kor:테크네튬, vie:tecnexi, hin:टेक्निशियम, ben:টেকনিসিয়াম, may:teknetium, swa:tekineti, ara: تكنيتيوم  
...
**tente** *tentar (seducir)* ← eng:tempt, fra:tenter, spa:por:tentar  
**teoria** *teoría* ← eng:theory, spa:teoría, por:teoria, fra:téorie, rus:теория (teoriya), fas:تئوری‎ (teori), may:teori  
**tepe** *cinta adhesiva* ← eng:tape, hin:टेप (ṭep), swa:tepu, jpn:テープ (tēpu), kor:테이프 (teipeu), tur:teyp  
...
**terce** *oblicuo (torcido)* ← spa:torcido, por:torto, hin:तिरछा (tirachha), ben:তেরছা (tērachā), pan:तिरकस (tirakasa)  
...
**texe** *tejer* ← spa:tejer, por:tecer, fra:tisser, eng:textile  
**teze** *tesis* ← eng:thesis, fra:thèse, spa:tesis, por:tese, rus:тезис (tezis), fas: تز‎ (tez), tur:tez, jpn:テーゼ (tēze), kor:테제 (teje)  
**tibe** *curar (sanar)* ← ara: طِبّ‎ (ṭibb), fas: طب‎ (tebb), hin:तिब्ब (tibb), ben:তবীব (tôbīb), tur:tıp, swa:tiba; tibu  
...
**tire** *disparar* ← fra:tirer, spa:por:tirar + fas: تیر (tir), hin:तीर (tīr), ben:তীর (tir)  
...
**tize** *intenso (brusco, ácido, fuerte, afilado, rápido)* ← fas: تیز (tiz), hin:तेज़ (tez), tur:tez  
**tolere** *tolerar* ← eng:tolerate, spa:por:tolerar, fra:tolérer, deu:tolerieren  
...
**toxe** *veneno (toxina; tóxico)* ← eng:toxic, fra:toxique, spa:por:tóxico, rus:токсичний (toksicniy), may:toksik + zho:毒 (dú), yue:毒 (duk6), wuu:毒 (do’), jpn:毒 (doku/toku), kor:독 (dok), vie:độc  
**tra** ** ← ita:tra, eng:through, spa:tras, por:(a)trás, fra:deu:may:trans-, rus:транс- (trans-)  
**trage** *triste (trágico)* ← eng:tragic, fra:tragique, spa:por:trágico, rus:трагический (tragičeskij)  
...
**trompe** *clarín (corneta)* ← spa:por:trompa, eng:trumpet, fra:trompette, jpn:ランペット (torampetto), kor:트럼펫 (teureompet), tur:trompet, swa:tarumbeta  
**truke** *truco* ← eng:trick, deu:Trick, fra:truc, spa:truco, por:truque, hun:trükk, rus:трюк (tr’uk)  
**tu** *tú (usted)* ← fra:por:spa:tu, hin:तू (tū), rus:ты (ty)  
...
**tuhe** *escupir (bufar)* ← hin: थूकना (thūknā), zho: 吐 (tǔ), tur:tükürmek  
...
**tunge** *dolor (sufrimiento; sufrir; doler)* ← zho:痛 (tòng), yue:痛 (tung3), kor:통 (tong)  
...
**turfe** *turba* ← eng:turf, fra:tourbe, spa:tur:turba, por:turfa, rus:торф (torf)  
...
**ulule** *aullar* ← deu:Heulen, ita:ululato, tur:uluma, tgl:aulong,   
**umame** *sabroso (umami)* ← jpn:旨味 (umami), kor:우마미 (umami), eng:fra:por:spa:may:umami, rus:умами (umami)  
**un** *uno (1)* ← fra:un, spa:uno, por:um, una, eng:one  
**unale** *el uno al otro (se; mutuo, recíproco))* ← eng:one another, ita:l’una, l’altra, fra: l'un l'autre, spa:el uno al otro, por:um ao outro, tur:birbirine, zho:彼此 (bǐcǐ)  
...
**vacin** *vacuna* ← eng:vaccine, por:vacina, rus:вакцина (vakcina), hin:वैक्सीन (vaiksīn), jpn:ワクチン (wakuchin), may:vaksin  
...
**vare** *distintos (diversos)* ← eng:various, spa:vario, por:vário  
...
**vate** *objeto (artículo)* ← hin:वस्तु (vastu), ben:বস্তু (bôstu), pan:ਵਸਤੁ (vastu), tha:วัสดุ (wạttu), mya:ဝတ္ထု (wathtu), khm:វត្ថុ (vŏəttho) + vie:vật, wuu:物 (veq5), zho:物 (wù), yue:物 (mat6), jpn:物 (butsu)  
...
**vaxe** *lavar* ← eng:wash, deu:waschen, zho:洗 (xǐ)  
**vei** *cola (rabo)* ← zho:尾 (wěi), yue:尾 (mei5), wuu:尾 (vi3), nan:尾 (bé), jpn:尾 (bi)  
**vele** *velo* ← eng:veil, fra:voile, spa:velo, por:véu, jpn:ベール (bêru), kor:베일 (beil), swa:veli  
...
**vere** *verdadero* ← eng:very, ita:vero, rus:верный (verniy), spa:verdadero, por:verdadeiro, deu:wahr, fra:vrai  
...
**veste** *oeste (occidental)* ← eng:west, deu:West, fra:ouest, spa:por:oeste, rus:вест (vest)  
...
**vide** *ver (mirar; visión)* ← rus:видеть (videt’), ita:vedere, spa:por:ver, pol:widzieć, eng:vide  
...
**viole** *violín* ← eng:violin, fra:violon, spa:violín, por:violino, may:biola, hin:वायलिन (vāylin), jpn:バイオリン (baiorin), kor:바이올린 (baiollin) + rus:виолончель (violončel’)  
**violete** *morado (púrpura)* ← eng:por:fra:violet, spa:violeta, deu:violett, rus:фиолетовый (fioletovyy), jpn:バイオレット (baioretto), kor:보라 (bola)  
...
**vizin** *GMS* ← zho:味精 (wèijīng), yue:味精 (mei6 zing1), vie:mì chính, may:vetsin, micin, tgl:bitsin  
**vode** *prometer (promesa, voto)* ← fra:vœu, spa:por:voto, ara:وعد (waʿd), hin:वादा (vādā), tur:vaat, fas:وعده (va'deh)  
**vodun** *vudú* ← ewe:vodun, hat:vodou, bra:vodum, eng:voodoo, fra:vaudou, spa:vudú  
**voke** ** ← eng:voke, fra:-voquer, spa:por:-vocar + deu:Vokal  
**vol** *querer (desear; deseo)* ← fra:voiloir, ita:volere, deu:wollen, eng:volition, spa:voluntad, rus:воля (volya), pol:wola  
...
**xam:** *noche (tarde)* ← fas: شام‎ (šâm), hin:शाम (śām), ben:শাম (śam), tur:akşam  
**xaman** *chamán (brujo, hechicero)* ← eng:shaman, fra:chaman, spa:chamán, rus:шаман (šaman), tur:şaman, may:shaman, jpn:シャーマン (shāman)  
**xanke** *duda* ← hin:शंका (śankā) + ara: شَكَّ‎ (šakka), swa:shaka  
**xante** *tranquilo (calmado)* ← hin:शांति (shānti), ben:শান্তি (shānti), pan:ਸ਼ਾਂਤੀ (shāntī), mar:शांत (shānta), tel:శాంతి (shānti), guj:શાંતિ (shānti), khm:សន្តិ (sɑnte’), eng:por:shanti, rus:шанти (šanti), jpn:シャンティ (shanti)  
...
**xarte** *condición (requisito, estipulación; espicificar, estipular)* ← tur:şart, ara:fas:(šart), swa:sharuti, hin:शर्त (śart), ben:শর্ত (śôrt)  
...
**xatrange** *ajedrez* ← hin:शतरंज (śatrañj), urd:(śatrañj), fas:(šatranj), tur:satranç, ara:(šaṭranj), swa:sataranji, tel:చతురంగము (caturaṅgamu), tam:சதுரங்கம் (caturaṅkam), may:catur, khm:ចត្រង្គ (caʾtrɑng), por:xadrez  
**xaxa** *susurrar (curjir)* ← zho:(shasha), rus:шуршать (shurshat’), swa:-chakacha  
**xe** *cosa* ← ara: شيء (šayʾ), tur:şey, fas: شیء‎ (šeyʼ) + zho:事 (shì), yue:事 (si6), vie:sự  
**xefe** *jefe* ← fra:chef, por:chefe, gal:xefe, spa:jefe, rus:шеф (šef), eng:chief, swa:chifu, jpn:チーフ (chīfu), + ara:(šeyx)  
**xehal** *situación* ← zho:事态 (shìtài), jpn:事態 (jitai), eng:state of affairs, fra:état des choses  
...
**xipe** *mojar (mojado)* ← zho:濕 (shī), yue:濕 (sap1), wuu:濕 (seq4), jpn:濕 (shitsu), kor:습 (seup)  
**xir** *poema* ← heb:שיר (šir), ara: شِعْر‎ (šiʿr), tur:şiir, fas: شعر‎ (še'r), swa:shairi, may:syair+ zho:诗 (shī), yue:詩 (si1), jpn:詩 (shi), kor:시 (shi)  
...
**xofe** *conducir* ← fra:eng:deu:chauffeur, spa:por:chofer, rus:шофёр (šofjor), pol:szofer, tha: โชเฟอร์ (chofoe), tur:şoför, fas:(šofer)  
**xoke** *choque (sacudida)* ← eng:shock, fra:choc, spa:por:choque, rus:шок (šok), jpn:ショック (shokku), kor:쇼크 (syokeu), may:syok, tur:şok  
**xope** *comprar (compras, shopping)* ← eng:fra:spa:shopping, jpn:ショッピング (shoppingu), kor:쇼핑 (syoping), tha:ชอปปิ้ง (chop-bing), rus:шоппинг (šopping), zho:血拼 (xuèpīn)  
**xou** *mostrar (exposición, espectáculo)* ← eng:deu:fra:spa:por:show, rus:шоу (šou), tur:şov, swa:shoo, tha:โชว์ (choo), kor:쇼 (syo), jpn:ショー (shō), zho:秀 (xiù)  
**xukre** *agradecer (gracias)* ← ara: شُكْر‎ (šukr), hin:शुक्रिया (śukriyā), ben:শুকরিয়া (śukriẏa), swa:shukrani, tur:şũkür  
**xule** *aprender (estudiar)* ← zho:学 (xué) + deu:Schule, swa:shule + eng:school, fra:école, spa:escuela, por:escola, rus:школа (škola), hin:स्कूल (skūl), ben:স্কুল (śkul), may:sekolah  
**xure** *comienzo (inicio, principio; comenzar, iniciar, empezar)* ← ara: شُرُوع‎ (šurūʿ), fas: شروع (šoru') , hin:शुरू (śurū), ben:শুরু (śuru) + zho:始 (shǐ), jpn:始 (kaishi), kor:시 (shi)  
...
**yage** *aproximadamente* ← kor:약 (yag), jpn:約 (yaku), yue:約 (yœk), zho:约 (yuē) + tur:yaklaşık  
...
**yau** *necesitar (necesidad)* ← zho:要 (yāo), yue:要 (jiu1), wuu:要 (yo1), jpn:要 (yō), vie:yêu  
**ye** *sí* ← eng:yeah + may:ya + kor:예 (ye)  
**yege** *cazar (pescar)* ← deu:jagen + eng:jaeger, rus:егерь (jeger’)  
**yeze** *coco* ← zho:椰子 (yēzi), yue:椰子 (ye4zi2), kor:야자 (yaja), jpn:椰子 (yashi)  
**yodium** *yodo (iodo)* ← eng:iodine, fra:iode, spa:yodo (iodo), por:iodo, rus:йод, jpn:ヨウ素, kor:요오드, vie:iot, hin:आयोडिन, ben:আয়োডিন, may:yodium, swa:iodini, ara: يود  
...
**yom** *día* ← ara: يَوْم‎ (yawm), hin:यौम (yaum), may:yaum  
...
**zaman** *tiempo (era, periodo, época)* ← ara: زَمَن‎ (zaman), swa:zamani, may:jam(an), tur:zaman, yor:samaani + hin:समय (samay), ben:সময় (sômyô)  
**zanger** *artesano* ← zho:匠 (jiàng), tha:ช่าง (jang), khm:ជាង (ciəng)  
**zar** *riesgo (posibilidad; azar, aleatorio)* ← ara: زَهْر (zahr), tur:zar, fas: زار (zâr) + eng:hazard, spa:por:azar  
...
**zoe** *animal (bestia)* ← eng:fra:spa:por:may:tur:zoo-, rus:зоо- (zoo-) + zho:兽 (shòu), yue:獸 (sau3), jpn:獣 (jū), kor:수 (su)  
...
**zong** *especie* ← zho:種 (zhǒng), yue:種 (zung2), wuu:種 (tson2), jpn:種 (shu), kor:종 (jong), vie:chủng  
...
**• konike** *comunitario* ← eng:common, spa:común, por:comum, fra:commun, rus:коммунальный (kommunal’nyy)  
**• kopiaje** *copia (réplica)* ← eng:copy, fra:copie, spa:por:copia, rus:копия (kopiya), hin:कापी (kāpī), tur:kopya, may:kopi, zho:拷貝 (kǎobèi), jpn:コピー (kopī)  
