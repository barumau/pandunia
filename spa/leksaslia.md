...
**agri** *cultivar* ← zho:农民 (nóng), yue:農民 (nung4), jpn:農 (nō), kor:농 (nong), vie:nông  
...
**be rota** *girar (rotar)* ← eng:rotate, deu:rotieren, spa:rotar, por:rodar, may:rotasi, tur:rotasyon  
...
**caku** *cuchillo* ← hin:चाक़ू (cāqū), fas:(čâqu), nep:चक्कु (cakku), kan:ಚಾಕು (cāku)  
...
**e** *ser (estar)* ← fra:est /ɛ/, por:é /ɛ/, spa:es, hin:है /ɦɛ/, bul:е /ɛ/  
...
**faxa** *tira (faja, vendaje, cinta)* ← ita:fascia, por:faixa, spa:faja  
...
**gomu** *goma (caucho, hule, borrador)* ← spa:tgl:goma, fra:gomme, jpn:ゴム (gomu), kor:고무 (gomu), deu:Gummi  
...
**kanca** *vidrio (cristal)* ← hin:काँच (kānc), ben:কাঁচ (kãcô), mar:काच (kāc), may:kaca, tel:గాజు (gāju)  
...
**metri** *medir (medida)* ← eng:meter, spa:por:-metro, rus:метр tur:metre, + hin:मात्रा (mātrā), ben:মাত্রা (matra), may:matra  
...
**sabu** *razón (causa)* ← heb:(sibá), hau:sabo;sababi, kon:sambu, ara:urd:(sabab), tur:sebep, may:sebab, swa:sababu  
...
**varite** *patrimonio (herencia, legado)* ← may:waris, ara:(wariþ), swa:urithi, tur:varis,miras  
