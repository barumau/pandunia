...
**jangoxute** *arte marcial* ← zho:武术 (wǔshù), jpn:武術 (bujutsu), vie:võ thuật, kor:무술 (musul), eng:martial art  
...
**kame** *lujuria (deseo)* ← hin:काम (kām), tha:กาม (gaam), eng:kama  
...
**kate** *cortar* ← eng:cut, ara:(qaṭa’a), hin:काटना (kāṭnā), ben:কাটা (kata), swa:kata, vie:cắt, zho:割 (gē), yue:割 (got3), wuu:割 (ga’), jpn:割 (katsu)  
...
**lave** *viejo (anciano)* ← zho:老 (lǎo), yue:老 (lau2), wuu:老 (lau3), jpn:老 (rō), vie:lão  
...
**laze** *basura (desechos)* ← zho:垃圾 (lājī)  
...
**pauze** *parar (pausa)* ← eng:deu:fra:pause, spa:por:pausa, rus:пауза (pauza)  
...
**siyahe** *negro* ← fas:سیاه‎ (siyâh), hin:सियाह (siyāh), urd:سیاہ (siyāh), pan:ਸਿਆਹ (siāh), tur:siyah  
