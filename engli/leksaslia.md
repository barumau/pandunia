...
|age|umur|ara:عُمْر‎ (ʿumr). hin:उमर (umar). ind:umur. swa:umri.|
...
|appearance (looks)|rupe|hin:रूप (rūp). ind: rupa. tha: รูป /rūp/. khm:រូប (rūp).|
|apple|aple|eng:apple. deu:Apfel. ind:apel. ben:আেপল (apôl). zul:ihhabhula.|
...
|asthma|asme|fra:asthme. eng:asthma. spa:por:ind:asma. pol:astma.|
|attack (assault, aggression)|agres|eng:deu:fra:agression. pol:agresja. rus:агрессия (agressiya). spa:agresión. por:agressão. ind:agresif.|
...
|bag (sack)|sake|deu:eng:sack. fra:sac. spa:por:saco. ind:kon:saku.|
|bah|bah|eng:spa:ita:bah. por:ba.|
|bake|beka|eng:bake. hin:पकाना (pakānā). rus:печь (peč). deu:backen.|
|balloon|balon|fra:ballon. tur:ind:pol:balon. eng:balloon. tgl:balun. hau:balân.|
|ball|bol|eng:ball. spa:por:ind:tgl:bola. tha:บอล (bɔl). jpn:ボール (bōru). kor:볼 (bol). khm:បាល់ (bal). ben:বল (bôl). deu:Ball. fra:boule,balle.|
...
|bank (depository)|banke|eng:deu:pol:ind:bank. tur:banka. rus:банк (bank). fra:banque. spa:por:banco. fas:(bânk). hin:बैंक (baiṅk). urd:(baiṅk). tel:బ్యాంకు (byāṅku). tam:(vaṅki).|
...
|breath|nafas|ara:fas:(nafas). ind:napas. tur:nefes. hau:numfashi.|
...
|cannabis (marijuana, ganja, pot, weed)|ganje|hin:गांजा (gāñjā). urd:(gānjā). pnb:ਗਾਂਜਾ (gāñjā). ben:গাঁজা (gañja). tel:గంజాయి (gañjāyi). tam:கஞ்சா (kañcā). khm:កញ្ឆា (kɑñchaa). tha:กัญชา (gan-chaa). vie:cần sa. eng:por:ind:ganja. jpn:ガンジャ (gānjya).|
...
|card|karde|eng:card. jpn: カード (kādo). swa: kadi. zho:卡 (kǎ). deu:Karte. ind:kartu. fra:carte.|
...
|chair|kurse|ara:(kursiy). hin:कुरसी (kursī). urd:(kursī). pnb:ਕੁਰਸੀ (kursī). tel:(kurcī). ind:som:kursi. fas:(korsi).|
|change (alter, convert)|muta|spa:mudar. eng:mutate. fra:muter.|
|chapter (section)|babe|ind:bab. ara:urd:fas:(bāb).|
...
|chaussure|sapate|spa:zapato. por:sapato. ind:sepatu. swa:sapatu.|
...
|chocolate|cokol|eng:chocolate. hin:चाकलेट (cāklet). zho:巧克力 (qiǎokèlì). spa:chocolate. ind:cokelat.|
...
|church|eglis|fas:(kelisā). tur:kilise. ind:gereja. por:igreja. hin:गिरजा (girjā). ara:(kanisā). fra:église.|
...
|civilized (civil)|sivili|eng:civil. por:civil. hin:सिविल (sivil). ind:sipil.|
...
|climate|klime|ell:κλίμα (eklíma). spa:por:clima. ara:(ʾiqlīm). ind:tur:iklim. eng:climate. rus:климат (klimat).|
|clothing|fuke|zho:衣服 (yīfu). yue:(yifuk). jpn:衣服 (ifuku). kor:의복 (uibog).|
|cloud|megam|hin:मेघ (megh). ben:মেঘ (megh). tam:மேகம் (mēgam). tel:మేఘము (mēghamu). ind:mega. tha:เมฆ (mek).|
...
|congratulate (bless)|barka|hau:barka. ind:berkah. tur:tebrik. fas:(tabrik). ara:urd:(mubārak). yor:alubarika.|
...
|cook (chef)|kuker|eng:cook. rus:кухар (kuhar). pol:kucharz. tha:กุ๊ก (gúk). ind:koki. deu:Koch.|
|cook (prepare food)|kuka|eng:cook. deu:Kock. ita:cuoco. ind:koki. tha:กุ๊ก (kuk). sango:kuku.|
...
|country (land)|dex|hin:देश (deś). ben:দেশ (deś). tel:(dēśamu).|
...
|cupboard (closet, cabinet, wardrobe)|almar|hin:अलमारी (almārī). ben:আলমারি (almari). ind:lemari. spa:armario. por:armário.|
...
|custom (tradition, practice, convention)|rasme|ara:(rasm). hin:रस्म (rasma). ind:resmi.|
|cute (sweet)|kaway|jpn:可愛い (kawaii). kor:카와이 (kawai). eng:kawaii.|
|cut|kata|eng: cut. hin: काटना /kāṭnā/. swa: -kata.|
...
|danger (peril)|hatre|ara:(xaṭar). fas:(xatar). urd:(xatra). hin:ख़तरा (xatrā). swa:hatari. tur:muhatara.|
|data (numeric information)|date|eng:ind:data. vie:đa ta. deu:Daten. spa:tgl:datos. por:dados. fas:(dâde-hâ). hin:डेटा (ḍeṭā). urd:(ḍeṭā). jpn:データ (dēta).|
...
|dead (deceased)|morti|por:morto. fra:mort. spa:muerto. fas:(morde). urd:(murda). hin:मृत (mrta). rus:мёртвый (myortvïy). + ind:mati. + ara:(mawt). amh:ሞት (mot).|
...
|die (dice)|dade|spa:por:tgl:dado. ind:swa:dadu.|
...
|dry|gan|zho:干 (gān). yue:乾 (gon1). kor:건 (geon).|
...
|earth (ground)|zeme|slk:zem. cze:země. pol:ziemia. rus:земля (zemlya). fas:urd:(zamīn). hin:ज़मीन (zamīn).|
...
|elephant|gaje|hin:गज (gaj). tel:గజము (gajamu). kan:ಗಜ (gaja). ind:gajah. tgl:gadya.|
|emerald|zumrude|ara:(zumurrud). fas:(zomorrod). tur:zümrüt. ind:zamrud. rus:изумруд (izumrud). swa:zumaridi.|
|emotion (feeling)|gam|yue:感 (gam2). zho:感 (gǎn). kor:감 (gam). vie:cảm xúc. jpn:感情 (kanjō).|
|empty|hali|ben:খালি (khali). hin:ख़ाली (xālī). tel:ఖాళీ (khāḷī) tam:(kali). urd:(xālī). fas:(xāli). ara:(xāliy). jpn:空 (kara).|
...
|even (intensifier)|hati|por:até. ara:(ḥatta). spa:hasta. swa:hata.|
...
|face|muke|ben:মুখ (mukh). hin:मुख (mukh). tam:முகம் (mukam). tel:(mukhamu). ind:muka. tgl:mukha.|
...
|forbidden (illicit, haram, taboo)|haram|ara:(ḥarām). hau:ind:tur:eng:deu:haram. hin:हराम (harām). kor:하람 (haram). fas:urd:(harām). swa:haramu. zho:哈拉姆 (hālāmǔ). rus:харамный (xaramniy).|
...
|giraffe|jiraf|ara:(zarāfa). Eng:fra:giraffe. por:girafa. spa:jirafa. rus:жираф (žiraf).ind:jerapah. tur:zürafa. kor:지라프 (jirapeu). hin: जिराफ़ (jirāf). ben:জরৈফ (jôrôph).|
|give|dona|eng:dan:give. deu:geben. zho:给 (gěi).|
|glass|kance|hin:काँच (kānc). ben:কাঁচ (kãcô). mar:काच (kāc). ind:may:kaca. tel:గాజు (gāju).|
...
|god (deity)|dew|por:deus. ind:dewa. hin:देवता (devtā). kan:(dēva).|
...
|grave (tomb)|gabre|ara:(qabr). hin:क़ब्र (qabra). ind:kubur. deu:Grab. pol:grób. rus:гроб (grob).|
|greedy|tami|ara: طَمَّاع‎ (ṭammāʿ). zho:贪 (tān). kor:탐욕 (tamyok). vie:tham.|
|greens|coy|zho:菜 (cài). yue:菜 (coi3). eng:-choy. Ind:-coy.|
|green|lugi|zho:绿 (lǜ). yue:綠 (luk6). vie:lục. kor:록/녹 (rok/nok). jpn: 緑色 (ryokushoku).|
|greeting (hello)|salame|ara:(salām). swa:salamu. ind:selamat. hin:सलाम (salām). ben: সালাম (salam). zho:萨拉姆 (sàlāmǔ). jpn:サラーム (sarāmu). kor:살람 (sallam). vie:xa lam. rus:салям (salyam).|
...
|guru (teacher)|gur|hin:गुरु (guru). ben:গুরু (guru). guj:ગુરુ (guru). pnb:ਗੁਰੂ (gurū). tgl:guro. tha:ครู (gruu). ind:eng:por:guru. spa:gurú. rus:гуру (guru). fra:gourou. kor:구루 (guru). jpn:グル (guru).|
...
|ind:badam. tur:badem. hin:बादाम (bādām). ben:বাদাম (badam). zho:巴旦木 (bādànmù).|badam|ind:badam. tur:badem. hin:बादाम (bādām). ben:বাদাম (badam). zho:巴旦木 (bādànmù).|
...
|infidel (pagan, heathen, unbeliever)|kafir|ara:(kāfir). fas:(kāfer). tur:fra:kâfir. yor:kaferi. swa:kafiri. ind:kafir. rus:кафир (kafir). hin:काफ़िर (kāfir).|
...
|instructions (recipe)|recete|ita:ricetta. rus:рецепт (retsept). deu:Rezept. spa:receta. por:receita. fra:recette. ind:resep.|
...
|island|nes|ell:νήσος (nēsos). ind:nusa. mlg:nosy.|
|issue (affair, concern)|masle|ara:(masʾala). hau:matsala. hin:मसला (maslā). ind:masalah.|
...
|jasmine|malike|kan:(mallige). tam:(mallikai). tel:(malla). ind:melati.  kor:말리 (malli). tha:มะลิ (mali). zho:茉莉 (mòlì).|
...
|kebab (skewer meat)|kababe|ara:fas:urd:(kabāb). tur:ind:eng:spa:kebab. hin:कबाब (kabāb). ben:কাবাব (kabab).|
...
|lamp|lampe|fra:deu:lampe. eng:lamp. ind:lampu.|
|language (communication)|bax|hin:भाषा (bhāṣā). urd:(bhāṣā). ben:ভাষা (bhaṣa). pnb:ਭਾਸ਼ਾ (bhāshā). tel:భాష (bhāṣa). tam:பாசை (pāsai). tha:ภาษา (phasa). ind:bahasa. jav:basa.|
...
|like (enjoy, be fond of)|suku|jpn:好く (suku). ind: suka.|
...
|lion|sing|ind:singa. hin:सिंघ (singh). ben:সিংহ (singh). tam:சிங்கம் (sinkam). tha:สิง (sing). zho:狮 (shī). jpn:獅子 (shishi). + swa:simba.|
...
|lychee (litchi)|lice|zho:荔枝 (lìzhī). hin:लीची (līcī). eng:lychee. rus:личи (liči). ind:leci. vie:lệ chi.|
|machine|maxin|fra: machine. eng: machine. deu: Maschine. ind: mesin.|
...
|market (bazaar)|bazar|fas:urd: بازار (bāzār). hin:बाज़ार (bāzār). fra:spa:por:bazar. eng:bazaar. rus:базар (bazar). ind: pasar. khm:ផ្សារ (psar).|
...
|mask (camouflage)|maske|eng:mask. fra:masque. spa:por:máscara. rus:маска (maska). hin:मास्क (māsk). jpn:マスク (masuku). kor:마스크 (maseukeu). ind:masker. Tur:maske.|
...
|mollusk|moluske|eng:mollusk. deu:Molluske. fra:mollusque. rus:моллюск (mollyusk). spa:por:molusco. ind:moluska. hin:urd:(molask).|
|moment (while, short time)|sate|ara:(sāʿa). fas:(sâ'at). ind:tur:saat. swa:saa. lin:sâ. som:saacad. scr:sat.|
...
|opportunity (chance)|canse|fra:eng:chance. jpn:チャンス (chansu). kor:찬스 (chanseu). rus:шанс (šans). tur:şans.|
...
|passport|pasporte|eng:passport. fra:passeport. spa:pasaporte. Por:passaporte. rus:паспорт (pasport). hin:पासपोर्ट (pāsporṭ). ben:পাসপোর্ট (pasporṭ). Ind:paspor. swa:paspoti. Jpn:パスポート pasupōto).|
...
|pineapple|nanas|ind:nanas. swa:nanasi. hin:अनन्नास (anānnas). rus:ананас (ananas).|
|pipe|pipe|spa:ind:pipa. eng:fra:pipe. fas:(pip). vie:píp.|
|piss (urine)|pix|eng:piss. fra:pisse. ita:piscia. hin:पेशाब (pešāb). ind:pipis.|
...
|praise (commend, exalt)|halela|heb:(hal'lu yah). eng:hallelujah. zho:哈利路亚 (hālìlùyà). ara:(hallilūyā). por:fra:alléluia. rus:аллилуйя (alliluyya). spa:aleluya. ind:haleluya. tgl:aleluya. jpn:ハレルヤ (hareruya). kor:할렐루야 (hallelluya).|
|pray|duwa|tur: dua. swa: dua. ind: doa. ara: دُعَاء‏ /duʿāʾ/.|
...
|reason (cause)|sabe|heb:(sibá). hau:sabo;sababi. kon:sambu. ara:urd:(sabab). tur:sebep. ind:sebab. swa:sababu.|
...
|register (record, log)|defte|tur:scr:defter. ell:τεφτέρι (tefteri). ind:daftar. ara:fas:(daftar).|
|relationship (association, connection)|guanxe|zho:关系 (guānxi). vie:quan hệ. kor:관계 (gwangye). jpn:関係 (kankei).|
|religion (worship)|din|ara:urd:(dīn). fas:(din). tur:ind:din. swa:dini. hau:addini. hin:दीन (dīn).|
...
|right (justification, privilege)|hake|ara: /haqq/. tur: hak. ind: hak. swa: haki. hau: hakki.|
|right hand side|raite|eng:right.|
|risk|riske|fra:risque. eng:tur:risk. por:risco. rus:риск (risk). jpn:リスク (ja) (risuku). deu:ind:risiko.|
...
|rotate (spin, turn on an axis)|rotu|eng:rotate. deu:rotieren. spa:rotar. por:rodar. ind:rotasi. tur:rotasyon.|
...
|salad|salade|fra:salade. end:ind:salad. deu:Salat. rus:салат (salat). tur:salata. fas:urd:(salād). hin:सलाद (salād). yue:沙律 (saa1 leot62).  zho:沙拉 (shālā). por:salada. spa:ensalado. kor:샐러드 (saelleodeu). jpn:サラダ (sarada). tha:สลัด (salat). khm:សាលាដ (saalaat).|
|salt|sal|por:spa:sal. eng:salt. rus:соль (solʹ).|
|same|sam|ind:sama. hin:urd: ”saman”. eng:same. fra:semblable.|
|sandwich|sanwice|eng:fra:sandwich. por:sanduíche. rus:сандвич (sandvič). ara:(sandawitš). Putong zho: (sānwénzhì). jpn:サンドイッチ (sandoichi). hin:सैंडविच (saiṇḍvic). ind:sandwic.|
...
|shampoo|kexosabun|por:xampu. spa:champú. eng:shampoo. jpn:シャンプー (shanpū). vie:xà bông. hin:शैंपू (śaimpū). tur:şampuan.|
...
|shirt|kamis|spa:por:camisa. ara:(qamīṣ). hin:क़मीज़ (kāmīz). ind:kemeja.|
...
|sibling (brother or sister)|saudar|ind:saudara. hin:सहोदर (sahodar). ben:সহোদর (sôhodôr).|
|sickness (illness, disease)|patia|deu:eng:fra:patho-. spa:por:pol:tur:ind:pato-. rus:пато- (pato-).|
...
|soul (mind, psyche)|ruhe|ara:(rūħ). ind:ruh. tur:ruh. hin:रूह (rūh). swa:roho. hau:ruhu. som:ruux. + rus:дух (duh).|
|sound (audio)|sonde|eng:sound,sonic. fra:son. spa:son,sonido. ita:suono. + kor:소리 (sori).|
|soup|supe|spa:sopa. eng: soup. fra: soupe. deu: Suppe. swa: supu. rus:суп (sup). ind:sup. jpn:スープ (sūpu).|
|sour|suan|zho:酸 (suān).|
|south|sude|spa:sur. por:sul. fra:sud.|
|space (cosmos, universe)|kosmia|rus:космос (kosmos). eng:fra:spa:cosmos.|
|special (distinct)|hasi|ara:(xāṣṣ). fas:urd:(xās). ind:ख़ास (xās). ind:khas.|
|speech (word)|loge|ell:λόγος (logos). eng:-logue. fas:(loğat). ara:(luğa). swa:lugha. tur:lügat. ind:logat.|
...
|stage (phase)|faze|spa:por:ita:ind:fase. eng:fra:phase. rus:фаза (faza). pol:faza. fas:(fāz).|
...
|step (degree, rank, grade, level, class)|darje|ara:(daraja). hin:दर्जा (darjā). swa:daraja. tur:derece. fas:(dareje). ind:derajat. + zho:阶 (jiē).|
...
|theft|core|hin:mar:चोरी (corī). urd:(corī). tha:โจร (chon). ind:curi. ben:চুরি (curi).|
...
|thought (idea)|fikre|ara:(fikr). fas:(fekr). tur:fikir. ind:pikir. hin:(fikr).|
...
|time (period, epoch, era)|zaman|tur:zaman. ind:jaman. swa:zamani. ara:(zaman). fas:(zamān). + hin:समय (samay).|
|time (turn, occasion)|ban|kor:번 (beon). vie:bận. jpn:番 (ban). zho:遍 (biàn). + hin:बार (bār). urd:fas:(bār). ben:বার (bar).|
|tobacco|tabake|deu:Tabak. rus:табак (tabak). fra:tabac. spa:por:tabaco. jpn:タバコ (tabako). eng:tobacco. hin:तंबाकू (tambākū). ind:tembakau.|
|tomato|tomate|eng:tomato. por:spa:tomate. rus:томат (tomat). ind:tomat. hin:टमाटर (ṭamāṭar).|
...
|toxic (poisonous, venomous)|toksi|eng:toxic. fra:toxique. spa:por:tóxico. rus:токсичний (toksicniy). ind:toksik.|
|train|tren|eng:fra:train. spa:tur:tren. hin:ट्रेन (ṭren). por:trem.|
|transit (passage)|transe|eng:fra:spa:por:deu:ind:trans-. rus:транс- (trans-).|
|translation (interpretation)|tarje|ara:(tarjama). hin:तर्जुमा (tarjuma). urd:(tarjuma). ben:তর্জমা (tôrjôma). ind:terjemah. tur:tercüme.|
...
|trunk (torso)|torse|fra:torse. rus:торс (tors). deu:eng:spa:ind:torso.|
...
|turquoise gem|firuze|per:(firuze). tur:firuze. ara:(fayrūz). swa:feruzi. hin:फीरोज़ा (phīrozā). ben:ফিরোজা (phiroja). ind:pirus. rus:бирюза (biryuza).|
...
|window|janel|por:janela. tam:சன்னல் (sannal). ben:জানালা (janala). ind:jendela. nya:zenera. kon:nêla.|
|wind|hawe|hin:हवा (havā). urd:(havā). pnb:ਹਵਾ (hawā). + ara:(hawāʾ). fas:(havā). tur:hava. ind:hawa. som:hawo. swa:hewa. ben:হাওয়া (haowa).|
...
|wood (timber)|moke|zho:目 (mù). yue:目 (muk). vie:mục. jpn:目 (-moku). kor:목 (mok).|
|world|dunia|ind:swa:dunia. ara:(dunyā). hindi:दुनिया (duniyā). urd:(duniyā). hau:duniya. fas:(donya).|
|worm|verme|eng:worm. por:verme. fra:ver. deu:Wurm.|
|worship (reveration)|puje|hin:पूजा (pūjā). urd:(pūjā). tha:บูชา (bucha). ind:puja.|
|wow! (gee!)|waw|zho:哇 (wā). eng:wow.|
|writing (text)|kitabe|ara:urd:(kitāb). fas:(ketâb). tur:kitap. ind:kitab. swa:kitabu. hin:किताब (kitāb).|
...
|yoga|yoge|hin:योग (yog). pnb:ਯੋਗ (yog). urd:(yog). ben:যোগ (jog). tel:యోగా (yōgā). tha:โยคะ (yōga). eng:spa:ind:tur:yoga. por:ioga. rus:йога (yoga). zho:瑜伽 (yújiā). jpn:ヨーガ (yōga). kor:요가 (yoga).|
...
|zero (none)|nol|rus:ноль (nol'). ind:tkm:nol. deu:null. eng:null.|
...
|zombie|zombe|kon:nzambi. Por:zumbi. eng:zombi. ind:zombi. hin:ज़ोंबी (zombī).|
