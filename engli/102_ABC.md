...
**b, d, f, h, j, k, l, m, n, p, t, z** is familiar and easy.
...
- **v** is considered to be a semivowel.
  It is pronounced like /w/ or /v/ or a sound between them
  depending on the accent of the speaker.


## Semivowels

There are two semivowels: **y** and **v**.
**y** is pronounced as in English.
**v** is pronounced as "w" in English.
As semivowels, **y** is close to the **i** sound
and **v** is close to the **u** sound.

Semivowels **y** and **v** are always followed by a full vowel or
a word break (when the bare word stem is used). For example:  
**mav nica gavi dav.** = The cat goes under the high road.
