...
|**seng**|zho:成 (chéng), yue:成 (sing4), jpn:成 (sei), kor:성 (seong)|
...
|**cerize**|eng:cherry, fra:cerise, spa:cereza, por:cereja, rus:черешня (čerešnya), ara:(karaz), tur:kiraz, hin:गिलास (gilās), ben:চেরি  (ceri), may:ceri, jpn:チェリー (cherī), kor:체리 (cheri)|
...
|**cope**|zho:锄 (chú), yue:鋤 (co4), tha:จอบ (chop), tur:çapa|
...
|**dare**|hin:धारा (dhārā), tel:ధార (dhāra) + fas: دریا‎ (daryâ), hin:दर्या (daryā), ben:দরিয়া (dôriẏa), tur:derya|
|**darge**|ara:(daraja), hin:दर्जा (darjā), swa:daraja, tur:derece, fas:(dareje), may:derajat, + zho:阶 (jiē)|
|**darmositium**|eng:darmstadtium, fra:darmstadtium, spa:darmstatio, por:darmstádio, rus:дармштадтий, zho: (dá), jpn:ダームスタチウム, kor:다름슈타튬, vie:darmstadti, hin:डार्म्स्टेडशियम, ben:ডারমস্টাডটিয়াম, may:darmstadtium, swa:darmstadti, ara: دارمشتاتيوم|
...
|**dosile**|eng:fra:ita:docile, spa:por:dócil|
...
|**dungia aventur**|eng:dungeon, fra:donjon, jpn:ダンジョン (danjon)|
...
|**em**|eng:-eme, spa:por:-ema, fra:-ème, rus:-ема (-ema), may:-em|
...
|**fade**|zho:发 (fā), yue:發 (faat3), wuu:發 (faq4), jpn:発 (hatsu), vie:phát|
...
|**fixe**|eng:fix, fra:fixer,ficher, spa:fijar, por:fixar|
...
|**komi**|eng:comic, fra:comique, spa:por:cómico + rus:комедия (komedija), jpn:コメディ (komedi), kor:코미디 (komidi)|
...
|**kope**|eng:copy, fra:copie, spa:por:copia, rus:копия (kopiya), hin:कापी (kāpī), tur:kopya, may:kopi, zho:拷貝 (kǎobèi), jpn:コピー (kopī)|
...
|**tire**|spa:por:tirar, fra:tirer, eng:tear, tur:tire|
