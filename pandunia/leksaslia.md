...
|**abies**|spa:por:abeto|
|**acente**|eng:fra:accent, spa:por:acento, pol:akcent, jpn:アクセント (akusento)|
|**acesa**|eng:access, spa:acceso, por:acesso, fra:accès, may:akses, jpn:アクセス (akusesu)|
...
|**agres**|eng:deu:fra:agression, pol:agresja, rus:агрессия (agressiya), spa:agresión, por:agressão, may:agresif|
|**agri**|eng:fra:spa:por:tur:agro-, rus:агро- (agro-)|
...
|**alge**|eng:spa:por:pol:may:alga, fra:algue, deu:Alge, tur:alg, fas:(âlg)|
|**ali**|ell:άλλος (állos), ltn:alius, eng:fra:allo-, por:spa:alo-, rus: алло- (allo-)|
|**alkol**|fra:alcool por:álcool spa:alcohol eng:alcohol hin: ara:(kuhul), rus:алкоголь (alkohol), pol:alkohol|
...
|**ameno**|heb: אָמֵן‎, (ʾāmēn), ara: آمین‎, (āmīna), swa:amina,amini, tur:amin + ell:ἀμήν (ámén), eng:deu:fra:pol:spa:amen, zho:阿门 (āmén), kor:아멘 (amen), jpn:アーメン (āmen)|
...
|**an**|deu:an, fra:en, spa:en+ ibo:lin:kon:na|
|**an:a**|eng:fra:-ant, spa:por:-ando, tur:-(y)an;-(y)en, may:-an + [ana] fas:(-ân-), hin:(-(v)ānā), ben:-নো  (-ānô)|
...
|**ani**|ell:ἀν- (an-), eng:un-, hin:अन- (an-), fra:spa:por:in-|
...
|**argente**|por:ita:argento, fra:argent, may:argentum|
...
|**Ashuria**|akk:(aššur), ara:(aššur), hin:अश्शूर (aśśūr), fas:(āšūr), eng:Assyria, fra:Assyrie, spa:Asiria, por:Assíria, rus:Ассирия (Assiriya), zho:亚述 (Yàshù)|
...
|**asme**|fra:asthme, eng:asthma, spa:por:may:asma, pol:astma|
...
|**ate**|por:ato, eng:act, fra:acte, spa:acto, rus:акт (akt), may:aksi|
...
|**au**|spa:ay, por:ai, fra:aïe, zho:哎 (ai), kor:아야 (aya), fas:(ây), rus:ай (ay)|
|**auda**|eng:spa:fra:audio, por:áudio|
|**aure**|ltn:aurum, por:ouro, spa:oro, fra:or, rus:аурум (aurum), may:aurum|
...
|**baki**|yue:白 (baak6), vie:bạch, zho:白 (bái), jpn:白 (haku), kor:백 (baek), + fra:blanc, spa:blanco, por:branco|
|**balde**|spa:por:balde, hin:बाल्टी (bālṭī), ben:(balti)|
|**balibali**|eng:various, spa:vario, por:vário, jpn:とりどり (toridori), ben:বিবিধ (bibidha), may:berbagai-bagai, swa:balimbali|
...
|**bara**|eng:bar, spa:por:barrar fra:barrière, rus:барьер (baryer) + hin:बाड़ (bāṛ), ben:বেড়া (beṛa)|
...
|**bari**|hin:भार  (bhār), ben:ভারী (bharī), may:berat, tel:బరువు (baruvu), fas: بار‎ (bâr), ell: βαρύς (barýs) + kor:바리 (bari)|
...
|**basi**|fas:urd:س (bas), ara:(bass), hin:(bas), swa:basi, spa:por:ita:basta|
...
|**bato**|zho:八 (bā), yue:八 (baat3), wuu:八 (baʔ), jpn:八 (hachi), kor:팔 (pal), tha:แปด (pæt) + hin:आठ (āṭh), ben:আট (aṭ)|
...
|**bel**|fas: بیل‎ (bil), tur:bel, hin:बेलचा (belcā), ben:বেলচা (bēlacā), fra:pelle|
|**ben**|ara: ابن (ibn, bint), heb:בן (ben), בת (bat)|
|**benche**|eng:bench, swa:benchi, hin:बेंच (bẽc), jpn:ベンチ (benchi), kor:벤치 (benchi)|
...
|**berande**|hin:बरामदा (barāmd), por:varanda, may:beranda, eng:veranda, rus:веранда (veranda), jpn:ベランダ (beranda), kor:베란다 (beranda), swa:varanda|
|**bere**|deu:Beere, eng:berry, may:beri, hin:बेरी (berī), ben:বেরি (beri), jpn: ベリー (berī)|
|**berete**|fra:béret, tur:bere, eng:beret, jpn:ベレー帽 (berē bō), zho:贝雷帽 (zh) (bèiléimào), rus:берет (beret)|
|**berje**|eng:birch, rus:берёза (ber’oza), hin:भूर्ज (bhūrj)|
...
|**bori**|eng:bored, spa:aburrido, hin:(bhorī)|
...
|**brosh**|eng:brush, fra:brosse, ben:ব্রাশ (braś), hin:ब्रश (braś), urd:(braś), hau:swa:burashi, jpn:ブラシ (burashi), kor:브러시 (beureosi), fas:(boros), may:berus|
|**brun**|fra:brun, ara:(bunniy), hin:भूरा (bhūrā), eng:brown|
|**bucher**|eng:butcher, fra:boucher, ita:beccaio, hin:बूचड़ (būcaṛ)|
|**buchokan**|fas: سلاخ خانه‎ (sallâx-xâne), hin:बूचड़खाना (būcaṛkhānā), ben:কসাইখানা (kôśaikhana)|
...
|**bui**|swa:mbuyu, wol:buy, sna:muuyu, zul:isimuhu|
...
|**Butan**|bhuའབྲུག་ཡུལ (ʈuk̚˩,yː˩), tib:འབྲུག་ཡུལ་ (drugyul)|
...
|**chabe**|por:chave, hin:(cābi), kon:nsapi|
...
|**chamache**|fas:(čamče), pnb:ਚਮਚਾ (camcā), ben:চামচ (camôc), hin:चम्मच (cammac), kan:ಚಮಚ (camaca), tha:ช้อน (chon)|
...
|**chana**|zho:產 (chǎn), yue:產 (caan2), vie:sản, jpn:產 (san), kor:산 (-san-) + ara:(ṣanaʿa), swa:sanaa, tur:sanat|
...
|**chate**|hin: छत (chat), ben: ছাদ (chad), tur:çatı, kyr:чатыр (čatyr)|
|**chatre**|rus:четыре (chetyre), hin:चार (cār), ben:চার (car), may:catur + fra:quatre, spa:cuatro, por:quatro|
|**chau**|zho:草 (cǎo), yue:草 (cou2), wuu:草 (tshau2), jpn:草 (sō), vie:tháu|
...
|**chini**|zho:瓷 (cí) + eng:chinaware, hin:चीनी (cīnī), ben:চীনামাটি (cinamaṭi), ara: صِينِيَّة‎ (ṣīniyya)|
...
|**chuta**|zho:出 (chū), hak:(chut), kor:출 (chul), hin:छूटना (chūtnā) + tur:çıkmak|
|**chuza**|eng:choose, + hin:चुनना (cunnā), + vie:chọn|
|**citi**|eng:city, fra:cité, por:cidade, spa:ciudad, ita:città + zho:市 (shì), kor:시 (si), jpn:都市 (toshi)|
|**da**|[da] fra:de,du, por:de,do,da, pas:د‎ (də), arm:דְּ‎ (də)|
...
|**damgem**|fra:jeu de dames, ara:(dāmā), may:dam, spa:por:damas, deu:Damespiel|
|**dan**|hin:दाना (dānā), tur:tane + jpn:種 (tane);銃弾 (jūdan), zho:弹 (dàn), vie:đạn, kor:탄알 (tanal)|
|**danga**|eng:dong, por:dlim-dlão, spa:tilín, zho:叮 (dīng), jpn:がんがん (gangan), tha:กระดิ่ง (grà-dìng)|
...
|**darje**|ara:(daraja), hin:दर्जा (darjā), swa:daraja, tur:derece, fas:(dareje), may:derajat, + zho:阶 (jiē)|
...
|**dayi**|yue:大 (daai), zho:大 (dá), vie:đại, jpn:(dai,tai), kor:대— (dae-)|
|**debili**|eng:debilitated, spa:por:débil, hin:दुर्बल, ben:দুর্বল, mar:दुबळा|
|**debu**|fra:devoir, spa:deber, por:dever|
|**def**|ara:(difāʿ), fas:(defâ'), hin:दफ़ा (dafā), urd:(difā'), + fra:eng:defense, spa:defensa, por:defesa, tur:defans|
...
|**donjon aventur**|eng:dungeon, fra:donjon, jpn:ダンジョン (danjon)|
|**dosh**|may:dosa, hin:दोष (doś), tha:โทษ (toot(sa))|
|**dosili**|eng:fra:ita:docile, spa:por:dócil|
|**doste**|tur:dost, hin:दोस्त (dost), guj:દોસ્ત (dost), urd:(dost), fas:(dust)|
...
|**dusi**|eng:fra:dys-, spa:por:dis-, rus:дис- (dis-) + hin:दुस्- (dus-), may:dur-, tur:düş-|
...
|**emoje**|jpn:絵文字 (emoji), kor:에모지 (emoji), eng:fra:por:tur:emoji, rus:эмодзи (emodzi), hin:इमोजी (imojī)|
...
|**esh**|eng:fra:spa:ex-, por:ex- (es-), rus:экзо- (ekzo-), may:eks-|
|**eshploze**|eng:fra:explosion, spa:explosión, por:exploção, rus:имплозия (imploziya), may:eksplosi|
...
|**evi**|eng:fra:spa:por:eu-|
|**fa**|eng:-ify, fra:-ifier, spa:por:-ificar + zho:化 (huà), yue:化 (faa3), kor:화 (hwa), vie:hoá|
|**fada**|zho:发 (fā), yue:發 (faat3), wuu:發 (faq4), jpn:発 (hatsu), vie:phát|
|**faidia**|ara:(fāʾida), tur:fayda, swa:faida, hin:फ़ायदा (fāyadā), may:faedah|
|**faini**|eng:fine, spa:por:fino, fra:fin|
...
|**fas**|eng:fra:por:face, spa:faz, deu:Facette|
|**fashe**|ita:fascia, por:faixa, spa:faja|
|**fashon**|eng:fashion, hin:फैशन (faiśan), jpn:ファッション (fasshon), kor:패션 (pæsyeon), tha:แฟชั่น (feechan), ben:ফ্যাশন (phaśôn)|
|**fasili**|eng:facility, spa:por:fácil, fra:facile|
|**fasinia**|eng:fascination, spa:fascinación, deu:Faszination|
|**fate**|fra:fait, por:fato, eng:fact, deu:Fakt, rus:факт (fakt), fas:(fâkt)|
|**fater**|por:fator, ita: fattore, eng: factor, rus: фактор (faktor)|
|**fatigia**|eng:fra:fatigue, spa:fatiga, por:fadiga, ita:fatica|
...
|**fere**|spa:hierro, por:ferro, fra:fer, may:ferum|
|**feste**|por:festa, spa:fiesta, fra:fête, deu:Fest, eng:festival, rus:фестиваль (festival')|
|**fete**|eng:fat, deu:Fett, swa:mafuta, rwa:mavuta, kon:mafuta|
|**feyu**|zho:飞 (fēi), yue:飛 (fei1), wuu:飛 (fi1), jpn:飛 (hi), kor:비 (bi), vie:bay|
|**figur**|eng:fra:figure, spa:por:figura|
|**fikir**|ara:(fikr), may:pikir, swa:fikiri, tur:fikir, hin:(fikr),  fas:(fekr)|
|**fiksa**|eng:fix, fra:fixer, spa:fijar, por:fixar|
...
|**foto grafe**|eng:photograph, fra:photographie, spa:por:fotografia, rus:фотография, hin:फ़ोटो (foṭo), ben:ফটো (phôṭo), may:foto, tur:fotoğraf|
|**frem**|eng:frame, ben:ফ্রেম (phrēma), pan:ਫਰੇਮ (pharēma), mar:फ्रेम (phrēma), swa:fremu|
|**frika**|eng:friction, spa:por:friccionar, fra:frictionner + ara:فرك (farak)|
...
|**funci**|eng:function, spa:por:funcionar, fra:fonctionner, rus:функциони́ровать (funkcionirovat’), may:berfungsi|
...
|**gani**|zho:干 (gān), yue:乾 (gon1), jpn:乾 (kan), kor:건 (geon)|
|**ganje**|hin:गांजा (gāñjā), urd:(gānjā), pnb:ਗਾਂਜਾ (gāñjā), ben:গাঁজা (gañja), tel:గంజాయి (gañjāyi), tam:கஞ்சா (kañcā), khm:កញ្ឆា (kɑñchaa), tha:กัญชา (gan-chaa), vie:cần sa, eng:por:may:ganja, jpn:ガンジャ (gānjya)|
...
|**gavi**|zho:高 (gāo), yue:高 (gou1), wuu:高 (kau1), jpn:高 (kō), kor:고 (go), vie:cao|
...
|**gingi**|zho:經 (jīng), yue:經 (ging1), jpn:經 (kei), kor:경 (gyeong), vie:kinh|
...
|**glisu**|fra:glisser, ita:glissare + eng:glacier,glissando, spa:por:glaciar,glisando, rus:глиссандо (glissando), ara:غليساندو (ghlysandw), jpn:グリッサンド (gurissando) + may:gelangsar|
...
|**gon**|hin:कोण (koṇ), tel:(kōnamu), swa:kona, eng:corner, hau:kwana, fra:-gone, spa:por:-gono|
...
|**gula**|ben:গেলা (gela), por:engolir, rus:глотать (glotat'), tha:กลืน (glʉʉn), spa:deglutir, fra:déglutir|
...
|**haida**|rum:háide, ell:άιντε (áinte), bul:ха́йде (hájde), rus:айда (ayda), tur:hadi, ara:هَيَّا‎ (hayyā), vie:hãy|
|**haki**|ara:(ḥaq), hin:हक़ (haq), tur:may:hak, swa:haki, hau:hakki|
|**hal**|ara:(ḥāla), hin:हालत (hālat), swa:hali, tur:hâl|
|**halali**|ara:(ḥalāl), fas:urd:(halāl), eng:spa:fra:por:may:halal, tur:helal, rus:халяльный (xaljalʹniy), hin:हलाल (halāl), swa:halali, kor:할랄 (hallal)|
...
|**hami**|ara: هَامّ (hāmm), hin:अहम (aham), urd: اہم (aham), swa:muhimu, tur:mühim, fas:(mohemm)|
|**hamili**|ara:(ḥāmil), may:hamil, swa:himila, tur:hamile, urd:(hāmila), fas:(hâmele)|
...
|**har**|hin:हर (har), tur:her, fas: هر (har)|
...
|**holi**|eng:whole, spa:por:holo-|
|**holire**|eng:cholera, spa:por:cólera, fra:choléra, rus:холера (holera), tur:kolera, ara:كُولِيرَا‎ (kōlīrā), hin:कॉलरा (kŏlrā), zho:虎列拉 (hǔlièlā), jpn:コレラ (korera)|
...
|**istan**|hin:स्थान (sthān), rus:стан (stan), fas:ـستان (-estān)|
|**ite**|eng:-ed, fra:-ite, deu:-it, spa:por:-ido, hin:-इत (-it)|
|**iyon**|eng:fra:spa:ion, rus:ион (ion), tur:iyon|
|**ja**|zho:者 (zhě);家 (jiă), kor:자 (ja), vie:gia|
|**jagi**|hin:जागना (jāgnā), ben:জাগা (jaga), pan:ਜਾਗਣਾ (jāgṇā), mar:जागणे (j̈āgṇe), guj:જાગવું (jāgvũ), may:jaga|
...
|**jar**|ara: جَرَة‎ (jara), eng:jar, fra:jarre, spa:por:jarra|
...
|**jebria**|ara:fas:(jabr), tur:cebir, urd:(aljabrā), eng:algebra, fra:algèbre, swa:aljebra|
...
|**jekogeta**|zho:借 (jiè), yue:借 (ze3), jpn:借 (shaku), kor:적 (jeok) + eng:check|
...
|**jengoshute**|zho:武术 (wǔshù), jpn:武術 (bujutsu), vie:võ thuật, kor:무술 (musul), eng:martial art|
...
|**jinu**|zho:進 (jìn), jpn:進 (shin, jin), kor:진 (jin), vie:tiến|
...
|**joveni**|hin:जवान (javān), fas:urd:(javān), tel:యువ (yuva), por:jovem, spa:joven, ita:giovane, eng:juvenile, fra:juvénile|
|**juder**|eng:judge, fra:juge, spa:juez, por:juiz, hin:जज (jaj), ben:জজ (jôj), swa:jaji + rus:судья (sud'ya)|
|**jumle**|ara:(jumla), tur:cümle, hin:जुमला (jumlā), zho:句 (jù)|
...
|**kanche**|hin:काँच (kānc), ben:কাঁচ (kãcô), mar:काच (kāc), may:kaca, tel:గాజు (gāju)|
...
|**kar**|may:karya, hin:कर्म (karma), urd:(karm), pnb:ਕਰਮ (karm), kan:tam:tel:(karma), eng:deu:fra:spa:por:karma, khm:កម្ម (kam), mya:ကံ (kam), tha:กรรม (kam), rus:карма (karma) |
...
|**karkan**|eng:workshop, fas:کارخانه‎ (kârxâne), hin:कारख़ाना (kārxānā), ben:কারখানা (karôkhana), zho:工厂 (gōngchǎng)|
...
|**karsi**|eng:coarse, may:kasar, ara:خشن (khashin)|
...
|**kash**|deu:Kasse, rus:касса (kassa), eng:case,cash, swa:kasha, por:caixa, spa:caja|
...
|**kata**|eng:cut, ara:(qaṭa’a), hin:काटना (kāṭnā), ben:কাটা (kata), swa:kata, vie:cắt, zho:割 (gē), yue:割 (got3), wuu:割 (ga’), jpn:割 (katsu)|
...
|**kavayi**|jpn:可愛い (kawaii), kor:카와이 (kawai), eng:kawaii|
|**kayi**|zho:开 (kāi), wuu:開 (khe1), jpn:開 (kai), kor:개 (gae), vie:khai, tha:ไข (kǎi), lao:ໄຂ (khai)|
...
|**kesh**|jpn:毛 (ke), hin:केश (keś), urd:(keś), pnb:ਕੇਸ਼ (keś), tel:(kēśamu), kan:(kēśa)|
...
|**kita**|fra:quitter, tur:gitmek, spa:quitar|
...
|**klari**|deu:klar, spa:por:claro, eng:clear, fra:clair|
...
|**klika**|eng:click, spa:clic, por:clicar, fra:claquer, hin:क्लिक (klika), ben:ক্লিক (klika), may:klik, jpn:クリック (kurikku)|
...
|**klusa**|eng:fra:spa:por:-clus-, rus:ключить (-klyučítʹ)|
...
|**komali**|hin:कोमल (komal), tel:కోమలము (kōmalamu), khm:កោមល (kaomɑl)|
...
|**komputer**|eng:computer, spa:computadora, por:computador, rus:компьютер (komp’uter), ara:كَمْبْيُوتَر‎ (kambyūtar), swa:kompyuta, hin:कंप्यूटर (kampyūṭar), ben:কম্পিউটার (kômpiuṭar), may:komputer, jpn:コンピューター (konpyūtā)|
|**komuni**|eng:common, spa:común, por:comum, fra:commun, rus:коммунальный (kommunal’nyy)|
|**konchung**|zho:昆蟲 (kūnchóng), yue:昆蟲 (kwan1 cung4), nan:昆蟲 (khun-thiông), jpn:昆蟲 (konchū)|
...
|**kosta**|eng:cost, spa:costar, por:custar, fra:coûter, deu:kosten|
...
|**krati**|eng:-cracy, fra:-cratie, spa:por:-cracia, rus:-кратия (kratiya), ara:(-qratiya), may:-krasi|
...
|**kuani**|zho:宽 (kuān), tha:กว้าง (kwang), vie:quảng|
...
|**kuka**|eng:cook, deu:Kock, ita:cuoco, may:koki, tha:กุ๊ก (kuk), sango:kuku|
|**kuker**|eng:cook, rus:кухар (kuhar), pol:kucharz, tha:กุ๊ก (gúk), may:koki, deu:Koch|
|**kuli**|eng:deu:fra:cool, jpn:クール (kūru), zho:酷 (kù)|
...
|**kurse**|ara:(kursiy), hin:कुरसी (kursī), urd:(kursī), pnb:ਕੁਰਸੀ (kursī), tel:(kurcī), may:som:kursi, fas:(korsi)|
|**kurve**|eng:curve, fra:courbe, spa:por:curva + rus:кривая (krivaya)|
|**kushloke**|fra:eng:couchette, ita:cuccetta, pol:kuszetka|
...
|**lali**|hin:लाल (lāl), ben:লাল (lal), tur:al|
...
|**lancha**|eng:launch, ita:lanciare, por:lançar, fra:lancer, spa:lanzar, deu:lancieren|
...
|**lasha**|fra:laisser,lâcher, ita:lasciare, deu:lassen|
|**lasti**|eng:elastic, spa:por:elástico, gla:lastaig, rus:эласти́чный (elastíčnyj), tur:may:elastik, jpn:エラスティック (erasutikku)|
...
|**lavi**|zho:老 (lǎo), yue:老 (lau2), wuu:老 (lau3), jpn:老 (rō), vie:lão|
...
|**legi**|eng:light, spa:ligero, fra:léger, rus:лёгкий (l’ogkiy), pol:lekki, ben:লঘু (laghu)|
...
|**lenshe**|zho:练习 (liànxí), jpn:練習 (renshū), kor:련습 (ryeonseup)|
|**lenti**|fra:lent, spa:por:lento|
|**letis**|eng:lettuce, jpn:レタス (retasu), hau:latas, hin:लेटिष (leṭiṣ), ben:লেটুস (leṭus), fra:laitue|
|**leu**|zho:了 (le, liǎo), wuu:了 (le’), yue:了 (liu), tha:แล้ว (lɛːw)|
...
|**liche**|zho:荔枝 (lìzhī), hin:लीची (līcī), eng:lychee, rus:личи (liči), may:leci, vie:lệ chi|
|**lider**|eng:fra:leader, spa:por:líder, rus:лидер (lider), tur:lider, hin:लीडर (līdar), jpn:リーダー (rīdā), kor:리더 (rideo)|
|**lifaf**|ara:(lifāfa), fas:(lefâf), hin:लिफ़ाफ़ा (lifāfā)|
...
|**linche**|eng:fra:lynx, spa:por:lince, hin:लिंक्स (links)|
...
|**lisi**|fra:lisse, spa:por:liso, fas:(liz), may:licin|
...
|**longi**|eng:fra:long, deu:lang, por:longo|
|**lontre**|spa:tgl:lutrino, fra:loutre, por:lontra, ita:lontra|
|**lote**|por:spa:lote, eng:fra:lot|
|**lova**|zho:漏 (lòu), yue:漏 (lau6), jpn:漏 (rō), 루 (ru)|
|**lugi**|zho:绿 (lǜ), yue:綠 (luk6), vie:lục, kor:록/녹 (rok/nok), jpn: 緑色 (ryokushoku)|
|**luku**|zho:六 (liù), jpn:六 (roku), kor:육/륙 (六, yuk/ryuk), vie:lục|
...
|**mash (masho)**|spa:mas, por:mais + eng:fra:maximum, rus:максимум (maksimum), may:maksimum, fas: ماکسیمم‎ (mâksimom)|
|**mashime**|eng:fra:maximum, por:spa:máximo, rus:максимум (maksimum), may:maksimum|
|**mashori**|fra:majeur, eng:major, spa:mayor|
|**mashoria**|spa:mayoría, por:maioria, eng:majority, fra:majorité|
...
|**medika**|eng:medicine, spa:medicina, por:medicamento, fra:médicament, rus:медикамент (medikament)|
|**medita**|eng:meditate, spa:meditar, fra:méditer, rus:медитировать (meditirovatʹ)|
...
|**mege**|hin:मेघ (megh), ben:মেঘ (megh), tam:மேகம் (mēgam), tel:మేఘము (mēghamu), may:mega, tha:เมฆ (mek)|
|**mei**|zho:每 (měi), wuu:每 (me), vie:mọi, kor:매 (mae)|
...
|**mikri**|eng:fra:spa:por:micro-, rus:микро- (mikro-), jpn:マイクロ- (maikuro-), may:tur:mikr-|
...
|**min (mino)**|spa:por:menos, fra:moins, rus:ме́нее (méneje), eng:min-|
|**minar**|swa: mnara, tur: minare, + eng:minaret|
|**mingi**|zho:wuu:明 (míng), yue:明 (ming4), vie:minh, kor:명 (myeong)|
|**minim (minimo)**|eng:fra:minimum, spa:por:mínimo, deu:Minimum, rus:ми́нимум (mínimum)|
|**minimistia**|eng:minimalism, spa:por:minimalismo, fra:minimalisme, rus:минимали́зм (minimalízm)|
...
|**misa**|eng:emit, spa:remitir, por:emitir, fra:émettre|
|**misal**|hin:मिसाल (misāl), ara:(mithāl), fas:(mesâl), may:misal, swa:mathalani, tur:mesela|
|**misha**|deu:mischen, rus:мешать (měšat'), pol:mieszać, eng:mix, ita:miscelare, + hin:मिश्रण (miśrān)|
|**miskini**|ara:مِسْكِين (miskīn), fas:مسکین‎ (meskin), tur:may:miskin, swa:maskini, hin:, ben:মিসকিন (miśkin), fra:miskine, spa:mezquino, por:mesquinho|
...
|**morti**|por:morto, fra:mort, spa:muerto, fas:(morde), urd:(murda), hin:मृत (mrta), rus:мёртвый (myortvïy), + may:mati, + ara:(mawt), amh:ሞት (mot)|
...
|**na**|eng:now, deu:na, zho:那 (nà) + rus:ну (nu)|
|**naber**|ara:(nabiy), hin:नबी (nabī), may:nabi, swa:nabii, hau:annabi, tur:nebi|
|**nadiri**|ara: نَادِر‎ (nādir), hin:नादिर (nādir), swa:nadra, tur:nadir, fas: نادر (nâder)|
...
|**name**|hin:नाम (nām), fas:pnb:urd:(nām), tha:นาม (naam), may:nama, deu:eng:name, jpn:名前 (namae), fra:nom|
...
|**nevi**|eng:new,neo-, fra:nouveau, spa:nuevo, por:novo, rus:новый (novyy), hin:नव (nav)|
...
|**nudi**|eng:nude, spa:desnudo, por:fra:nu|
...
|**ode**|eng:order, fra:ordre, spa:orden, por:ordem, swa:oda + zho:第 (dì), vie:đệ, khm:ទី (dī)|
...
|**okeyi**|eng:okay, spa:tur:may:okey, por:OK, rus:окей (okej), ara:أُوكِي‎‎‎ (ʾokey), hin:ओके (oke), zho:OK (ōukèi), jpn:オーケー (ōkē)|
...
|**orti**|eng:fra:ortho-, spa:por:orto-, rus:орто- (orto-)|
...
|**oskuri**|eng:obscure, spa:oscuro, por:escuro, fra:obscur|
...
|**pa**|por:pai + zho:爸 (bà)  + eng:fra:papa, spa:papá, rus:папа (papa), ara:(bābā), jpn:パパ (papa), kor:아빠 (appa), hin:बाप (bāp),  ben:বাবা (baba), may:bapa, swa:tur:baba|
|**pache**|ita:pace, eng:peace, spa:por:paz, fra:paix|
...
|**pan**|tha:ปัง (pang), kor:빵 (ppang), khm:នំប៉័ង (numpang), jpn:パン (pan), por:pão, spa:pan, fra:pain|
|**pande**|eng:spa:por:fra:may:panda, rus:панда (panda), hin:पांडा (pāṇḍā), jpn:パンダ (panda)|
...
|**pari**|eng:peer, fra:pair,  spa:por:par, deu:Pere, hin:बराबर (barābar), fas:urd: برابر‎ (barâbar)|
...
|**pashia**|eng:fra:passion, spa:pasión, por:paixão, kon:mpasi|
...
|**penda**|eng:pendant, por:fra:pender|
|**penis**|eng:tur:may:penis, spa:pene, por:fra:pénis, rus:пенис (penis)|
|**penta**|eng:fra:spa:por:pent- + rus:пять (pyat'), hin:पाँच (pā̃c), ben:পাঁচ (pãc)|
...
|**peri**|hin:परी (parī), ben:পরী (pôri), may:tur:peri, fas: پری‎ (pari) + eng:fairy|
|**pese**|hin:पैसा (paisā), mar:पैसा (paisā), pnb:ਪੈਸਾ (pēsā), guj:પૈસો (paiso), ara:(bēzāt), swa:pesa + spa:peso|
|**pesh**|spa:pez, por:peixe, ita:pesce + eng:fish, deu:Fisch|
...
|**pirater**|eng:fra:pirate, spa:por:pirata, deu:Pirat, rus:пират (pirat)|
|**piratia**|eng:piracy, spa:piratería, por:pirataria, fra:piraterie, deu:Piraterie, rus:пиратство (piratstvo), jpn:パイレーシ|
|**pise**|spa:por:pícea, fra:Épicéa|
...
|**pudi**|eng:putrid, spa:por:podre, fra:putride + zho:腐 (fǔ), jpn:腐 (fu) + tha:ผุ (phu)|
...
|**puri**|hin:पूर्ण (pūrn), ben:পূর্ণ (pūrṇa), pnb:ਪੂਰਾ (pūrā), fas:(por)|
...
|**rapidi**|spa:por:rápido, eng:rapid, fra:rapide|
|**rari**|eng:fra:rare, spa:por:raro, jpn:レア (rea)|
...
|**ratiba**|ara: رَتَّبَ (rattaba), swa:ratibu, hau:rattaba, fas: ترتيب (tartīb), hin:तरतीब (taratība), may:tertib, tur:tertip|
...
|**richi**|eng:rich, fra:riche, por:spa:rico|
...
|**riu**|hin:धारा (dhārā), tel:ధార (dhāra) + fas: دریا‎ (daryâ), hin:दर्या (daryā), ben:দরিয়া (dôriẏa), tur:derya|
...
|**roka**|eng:fra:spa:por:rock, rus:рок (rok), hin:रॉक (rŏk), ben:রক (rôk), jpn:ロック (rokku), kor:록 (rok), ara: رُوك‎ (rūk)|
...
|**romansia**|fra:eng:spa:por:romance, rus:роман (roman), tur:romans, may:roman, jpn:ロマンス (romansu), kor:로맨스 (romaenseu)|
|**rose**|fra:rosée, spa:rocío, rus:роса (rosa)|
|**rosta**|fra:rôtir, eng:roast, deu:rösten, ita:arrostare|
|**rototope**|eng:top, fra:toupie|
|**rotu**|eng:rotate, deu:rotieren, spa:rotar, por:rodar, may:rotasi, tur:rotasyon|
...
|**rula**|eng:roll, fra:rouler, deu:aufrollen|
...
|**sabi**|spa:por:saber, fra:savoir, eng:savvy, pcm:sabi|
...
|**salame**|ara:(salām), swa:salamu, may:selamat, hin:सलाम (salām), ben: সালাম (salam), zho:萨拉姆 (sàlāmǔ), jpn:サラーム (sarāmu), kor:살람 (sallam), vie:xa lam, rus:салям (salyam)|
|**sali**|fra:spa:por:salubre + ara: سَلَامَة‎ (salāma) + tur:sağlık|
...
|**sate**|ara:(sāʿa), fas:(sâ'at), may:tur:saat, swa:saa|
...
|**sekuri**|eng:secure, deu:sicher, spa:por:seguro|
...
|**sete**|spa:siete, por:sete, fra:sept, hin:सात (sāt), ben:সাত (sat)|
...
|**shake**|ben:শাখা (śakha), hin:शाखा (śākhā), urd:(śāx), fas:(šax)|
...
|**sharme**|fas:(šarm),  urd:(śarma), hin:शर्म (śarma), deu:Scham, eng:shame, rus:срам (sram)|
|**sharnir**|fra:charnière, spa:charnela, deu:Scharnier, rus:шарнир (šarnir)|
|**sharte**|tur:şart, ara:fas:(šart), swa:sharuti, hin:शर्त (śart), ben:শর্ত (śôrt)|
|**shashu**|zho:(shasha), rus:шуршать (shurshat’), swa:-chakacha|
|**shatan**|heb: שָׂטָן‎ (śaṭan), ara:(šayṭān), eng:fra:deu:vie:Satan, spa:Satán, por:Satã, rus:Сатана (Satana), zho:撒但 (Sādàn), kor:사탄 (satan), jpn:サタン (satan), hin:शैतान (śaitān), may:Setan, tur:şeytan, swa:Shetani|
|**shatranje**|hin:शतरंज (śatrañj), urd:(śatrañj), fas:(šatranj), tur:satranç, ara:(šaṭranj), swa:sataranji, tel:చతురంగము (caturaṅgamu), tam:சதுரங்கம் (caturaṅkam), may:catur, khm:ចត្រង្គ (caʾtrɑng), por:xadrez|
...
|**shindavistia**|jpn:神道 (shintō), kor:신도 (sindo), zho:神道 (shéndào)|
...
|**tali**|fas:ته (tah), hin:तह (tah) + zho:低 (dī), yue:低 (dai1), wuu:低 (ti1), jpn:低 (tei) + cze:dole|
|**tamar**|por:tamara, ara:(tamar)|
|**tami**|ara: طَمَّاع‎ (ṭammāʿ), zho:贪 (tān), kor:탐욕 (tamyok), vie:tham|
...
|**tarje**|ara:(tarjama), hin:तर्जुमा (tarjuma), urd:(tarjuma), ben:তর্জমা (tôrjôma), may:terjemah, swa:tarjumi, tur:tercüme|
|**tas**|rus:таз, ara:طشت‎ (ṭašt), hin:तश्तरी (tashtarī)|
|**tate**|hin:तट (taṭ), ben:তট (taṭ), pan:ਤੱਟ (taṭ), guj:તટ (taṭ)|
...
|**tazi**|tur:taze, hin:ताज़ा (tāzā), ben:তাজা (taja), fas:(tâze)|
...
|**tensi**|eng:tense, fra:tendu, spa:por:tenso|
...
|**terchi**|spa:torcido, por:torto, hin:तिरछा (tirachha), ben:তেরছা (tērachā), pan:तिरकस (tirakasa)|
...
|**tesha**|spa:tejer, por:tecer, fra:tisser, eng:textile|
|**teste**|eng:fra:test, rus: тест (test), por:teste, tur:test|
|**tezi**|hin:तेज़ (tez), urd:(tez), fas:(tiz)|
|**tichin**|zho:提琴 (tíqín), yue:提琴 (tai4 kam4), uu:提琴 (di jin3), jpn:提琴 (teikin)|
...
|**tira**|spa:por:tirar, fra:tirer, eng:tear, tur:tire|
|**tisa**|ara: تِسْعَة‎ (tisʿa), swa:tisa|
|**tocha**|eng:touch, spa: tocar, + hin: छूना (chūnā), zho: 触 (chù)|
...
|**turba**|eng:disturb, fra:perturber, spa:por:perturbar|
...
|**u**|ben:ও (o), hin:वह (vo), tur:o|
|**ulula**|deu:Heulen, ita:ululato, tur:uluma, tgl:aulong,|
...
|**unal**|eng:one another, ita:l’una, l’altra, fra: l'un l'autre, spa:el uno al otro, por:um ao outro, tur:birbirine, zho:彼此 (bǐcǐ)|
|**ura**|rus:ура (ura), ita:urrà, deu:spa:hurra, fra:hourra, eng:hurrah, may:hore, fas:(hurâ)|
|**urse**|fra:ours, por:urso, spa:oso, fas:(xers)|
|**use**|eng:use, fra:user, spa:por:usar, pol:używać|
|**va**|eng:wow, fra:ouah, zho:哇 (wā), jpn:わあ (wā), kor:와 (wa), hin:वाह (vāh), may:wah|
|**vacin**|eng:vaccine, spa:vacuna, por:vacina, rus:вакцина (vakcina), hin:वैक्सीन (vaiksīn), jpn:ワクチン (wakuchin), may:vaksin|
...
|**vildi**|deu:eng:ned:wild, sve:vild|
...
|**visi**|eng:fra:spa:por:vice-, rus:вице- (vitse-), deu:vize-|
|**vite**|fra:vis, ita:vite, rus:винт (vint), tur:vida|
|**viyoleti**|eng:por:fra:violet, spa:violeta, deu:violett, rus:фиолетовый (fioletovyy), jpn:バイオレット (baioretto), kor:보라 (bola)|
...
|**volu**|fra:voiloir, ita:volere, deu:wollen, eng:volition, spa:voluntad, rus:воля (volya), pol:wola|
|**vote**|eng:vote, spa:por:voto, hin:वोट (voṭ), rus:вотум (votum)|
|**vulve**|fra:vulve, eng:por:spa:tur:vulva, rus:вульва (vul’va)|
|**vute**|zho:物 (wù), wuu:物 (veq5), jpn:物 (butsu), vie:vật + hin:mar:वस्तु (vastu), ben:বস্তু (bôstu), pan:ਵਸਤੁ (vastu), tha:วัสดุ (wạttu)|
...
|**yama**|khm:ញ៉ាំ (nyam), ful:nyami, + spa:ñam, rus:ням (nyam), ita:gnam, eng:yum, kor:냠냠 (nyamnyam), hun:nyam|
...
|**yeki**|zho:易 (yì), yue:易 (yik6), jpn:易 (eki), kor:역 (yeok), vie:dịch|
|**yeze**|zho:椰子 (yēzi), yue:椰子 (ye4zi2), kor:야자 (yaja), jpn:椰子 (yashi)|
|**yo**|hin:कोई (koī), urd:(koī), rus:кое- (koye-)|
...
|**yoke**|eng:yoke, spa:yugo, por:jugo, fas:  یوغ‎ (yuğ), yue:軛 (aak1), vie:ách|
|**yom**|ara: يَوْم‎ (yawm), hin:यौम (yaum), may:yaum, heb: יוֹם‎ (yom)|
|**yongu**|zho:溶 (róng), yue:溶 (jung4), jpn:溶 (yō), kor:용 (yong), vie:dung|
