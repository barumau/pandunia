...
|**fun cupa gi**|zho:吸尘器 (xīchénqì), deu:Staubsauger|
...
|**mesaje**|eng:deu:fra:message, spa:mensaje, por:mensagem, tur:mesaj, jpn:メッセージ (messēji), kor:메시지 (mesiji), rus:месседж (messedzh), may:mesej|
