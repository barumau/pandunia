...
lowa ← zho:漏 "lòu".  
luge ← zho:录 (lù). yue:錄 (luk). vie:(lục). jpn:錄 (roku). eng:log.  
...
mamá ← spa:mamá. fra:maman. eng:mama. zho: 妈妈 (māma). ben:মা (ma). hin:मां (mã).  
...
pape ← deu:Papier. eng:paper. spa:por:papel. fra:pol:papier.  
