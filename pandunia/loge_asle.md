...
axuria ← akk:(aššur). ara:(aššur). hin:अश्शूर (aśśūr). per:(āšūr).  
ay ← spa:ay. zho:"ai".  
##b  
...
badan ← ara:(badan). hin:बदन (badan). per:urd:(badan). tur:beden. eng:body.  
...
barka ← hau:barka. ind:berkah. tur:tebrik. per:(tabrik). ara:urd:(mubārak). yor:alubarika.  
...
bas ← per:urd:س (bas). ara:(bass). hin:(bas). swa:basi. spa:por:ita:basta.  
...
batre ← eng:battery. hat:batri. per:(bātri). swa:betri. hin:बैटरी (baiṭrī). ara:(baṭṭāriyya). jpn:バッテリー (batterī). rus:батарея (batareja).  
...
brox ← eng:brush.  
bubul ← eng:bubble. snh:බුබුළු (bubuḷu). hun:buborék. cze:bublina. hin:बुल्ला (bullā). tgl:bula. fra:bulle. pan:ਬੁਲਬੁਲਾ (bulabulā).  
...
buge ← eng:bugle. ara:(būq). per:(buq). kat:ბუკი (buḳi).  
buke ← eng: book. deu: Buch. ind: buku. swa: buku.  
buking ← eng:booking. deu:Buchung. hin:"buking".  
bulbul ← ind:bulbul. tur:bülbül. hin:बुलबुल (bulbul). urd:(bulbul). per:(bolbol). kaz:бұлбұл (bulbul).  
...
darje ← ara:(daraja). hin:दर्जा (darjā). swa:daraja. tur:derece. per:(dareje). ind:derajat. + zho:阶 (jiē).  
...
defte ← tur:scr:defter. ell:τεφτέρι (tefteri). ind:daftar. ara:per:(daftar).  
...
dom ← zho:家 "jiă".  
doste ← tur:tkm:dost. uzb:doʻst. hin:दोस्त (dost). guj:દોસ્ત (dost). urd:(dost). per:(dust). taj:дӯст (düst).  
...
faze ← spa:por:ita:ind:fase. eng:fra:phase. rus:фаза (faza). pol:faza. per:(fāz).  
...
giva ← eng:dan:give. deu:geben. zho:给 (gěi).  
...
gur ← hin:गुरु (guru). ben:গুরু (guru). guj:ગુરુ (guru). pan:ਗੁਰੂ (gurū). tgl:guro. tha:ครู (gruu). ind:eng:por:guru. spa:gurú. rus:гуру (guru). fra:gourou. kor:구루 (guru). jpn:グル (guru).  
...
hamir ← ara:(xamīra). hin:ख़मीर (xamīr). tur:hamur. per:(moxammer). + kor:효모 (hyomo).  
...
hava ← eng:have. deu:haben. fra:avoir. ita:avere. sve:hava. dan:nor:have.  
hawe ← per:urd:(havā). tur:hava. ind:hawa. som:hawo. swa:hewa. hin:हवा (havā). ben:হাওয়া (haowa).  
hay ← zho:还 "hai".  
...
ide ← fra:idée. deu:Idee. hat:ind:ide. per:(ide). por:ideia. rus:идея (ideya). vie:ý định.  
...
jive ← hin:जीवन "jīvan". tha:ชีวิต "chiwit". khm:"jiweut". + ind:jiwa. + rus:живой "živoy".  
jovan ← hin: "javān". por:jovem. spa:joven.  
...
kababe ← ara:per:urd:(kabāb). tur:ind:eng:spa:kebab. hin:कबाब (kabāb). ben:কাবাব (kabab).  
kace ← ben:কাঁচ (kãcô). mar:काच (kāc). ind:may:kaca. tel:గాజు (gāju).  
kafe ← deu:Kaffee. fra: café. spa: café. zho: 咖啡 "kāfēi".  
kafir ← ara:(kāfir). per:(kāfer). tur:fra:kâfir. yor:kaferi. swa:kafiri. ind:kafir. rus:кафир (kafir). hin:काफ़िर (kāfir).  
...
kal ← hin: काला (kālā). ben:কালো (kalô). pan:ਕਾਲਾ (pkālā). tur:kara.  
kalam ← hau:alƙalami. yor:swa:kalamu.  
...
kote ← eng:coat. swa:koti. orm:koota. jpn:コート (kōto). per:(kot). hin:कोट (kot).  
...
kupol ← per:(koppe). ara:(qubba). tur:kubbe. ind:kubah. rus:купол (kupol). spa:cúpula. deu:Kuppel. cze:kupole.  
kurve ← fra:courbe spa:por:curva. eng:curve. eus:kurba.  
##l  
labe ← per:urd:(lab). hin:लब (lab). uzb:lab. tgl:labi. spa:labio. por:lábio.  
laje ← zho:垃圾 (lājī).  
lala ← swa:-lala.  
...
master ← eng:master. rus:мастер (master). spa:maestro. deu:Meister.  
...
meme ← lin:kon:meme.  
mene ← ara:(maʿnā). per:urd:(ma'ni). hin:मअनी (maani). swa:maana. haw:manao. eng:meaning. deu:Meinung.  
...
mum ← tur:mum. per:(mum). hin:मोम (mom). ben:মোম (mom).  
...
nafas ← ara:per:(nafas). ind:napas. tur:nefes. hau:numfashi.  
...
nol ← ind:nol.  
novi ← per:(now). pol:nowy. rus:новый (novyy). por:novo. spa:nuevo.  
...
pakse ← hin:mar:पक्षी (pakṣī). mal:പക്ഷി (pakṣi). tel:(pakṣi). kh:បក្សី (baksəy). tha:ปักษา (pak-sa). ben:পাখী (pakhī). pan:ਪੰਖੀ (paṅkhī).  
pal ← hin:फल (phal). pan:ਫਲ (phal). ben:ফল (phal). tam: பழம் (palam). tel:(phalamu). tha:ผน-ละ- (phon-la).  
...
pasporte ← eng:passport. por:passaporte. rus:паспорт (pasport).  
...
pese ← hin:पैसा (paisā). mar:पैसा (paisā). pan:ਪੈਸਾ (pēsā). guj:પૈસો (paiso). ara:(bēzāt). swa:pesa. (spa:peso).  
petre ← hin:पत्थर (patthar). urd:(patthar). ita:pietra. por:pedra. spa:piedra.  
pexe ← per:(piše). hin:पेशा (peśā). ben:পেশা (peśa).  
...
pulte ← hin:पुल (pul). ben:পুল (pul). urd:(pul). per:(pol). por:ponte. fra:pont. spa:puente.  
...
rander ← tur:scr:rende. bul:ренде (rende). ron:rindea. hin:रंदा. (randâ). per:(rande). swa:(randa).  
...
ray ← ara:(raʾy). per:(ra'y). hin:राय (rāy). tur:rey.  
recete ← ita:ricetta. rus:рецепт (retsept). deu:Rezept. spa:receta. por:receita. fra:recette. ind:resep.  
rege ← per:(rig). hin:रेग (reg). urd:(reg).  
ren ← zho: 人 "rén".  
repe ← eng:rep(etition). spa:repetición. + vie:lặp.  
reside ← per:(resid). hin:रसीद (rasīd). urd:(rasīd). guj:રસીદ (rasīd). tel:రసీదు (rasīdu). + eng:receipt. swa:resiti. mal:resit.  
reste ← fra:reste. eng:deu:Rest. pol:reszta. spa:por:resto.  
rezin ← eng:resin. fra:résine. per:(rezin). por:spa:resina. tur:reçine.  
...
sanduke ← swa:sanduku. tur:sandık. rus:сундук (sunduk). ara:صُنْدُوق‎ (ṣundūq). per:urd:صندوق‎ (sanduq).  
...
sen ← fra:scène. spa:escena. rus:сцена (scena). deu:Szene. tur:sahne. per:(sahne).  
...
sife ← ara:(ṣifa). tur:sıfat. per:(sefat). urd:(sifat). swa:sifa.  
...
tan ← hin:mar:तन (tan). per:urd:(tan). taj:тан (tan). tha:ตน (ton). vie:thân. yue:親 (can3).  
...
tave ← hin:तवा "tavā". tur:tava. per:"tābe".  
tazi ← tur:taze.  
...
tezi ← hin:तेज़ (tez). urd:(tez). per:(tiz). aze:uzb:tez. kaz:тез (tez).  
...
##v  
vale ← por:vale. eng:valley. fra:vallée. spa:valle.  
valve ← eng:valve. spa:por:válvula. jpn:バルブ (barubu). kor:밸브 (baelbeu). tgl:balbula.  
vaze ← deu:eng:fra:vase. pol:waza. rus:ваза (vaza). tur:vazo. tkm:waza.  
veje ← eng:vegetable,veg. spa:vegetal.  
verande ← hin:बरामदा (barāmd). por:varanda. ind:beranda. eng:veranda. rus:веранда (veranda). jpn:ベランダ (beranda). kor:베란다 (beranda).  
verdi ← spa:por:verde. fra:vert. eus:ceb:tgl:berde.  
veri ← eng:very. ita:vero. spa:verdadero. por:verdadeiro. deu:wahr. fra:vrai.  
version ← eng:fra:version. por:versão. rus:версия (versiya). ind:versi.  
vida ← rus:видеть (videt). ita:vedere. spa:por:ver. pol:widzieć. cze:vidět. ron:uita.  
vin ← fra:vin. spa:vino. rus:вино (vino). eng:wine. deu:Wein. hin:वाइन (vāin). jpn:ワイン (wain).  
virus ← eng:virus. rus:вирус (virus).  
virusolojia ← pol:wirusologia. rus:вирусология (virusologiya).  
vis ← eng:fra:spa:por:vice-. rus:вице- (vitse-). deu:vize-.  
vize ← tur:vize. eng:visa. rus:виза (viza). hin:वीज़ा (vīzā).  
vizite ← eng:visit. fra:visite. spa:por:visita. rus:визит (vizit).  
...
warke ← ara:(waraqa). hau:warƙa. tur:varak. per:(varaqe). taj:варақа (varaqa). swa:waraka. + mya:အရွက် (arwak).  
...
xam ← hin: शाम (śām). per:(šām). tur:akşam.  
...
xarme ← per:(šarm).  urd:(śarma). hin:शर्म (śarma). deu:Scham. eng:shame. rus:срам (sram).  
...
ziran ← ben:জিরা "zīra". hin:ज़ीरा (zīrā). tam:சீரகம் (sīrakam). swa:mjira. per:(zire). zho:孜然 (zīrán).  
