...
|**bawe**|trezoro|mandarena:宝 (bǎo), korea:보 (bo), vjetnama:bảo, japana:宝 (hō)|
...
|**campion (campione)**|ĉampiono|angla:franca:champion, hispana:campeón, portugala:campeão, rusa:чемпион (chempion), turka:şampiyon, japana:チャンピオン (chanpeon), korea:챔피언 (chaempieon)|
...
|**daixer**|ambasadoro|mandarena:大使 (dàshǐ), kantona:大使 (daai6 si3), japana:大使 (taishi), korea:대사 (daesa), vjetnama:đại sứ|
...
|**daymare**|oceano|vjetnama:đại dương, korea:대양 (daeyang), japana:大洋 (taiyō), mandarena:大洋 (dàyáng), taja:มหาสมุทร (mahasamut), hindia:महासागर (mahāsāgar)|
...
|**dowe**|fabo aŭ pizo|mandarena:豆 (dòu), kantona:豆 (dau6), vua:豆 (deu3), japana:豆 (tō), korea:두 (du), vjetnama:đậu|
...
|**eme**|ero|angla:-eme, hispana:portugala:-ema, franca:-ème, rusa:-ема (-ema), malaja:-em|
...
|**eskulta**|skulti|angla:sculpt, hispana:esculpir, franca:sculpter|
...
|**feya**|flugi|mandarena:飞 (fēi), kantona:飛 (fei1), vua:飛 (fi1), japana:飛 (hi), korea:비 (bi), vjetnama:bay|
...
|**ganputawe**|sekvinbero|korea:건포도 (geonpodo), mandarena:葡萄干 (pútáogān)|
...
|**garda**|gardi|angla:guard, hispana:portugala:guardar, franca:garder|
...
|**gida**|stiri|angla:guide, hispana:portugala:guiar + araba:قَادَ‎ (qāda)|
...
|**gowa**|iri|angla:go + mandarena:去 (qù), japana:行 (kou)|
...
|**karlekse**|verbo|hindia:क्रिया (kriyā), bengala:ক্রিয়া (kriya), teluga:క్రియ (kriya), kmera:កិរិយា (keriyaa), taja:กริยา (grì-yaa), malaja:kata kerja|
|**karote**|karoto|angla:carrot, franca:carotte, deu:Karotte, svahila:karoti, malaja:karot|
...
|**loge**|parolo (vortoj)|greka:λόγος (logos), angla:-logue, persa:(loğat), araba:(luğa), hindia:लुग़त (luġat), svahila:lugha, turka:lügat, malaja:logat|
...
|**mare**|maro|itala:mare, hispana:portugala:mar, franca:mer, deu:Meer, rusa:море (more), polona:morze|
...
|**marmare**|marmoro|hindia:संगमरमर (saṅgmarmar), hispana:marmól, portugala:mármore, rusa:мрамор (mramor), malaja:marmer, turka:mermer|
...
|**namlekse**|substantivo|mandarena:名词 (míngcí), kantona:名詞 (ming4 ci4), japana:名詞 (meishi), korea:명사 (myeongsa), hindia:नाम (nām), franca:nom, hispana:nombre, portugala:nome, rusa:имя (imya), araba:(ism), per:(esm), svahila:nomino|
...
|**pantalone**|pantalonoj|hispana:pantalón, franca:pantalon, araba:بنطلون‎ (banṭalōn), hindia:पैंट  (paiṇṭ)|
...
|**pawe**|fusilo|mandarena:炮 (pâo), kantona:炮 (paau3), vjetnama:pháo, korea:포 (po), mon:буу (buu)|
...
|**petre**|roko (ŝtono)|hindia:पत्थर (patthar), urdua:(patthar), itala:pietra, portugala:pedra, hispana:piedra, franca:pierre|
...
|**plus (pluso)**|ankaŭ|angla:franca:plus, rusa:плюс (pl’us)|
...
|**putawe**|vinbero|mandarena:葡萄 (pútáo), kantona:葡萄 (pou4 tou4), vua:葡萄 (bu dau3), japana:葡萄 (budō), korea:포도 (podo), vjetnama:bồ đào|
...
|**repe**|ripetado|angla:rep(etition), hispana:repetición, + vjetnama:lặp|
...
|**tatawe**|tatuo|sam:tah:tatau, haw:kākau, malaja:tato, angla:tattoo, franca:tatouage, hispana:tatuaje, rusa:тату (tatu)|
|**tawe**|pato|hindia:तवा (tavā), turka:tava, persa:(tābe)|
...
|**towale**|viŝilo|angla:towel, hispana:toalla, portugala:toalha, hindia:तौलिया (tauliyā), bengala:তোয়ালে (toyale), filipina:tuwalya, japana:タオル (taoru)|
...
|**xine**|kredo|mandarena:信 (xìn), kantona:信 (seon3), japana:信 (shin), vjetnama:tin|
|**xinge**|stelo|mandarena:星 (xīng), vua:星 (xing), kantona:星 (sing1), japana:星 (sei), korea:성 (seong)|
|**xire**|poemo|heb:שיר (šir), araba:(šiʿr), turka:şiir, persa:(še'r), svahila:shairi, mandarena:诗 (shī), kantona:詩 (si1), japana:詩 (shi), korea:시 (shi)|
...
|**xowe**|montri (ekspozicii)|angla:deu:franca:hispana:portugala:show, rusa:шоу (šou), turka:şov, svahila:shoo, taja:โชว์ (choo), korea:쇼 (syo), japana:ショー (shō), mandarena:秀 (xiù)|
|**xudu**|devus|angla:should|
|**xukare**|sukero|araba:(sukkar), svahila:sukari, portugala:açúcar, hispana:azúcar, hindia:शक्कर (śakkar), bengala:শর্করা (śôrkôra), turka:şeker, tamila:சக்கரை (cakkarai)|
