...
**a** *by (at, in, on)* ← French:à, Spanish:Portuguese:a, English:a-;ad-, Russian:а- (a-), Hausa:a + Fulani:haa  
...
**ade** *habit (custom)* ← Arabic: عادة (ʿāda), Hindi:आदत (ādat), Malay:adat, Turkish:adet, Swahili:ada, Hausa:al'ada, Fulani:aada  
...
**af** *sorry (pardon)* ← Arabic: مُعَاف‎ (muʿāf), Hindi:माफ़ (māf), Bengali:মাফ (maph), Malay:maaf, Swahili:afu, Turkish:af, Fulani:yaafu, Hausa:yafe  
...
**akle** *sense (reason, intellect)* ← Arabic: عَقْل‎ (ʕaql), Persian: عقل‎ ('aql), Hindi:अक़्ल (aqla), Bengali:আকল (akol), Malay:akal, Fulani:hakkille, Wolof:hakilo, Hausa:hankali, Swahili:akili, Turkish:akıl  
...
**alkol** *alcohol* ← Arabic: كُحُول‎ (kuḥūl), English:Spanish:alcohol, French:alcool, Portuguese:álcool,  Russian:алкоголь (alkohol), Japanese:アルコール (arukōru), Korean:알콜 (alkol), Hindi:ऐल्कोहॉल (ailkohŏl), Bengali:এলকোহল (elkohôl), ind:alkohol, Turkish:Fulani:alkol  
...
**amen** *trust (be sure of, have faith in)* ← heb: אָמֵן‎, (ʾāmēn), Arabic: آمَنَ‎ (āmana), Swahili:amini, Fulani:amiini, Hausa:amince, Turkish:amin + Greek:ἀμήν (ámén), English:deu:French:Polish:Spanish:amen, Mandarin:阿门 (āmén), Cantonese:阿門 (aa3mun4), Korean:아멘 (amen), Japanese:アーメン (āmen), Vietnamese:a-men  
...
**arsenium** *arsenic* ← English:arsenic, French:arsenic, Spanish:arsénico, Portuguese:arsénic, Mandarin:砷 (shēn), Vietnamese:asen, Hindi:आर्सेनिक, Bengali:আর্সেনিক, Malay:arsen, Swahili:aseniki, Arabic: زرنيخ  
...
**badam** *almond* ← Malay:badam, Turkish:badem, Hindi:बादाम (bādām), Bengali:বাদাম (badam), Tamil:வாதுமை (vātumai), Mandarin:巴旦木 (bādànmù)  
...
**baki** *rest (remainder)* ← Arabic: بَقِيَّة‎ (baqiyya), Persian: بقیه‎ (baqiye), Hindi:बाक़ी (bāqī), Malay:baki, Turkish:bakıye, Swahili:-baki, Fulani:bakke  
...
**bande** *tie (fasten, bind; band, bandage, lace, ribbon, strip, tape)* ← English:bind; band, deu:Band, French:bande, Spanish:venda, Russian:бинт (bint), Persian: بند‎ (band), Hindi:बाँधना (bāndhnā), Mandarin:绑 (bǎng), Cantonese:綁 (bong2), Vietnamese:băng, Turkish:bant, Fulani:banda; bandaas + Swahili:bendeji, Hausa:bandeji  
...
**banke** *save (deposit, bank)* ← English:deu:Polish:Malay:bank, Turkish:banka, Russian:банк (bank), French:banque, Spanish:Portuguese:banco, Persian:(bânk), Hindi:बैंक (baiṅk), Urdu:(baiṅk), Telugu:బ్యాంకు (byāṅku), Tamil:(vaṅki), Fulani:banke, Hausa:banki  
...
**barke** *congratulate (bless)* ← Hausa:barka, Malay:berkah, Turkish:tebrik, Persian:(tabrik), Arabic:Urdu:(mubārak), Swahili:baraka, hau:albarka, Yoruba:alubarika, Fulani:(al)barka  
...
**benke** *bench* ← French:banc, deu:Bank, Spanish:Portuguese:banco, Malay:bangku, Fulani:baŋ + English:bench, Swahili:benchi, Hindi:बेंच (bẽc), Japanese:ベンチ (benchi), Korean:벤치 (benchi)  
...
**bere** *beret* ← French:béret, Turkish:Fulani:bere, English:beret, Japanese:ベレー帽 (berē bō), Mandarin:贝雷帽 (bèiléimào), Cantonese:巴黎帽 (baalaimou), Russian:берет (beret), ful:beere  
...
**bine** *build (construct)* ← Arabic: بِنَاء‎ (bināʾ), Hindi: बनाना (banānā), Urdu:(banānā), Persian:(banā), Turkish: bina, + Japanese:ビル (biru)  
...
**bol** *ball (sphere, orb)* ← English:ball, Spanish:Portuguese:Malay:Filipino:bola, Thai:บอล (bɔl), Japanese:ボール (bōru), Korean:볼 (bol), Khmer:បាល់ (bal), Bengali:বল (bôl), deu:Ball, French:boule; balle, Turkish:may:balon, Fulani:bal, Hausa:balân  
...
**bote** *shoe or boot* ← Hindi:बूट (būṭ), Polish:but, cze:bota, Yoruba:bata + English:boot, French:botte, Spanish:Portuguese:bota, Russian:ботинок (botinok), pol:Malay:but, Persian: بوت‎ (but), Arabic: بوت‎ (bōt), Japanese:ブーツ (būtsu), Swahili:buti  
**botel** *bottle* ← English:bottle, French:bouteille, Spanish:botella, Portuguese:botelha, Russian:бутылка (butylka), Persian: بطری‎ (botri), Hindi:बोतल (botal), Bengali:বোতল (botôl), Malay:botol, Tamil:புட்டி (puṭṭi), Fulani:butél  
...
**bure** *office (bureau)* ← English:French:bureau, Spanish:buro-, Portuguese:birô, Russian:бюро (byuro), Polish:biuro, Turkish:büro, Fulani:biró  
...
**buton** *key (push-button, switch)* ← English:button, Spanish:botón, Portuguese:botão, French:bouton, Hindi:बटन (baṭan), Bengali:বোতাম (botam), Japanese:ボタン (botan), Korean:버튼 (beoteun), Fulani:butoŋ  
**buyu** *baobab* ← Swahili:mbuyu, Wolof:buy, sna:muuyu, Zulu:isimuhu, Fulani:ɓokki  
...
**cerium** *cerium* ← English:cerium, French:cérium, Spanish:cerio, Portuguese:cério, Russian:церий, Mandarin:铈 (shì), Japanese:セリウム, Korean:세륨, Vietnamese:xeri, Hindi:सेरियम, Bengali:সেরিয়াম, Malay:serium, Swahili:seri, Arabic: سيريوم  
...
**cian** *cyan* ← English:cyan, Spanish:cian, Russian:циан (tsian), Arabic:سيان (sayan), Hindi:क्यान (kyāna), Japanese:シアン (shian), Malay:sian + Mandarin:青色 (qīngsè), Cantonese:青 (ceng1), Korean:청 (cheong)  
...
**coklate** *chocolate* ← Spanish:Portuguese:English:chocolate, French:chocolat, Russian:шоколад (šokolad), Mandarin:巧克力 (qiǎokèlì), Cantonese:朱古力 (zyugulik), Japanese:チョコレート (chokorēto), Korean:초콜렛 (chokollet), Hindi:चाकलेट (cāklet), Bengali:চকলেট (côkleṭ), Malay:cokelat, Swahili:chokoleti, Turkish:çikolata, Fulani:cokolete  
...
**cung** *insect (bug)* ← Mandarin:虫 (chóng), Cantonese:蟲 (cung4), Korean:충 (chung), Vietnamese:trùng  
...
**dalil** *evidence (argument, proof, testimonial)* ← Arabic: دَلِيل (dalīl), Hindi:दलील (dalīl), Bengali:দলিল (dôlil), Hausa:Swahili:dalili, Turkish:delil, Fulani:daliilu  
...
**din** *religion (worship)* ← Arabic:(dīn), Bengali:দীন (din), Persian:(din), Turkish:Malay:din, Swahili:dini, Hausa:addini, Fulani:Wolof:diine, Hindi:दीन (dīn)  
...
**dotor** *doctor (scholar who has attained doctorate)* ← Portuguese:doutor, Italian:dottore, English:Spanish:doctor, Russian:доктор (doktor) + Fulani:doktoor  
...
**fake** *fuck (obscene word for sexual intercourse)* ← English:fuck + Russian:фак (fak), Mandarin:法克 (fǎkè), Japanese:ファック (fakku)  
**famil** *family* ← deu:Familie, English:family, Spanish:familia, Portuguese:família, French:famille, Persian: فامیل‎ (fâmil), Swahili:familia, Malay:famili  
...
**flam** *flame* ← English:flame, French:flamme + Mandarin:炎 (yán), Cantonese:炎 (jim4), Korean:염 (yeom), Vietnamese:viêm  
...
**gandum** *wheat* ← Persian:گندم‎(gandom), Hindi:गोधूम (godhūm), Bengali:গম (gom), Tamil:கோதுமை (kōtumai), Telugu:గోధుమ (gōdhuma), Malay:gandum, Swahili:ngano  
**gani** *sing (song, chant)* ← Arabic: غَنَّى‎ (ḡannā) + Hindi:गाना (gānā), Bengali:গান (gan) + Mandarin:歌 (gē), Cantonese:歌 (go1), Japanese:歌 (ka), Korean:가 (ga), Vietnamese:ca  
**ganja** *cannabis (marijuana, ganja, pot, weed)* ← Hindi:गांजा (gāñjā), Urdu:(gānjā), Punjabi:ਗਾਂਜਾ (gāñjā), Bengali:গাঁজা (gañja), Telugu:గంజాయి (gañjāyi), Tamil:கஞ்சா (kañcā), Khmer:កញ្ឆា (kɑñchaa), Thai:กัญชา (gan-chaa), Vietnamese:cần sa, English:Portuguese:Malay:ganja, Japanese:ガンジャ (gānjya)  
...
**garanti** *guarantee (warranty)* ← English:guarantee, Spanish:garantía, Portuguese:garantia, French:garantie, deu:Garantie, Russian:гарантия (garantiya), Turkish:garanti  
**garde** *guard (watch)* ← English:guard, French:garde, Spanish:Portuguese:guarda, Malay:garda, Japanese:ガード (gādo), Korean:가드 (gadeu), Fulani:garde  
**garma** *warm (hot)* ← Hindi:गरम (garm), Urdu:Persian:گرم‎‎ (garm), kur:germ, deu:English:warm  
**gas** *gas* ← deu:English:Spanish:Malay:gas, Portuguese:gás, Bengali:গ্যাস (gyas), Mandarin:瓦斯 (wǎsī), Cantonese:瓦斯 (ngaa5 si1), Japanese:ガス (gasu), Korean:가스 (gaseu), Hindi:गैस (gais), French:Turkish:gaz, Russian:газ (gaz), Arabic:(ḡāz), Fulani:gaas, Swahili:gesi  
**gate** *cut (bite, incise)* ← Arabic: قَطَعَ (qaṭa’a) + Mandarin:割 (gē), Cantonese:割 (got3), Wu-Chinese:割 (ga’), Japanese:割 (katsu), Vietnamese:cắt + Hindi:काटना (kāṭnā), Bengali:কাটা (kata) + Tamil:கடி (kaṭi) + Thai:กัด (kat) + English:cut + Swahili:-kata  
**gati** *hard (firm, solid, rigid, tough)* ← Telugu:గట్టి (gaṭṭi), Turkish:katı, Hindi:कड़ा (kaṛā), Japanese:硬い (katai)  
**gau di** *high (tall)* ← Mandarin:高 (gāo), Cantonese:高 (gou1), Wu-Chinese:高 (kau1), Japanese:高 (kō), Korean:고 (go), Vietnamese:cao  
...
**gense** *sort (category, class, genus, genre, gender)* ← English:genre, French:genre, Spanish:género, Portuguese:gênero, Persian: جنس‎ (jens), Arabic: جِنْس‎ (jins), Fulani:Hausa:Swahili:jinsi, Turkish:cins, Japanese:ジェンダー (jendā)  
...
**gitar** *guitar* ← English:guitar, French:guitare, Spanish:Portuguese:guitarra, Russian:гитара (gitara), Arabic:(qīṯāra), Hindi:गिटार (giṭār), Bengali:গিটার (giṭar), Mandarin:吉他 (jítā), Cantonese:結他 (git6taa1), Japanese:ギター (gitā), Korean:기타 (gita), Swahili:gitaa  
**glas** *glass* ← deu:Glas, English:glass + Persian: گیلاس‎ (gilâs), Hindi:गिलास (gilās), Bengali:গ্লাস (glaś), Japanese:グラス (gurasu), Korean:글라스 (geullaseu), Malay:gelas, Swahili:glasi, Hausa:gilashi + Russian:глазурь, Spanish:glasear  
**glis** *slide (slip, glide)* ← French:glisser, Italian:glissare + English:glacier,glissando, Spanish:Portuguese:glaciar,glisando, Russian:глиссандо (glissando), Arabic:غليساندو (ghlysandw), Japanese:グリッサンド (gurissando) + Malay:gelangsar  
**glute** *glue (adhesive)* ← English:glue, Swahili:gluu, Malay:glu + Spanish:French:gluten, Portuguese:glúten, Russian:глютен (glyuten), Arabic: غْلُوتِين‎ (ḡlūtīn), Japanese:グルテン (guruten)  
**gogia** *country (land, state)* ← Mandarin:国家 (guójiā), Cantonese:國家 (gwok3 gaa1), Japanese:国 (koku); 国家 (kokka), Korean:국가 (gukga), Vietnamese:quốc gia  
...
**gomu** *rubber (latex, eraser)* ← French:gomme, Spanish:Filipino:goma, Japanese:ゴム (gomu), Korean:고무 (gomu) + English:gum, deu:Gummi + Hindi:गम (gam), Bengali:গাম (gam)  
**gone** *corner (angle)* ← Hindi:कोण (koṇ), Telugu:(kōnamu), Swahili:kona, English:corner; -gon, Hausa:kwana, French:-gone, Spanish:Portuguese:-gono  
**gorila** *gorilla* ← English:gorilla, French:gorille, Spanish:Portuguese:Malay:gorila, Russian:горилла (gorilla), Arabic:غوريلا (ḡūrīlā), Japanese:ゴリラ (gorira), Korean:고릴라 (gorilla), Vietnamese:gôrila, Hindi:गोरिल्ला (gorillā), Bengali:গরিলা (gôrila), Tamil:கொரில்லா (korillā)  
...
**gram** *gram (g)* ← English:gram, deu:Gramm, French:gramme, Spanish:gramo, Portuguese:grama, Russian:грамм (gramm), Persian: گرم‎ (geram), Hindi:ग्राम (grām), Bengali:গ্রাম (gram), Arabic: غْرَام‎ (ḡrām), Fulani:giram, Swahili:gramu, Japanese:グラム (guramu), Korean:그램 (geuraem), Vietnamese:gam, Malay:Turkish:gram  
**gran** *grain (particle)* ← English:French:grain, Spanish:grano, Portuguese:grão + Russian:гранит (granit), Turkish:Vietnamese:Malay:granit, Arabic:جرانيت (jaraniat), Hindi:ग्रेनाइट (grenait)  
...
**gros** *rough (coarse, harsh)* ← French:gros, Portuguese:grosso + Spanish:grosero, English:gross  
...
**gua** *cave* ← Bengali:গুহা (guha), Hindi:गुफ़ा (gufā), Tamil:குகை (kukai), Telugu:గుహ (guha), Malay:gua, Thai:คูหา (gūhā)  
...
**gubu** *hippopotamus* ← Fulani:ngabbu Kongo:ngubu, sot:tsw:kubu, Zulu:rwa:imvubu, Amharic:ጉማሬ (gumare)  
...
**gule** *ghoul* ← Arabic:الغول (ghūl), Persian:غول‎ (ğul), English:Portuguese:ghoul, Spanish:gul, Russian:гуль (gul′), Turkish:kulbastı, Malay:ghul, Japanese:グール (gūru), Hausa:gwal  
**guma** *drum* ← Swahili:ngoma, rwa:ingoma + Mandarin:鼓 (gǔ)  
**guru** *guru (teacher, sage)* ← Hindi:गुरु (guru), Bengali:গুরু (guru), Tamil:குரு (kuru), Filipino:guro, Thai:ครู (gruu), Malay:English:Portuguese:guru, Spanish:gurú, Russian:гуру (guru), French:gourou, Korean:구루 (guru), Japanese:グル (guru)  
...
**ha** *have (there be)* ← English:have, French:avoir, Spanish:hay  
**habar** *news* ← Arabic: خَبَر‎ (xabar), Persian: خبر‎ (xabar), Hindi:ख़बर (xabar), Bengali:খবর (khôbôr), Tamil:கபர் (kapar), Malay:kabar, Turkish:haber, Swahili:habari, Hausa:labari, Yoruba:làbarè, Fulani:kibaaru  
**hafenium** *hafnium* ← English:hafnium, French:hafnium, Spanish:hafnio, Portuguese:háfnio, Russian:гафний, Mandarin:铪 (hā), Japanese:ハフニウム, Korean:하프늄, Vietnamese:hafini, Hindi:हाफ्नियम, Bengali:হাফনিয়াম, Malay:hafnium, Swahili:hafni, Arabic: هفنيوم  
**hafiz-** *keep (preserve, conserve, retain, spare)* ← Arabic:(ḥafiẓa), Persian:Urdu:(hāfiz), Turkish:muhafaza, Hindi:हाफ़िज़ (hāfīz), Swahili:hifadhi  
...
**haima** *tent* ← Arabic:(xayma), Hausa:laima, Hindi:ख़ैमा (xEmā), Swahili:hema, Malay:kemah, may:khemah, mng:майхан (mayhan)  
**haje** *pilgrimage* ← Arabic: حَجّ‎ (ḥajj), Persian: حج‎ (hajj), Turkish:hac, Swahili:hija, Hausa:haji, Fulani:hajju  
**hake** *right (entitlement)* ← Arabic: حَقّ‎ (ḥaqq), Hindi:हक़ (haq), Bengali:হক (hôk), Punjabi:ਹੱਕ (hakka), Telugu:హక్కు (hakku), Turkish:Malay:hak, Swahili:haki, Hausa:hakki, Fulani:haƙƙe  
**haki** *dust* ← Persian: خاک (xâk), Hindi:ख़ाक (xāk), Bengali:খাক (khâk), Turkish:haki, English:khaki, French:kaki, Spanish:caqui, Portuguese:cáqui, Russian:хаки (haki), Mandarin:卡其 (kǎqí), Cantonese:卡其色 (kaakeisik), Japanese:カーキ色 (kāki-iro), Korean:카키색 (kakisaek), Vietnamese:màu kaki  
**hal** *state (condition, status, situation, circumstances)* ← Arabic:حال (ḥāl), Hindi:हालत (hālat), Swahili:Hausa:hali, Fulani:haala; alhaali, Turkish:hâl  
**halal** *permissible (allowed, halal)* ← Arabic:(ḥalāl), Persian:Urdu:(halāl), English:Spanish:French:Portuguese:Malay:Hausa:halal, Turkish:helal, Russian:халяльный (xaljalʹniy), Hindi:हलाल (halāl), Swahili:halali, Korean:할랄 (hallal)  
...
**halife** *caliph* ← Arabic: خَلِيفَة‎ (ḵalīfa), English:caliph, French:calife, Spanish:Portuguese:califa, Russian:халиф (khalif), Hindi:ख़लीफ़ा (xalīfā), Bengali:খলিফা (khôlipha), Tamil:கலீஃப் (kalīph), Malay:khalifah, Swahili:halifa, Hausa:khalifa, Mandarin:哈里发 (hālǐfā), Japanese:ハリーファ (harīfā), Korean:칼리파 (kallipa), Turkish:halife, Fulani:kaliifa  
...
**halte** *stop (halt)* ← deu:English:halt, French:halte, Spanish:Portuguese:alto, Malay:halte  
**ham di** *important* ← Arabic: هَامّ (hāmm), Hindi:अहम (aham), Urdu: اہم (aham), Swahili:muhimu, Turkish:mühim, Persian:(mohemm), Hausa:muhimmi  
...
**haram** *sacred (forbidden, illicit, haram, taboo)* ← Arabic:(ḥarām), Fulani:Hausa:Malay:Turkish:English:deu:haram, Hindi:हराम (harām), Korean:하람 (haram), Persian:Urdu:(harām), Swahili:haramu, Mandarin:哈拉姆 (hālāmǔ), Russian:харамный (xaramniy)  
...
**has** *special (distinct)* ← Arabic:(xāṣṣ), Persian:Urdu:(xās), Hindi:ख़ास (xās), Malay:khas, Swahili:hususa  
**haste** *hurry (rush, haste; hasty, busy, hurried, swift, fast)* ← deu:Hast, English:haste, French:hâte + Persian:آهسته (âheste), Hindi:आहिस्ता (āhistā), Bengali:আস্তে (aste), Turkish:aheste  
**hata** *until (til, up to)* ← Portuguese:até, Arabic:(ḥatta), Spanish:hasta, Swahili:hata, Hausa:hatta, Fulani:haa + Persian: تا‎ (tâ), Hindi:तक (-tak)  
**hatar** *danger (peril)* ← Arabic: خطر‎ (xaṭar), Persian: خطر‎ (xatar), Urdu: خطرہ‎ (xatrā), Hindi:ख़तरा (xatrā), Swahili:hatari, Hausa:hatsari, Turkish:muhatara  
**hau** *good* ← Mandarin:好 (hǎo), Cantonese:好 (hou2), Vietnamese:hảo  
**hava** *wind* ← Arabic: هَوَاء‎ (hawāʾ), Persian: هوا‎ (havâ), Hindi:हवा (havā), Bengali:হাওয়া (hava), Malay:hawa, Swahili:hewa, Turkish:hava  
**haxi** *chopsticks* ← Japanese:箸 (hashi), Bengali:হাশি (haśi), Gujarati:હાશી (hāśī), Portuguese:hashi  
**haxix** *hashish* ← Arabic: حَشِيش (ḥašīš), English:hashish, French:haschich, Portuguese:haxixe, Russian:гашиш (gašiš), Japanese:ハシシ (hashishi), Korean:해시시 (haesisi), Hindi:हशीश (haśīś), Malay:hasyis  
**hazin** *store (deposit)* ← Arabic: خَزَنَ‎ (xazana) + Persian: خزینه‎ (xazine), Hindi:ख़िज़ाना (xizānā), Russian:казна (kazna), Swahili:hazina + English:magazine, Spanish:almacén, Portuguese:armazém, Turkish:hazine; mahzen  
**he** *huh? (eh?, pardon?)* ← English:huh, French:hein, Portuguese:hã, Vietnamese:hả, deu:hä + Mandarin:何 (hé)  
**hei** *hey (exclamation to get attention)* ← English:hey, French:hé, Spanish:hey, Portuguese:ei, Russian:эй (ey), Mandarin:喂 (wèi), Vietnamese:ê; ơi, Persian: هی‎ (hey), Fulani:héé  
**helium** *helium* ← English:helium, French:hélium, Spanish:helio, Portuguese:hélio, Russian:гелий, Mandarin:氦 (hài), Japanese:ヘリウム, Korean:헬륨, Vietnamese:Swahili:heli, Hindi:हिलियम, Bengali:হিলিয়াম, Malay:helium, Arabic: هيليوم  
**helix** *spiral (helix, corkscrew, twist)* ← Greek: ἕλιξ (helix), English:helix, French:Portuguese:Spanish:hélice, Polish:helisa, Arabic:(ḥalazūn), Turkish:helezon  
**heme** *blood* ← English:Spanish:Portuguese:Malay:Vietnamese:Turkish:hemo-, French:hémo-, Russian:гемо- (gemo-), Japanese:ヘモ- (hemo-)  
**hem…** *hmm…* ← English:hmm, Russian:хм (hm), эм (em), Korean:음 (eum)  
**hen** *hatred (hate, resentment, odium)* ← Mandarin:恨 (hèn), Cantonese:恨 (han6), Wu-Chinese:恨 (hhen3), Vietnamese:hận, Korean:한  (han) + Japanese:嫌 (ken) + French:haine  
**hena** *henna (alcanna)* ← Arabic: حِنَّاء‎ (ḥinnāʾ), English:henna, deu:Henna, French:henné, Spanish:alheña, Portuguese:hena, Russian:хна (hna), Persian:حنا‎ (hanâ), Hindi:हिना (hinā), Turkish:kına  
**hepate** *liver* ← Mandarin:肝 (gān), Cantonese:肝 (gon1), Wu-Chinese:肝 (koe1), Korean:간 (gan), Japanese:肝臓 (kanzō), Vietnamese:gan + Swahili:ini  
**hero** *hero* ← English:hero, French:héros, Spanish:héroe, Portuguese:héroi, Russian:герой (geroy), Hindi:हीरो (hīro), Japanese:ヒーロー (hīrō), Korean:히로 (hiro)  
**hesium** *hassium* ← English:hassium, French:hassium, Spanish:hasio, Portuguese:hássio, Russian:хассий, Mandarin: (hēi), Japanese:ハッシウム, Korean:하슘, Vietnamese:hassi, Hindi:हसियम, Bengali:হ্যাসিয়াম, Malay:hassium, Swahili:hassi, Arabic: هاسيوم  
...
**hindium** *indium* ← English:indium, French:indium, Spanish:indium, Portuguese:índio, Russian:индий, Mandarin:铟 (yīn), Japanese:インジウム, Korean:인듐, Vietnamese:indi, Hindi:इण्डियम, Bengali:ইন্ডিয়াম, Malay:indium, Swahili:indi, Arabic: انديوم  
**hisabe** *calculate* ← Arabic: حِسَاب‎ (ḥisāb), Hindi:हिसाब (hisāb), Bengali:হিসাব (hiśab), Turkish:hesap, Oromo:hisaaba, Swahili:hisabu, Hausa:lisafi, Fulani:hiisa  
**histor** *history (annals)* ← English:history, Spanish:Swahili:historia, Portuguese:história, French:histoire, Russian:история (istoriya)  
**hiyar** *cucumber* ← Persian:خیار (xiyâr), Turkish:hıyar, Arabic:خيار‎ (khiyār), Hindi:खीरा (khīrā), Bengali:ক্ষীরা (kṣīrā)  
**hobi** *hobby* ← English:Spanish:Portuguese:deu:French:hobby, Russian:хобби (hobbi)  
**hogo** *fire (burning)* ← Spanish:fuego, Portuguese:fogo + Russian:огонь (ogon’), Hindi:आग (āg), Bengali:অগ্নি (ôgni), pan:ਅੱਗ (ag) + Mandarin:火 (huǒ), Cantonese:火 (fo2), Wu-Chinese:火 (hu2), Korean:화 (hwa), Vietnamese:hoả  
**hoki** *hockey* ← English:French:Spanish:hockey, Portuguese:hóquei, Russian:хоккей (hokkey),  Japanese:ホッケー (hokkē), Hindi:हाकी (hākī), Bengali:হকি (hôki), Arabic:(hūkī), Swahili:hoki  
**hol** *whole (entire)* ← English:whole; all; holo-, deu:French:Spanish:Portuguese:holo-, Russian:голо- (golo-); хол- (hol-), Japanese:ホログ- (holo-), Korean:홀로- (hollo-) + Arabic: كُلّ‎ (kull)  
**holera** *cholera* ← English:cholera, Spanish:Portuguese:cólera, French:choléra, Russian:холера (holera), Turkish:kolera, Arabic:كُولِيرَا‎ (kōlīrā), Hindi:कॉलरा (kŏlrā), Mandarin:虎列拉 (hǔlièlā), Japanese:コレラ (korera), Hausa:kwalara  
**holmium** *holmium* ← English:holmium, French:holmium, Spanish:holmio, Portuguese:hólmio, Russian:гольмий, Mandarin:钬 (huǒ), Japanese:ホルミウム, Korean:홀뮴, Vietnamese:honmi, Hindi:होल्मियम, Bengali:হলমিয়াম, Malay:holmium, Swahili:homi, Arabic: هلميوم  
**hore** *shiver (creeps)* ← English:Spanish:Portuguese:horror, French:horreur, Japanese:ホラー (horā), Korean:호러 (horeo)  
...
**hotel** *hotel* ← English:deu:Spanish:Portuguese:Malay:hotel, French:hôtel, Hindi:होटल (hoṭal), Bengali:হোটেল (hoṭel), Tamil:ஹோட்டல் (hottal), Japanese:ホテル (hoteru), Korean:호텔 (hotel), Russian:отель (otel), Swahili:hoteli, Hausa:otal  
**hua** *flower* ← Mandarin:花 (huā), Cantonese:花 (faa1), Vietnamese:hoa, Korean:화 (hwa) + Swahili:ua  
**huang** *yellow* ← Mandarin:黄 (huáng), Cantonese:黃 (wong4), Wu-Chinese:黃 (húan), Vietnamese:vàng  
...
**humel** *hop* ← Russian:хмель (hmel'), Persian: خمل‎ (xemel) + French:houblon  
...
**hura** *cheer (hurrah, hooray, yay)* ← Russian:ура (ura), Italian:urrà, deu:Spanish:hurra, French:hourra, English:hurrah, Malay:hore, Persian:(hurâ)  
**hure** *free (unchained)* ← Arabic: حر (ḥurr), Turkish:hür, Swahili:huru, Spanish:horro, Portuguese:forro  
...
**idee** *idea (concept, notion)* ← English:Spanish:idea, French:idée, deu:Idee, Portuguese:ideia, Russian:идея (ideya), Malay:ide, Japanese:アイデア (aidea), Korean:아이디어 (aidieo), Vietnamese:ý định  
...
**iglu** *igloo* ← English:igloo, French:iglou, Spanish:iglú, Portuguese:Turkish:Malay:iglu, Russian:иглу (iglu), Hindi:इग्लू (iglū), Japanese:イグルー (igurū), Korean:이글루 (igeullu)  
**iha** *donkey (ass)* ← onom. English:heehaw, French:hi-han, Russian:и-а (i-a), Vietnamese:hô hố, Turkish:aa-i  
**ilme** *knowledge (wisdom)* ← Arabic: عِلْم‎ (ʕilm), Persian: علم‎ ('elm), Hindi:इल्म (ilm), Bengali:এলেম (elem), Malay:Fulani:ilmu, Hausa:ilmi, Swahili:elimu, Turkish:ilim  
**imperia** *empire* ← English:French:empire, Spanish:imperio, Portuguese:império, Russian:империя (imperiya), Arabic:(ʾimbirāṭūriyya), Turkish:imparatorluk  
...
**insulte** *insult (offence)* ← English:insult, French:insulte, Spanish:Portuguese:insulto, Russian:инсульт (insul’t)  
...
**jamia** *collection (congregation, assembly)* ← Arabic: جَمَعَ‎ (jamaʿa), Swahili:jamii, Turkish:camia, Persian: جمع (jam’), Hausa:jam'iyya + Hindi:जमात (jamāt)  
...
**jan** *care (caution, attention, heed)* ← Hindi:ध्यान (dhyān), Bengali:ধ্যান (dhyān), Japanese:禅 (zen), English:French:Portuguese:zen, Russian:дзэн (dzen), Mandarin:禅 (chán), Korean:선 (seon), Vietnamese:thiền, Burmese:ဈာန် (jhan)  
**janela** *window* ← Portuguese:janela, Bengali:জানালা (janala), Tamil:ஜன்னல் (jaṉṉal), Malay:jendela  
**jang suta** *martial art* ← Mandarin:武术 (wǔshù), Japanese:武術 (bujutsu), Vietnamese:võ thuật, Korean:무술 (musul), English:martial art  
**jang** *fight (war, battle, combat)* ← Persian: جنگ (jang), Hindi:जंग (jang), Bengali:জঙ্গ (jôṅg), Turkish:cenk + Mandarin:仗 (zhàng); 爭 (zhēng), Cantonese:争 (zang1), Korean:전쟁 (jeonjaeng), Vietnamese:(chiến) tranh + Malay:juang  
**jangal** *forest (woods, jungle)* ← English:French:jungle, Spanish:jungla, Portuguese:jângal, Russian:джунгли (džungli), Hindi:जंगल (jangal), Bengali:জঙ্গল (jônggôl), Malay:jenggela, Japanese:ジャングル (janguru), Korean:정글 (jeonggeul), Turkish:cengel  
**jara** *jar (jug, pitcher, carafe, amphora, vase)* ← Arabic: جَرَة‎ (jara), English:jar, French:jarre, Spanish:Portuguese:jarra  
...
**javabe** *answer (reply, respond; response)* ← Arabic: جَوَاب‎ (jawāb), Hindi:जवाब (javāb), Malay:jawab, Fulani:jaabaade, Swahili:jibu,jawabu, Turkish:cevap  
**jebe** *pocket* ← Arabic: جَيْب‎ (jayb), Persian: جیب‎ (jib), Hindi:जेब (jeb), Punjabi:ਜੇਬ (jeb), Telugu:(jēbu), Turkish:cep, Portuguese:algebeira, Fulani:jeyba, Hausa:aljihu, ful:jiiba, Wolof:jiba, Amharic:ጅብ (ǧəb)  
...
**jele** *imprison (jail; imprisonment)* ← English:jail, French:geôle, Hindi:जेल (jel), Bengali:জেল (jēl), Telugu:జైలు (jailu), Swahili:jela + Spanish:Portuguese:jaula  
**jen** *person (individual)* ← Mandarin:人 (rén), wuu人 (zén), Japanese:人 (jin) + French:gens, Spanish:Portuguese:gente + Hindi:जन (jan), Bengali:-জন (-jôn), Malay:-jana, Thai:ชน (chon), Khmer:ជន (jon)  
...
**jihade** *struggle (strife)* ← Arabic: جهاد (jihād), Turkish:cihat, Fulani:jihaadi, Swahili:jihadi + English:French:Portuguese:Malay:jihad, Spanish:yihad, Russian:джихад (džihad), Japanese:ジハード (jihādo), Korean:지하드 (jihadeu), Hindi:जिहाद (jihād)  
**jin** *spirit (soul, vitality, life force)* ← Arabic: جِنّ (jinn), Fulani:Wolof:jinne, Swahili:jini, man:jinnoo, Russian:джинн (džinn) + English:genie, French:génie, Spanish:genio, Portuguese:gênio + Hindi:जान (jān), Bengali:জান (jan), Turkish:can  
**jiva** *live (be alive; living; life, existence)* ← Hindi:जीव (jīv), Bengali:জীউ (jiu), Telugu:జీవము (jīvamu), Malay:jiwa, Thai:ชีวิต  (chiwit), Burmese:ဇီဝ (jiwa), Khmer:ជីវិត (jĭvit), Russian:живой (živoy), Polish:żywy  
...
**jovar** *sorghum (durra, jawar, Indian millet)* ← Persian: جواری‎ (jovâri), Hindi:ज्वार (jvār), Bengali:জোয়ার (joyār), Arabic: جَاوَرْس (jāwaras), English:jawar  
**jube** *robe (tunica, gown, jubbah)* ← Arabic: جُبَّة (jubba), Swahili:juba, Malay:jubah, Spanish:aljuba, Portuguese:gibão, French:jupon, Russian:жупан (župan)  
**judau** *judo* ← Mandarin:柔道 (róudào), Japanese:柔道 (jūdō), Korean:유도 (yudo), Vietnamese:nhu đạo, English:deu:French:Spanish:Portuguese:Malay:Turkish:Swahili:judo, Russian:дзюдо (dzyudo), Arabic: جُودُو‎ (jūdū), Persian: جودو‎ (judo), Hindi:जूदो (jūdo)  
**jude** *judge* ← English:judge, French:juge, Spanish:juez, Portuguese:juiz, Hindi:जज (jaj), Bengali:জজ (jôj), Swahili:jaji, Fulani:juuju + Russian:судья (sud'ya)  
...
**kabile** *tribe* ← Arabic: قَبِيلَة‎ (qabīla), Persian: قبیله‎ (qabile), Hindi:क़बीला (qābilā), Turkish:kabile, Fulani:ƙabiila, Swahili:Hausa:kabila  
...
**kafe** *coffee* ← deu:Kaffee, French:Spanish:Portuguese:café, Russian:кофе, Mandarin: 咖啡 (kāfēi), Cantonese:咖啡 (gaa3 fe1), English:coffee, Hindi:काफ़ी (kāfī), Bengali:কফি (kôphi), Turkish:kahve, Hausa:kofi, Fulani:kafe  
**kafir** *infidel (pagan, heathen, unbeliever)* ← Arabic:(kāfir), Persian:(kāfer), Turkish:French:kâfir, Fulani:keefeero, Yoruba:kaferi, Swahili:Hausa:kafiri, Malay:kafir, Russian:кафир (kafir), Hindi:काफ़िर (kāfir)  
...
**kaju** *cashew* ← French:cajou, Spanish:cajú, Portuguese:caju, English:cashew, deu:Kaschu, Hindi:काजू (kājū), Bengali:কাজু (kaju), Arabic: كَاجُو‎ (kājū), Fulani:kasu, Malay:gajus, Turkish:kaşu, Japanese:カシュー (kashū), Korean:캐슈 (kaesyu)  
**kaka** *excrement (shit)* ← Spanish:Portuguese:French:caca, deu:Kacke, Arabic:(kākā), Turkish:kaka, Russian:кака (kaka), Persian:(kake)  
**kakau** *cocoa* ← Portuguese:cacau, Arabic:(kākāw), Spanish:cacao, English:cocoa, Russian:какао (kakao), Japanese:カカオ (kakao), Mandarin:可可 (kěkě), Cantonese:唂咕 (guk1gu2), Vietnamese:cacao, Fulani:kokko, Swahili:kakao  
...
**kal** *what kind of?* ← English:quality, deu:Qualität, French:qualité, Spanish:calidad, Portuguese:qualidade, Turkish:kalite, Malay:kualitas  
**kala** *black* ← Hindi:काला (kālā); कारौ (kārau), Bengali:কালো (kalo), Punjabi:ਕਾਲਾ (kālā) + Tamil:கருப்பு (karuppu) + Turkish:kara, kaz:қара (qara)  
...
**kalende** *calendar* ← English:calendar, French:calendrier, Spanish:Portuguese:calendario, Russian:календарь (kalendar’), deu:Malay:kalender, Japanese:カレンダー (karendā), Korean:카렌더 (karendeo), Hindi:कैलेण्डर (kaileṇḍar), Swahili:kalenda, Hausa:kalanda  
...
**kalifornium** *californium* ← English:californium, French:californium, Spanish:californio, Portuguese:califórnio, Russian:калифорний, Mandarin:锎 (kāi), Japanese:カリホルニウム, Korean:칼리포르늄, Vietnamese:califoni, Hindi:कैलीफोर्नियम, Bengali:ক্যালিফোর্নিয়াম, Malay:kalifornium, Swahili:kalifoni, Arabic: كاليفورنيوم  
**kalium** *potassium* ← Russian:калий, Japanese:カリウム, Vietnamese:kali, Malay:kalium, Swahili:kali  
...
**kalsium** *calcium (Ca)* ← English:calcium (Ca), French:calcium, Spanish:calcio, Portuguese:cálcio, Russian:кальций, Mandarin:钙 (gài), Japanese:カルシウム, Korean:칼슘, Vietnamese:canxi, Hindi:कैल्शियम, Bengali:ক্যালসিয়াম, Malay:kalsium, Swahili:kalisi, Arabic: كلسيوم  
**kam** *little (few, not many)* ← deu:kaum + Persian: کم‎ (kam), Hindi:कम (kam), Bengali:কম (kôm) + Cantonese:減 (gaam2), Japanese:減 (-gen), Korean:감 (gam), Vietnamese:giảm  
...
**kan** *workshop (shop, building, house or place for doing something)* ← Persian:خانه‎ (xâne), Russian:-хана (-hana), Hindi:ख़ाना (xānā), Bengali:খানা (khana), Swahili:karakana, Turkish:hane + Mandarin:馆 (guǎn), Cantonese:館 (gun2), Korean:관 (gwan), Japanese:館 (-kan), Vietnamese:quán  
...
**kandi** *candy (sweets)* ← English:candy, Hindi:कैंडी (kaiṇḍī), Bengali:ক্যান্ডি (kyandi), Japanese:キャンデー (kyandē), Filipino:kendi + Arabic:Persian: قند (qand), Tamil:கண்டு (kaṇṭu)  
**kane** *bar (pole, rod, shaft, staff, stick)* ← English:cane, French:canne + Mandarin:杆 (gǎn), Cantonese:杆 (gon1), Vietnamese:cần, Thai:คัน (khan)  
...
**kanse** *cancer* ← English:French:cancer, Spanish:cáncer, Portuguese:câncer, Hindi:कैंसर (kainsar), Bengali:ক্যান্সার (kênsar), Turkish:kanser, Swahili:kansa, Japanese:癌 (gan)   
...
**kapa** *head* ← deu:Kopf, Spanish:cabeza; cabo, Portuguese:cabeça; cabo, Malay:kepala + Hindi:कपाल (kapāl) + English:cape, French:cap + Cantonese:岬 (gaap3), Korean:갑 (gap)  
**kape** *catch (capture, grab, seize, snatch)* ← Turkish:kapmak, Hungarian:kap, Spanish:Portuguese:caber; capturar, English:capture  
...
**karcof** *globe artichoke* ← Arabic: خرشوف (kharshuf), Amharic:ከርቹፍ (kärčuf), Spanish:alcachofa, Portuguese:alcachofra, Malay:kharsyuf, Polish:karczoch  
...
**kargadan:** *rhinoceros* ← Persian: کرگدن‎ (kargadan), Arabic: كَرْكَدَّن‎ (karkaddan), Turkish:kergedan, Hausa:karkanda, Oromo:karkaarro, Hindi:खड्गधेनु (khaḍgadhenu), Tamil:ఖడ్గమృగం (khaḍgamr̥gaṁ), Telugu:ఖడ్గమృగం (khaḍgamr̥gaṁ)  
**kari** *curry* ← English:French:Portuguese:curry, Spanish:curri, Russian:карри (karri), Mandarin:咖喱 (kālǐ), Cantonese:咖喱 (gaa3lei1), Japanese:カレー (karē), Korean:커리 (keori), Vietnamese:cà ri,Hindi:करी (karī), Bengali:কারি (kari), Malay:kari, Arabic: كَارِي‎ (kārī)  
**karim di** *charitable (gentle, kind)* ← Arabic:(karīm), Swahili:-karimu, Turkish:kerim, Spanish:Portuguese:caritativo  
**karite** *shea (vitellaria)* ← Wolof:kaarite, French:Spanish:karité, Portuguese:carité, Fulani:kaare; kareje, Hausa:kaɗanya  
**karne** *meat (flesh)* ← Spanish:Portuguese:carne, English:carnal + French:charnel; incarnation, deu:Inkarnation  
**karote** *carrot* ← English:carrot, French:carotte, deu:Karotte, Fulani:Swahili:karoti, Hausa:karas, Amharic:ካሮት (karot), Malay:karot, Vietnamese:cà rốt, Tamil:காரட் (kāraṭ)  
**karta** *card* ← English:card, French:carte, Spanish:Portuguese:carta, deu:Karte, Russian:карта (karta), Turkish:kart, Fulani:kartal, Swahili:kadi, Hausa:karta, Hindi:कार्ड (kārḍa), Bengali:কার্ড (kārḍa), Malay:kartu, Mandarin:卡 (kǎ), Cantonese:卡 (kaa1), Japanese:カード (kādo), Korean:카드 (kadeu)  
**karte** *map (chart, geographic map)* ← English:chart, French:carte, Spanish:Portuguese:carta, Russian:карта (karta), Arabic: خَرِيطَة‎ (ḵarīṭa), Turkish:harita  
**kartux** *cartridge* ← French:cartouche, Spanish:Portuguese:cartucho, Hindi:कारतूस (kārtūs), Arabic: خَرْطُوش‎ (ḵarṭūš), Fulani:kartus, Turkish:hartuç  
...
**kase** *box (container)* ← lat:capsa, deu:Kasse, English:case, French:caise, Spanish:caja, Portuguese:caixa, Russian:касса (kassa), Swahili:kasha, Fulani:keesu + Arabic:(qafaṣ), Hindi:क़फ़स (qafas), Turkish:kafes + Mandarin:卡式 (kǎshì), Cantonese:卡式 (kaa1sik1), Japanese:カセット (kasetto), Korean:카세트 (kaseteu), Hausa:kaset  
**kaska** *shell (crust, carapace, shield)* ← French:casque, Spanish:cáscara, Portuguese:casca, Fulani:kaske + nan:殼 (kag4), Wu-Chinese:殼 (khoq4), Japanese:殻 (kaku)  
**kastana** *chestnut* ← deu:Kastanie, Spanish:castaňa, Portuguese:castanha, Russian:каштан (kaštan), Persian: کستانه‎ (kastâne), Arabic: كَسْتَنَاء‎ (kastanāʔ), Turkish:kestane  
...
**katil** *bed* ← Tamil:கட்டில் (kaṭṭil), Malay:katil, Hindi:खाट (khāṭ), English:cot, Spanish:Portuguese:catre  
**katus** *cactus* ← English:Spanish:Portuguese:French:cactus, deu:Kaktus, Russian:кактус (kaktus), Hindi:कैक्टस (kaikṭas), Turkish:kaktüs, Malay:kaktus  
...
**kavai** *cute (sweet)* ← Japanese:可愛い (kawaii), Korean:카와이 (kawai), English:kawaii  
**kave** *dig (pit, cavity)* ← Spanish:Portuguese:cavar, English:excavar, French:excaver  
**ke** *what?* ← French:que, Spanish:qué, Portuguese:o que + Bengali:কে (ke) + Mandarin:何 (hé)  
**kecape** *ketchup* ← Cantonese:茄汁 (kezap), English:French:Spanish:ketchup, Portuguese:catchup, Russian:кетчуп (ketčup), Japanese:ケチャップ (kechappu), Korean:케첩 (kecheop), Hindi:केचप (kecap), Bengali:কেচাপ (kecap), Arabic: كَتْشَب‎ (katšab)  
**keci** *polite* ← Mandarin:客气 (kèqì), Cantonese:客氣 (haak3 hei3), Wu-Chinese:客氣 (khaq qi4)  
**keke** *cake (cookie)* ← English:cake, Russian:кекс (keks), Arabic:(kaʿka), Hindi:केक (kek), Japanese:ケーキ (kēki), Swahili:keki, Turkish:Hausa:kek  
**kelele** *noise* ← Swahili:Kongo:makelele  
**ken** *know* ← deu:kennen, English:ken + Bengali:জ্ঞান (gên) + Malay:kenal  
...
**kerubi** *cherub* ← heb:כְּרוּב‎ (kerúv), English:cherub, Spanish:querubín, Portuguese:querubim, French:chérubin, Russian:херувим (heruvim), Swahili:kerubi, Hausa:Malay:kerub, Mandarin:基路伯 (jīlùbó)  
...
**keze** *cheese* ← Spanish:queso, Portuguese:queijo, Malay:keju, deu:Käse, English:cheese, Mandarin:起司 (qǐsī), Cantonese:知士 (zi1si62), Japanese:チーズ (chīzu), Korean:치즈 (chijeu), Hindi:चीज़ (cīz), Swahili:chizi  
...
**kirate** *carat* ← Arabic: قِيرَاط‎ (qīrāṭ), English:French:carat, Spanish:Portuguese:quilate, Russian:карат (karat), Mandarin:克拉 (kèlā), Japanese:カラット (karatto), Korean:캐럿 (kaereot), Malay:Hausa:karat, Swahili:karati, Turkish:kırat  
...
**kitabe** *write (writing, text, script)* ← Arabic: كِتَاب‎ (kitāb), Persian: کتاب‎ (ketâb), Hindi:किताब (kitāb), Turkish:kitap; katip, Malay:kitab, katib, Swahili:kitabu; katibu, Hausa:littafi  
...
**klas** *class (category)* ← English:class, Spanish:clase, Portuguese:French:classe, Russian:класс (klass), کلاس‎ (kelâs), Malay:kelas, Japanese:クラス (kurasu), Fulani:kalaas  
...
**klike** *click (snap)* ← English:click, Spanish:clic, Portuguese:clicar, French:claquer, Hindi:क्लिक (klika), Bengali:ক্লিক (klika), Malay:klik, Japanese:クリック (kurikku)  
**klima** *climate* ← Greek:κλίμα (eklíma), Spanish:Portuguese:clima, Arabic:(ʾiqlīm), Malay:Turkish:iklim, English:climate, Russian:климат (klimat)  
**klin** *slope (tilt, slant, bias, inclination, tendency)* ← English:-cline, French:-cliner, Portuguese:Spanish:-clinar, Russian:склонить (sklonit’)  
**klon** *clone (replica)* ← English:Portuguese:French:clone, Spanish:clon Russian:клон (klon), deu:Malay:Turkish:klon, may:klon, Mandarin:克隆 (kèlóng), Japanese:クローン (kurōn)  
**klor** *chlorine* ← English:chlorine, French:chlore, Spanish:cloro, Portuguese:cloro, Russian:хлор, Vietnamese:clo, Hindi:क्लोरीन, Bengali:ক্লোরিন, Malay:klor, Swahili:klorini, Arabic: كلور  
...
**kluze** *close (shut)* ← English:French:Spanish:Portuguese:-clus-, Russian:ключить (-klyučítʹ)  
**koala** *koala* ← English:French:Spanish:Vietnamese:Malay:Swahili:Turkish:koala, Portuguese:coala, Russian:коала (koala), Mandarin:考拉 (kǎolā), Cantonese:考拉 (haau2laa1), Japanese:コアラ (koara), Korean:코알라 (koalla), Arabic: كُوَالَا‎ (kuwalā), Hindi:कोअला (koalā), Bengali:কোয়ালা (koẏala)  
**kobalte** *cobalt* ← English:cobalt, French:cobalt, Spanish:cobalto, Portuguese:cobalto, Russian:кобальт, Mandarin:钴 (gǔ), Japanese:コバルト, Korean:코발트, Vietnamese:coban, Hindi:कोबाल्ट, Bengali:কোবাল্ট, Malay:kobalt, Swahili:kobalti, Arabic: كوبلت  
...
**koko** *chicken* ← French:coq, English:cock, Polish:kogut, Hindi:कुक्कुट (kukkuṭ) + Swahili:kuku, Zulu:inkukhu, Igbo:Ọkụkọ + (onom.) Italian:coccodè, Japanese:コッコッ (kokko), Persian:(qod-qod-qodās), Russian:куд-куда  
**kola** *kola* ← English:Spanish:cola, Russian:кола (kola), Hindi:कोला (kolā), Japanese:コラ (kora), Swahili:mkola, Fulani:ngoro, Hausa:gworo, Wolof:goro  
...
**kolone** *settle (colonize)* ← English:colony, Spanish:colonia, Portuguese:colônia, Russian:колония (koloniya), Turkish:ma:koloni, Hindi:कॉलोनी (kŏlonī), Japanese:コロニー  
...
**komike** *comic (funny)* ← English:comic, French:comique, Spanish:Portuguese:cómico + Russian:комедия (komedija), Japanese:コメディ (komedi), Korean:코미디 (komidi)  
**kompani** *company (corporation)* ← English:company, Hindi:कंपनी (kampanī), Russian:компания (kompaniya), Filipino:kompanya, Polish:kompania  
**kon** *with (together; common)* ← English:con-; common, French:con-; commun, Spanish:con-; común, Portuguese:con-; comum, Russian:кон- (kon-) + Mandarin:共 (gòng), Cantonese:共 (gung), Korean:공 (gong), Vietnamese:cộng  
...
**konu** *cone* ← English:Portuguese:cone, French:cône, Spanish:cono, Russian:конус, Malay:kon, Swahili:Turkish:koni  
**kopernium** *copernicium* ← English:French:copernicium, Spanish:copérnico, Portuguese:copernício, Russian:коперниций, Japanese:コペルニシウム, Korean:코페르니슘, Vietnamese:copernici, Malay:copernicium, Swahili:kopernici  
**kopi** *copy (duplicate, replica)* ← English:copy, French:copie, Spanish:Portuguese:copia, Russian:копия (kopiya), Hindi:कापी (kāpī), Turkish:kopya, Malay:kopi, Mandarin:拷貝 (kǎobèi), Japanese:コピー (kopī)  
**koral** *coral* ← English:Spanish:Portuguese:coral, French:corail, deu:Koralle, Russian:коралл + Malay:karang  
**kore** *run* ← French:courir, Spanish:Portuguese:correr  
**korne** *horn* ← French:corne, Spanish:cuerno, Portuguese:corno, English:horn, Arabic:(qarn)  
**korona** *crown* ← French:couronne, English:crown, Spanish:corona, Japanese:クラウン (kuraun), Russian:корона (korona), Portuguese:coroa  
**korte** *short (brief)* ← Spanish:corto, Russian:короткий (korotkiy), Portuguese:curto, French:court, deu:kurz, English:short  
**kosi** *sew* ← Spanish:Portuguese:coser + Hindi:सीना (sīnā), Bengali:স্যূত (syūta), Marathi:शिवणे (śivṇe), Gujarati:સીવવું (sīvvũ), Russian:шить (šit'), English:sew  
**kosme** *space (cosmos, universe)* ← Russian:космос (kosmos), English:French:Spanish:cosmos  
**koso** *cough* ← Russian:кашель (kašel'), Polish:kaszel, Bengali:কাশা (kaśa), Mandarin:咳嗽 (késou)  
**kote** *coat* ← English:coat, Swahili:koti, Hausa:kwat, Oromo:koota, Japanese:コート (kōto), Persian:(kot), Hindi:कोट (kot)  
...
**kratia** *government (rule (reign, -ocracy, -archy)* ← English:-cracy, French:-cratie, Spanish:Portuguese:-cracia, Russian:-кратия (kratiya), Arabic:(-qratiya), Malay:Swahili:-krasi  
**kree** *create* ← English:create, deu:kreieren, French:créer, Spanish:crear, Portuguese:criar + Malay:kreatif  
**krem** *cream* ← French:crème, Portuguese:creme, Spanish:crema, English:cream, Japanese:クリーム (kurīmu), Mandarin:淇淋 (qílin), Fulani:kerem  
**krepe** *pancake* ← French:English:crêpe, Portuguese:crepe, Spanish:crepa, Turkish:krep, Mandarin:可丽饼 (kělìbǐng)  
...
**krim di** *criminal* ← Arabic: جُرْم (jurm), Persian: جرم‎ (jorm), Hindi:जुर्म (jurm)  
**krim** *crime (commit a crime, perpetrate)* ← English:French:Portuguese:crime, Spanish:crimen, Filipino:krimen  
...
**krizi** *crisis* ← English:crisis, French:Portuguese:crise, deu:Krise, Russian:кризис (krizis), Spanish:crisis  
...
**krokro** *frog* ← English:croak, French:croa croa, Spanish:Portuguese:croac croac, Japanese:ケロケロ (kero kero), Malay:krok krok  
**kromium** *chromium* ← English:chromium, French:chrome, Spanish:cromo, Portuguese:crómo, Russian:хром, Japanese:クロム, Korean:크로뮴, Vietnamese:crom, Hindi:क्रोमियम, Bengali:ক্রোমিয়াম, Malay:krom, Swahili:kromi, Arabic: كروم  
**krote** *mole (burrowing animal)* ← Russian:крот (krot), Polish:kret  
**kruasan** *croissant* ← French:English:croissant, Portuguese:croassã, Spanish:cruasán, Russian:круассан, Mandarin:可颂 (kěsòng), Japanese:クロワッサン (kurowassan), Korean:크루아상 (keruasang), Hindi:क्रोइसैन (kroisain)  
...
**kuan** *mineral (ore)* ← Mandarin:矿 (kuàng), Vietnamese:khoáng, Korean:광 (guang) + Persian: کان‎ (kân), Hindi:खान (khān), Bengali:খাদ (khad)  
...
**kuku** *cuckoo* ← English:cuckoo, French:coucou, Spanish:Portuguese:cuco, Russian:кукушка (kukushka), Persian: کوکو‎ (kuku), Japanese:郭公 (kakkō), Mandarin:布谷鸟 (bùgǔniǎo), Cantonese:布谷鳥 (bou3 guk1 niu5), Turkish:guguk, Hausa:kukku  
**kule** *slave (coolie)* ← Turkish:köle; kul, Hindi:क़ुली (qulī), Tamil:கூலி (kūli), Malay:kuli, Mandarin:苦力 (kǔlì), Cantonese:咕哩 (gu1 lei1), Japanese:苦力 (kūrī), Korean:쿨리, Vietnamese:cu li, English:French:coolie, Spanish:culi, Portuguese:cule, deu:Kuli, Russian:кули (kuli)  
**kulte** *cultivate (foster)* ← English:cultivate, French:cultiver, Spanish:Portuguese:cultivar, Russian:культура (kulʹtúra), Persian: کولتور‎ (kultur), Turkish:kültür, Japanese:カルチャー (karuchā), Tamil:கலாச்சாரம் (kalāccāram)  
**kume** *mound (hill)* ← English:cumulate, French:cumuler, Spanish:Portuguese:cumular + Turkish:kumul + Arabic:كَوْمَة‎ (kawma), Persian: کومه (kume)  
**Kung Fuzi** *Confucious* ← Mandarin:孔夫子 (Kǒng Fūzǐ)  
**kung** *hole* ← Mandarin:孔 (kǒng), Cantonese:孔 (hung2), Wu-Chinese:孔 (khon2), Japanese:孔 (kō), Korean:공 (gong), Vietnamese:hỏng  
**kupa** *drinking vessel (cup, glass, mug, goblet, chalice)* ← English:cup, French:coupe, Spanish:copa, Portuguese:copo, Arabic: كُوب‎ (kūb), Fulani:kóppu, Turkish:kupa, Hindi:कप (kap), Japanese:コップ (koppu), Korean:컵 (keop) + Persian:(koppe), ara:قبة (qubba), Malay:kubah, Russian:купол (kupol), deu:Kuppel  
...
**kupre** *copper* ← English:copper, French:cuivre, Spanish:cobre, Portuguese:cobre, Swahili:kupri  
**kuran** *Quran (Koran)* ← Arabic: الْقُرْآن‎ (al-qurʔān), Turkish:Kuran, Swahili:Kurani, Hausa:Alƙur'ani, Fulani:alkur'aana, English:Quran, French:Coran, Spanish:Corán, Portuguese:Corão, Russian:Коран (Koran), Persian: قرآن‎ (qor-ân), Hindi:क़ुरान (qurān), Bengali:কুরআন (kuran), Malay:Al-Qur'an, Mandarin:古兰经 (gǔlánjīng), Japanese:クルアーン (kuruān), Korean:꾸란 (kkuran), Vietnamese:kinh Koran  
**kurban** *sacrifice (offer)* ← Arabic: قُرْبَان‎ m (qurbān), Hindi:कुरबानी (kurbānī), Bengali:কোরবানি (korbani), Malay:Turkish:kurban  
**kurium** *curium* ← English:curium, French:curium, Spanish:curio, Portuguese:cúrio, Russian:кюрий, Japanese:キュリウム, Korean:퀴륨, Vietnamese:curi, Hindi:क्यूरियम, Bengali:কুরিয়াম, Malay:kurium, Swahili:kuri, Arabic: كوريوم  
**kurse** *go (going; course)* ← English:course, French:cours, Spanish:Portuguese:curso, Russian:курс (kurs) + Hindi:कोर्स कोर्स् (kors), Malay:kursus, Korean:코스 (koseu), Japanese:コース (kōsu)  
**kursi** *chair* ← Arabic:(kursiy), Hindi:कुरसी (kursī), Urdu:(kursī), Punjabi:ਕੁਰਸੀ (kursī), Telugu:(kurcī), Malay:som:kursi, Persian:(korsi)  
**kurta** *tunic (kirtle)* ← Persian: کرته‎ (korte), Hindi:कुरता (kurtā), Bengali:কুরতা (kurôta), Telugu:కుర్తా (kurtā), Malay:kurta, Russian:курта (kurta), English:kirtle  
**kurva** *curve (bend)* ← English:curve, French:courbe, Spanish:Portuguese:curva, Swahili:kuruba + Russian:кривая (krivaya)  
**kutu** *louse (cootie)* ← Malay:kutu, Filipino:kuto, English:cootie  
**kux loka** *berth (couchette)* ← French:English:couchette, Italian:cuccetta, Polish:kuszetka  
**kuxen** *cushion (pillow)* ← English:cushion, French:coussin, Spanish:cojín, Portuguese:coxim, Japanese:クッション (kusshon), Korean:쿠션 (kusyeon), Cantonese:咕𠱸 (ku1 seon2), Hausa:kushin, Igbo:kushọn  
...
**lake** *lacquer (varnish)* ← English:lacquer, deu:Lack, Spanish:Portuguese:laca, French:laque, Russian:лак (lak), Malay:lak, Arabic: لَكّ‎ (lakk), Turkish:lake, Mandarin:蜡克 (làkè), Japanese:ラッカー (rakkā), Korean:래커 (raekeo)  
**lala** *lull* ← English:lull, Polish:lulać, Persian: لالا کردن‎ (lâlâ kardan) + Japanese:ララバイ (rarabai), Filipino:lalay + Swahili:-lala  
**lampa** *lamp* ← English:lamp, deu:French:lampe, Spanish:lámpara, Portuguese:lâmpada, Russian:лампа (lampa), Arabic: لمبة‎(lamba), Japanese:ランプ (ranpu), Korean:램프 (raempeu), Hindi:लैंप (laimp), Bengali:ল্যাম্প (lyamp), Fulani:Malay:lampu, Turkish:lamba  
**langan** *banister (handrail)* ← Mandarin:栏杆 (lángān), Japanese:欄干 (rankan), Korean:난간 (nan-gan)  
**lanse** *throw (launch)* ← English:launch, Italian:lanciare, Portuguese:lançar, French:lancer, Spanish:lanzar, deu:lancieren  
**lantan** *lanthanum* ← English:lanthanum, French:lanthane, Spanish:lantano, Portuguese:lantâno, Russian:лантан, Mandarin:镧 (lán), Japanese:ランタン, Korean:란탄, Vietnamese:lantan, Hindi:लाञ्थनम, Bengali:ল্যান্থানাম, Malay:lantanium, Swahili:lanthani, Arabic: لنثانوم  
**larva** *larva (maggot, caterpillar)* ← deu:French:larve, English:Turkish:larva, Hindi:लार्वा (lārvā), Urdu:(lārvā), Polish:larwa  
**lasa** *garbage (rubbish, trash, junk)* ← Mandarin:垃圾 (lājī / lèsè), Cantonese:垃圾 (laap6 saap3), Hakka-Chinese:垃圾 (lá-sap), nan:垃圾 (lah-sap)  
...
**lau** *old (aged, elderly)* ← Mandarin:老 (lǎo), Cantonese:老 (lau2), Wu-Chinese:老 (lau3), Japanese:老 (rō), Vietnamese:lão  
**laurencium** *lawrencium* ← English:lawrencium, French:lawrencium, Spanish:laurencio, Portuguese:lawrêncio, Russian:лоуренсий, Mandarin:铹 (láo), Japanese:ローレンシウム, Korean:로렌슘, Vietnamese:lorenxi, lawrenci, Hindi:लॉरेंशियम, Bengali:লরেনসিয়াম, Malay:lawrensium, Swahili:lawirensi, Arabic: لورنسيوم  
...
**lazur petra** *lapis lazuli* ← Persian:لاجورد (lājevard), English:lazuli, Spanish:lapislázuli, Russian:лазурит (lazurit), Arabic:لازورد (lāzaward), Hindi:लाजवर्द (lājavarda), Japanese:ラピスラズリ (rapisurazuri), Malay:lazuardi, Turkish:lazur taşı  
**le** *attain (accomplish, indicates the current position)* ← Mandarin:了 (le, liǎo), Wu-Chinese:了 (le’), Cantonese:了 (liu), Thai:แล้ว (lɛːw)  
**lege** *light (requiring little effort, easy, soft, minute, unimportant, etc.)* ← Hindi:लघु (laghu), Bengali:লঘু (laghu) + English:light, Spanish:ligero, Portuguese:ligeiro, French:léger, Russian:лёгкий (l’ogkiy), Polish:lekki  
**leng** *cold* ← Mandarin:冷 (lěng), Vietnamese:lạnh, Cantonese:冷 (laang5)  
...
**lenxi** *exercise* ← Mandarin:练习 (liànxí), Japanese:練習 (renshū), Korean:련습 (ryeonseup)  
**lete** *read* ← Portuguese:leer; leitor, Spanish:ler; lector, French:lire; lecteur, Russian:лектор (lektor) English:literature, deu:Literatur, fra:littérature, Turkish:literatür  
...
**lexe** *word* ← deu:English:French:Spanish:Portuguese:lex-, Russian:лекс- (leks-), Malay:leks-  
...
**lide** *lead (direct)* ← English:lead, Spanish:liderar + French:leader, Portuguese:líder, Russian:лидер (lider), Turkish:lider, Hindi:लीडर (līdar), Japanese:リーダー (rīdā), Korean:리더 (rideo)  
**lifafe** *wrapping (envelope, covering)* ← Arabic: لِفَافَة‎ (lifāfa), Persian:(lefâf), Hindi:लिफ़ाफ़ा (lifāfā), Bengali:লেফাফা (lephapha)  
**lige** *league (alliance)* ← French:ligue, deu:Spanish:Polish:Portuguese:liga, English: league, Russian: лига (liga), Turkish:lig, Swahili:ligi, Japanese:リーグ (rīgu)  
**lila** *lilac* ← English:lilac, French:lilas, Portuguese:lilás, Spanish:Filipino:lila, Japanese:ライラック (rairakku), Turkish:leylak, Arabic:(laylak)  
**lima** *five (5)* ← Malay:Filipino:lima  
**limfa** *lymph* ← English:lymph, Spanish:Portuguese:linfa, Russian:ли́мфа (límfa), Malay:limfa, Japanese:リンパ (rinpa), Mandarin:淋巴 (línbā)  
**limite** *limit (boundary)* ← English:limit, Spanish:límite, French:Portuguese:limite, Russian:лимит (limit)  
**limon** *lemon* ← Persian:(limun), English:lemon, Turkish:limon, Russian:лимон (limon), Spanish:limón, Portuguese:limão, Hindi:नींबू (nīmbū), Urdu:(nībū), Mandarin:柠檬 (níngméng), Cantonese:檸檬 (ning4mung1), Japanese:檸檬 (remon), Korean:레몬 (remon), Vietnamese:lêmon, Swahili:ndimu; limau, Fulani:leemuure, Bengali:লেবু (lebu)  
**lin** *line (thread, string)* ← English:line, French:ligne, Spanish:línea, Portuguese:linha, Russian:линия (liniya), Polish:linia  
**linke** *connection, (association, joint, link, relationship)* ← English:link, French:lien, deu:Link, Persian:لینک • (link), Japanese:リンク (rinku) + Mandarin:連結 (liánjié), Cantonese:連結 (lin4 git3), Hakka-Chinese:連結 (lièn-kiet), Vietnamese:liên kết  
**linxe** *lynx* ← English:French:lynx, Spanish:Portuguese:lince, Hindi:लिंक्स (links)  
**lis** *smooth* ← French:lisse, Spanish:Portuguese:liso, Persian:(liz), Malay:licin  
...
**litre** *litre (liter)* ← English:French:Turkish:litre, deu:Malay:liter, Spanish:Portuguese:litro, Russian:литр (litr), Polish:litr, Arabic: لتر‎(litr), Hindi:लीटर (līṭar), Bengali:লিটার (liṭar), Japanese:リットル (rittoru), Korean:리터 (riteo), Vietnamese:lít, Swahili:Hausa:lita, Fulani:liter  
...
**lixu** *squirrel* ← Mandarin:栗鼠 (lìshǔ), Japanese:栗鼠 (risu)  
...
**lote** *lot* ← English:French:lot, deu:Los, Spanish:Portuguese:loteria, Russian:лотерея (lotereia), Persian: لاتاری‎ (lâtâri), Hindi:लॉटरी (lŏṭrī), Bengali:লটারি (lôṭari), Mandarin:乐透 (lètòu)  
**lotra** *otter* ← English:otter + French:loutre, Spanish:Filipino:lutrino, Portuguese:lontra + Russian:выдра (vydra)  
**lou** *leak* ← Mandarin:漏 (lòu), Cantonese:漏 (lau6), Japanese:漏 (rō), 루 (ru)  
...
**lutesium** *lutetium* ← English:lutetium, French:lutécium, Spanish:lutecio, Portuguese:lutécio, Russian:лютеций, Mandarin:镥 (lǔ), Japanese:ルテニウム, Korean:루테튬, Vietnamese:lutexi, Hindi:लुटेटियम, Bengali:লুটেসিয়াম, Malay:lutetium, Swahili:luteti, Arabic: لوتيتيوم  
...
**mahala** *quarter (neighbourhood, district, locality, section of town)* ← Arabic: مَحَلَّة‎ (maḥalla), Hindi:मुहल्ला (muhallā), Turkish:mahalle  
**maina** *myna bird* ← Hindi:मैना (mainā), Bengali:ময়না (môẏna), Tamil:மைனா (maiṉā), deu:Maina, English:myna, Spanish:Portuguese:mainá  
**mais** *corn (maize)* ← English:maize, Spanish:maíz, French:maïs, Russian:маи́с (maís)  
**majang** *mahjong* ← English:Spanish:Portuguese:mahjong, French:mah-jong, Russian:маджонг (madžong), Malay:mahjung, Mandarin:麻将 (májiàng), Cantonese:麻将 (maa4zoeng3), Japanese:麻雀 (mājan), Korean:마작 (majang), Vietnamese:mạt chược  
**makas** *scissors (shears)* ← Arabic: مَقَص‎ (maqaṣ), Turkish:makas, Swahili:mkasi, Oromo:maqasii, Hausa:almakashi, Yoruba:àlùmogàjí, Fulani:almakaci  
**makin** *machine* ← English:French:machine, deu:Maschine, Spanish:Portuguese:máquina, Fulani:masin, Swahili:mashine, Hindi:मशीन (maśīn), Bengali:মেশিন (meśin), Malay:mesin, Arabic: مَاكِينَة‎ (mākīna), Turkish:makine, Japanese:マシン (mashin), Korean:머신 (meosin)  
**mal** *property (belongings, possessions)* ← Arabic:Persian:Urdu:  مَال‎ (māl), Hindi:माल (māl), Bengali:মালিক, Swahili:mali, Hausa:mallake, Malay:milik, Turkish:mal  
...
**mame** *breast (boob, tit)* ← Persian: ممه‎ (mame), Turkish:meme, English:mamma, Spanish:Portuguese:mama + French:mammifère, Malay:mamalia  
...
**mang** *busy (occupied)* ← Mandarin:忙 (máng), Cantonese:忙 (mong4), Wu-Chinese:忙 (maan), Korean:망 (mang)  
**mangan** *manganese* ← English:manganese, French:manganèse, Spanish:manganeso, Portuguese:manganésio, Russian:марганец, Mandarin:锰 (měng), Japanese:マンガン, Korean:망가니즈, Vietnamese:mangan, Hindi:मैंगनीज, Bengali:ম্যাঙ্গানিজ, Malay:manggan, Swahili:manganisi, Arabic: منجنيز  
**mango** *mango* ← Malayalam:മാങ്ങ (māṅṅa), English:Spanish:Turkish:mango, Portuguese:manga, Russian:манго (mango), Malay:mangga, Japanese:マンゴー (mangō), Korean:망고 (manggo), Fulani:mannguure  
**mania** *mania (abnormally high mood and arousal level)* ← English:Portuguese:mania, deu:Manie, French:manie, Spanish:manía, Russian:мания (maniya)  
**manioka** *cassava (manioc)* ← English:French:manioc, Spanish:Portuguese:mandioca, Russian:маниока (manioka), Korean:마니옥 (maniok), Lingala:manyɔ́kɔ, Kongo:mandioko  
**manite** *magnet* ← English:magnet, French:magnétique, Spanish:magnete, Russian:магнит (magnit), Turkish:mıknatıs, Arabic: مَغْنَاطِيس‎ (maḡnāṭīs), Malay:maknit  
...
**mar** *time (instance, occurrence, number of times)* ← Arabic: مرة (marra), Swahili:mara, Hausa:marra, Persian: بار‎ (bâr), Hindi:बार (bār), Bengali:বার (bar), Tamil:முறை (muṟai), deu:Mal  
...
**marke** *mark (trace)* ← English:mark, Spanish:Portuguese:marca, French:marque, Korean:마크 (makeu), Japanese:マーク (māku), Fulani:marke  
...
**masta** *mast* ← English:deu:mast, Hindi:मस्तूल (mastūl), Japanese:マスト (masuto), Russian:мачта (mačta), Polish:maszt, Portuguese:mastro, Spanish:mástil  
**master** *master (expert)* ← Portuguese:mestre, French:maître, Polish:mistrz, English:master, Russian:мастер (master), Spanish:maestro, deu:Meister, Hindi:(mistrī)  
**mata** *die (death; dead, deceased)* ← Malay:mati + Arabic: مَوْت‎ (mawt), Amharic:ሞት (mot), Swahili:mauti + Spanish:Portuguese:matar + English:matte, French:mat, Russian:матовый (matovyj), Persian: مات‎ (mât)  
**mate** *maté* ← English:maté, French:Spanish:Portuguese:mate, Russian:матэ (mate), Mandarin:马黛茶, Japanese:マテ茶 (matecha), Korean:마테차 (matecha)  
**matras** *mattress* ← English:mattress, deu:Matratze, French:matelas, Russian:матрас (matras), Malay:matras, Japanese:マットレス (mattoresu), Korean:매트리스 (maeteuriseu)  
**max** *more* ← Spanish:mas; máximo, Portuguese:mais; máximo, + English:French:maximum, Russian:максимум (maksimum), Malay:maksimum, Persian: ماکسیمم‎ (mâksimom)  
**mayur** *peafowl (peacock)* ← Hindi:मयूर (mayūr), Bengali:ময়ূর (môyūr), Tamil:மயில் (mayil) + Malay:merak  
...
**medal** *medal* ← English:medal, Spanish:medalla, Portuguese:medalha, French:médaille, deu:Medaille, Russian:меда́ль (medálʹ), Persian: مدال‎ (medâl), Hindi:मेडल (meḍal), Bengali:মেডেল (meḍel), Malay:medali, Arabic: مِيدَالِيَة‎ (mīdāliya), Turkish:madalya, Japanese:メダル (medaru), Korean:메달 (medal), Vietnamese:mề đay  
**medan** *field (square, plaza, maidan)* ← Arabic: مَيْدَان‎ (maydān), Persian:(meydan), Hindi:मैदान (maidān), Bengali:ময়দান (moidan), Turkish:meydan, Swahili:medani, Russian:майдан (maydan)  
**mede** *help (aid, assistance)* ← Arabic: مَدَد‎ (madad), Persian: مدد (madad), Hindi:मदद (madad), Bengali:মদদ (môdôd), Telugu:మద్దతు (maddatu) + French:aider, English:aid + Russian:мэдэ (mede), Japanese:メーデー (mēdē), Korean:메이데이 (meidei)  
**medu** *honey* ← Russian:мёд (myod), Hindi:मधु (madhu), Bengali:মধু (môdhu), Malay:madu + Portuguese:mel, French:Spanish:miel + Cantonese:蜜 (mat6)  
**mega** *million (mega-)* ← English:French:Spanish:Portuguese:Malay:Turkish:mega-, Russian:мега- (mega-), Japanese:メガ (mega), Korean:메가- (mega-)  
**megi** *cloud* ← Hindi:मेघ (megh), Bengali:মেঘ (megh), Tamil:மேகம் (mēgam), Telugu:మేఘము (mēghamu), Malay:mega, Thai:เมฆ (mek) + Arabic: غَيْمَة‎ (ḡayma) + Vietnamese:mây  
**mehe** *sheep* ← Lingala:Kongo:meme + Hindi:मेष (meṣ), Persian:(miš), Thai:เมษ (met) + Japanese:メーメー (mē mē), Portuguese:meh, Arabic:(maa'), Turkish:mee  
**mei** *beautiful (handsome, pretty)* ← Mandarin:美 (měi), Cantonese:美 (mei5), Japanese:美 (mi), Korean:미 (mi), Vietnamese:mĩ, mỹ  
**meitnerium** *meitnerium* ← English:meitnerium, French:meitnérium, Spanish:meitnerio, Portuguese:meitnério, Russian:майтнерий, Japanese:マイトネリウム, Korean:마이트너륨, Vietnamese:meitneri, Hindi:मेइट्नेरियम, Bengali:মিটনেরিয়াম, Malay:meitnerium, Swahili:meitneri, Arabic: مايتنريوم  
...
**men** *many (plural)* ← Mandarin:们 (men), Cantonese:們 (mun4) + English:many + Korean:많- (man-) + (tumen) Hindi:तुम (tum), rom:tumen  
...
**mer** *member (part of a group, component)* ← English:deu:Spanish:Portuguese:mero-, French:méro-, Russian:меро- (mero-)  
...
**mesi** *messiah* ← English:messiah, French:messie, Spanish:mesías, Portuguese:messias, Russian:мессия (messiya), Arabic: مَسِيح‎ (masīḥ), Hindi:मसीह (masīh), Bengali:মসিহ (môśih), Malay:al-Masih, Swahili:Masiya, Turkish:Mesih, Hausa:Almasihu  
**meta** *hind (behind, later)* ← English:Spanish:Portuguese:meta-, French:méta-, Russian:мета- (meta-)  
...
**mi** *I (me)* ← English:French:Portuguese:me, Spanish:mi; me, Persian: من‎ (man), Hindi:मैं (mẽ), Bengali:আমি (ami), Fulani:mi, Swahili:mimi  
**miau** *cat* ← Mandarin:猫 (māo), Cantonese:貓 (maau), Vietnamese:mèo, Thai:แมว (mæo), Swahili:nyau + English:miaow; meow, French:miaou, deu:Spanish:Portuguese:miau, Russian:мяу (myau), Persian: میو‎ (miyu), Hindi:म्याऊँ (myāū̃), Tamil:மியாவ் (miyāv), Turkish:miyav,   
**mide** *middle (the part in between)* ← English:mid; medium, deu:Mitte, Spanish:medio, Portuguese:meio, Hindi:मध्य (madhya), Bengali:মধ্য (môddh), Tamil:மத்தியம் (mattiyam) + French:médias, Russian:медиа (media), Mandarin:媒体 (méitǐ), Japanese:メディア (media), Korean:미디어 (midieo), Turkish:medya  
...
**mikro** *tiny (microscopic, micro-)* ← English:French:Spanish:Portuguese:micro-, Russian:микро- (mikro-), Japanese:マイクロ- (maikuro-), Malay:Turkish:mikr-, Mandarin:麦克 (mâikè)  
**milke** *milk* ← English:milk, deu:Milch, Japanese:ミルク  (miruku), Korean:밀크 (milkeu), Lingala:míliki, Russian:молоко (moloko)  
**mime** *mimic (imitate, emulate)* ← English:French:mime, Spanish:Portuguese:mímico, Russian:мим (mim)  
**min** *less* ← Spanish:Portuguese:menos, French:moins, Russian:ме́нее (méneje), English:min-  
**ming** *bright (brilliant, clear)* ← Mandarin:Wu-Chinese:明 (míng), Cantonese:明 (ming4), Vietnamese:minh, Korean:명 (myeong)  
**minim** *least (minimally)* ← English:French:minimum, Spanish:Portuguese:mínimo, deu:Minimum, Russian:ми́нимум (mínimum)  
**minisme** *minimalism* ← English:minimalism, Spanish:Portuguese:minimalismo, French:minimalisme, Russian:минимали́зм (minimalízm)  
**minte** *mint* ← English:mint, Spanish:Portuguese:menta, French:menthe, Russian:мята (m’ata), Japanese:ミント (minto)  
...
**mire** *stare (watch, gaze)* ← French:mirer, Spanish:Portuguese:mirar + Japanese:見る (miru) + Arabic:مِرْآة‎ (mirʾāh)  
**misal** *example (instance of)* ← Hindi:मिसाल (misāl), Arabic:(mithāl), Persian:(mesâl), Malay:misal, Swahili:mathalani, Turkish:mesela, Hausa:misali  
**mise** *send (emit, transmit)* ← English:emit, French:émettre, Spanish:Portuguese:remitir, Malay:emisi, deu:Mission, Russian:миссия (missiya), Turkish:misyon + Hindi:कमीशन (kamīśan), Bengali:কমিশন (kômiśôn)  
**miskin** *poor (miserable)* ← Arabic:مِسْكِين (miskīn), Persian:مسکین‎ (meskin), Turkish:Malay:Hausa:miskin, Swahili:maskini, Hindi:, Bengali:মিসকিন (miśkin), French:miskine, Spanish:mezquino, Portuguese:mesquinho  
**Misre** *Egypt* ← Arabic:(miṣr), Turkish:Mısır, Swahili:Misri, Hindi:मिस्र (misra), Bengali:মিশর (miśôr), Hausa:Masar  
**mite** *tale (fiction, myth)* ← English:myth, deu:Mythos, French:mythe, Spanish:Portuguese:mito, Russian:миф (mif), Hindi:मिथक (mithak), Turkish:mit  
**mitre** *meter (100 cm)* ← English:Turkish:metre, deu:Malay:meter, French:mètre, Spanish:Portuguese:metro, Russian:метр (metr), Arabic: متر‎ (mitr), Mandarin:米 (mǐ), Japanese:メートル (mētoru), Korean:미터 (miteo), Vietnamese:mét, Hindi:मीटर (mīṭar), Bengali:মিটার (miṭar), Swahili:Hausa:mita, Fulani:meter  
**mixe** *mix (blend)* ← deu:mischen, Russian:мешать (měšat'), Polish:mieszać, English:mix, Italian:miscelare, + Hindi:मिश्रण (miśrān)  
**mode** *mode (pattern, fashion, style)* ← French:English:mode, deu:Mode; Modus, Spanish:Portuguese:modo, Russian:мода (moda), Turkish:mod, Malay:mode, Korean:모드 (modeu) + Mandarin:模 (mó), Cantonese:模 (mou4), Japanese:模 (mo); モード (mōdo)  
...
**mole** *grind (grind in mill)* ← Mandarin:磨 (mò), Cantonese:磨 (mo4) Thai:โม่ (mo), French:moulin, Spanish:molino, Russian:молоть  (molot’)  
...
**moliden** *molybdenum* ← English:molybdenum, French:molybdène, Spanish:molibdeno, Portuguese:molibdénio, Russian:молибден, Mandarin:钼 (mù), Japanese:モリブデン, Korean:몰리브덴, Vietnamese:molypđen, Hindi:मोलिब्डेनम, Bengali:মলিবডেনাম, Malay:molibden, Swahili:molibdeni, Arabic: مولبيدنيوم  
...
**mone** *only (lone, single, individual)* ← deu:English:French:Spanish:Portuguese:Malay:mono-, Russian:моно- (mono-)  
**moral** *morality (ethics)* ← English:Spanish:Portuguese:Malay:moral, French:morale, Russian:мораль (moral’)  
**mos** *moss* ← English:moss, Spanish:Portuguese:musgo, French:mousse, deu:Moos, Russian:мох (mox), Hindi:मॉस (mosa)  
**mosim** *season* ← Arabic: موسم (mawsim), Hindi:मौसम (mausam), Malay:musim, Turkish:mevsim, Swahili:msimu + English:monsoon, French:mousson, Portuguese:monção, Russian:муссон (musson)  
...
**mote** *move (transfer, shift, stir, budge, rouse, motivate, inspire)* ← English:move; motion, French:mouvoir, Spanish:Portuguese:mover + Russian:мотор (motor), Turkish:Malay:motor, Arabic:(mutūr), Mandarin:摩托 (mótuō), Cantonese:摩打 (mo1daa2), Japanese:モーター (mōtā), Korean:모터 (moteo), Vietnamese:mô-tơ, Hindi:मोटर (moṭar), Bengali:মোটর (moṭôr), Swahili:Hausa:mota  
...
**mum** *wax* ← Hindi:मोम (mom), Bengali:মোম (mom), Persian: موم‎ (mum), Turkish:mum + Arabic: مومياء (mumiya), English:mummy, French:momie, Spanish:momia, Portuguese:múmia, Russian:мумия (mumiya), Mandarin:木乃伊 (mùnǎiyī), Malay:mumia  
...
**muringa** *moringa (drumstick tree, horseradish tree)* ← English:Portuguese:moringa, Tamil:முருங்கை (muruṅkai), Malayalam:മുരിങ്ങ (muriṅṅa), Malay:merunggai, Filipino:malunggay, Thai:มะรุม (má-rum)  
**murmeke** *ant* ← Persian: مور‎ (mur), Russian:муравей (muravei), English:myrmeco-, deu:myrmeko-, French:myrméco-  
...
**muxmula** *medlar* ← Russian:мушмула́ (mušmula), Turkish:muşmula, Arabic: مَشْمَلَة‎ (mašmala)  
...
**nadir** *rare (scarce, sparse, uncommon)* ← Arabic: نَادِر‎ (nādir), Persian: نادر (nâder), Hindi:नादिर (nādir), Swahili:nadra, Turkish:nadir, Hausa:nadiri  
...
**nam lexe** *noun* ← Mandarin:名词 (míngcí), Cantonese:名詞 (ming4 ci4), Japanese:名詞 (meishi), Korean:명사 (myeongsa), Hindi:नाम (nām), French:nom, Spanish:nombre, Portuguese:nome, Russian:имя (imya), Arabic:(ism), per:(esm), Swahili:nomino  
**nam** *name* ← deu:English:name, French:nom, Hindi:नाम (nām), Bengali:নাম (nam), Malay:nama, Thai:นาม (naam) + Japanese:名前 (namae)  
**nan** *male* ← Mandarin:男 (nán), Japanese:男 (nan), Korean:남 (nam), Vietnamese:nam + Persian: نر‎ (nar), Hindi:नर (nar), Bengali:নর (nôr), Telugu:నరుడు (naruḍu) + English:man, deu:Mann + Tamil:ஆண் (āṇ)  
...
**naram** *soft* ← Persian: نرم‎ (narm), Hindi:नरम (naram), Bengali:নরম (nôrôm) + Arabic: نَاعِم‎ (nāʿim) + Thai:นุ่ม (num)  
**narde** *backgammon* ← Persian: نرد‎ (nard), Hindi:नर्द (nard), Turkish:nert, Arabic: نَرْد‎ (nard), Russian:нарды (nardy)  
**narke** *drug (narcotic, dope, intoxicating substance)* ← English:narcotic, French:narcotique, Spanish:Portuguese:narcótico, Russian:наркотик (narkotik), Malay:narkotik  
**nas** *people (folk)* ← Arabic:(nās) + English:French:nation, deu:Nazion, Portuguese:nação, Spanish:nación, Polish:nacja, Russian:нация (natsiya)  
**nate** *birth* ← French:naître, Spanish:Portuguese:nato, English:-nate + deu:Nazion, Polish:nacja, Russian:нация (natsiya) + Arabic:(nās)  
**natre** *sodium* ← English:sodium, French:sodium, Spanish:sodio, Portuguese:sódio, Russian:натрий, Mandarin:钠 (nà), Japanese:ナトリウム, Korean:나트륨, Vietnamese:natri, Hindi:सोडियम, Bengali:সোডিয়াম, Malay:natrium, Swahili:natiri  
...
**ne** *right? (isn't it?)* ← Portuguese:né, Hindi:न (na), Mandarin:呢 (ne), Cantonese:呢 (ne1), Japanese:ね (ne), Vietnamese:nhé  
...
**nelu** *four (4)* ← Korean:넷 (net) + Swahili:nne, Zulu:ne, Fulani:nay + Tamil:நான்கு (nāṉku), Malayalam:നാലു (nālu), Telugu:నాలుగు (nālugu), Kannada:ನಾಲ್ಕು (nālku) + fin:neljä, est:neli, Hungarian:négy  
**nen mes den** *date* ← Mandarin:年月日 (niányuèrì), Cantonese:年月日 (ninyutyat), Japanese:年月日 (nengappi), Korean:연월일 (yeonworil)  
...
**neputunium** *neptunium* ← English:neptunium, French:neptunium, Spanish:neptunio, Portuguese:neptúnio, Russian:нептуний, Mandarin:镎 (ná), Japanese:ネプツニウム, Korean:넵투늄, Vietnamese:neptuni, Hindi:नेप्ट्यूनियम, Bengali:নেপচুনিয়াম, Malay:neptunium, Swahili:neptuni, Arabic: نبتونيوم  
**nere** *African locust bean (neto tree)* ← man:nɛrɛ, Wolof:nere, French:néré, Fulani:nɛtɛ  
**nese** *island* ← Greek:νήσος (nēsos), English:Spanish:Malay:-nesia, Portuguese:-nésia, French:-nésie, Russian:-незия (-nezija), Turkish:-nezya, Mandarin:-尼西亚 (níxīyà), Japanese:ネシア (neshia) + may:nusa, mlg:nosy  
**nete** *nexus (web, network)* ← English:net(work), deu:Netz(werk), Japanese:ネット(ワーク) (nettowāku), Korean:네트워크 (neteuwokeu) + French:connecter, Spanish:Portuguese:connectar  
...
**nia** *intention (purpose)* ← Arabic: نِيَّة‎ (niyya), Hindi:नीयत (niyat), Malay:niat, Swahili:nia, Hausa:niyya, Fulani:anniya, Turkish:niyet  
...
**nikel** *nickel* ← English:nickel, French:nickel, Spanish:níquel, Portuguese:níquel, Russian:никель, Mandarin:镍 (niè), Japanese:ニッケル, Korean:니켈, Vietnamese:nikel, Hindi:निकेल, Bengali:নিকেল, Malay:nikel, Swahili:nikeli, Arabic: نيكل  
**nil** *blue* ← Bengali:নীল (nīl), Hindi:नीला (nīlā), Urdu:(nīlā), Tamil:நீலம் (nīlam), Malay:nilam  
...
**nobelium** *nobelium* ← English:nobelium, French:nobélium, Spanish:nobelio, Portuguese:nobélio, Russian:нобелий, Mandarin:锘 (nuò), Japanese:ノーベリウム, Korean:노벨륨, Vietnamese:nobeli, Hindi:नोबेलियम, Bengali:নোবেলিয়াম, Malay:nobelium, Swahili:nobeli, Arabic: نوبليوم  
**noce** *night* ← Spanish:noche, Portuguese:noite, Russian:ночь (nočʹ), Polish:noc  
**node** *knot (node)* ← English:node, Spanish:nudo, Portuguese:nó, French:nœud + Vietnamese:nút  
**nomi** *management (arrangement, -nomy)* ← English:-nomy, deu:French:-nomie, Spanish:Portuguese:-nomia, Russian:-номия (-nomiya), Malay:-nomi  
**norde** *north* ← English:north, Spanish:Portuguese:norte, deu:Nord, French:nord, Russian:норд (nord)  
**norma** *norm (standard)* ← English:Spanish:Portuguese:French:deu:normal, Russian:нормальный (normalʹnyj), Persian:نرمال‎ (normâl)  
...
**note** *note (observe, notice)* ← deu:English:French:note, Spanish:Portuguese:nota, Turkish:not, Japanese:ノート (nōto), Korean:노트 (noteu), Persian:(not)  
**nu** *well (now; used to introduce a statement)* ← Russian:ну (nu) + English:now, deu:na, Mandarin:那 (nà)  
**nude** *naked (bare, nude)* ← English:nude, Spanish:desnudo, Portuguese:French:nu + Russian:нудизм (nudizm), Turkish:nudizm, Japanese:ヌーディズム (nūdizumu), Korean:  
**nuka** *neck (nape)* ← English:neck, Spanish:Portuguese:nuca, French:nuque + Arabic:عُنُق‎ (ʿunuq)  
**nume** *number (quantity; count, enumerate)* ← English:number, French:nombre, Spanish:Portuguese:número, Russian:номер (nomer), deu:Nummer, Japanese:ナンバー (nanbā), Hindi:नंबर (nambar), Bengali:নম্বর (nômbôr), Turkish:numara, Malay:nombor, Swahili:namba(ri)  
...
**ope** *work of art (opus)* ← English:opus, Spanish:Portuguese:obra, Russian:опус (opus)  
...
**orto** *straight* ← English:French:ortho-, Spanish:Portuguese:orto-, Russian:орто- (orto-)  
...
**oskur** *dark (dim)* ← English:obscure, Spanish:oscuro, Portuguese:escuro, French:obscur  
**osmium** *osmium* ← English:osmium, French:osmium, Spanish:osmio, Portuguese:ósmio, Russian:осмий, Japanese:オスミウム, Korean:오스뮴, Vietnamese:osimi, Hindi:अस्मियम, Bengali:অসমিয়াম, Malay:osmium, Swahili:osmi, Arabic: ازميوم  
...
**ote** *opt (prefer, choose)* ← English:opt, French:opter, Spanish:Portuguese:optar + Russian:опция (opciya)  
...
**pa** *father (dad, papa)* ← English:French:papa, Spanish:papá, Portuguese:pai, Russian:папа (papa), Arabic:(bābā), Mandarin:爸 (bà), Cantonese:爸 (baa1), Japanese:パパ (papa), Korean:아빠 (appa), Hindi:बाप (bāp), Bengali:বাবা (baba), Malay:bapa, Hausa:Swahili:Turkish:baba, Fulani:ba; baaba  
**pace** *peace* ← Italian:pace, English:peace, Spanish:Portuguese:paz, French:paix, Russian:пац- (pac-), Malay:Turkish:pas-  
...
**paka** *coercion (force, compulsion)* ← Mandarin:迫 (pò), Cantonese:迫 (baak1), Wu-Chinese:迫 (paq4), Japanese:迫 (haku), Vietnamese:bách  
**pake** *pack (package)* ← English:pack, Russian:пакет (paket), Hindi:पैकेट (pækeṭ), deu:Turkish:paket, French:paquet, Spanish:paquete, Portuguese:pacote, Fulani:pakɛt, Hausa:fakiti  
**palaba** *palaver (debate, fuss)* ← English:palaver, deu:Palaver, French:palabre, krio:plabah, Kongo:palaba  
...
**palma** *palm tree* ← deu:Palme, English:palm, Portuguese:Spanish:palma, Russian:пальма (palma), Turkish:palmiye, Malay:palem, Thai:ปาล์ม (pām)  
**pan** *every (all)* ← English:French:Spanish:Portuguese:pan-, Russian:пан- (pan-) + Mandarin:泛 (fàn), Cantonese:泛 (faan3), Japanese:汎 (han), Korean:범 (beom)  
...
**pankreas** *pancreas* ← English:French:Spanish:Portuguese:pancreas, deu:Malay:Turkish:pankreas  
**pante** *pants (trousers)* ← English:pants, French:pantalon, Spanish:pantalón, Hindi:पैंट (paiṇṭ), Bengali:প্যান্ট (pyanṭ), Telugu:ప్యాంటు (pyāṇṭu), Arabic:بنطلون‎ (banṭalōn), Turkish:pantolon + Japanese:パンツ (pantsu), Korean:팬티 (paenti)  
**papagai** *parrot (parakeet)* ← Arabic: بَبَغَاء‎ (babaḡāʾ), Turkish:papağan, deu:Papagei, Spanish:papagayo, Portuguese:papagaio, Russian:попугай (popugay), jin:八哥 (bāgē)  
...
**para** *beside (para-)* ← English:French:Spanish:Portuguese:para-, Persian: پیرا‎ (pīrā-)  
...
**pari** *fairy (faery)* ← Persian: پری‎ (pari), Hindi:परी (parī), Bengali:পরী (pôri), Malay:Turkish:peri, Hausa:fari, English:fairy; peri, French:péri, deu:Peri, Russian:пери (peri)  
...
**parte** *piece (chip, fragment, shred, morsel, crumb, shard)* ← English:part, Portuguese:Spanish:parte + Persian: پارچه (pârče), Hindi:पारचा (pārcā), Turkish:parça  
**pas** *pass (go across or through, skip)* ← English:past, Spanish:pasado, Portuguese:passado, French: passé + Fulani:pasaas, man:pasaasoo  
**pasporte** *passport* ← English:passport, French:passeport, Spanish:pasaporte, Portuguese:passaporte, Russian:паспорт (pasport), Hindi:पासपोर्ट (pāsporṭ), Bengali:পাসপোর্ট (pasporṭ), Malay:paspor, Swahili:paspoti, Japanese:パスポート pasupōto), Hausa:fasfo  
**pasta** *paste (dough)* ← English:deu:paste, Russian:паста (pasta), Spanish:Portuguese:pasta  
**pata** *route (path, trail, course, itinerary)* ← English:path, deu:Pfad, Russian:путь (putʹ), Hindi:पथ (path), Bengali:পথ (pôth), Telugu:పథము (pathamu),   
...
**pate** *suffer (be hurt, be ill)* ← deu:English:French:patho-, Spanish:Portuguese:Polish:Turkish:Malay:pato-, Russian:пато- (pato-)  
**pau gi** *gun (firearm)* ← Mandarin:炮 (pâo), Cantonese:炮 (paau3), Vietnamese:pháo, Korean:포 (po), mon:буу (buu)  
**pauze** *pause (break, interruption)* ← deu:Pause, English:deu:French:pause, Spanish:Portuguese:pausa, Russian:пауза (pauza)  
**payace** *clown* ← Italian:pagliaccio, French:paillassa, Spanish:payaso, Portuguese:palhaço, Russian:паяц (payac), Turkish:palyaço  
...
**pente** *paint* ← English:paint, Spanish:Portuguese:pintura, French:peinture, nld:pek, Japanese:ペンキ (penki), Hindi:पेंट (penṭa), Fulani:pentur, Hausa:fenti  
...
**perde** *fart (flatulence)* ← Bengali:পাদ (pad), Hindi:पाद (pād), Spanish:pedo, Portuguese:peido, French:pet, Russian:пердение (perdeniye)  
...
**petra** *rock* ← Hindi:पत्थर (patthar), Urdu:(patthar), Italian:pietra, Portuguese:pedra, Spanish:piedra, French:pierre  
**pexe** *fish* ← Spanish:pez, Portuguese:peixe, Italian:pesce + English:fish, deu:Fisch  
...
**pigu** *buttocks (bum, butt, ass)* ← Filipino:pigi, Mandarin:屁股 (pìgu), Cantonese:屁股 (pei3 gu2)  
...
**pilau** *pilaf (pulao)* ← English:French:Spanish:Portuguese:pilaf, deu:Pilaw, Russian:плов (plov), Persian: پلو‎ (polou), Hindi:पुलाव (pulav), Bengali:পোলাও (polao), Tamil:புழுக்கு (puḻukku), Telugu:పులావ్ (pulāv), Arabic: بِيلَاو‎ (bilāw), Turkish:pilav, Japanese:ピラフ (pirafu), Korean:필라프 (pillapeu)  
**pilote** *pilot* ← English:Portuguese:pilot, Spanish:piloto, French:pilote, deu:Pilot, Russian:пило́т (pilót), Japanese:パイロット (pairotto)  
**pin** *needle (pin, splinter, prickle, thorn, stinger, spine, quill)* ← English:pin, Japanese:ピン (pin), Korean:핀 (pin), Hindi:पिन (pin), Fulani:pingu, Wolof:ping  
...
**pinse gi** *pliers (pincers)* ← English:pincers, French:pinces, Turkish:pense, Japanese:ペンチ (penchi)  
**pipa** *lute* ← Mandarin:琵琶 (pípa), Cantonese:琵琶 (pei4 paa4), Japanese: 琵琶 (biba), Korean:비파 (bipa), Vietnamese:tì bà  
**pipe** *pipe* ← English:French:pipe, deu:Pfeife, Spanish:Malay:pipa, Persian: پیپ‎ (pip), Hindi:पाइप (pāip), Bengali:পাইপ (paip), Japanese:パイプ (paipu), Vietnamese:píp, Turkish:pipo, Arabic: بِيبَة‎‎ (bība)  
...
**pirate** *hijack* ← English:French:pirate, Spanish:Portuguese:pirata, deu:Pirat, Russian:пират (pirat), Japanese:パイレーシ  
...
**piza** *pizza* ← English:deu:French:Spanish:Turkish:Vietnamese:pizza, Russian:пицца (pitsa), Persian: پیتزا‎ (pitzâ), Hindi:पिज़ा (pizā), Bengali:পিৎজা (pitja), Tamil:பீத்சா (pītcā), Malay:piza, Mandarin:比萨 (bǐsà), Japanese:ピザ (piza), Korean:피자 (pija), Arabic: بِيتْزَا‎ (bītzā)  
...
**planeta** *planet* ← English:Turkish:Malay:planet, Spanish:Portuguese:planeta, French:planète, Russian:планета (planeta)  
**plaste** *plastic* ← English:plastic, Spanish:Portuguese:plástico, Russian:пластик (plastik), Turkish:Malay:plastik, Swahili:plastiki, Hausa:filastik, Arabic:بلاستيك (blastīk), Hindi:प्लास्टिक (plāsṭik), Japanese:プラスチック (purasuchikku), Korean:플라스틱 (peullaseutik)  
**plate** *plane (plate)* ← English:plate, Spanish:Portuguese:placa, deu:Platte, Russian:пластина (plastina)  
**platin** *platinum* ← English:platinum, French:platine, Spanish:platino, Portuguese:platina, Russian:платина, Mandarin:铂 (bó), Vietnamese:platin, Hindi:प्लाटिनम, Bengali:প্লাটিনাম, Malay:platina, Swahili:platini, Arabic: بلاتين  
**plazma** *plasma (ionized gas)* ← English:plasma, Spanish:plasma, Russian:плазма (plazma), Arabic:بلازما (balazima), Hindi:प्लाज़्मा (plaazma), Japanese:プラズマ (purazuma), Malay:plasma  
**ple** *fold (layer)* ← English:ply, French:pli, Spanish:plegar + Portuguese:aplicação  
**plumbe** *lead* ← French:plomb, Spanish:plomo, Portuguese:chumbo, Swahili:plumbi  
**plutonium** *plutonium* ← English:plutonium, French:plutonium, Spanish:plutonio, Portuguese:plutónio, Russian:плутоний, Mandarin:钚 (bù), Japanese:プルトニウム, Korean:플루토늄, Vietnamese:plutoni, Hindi:प्लूटोनियम, Bengali:প্লুটোনিয়াম, Malay:plutonium, Swahili:plutoni, Arabic: بلوتونيوم  
**poke** *poker* ← English:French:Turkish:poker, Spanish:Portuguese:póquer, Russian:покер (poker), Arabic:بُوكَر‎ (būkar), Hindi:पोकर (pokar), Mandarin:扑克 (pūkè), Japanese:ポーカー (pōkā), Korean:포커 (pokeo)  
**pole** *city (town)* ← English:Spanish:-polis, deu:French:Portuguese:-pole, Russian:-поль (-pol'), Malay:Turkish:-pol  
**poli** *many (much, more than one)* ← Greek:πολλοί (polloí), English:French:deu:poly-, Spanish:Portuguese:poli-, Russian:поли- (poli-) + Tamil:பல (pala)  
**polis** *police* ← English:French:police, Portuguese:polícia, Spanish:policía, Russian:полиция (policija), Fulani:Turkish:Malay:polis, Swahili:polisi, Arabic:بُولِيس‎ (būlīs), Hindi:पोलिस (polis), Bengali:পুলিশ (puliś)  
...
**pompe** *pump* ← English:pump, Spanish:Portuguese:bomba, French:Fulani:pompe, deu:Pumpe, Russian:помпа (pompa), Persian: پمپ‎ (pomp), Hindi:पंप (pamp), Bengali:পাম্প (pamp), Telugu:పంపు (pampu), Turkish:Malay:pompa, Hausa:famfo, Mandarin:泵 (bèng), Cantonese:泵 (bam1), Japanese:ポンプ (ponpu), Korean:펌프 (peompeu), Vietnamese:bơm  
...
**porto** *port (station)* ← English:port, French:porte, Spanish:puerto, Portuguese:porto, Russian:порт (port), Hindi:पोर्ट (porṭ), Urdu:(porṭ), Bengali:পোর্ট (porṭ), Thai:พอร์ต (phot)  
**pos** *consequence (back, follow-up)* ← English:French:post-, Spanish:pos, Portuguese:pós-, Russian:после- (posle-) + Persian: پس (pas)  
**poste** *mail* ← English:post, Portuguese:postagem, French:poste, Russian:почта (pochta), Turkish:posta, Arabic:بوسطة‎ (busṭa), Swahili:posta, Malay:pos, Persian:پست‎ (post)  
**pote** *pot (vase, bin, jar)* ← English:French:pot, Spanish:Portuguese:pote, Malay:poci, Japanese:ポット (potto), Korean:포트 (poteu), Fulani:pooti; fotiire  
...
**prazedimium** *praseodymium* ← English:praseodymium, French:praséodyme, Spanish:praseodimio, Portuguese:praseodímio, Russian:празеодим, Japanese:プラセオジム, Korean:프라세오디뮴, Vietnamese:prazeođim, Hindi:प्रासियोडाइमियम, Bengali:প্র্যাসেওডিমিয়াম, Malay:praseodinium, Swahili:praseodimi, Arabic: براسوديميوم  
**pre** *before (previous, fore, past)* ← English:French:Spanish:Portuguese:pre-, Hindi:प्र- (pra-), Bengali:প্র- (prô-), Malay:pra-  
**prese** *press (pressure)* ← French:pression, Spanish:presión, Portuguese:pressão, Russian:пресс (press), Japanese:プレス (puresu)  
**presidente** *president* ← English:president, deu:Präsident, French:président, Spanish:Portuguese:presidente, Russian:президент (prezident), Persian: پرزیدنت‎ (perezident), Malay:presiden  
**prive** *own (personal, private)* ← English:private, deu:privat, French:privé, Spanish:Portuguese:privado, Russian:прива́тный (privatnyi), Malay:pribadi  
**pro** *toward (forward)* ← deu:English:French:Spanish:Portuguese:pro-, Hindi:प्र- (pra-), Bengali:প্র- (prô-), Malay:pro-; pra-  
...
**profesor** *professor* ← English:deu:Portuguese:professor, French:professeur, Spanish:profesor, Russian:профессор (professor), Arabic: بروفيسور‎ (brofesōr), Turkish:profesör, Swahili:profesa, Hausa:farfesa, Persian:پروفسور‎ (profesor), Hindi:प्रोफ़ेसर (profesar)  
**prometium** *promethium* ← English:promethium, French:prométhium, Spanish:prometio, Portuguese:promécio, Russian:прометий, Mandarin:钷 (pǒ), Japanese:プロメチウム, Korean:프로메튬, Vietnamese:prometi, Hindi:प्रोमेथियम, Bengali:প্রমিথিয়াম, Malay:prometium, Swahili:promethi, Arabic: بروميثيوم  
**protacinium** *protactinium* ← English:protactinium, French:protactinium, Spanish:proactinio, Portuguese:protacnídio, Russian:протактиний, Mandarin:镤 (pú), Japanese:プロトアクチニウム, Korean:프로트악티늄, Vietnamese:protactini, Hindi:प्रोटैक्टीनियम, Bengali:প্রোটেক্টিনিয়াম, Malay:protaktinium, Swahili:protaktini, Arabic: بروتكتنيوم  
**prote** *proto-* ← deu:English:French:Spanish:Portuguese:Malay:Turkish:proto-, Russian:прото- (proto-)  
**proxe** *close (near)* ← English:proximal, French:proche, Spanish:Portuguese:próximo  
**puding** *pudding* ← English:French:deu:pudding, Spanish:pudín, Portuguese:pudim, Russian:пудинг (puding), Turkish:Malay:puding, Swahili:pudini, Arabic:بودنغ (budingh), Mandarin:布丁 (bùdīng), Japanese:プディング (pudingu), Korean:푸딩 (puding)  
**puje** *worship (adore; reveration, veneration)* ← Hindi:पूजा (pūjā), Urdu: پوجا‎ (pūjā), Tamil:பூசை (pūcai), Telugu:పూజ (pūja), Malay:puja, Thai:บูชา (bucha)  
**pul** *full (complete, saturated)* ← Hindi:पूर्ण (pūrn), Bengali:পূর্ণ (pūrṇa), Punjabi:ਪੂਰਾ (pūrā), Persian:(por), Spanish:pleno, French:plein, English:full, Russian:полный (polnyj), Polish:pełny  
**pulmon** *lung* ← Spanish:pulmón, French:poumon, Portuguese:pulmão, English:pulmonic  
**pulse** *push* ← English:push; pulse, French:pousser + Spanish:Portuguese:impulso, Russian:импульс (impul's)  
**puma** *cougar (puma, mountain lion)* ← English:Spanish:French:Portuguese:Swahili:Malay:Turkish:puma, Russian:пума (puma), Japanese:ピューマ (pyūma), Hindi:पूमा (pooma), pan:ਪੂਮਾ (pūmā), Marathi:प्युमा (pyumā)  
**punte** *point (period, full stop)* ← English:point, deu:Punkt, Spanish:punto, Russian:пункт (punkt)  
...
**rade** *ray* ← English:French:radiation, Spanish:radiación, Portuguese:radiação, Malay:radiasi, Russian:радио (radio), Turkish:radyo, Swahili:redio, Hindi:रेडियो (reḍiyo), Bengali:রেডিও (reḍio), Japanese:ラジオ (rajio), Korean:라디오 (radio)  
**radio** *radio* ← deu:English:French:Spanish:Portuguese:radio, Russian:радио (radio), Fulani:Turkish:radyo, Swahili:redio, Hausa:rediyo, Hindi:रेडियो (reḍiyo), Bengali:রেডিও (reḍio), Japanese:ラジオ (rajio), Korean:라디오 (radio)  
**radium** *radium* ← English:radium, French:radium, Spanish:radio, Portuguese:rádio, Russian:радий, Mandarin:镭 (léi), Japanese:ラジウム, Korean:라듐, Vietnamese:rađi, Hindi:रेडियम, Bengali:রেডিয়াম, Malay:radium, Swahili:radi, Arabic: راديوم  
...
**rande** *plane (tool for making a smooth surface)* ← Persian: رنده‎ (rande), Hindi:रंदा, (randā), Turkish:rende, Swahili:randa  
...
**rase** *race (breed)* ← English:French:race, Spanish:raza, Portuguese:raça, Russian:раса (rasa), Malay:ras  
**rate** *make sense (reason)* ← lat:ratio, English:rational, French:rationnel, Spanish:Portuguese:racional + deu:Rat, Russian:рада (rada), Polish:rada  
...
**reseta** *instructions (recipe)* ← Italian:ricetta, Russian:рецепт (retsept), deu:Rezept, Spanish:receta, Portuguese:receita, French:recette, Malay:resep, Turkish:reçete  
**reside** *receipt (acknowledgement, acquittance)* ← Persian: رسید‎ (resid), Hindi:रसीद (rasīd), Bengali:রসিদ (rôśid), Tamil:ரசீது (racītu), Telugu:రసీదు (rasīdu) + English:receipt, Japanese:レシート (reshīto), Malay:resit, Swahili:resiti, Yoruba:rìsíìtì  
...
**rime** *rhyme (verse)* ← Spanish:Portuguese:rima, French:rime, English:rhyme, Polish:rym, deu:Reim  
...
**rite** *way (manner, means, method, mode, procedure, rite)* ← Hindi:रीति (rīti), Bengali:রীতি (rīti) + English:French:rite, Spanish:Portuguese:rito, Russian:ритуал (ritual), Malay:ritus  
...
**rivo** *river (stream)* ← Spanish:Portuguese:rio, English:river, French:rivière  
...
**rode** *rose* ← Greek:ῥόδον (rhódon), French:English:rose, Spanish:Portuguese:rosa, Russian:роза (roza), Malay:ros, Filipino:rosas + Arabic: وَرْد‎ (ward), Swahili:waridi  
...
**rupe** *appear (look like; appearance, looks, figure, representation)* ← Hindi:रूप (rūp), Urdu: روپ‎ (rūp), Bengali:রূপ (rup), Tamil:ரூபம் (rūpam), Malay: rupa, Thai: รูป (rūp), Khmer:រូប (rūp)  
**rute** *route (path, trail, course, itinerary)* ← English:French:route, Spanish:ruta, Portuguese:rota, deu:Route, Japanese:ルート (rūto), Russian:маршрут (maršrut); рутина (rutina) + Persian:روتین‎ (rutin)  
...
**sabun** *soap* ← French:savon, Spanish:jabón, Portuguese:sabão, Arabic: صَابُون‎ (ṣābūn), Persian: صابون‎ (sâbun), Hindi:साबुन (sābun), Bengali:সাবান (śaban), Telugu:సబ్బు (sabbu), Malay:Turkish:sabun, Swahili:sabuni, Fulani:saabunde, Hausa:sabulu, Japanese:シャボン (shabon), Vietnamese:xà bông  
...
**safar** *travel (voyage, trip)* ← Arabic:(safar), Hindi:सफ़र (safar), Turkish:sefer, Swahili:safari, Hausa:safara, English:French:Spanish:Portuguese:deu:Malay:safari  
...
**sahi** *right (correct, accurate)* ← Arabic: صَحِيح‎ (ṣaḥīḥ), Persian: صحیح‎ (sahih), Hindi:सही (sahī), Malay:sah, Hausa:Swahili:sahihi  
**saide** *hunting (fishing)* ← Arabic:(ṣayd), Turkish:seyd, Urdu:صید‎ (said), Persian:صید‎ (seyd), heb:ציד‎ (tsayid)  
**sake** *bag (sack)* ← deu:English:sack, French:sac, Spanish:Portuguese:saco, Malay:Kongo:saku, Fulani:saakuuru  
**sal** *hello (hi)* ← Arabic:Persian: سلام‎ (salâm), Hindi:सलाम (salām), Bengali: সালাম (salam), Malay:selamat, Swahili:salamu, Fulani:salaam, Hausa:salam, Turkish:selam + English:salute, French:salut, Spanish:salude, Portuguese:saúde + Korean:잘 (jal)  
...
**salade** *salad* ← French:salade, Malay:salad, deu:Salat, Russian:салат (salat), Turkish:salata, Persian:Urdu:(salād), Hindi:सलाद (salād), Cantonese:沙律 (saa1 leot62),  Mandarin:沙拉 (shālā), Portuguese:salada, Spanish:ensalado, Korean:샐러드 (saelleodeu), Japanese:サラダ (sarada), Thai:สลัด (salat), Fulani:salati  
...
**sam** *same (equal, alike, match)* ← English:same, French:semblable, Russian:самый (samyy), Persian:هم‎ (ham), Hindi:सम (sam), Malay:sama + Arabic: سَوَاء (sawāʾ), Swahili:sawa  
**sama** *sky (heaven)* ← Arabic: سَمَاء‎ (samāʾ), Swahili:samawati, Amharic:ሰማይ (sämay), Hausa:sama, Yoruba:sanma, Turkish:sema, Oromo:samii + Fulani:asamaan, Hindi:आसमान (āsmān), Bengali:আসমান (aśman)  
**samarium** *samarium* ← English:samarium, French:samarium, Spanish:samario, Portuguese:samário, Russian:самарий, Mandarin:钐 (shān), Japanese:サマリウム, Korean:사마륨, Vietnamese:samari, Hindi:सैमरियम, Bengali:সামারিয়াম, Malay:samarium, Swahili:Hausa:samari, Arabic: ساماريوم  
**sanduice** *sandwich* ← English:French:Spanish:sandwich, Portuguese:sanduíche, Russian:сандвич (sandvič), Arabic:(sandawitš), Mandarin: (sānwénzhì), Japanese:サンドイッチ (sandoichi), Hindi:सैंडविच (saiṇḍvic), Malay:sandwic, Hausa:sanwici  
**sanduku** *box (chest)* ← Russian:сундук (sunduk), Arabic: صُنْدُوق‎ (ṣundūq), Persian: صندوق‎ (sanduq), Swahili:sanduku, Hausa:sàndūƙī̀, Oromo:saanduqa, Turkish:sandık swa:Lingala:sanduku, tur:sandık  
**sanga** *order (group with common interests, -hood)* ← Hindi:संघ (saṅgh), Bengali:সঙ্ঘ (śôṅgh), Tamil:சங்கம் (saṅgam), Malay:sangha, Mandarin:僧伽 (sēngjiā), Korean:승가 (seungga), Vietnamese:tăng già, Thai:สงฆ์ (sǒng), Khmer:សង្ឃ (sɑng), Burmese:သံဃာ (samgha)  
...
**sari** *sari* ← English:deu:French:Spanish:Portuguese:Malay:sari, Russian:сари (sari), Hindi:साड़ी (sāṛī), Bengali:শাড়ি (śaṛi), Mandarin:莎丽 (shālì), Japanese:サリー (sarī), Korean:사리 (sari), Arabic: سَارِي‎ (sārī), Persian: ساری‎ (sâri)  
**sau** *sibling (brother or sister)* ← Hindi:सहोदर (sahodar), Bengali:সহোদর (śôhodôr), Tamil:சகோதரன் (sahōdaraṉ), Malay:saudara  
...
**saye** *shadow* ← Persian: سایه‎ (sāye), Hindi:साया (sāyā); छाया (chāyā), Bengali:ছায়া (chaya), Turkish:saye, Thai:ฉายา (chāyā), Burmese:ဆာယာ (sʰaya)  
**seku** *stone (piece of rock)* ← Mandarin: 石 (shí), Cantonese:石 (sek3), Japanese:石 (seki), Korean:석 (seok)  
...
**sel** *advice (counsel, recommendation)* ← Arabic: صَلَاح‎ (ṣalāḥ), Hindi:सलाह (salāh), Telugu:సలహా (salahā), Turkish:salık + English:counsel, French:conseil, Spanish:consejo, Portuguese:conselho  
**selenium** *selenium* ← English:selenium, French:sélénium, Spanish:selenio, Portuguese:selénio, Russian:селен, Mandarin:硒 (xī), Japanese:セレン, Korean:셀렌, Vietnamese:selen, Hindi:सेलेनियम, Bengali:সেলেনিয়াম, Malay:selenium, Swahili:seleni, Arabic: سيلينيوم  
...
**semente** *cement* ← English:cement, Malay:semen, Spanish:cemento, Swahili:sementi, Hausa:siminti, Fulani:siment, Turkish:çimento, Vietnamese:xi măng, Hindi:सीमेंट (siment), Russian:цемент (tsement), Arabic:(ʾasmant), Korean:시멘트 (simenteu)  
...
**si** *if (suppose, assume)* ← French:Spanish:si, Portuguese:se, Turkish:ise, Mandarin:使 (shǐ); 要是 (yàoshǐ), Cantonese:使 (si2); 要是 (jiu3si6), Fulani:si; se  
...
**sifa** *attribute (charasteristic, quality, feature, description, property)* ← Arabic:صفة (ṣifa), Persian:صفت (sefat), Hindi:सिफ़त (sifat), Fulani:siifa, Swahili:Hausa:sifa, Turkish:sıfat, Malay:sifat  
**sigare** *cigar* ← English:French:cigarette, Spanish:cigarillo, Portuguese:cigarro, Russian:сигарета (sigarteta), Arabic:(sījāra), Mandarin:雪茄 (xǔejiā), Wu-Chinese:雪茄 (xi'gá), Hindi:सिगरेट (sigreṭ), Bengali:সিগারেট (śigareṭ), Swahili:Turkish:sigara, Hausa:sigari, Fulani:sigaari, Amharic:ሲጃራ (siǧara)  
...
**silike** *silicon* ← English:silicon, French:silicium, Spanish:silicio, Portuguese:silício, Vietnamese:silic, Hindi:सिलिकॉन, Bengali:সিলিকন, Malay:silikon, Swahili:silikoni, Hausa:siliki, Arabic: سيلكون (silikōn)  
...
**sine** *chest (breast)* ← Persian: سینه‎ (sine) Turkish:sine, Hindi:सीना (sīnā), Bengali:সিনা (sinā), Spanish:seno, French:sein, Latin:sinus  
**sine** *sign (signal)* ← English:sign, Spanish:señal, Portuguese:sinal, French:signe  
...
**sir** *secret (hidden)* ← Arabic: سِرّ (sirr), Hindi:सेर (ser), Malay:sir, Swahili:siri, Hausa:asiri, Fulani:sirri, Yoruba:àṣírí, Turkish:sır, Persian:(serr)  
**sirke** *circle* ← English:circle, French:cercle, Spanish:Portuguese:círculo + deu:Zirkus, Russian:цирк (cirk), Persian: سیرک‎ (sirk), Hindi:सर्कस (sarkas), Bengali:সার্কাস (sarkas), Arabic: سِيرْك‎ (sirk), Japanese:サーカス (sākasu), Korean:서커스 (seokeoseu), Vietnamese:xiếc, Malay:sirkus, Turkish:sirk  
**siro** *zero (none)* ← Arabic: صِفْر‎ (ṣifr), Swahili:sifuri, Hausa:sifili, Hindi:सिफ़र (sifar), Malay:sifar, English:Portuguese:zero, French:zéro, Spanish:cero, Russian:зеро (zero), Japanese:ゼロ (zero), Korean:제로 (jero), Vietnamese:zêrô  
**sis** *hiss (sizzle)* ← English:hiss, deu:zischen, Spanish:sisear, Mandarin:咝 (sī), Cantonese:噝 (si1)  
**sis** *sister* ← English:sister, deu:Schwester, Russian:сестра (sestra)  
...
**site** *quote (cite)* ← English:cite, Spanish:Portuguese:citar, French:citer, deu:zitieren, Russian:цитировать (citirovat’)  
**sivil** *civilized (civil)* ← English:civil, Portuguese:civil, Hindi:सिविल (sivil), Malay:sipil  
**skandium** *scandium* ← English:scandium, French:scandium, Spanish:escandio, Portuguese:escândio, Russian:скандий, Mandarin:钪 (kàng), Japanese:スカンジウム, Korean:스칸듐, Vietnamese:scandi, Hindi:स्काण्डियम, Bengali:স্ক্যান্ডিয়াম, Malay:skandium, Swahili:skandi, Arabic: سكانديوم  
...
**skuter** *scooter* ← English:French:Spanish:scooter, Russian:скутер (skuter), Mandarin:速克达 (sùkèdá), Japanese:スクーター (sukūtā), Korean:스쿠터 (seukuteo), Hindi:स्कूटर (skūṭar), Bengali:স্কুটার (śkuṭar), Malay:skuter  
**sofa** *sofa (couch)* ← English:French:sofa, Spanish:Portuguese:sofá, Russian:софа (sofa), Mandarin:沙发 (shāfā), Cantonese:梳化 (so1faa32), Japanese:ソファ (sofa), Korean:소파 (sopa), Hindi:सोफ़ा (sofā)  
...
**son** *son* ← English:son, deu:Sohn, Russian:сын (syn), Sanskrit:सूनु (sūnu)  
**sona papi** *opium poppy* ← English:poppy, Spanish:amapola, Portuguese:papoula, Swahili:mpopi, Hindi:पॉपी (pŏpī), Bengali:পপি (papi), Japanese:ポピー (popī)  
**sona** *sleep* ← French:sommeil, Portuguese:sono, Russian:сон (son), Hindi:सोना (sonā), Bengali:শোয়া (śoya) + Arabic: سِنَة (sina)  
**songi** *pine tree* ← Mandarin:松 (sōng), Wu-Chinese:(son), Thai:สน (sǒn), Korean:솔 (sol), Vietnamese:thông, + Russian:сосна (sosna)  
...
**sorbe** *sip (slurp, suck up)* ← Spanish:sorber, Portuguese:sorver, Russian:сёрбать (syorbatʹ), English:absorb, French:absorber  
**sos** *sauce* ← English:French:sauce, deu:Soße, Russian:соус (sous), Persian: سس‎ (sos), Hindi:सॉस (sos), Bengali:সস (śôś), Japanese:ソース (sōsu), Korean:소스 (soseu), Vietnamese:xốt, Malay:saus, Turkish:sos  
**sosia** *society (association)* ← Russian:социум (socium), English:society, French:société, Spanish:sociedad, Portuguese:sociedade, deu:sozial, Malay:sosial  
...
**stan** *tract (land, ground, region)* ← Hindi:स्थान (sthān), Russian:стан (stan), Persian:ـستان (-estān)  
**state** *stand* ← English:stand; static, deu:stehen; statisch, French:statique, Spanish:Portuguese:estático, Russian:стоять (stoyat'); статический (statičeskiy), Malay:statis, Turkish:istasyon, Hindi:स्टेशन (sṭeśan), Bengali:স্টেশন (śṭeśôn)  
...
**su** *possessive postposition (’s)* ← English:’s, deu:ned:-s, afr:se + French:son;sa, Spanish:su, Portuguese:seu  
**sual** *question (query, inquiry)* ← Arabic: سؤال (su'āl), Persian: سؤال‎ (so'âl), Hindi:सवाल (savāl), Bengali:সওয়াল (śôwal), Malay:soal, Swahili:swali, Turkish:sual + Khmer:សួរ (suə)  
**suan** *sour* ← Mandarin:酸 (suān), Cantonese:酸 (syun1), Wu-Chinese:酸 (soe1), Japanese:酸 (san), Korean:산 (san), Vietnamese:toan  
**suba** *morning (dawn)* ← Arabic:(ṣabāḥ), Turkish:sabah, Persian:(sobh), Urdu:(subah), Hindi:सुबह (subah), Swahili:asubuhi, Hausa:asuba, Fulani:subaka  
...
**sukar** *sugar* ← English:sugar, French:sucre, Spanish:azúcar, Portuguese:açúcar, Arabic: سُكَّر (sukkar), Hindi:शक्कर (śakkar), Bengali:শর্করা (śôrkôra), Malay:sakar, Hausa:Swahili:sukari, Fulani:sukar, Turkish:şeker, Tamil:சக்கரை (cakkarai)  
...
**suna** *custom (tradition, practice, convention)* ← Arabic: سُنَّة (sunna), Hindi:सुन्नत (sunnat), Bengali:সুন্নাহ (śunnah), Swahili:suna + English:Malay:sunnah, French:Spanish:sunna, Portuguese:suna, Russian:сунна, Turkish:sünnet  
...
**susan** *lily* ← Arabic: سَوْسَن‎ (sawsan), Spanish:azucena + English:Susan, Portuguese:Susana, French:Suzanne, Polish:Zuzana, Russian:Сусанна (Susanna)  
**sute** *skill (art, craft)* ← Mandarin:术 (shù), Cantonese:術 (seot6), Japanese:術 (jutsu), Korean:술 (sul)  
**sutur** *suture (seam)* ← French:English:suture, Portuguese:Spanish:sutura  
**suxi** *sushi* ← Japanese:寿司 (sushi), Mandarin:寿司 (shòusī), Cantonese:壽司 (sau6si1), Korean:스시 (seusi), deu:English:French:Spanish:Portuguese:sushi, Russian:суши (sushi), Persian: سوشی‎ (suši), Hindi:सुशी (suśī), Bengali:সুশি (śuśi), Turkish:suşi, Arabic: سُوشِي‎ (sūšī)  
**ta** *-ness, (-ity)* ← Russian:-та (-ta), Hindi:-ता (-tā) + French:-ité, Spanish:-idad, Portuguese:-idade, Italian:-ità, Malay:-itas  
**tabake** *tobacco* ← deu:Tabak, Russian:табак (tabak), French:tabac, Spanish:Portuguese:tabaco, Japanese:タバコ (tabako), English:tobacco, Arabic:تَبْغ‎ (tabḡ), Persian:تنباکو‎ (tanbâku), Turkish:tömbeki, Hindi:तंबाकू (tambākū), Bengali:তামাকু (tāmāku), Malay:tembakau, Swahili:mtubaku, Hausa:taba  
**tabe** *disposition (characteristic)* ← Arabic:طبيعة (ṭabīʿa), Persian:طبیعت‎ (tabi'at), Hindi:तबीयत (tabīyat), Bengali:তবিয়ত (tôbiyôt), Swahili:tabia, Fulani:dabia, Hausa:tsabi'a, Turkish:tabiat  
**table** *slab (slate, tablet, board)* ← English:table, French:tableau, Spanish:tabla, Russian:табличка (tablichka), Malay:tabel, Turkish:tablo, Fulani:Wolof:taabal  
...
**tala** *lock (fastener)* ← Hindi:ताला (tālā), Bengali:তালা (tala), Telugu:తాళము (tāḷamu)  
...
**tanke** *tank (reservoir)* ← English:tank, deu:Tank, Spanish:tanque, Hindi:टंकी (ṭaṅkī), Malay:tangki, Swahili:tangi, Japanese:タンク (tanku), Korean:탱크 (taengkeu), Vietnamese:tăng  
**tantalium** *tantalum* ← English:tantalum, French:tantale, Spanish:tántalo, Portuguese:tântalo, Russian:тантал, Mandarin:钽 (tǎn), Japanese:タンタル, Korean:탄탈, Vietnamese:tantali, Hindi:टाण्टलम, Bengali:ট্যান্টালাম, Malay:tantalum, Swahili:tantali, Arabic: تنتالم  
**tanur** *oven (furnace)* ← Persian:heb:tanur, Arabic:(tannūr), English:tandoor, athanor, Turkish:tandır, Hindi:तनूर (tanūr), Urdu:(tanūr), Punjabi:ਤੰਦੂਰ (tandūr), Swahili:tanuri, Hausa:tanda  
**tape** *stopper (cap, peg, plug, spigot, tap)* ← English:tap, deu:Zapfen, Spanish:Turkish:tapa, Portuguese:tampa, Greek:τάπα (tapa), bul:тапа (tapa)  
...
**tasa** *bowl (dish)* ← Arabic: طَاس (ṭās), Hausa:taasaa, Swahili:tasa, Fulani:taasal, Turkish:tas, French:tasse, Spanish:taza, Russian:таз, Hindi:तश्तरी (tashtarī)  
**tatu** *tattoo* ← sam:tah:tatau, haw:kākau, Malay:Filipino:tato, English:tattoo, French:tatouage, Spanish:tatuaje, Portuguese:tatuagem, Russian:тату (tatu)  
**tava** *frying pan (skillet)* ← Persian: تاوه‎ (tâve), Hindi:तवा (tavā), Arabic: طاوة‎ (ṭāwa), Turkish:scr:tava  
**taxe** *order (arrangement)* ← English:deu:Spanish:taxo-, French:Portuguese:taxi-, Russian:-таксис (-taksis), Persian: تاکتیک‎ (tâktik), Malay:taktik  
**taxi** *fee (fare)* ← English:tax, Portuguese:taxa, Spanish:tasa, Hindi:टैक्स (ṭEks) + French:taxi, Russian:такси (taksi), Japanese:タクシー (takushī), Korean:택시 (taeksi), Vietnamese:tắc xi, hin:टैक्सी (ṭaiksī), Bengali:ট্যাক্সি (ṭyaksi), Turkish:Malay:taksi, Swahili:teksi  
**taza** *fresh* ← Persian: تازه (tâze), Hindi:ताज़ा (tāzā), Bengali:তাজা (taja), Turkish:taze, Arabic: طَازَج (ṭāzaj)  
**tef** *lovegrass (teff)* ← Amharic:ጤፍ (ṭēff), Oromo:xaafii, Swahili:mtefi, English:teff, Spanish:Malay:tef, Portuguese:tefe, Russian:теф (tef), Mandarin:苔麸 (tái fū), Japanese:テフ (tefu), Korean:테프 (teipeu)  
**tege** *brick* ← lat:tegula, Italian:tegola, English:tile, deu:Ziegel, French:tuile, Spanish:teja, Portuguese:telha, Hindi:टाइल (ṭāila), Bengali:টালি (ṭali), Japanese:タイル (tairu), Korean:타일 (tail), Arabic: طَجِين‎  (ṭajīn), Turkish:tuğla; tajine  
...
**tehnetium** *technetium* ← English:technetium, French:technétium, Spanish:tecnetio, Portuguese:tecnécio, Russian:технеций, Mandarin:锝 (dé), Japanese:テクネチウム, Korean:테크네튬, Vietnamese:tecnexi, Hindi:टेक्निशियम, Bengali:টেকনিসিয়াম, Malay:teknetium, Swahili:tekineti, Arabic: تكنيتيوم  
**tela** *cloth (fabric, textile)* ← Spanish:Portuguese:Filipino:tela, French:toile + English:towel, Hindi:तौलिया (tauliyā), Tamil:துவாலை (tuvālai), Swahili:taulo, Hausa:tawul, Japanese:タオル (taoru), Malay:tuala  
**tele** *far* ← English:Spanish:Portuguese:Malay:tele-, French:télé-, Russian:теле- (tele-)  
**telurium** *tellurium* ← English:tellurium, French:tellure, Spanish:telurio, Portuguese:telúrio, Russian:теллур, Mandarin:碲 (dì), Japanese:テルル, Korean:텔루르, Vietnamese:telu, Hindi:टेलुरियम, Bengali:টেলুরিয়াম, Malay:telurium, Swahili:teluri, Arabic: تيلوريوم  
...
**tenesium** *tennessine* ← English:French:Portuguese:Malay:tennessine, Spanish:teneso, Russian:теннессин, Japanese:テネシン, Korean:우눈셉튬  
...
**teori** *theory* ← English:theory, Spanish:teoría, Portuguese:teoria, French:téorie, Russian:теория (teoriya), Persian:تئوری‎ (teori), Malay:teori  
**tera** *tera-* ← English:French:Spanish:Portuguese:Malay:Turkish:tera-, Russian:тера- (tera-), Japanese:テラ (tera), Korean:테라- (tera-)  
**terbium** *terbium* ← English:terbium, French:terbium, Spanish:terbio, Portuguese:térbio, Russian:тербий, Mandarin:铽 (tè), Japanese:テルビウム, Korean:테르븀, 2터븀, Vietnamese:tecbi, Hindi:टर्बियम, Bengali:টার্বিয়াম, Malay:terbium, Swahili:taribi, Arabic: تربيوم  
...
**tere** *fear (fright, terror)* ← English:Spanish:Portuguese:terror, French:terreur + Russian:терроризм (terrorizm), Japanese:テロリズム (terorizumu), Korean:테러리즘 (tereorijeum), Malay:terorisme  
...
**tole** *tolerate (bear, endure, stand, put up with)* ← English:tolerate, Spanish:Portuguese:tolerar, French:tolérer, deu:tolerieren, sve:tåla, dan:nor:tåle  
...
**ton** *tone (note, pitch, shade)* ← English:tone, deu:Ton, French:ton, Spanish:tono, Portuguese:tom, Russian:тон (ton), Hindi:तान (tān), Swahili:kitone  
...
**tope** *region (tract, land, ground)* ← English:French:Spanish:Portuguese:Turkish:Malayalam:topo-, Russian:топо- (topo-)  
**tore** *tower* ← English:tower, French:tour, Spanish:Portuguese:torre, deu:Turm, Hindi:टावर (ṭāvar) + Japanese:塔 (tō), Mandarin:塔 (tǎ)  
...
**torso** *trunk (torso)* ← French:torse, Russian:торс (tors), deu:English:Spanish:Malay:torso  
**tortuga** *turtle (tortoise)* ← English:tortoise, Spanish:tortuga, Portuguese:tartaruga, French:tortue  
**toxe** *poison (venom)* ← English:toxic, French:toxique, Spanish:Portuguese:tóxico, Russian:токсичний (toksicniy), Malay:toksik + Mandarin:毒 (dú), Cantonese:毒 (duk6), Wu-Chinese:毒 (do’), Japanese:毒 (doku/toku), Korean:독 (dok), Vietnamese:độc  
**tra** *through* ← Italian:tra, English:through, Spanish:tras, Portuguese:(a)trás, French:deu:Malay:trans-, Russian:транс- (trans-)  
**tragike** *sad (tragic)* ← English:tragic, French:tragique, Spanish:Portuguese:trágico, Russian:трагический (tragičeskij)  
**trate** *drag (haul, tow, trail)* ← Spanish:traer + English:tractor, French:tracteur, Portuguese:trator, Russian:трактор (traktor), Arabic: تَرَاكْتُور‎ (tarāktūr), Japanese:トラクター (torakutā), Korean:트랙타 (teuraekta), Hindi:ट्रैक्टर (ṭraikṭar), Bengali:ট্র্যাক্টর (ṭrækṭôr), Malay:traktor, Swahili:trekta, Turkish:traktör  
...
**tren** *train* ← English:French:train, Spanish:Turkish:tren, Portuguese:trem, Persian: ترن‎ (tran), Hindi:ट्रेन (ṭren), Bengali:ট্রেন (ṭren), Swahili:treni  
**trepe** *stairs (ladder; climb)* ← deu:Treppe, ned:trap, Russian:трап (trap), Malay:terap, Japanese:タラップ (tarappu) + Spanish:Portuguese:trepar  
...
**tu** *you (singular)* ← deu:du, French:Portuguese:tu, Spanish:tú, Russian:ты (ty), Persian: تو‎ (to), Hindi:तू (tū), Bengali:তুই (tui)  
...
**tube** *tube (pipe)* ← Spanish:Portuguese:tubo, English:French:tube, Japanese:チューブ (chūbu), Zulu:ithumbu, xho:íthumbu  
...
**tuh** *spit* ← Hindi: थूकना (thūknā), Mandarin: 吐 (tǔ), Turkish:tükürmek, Fulani:tuutde  
...
**tulpan** *tulip* ← English:Malay:tulip, French:tulipe, deu:Tulpe, Spanish:tulipá, Portuguese:túlipa, nld:tulp, Russian:тюльпан (t’ul’pan), Arabic:توليب (tūlīb), Hindi:ट्यूलिप (ṭyūlip), may:tulip, Japanese:チューリップ (chūrippu), Korean:튤립 (tyullip)  
...
**tung** *tung tree* ← Mandarin:油桐 (yóutóng), Cantonese:油桐 (yau4tung4), English:tung tree, French:tung, Portuguese:tungue, Russian:тунг  
**tupi** *hat (cap)* ← Malay:topi, Hindi: टोपी (ṭopī), Bengali:টুপি (ṭupi), Tamil:தொப்பி (toppi)  
**tur** *tour (excursion, trip)* ← English:deu:Spanish:tour, French:tournée, Portuguese:turnê, Russian:турне (turne), Malay:tur, Japanese:ツアー (tsuā), Korean:투어 (tueo), Mandarin:旅途 (lǚtú)  
...
**turfa** *peat* ← English:turf, French:tourbe, Spanish:Turkish:turba, Portuguese:turfa, Russian:торф (torf)  
**tuta** *mulberry* ← Russian:тута (tuta), Arabic: تُوت‎ (tūt), Hindi:तूत (tūt), Turkish:dut  
**tuzi** *rabbit (hare)* ← Mandarin:兔子 (tùzi), Cantonese:兔仔 (tou3zai2), Korean:토끼 (tokki), Vietnamese:thỏ, Thai:เถาะ (tho)  
**uhu** *cry (boo-hoo, alas, woe)* ← English:boo hoo, Mandarin:呜呼 (wūhū), Korean:오호 (oho), Vietnamese:hu hu,   
**uma** *horse* ← Mandarin:马 (mǎ), Cantonese:馬 (maa5), Japanese:馬 (uma), Korean:말 (mal), Vietnamese:mã  
**umami** *savory (umami)* ← Japanese:旨味 (umami), Korean:우마미 (umami), English:French:Portuguese:Spanish:Malay:umami, Russian:умами (umami)  
**umur** *age* ← Arabic: عُمُر‎ (ʿumur), Persian: عمر (omr), Hindi:उमर (umar), Bengali:ওমর (omôr), Swahili:umri, Malay:umur, Turkish:ömür  
**un** *one (1)* ← French:un, Spanish:uno, Portuguese:um,una, English:one  
**unabe** *jujube* ← Arabic: عُنَّاب‎ (ʕunnāb), Persian: عناب‎ ('annâb), Russian:унаби (unabi), Turkish:hünnap  
**uranium** *uranium* ← English:uranium, French:uranium, Spanish:uranio, Portuguese:urânio, Russian:уран, Japanese:ウラン, Korean:우라늄, Vietnamese:urani (uran), Hindi:युरेनियम, Bengali:ইউরেনিয়াম, Malay:uranium, Swahili:urani, Arabic: يورانيوم  
**uze** *use (employ, apply)* ← English:use, French:user, Spanish:Portuguese:usar, Polish:używać  
**va** *wow! (gee!)* ← English:wow, French:ouah, Mandarin:哇 (wā), Cantonese:嘩 (waa1), Japanese:わあ (wā), Korean:와 (wa), Hindi:वाह (vāh), Malay:wah, Fulani:wai  
**vaf** *dog* ← English:woof, French:ouaf, Russian:гав (gav), Turkish:hav, Mandarin:汪 (wāng), Japanese:ワン (wan)  
**vafle** *waffle* ← English:waffle, deu:Waffel, Russian:вафля (vaflya), Mandarin:窝夫 (wōfū), Cantonese:華夫 (waa4fu1), Japanese:ワッフル (waffuru), Korean:와플 (wapeul)  
...
**vakil** *represent* ← Arabic: وكيل‎ (wakīl), Persian: وکیل‎ (vakil), Hindi:वकील (vakīl), Bengali:উকিল (ukil), Tamil:வக்கீல் (vakkīl), Malay:wakil, Turkish:vekil, Swahili:Hausa:wakili, Amharic:ወኪል (wäkil)  
...
**valve** *valve (tap, faucet)* ← English:French:valve, Spanish:Portuguese:válvula, Hindi:वाल्व (vālv), Japanese:バルブ (barubu), Korean:밸브 (baelbeu), Cantonese:嘩佬 (waa1 lou2), Swahili:valvu, Turkish:valf  
...
**vanadium** *vanadium* ← English:vanadium, French:vanadium, Spanish:vanadio, Portuguese:vanádio, Russian:ванадий, Mandarin:钒 (fán), Japanese:バナジウム, Korean:바나듐, Vietnamese:vanađi, Hindi:वनेडियम, Bengali:ভ্যানাডিয়াম, Malay:vanadium, Swahili:vanadi, Arabic: فناديوم  
**vanila** *vanilla* ← English:vanilla, Spanish:vainilla, Portuguese:baunilha, French:vanille, Russian:ваниль (vanil’), Cantonese:云呢拿 (wan4 ni1 laa4-2), Japanese:バニラ (banira), Korean:바닐라 (banilla), Vietnamese:vani, Turkish:vanilya  
**vanu** *fun (amusement)* ← Mandarin:玩 (wán), Cantonese:玩 (waan4), cjy:玩 (van1), Korean:완 (wan)  
**vari** *various (diverse, miscellaneous)* ← English:various, Spanish:vario, Portuguese:vário, French:varier, deu:variieren  
**varis** *rice* ← Tamil:அரிசி (arisi), Telugu: వరి (vari), Malayalam:vary, Malay:beras, otb:འབྲས ('bras), Persian: برنج‎ (berenj), Arabic: أَرُزّ‎ (ʾaruzz), Spanish:Portuguese:arroz, French:riz, English:rice, deu:Reis, Russian:рис (ris), Oromo:ruuzii  
**varite** *heritage (legacy, bequest)* ← Arabic: وَرَثَ‎ (waraṯa), Persian: وارث‎ (vâres), Hindi:वारिस (vāris), Malay:waris, Swahili:-rithi, Turkish:vâris + English:inherit, French:hériter, Spanish:heredar  
**vasin** *vaccine* ← English:vaccine, Spanish:vacuna, Portuguese:vacina, Russian:вакцина (vakcina), Hindi:वैक्सीन (vaiksīn), Japanese:ワクチン (wakuchin), Malay:vaksin  
...
**vaxi** *wash* ← English:wash, deu:waschen, Mandarin:洗 (xǐ)  
**vazir** *minister (vizier, high-ranking official)* ← Arabic: وَزِير‎ (wazīr), Persian: وَزیر‎ (vazir), Hindi:वज़ीर (vazīr), Bengali:উজির (ujir), Turkish:vezir, Swahili:Malay:wazir + English:vizier, deu:Wesir, French:Portuguese:vizir, Spanish:visir, Russian:визирь (vizir')  
**vei** *latitudinal (horizontal)* ← Mandarin:纬 (wěi), Cantonese:緯 (wai6), Korean:위 (wi), Vietnamese:vĩ  
**vel** *veil* ← eng;veil, French:voile, Spanish:velo, Portuguese:véu, Japanese:ベール (bêru), Korean:베일 (beil), Swahili:veli  
...
**veranda** *veranda (balcony, terrace, porch)* ← Hindi:बरामदा (barāmd), Tamil:வராந்தா (varāntā), Portuguese:varanda, Malay:beranda, English:veranda, Russian:веранда (veranda), Japanese:ベランダ (beranda), Korean:베란다 (beranda), Swahili:varanda  
**verme** *worm* ← English:worm, Spanish:Portuguese:verme, French:ver, deu:Wurm  
**verse** *turn toward (direct, flip; versus)* ← English:versus, French:verse, Spanish:Portuguese:versar + Russian:версия (versiya), Malay:versi  
**veruke** *wart* ← English:verruca, French:verrue, Spanish:Portuguese:verruga  
...
**vidua** *widow* ← English:widow, Spanish:viudo, Portuguese:viúvo, French:veuve, deu:Witwe, Russian:вдова (vdova), Hindi:विधवा (vidhavā), Bengali:বিধবা (bidhabā), Telugu:విధవ (vidhava)  
**vijing** *MSG (monosodium glutamate)* ← Mandarin:味精 (wèijīng), Cantonese:味精 (mei6 zing1), Vietnamese:mì chính, Malay:vetsin,micin, Filipino:bitsin  
...
**vote** *vote (ballot)* ← English:French:vote, Spanish:Portuguese:voto, deu:Votum, Russian:вотум (votum), Hindi:वोट (voṭ), Bengali:ভোট (bhōṭ)  
...
**xakal** *jackal* ← Persian: شغال‎ (šağâl), Turkish:çakal, English:jackal, French:Spanish:Portuguese:chacal, Russian:шакал (šakal), Bengali:শৃগাল (śrigal), Malay:jakal, Japanese:ジャッカル (jakkaru), Korean:자칼 (jakal), Hausa:jakkali  
**xake** *suspect (doubt; suspicion)* ← Arabic: شَكَّ‎ (šakka), Persian: شک‎ (šak), Hindi:शक (śak); शंका (śankā), Malay:syak; sangka, Turkish:şek, Swahili:shaka; -shuku, Hausa:shakka  
...
**xatan** *devil (Satan)* ← heb: שָׂטָן‎ (śaṭan), Arabic:(šayṭān), English:French:deu:Vietnamese:Satan, Spanish:Satán, Portuguese:Satã, Russian:Сатана (Satana), Mandarin:撒但 (Sādàn), Cantonese:撒但 (saat3daan6), Korean:사탄 (satan), Japanese:サタン (satan), Hindi:शैतान (śaitān), Tamil:சயித்தான் (cayittāṉ), Malay:Setan, Turkish:şeytan, Swahili:Shetani, Hausa:shaidan  
**xava** *roast* ← Arabic: شَوَى‎ (šawā) + Mandarin:烧 (shāo), Cantonese:燒, (siu1)  
**xaxa** *rustle* ← Mandarin:(shasha), Russian:шуршать (shurshat’), Swahili:-chakacha  
**xayu** *shark* ← Mandarin:鲨鱼 (shāyú), Cantonese: 鯊魚  (saa1 jyu4-2), Korean:상어 (sang'eo), Japanese:鮫 (same) + Malay:hiu; yu  
**xe hal** *situation (circumstances, state of affairs)* ← Mandarin:事态 (shìtài), Cantonese:事態 (si6taai3), Japanese:事態 (jitai), English:state of affairs, French:état des choses  
**xe** *thing* ← Arabic:(šayʾ), Turkish:şey, + Mandarin:事 (shì), Cantonese:事 (si6)  
**xefe** *chief (boss)* ← French:chef, Portuguese:chefe, Spanish:jefe, Russian:шеф (šef), English:chief, Swahili:chifu, Japanese:チーフ (chīfu) + Arabic: شَيْخ‎ (šayx), swa:shehe, Bengali:শেখ (śekh), Turkish:şeyh  
...
**xirope** *syrup* ← Arabic:(šarāb), Portuguese:xarope, English:syrup, deu:Sirup, French:sirop, Spanish:jarabe; sirope, Russian:сироп (sirop), Persian: شیره‎ (fa) (šire), Hindi:शर्बत (śarbat), Bengali:শীরা (śira), Turkish:şurup, Japanese:シロップ (shiroppu), Korean:시럽 (sireop), Vietnamese:xi-rô, Swahili:shira  
**xite** *feces (poop, shit)* ← English:shit, Mandarin:屎 (shǐ), Cantonese:屎 (si2)  
**xiti bai** *failure (blunder, flop, miss, loss, defeat)* ← Mandarin:失败 (shībài), Japanese:失敗 (shippai), Korean:실패 (šilpæ), Vietnamese:thất bại  
**xiti** *lose (misplace, miss, shed)* ← Mandarin:失 (shī), Japanese:失 (shitsu), Korean:실 (šil), Vietnamese:thất  
**xiu** *little (small)* ← Mandarin:小 (xiǎo), Cantonese:小 (siu2), Japanese:小 (shō), Korean:소 (so), Vietnamese:tiểu  
**xix** *skewer* ← Turkish:şiş + English:shish-, Russian:шиш- (šiš-)  
**xixa** *vial (phial, flask)* ← Persian: شیشه (šiše), Hindi:शीशा (śīśā), Telugu:సీసా (sīsā), Turkish:şişe, Arabic: شيشة‎ (šīša) + English:shisha, deu:Schischa, French:chicha, Portuguese:xixa  
...
**xou** *show (display, exhibition, demonstration, demo)* ← English:deu:French:Spanish:Portuguese:show, Russian:шоу (šou), Turkish:şov, Swahili:shoo, Korean:쇼 (syo), Japanese:ショー (shō), Mandarin:秀 (xiù), Cantonese:騷 (sou1)  
**xukre** *thanks (thank you)* ← Arabic: شُكْر‎ m (šukr), Hindi:शुक्र (śukr), Bengali:শোকর (śokôr), Swahili:-shukuru, Turkish:şükür  
**xulekan** *school (institution)* ← Mandarin:学 (xué) + deu:Schule, Swahili:shule + English:school, French:école, Spanish:escuela, Portuguese:escola, Russian:школа (škola), Bengali:স্কুল (śkul), Malay:sekolah + Hindi:पाठशाला (pāṭhśālā), Marathi:शाळा (śāḷā), Tamil:பாடசாலை (pāṭasālai)  
...
**ya** *yes* ← English:yeah, deu:ja, Korean:예 (ye), Malay:ya  
**yake** *about (approximately, nearly, almost)* ← Korean:약 (yak), Japanese:約 (yaku), Cantonese:約 (yœk), Turkish:yaklaşık, Mandarin:约 (yuē)  
**yaku** *yak* ← tib:གཡག (g-yag), English:deu:French:Spanish:Turkish:yak, Portuguese:iaque, Russian:як (iak), Hindi:याक (yāk)  
**yam** *consume (eat or drink)* ← Khmer:ញ៉ាំ (nyam), Fulani:nyaamude + Spanish:ñam, Russian:ням (nyam), Italian:gnam, English:yum, Korean:냠냠 (nyamnyam), Hungarian:nyam  
...
**yatim** *orphan* ← Arabic: يَتِيم‎ (yatīm), Persian: یتیم‎ (yatim), Turkish:yetim, Malay:yatim, Swahili:yatima, Hindi:यतीम (yatīm), Bengali:এতিম (etim), Tamil:எத்தீம் (ettīm), Fulani:alyatiimu  
...
**yoke** *jade* ← Mandarin:玉 (yù), Cantonese:玉 (yuk6), nan:玉 (gio̍k), Japanese:玉 (gyoku), Vietnamese:ngọc (玉), Korean:옥 (ok), Malay:giok, Thai:หยก (yok), Khmer:យក់ (yuək)  
...
**yuge** *joint (join)* ← English:yoke, Spanish:yugo, Portuguese:jugo, French:joug, Russian:иго (igo), Persian:  یوغ‎ (yuğ) + deu:Junktion + Cantonese:軛 (aak1), Vietnamese:ách  
...
**zai** *exist (presently, currently)* ← Mandarin:在 (zài), Cantonese:在 (zoi6), Japanese:在 (zai), Vietnamese:tại  
**zalime** *oppress (bully)* ← Arabic: ظَالِم‎ (ẓālim), Persian: ظالم‎ (zâlem), Hindi:ज़ालिम (zālim), Turkish:Malay:zalim, Swahili:dhalimu, Hausa:zalumci  
**zaman** *period (era, epoch, term)* ← Malay:jam, Arabic: زَمَن‎ (zaman), Hausa:Swahili:zamani, Fulani:jamaanu, Turkish:zaman, Persian: زمان‎ (zamân), Hindi:समय (samay), Bengali:সময় (sômyô)  
**zange** *grow (grow up)* ← Mandarin:长 (zhǎng); 增加 (zēng), Cantonese:增 (zang1), Korean:장 (jang), Vietnamese:tăng  
**zar** *hazard (chance)* ← Arabic: زَهْر (zahr), Turkish:zar, Persian: زار (zâr) + English:hazard, Spanish:Portuguese:azar, Hausa:hazari  
**zebra** *zebra* ← English:deu:Portuguese:Turkish:Malay:zebra, French:zèbre, Spanish:cebra, Russian:зебра (zebra), Hindi:ज़ेब्रा (zebrā), Bengali:জেবরা (jebra), Japanese:ゼブラ (zebura)  
**zelo** *fervour (zeal, passion)* ← Greek:ζῆλος (zêlos), English:zeal; jealous, French:jaloux, Spanish:celos, Portuguese:zelo  
**zeta** *zetta-* ← English:French:Spanish:Portuguese:zetta-, Malay:zeta-, Japanese:ゼタ- (zeta-), Korean:제타- (jeta-), Mandarin:泽它- (zétā-)  
**zete** *oil* ← Arabic: زَيْت‎ (zayt), Spanish:Portuguese:aceite  
**zetun** *olive* ← Arabic: زَيْتُون‎ (zaitūn), Spanish:aceituna, Malay:zaitun, Swahili:zeituni, Turkish:zeytin, Hausa:swa:zaituni, Persian: زیتون‎ (zeytun), Hindi: ज़ैतून (zaitūn), Bengali:জয়তূন (zôẏtūn), Tamil:சைதூண் (caitūṇ)  
...
**zi** *character (written symbol)* ← Mandarin:字 (zì), Cantonese:字 (zi6), Japanese:字 (ji), Korean:자 (ja)  
**zikura** *ziggurat* ← Arabic: زِقُّورَة‎ (ziqqūra), English:Turkish:ziggurat, deu:Zikkurat, French:ziggourat, Spanish:zigurat, Portuguese:zigurate, Russian:зиккурат (zikkurat), Mandarin:金字形神塔, Japanese:ジッグラト (jiggurato), Korean:지구라트 (jigurateu)  
**zina** *adultery (infidelity)* ← Arabic: زِنَاء‎ (zināʾ), Malay:Turkish:Hausa:zina, Fulani:jinaa, Swahili:zinaa, Persian: زنا‎ (zenā)  
...
**zoku** *continue (go on, keep on, carry on, proceed)* ← Wu-Chinese:续 (zoq), Cantonese:續 (zuk6), Japanese:続 (zoku), Korean:속 (sok), Vietnamese:kế tục  
...
**zukam** *cold (illness)* ← Arabic:زُكَام‎ (zukām), Hindi:ज़ुकाम (zukām) + Mandarin:感(冒) (gǎn(mào)), Cantonese:感冒 (gam2mou6), Japanese:感(冒) (kan(bō)), Korean:감(기) (gam(gi)), Vietnamese:cảm  
