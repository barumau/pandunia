...
**ange** *limb (member, branch)* ← Hindi:अंग (aṅg), Bengali:অঙ্গ (ôṅg), Punjabi:ਅੰਗ (aṅga), Telugu:అంగము (aṅgamu), Khmer: អង្គ (ʔɑŋ), Thai: องค์ (ong)  
...
**arme** *weapon (arms)* ← English:arms, French:arme, Spanish:Portuguese:arma + Russian:армия (armiya), Hindi:आर्मी (ārmī)  
...
**Atlante Hai** *Atlantic Ocean* ← English:Atlantic, Spanish:Atlántico, Portuguese:Atlântico, Russian:Атлантический океан (Atlanticheskyy okean), Swahili:Atlantiki  
...
**bade** *body (bodily, corporal)* ← English:body + Arabic:  بَدَن‎ (badan), Persian: بدن‎ (badan), Hindi:बदन (badan), Malay:badan, Turkish:beden, Swahili:badani  
**badle** *exchange (swap, replace, trade)* ← Arabic:(badala), Hindi:बदला (badlā), Swahili:badili, Turkish:bedel  
**bage** *bag* ← English:bag; baggage, Hindi:बैग (bæg), Japanese:バッグ (baggu) + French:bagage, Portuguese:bagagem, Russian:багаж (bagazh), Bengali:ben:ব্যাগেজ (byagej), Malay:beg; bagasi, Turkish:bagaj  
...
**bale** *strong* ← Hindi:बल (bal), Bengali:বল (bôl), Malay:bala, Telugu:బలము (balamu), Thai:พล (pon), พละ (pá-lá)  
...
**bana** *arrow (bolt)* ← Hindi:बाण (bāṇ), Telugu:బాణము (bāṇamu), Malay:panah  
...
**bandir** *flag (banner)* ← English:banner, French:bannière, Spanish:bandera, Portuguese:bandeira, Malay:Swahili:bendera, Filipino:bandila  
...
**barxe** *rain (precipitation)* ← Persian: باران‎ (bârân), Hindi:बारिश (bāriś), Bengali:বৃষ্টি (briśṭi), Turkish:baran  
...
**baze** *base (foundation, bottom; basic; base on, found)* ← English:French:Portuguese:Spanish:base, deu:Basis, Russian:база (baza)  
...
**bing** *jar (vase)* ← Mandarin:瓶 (píng), Cantonese:瓶 (ping4), Wu-Chinese:瓶 (bín), Japanese:瓶 (bin), Korean:병 (byeong), Vietnamese:bình  
...
**brun** *brown* ← English:brown, French:brun + Arabic: بُنِّيّ‎ (bunniyy) + Hindi:भूरा (bhūrā)  
**bu!** *boo!* ← English:boo, French:bouh, Portuguese:Spanish:bu, Russian:бу (bu), Korean:부 (bu)  
**buce** *butcher (slaughter)* ← English:butcher, French:boucher, Italian:beccaio, Hindi:बूचड़ (būcaṛ) + Korean:푸주한 (pujuhan)  
...
**bufon** *fool (buffoon)* ← Spanish:Portuguese:bobo, Korean:바보 (babo)  
...
**cang** *layer (level, storey, floor, stratum, tier)* ← Mandarin:层 (céng), Cantonese:層 (cang4), Korean:층 (cheung), Vietnamese:tầng + Min-Chinese:棧 (chàn) + Khmer:ជាន់ (cŏən) , Thai:ชั้น (chan)  
...
**cante** *sing (song, chant)* ← French:chanter, English:chant, Portuguese:Spanish:cantar, + Mandarin:唱 (chàng), Cantonese:唱 (coeng3), Korean:창 (chang)  
...
**catre** *four (4)* ← Russian:четыре (chetyre), Hindi:चार (cār), Bengali:চার (car), Malay:catur + French:quatre, Spanish:cuatro, quatro  
...
**cin** *parent (mother or father)* ← Mandarin:亲 (qīn), Cantonese:親 (can1)  
...
**cope** *hoe (hack, tool for chopping)* ← Mandarin:锄 (chú), Cantonese:鋤 (co4), Thai:จอบ (chop), Turkish:çapa + English:chop  
...
**cuke** *touch* ← Mandarin: 触 (chù), Cantonese:觸 (cuk1), Japanese:触 (shoku), Korean:촉 (chok) + Hindi: छूना (chūnā), Punjabi:ਛੂਹਣਾ (chūhṇā)  
**cum** *kiss* ← Hindi:चूमना (cūmnā), Urdu:(cūmnā), Malayalam:ചുംബനം (cumbanaṃ), Malay:cium, Japanese:チュー (chū), Thai:จูบ (cup)  
**cupe** *suck (absorb)* ← Spanish:Portuguese:chupar, Khmer:ជប់ (cup) + Hindi:चूसना (cūsnā)  
...
**dane** *seed (semen)* ← Persian: دانه‎ (dāna), Hindi:दाना (dānā), Turkish:tane + Japanese:種 (tane) + Mandarin:弹 (dàn), Vietnamese:đạn, Korean:탄알 (tanal)  
**dang** *bell (ring, toll, clang)* ← English:dong + Persian: زنگ‎ (zang), Turkish:çan + Mandarin:钟 (zhōng), Cantonese:鐘 (zung1), Korean:종 (jong), Vietnamese:chuông, Khmer:ចួង (cuəng) + Russian:звон (zvon)  
...
**darmesitium** *darmstadtium* ← English:darmstadtium, French:darmstadtium, Spanish:darmstatio, Portuguese:darmstádio, Russian:дармштадтий, Mandarin: (dá), Japanese:ダームスタチウム, Korean:다름슈타튬, Vietnamese:darmstadti, Hindi:डार्म्स्टेडशियम, Bengali:ডারমস্টাডটিয়াম, Malay:darmstadtium, Swahili:darmstadti, Arabic: دارمشتاتيوم  
...
**dite** *dictate* ← English:dicate, French:dicter, Spanish:dictar, Portuguese:ditar + deu:Malay:diktator, Russian:диктатор (diktator), Turkish:diktatör, Arabic:(diktatūr)  
...
**dunjia aventur** *dungeon crawl* ← English:dungeon, French:donjon, Japanese:ダンジョン (danjon)  
...
**eme** *element (the simplest unit)* ← English:-eme, Spanish:Portuguese:-ema, French:-ème, Russian:-ема (-ema), Malay:-em  
**emote** *feel (emote)* ← English:emotion, French:émotion, Spanish:emoción, Portuguese:emoção, Russian:эмоция (emociya), Malay:emosi, Filipino:emosyon  
...
**file** *like (liking, attraction, -philia)* ← English:French:-phile, Portuguese:Spanish:-filo  
...
**fixe** *fix (attach)* ← English:fix, French:fixer;ficher, Spanish:fijar, Portuguese:fixar, deu:fixieren  
**fizike** *physics* ← English:physics, Spanish:Portuguese:física, Russian:физика (fizika), Turkish:Malay:fizik, Arabic:فِيزِيقَا‎ (fīzīqā), Swahili:fizikia, Hindi:फ़िज़िक्स (fiziks)  
...
**fobe** *fear (scare; frighten; scared, afraid)* ← English:-phobia, Spanish:Portuguese:Malay:-fobia, French:deu:-phobie, Russian:-фобия (-fobiya), Turkish:-fobi  
**fokus** *focus (concentrate; concentration)* ← English:focus, Spanish:Portuguese:foco, deu:Fokus, Russian:фо́кус, Persian:فوکوس‎ (fokus)  
...
**futau** *axe (hatchet)* ← Mandarin:斧头 (fǔtóu), Cantonese:斧頭 (fu2tau4), Wu-Chinese:斧头 (fu déu), Filipino:puthaw  
**fute** *foot* ← English:foot, deu:Pfote  
**futebol** *football (soccer)* ← English:French:football, Spanish:fútbol, Portuguese:futebol, deu:Fußball, Hindi:फ़ुटबॉल (fuṭbŏl), Urdu:(fuṭ bāl), Bengali:ফুটবল (phuṭbôl), Russian:футбол (futbol), Thai:ฟุตบอล (th) (fút-bɔn), Japanese:フットボール (futtobōru), Zulu:ibhola  
...
**gas** *gas (gaseous)* ← deu:English:Spanish:Malay:gas, Portuguese:gás, Bengali:গ্যাস (gyas), Mandarin:瓦斯 (wǎsī), Cantonese:瓦斯 (ngaa5 si1), Japanese:ガス (gasu), Korean:가스 (gaseu), Hindi:गैस (gais), French:Turkish:gaz, Russian:газ (gaz), Arabic:(ḡāz)  
**gate** *hard (tough)* ← Telugu:గట్టి (gaṭṭi), Hindi:कड़ा (kaṛā) + Japanese:硬い (katai) + Turkish:katı  
...
**glas** *glass* ← dei:Glas, English:glass, + Persian: گیلاس‎ (gilâs), Hindi:गिलास (gilās), Bengali:গ্লাস (glaś), Japanese:グラス (gurasu), Korean:글라스 (geullaseu), Malay:gelas, Swahili:glasi + Russian:глазурь, Spanish:glasear  
...
**grane** *grain (particle)* ← English:French:grain, Spanish:grano, Portuguese:grão + Russian:гранит (granit), Turkish:Vietnamese:Malay:granit, Arabic:جرانيت (jaraniat), Hindi:ग्रेनाइट (grenait)  
**grave** *gravel* ← English:gravel, Spanish:grava, French:gravire, Russian:гравий (graviy) + Swahili:changarawe  
**grese** *stride* ← English:deu:French:agression, Polish:agresja, Russian:агрессия (agressiya), Spanish:agresión, Portuguese:agressão, Malay:agresif  
...
**harame** *forbidden (illicit, haram, taboo)* ← Arabic:(ḥarām), Hausa:Malay:Turkish:English:deu:haram, Hindi:हराम (harām), Korean:하람 (haram), Persian:Urdu:(harām), Swahili:haramu, Mandarin:哈拉姆 (hālāmǔ), Russian:харамный (xaramniy)  
**harfe** *letter (character, written symbol)* ← Arabic:(ḥarf), Turkish:harf, Persian:Urdu:(harf), Hausa:harafi, Swahili:herufi, Malay:huruf  
**harmone** *harmonious* ← English:harmony, Spanish:armonía, Portuguese:harmonia, French:harmonie, Russian:гармония (garmoniya)  
...
**hate** *until (til, up to)* ← Portuguese:até, Arabic:(ḥatta), Spanish:hasta, Swahili:hata + Persian: تا‎ (tâ), Hindi:तक (-tak)  
**hatre** *danger (peril; dangerous, perilous)* ← Arabic: خطر‎ (xaṭar), Persian: خطر‎ (xatar), Urdu: خطرہ‎ (xatrā), Hindi:ख़तरा (xatrā), Swahili:hatari, Turkish:muhatara  
**have** *atmosphere (air, wind)* ← Arabic: هَوَاء‎ (hawāʾ), Hindi:हवा (havā), Bengali:হাওয়া (haowa), Malay:hawa, Swahili:hewa, Turkish:hava  
**haxi** *chopsticks* ← Japanese:箸 (hashi), Bengali:হাশি (haśi), Gujarati:હાશી (hāśī), Portuguese:hashi  
**haxix** *grass (hashish)* ← Arabic: حَشِيش (ḥašīš), English:hashish, French:haschich, Portuguese:haxixe, Russian:гашиш (gašiš), Japanese:ハシシ (hashishi), Korean:해시시 (haesisi), Hindi:हशीश (haśīś), Malay:hasyis  
**he** *huh? (pardon?)* ← deu:hä, French:Portuguese:hein, Japanese:e + English:huh, Vietnamese:hả + Mandarin:啊 (à, a)  
**hei** *hey (exclamation to get attention)* ← English:hey, French:hé, Spanish:hey, Portuguese:ei, Russian:эй (ey), Mandarin:喂 (wèi), Persian: هی‎ (hey)  
...
**hima** *snow (be snowing)* ← Hindi:हिमपात (himpāt), Thai:หิมะ (hima), Telugu:(himamu)  
...
**hisabe** *calculate (calculation)* ← Arabic: حِسَاب‎ (ḥisāb), Turkish:hesap, Oromo:hisaaba, Swahili:hisabu, Hindi:हिसाब (hisāb), Bengali:হিসাব (hiśab)  
**histore** *history (annals)* ← English:history, Spanish:Swahili:historia, Portuguese:história, French:histoire, Russian:история (istoriya)  
...
**hole** *whole (entire)* ← English:whole, Spanish:Portuguese:holo-  
...
**hura** *cheer (hurrah, hooray, yay)* ← English:hurrah, deu:Spanish:hurra, French:hourra, Russian:ура (ura), Malay:hore, Persian:(hurâ)  
**hurargente** *mercury (quicksilver)* ← Swahili:hidrajiri  
**hure** *free (unchained)* ← Arabic: حر (ḥurr), Turkish:hür, Swahili:huru, Spanish:horro, Portuguese:forro  
**hux** *nice (pleasant, comfortable, cushy)* ← Persian: خوش‎ (xoš), Hindi:ख़ुश (xuś), Bengali:খুশি (khuśi), Turkish:hoş, English:cushy  
...
**impere** *reign (rule as an emperor)* ← English:empire, Spanish:imperio, Portuguese:império, Russian:империя (imperiya), Arabic:إِمْبِرَاطُورِيَّة‎ (ʾimbirāṭūriyya), Persian:امپراطوری‎ (emperâturi), Malay:empayar  
...
**jainisme** *Jainism* ← Hindi:Marathi:जैन (jain), Thai:เชน (chen), English:jainism, French:jaïnisme, Russian:джайнизм (džaynizm)  
...
**javabe** *answer (respond, reply; response)* ← Arabic: جَوَاب‎ (jawāb), Hindi:जवाब (javāb), Malay:jawab, Swahili:jibu, jawabu, Turkish:cevap  
**jebe** *pocket* ← Hindi:जेब (jeb), Punjabi:ਜੇਬ (jeb), Urdu:(jeb), Telugu:(jēbu), Arabic:(jayb), Turkish:cep, Wolof:jiba  
**jebre** *algebra* ← Arabic:Persian:(jabr), Turkish:cebir, Urdu:(aljabrā), English:algebra, French:algèbre, Swahili:aljebra  
**jeke** *borrow (lend)* ← Mandarin:借 (jiè), Cantonese:借 (ze3), Japanese:借 (shaku), Korean:적 (jeok) + English:check  
**jele** *imprison (jail)* ← English:jail, French:geôle, Hindi:जेल (jel), Bengali:জেল (jēl), Telugu:జైలు (jailu), Urdu: جیل‎ (jēl), Swahili:jela + Spanish:Portuguese:jaula  
**jen** *person (individual)* ← Mandarin:人 (rén), wuu人 (zén), Japanese:人 (jin) + Hindi:जन (jan), Bengali:-জন (-jôn), Malay:-jana, Thai:ชน (chon), Khmer:ជន (jon) + French:gens, Portuguese:gente  
**jenje** *ginger* ← English:ginger, French:gingembre, Spanish:gengibre, Portuguese:jengibre, Mandarin:姜 (jiāng), Tamil:இஞ்சி (inji), Arabic: زنجبيل‎ (zanjabīl), Turkish:zencefil  
...
**jense** *gender (sex)* ← English:gender, Portuguese:gênero, Japanese:ジェンダー (jendā) + Arabic:Urdu:(jins), Persian:(jens), Swahili:jinsi, Turkish:cins  
...
**kama** *lust (desire, libido, sexual passion)* ← Hindi:काम (kām), Bengali:কাম (kam), Thai:กาม (gaam), English:kama  
...
**kanal** *channel (canal)* ← English:Spanish:Portuguese:French:canal, Russian:канал (kanal), Malay:kanal + Arabic: قَنَاة‎ (qanāh) + Bengali:খাল (khal)  
...
**kande** *candy (sweets)* ← English:candy, Hindi:कैंडी (kaiṇḍī), Bengali:ক্যান্ডি (kyandi), Japanese:キャンデー (kyandē), Filipino:kendi + Arabic:Persian: قند (qand)  
...
**kara** *black* ← Hindi:काला (kālā); कारौ (kārau), Bengali:কালো (kalo), Punjabi:ਕਾਲਾ (kālā) + Tamil:கருப்பு (karuppu) + Turkish:kara, kaz:қара (qara)  
**karave** *caraway* ← Arabic:(karāwiya), English:caraway, French:carvi, Spanish:alcaravea, Portuguese:alcaravia  
...
**karde** *card* ← English:card, French:carte, Spanish:Portuguese:carta, deu:Karte, Russian:карта (karta), Turkish:kart, Swahili:kadi, Hindi:कार्ड (kārḍa), Bengali:কার্ড (kārḍa), Malay:kartu, Mandarin:卡 (kǎ), Japanese:カード (kādo), Korean:카드 (kadeu) deu:Karte, may:kartu, fra:carte  
**kardon** *thistle* ← Spanish:Portuguese:cardo, French:chardon, English:cardoon, Japanese:カルドン (karudon)  
**kare** *work* ← Persian: کار (kâr), Hindi:कार (kār), कार्य (kārya), Bengali:কাজ (kaj), Malay:karya,kerja + Swahili:kazi  
...
**karge** *burden (load, weight, charge, cargo)* ← Spanish:Portuguese:carga, English:cargo, Malay:kargo  
...
**karime** *charitable (gentle, kind)* ← Arabic:(karīm), Swahili:-karimu, Turkish:kerim, Spanish:Portuguese:caritativo  
...
**karte** *map (chart)* ← English:chart, French:carte, Spanish:Portuguese:carta, Russian:карта (karta), Arabic: خَرِيطَة‎ (ḵarīṭa), Turkish:harita  
**karube** *carob (St. John's bread)* ← Arabic: خَرُّوب‎ (ḵarrūb), English:carob, French:caroube, Spanish:algarrobo, Portuguese:alfarroba  
...
**kase** *box (container, case)* ← lat:capsa, deu:Kasse, English:French:case, Spanish:caja, Portuguese:caixa, Russian:касса (kassa), Swahili:kasha + Arabic:(qafaṣ), Hindi:क़फ़स (qafas), Turkish:kafes + Mandarin:卡式 (kǎshì), Japanese:カセット (kasetto), Korean:카세트 (kaseteu)  
**kaske** *shell (crust, carapace)* ← Spanish:cáscara, Portuguese:casca + nan:殼 (kag4), Wu-Chinese:殼 (khoq4), Japanese:殻 (kaku)  
**kaslan** *lazy (indolent)* ← Arabic: كَسْلَان‎ (kaslān) + Mandarin:懒 (lǎn), Cantonese:懶 (laan5) + आलसी (ālsī)  
...
**kate** *bite* ← Hindi:काटना (kāṭnā), Bengali:কাটা (kata) + Tamil:கடி (kaṭi) + Thai:กัด (kat) + English:cut + Arabic:(qaṭa’a) + Swahili:-kata + Vietnamese:cắt, Mandarin:割 (gē), Cantonese:割 (got3), Wu-Chinese:割 (ga’), Japanese:割 (katsu)  
...
**kave** *dig (excavate)* ← Spanish:Portuguese:cavar, English:excavar, French:excaver  
**ke** *what? (who? which?)* ← French:que, Spanish:qué, Portuguese:o que + Bengali:কে  (ke) + Mandarin:何 (hé)  
...
**kex** *hair* ← Japanese:毛 (ke) + Hindi:केश (keś), Urdu:(keś), Punjabi:ਕੇਸ਼ (keś), Telugu:(kēśamu)  
...
**kine** *kinetic* ← English:kinetic, Spanish:Portuguese:cinético, French:cinétique, deu:kinetisch, Russian:кинетический (kineticheskyy)  
...
**kitabe** *write (writing)* ← Arabic:Urdu:(kitāb), Persian:(ketâb), Turkish:kitap, Malay:kitab, Swahili:kitabu, Hindi:किताब (kitāb)  
...
**klame** *cry (shout, scream, yell)* ← English:-claim, French:-clamer, Spanish:Portuguese:-clamar  
**klare** *clear (obvious; obviously, of course)* ← deu:klar, Spanish:Portuguese:claro, English:clear, French:clair  
...
**klorium** *chlorine* ← English:chlorine, French:chlore, Spanish:cloro, Portuguese:cloro, Russian:хлор, Vietnamese:clo, Hindi:क्लोरीन, Bengali:ক্লোরিন, Malay:klor, Swahili:klorini, Arabic: كلور  
...
**kome** *comic (funny)* ← English:comic, French:comique, Spanish:Portuguese:cómico + Russian:комедия (komedija), Japanese:コメディ (komedi), Korean:코미디 (komidi)  
...
**kopernikium** *copernicium* ← English:French:copernicium, Spanish:copérnico, Portuguese:copernício, Russian:коперниций, Japanese:コペルニシウム, Korean:코페르니슘, Vietnamese:copernici, Malay:copernicium, Swahili:kopernici  
**kor** *core (heart, nucleus, kernel)* ← English:core, French:coeur  
**koral** *coral* ← English:Spanish:Portuguese:coral, French:corail, deu:Koralle, Russian:коралл + Malay:karang  
**korne** *horn* ← French:corne, Spanish:cuerno, Portuguese:corno, English:horn, deu:Horn + Arabic: قَرْن‎ (qarn)  
**koron** *crown* ← French:couronne, English:crown, Spanish:corona, Japanese:クラウン (kuraun), Russian:корона (korona), Portuguese:coroa  
**korse** *chair* ← Arabic:(kursiy), Hindi:कुरसी (kursī), Urdu:(kursī), Punjabi:ਕੁਰਸੀ (kursī), Telugu:(kurcī), Malay:som:kursi, Persian:(korsi)  
...
**kristejen** *Christmas* ← Greek:Χριστούγεννα (Christoúgenna)  
...
**kuane** *wide (broad)* ← Mandarin:宽 (kuān), Thai:กว้าง (kwang), Vietnamese:quảng  
...
**kuke** *cook (prepare food)* ← English:cook, deu:Kock, Italian:cuoco, Malay:koki, Thai:กุ๊ก (kuk), sango:kuku  
...
**kumar** *adolescent (yong man; maiden)* ← Hindi:कुमार (kumār), Telugu:కుమారుడు (kumāruḍu), Khmer:កុមារ (ko’maa), Thai:กุมาร (kuman)  
...
**kupe** *drinking vessel (cup, glass, mug, goblet, chalice)* ← English:cup, French:coupe, Spanish:copa, Portuguese:copo, Arabic: كُوب‎ (kūb), Turkish:kupa, Hindi:कप (kap), Japanese:コップ (koppu), Korean:컵 (keop) + Persian:(koppe), Malay:kubah, Russian:купол (kupol), deu:Kuppel  
...
**lazurite** *lapis lazuli* ← Persian:لاجورد (lājevard), English:lazuli, Spanish:lapislázuli, Russian:лазурит (lazurit), Arabic:لازورد (lāzaward), Hindi:लाजवर्द (lājavarda), Japanese:ラピスラズリ (rapisurazuri), Malay:lazuardi, Turkish:lazur taşı  
**le** *already (yet)* ← Mandarin:了 (liǎo), Cantonese:了 (liu5), Thai:แล้ว (lɛw) + Japanese:了 (ryō)  
...
**leve** *left* ← Latin:laevus, English:left; levo-, French:lévo-, Spanish:Portuguese:levo-, Russian:левый (levyy), Polish:lewy  
...
**lifafe** *wrap (wrapping, envelope, covering)* ← Arabic: لِفَافَة‎ (lifāfa), Persian:(lefâf), Hindi:लिफ़ाफ़ा (lifāfā), Bengali:লেফাফা (lephapha)  
**lige** *associate (association, league)* ← French:ligue, deu:Spanish:Polish:Portuguese:liga, English: league, Russian: лига (liga), Turkish:lig, Swahili:ligi, Japanese:リーグ (rīgu)  
**lila** *lilac* ← Turkish:leylak, Arabic:(laylak), English:lilac, French:lilas, Portuguese:lilás, Spanish:Filipino:lila, Japanese:ライラック (rairakku)  
**lime** *limit (boundary)* ← English:limit, Spanish:límite, French:Portuguese:limite, Russian:лимит (limit) + Hindi:सीमा (sīmā)  
**limfa** *lymph* ← English:lymph, Spanish:Portuguese:linfa, Russian:лимфа (límfa), Malay:limfa, Japanese:リンパ (rinpa), Mandarin:淋巴 (línbā)  
...
**line** *line (thread, string)* ← English:line, French:ligne, Spanish:línea, Portuguese:linha, Russian:линия (liniya), Polish:linia  
**lisan** *tongue* ← Arabic: لِسَان‎ (lisān), Hindi:लिसान (lisān), Swahili:lisani, Malay:Turkish:lisan, Amharic:ልሳን (ləsan)  
**lise** *smooth* ← French:lisse, Spanish:Portuguese:liso, Persian:(liz), Malay:licin  
...
**loje** *research (to study)* ← English:-ology, Spanish:-ología, French:-ologie, Russian:ология (-ologiya), Turkish:-loji  
...
**luke** *green* ← Mandarin:绿 (lǜ), Cantonese:綠 (luk6), Vietnamese:lục, Korean:록/녹 (rok/nok), Japanese: 緑色 (ryokushoku)  
**lumbe** *loin* ← French:lombes, Spanish:lomo, Portuguese:lombo + English:lumbago, Russian:люмбаго (lyumbago)  
...
**lutetium** *lutetium* ← English:lutetium, French:lutécium, Spanish:lutecio, Portuguese:lutécio, Russian:лютеций, Mandarin:镥 (lǔ), Japanese:ルテニウム, Korean:루테튬, Vietnamese:lutexi, Hindi:लुटेटियम, Bengali:লুটেসিয়াম, Malay:lutetium, Swahili:luteti, Arabic: لوتيتيوم  
**luxe** *lush* ← English:lush, French:luxe, Spanish:lujo, Portuguese:luxo, Russian:люкс (lyuks), Turkish:lüks  
**ma** *mom (mama)* ← Mandarin:妈 (mā), Vietnamese:má, Bengali:মা (ma), Hindi:मां (mã) + English:Swahili:mama, French:maman, Spanish:mamá, Portuguese:por:mãe, Russian:мама (mama), Japanese:ママ (mama), Korean:엄마 (eomma)  
**mace** *compete (match, contest)* ← English:French:match, Hindi:मैच (mɛc), Swahili:meci, Polish:mecz, Russian:матч (matč), Turkish:maç  
**madu** *honey* ← Russian:мёд (myod), Hindi:मधु (madhu), Bengali:মধু (môdhu), Malay:madu + Portuguese:mel, French:Spanish:miel + Cantonese:蜜 (mat6)  
...
**magente** *magenta (fuchsia)* ← English:magenta, Spanish:magenta, Russian:маджента (madzhenta), Arabic:ماجنتي (majinati), Hindi:मैजेंटा (maijenta), Japanese:マゼンタ (mazenta), Malay:magenta  
**magesium** *magnesium* ← English:magnesium, French:magnésium, Spanish:magnesio, Portuguese:magnésio, Russian:магний, Mandarin:镁 (měi), Japanese:マグネシウム, Korean:마그네슘, Vietnamese:magiê, Hindi:मैग्नेशियम, Bengali:ম্যাগনেসিয়াম, Malay:magnesium, Swahili:magnesi, Arabic: مغنيسيوم  
...
**maitnerium** *meitnerium* ← English:meitnerium, French:meitnérium, Spanish:meitnerio, Portuguese:meitnério, Russian:майтнерий, Japanese:マイトネリウム, Korean:마이트너륨, Vietnamese:meitneri, Hindi:मेइट्नेरियम, Bengali:মিটনেরিয়াম, Malay:meitnerium, Swahili:meitneri, Arabic: مايتنريوم  
**makal** *article (writing)* ← Arabic:مَقَال‎ (maqāl), Turkish:makale, Swahili:makala, Persian:مقاله‎ (maqâle), Malay:makalah  
**makan** *butter* ← Hindi:मक्खन (makkhan), Bengali:মাখন (makhôn)  
...
**manioke** *cassava (manioc)* ← English:French:manioc, Spanish:Portuguese:mandioca, Russian:манио́ка (manióka)  
...
**master** *master (master’s degree)* ← English:French:master, Portuguese:mestre, Russian:магистр (magistr), Malay:magister  
...
**membe** *belong (be a member)* ← English:member, Spanish:miembro, Portuguese:membro, French:membre, Japanese:メンバー (menbā)  
...
**menu** *menu* ← English:French:Portuguese:menu, Spanish:menú, Russian:меню (menyu), Japanese:メニュー (menyū), Korean:메뉴 (menyu), Hindi:मेनू (menū), Turkish:menü  
...
**migre** *move (migrate, relocate)* ← French:English:migration, Spanish:migración, Portuguese:migração, Russian:миграция (migratsiya)  
**mikre** *tiny (microscopic)* ← English:French:Spanish:Portuguese:micro-, Russian:микро- (mikro-), Japanese:マイクロ- (maikuro-), Malay:Turkish:mikr-  
...
**mire** *reflect* ← Spanish:mirar, English:admire, French:admirer + Arabic:mirʾāh, Turkish:mirat  
**misal** *example (instance of)* ← Hindi:मिसाल (misāl), Arabic:(mithāl), Persian:(mesâl), Malay:misal, Swahili:mathalani, Turkish:mesela  
**mise** *send (emit, transmit)* ← English:French:mission, deu:Mission, Spanish:misión, Portuguese:missão, Russian:миссия, Malay:misi, Filipino:misyon + Turkish:mesaj, Japanese:メッセージ (messēji), Korean:메시지 (mesiji)  
...
**mone** *money* ← English:money + French:monnaie, Spanish:Portuguese:moneda, Russian:монета  
...
**moskovium** *moscovium* ← English:French:moscovium, Spanish:moscovio, Portuguese:moscovio, Russian:московий, Japanese:モスコビウム, Korean:우눈펜튬, Vietnamese:moscovi, Malay:moskovium, Swahili:moscovi  
**motegar** *motorcar (automobile)* ← English:motorcar, sna:motokari, sot:motokara, Swahili:motokaa, Zulu:imoto, Hausa:mota  
**motesikle** *motorcycle* ← English:motorcycle, Spanish:motocicleta, French:motocyclette, Russian:мотоцикл (mototsikl), Turkish:motosiklet, Hindi:मोटरसाइकिल (moṭarasāikila), Malay:motosikal, Mandarin:摩托车 (mótuōchē), Japanese:モーターサイクル (mōtāsaikuru)  
...
**multe** *many (much)* ← Portuguese:muito, English:French:Spanish:multi-, Russian:мульти- (mulʹti-)  
...
**mun** *door (gate)* ← Korean:문 (mun), Cantonese:門 (mun), Japanese:門 (mon), Mandarin:门 (mén)  
...
**muze** *have fun (enjoy; amuse, entertain; amusement, entertainment)* ← English:amuse, French:amuser, deu:amüsieren + Persian: مزه (maze), Hindi:मज़ा (mazā), Bengali:মজা (môja)  
**muzike** *music (play music)* ← English:music, French:musique, Spanish:Portuguese:música, Russian:музика (muzika), Arabic:(mūsīqā), Swahili:muziki, Turkish:müzik, Malay:musik  
...
**namelexe** *noun* ← Mandarin:名词 (míngcí), Cantonese:名詞 (ming4 ci4), Japanese:名詞 (meishi), Korean:명사 (myeongsa), Hindi:नाम (nām), French:nom, Spanish:nombre, Portuguese:nome, Russian:имя (imya), Arabic:(ism), per:(esm), Swahili:nomino  
...
**narme** *soft* ← Persian: نرم‎ (narm), Hindi:नरम (naram), Bengali:নরম (nôrôm) + Arabic: نَاعِم‎ (nāʿim) + Thai:นุ่ม (num)  
...
**nate** *birth* ← English:French:nature, deu:Natur, Portuguese:natureza, Spanish:naturaleza  
**natrium** *sodium* ← English:sodium, French:sodium, Spanish:sodio, Portuguese:sódio, Russian:натрий, Mandarin:钠 (nà), Japanese:ナトリウム, Korean:나트륨, Vietnamese:natri, Hindi:सोडियम, Bengali:সোডিয়াম, Malay:natrium, Swahili:natiri  
...
**nepe** *cloud* ← Greek:νέφος (nephos), scr:नभस् (nábhas), Tamil:நபம் (napam) + English:nepho-, French:népho- + Spanish:nube, Portuguese:nuvem + Russian:небо (nebo)  
**nepotunium** *neptunium* ← English:neptunium, French:neptunium, Spanish:neptunio, Portuguese:neptúnio, Russian:нептуний, Mandarin:镎 (ná), Japanese:ネプツニウム, Korean:넵투늄, Vietnamese:neptuni, Hindi:नेप्ट्यूनियम, Bengali:নেপচুনিয়াম, Malay:neptunium, Swahili:neptuni, Arabic: نبتونيوم  
...
**neu** *new (recent)* ← deu:neu, English:new; neo-, French:nouveau; néo-, Spanish:nuevo; neo-, Portuguese:novo; neo-, Russian:новый (novyy); нео- (neo-), Hindi:नव (nav), Bengali:নয় (nôy); নও- (nôo-), Malay:nawa  
**neure** *nerve (neural)* ← English:Spanish:Portuguese:French:deu:neuro-, Russian:невро- (nevro-)  
...
**nis** *niche (recess, alcove)* ← French:English:niche, Portuguese:nicho, Russian:ниша (niša)  
...
**node** *tie (make knot; knot, node)* ← English:node, Spanish:nudo, Portuguese:nó, French:nœud + Vietnamese:nút  
**nome** *manage (organize)* ← English:-nomy, deu:French:-nomie, Spanish:Portuguese:-nomia, Russian:-номия (-nomiya), Malay:-nomi  
**norde** *north (northern)* ← English:north, Spanish:Portuguese:norte, deu:Nord, French:nord, Russian:норд (nord)  
**norme** *norm (standard; normal)* ← English:Spanish:Portuguese:French:deu:normal, Russian:нормальный (normalʹnyj), Persian:نرمال‎ (normâl)  
**noste** *homecoming* ← ← English:Portuguese:Spanish:nostalgia, French:nostalgie, deu:Nostalgie, Russian:ностальгия (nostalʹgiya), Japanese:ノスタルジー (nosutarujī), Persian:(nostâlži)  
**note** *note (observation, remark, comment; notice, observe)* ← deu:English:French:note, Spanish:Portuguese:nota, Turkish:not, Japanese:ノート (nōto), Korean:노트 (noteu), Persian:(not)  
**nove** *nine (9)* ← French:neuf, Spanish:nueve, Portuguese:nove, Persian: نُه‎ (noh), Hindi:नौ (nau), Bengali:নয় (nôy), Malay:nawa  
**nude** *naked (bare, nude)* ← English:nude, Spanish:desnudo, Portuguese:French:nu + Russian:нудизм (nudizm), Japanese:ヌーディズム (nūdizumu)  
**nuke** *neck (nape)* ← English:neck, Spanish:Portuguese:nuca, French:nuque, spa:por:nuca + Arabic:عُنُق‎ (ʿunuq)  
**nume** *number (count; enumerate)* ← English:number, French:nombre, Spanish:Portuguese:número, Russian:номер (nomer), deu:Nummer, Japanese:ナンバー (nanbā), Hindi:नंबर (nambar), Bengali:নম্বর (nômbôr), Turkish:numara, Malay:nombor, Swahili:namba(ri)  
...
**onor** *respect (honor, esteem)* ← English:Polish:Spanish:honor, French:honneur, Portuguese:honra, Turkish:onur + Russian:гонор (gonor)  
...
**orde** *army* ← Turkish:ordu, Persian: اردو (ordu) + English:French:horde, Spanish:Portuguese:horda, Russian:орда (orda), Mandarin:斡耳朵 (wò'ěrduǒ), zho:オルド (orudo), Korean:오르도 (oreudo) + Arabic: عُرْضِيّ‎ (ʿurḍiyy)  
...
**orte** *straight* ← English:French:ortho-, Spanish:Portuguese:orto-, Russian:орто- (orto-)  
**ose** *abundant (-ous)* ← English:French:-s + Spanish:Portuguese:-oso  
...
**ove** *egg* ← French:oeuf, Spanish:huevo, Portuguese:ovo + English:Turkish:oval, Russian:овал (oval)  
...
**pa** *dad (papa)* ← English:French:papa, Spanish:papá, Russian:папа (papa), Arabic:(bābā), Mandarin:爸爸 (bàba), Japanese:パパ (papa), Korean:아빠 (appa), Vietnamese:ba/bố, Hindi:बाप (bāp), Bengali:বাবা (baba), Malay:bapa, Swahili:Turkish:baba  
**pace** *peace* ← Italian:pace, English:peace, Spanish:Portuguese:paz, French:paix  
**pade** *fall down (drop down)* ← Russian:падать (padat') + Hindi: पड़ना (paṛnā), Bengali:পড়া (pôŗa), Telugu:పడు (paḍu)  
...
**pakse** *bird* ← Hindi:पक्षी (pakṣī), Bengali:পাখী (pakhī), Telugu:(pakṣi), Khmer:បក្សី (baksəy), Thai:ปักษา (pak-sa)  
...
**parce** *shatter (break; fragment, morsel, crumb, shard)* ← Persian:(parče), Turkish:parça, Hindi:पारचा (pārcā), English:part, Portuguese:Spanish:parte  
**pare** *even (level, peer, equal)* ← English:peer, French:pair, Spanish:Portuguese:par, deu:Pere, Hindi:बराबर (barābar), Persian:Urdu: برابر‎ (barâbar)  
...
**pas** *pass (go across or through)* ← English:pass, Spanish:pasar, Portuguese:passar, French: passer + Russian:паспорт (pasport), Hindi:पासपोर्ट (pāsporṭ), Bengali:পাসপোর্ট (pasporṭ), Malay:paspor, Swahili:paspoti, Japanese:パスポート pasupōto)  
...
**pate** *ill (sick)* ← deu:English:French:patho-, Spanish:Portuguese:Polish:Turkish:Malay:pato-, Russian:пато- (pato-)  
**pau** *gun (firearm)* ← Mandarin:炮 (pâo), Cantonese:炮 (paau3), Vietnamese:pháo, Korean:포 (po), mon:буу (buu)  
**pauze** *pause (break)* ← deu:Pause, English:deu:French:pause, Spanish:Portuguese:pausa, Russian:пауза (pauza)  
...
**pexe** *fish* ← Portuguese:peixe, Spanish:pez + deu:Fisch, English:fish  
...
**picea** *spruce tree* ← Spanish:Portuguese:pícea, French:épicéa  
...
**plasme** *plasma (ionized gas)* ← English:plasma, Spanish:plasma, Russian:плазма (plazma), Arabic:بلازما (balazima), Hindi:प्लाज़्मा (plaazma), Japanese:プラズマ (purazuma), Malay:plasma  
**plaste** *mold (shape)* ← English:plastic, Spanish:Portuguese:plástico, Russian:пластик (plastik), Turkish:Malay:plastik, Swahili:plastiki, Arabic:بلاستيك (blastīk), Hindi:प्लास्टिक (plāsṭik), Japanese:プラスチック (purasuchikku), Korean:플라스틱 (peullaseutik)  
**plate** *plane (plate)* ← English:plate, Spanish:Portuguese:placa, deu:Platte, Russian:пластина (plastina)  
**platinium** *platinum* ← English:platinum, French:platine, Spanish:platino, Portuguese:platina, Russian:платина, Mandarin:铂 (bó), Vietnamese:platin, Hindi:प्लाटिनम, Bengali:প্লাটিনাম, Malay:platina, Swahili:platini, Arabic: بلاتين  
**ploze** *clap* ← English:French:explosion, Spanish:explosión, Portuguese:exploção, Russian:имплозия (imploziya), Malay:eksplosi  
**plum** *plum (prune)* ← English:plum, deu:Pflaume, Japanese:プラム (pulamu) + French:prune, Spanish:pruna  
...
**poke** *poker* ← English:poker, Mandarin:扑克 (pūkè), Japanese:ポーカー (pōkā), Korean:포커 (pokeo), Vietnamese:pôke  
**polau** *pilaf (pulao)* ← Persian:(polou), Hindi:पुलाव (pulav), Turkish:pilav, Russian:плов (plov)  
**poli** *many (much, more than one; poly-, multi-)* ← Greek:πολλοί (polloí), English:French:deu:poly-, Spanish:Portuguese:poli-, Russian:поли- (poli-)  
...
**porta** *port (station)* ← English:port, French:porte, Spanish:puerto, Portuguese:porto, Russian:порт (port), Hindi:पोर्ट (porṭ), Urdu:(porṭ), Bengali:পোর্ট (porṭ), Thai:พอร์ต (phot)  
...
**poste** *mail (send by mail)* ← English:post, Portuguese:postagem, French:poste, Russian:почта (pochta), Arabic:بوسطة‎ (busṭa), Swahili:posta, Malay:pos  
**pote** *pot (vase, bin, jar, jug, pitcher, carafe, amphora)* ← English:French:pot, Spanish:Portuguese:pote, Malay:poci, Japanese:ポット (potto), Korean:포트 (poteu)  
...
**prasedium** *praseodymium* ← English:praseodymium, French:praséodyme, Spanish:praseodimio, Portuguese:praseodímio, Russian:празеодим, Japanese:プラセオジム, Korean:프라세오디뮴, Vietnamese:prazeođim, Hindi:प्रासियोडाइमियम, Bengali:প্র্যাসেওডিমিয়াম, Malay:praseodinium, Swahili:praseodimi, Arabic: براسوديميوم  
...
**probe** *try (attempt, test, give a go, check out, probe)* ← deu:Probe, English:prove; probe, Spanish:probar, Portuguese:provar, Russian:проба  
...
**pude** *rotten* ← English:putrid, Spanish:Portuguese:podre, French:putride + Mandarin:腐 (fǔ), Japanese:腐 (fu) + Thai:ผุ (phu)  
...
**puje** *worship (revere; reveration)* ← Hindi:पूजा (pūjā), Urdu:(pūjā), Thai:บูชา (bucha), Malay:puja  
...
**pulse** *push (thrust)* ← English:push; pulse, French:pousser + Spanish:Portuguese:impulso, Russian:импульс (impul's)  
...
**pure** *full (complete, saturated)* ← Hindi:पूर्ण (pūrn), Bengali:পূর্ণ (pūrṇa), Punjabi:ਪੂਰਾ (pūrā), Persian:(por)  
...
**putavorange** *grapefruit* ← English:grapefruit, Mandarin:葡萄柚  
**pute** *put (arrange, set into a certain relation, state or condition)* ← English:computer, Spanish:computadora, Portuguese:computador, Russian:компьютер (komp’uter), Arabic:كَمْبْيُوتَر‎ (kambyūtar), Swahili:kompyuta, Hindi:कंप्यूटर (kampyūṭar), Bengali:কম্পিউটার (kômpiuṭar), Malay:komputer, Japanese:コンピューター (konpyūtā)  
**putonge** *common (general)* ← Mandarin:普通 (pǔtōng), Cantonese:普通 (pou2tung1), Vietnamese:phổ thông, Korean:보통 (botong)  
...
**rate** *make sense (reason)* ← lat:ratio, English:rational, French:rationnel, Spanish:Portuguese:racional + deu:Rat, Polish:rada, Russian:рада (rada)  
**ratibe** *order (arrange)* ← Arabic: رَتَّبَ (rattaba), Swahili:ratibu, Hausa:rattaba, Persian: ترتيب (tartīb), Hindi:तरतीब (taratība), Malay:tertib, Turkish:tertip  
**reje** *reign* ← English:reign, French:régner, Spanish:Portuguese:reinar + Hindi:राजा (rājā), Bengali:রাজা (raja), Tamil:ராஜா (rājā), Malay:raja  
**rel** *real (genuine)* ← English:Spanish:Portuguese:real, French:réel, Russian:реальный  
...
**rentogenium** *roentgenium* ← English:roentgenium, French:roentgenium, Spanish:roentgenio, Portuguese:roentgênio, Russian:рентгений, Mandarin: (lún), Japanese:レントゲニウム, Korean:뢴트게늄, Vietnamese:roentgeni, Hindi:रॉन्टजैनियम, Bengali:রোয়েন্টজেনিয়াম, Malay:roentgenium, Swahili:roentgeni, Arabic: رونتجينيوم  
...
**rice** *rich* ← English:rich, French:riche, Portuguese:Spanish:rico  
...
**rite** *custom (tradition, practice, convention; conventional, customary, traditional)* ← Hindi:रीति (rīti), Bengali:রীতি (rīti) + English:French:rite, Spanish:Portuguese:rito  
...
**romante** *romance (romantic love)* ← French:English:Spanish:Portuguese:romance, Russian:роман (roman), Turkish:romans, Malay:roman, Japanese:ロマンス (romansu), Korean:로맨스 (romaenseu)  
**rose** *dew* ← French:rosée, Spanish:rocío, Russian:роса (rosa)  
**roste** *roast* ← French:rôtir, English:roast, deu:rösten, Italian:arrostare  
**rote** *wheel* ← Spanish:Portuguese:Malay:roda + English:rotate, deu:rotieren, French:rotationner, Turkish:rotasyon  
...
**rubidium** *rubidium* ← English:rubidium, French:rubidium, Spanish:rubidio, Portuguese:rubídio, Russian:рубидий, Mandarin:铷 (rú), Japanese:ルビジウム, Korean:루비듐, Vietnamese:rubiđi, Hindi:रुबिडियम, Bengali:রুবিডিয়াম, Malay:rubidium, Swahili:rubidi, Arabic: روبيديوم  
...
**rul** *roll (scroll, coil)* ← English:roll, French:rouler, deu:aufrollen  
**rum** *rum* ← English:rum, Spanish:ron, Hindi:रम (ram), Russian:ром (rom)  
**rupe** *appearance (looks; seem)* ← Hindi:रूप (rūp), Malay: rupa, Thai: รูป (rūp), Khmer:រូប (rūp)  
**rute** *burst (split, break, rupture)* ← English:French:rupture, Spanish:rotura, Portuguese:rutura + Russian:банкрот (bankrot), Malay:bangkrut  
...
**sababe** *reason (cause)* ← heb:(sibá), Hausa:sabo;sababi, Kongo:sambu, Arabic:Urdu:(sabab), Turkish:sebep, Malay:sebab, Swahili:sababu  
**sabe** *know (know how, savvy)* ← French:savoir, Spanish:Portuguese:saber, English:savvy, pcm:sabi  
...
**sade** *plain (ordinary, unadorned, simple, mere)* ← Turkish:sade, Persian:(sāde), Hindi:सादा (sādā)  
...
**safe** *clean (pure; purify)* ← Swahili:safi, Hindi:साफ़ (sāf), Urdu:(sāf), Bengali:চাফা (sapha)  
...
**sage** *tale (story, legend, saga; tell, narrate)* ← English:Spanish:Portuguese:Malay:saga, deu:Sage, Russian:сага (saga)  
...
**sahe** *right (correct, accurate)* ← Hindi:सही (sahī), Urdu:(sahī), Persian:(sahih), Arabic:(ṣaḥīḥ), Swahili:sahihi, Malay:sah  
...
**sam:** *same (equal, match)* ← English:same, French:semblable, Russian:самый (samyy), Malay:sama, Hindi:सम (sam)  
...
**sanduke** *box (chest)* ← Russian:сундук (sunduk), Arabic: صُنْدُوق‎ (ṣundūq), Persian:Urdu:صندوق‎ (sanduq), Swahili:sanduku, Turkish:sandık  
...
**sapate** *shoe* ← Spanish:zapato, Portuguese:sapato, Malay:sepatu, Swahili:sapatu  
...
**sel** *advice (recommend)* ← Arabic: صَلَاح‎ (ṣalāḥ), Hindi:सलाह (salāh), Telugu:సలహా (salahā), Turkish:salık + English:counsel, French:conseil, Spanish:consejo, Portuguese:conselho + Russian:консультант (konsultant)  
...
**sere** *series (sequence, succession)* ← English:series, French:série, Spanish:serie, Russian:серия (seriya), Turkish:seri + Hindi:सिलसिला (silsilā), Arabic:(silsila), tur:silsile, Swahili:silisili, Persian: سلسله‎ (selsele) + Mandarin:系列 (xìliè)  
...
**serve** *serve (service)* ← English:French:service, Portuguese:serviço, Russian:сервис (servis), Turkish:servis, Hindi:(sevâ)  
...
**side** *sit* ← Russian:сидеть (sidet'), English:sit, deu:sitzen, Italian:sedere + Spanish:Portuguese:presidente, Persian: پرزیدنت‎ (perezident), Malay:presiden  
...
**sigare** *cigarette (cigar)* ← English:French:cigarette, Spanish:cigarillo, Portuguese:cigarro, Russian:сигарета (sigarteta), Arabic:(sījāra), Mandarin:雪茄 (xǔejiā), Wu-Chinese:雪茄 (xi'gá), Hindi:सिगरेट (sigreṭ), Bengali:সিগারেট (śigareṭ), Swahili:Turkish:sigara, Amharic:ሲጃራ (siǧara)  
...
**sine** *sign (signal, indication)* ← English:sign, Spanish:señal, Portuguese:sinal, French:signe  
...
**sir** *secret (hidden; hide, conceal)* ← Arabic: سِرّ (sirr), Hindi:सेर (ser), Malay:sir, Swahili:siri, Hausa:Fulani:asiri, Yoruba:àṣírí, Turkish:sır, Persian:(serr)  
...
**sive** *citizen* ← English:French:Spanish:Portuguese:civil, por:civil, Hindi:सिविल (sivil), Malay:sipil  
**sixe** *six (6)* ← English:French:six, Spanish:Portuguese:seis, deu:sechs, Russian:шесть (shest’), Persian: شِش‎ (šeš) + Arabic:ستة‎ (sitta), Swahili:sita, Hausa:shidà  
**skale** *stairs (ladder; scale)* ← Spanish:Portuguese:escalar + French:escalier + English:scale, deu:Skale, Russian:шкала (škala)   
...
**skerte** *skirt* ← English:skirt, Hindi:स्कर्ट (skarṭ), Bengali:স্কার্ট (śkarṭ), Japanese:スカート (sukāto), Korean:스커트 (seukeoteu), Swahili:sketi, Hausa:siket  
...
**skulte** *sculpt* ← English:sculpt, Spanish:esculpir, French:sculpteur, Portuguese:escultor, Russian:скульптор (skulptor)  
**skute** *scoot (ride a scooter, move while sitting)* ← English:French:Spanish:scooter, Russian:скутер (skuter), Mandarin:速克达 (sùkèdá), Japanese:スクーター (sukūtā), Korean:스쿠터 (seukuteo), Vietnamese:xe xcutơ, Hindi:स्कूटर (skūṭar), Bengali:স্কুটার (śkuṭar), Malay:skuter  
**soce** *socialize (interact)* ← English:socialize + Spanish:sociedad, Russian:социум (socium)  
**sofa** *sofa (couch)* ← English:French:sofa, Spanish:Portuguese:sofá, Russian:софа (sofa), Mandarin:沙发 (shāfā), Japanese:ソファ (sofa), Korean:소파 (sopa), Vietnamese:xô pha, Hindi:सोफ़ा (sofā)  
**sofe** *wise* ← Greek:σοφία (sofía) + English:philosophy, French:philosophie, Spanish:filosofia, Russian:философия (filosofiya), Malay:filsafat, Arabic:(falsafa), Swahili:falsafa, Turkish:felsefe, Hindi:फ़लसफ़ा (falasfā)  
**soge** *search (seek, look for)* ← Mandarin:搜 (sōu), Cantonese:索 (sok3), Wu-Chinese:搜 (seu1), Japanese:捜索 (sōsaku) + English:seek, deu:suchen, Polish:szukać, ukr:шукати (šukati) + Russian:искать (iskat’)  
...
**sponje** *sponge* ← English:sponge, Spanish:Portuguese:esponja, Arabic:إسفنج (ʾisfanj), Persian:اسفنج‎ (esfanj), Hindi:स्पंज (spanja), Japanese:スポンジ (suponji), Malay:spon, Swahili:sponji  
...
**state** *stand still* ← Turkish:istasyon, Portuguese:estação, Spanish:estación, Filipino:estasyon, Urdu:(isṭeśan), English:French:station, Hindi:स्टेशन (sṭeśan), Russian:станция (stantsiya)  
...
**suke** *pleased (delighted, happy)* ← Hindi:सुखी (sukhī), Japanese:好き (suki), Thai:สุข (suk) + jpn:好く (suku), Malay: suka  
**sulfe** *sulfur (brimstone)* ← English:sulfur, French:soufre, Spanish:azufre, Portuguese:enxofre, Swahili:sulfuri  
**sultan** *sultan* ← Arabic:سلطة (sulṭa), English:Turkish:Malay:sultan, Spanish:sultán, Russian:султан (sultan), Persian:سلطان‎ (soltân), Hindi:सुल्तान (sultān), Bengali:সুলতান (śultan), Swahili:sultani  
**sum** *sum (total; sum up, add together)* ← English:sum, Spanish:suma, Portuguese:soma, French:somme, deu:Summe, Russian:сумма (summa)  
**supe** *soup (stew)* ← Spanish:sopa, English: soup, French: soupe, deu: Suppe, Swahili: supu, Russian:суп (sup), Malay:sup, Japanese:スープ (sūpu)  
**supre** *upper* ← English:super, French:super, Spanish:Portuguese:sobre, Italian:sopra, Japanese:スーパー (sūpā)  
...
**sus** *licorice* ← Arabic: سُوس (sus), Spanish:alcazus, Portuguese:alcaçuz, Swahili:susi  
...
**sute** *sew* ← Hindi:सीना (sīnā), Russian:шить (šit') + French:English:suture, Portuguese:Spanish:sutura  
**sutre** *codex (ancient book, classic, sutra)* ← Hindi:सूत्र (sūtra), Malay:sutera, English:French:Spanish:Portuguese:sutra, Russian:сутра, Japanese:スートラ (sūtora), Korean:수트라 (suteura)  
**suxi** *sushi* ← Japanese:寿司 (sushi), English:Spanish:sushi, Russian:су́ши (sushi), Turkish:suşi  
**ta** *to (toward, till, until, for)* ← English:to + Hindi:-तक (-tak) + Persian: تا‎ (tâ)  
...
**tame** *greedy* ← Arabic: طَمَّاع‎ (ṭammāʿ), Mandarin:贪 (tān), Korean:탐욕 (tamyok), Vietnamese:tham  
...
**tanur** *oven (furnace)* ← Arabic: تَنُّور‎ (tannūr), Persian: تنور (tannūr), Hindi:तनूर (tanūr), Bengali:তন্দুর (tôndur), Swahili:tanuri, Turkish:tandır + English:tandoor  
**tape** *stop (obsruct, block; plug, stopper, cap, peg, tap)* ← Spanish:Turkish:tapa, Portuguese:tampa, Greek:τάπα (tapa), bul:тапа (tapa), English:tap  
...
**tas** *dish (bowl)* ← Arabic: طَاس (ṭās), Swahili:tasa, Turkish:tas, French:tasse, Spanish:taza, Russian:таз + Hindi:तश्तरी (tashtarī)  
**tate** *touch (tact)* ← English:French:tact, Spanish:tacto, Portuguese:tato  
**tatike** *tactics (strategy)* ← Portuguese:tática, Italian:tattica, English:tactic, Russian:тактика (taktika), deu:Taktik  
**tato** *tattoo* ← sam:tah:tatau, haw:kākau, Malay:Filipino:tato, English:tattoo, French:tatouage, Spanish:tatuaje, Portuguese:tatuagem, Russian:тату (tatu)  
**tave** *frying pan* ← Hindi:तवा (tavā), Turkish:tava, Persian:(tābe)  
**taxe** *fee (fare)* ← English:tax, Portuguese:taxa, Spanish:tasa, Hindi:टैक्स (ṭEks)  
**taze** *fresh (new)* ← Persian: تازه (tâze), Hindi:ताज़ा (tāzā), Bengali:তাজা (taja), Turkish:taze, Arabic: طَازَج (ṭāzaj)  
...
**tehnium** *technetium* ← English:technetium, French:technétium, Spanish:tecnetio, Portuguese:tecnécio, Russian:технеций, Mandarin:锝 (dé), Japanese:テクネチウム, Korean:테크네튬, Vietnamese:tecnexi, Hindi:टेक्निशियम, Bengali:টেকনিসিয়াম, Malay:teknetium, Swahili:tekineti, Arabic: تكنيتيوم  
...
**tense** *tight (tense; tighten)* ← English:tense, French:tendu, Spanish:Portuguese:tenso  
**tente** *tempt (entice)* ← English:tempt, French:tenter, Spanish:Portuguese:tentar  
...
**tepe** *tape* ← English:tape, Hindi:टेप (ṭep), Swahili:tepu, Japanese:テープ (tēpu), Korean:테이프 (teipeu), Turkish:teyp  
...
**terce** *oblique (askew, tilted)* ← Spanish:torcido, Portuguese:torto, Hindi:तिरछा (tirachha), Bengali:তেরছা (tērachā), pan:तिरकस (tirakasa)  
**tere** *fear (fright)* ← English:Spanish:Portuguese:terror, French:terreur + Russian:терроризм (terrorizm), Japanese:テロリズム (terorizumu), Korean:테러리즘 (tereorijeum), Malay:terorisme  
...
**tire** *shoot (fire)* ← French:tirer, Spanish:Portuguese:tirar + Persian: تیر (tir), Hindi:तीर (tīr), Bengali:তীর (tir)  
...
**toxe** *poison (venom; toxic, poisonous, venomous)* ← English:toxic, French:toxique, Spanish:Portuguese:tóxico, Russian:токсичний (toksicniy), Malay:toksik + Mandarin:毒 (dú), Cantonese:毒 (duk6), Wu-Chinese:毒 (do’), Japanese:毒 (doku/toku), Korean:독 (dok), Vietnamese:độc  
**tra** *through* ← Italian:tra, English:through, Spanish:tras, Portuguese:(a)trás, French:deu:Malay:trans-, Russian:транс- (trans-)  
**trage** *sad (tragic)* ← English:tragic, French:tragique, Spanish:Portuguese:trágico, Russian:трагический (tragičeskij)  
...
**trompe** *bugle (horn instrument)* ← Spanish:Portuguese:trompa, English:trumpet, French:trompette, Japanese:ランペット (torampetto), Korean:트럼펫 (teureompet), Turkish:trompet, Swahili:tarumbeta  
...
**tu** *you (singular)* ← French:Portuguese:Spanish:tu, Hindi:तू (tū), Russian:ты (ty)  
...
**tuhe** *spit* ← Hindi: थूकना (thūknā), Mandarin: 吐 (tǔ), Turkish:tükürmek  
...
**unale** *each other (one another, mutually; mutual)* ← English:one another, Italian:l’una, l’altra, French: l'un l'autre, Spanish:el uno al otro, Portuguese:um ao outro, Turkish:birbirine, Mandarin:彼此 (bǐcǐ)  
...
**vacin** *vaccine* ← English:vaccine, Portuguese:vacina, Russian:вакцина (vakcina), Hindi:वैक्सीन (vaiksīn), Japanese:ワクチン (wakuchin), Malay:vaksin  
...
**vare** *various (diverse, miscellaneous)* ← English:various, Spanish:vario, Portuguese:vário  
...
**vate** *thing (object, item, matter)* ← Hindi:वस्तु (vastu), Bengali:বস্তু (bôstu), pan:ਵਸਤੁ (vastu), Thai:วัสดุ (wạttu), Burmese:ဝတ္ထု (wathtu), Khmer:វត្ថុ (vŏəttho) + Vietnamese:vật, Wu-Chinese:物 (veq5), Mandarin:物 (wù), Cantonese:物 (mat6), Japanese:物 (butsu)  
...
**vere** *true (real, genuine)* ← English:very, Italian:vero, Russian:верный (verniy), Spanish:verdadero, Portuguese:verdadeiro, deu:wahr, French:vrai  
**verme** *worm* ← English:worm, French:ver, Spanish:Portuguese:verme + Japanese:ワーム (wāmu)  
...
**vile** *farmhouse (villa)* ← English:French:Spanish:Turkish:villa,Portuguese:vila,  Russian:вилла (villa), Japanese:ビラ (bira), Korean:빌라 (billa)  
...
**viole** *violin (fiddle)* ← English:violin, French:violon, Spanish:violín, Portuguese:violino, Malay:biola, Hindi:वायलिन (vāylin), Japanese:バイオリン (baiorin), Korean:바이올린 (baiollin) + Russian:виолончель (violončel’)  
**violete** *purple (violet)* ← English:Portuguese:French:violet, Spanish:violeta, deu:violett, Russian:фиолетовый (fioletovyy), Japanese:バイオレット (baioretto), Korean:보라 (bola)  
...
**vise** *vice (deputy, substitute, replacement)* ← English:French:Spanish:Portuguese:vice-, Russian:вице- (vitse-), deu:vize-  
...
**vizin** *MSG (monosodium glutamate)* ← Mandarin:味精 (wèijīng), Cantonese:味精 (mei6 zing1), Vietnamese:mì chính, Malay:vetsin, micin, Filipino:bitsin  
**vode** *promise (vow, oath, pledge)* ← French:vœu, Spanish:Portuguese:voto, Arabic:وعد (waʿd), Hindi:वादा (vādā), Turkish:vaat, Persian:وعده (va'deh)  
...
**vol** *want (desire, wish; longing)* ← French:voiloir, Italian:volere, deu:wollen, English:volition, Spanish:voluntad, Russian:воля (volya), Polish:wola  
...
**xam:** *evening* ← Persian: شام‎ (šâm), Hindi:शाम (śām), Bengali:শাম (śam), Turkish:akşam  
...
**xir** *poem* ← heb:שיר (šir), Arabic: شِعْر‎ (šiʿr), Turkish:şiir, Persian: شعر‎ (še'r), Swahili:shairi, Malay:syair+ Mandarin:诗 (shī), Cantonese:詩 (si1), Japanese:詩 (shi), Korean:시 (shi)  
...
**xiu** *little (small; a little, somewhat)* ← Mandarin:小 (xiǎo), Cantonese:小 (siu2), Japanese:小 (shō), Korean:소 (so), Vietnamese:tiểu  
**xix** *skewer* ← Turkish:şiş + English:shish-, Russian:шиш- (šiš-)  
**xofe** *drive (steer)* ← French:English:deu:chauffeur, Spanish:Portuguese:chofer, Russian:шофёр (šofjor), Polish:szofer, Thai: โชเฟอร์ (chofoe), Turkish:şoför, Persian:(šofer)  
...
**xule** *learn (study)* ← Mandarin:学 (xué) + deu:Schule, Swahili:shule + English:school, French:école, Spanish:escuela, Portuguese:escola, Russian:школа (škola), Hindi:स्कूल (skūl), Bengali:স্কুল (śkul), Malay:sekolah  
...
**zoe** *animal (beast)* ← English:French:Spanish:Portuguese:Malay:Turkish:zoo-, Russian:зоо- (zoo-) + Mandarin:兽 (shòu), Cantonese:獸 (sau3), Japanese:獣 (jū), Korean:수 (su)  
...
**zor** *force (violence)* ← Hindi:ज़ोर (zor), Bengali:জোর (zor), Persian: زور (zur)  
**zukam** *cold (common cold)* ← Arabic:زُكَام‎ (zukām), Hindi:ज़ुकाम (zukām) + Mandarin:感(冒) (gǎn(mào)), Japanese:感(冒) (kan(bō)), Korean:감(기) (gam(gi)), Vietnamese:cảm  
...
**• konike** *common (shared)* ← English:common, Spanish:común, Portuguese:comum, French:commun, Russian:коммунальный (kommunal’nyy)  
**• kopiaje** *copy (duplicate, replica)* ← English:copy, French:copie, Spanish:Portuguese:copia, Russian:копия (kopiya), Hindi:कापी (kāpī), Turkish:kopya, Malay:kopi, Mandarin:拷貝 (kǎobèi), Japanese:コピー (kopī)  
