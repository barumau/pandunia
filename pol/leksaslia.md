...
**a kon** *razem (wspólnie)* ← zho:共 (gòng), yue:共 (gung4), kor:공 (gong), vie:cộng, jpn:共 (kyō-), eng:fra:spa:por:con-  
...
**arme** *broń* ← eng:arms, fra:arme, spa:por:arma + rus:армия (armiya), hin:आर्मी (ārmī)  
...
**Atlante Hai** *Ocean Atlantycki* ← eng:Atlantic, spa:Atlántico, por:Atlântico, rus:Атлантический океан (Atlanticheskyy okean), swa:Atlantiki  
...
**axe** *oś* ← eng:axis, fra:axe, por:eixo, hin:अक्ष (akṣ), tel:అక్షము (akṣamu), tur:eksen  
...
**bade** *ciało* ← eng:body + ara:  بَدَن‎ (badan), fas: بدن‎ (badan), hin:बदन (badan), may:badan, tur:beden, swa:badani  
...
**bana** *strzała (bełt)* ← hin:बाण (bāṇ), tel:బాణము (bāṇamu), may:panah  
...
**bandir** *flaga, sztandar* ← eng:banner, fra:bannière, spa:bandera, por:bandeira, may:swa:bendera, tgl:bandila  
...
**barxe** *deszcz (padać, lać)* ← fas: باران‎ (bârân), hin:बारिश (bāriś), ben:বৃষ্টি (briśṭi), tur:baran  
...
**baze** *podstawa (baza, fundament, dół, spód; bazowy; zakładać, założyć, ustanowić)* ← eng:fra:por:spa:base, deu:Basis, rus:база (baza)  
...
**bil** *móc, umieć* ← tur:bilmek + eng:-bility, fra:-bilité, spa:-bilidad, por:-bilidade  
...
**brun** *brązowy (koloru kawy)* ← eng:brown, fra:brun + ara: بُنِّيّ‎ (bunniyy) + hin:भूरा (bhūrā)  
...
**bufon** *głupiec, bufon* ← spa:por:bobo, kor:바보 (babo)  
...
**cang** *warstwa (poziom, piętro, kondygnacja)* ← zho:层 (céng), yue:層 (cang4), kor:층 (cheung), vie:tầng + min:棧 (chàn) + khm:ជាន់ (cŏən) , tha:ชั้น (chan)  
**canse** *szansa* ← fra:eng:spa:por:chance, jpn:チャンス (chansu), kor:찬스 (chanseu), rus:шанс (šans), tur:şans, hin:चांस (cāns)  
**cante** *śpiewać (piosenka, pieśń)* ← fra:chanter, eng:chant, por:spa:cantar, + zho:唱 (chàng), yue:唱 (coeng3), kor:창 (chang)  
...
**catre** *cztery (4)* ← rus:четыре (chetyre), hin:चार (cār), ben:চার (car), may:catur + fra:quatre, spa:cuatro, quatro  
...
**ceng** *dorosły, dojrzały* ← zho:成 (chéng), yue:成 (sing4), jpn:成 (sei), kor:성 (seong) + khm:ឆ្អិន (chʼən)  
...
**cin** *rodzic (matka lub ojciec)* ← zho:亲 (qīn), yue:親 (can1)  
**cina** *han chiński* ← hin:चीनी (cīnī), tur:Çin, ara:(ṣiniy), spa:chino, eng:Chinese, tha:จีน (chin), zho:秦 (qín)  
...
**cope** *motyka* ← zho:锄 (chú), yue:鋤 (co4), tha:จอบ (chop), tur:çapa + eng:chop  
**core** *kraść (ukraść; kradzież)* ← hin:mar:चोरी (corī), urd:(corī), tha:โจร (chon), may:curi, ben:চুরি (curi)  
**Cosen** *Korea* ← kor:조선 (Joseon), jpn:朝鮮 (chōsen), zho:朝鲜 (zh) (Cháoxiǎn)  
**cuke** *dotyczyć* ← zho: 触 (chù), yue:觸 (cuk1), jpn:触 (shoku), kor:촉 (chok) + hin: छूना (chūnā), pnb:ਛੂਹਣਾ (chūhṇā)  
**cum** *całus* ← hin:चूमना (cūmnā), urd:(cūmnā), mal:ചുംബനം (cumbanaṃ), may:cium, jpn:チュー (chū), tha:จูบ (cup)  
**cupe** *ssać* ← spa:por:chupar, khm:ជប់ (cup) + hin:चूसना (cūsnā)  
...
**dane** *ziarno (nasienie)* ← fas: دانه‎ (dāna), hin:दाना (dānā), tur:tane + jpn:種 (tane) + zho:弹 (dàn), vie:đạn, kor:탄알 (tanal)  
**dang** *dzwon (dzwonek; dzwonić, dźwięczeć, szczękać)* ← eng:dong + fas: زنگ‎ (zang), tur:çan + zho:钟 (zhōng), yue:鐘 (zung1), kor:종 (jong), vie:chuông, khm:ចួង (cuəng) + rus:звон (zvon)  
...
**dar** *latać (fruwać)* ← hin:धारा (dhārā), tel:ధార (dhāra) + fas: دریا‎ (daryâ), hin:दर्या (daryā), ben:দরিয়া (dôriẏa), tur:derya  
**darge** *stopień, poziom, ranga, klasa* ← ara:(daraja), hin:दर्जा (darjā), swa:daraja, tur:derece, fas:(dareje), may:derajat, + zho:阶 (jiē)  
**darmesitium** *darmsztadt* ← eng:darmstadtium, fra:darmstadtium, spa:darmstatio, por:darmstádio, rus:дармштадтий, zho: (dá), jpn:ダームスタチウム, kor:다름슈타튬, vie:darmstadti, hin:डार्म्स्टेडशियम, ben:ডারমস্টাডটিয়াম, may:darmstadtium, swa:darmstadti, ara: دارمشتاتيوم  
...
**dele** *czekać* ← eng:delay, fra:délai + hin:देरी (derī), urd: دیر‎ (der)  
...
**domino** *domino* ← eng:dominoes, spa:por:dominó, fra:dominos, rus:домино (domino), zho:多米诺 (duōmǐnuò), jpn:ドミノ牌 (dominohai)  
...
**dunjia aventur** *przygoda w lochu* ← eng:dungeon, fra:donjon, jpn:ダンジョン (danjon)  
...
**eme** *pierwiastek (jednostki podstawowej)* ← eng:-eme, spa:por:-ema, fra:-ème, rus:-ема (-ema), may:-em  
**emote** *czuć, odczuć, odczuwać* ← eng:emotion, fra:émotion, spa:emoción, por:emoção, rus:эмоция (emociya), may:emosi, tgl:emosyon  
...
**fixe** *przyczepić, przymocować* ← eng:fix, fra:fixer;ficher, spa:fijar, por:fixar, deu:fixieren  
...
**fokus** *skupienie (koncentracja; skupić, się, skoncentrować się)* ← eng:focus, spa:por:foco, deu:Fokus, rus:фо́кус, fas:فوکوس‎ (fokus)  
...
**futebol** *piłka nożna* ← eng:fra:football, spa:fútbol, por:futebol, deu:Fußball, hin:फ़ुटबॉल (fuṭbŏl), urd:(fuṭ bāl), ben:ফুটবল (phuṭbôl), rus:футбол (futbol), tha:ฟุตบอล (th) (fút-bɔn), jpn:フットボール (futtobōru), zul:ibhola  
...
**gate** *twardy* ← tel:గట్టి (gaṭṭi), hin:कड़ा (kaṛā) + jpn:硬い (katai) + tur:katı  
...
**glas** *szkło* ← dei:Glas, eng:glass, + fas: گیلاس‎ (gilâs), hin:गिलास (gilās), ben:গ্লাস (glaś), jpn:グラス (gurasu), kor:글라스 (geullaseu), may:gelas, swa:glasi + rus:глазурь, spa:glasear  
...
**grane** *cząstka* ← eng:fra:grain, spa:grano, por:grão + rus:гранит (granit), tur:vie:may:granit, ara:جرانيت (jaraniat), hin:ग्रेनाइट (grenait)  
...
**Guangzou** *Kanton* ← CN  
**guanse** *związek, powiązanie, połączenie* ← zho:关系 (guānxi), vie:quan hệ, kor:관계 (gwangye), jpn:関係 (kankei)  
...
**gulgui** *ghul* ← ara:الغول (ghūl), fas:غول‎ (ğul), eng:por:ghoul, spa:gul, rus:гуль (gul′), tur:kulbastı, may:ghul, jpn:グール (gūru)  
...
**haima** *namiot* ← ara:(xayma), hau:laima, hin:ख़ैमा (xEmā), swa:hema, may:kemah, may:khemah, mng:майхан (mayhan)  
...
**halte** *zatrzymać (stop, przerwa, zatrzymanie)* ← deu:eng:halt, fra:halte, spa:por:alto, may:halte  
...
**hamile** *ciężarny (w ciąży)* ← ara:(ḥāmil), may:hamil, swa:himila, tur:hamile, urd:(hāmila), fas:(hâmele)  
...
**harabe** *zły, zrujnowany, zepsuty* ← ara:fas:urd:(xarāb), tur:harap, hin:ख़राब (xarāb), ben:খারাপ (kharap), swa:-haribu  
**harame** *zabroniony (wzbroniony, nielegalny, haram, tabu)* ← ara:(ḥarām), hau:may:tur:eng:deu:haram, hin:हराम (harām), kor:하람 (haram), fas:urd:(harām), swa:haramu, zho:哈拉姆 (hālāmǔ), rus:харамный (xaramniy)  
**harfe** *litera, znak* ← ara:(ḥarf), tur:harf, fas:urd:(harf), hau:harafi, swa:herufi, may:huruf  
**harmone** *harmoniczny* ← eng:harmony, spa:armonía, por:harmonia, fra:harmonie, rus:гармония (garmoniya)  
...
**hate** *aż do* ← por:até, ara:(ḥatta), spa:hasta, swa:hata + fas: تا‎ (tâ), hin:तक (-tak)  
**hatre** *zagrożenie (niebezpieczeństwo; niebezpieczny)* ← ara: خطر‎ (xaṭar), fas: خطر‎ (xatar), urd: خطرہ‎ (xatrā), hin:ख़तरा (xatrā), swa:hatari, tur:muhatara  
...
**haxix** *haszysz* ← ara: حَشِيش (ḥašīš), eng:hashish, fra:haschich, por:haxixe, rus:гашиш (gašiš), jpn:ハシシ (hashishi), kor:해시시 (haesisi), hin:हशीश (haśīś), may:hasyis  
**he** *hę?, co?, pardon?* ← deu:hä, fra:por:hein, jpn:e + eng:huh, vie:hả + zho:啊 (à, a)  
**hei** *hej* ← eng:hey, fra:hé, spa:hey, por:ei, rus:эй (ey), zho:喂 (wèi), fas: هی‎ (hey)  
**helis** *helisa* ← ell: ἕλιξ (helix), eng:helix, fra:por:spa:hélice, pol:helisa, ara:(ḥalazūn), tur:helezon  
**helium** *hel* ← eng:helium, fra:hélium, spa:helio, por:hélio, rus:гелий, zho:氦 (hài), jpn:ヘリウム, kor:헬륨, vie:swa:heli, hin:हिलियम, ben:হিলিয়াম, may:helium, ara: هيليوم  
**hem** *hmm* ← eng:hmm, rus:хм (hm), эм (em), kor:음 (eum)  
**heme** *krew* ← eng:spa:por:may:vie:tur:hemo-, fra:hémo-, rus:гемо- (gemo-), jpn:ヘモ- (hemo-)  
**hen** *nienawidzić* ← zho:恨 (hèn), yue:恨 (han6), wuu:恨 (hhen3), vie:hận, jpn:嫌 (ken), kor:혐 (hyeom) + fra:haine  
**hesium** *has* ← eng:hassium, fra:hassium, spa:hasio, por:hássio, rus:хассий, zho: (hēi), jpn:ハッシウム, kor:하슘, vie:hassi, hin:हसियम, ben:হ্যাসিয়াম, may:hassium, swa:hassi, ara: هاسيوم  
**hibride** *hybryda; kundel* ← eng:hybrid, spa:por:híbrido, fra:hybride, rus:гибрид (gibrid)  
**hidre** *wodór* ← eng:fra:hydro-, spa:por:may:swa:hidro-, vie:hyđrô, ara: هيدروجين  
...
**hole** *cały* ← eng:whole, spa:por:holo-  
...
**holmium** *holm* ← eng:holmium, fra:holmium, spa:holmio, por:hólmio, rus:гольмий, zho:钬 (huǒ), jpn:ホルミウム, kor:홀뮴, vie:honmi, hin:होल्मियम, ben:হলমিয়াম, may:holmium, swa:homi, ara: هلميوم  
...
**hua** *kwiat* ← zho:花 (huā), yue:花 (faa1), vie:hoa, kor:화 (hwa) + swa:ua  
...
**humor** *humor* ← rus:юмор (yumor), spa:eng:humor, fra:humour, jpn:ユーモア (yūmoa), kor:유머 (yumeo), zho:幽默 (yōumò)  
...
**hura** *wiwatować (hura, jej)* ← eng:hurrah, deu:spa:hurra, fra:hourra, rus:ура (ura), may:hore, fas:(hurâ)  
**hurargente** *rtęć* ← swa:hidrajiri  
...
**iridium** *iryd* ← eng:iridium, fra:iridium, spa:iridio, por:irídio, rus:иридий, jpn:イリジウム, kor:이리듐, vie:iriđi, hin:इरिडियम, ben:ইরিডিয়াম, may:iridium, swa:iridi, ara: إريديوم  
...
**jainisme** *dźinizm, dżinizm* ← hin:mar:जैन (jain), tha:เชน (chen), eng:jainism, fra:jaïnisme, rus:джайнизм (džaynizm)  
**jake** *kurtka* ← eng:jacket, zho:夹克 (jiākè), rus:жакет (žaket), deu:Jacke, por:jaqueta  
**jambul** *czapetka kuminowa* ← hin:जामुन (jāmun), eng:jambul, por:jambolão, ara:جَمُّون (jammūn), swa:zambarau  
**jame** *kolekcjonować, zebrać, zbierać* ← ara: جَمَعَ‎ (jamaʿa), hin:जमात (jamāt), swa:jamaa,jamii, hau:jam'iyya,jàma'à, yor:jànmọ́ọ̀, tur:camia  
...
**jangle** *dziki* ← eng:fra:jungle, spa:jungla, por:jângal, rus:джунгли (džungli), hin:जंगल (jangal), ben:জঙ্গল (jônggôl), may:jenggela, jpn:ジャングル (janguru), kor:정글 (jeonggeul), tur:cengel + swa:jangwa  
**jau** *jęczmień* ← hin:जौ (jau), ben:যব (jôb), mar:जव (jav), guj:જવ (jav), fas: جو‎ (jow)  
**javabe** *odpowiedź (odzew; odpowiedzieć, odpowiadać)* ← ara: جَوَاب‎ (jawāb), hin:जवाब (javāb), may:jawab, swa:jibu, jawabu, tur:cevap  
**jebe** *kieszeń* ← hin:जेब (jeb), pnb:ਜੇਬ (jeb), urd:(jeb), tel:(jēbu), ara:(jayb), tur:cep, wol:jiba  
**jebre** *algebra* ← ara:fas:(jabr), tur:cebir, urd:(aljabrā), eng:algebra, fra:algèbre, swa:aljebra  
**jeke** *pożyczyć* ← zho:借 (jiè), yue:借 (ze3), jpn:借 (shaku), kor:적 (jeok) + eng:check  
**jele** *uwięzić, więzić, pozbawić wolności* ← eng:jail, fra:geôle, hin:जेल (jel), ben:জেল (jēl), tel:జైలు (jailu), urd: جیل‎ (jēl), swa:jela + spa:por:jaula  
**jen** *osoba* ← zho:人 (rén), wuu人 (zén), jpn:人 (jin) + hin:जन (jan), ben:-জন (-jôn), may:-jana, tha:ชน (chon), khm:ជន (jon) + fra:gens, por:gente  
**jenje** *imbir* ← eng:ginger, fra:gingembre, spa:gengibre, por:jengibre, zho:姜 (jiāng), tam:இஞ்சி (inji), ara: زنجبيل‎ (zanjabīl), tur:zencefil  
**jenju** *perła* ← zho:珍珠 (zhēnzhū), yue:珍珠 (zan1 zyu1), jpn:真珠 (shinju), kor:진주 (jinju), vie:trân châu, rus:жемчуг (žemčug), tur:inci,incü  
**jense** *płeć* ← eng:gender, por:gênero, jpn:ジェンダー (jendā) + ara:urd:(jins), fas:(jens), swa:jinsi, tur:cins  
...
**kai** *otwarty (otworzyć, otwierać)* ← zho:开 (kāi), wuu:開 (khe1), jpn:開 (kai), kor:개 (gae), vie:khai, tha:ไข (kǎi), lao:ໄຂ (khai)  
**kaka** *ekskrement (gówno; defekować, srać)* ← spa:por:fra:caca, deu:Kacke, ara:(kākā), tur:kaka, rus:кака (kaka), fas:(kake)  
**kakau** *kakao* ← por:cacau, ara:(kākāw), spa:cacao, eng:cocoa, rus:какао (kakao), jpn:カカオ (kakao), zho:可可 (kěkě), vie:cacao, swa:kakao  
**kalam** *pióro, długopis* ← ara:fas:urd: قلم‎ (qalam), hau:alƙalami, yor:swa:kalamu, tur:kalem, hin:क़लम (qalam), ben:কলম (kôlôm), spa:por:cálamo  
**kale** *pusty* ← ben:খালি (khali), hin:ख़ाली (xālī), tel:ఖాళీ (khāḷī), tam:(kali), urd:(xālī), fas:خالی (xāli), ara:خَالٍ‎ (xāliy), jpn:空 (kara)  
...
**kalifornium** *kaliforn* ← eng:californium, fra:californium, spa:californio, por:califórnio, rus:калифорний, zho:锎 (kāi), jpn:カリホルニウム, kor:칼리포르늄, vie:califoni, hin:कैलीफोर्नियम, ben:ক্যালিফোর্নিয়াম, may:kalifornium, swa:kalifoni, ara: كاليفورنيوم  
**kalium** *potas* ← rus:калий, jpn:カリウム, vie:kali, may:kalium, swa:kali  
...
**kalsium** *wapń* ← eng:calcium (Ca), fra:calcium, spa:calcio, por:cálcio, rus:кальций, zho:钙 (gài), jpn:カルシウム, kor:칼슘, vie:canxi, hin:कैल्शियम, ben:ক্যালসিয়াম, may:kalsium, swa:kalisi, ara: كلسيوم  
**kam** *niewiele (mało)* ← deu:kaum + fas: کم‎ (kam), hin:कम (kam), ben:কম (kôm) + yue:減 (gaam2), jpn:減 (-gen), kor:감 (gam), vie:giảm  
**kama** *pożądanie, żadza* ← hin:काम (kām), ben:কাম (kam), tha:กาม (gaam), eng:kama  
...
**kande** *cukierek, słodycze* ← eng:candy, hin:कैंडी (kaiṇḍī), ben:ক্যান্ডি (kyandi), jpn:キャンデー (kyandē), tgl:kendi + ara:fas: قند (qand)  
...
**kanzar** *sztylet (puginał)* ← fas:(xanjar), tur:haner, rus:кинжал (kinžal)  
...
**kara** *czarny* ← hin:काला (kālā); कारौ (kārau), ben:কালো (kalo), pnb:ਕਾਲਾ (kālā) + tam:கருப்பு (karuppu) + tur:kara, kaz:қара (qara)  
**karave** *kminek* ← ara:(karāwiya), eng:caraway, fra:carvi, spa:alcaravea, por:alcaravia  
**karbau** *bawół domowy* ← spa:carabao, may:kerbau, jav:kebo, khm:ក្របី (krɑbəy)  
**karbe** *węgiel* ← eng:carbon, fra:carbone, spa:carbón, por:carbono, vie:cacbon, hin:कार्बन, ben:কার্বন, may:karbon, swa:kaboni, ara: كربون  
**karcof** *karczoch zwyczajny* ← ara:خرشوف (kharshuf), amh:ከርቹፍ (kärčuf), spa:alcachofa, por:alcachofra, pol:karczoch  
**karde** *karta* ← eng:card, fra:carte, spa:por:carta, deu:Karte, rus:карта (karta), tur:kart, swa:kadi, hin:कार्ड (kārḍa), ben:কার্ড (kārḍa), may:kartu, zho:卡 (kǎ), jpn:カード (kādo), kor:카드 (kadeu) deu:Karte, may:kartu, fra:carte  
**kardon** *oset* ← spa:por:cardo, fra:chardon, eng:cardoon, jpn:カルドン (karudon)  
**kare** *pracować* ← fas: کار (kâr), hin:कार (kār), कार्य (kārya), ben:কাজ (kaj), may:karya,kerja + swa:kazi  
...
**karge** *ciężar (brzemię; ładować)* ← spa:por:carga, eng:cargo, may:kargo  
...
**karime** *hojny (szczodry)* ← ara:(karīm), swa:-karimu, tur:kerim, spa:por:caritativo  
...
**karte** *mapa* ← eng:chart, fra:carte, spa:por:carta, rus:карта (karta), ara: خَرِيطَة‎ (ḵarīṭa), tur:harita  
...
**kave** *wykopać, kopać, wydobyć, wydobywać, wykopywać* ← spa:por:cavar, eng:excavar, fra:excaver  
**ke** *co?* ← fra:que, spa:qué, por:o que + ben:কে  (ke) + zho:何 (hé)  
**kecape** *keczup* ← yue:茄汁 (kezap), eng:fra:spa:ketchup, por:catchup, rus:кетчуп (ketčup), jpn:ケチャップ (kechappu), kor:케첩 (kecheop), hin:केचप (kecap), ben:কেচাপ (kecap), ara: كَتْشَب‎ (katšab)  
...
**kex** *włos* ← jpn:毛 (ke) + hin:केश (keś), urd:(keś), pnb:ਕੇਸ਼ (keś), tel:(kēśamu)  
**keze** *ser* ← spa:queso, por:queijo, may:keju, deu:Käse, eng:cheese, zho:起司 (qǐsī), jpn:チーズ (chīzu), kor:치즈 (chijeu), hin:चीज़ (cīz), swa:chizi  
...
**kine** *ruchowy, kinetyczny* ← eng:kinetic, spa:por:cinético, fra:cinétique, deu:kinetisch, rus:кинетический (kineticheskyy)  
...
**kitabe** *pisać (pismo)* ← ara:urd:(kitāb), fas:(ketâb), tur:kitap, may:kitab, swa:kitabu, hin:किताब (kitāb)  
**kivi** *owoc kiwi* ← eng:fra:spa:may:swa:kiwi, por:quivi, jpn:キーウィ (kīwi), kor:키위 (kiwi), hin:कीवी (kīvī), tur:kivi  
**klame** *krzyknąć, krzyczeć* ← eng:-claim, fra:-clamer, spa:por:-clamar  
**klare** *przeźroczysty (jasny; oczywiście)* ← deu:klar, spa:por:claro, eng:clear, fra:clair  
...
**klorium** *chlor* ← eng:chlorine, fra:chlore, spa:cloro, por:cloro, rus:хлор, vie:clo, hin:क्लोरीन, ben:ক্লোরিন, may:klor, swa:klorini, ara: كلور  
...
**kor** *rdzeń (jądro, pestka)* ← eng:core, fra:coeur  
**koral** *koral* ← eng:spa:por:coral, fra:corail, deu:Koralle, rus:коралл + may:karang  
**korne** *róg* ← fra:corne, spa:cuerno, por:corno, eng:horn, deu:Horn + ara: قَرْن‎ (qarn)  
...
**kristejen** *Boże Narodzenie* ← ell:Χριστούγεννα (Christoúgenna)  
...
**kromium** *chrom* ← eng:chromium, fra:chrome, spa:cromo, por:crómo, rus:хром, jpn:クロム, kor:크로뮴, vie:crom, hin:क्रोमियम, ben:ক্রোমিয়াম, may:krom, swa:kromi, ara: كروم  
...
**kuane** *szeroki* ← zho:宽 (kuān), tha:กว้าง (kwang), vie:quảng  
...
**kuke** *gotować, szykować jedzenie* ← eng:cook, deu:Kock, ita:cuoco, may:koki, tha:กุ๊ก (kuk), sango:kuku  
...
**kupe** *kubek* ← eng:cup, fra:coupe, spa:copa, por:copo, ara: كُوب‎ (kūb), tur:kupa, hin:कप (kap), jpn:コップ (koppu), kor:컵 (keop) + fas:(koppe), may:kubah, rus:купол (kupol), deu:Kuppel  
...
**kurium** *kiur* ← eng:curium, fra:curium, spa:curio, por:cúrio, rus:кюрий, jpn:キュリウム, kor:퀴륨, vie:curi, hin:क्यूरियम, ben:কুরিয়াম, may:kurium, swa:kuri, ara: كوريوم  
...
**kuxen** *poduszka* ← eng:cushion, fra:coussin, spa:cojín, por:coxim, jpn:クッション (kusshon), kor:쿠션 (kusyeon), yue:咕𠱸 (ku1 seon2), hau:kushin, ibo:kushọn  
...
**lale** *czerwony* ← hin:लाल (lāl), ben:লাল (lal), tur:al  
...
**lantanium** *lantan* ← eng:lanthanum, fra:lanthane, spa:lantano, por:lantâno, rus:лантан, zho:镧 (lán), jpn:ランタン, kor:란탄, vie:lantan, hin:लाञ्थनम, ben:ল্যান্থানাম, may:lantanium, swa:lanthani, ara: لنثانوم  
...
**laste** *elastyczny* ← eng:elastic, spa:por:elástico, gla:lastaig, rus:эласти́чный (elastíčnyj), tur:may:elastik, jpn:エラスティック (erasutikku)  
...
**laurensium** *lorens* ← eng:lawrencium, fra:lawrencium, spa:laurencio, por:lawrêncio, rus:лоуренсий, zho:铹 (láo), jpn:ローレンシウム, kor:로렌슘, vie:lorenxi, lawrenci, hin:लॉरेंशियम, ben:লরেনসিয়াম, may:lawrensium, swa:lawirensi, ara: لورنسيوم  
**laxe** *rozluźnić (poluzować)* ← eng:(re)lax, fra:(re)lâcher, spa:(re)lajar, ita:lasciare, deu:lassen  
...
**lege** *lekki* ← eng:light, spa:ligero, fra:léger, rus:лёгкий (l’ogkiy), pol:lekki, ben:লঘু (laghu)  
**lenge** *zimny, chłodny* ← zho:冷 (lěng), vie:lạnh, yue:冷 (laang5)  
...
**leve** *lewy (lewostronny, z lewej strony)* ← ltn:laevus, eng:left; levo-, fra:lévo-, spa:por:levo-, rus:левый (levyy), pol:lewy  
...
**lila** *lilak* ← tur:leylak, ara:(laylak), eng:lilac, fra:lilas, por:lilás, spa:tgl:lila, jpn:ライラック (rairakku)  
**lime** *limit, granica* ← eng:limit, spa:límite, fra:por:limite, rus:лимит (limit) + hin:सीमा (sīmā)  
**limfa** *limfa* ← eng:lymph, spa:por:linfa, rus:лимфа (límfa), may:limfa, jpn:リンパ (rinpa), zho:淋巴 (línbā)  
**limon** *cytryna* ← fas:(limun), eng:lemon, tur:limon, rus:лимон (limon), spa:limón, por:limão, hin:नींबू (nīmbū), urd:(nībū), zho:柠檬 (níngméng), jpn:檸檬 (remon), kor:레몬 (remon), vie:lêmon, swa:ndimu, limau, ben:লেবু (lebu)  
**lince** *ryś* ← eng:fra:lynx, spa:por:lince, hin:लिंक्स (links)  
**line** *linia (nić, lina, pas, pręga, smuga, dratwa)* ← eng:line, fra:ligne, spa:línea, por:linha, rus:линия (liniya), pol:linia  
**lisan** *język* ← ara: لِسَان‎ (lisān), hin:लिसान (lisān), swa:lisani, may:tur:lisan, amh:ልሳን (ləsan)  
**lise** *gładki* ← fra:lisse, spa:por:liso, fas:(liz), may:licin  
...
**litium** *lit* ← eng:lithium, fra:lithium, spa:litio, por:lítio, rus:литий, zho:锂 (lǐ), jpn:リチウム, kor:리튬, vie:swa:lithi, hin:लिथियम, ben:লিথিয়াম, may:litium, swa:lithi, ara: ليثيوم  
...
**live** *pozostawiać (pozostawić, zostać, zostawać)* ← eng:leave + zho:留 (liú), jpn:留 (ryū), kor:류 (ryu), vie:lưu  
...
**luge** *rejestr (zapisać, zarejestrować)* ← eng:log + zho:录 (lù), yue:錄 (luk6), jpn:録 (roku), kor:록 (rok), vie:lục  
**luke** *zielony* ← zho:绿 (lǜ), yue:綠 (luk6), vie:lục, kor:록/녹 (rok/nok), jpn: 緑色 (ryokushoku)  
...
**lun** *księżyc* ← fra:lune, spa:luna, eng:lunar, rus:луна (luná)  
...
**magente** *magenta* ← eng:magenta, spa:magenta, rus:маджента (madzhenta), ara:ماجنتي (majinati), hin:मैजेंटा (maijenta), jpn:マゼンタ (mazenta), may:magenta  
**magesium** *magnez* ← eng:magnesium, fra:magnésium, spa:magnesio, por:magnésio, rus:магний, zho:镁 (měi), jpn:マグネシウム, kor:마그네슘, vie:magiê, hin:मैग्नेशियम, ben:ম্যাগনেসিয়াম, may:magnesium, swa:magnesi, ara: مغنيسيوم  
...
**maitnerium** *meitner* ← eng:meitnerium, fra:meitnérium, spa:meitnerio, por:meitnério, rus:майтнерий, jpn:マイトネリウム, kor:마이트너륨, vie:meitneri, hin:मेइट्नेरियम, ben:মিটনেরিয়াম, may:meitnerium, swa:meitneri, ara: مايتنريوم  
**makal** *artykuł, tekst* ← ara:مَقَال‎ (maqāl), tur:makale, swa:makala, fas:مقاله‎ (maqâle), may:makalah  
**makan** *masło* ← hin:मक्खन (makkhan), ben:মাখন (makhôn)  
...
**malika** *jaśmin* ← kan:(mallige), tam:(mallikai), tel:(malla), may:melati, kor:말리 (malli), tha:มะลิ (mali), zho:茉莉 (mòlì)  
...
**master** *magister* ← eng:fra:master, por:mestre, rus:магистр (magistr), may:magister  
...
**metre** *miara (zmierzyć)* ← eng:-meter, fra:-métrie, spa:-metría, por:-metria, rus:-метрия (-metriya), hin:मात्रा (mātrā), ben:মাত্রা (matra), may:matra, tur:-metri  
...
**minute** *minuta* ← eng:minute, spa:por:minuto, rus:минута (minuta), hin:मिनट (minaṭ), ben:মিনিট (miniṭ), may:minit  
**mire** *odbić, odbijać* ← spa:mirar, eng:admire, fra:admirer + ara:mirʾāh, tur:mirat  
...
**mole** *zemleć (mleć, mielić)* ← zho:磨 (mò), yue:磨 (mo4) tha:โม่ (mo), fra:moulin, spa:molino, rus:молоть  (molot’)  
**molekul** *molekuła (cząsteczka)* ← eng:molecule, spa:por:molécula, fra:molécule  
**molidenium** *molibden* ← eng:molybdenum, fra:molybdène, spa:molibdeno, por:molibdénio, rus:молибден, zho:钼 (mù), jpn:モリブデン, kor:몰리브덴, vie:molypđen, hin:मोलिब्डेनम, ben:মলিবডেনাম, may:molibden, swa:molibdeni, ara: مولبيدنيوم  
...
**mone** *pieniądze* ← eng:money + fra:monnaie, spa:por:moneda, rus:монета  
**monster** *potwór, monstrum* ← eng:monster, spa:por:monstro, fra:monstre, rus:монстр (monstr), jpn:モンスター (monsutā)  
**monte** *góra, wzgórze* ← eng:mountain, por:spa:monte, fra:montaigne  
**morfe** *morf* ← eng:morph, spa:morfo, rus:морф (morf)  
**morte** *umrzeć (umierać; śmierć; martwy, nieżywy, zabity)* ← por:morto, fra:mort, spa:muerto, fas:(morde), urd:(murda), hin:मृत (mrta), rus:мёртвый (myortvïy), + may:mati, + ara:(mawt), amh:ሞት (mot)  
...
**moskovium** *moskovium* ← eng:fra:moscovium, spa:moscovio, por:moscovio, rus:московий, jpn:モスコビウム, kor:우눈펜튬, vie:moscovi, may:moskovium, swa:moscovi  
**motegar** *samochód (automobil)* ← eng:motorcar, sna:motokari, sot:motokara, swa:motokaa, zul:imoto, hau:mota  
**motesikle** *motocykl (motor)* ← eng:motorcycle, spa:motocicleta, fra:motocyclette, rus:мотоцикл (mototsikl), tur:motosiklet, hin:मोटरसाइकिल (moṭarasāikila), may:motosikal, zho:摩托车 (mótuōchē), jpn:モーターサイクル (mōtāsaikuru)  
...
**multe** *wiele* ← por:muito, eng:fra:spa:multi-, rus:мульти- (mulʹti-)  
**mum** *wosk* ← hin:मोम (mom), ben:মোম (mom), fas: موم‎ (mum), tur:mum + ara: مومياء (mumiya), eng:mummy, fra:momie, spa:momia, por:múmia, rus:мумия (mumiya), zho:木乃伊 (mùnǎiyī), may:mumia  
...
**muze** *zabawa (rozrywka; bawić, zabawiać)* ← eng:amuse, fra:amuser, deu:amüsieren + fas: مزه (maze), hin:मज़ा (mazā), ben:মজা (môja)  
**muzike** *muzyka (grać muzykę)* ← eng:music, fra:musique, spa:por:música, rus:музика (muzika), ara:(mūsīqā), swa:muziki, tur:müzik, may:musik  
...
**namelexe** *rzeczownik* ← zho:名词 (míngcí), yue:名詞 (ming4 ci4), jpn:名詞 (meishi), kor:명사 (myeongsa), hin:नाम (nām), fra:nom, spa:nombre, por:nome, rus:имя (imya), ara:(ism), per:(esm), swa:nomino  
...
**narme** *miękki* ← fas: نرم‎ (narm), hin:नरम (naram), ben:নরম (nôrôm) + ara: نَاعِم‎ (nāʿim) + tha:นุ่ม (num)  
...
**nege** *odmówić (odrzucić)* ← spa:por:negar, eng:negate  
...
**neodimium** *neodym* ← eng:neodymium, fra:néodyme, spa:neodimio, por:neodímio, rus:неодим, zho:钕 (nǚ), jpn:ネオジム, kor:네오디뮴, vie:neođim, hin:नियोडाइमियम, ben:নিওডিমিয়াম, may:neodinium, swa:neodimi, ara: نيودميوم  
...
**nepe** *chmura* ← ell:νέφος (nephos), scr:नभस् (nábhas), tam:நபம் (napam) + eng:nepho-, fra:népho- + spa:nube, por:nuvem + rus:небо (nebo)  
**nepotunium** *neptun* ← eng:neptunium, fra:neptunium, spa:neptunio, por:neptúnio, rus:нептуний, zho:镎 (ná), jpn:ネプツニウム, kor:넵투늄, vie:neptuni, hin:नेप्ट्यूनियम, ben:নেপচুনিয়াম, may:neptunium, swa:neptuni, ara: نبتونيوم  
...
**neu** *nowy* ← deu:neu, eng:new; neo-, fra:nouveau; néo-, spa:nuevo; neo-, por:novo; neo-, rus:новый (novyy); нео- (neo-), hin:नव (nav), ben:নয় (nôy); নও- (nôo-), may:nawa  
...
**niobium** *niob* ← eng:niobium, fra:niobium, spa:niobio, por:nióbio, rus:ниобий, zho:铌 (ní), jpn:ニオブ, kor:나이오븀, vie:niobi, hin:नायोबियम, ben:নাইওবিয়াম, may:niobium, swa:niobi, ara: نيوبيوم  
**niponium** *nihonium* ← eng:fra:may:nihonium, spa:nihonio, por:nihonium, rus:нихоний, jpn:ニホニウム, kor:우눈트륨, vie:swa:nihoni  
**nis** *nisza, alkowa* ← fra:eng:niche, por:nicho, rus:ниша (niša)  
...
**nobelium** *nobel* ← eng:nobelium, fra:nobélium, spa:nobelio, por:nobélio, rus:нобелий, zho:锘 (nuò), jpn:ノーベリウム, kor:노벨륨, vie:nobeli, hin:नोबेलियम, ben:নোবেলিয়াম, may:nobelium, swa:nobeli, ara: نوبليوم  
...
**note** *uwaga (obserwacja; notować, obserwować, zauważyć, zauważać)* ← deu:eng:fra:note, spa:por:nota, tur:not, jpn:ノート (nōto), kor:노트 (noteu), fas:(not)  
**nove** *dziewięć (9)* ← fra:neuf, spa:nueve, por:nove, fas: نُه‎ (noh), hin:नौ (nau), ben:নয় (nôy), may:nawa  
**nude** *nagi (goły, obnażony)* ← eng:nude, spa:desnudo, por:fra:nu + rus:нудизм (nudizm), jpn:ヌーディズム (nūdizumu)  
**nuke** ** ← eng:neck, spa:por:nuca, fra:nuque, spa:por:nuca + ara:عُنُق‎ (ʿunuq)  
**nume** *numer (liczyć)* ← eng:number, fra:nombre, spa:por:número, rus:номер (nomer), deu:Nummer, jpn:ナンバー (nanbā), hin:नंबर (nambar), ben:নম্বর (nômbôr), tur:numara, may:nombor, swa:namba(ri)  
...
**okei** *zaakceptować, akceptować, powiedzieć okej, mówić okej* ← eng:okay, spa:tur:may:okey, por:OK, rus:окей (okej), ara:أُوكِي‎‎‎ (ʾokey), hin:ओके (oke), zho:OK (ōukèi), jpn:オーケー (ōkē)  
...
**onor** *respekt, honor, szacunek, poważanie* ← eng:pol:spa:honor, fra:honneur, por:honra, tur:onur + rus:гонор (gonor)  
**or** *ucho* ← zho:耳 (ěr), eng:ear, deu:Ohr, fra:oreille, por:orelha, spa:oreja  
**orange** *pomarańcza* ← eng:orange, spa:naranja, por:laranja, hin:नारंगी (narangi), jpn:(orenji), + fra:orange, rus:оранжевый (oranževiy)  
**orde** *armia* ← tur:ordu, fas: اردو (ordu) + eng:fra:horde, spa:por:horda, rus:орда (orda), zho:斡耳朵 (wò'ěrduǒ), zho:オルド (orudo), kor:오르도 (oreudo) + ara: عُرْضِيّ‎ (ʿurḍiyy)  
...
**orte** *prosty* ← eng:fra:ortho-, spa:por:orto-, rus:орто- (orto-)  
...
**pake** *pakować (paczka, paka)* ← eng:pack, rus:пакет (paket), hin:पैकेट (pækeṭ), deu:tur:paket, fra:paquet, spa:paquete, por:pacote  
**pakse** *ptak* ← hin:पक्षी (pakṣī), ben:পাখী (pakhī), tel:(pakṣi), khm:បក្សី (baksəy), tha:ปักษา (pak-sa)  
...
**paladium** *pallad* ← eng:palladium, fra:palladium, spa:paladio, por:paládio, rus:палладий, zho:钯 (bǎ), jpn:パラジウム, kor:팔라듐, vie:palađi, hin:पलाडियम, ben:প্যালাডিয়াম, may:paladium, swa:paladi, ara: بلاديوم  
**palme** *palma, drzewo palmowe* ← deu:Palme, eng:palm, por:spa:palma, rus:пальма (palma), tur:palmiye, may:palem, tha:ปาล์ม (pām)  
**pan** *wszyscy, wszystkie, wszystko; każdy* ← eng:spa:por:deu:may:pan-, rus:пан- (pan-) + zho:泛 (fàn), jpn:汎 (han-)  
...
**panke** *skrzydło* ← hin:पंखा (paṅkhā) + (fan) mya:ပန်ကာ (panka), fas:(panke), + eng:punkah, fra:panka, deu:Pankha  
...
**parce** *stłuc się (część, strzęp, kawałek, okruch, fragment)* ← fas:(parče), tur:parça, hin:पारचा (pārcā), eng:part, por:spa:parte  
**pare** *równy* ← eng:peer, fra:pair, spa:por:par, deu:Pere, hin:बराबर (barābar), fas:urd: برابر‎ (barâbar)  
...
**pas** *minąć, mijać, przeminąć, przemijać* ← eng:pass, spa:pasar, por:passar, fra: passer + rus:паспорт (pasport), hin:पासपोर्ट (pāsporṭ), ben:পাসপোর্ট (pasporṭ), may:paspor, swa:paspoti, jpn:パスポート pasupōto)  
...
**pate** *chory* ← deu:eng:fra:patho-, spa:por:pol:tur:may:pato-, rus:пато- (pato-)  
**pau** *pistolet, strzelba, ręczna broń palna* ← zho:炮 (pâo), yue:炮 (paau3), vie:pháo, kor:포 (po), mon:буу (buu)  
**pauze** *przerwać (przerywać; pauza, przerwa)* ← deu:Pause, eng:deu:fra:pause, spa:por:pausa, rus:пауза (pauza)  
...
**pende** *powiesić, wieszać* ← por:fra:pender + eng:pendant, jpn:ペンダント (pendanto), kor:펜던트 (pendeonteu), tur:pandantif  
...
**pente** *pięć (5)* ← fas: پنج‎ (panj), rus:пять (pyat'), hin:पाँच (pā̃c), ben:পাঁচ (pãcô) + ell:πέντε (pente), eng:fra:spa:por:penta-  
**perde** *pierdnięcie (pierdzieć)* ← eng:fart + fra:pet, spa:pedo, por:peido, rus:пердение (perdeniye), ben:পাদ (pad), hin:पाद (pād)  
...
**pexe** *ryba* ← por:peixe, spa:pez + deu:Fisch, eng:fish  
...
**pirater** *pirat* ← eng:fra:pirate, spa:por:pirata, deu:Pirat, rus:пират (pirat) + jpn:パイレーシ (pairēshi)  
**pis** *siki* ← eng:piss, fra:pisse, ita:piscia, hin:पेशाब (pešāb), may:pipis  
...
**plasme** *plazma (zjonizowany gaz)* ← eng:plasma, spa:plasma, rus:плазма (plazma), ara:بلازما (balazima), hin:प्लाज़्मा (plaazma), jpn:プラズマ (purazuma), may:plasma  
...
**platinium** *platyna* ← eng:platinum, fra:platine, spa:platino, por:platina, rus:платина, zho:铂 (bó), vie:platin, hin:प्लाटिनम, ben:প্লাটিনাম, may:platina, swa:platini, ara: بلاتين  
**ploze** ** ← eng:fra:explosion, spa:explosión, por:exploção, rus:имплозия (imploziya), may:eksplosi  
**plum** *śliwka* ← eng:plum, deu:Pflaume, jpn:プラム (pulamu) + fra:prune, spa:pruna  
**plumbe** *ołów* ← fra:plomb, spa:plomo, por:chumbo, swa:plumbi  
**plutonium** *pluton* ← eng:plutonium, fra:plutonium, spa:plutonio, por:plutónio, rus:плутоний, zho:钚 (bù), jpn:プルトニウム, kor:플루토늄, vie:plutoni, hin:प्लूटोनियम, ben:প্লুটোনিয়াম, may:plutonium, swa:plutoni, ara: بلوتونيوم  
**poke** *poker* ← eng:poker, zho:扑克 (pūkè), jpn:ポーカー (pōkā), kor:포커 (pokeo), vie:pôke  
**polau** *pilaw* ← fas:(polou), hin:पुलाव (pulav), tur:pilav, rus:плов (plov)  
**poli** *wiele (wielo-, poli-, multi-)* ← ell:πολλοί (polloí), eng:fra:deu:poly-, spa:por:poli-, rus:поли- (poli-)  
...
**polskium** *polon* ← eng:polonium, fra:polonium, spa:polonio, por:polónio, rus:полоний, zho:钋 (pō), jpn:ポロニウム, kor:폴로늄, vie:poloni, hin:पोलोनियम, ben:পোলনিয়াম, may:polonium, swa:poloni, ara: بولونيوم  
...
**poste** *nadać, wysłać pocztą* ← eng:post, por:postagem, fra:poste, rus:почта (pochta), ara:بوسطة‎ (busṭa), swa:posta, may:pos  
...
**poze** *pozować (ustawiać się; poza, pozycja)* ← eng:spa:por:fra:pose, deu:Pose, rus:поза (poza), jpn:ポーズ (pōzu)  
...
**pre** *poprzedni* ← eng:fra:spa:por:pre-  
**prese** ** ← fra:pression, spa:presión, por:pressão, rus:пресс (press), jpn:プレス (puresu)  
**probe** *spróbować, próbować* ← deu:Probe, eng:prove; probe, spa:probar, por:provar, rus:проба  
...
**prometium** *promet* ← eng:promethium, fra:prométhium, spa:prometio, por:promécio, rus:прометий, zho:钷 (pǒ), jpn:プロメチウム, kor:프로메튬, vie:prometi, hin:प्रोमेथियम, ben:প্রমিথিয়াম, may:prometium, swa:promethi, ara: بروميثيوم  
...
**protacinium** *protaktyn* ← eng:protactinium, fra:protactinium, spa:proactinio, por:protacnídio, rus:протактиний, zho:镤 (pú), jpn:プロトアクチニウム, kor:프로트악티늄, vie:protactini, hin:प्रोटैक्टीनियम, ben:প্রোটেক্টিনিয়াম, may:protaktinium, swa:protaktini, ara: بروتكتنيوم  
**proxe** *bliski* ← eng:proximal, fra:proche, spa:por:próximo  
...
**puje** *czcić (szanować; cześć, szacunek)* ← hin:पूजा (pūjā), urd:(pūjā), tha:บูชา (bucha), may:puja  
**pul** *most* ← hin:पुल (pul), ben:পুল (pul), urd:(pul), fas:(pol)  
**pulmon** *płuco* ← spa:pulmón, fra:poumon, por:pulmão, eng:pulmonic  
**pulse** *pchnąć, pchać* ← eng:push; pulse, fra:pousser + spa:por:impulso, rus:импульс (impul's)  
...
**pure** *pełny* ← hin:पूर्ण (pūrn), ben:পূর্ণ (pūrṇa), pnb:ਪੂਰਾ (pūrā), fas:(por)  
...
**rase** *rasa* ← eng:fra:race, spa:raza, por:raça, rus:раса (rasa), may:ras  
...
**ri-** *powtarzanie, powtórka* ← eng:fra:por:spa:re-, rus:ре- (re-)  
**rice** *bogaty* ← eng:rich, fra:riche, por:spa:rico  
...
**rite** *obyczaj (zwyczaj, tradycja, praktyka, konwencja; konwencjonalny, zwyczajowy, tradycyjny)* ← hin:रीति (rīti), ben:রীতি (rīti) + eng:fra:rite, spa:por:rito  
...
**rodium** *rod* ← eng:rhodium, fra:rhodium, spa:rodio, por:ródio, rus:родий, jpn:ロジウム, kor:로듐, vie:rođi, hin:रोडियम, ben:রোডিয়াম, may:rodium, swa:rodi, ara: روديوم  
...
**rul** *rulon (rolka, zwój)* ← eng:roll, fra:rouler, deu:aufrollen  
**rum** *rum* ← eng:rum, spa:ron, hin:रम (ram), rus:ром (rom)  
**rupe** *wygląd (wyglądać, wydawać się)* ← hin:रूप (rūp), may: rupa, tha: รูป (rūp), khm:រូប (rūp)  
**rute** ** ← eng:fra:rupture, spa:rotura, por:rutura + rus:банкрот (bankrot), may:bangkrut  
**ruterfordium** *rutherford* ← eng:rutherfordium, fra:rutherfordium, spa:rutherfordio, por:rutherfórdio, rus:резерфордий, ²курчатовий, zho: (lú), jpn:ラザホージウム, kor:러더포듐, vie:rutherfordi, hin:रुथरफोर्डियम, ben:রাদারফোর্ডিয়াম, may:rutherfordium, swa:rutherfordi, ara: رذرفورديوم  
**rutin** *rutyna, nawyk, zwyczaj* ← eng:fra:routine, spa:rutina, por:rotina, deu:Routine, fas:روتین‎ (rutin), rus:рутина (rutina)  
**sababe** *powód (przyczyna; spowodować, powodować)* ← heb:(sibá), hau:sabo;sababi, kon:sambu, ara:urd:(sabab), tur:sebep, may:sebab, swa:sababu  
**sabe** *wiedzieć (wiedza)* ← fra:savoir, spa:por:saber, eng:savvy, pcm:sabi  
...
**sade** *zwykły, zwyczajny, prosty* ← tur:sade, fas:(sāde), hin:सादा (sādā)  
**safar** *podróż (podróżować)* ← ara:(safar), hin:सफ़र (safar), tur:sefer, swa:safari, eng:fra:spa:por:deu:safari  
**safe** *czysty (wyczyścić, czyścić)* ← swa:safi, hin:साफ़ (sāf), urd:(sāf), ben:চাফা (sapha)  
...
**sage** *opowiadanie (opowieść, legenda, saga; opowiedzieć, opowiadać)* ← eng:spa:por:may:saga, deu:Sage, rus:сага (saga)  
...
**sahe** *właściwy (poprawny; poprawić, poprawiać, prostować, korygować)* ← hin:सही (sahī), urd:(sahī), fas:(sahih), ara:(ṣaḥīḥ), swa:sahihi, may:sah  
...
**salade** *sałatka* ← fra:salade, may:salad, rus:салат (salat), hin:सलाद (salād), yue:沙律 (saa1 leot62), zho:沙拉 (shālā), por:salada, spa:ensalado, jpn:サラダ (sarada), kor:샐러드 (saelleodeu), vie:xà lách  
...
**salve** *ratować* ← eng:save, salvage, fra:sauver, spa:por:salvar  
**sam:** *taki sam* ← eng:same, fra:semblable, rus:самый (samyy), may:sama, hin:सम (sam)  
**samarium** *samar* ← eng:samarium, fra:samarium, spa:samario, por:samário, rus:самарий, zho:钐 (shān), jpn:サマリウム, kor:사마륨, vie:samari, hin:सैमरियम, ben:সামারিয়াম, may:samarium, swa:samari, ara: ساماريوم  
...
**sanduke** *pudło, skrzynia* ← rus:сундук (sunduk), ara: صُنْدُوق‎ (ṣundūq), fas:urd:صندوق‎ (sanduq), swa:sanduku, tur:sandık  
...
**selenium** *selen* ← eng:selenium, fra:sélénium, spa:selenio, por:selénio, rus:селен, zho:硒 (xī), jpn:セレン, kor:셀렌, vie:selen, hin:सेलेनियम, ben:সেলেনিয়াম, may:selenium, swa:seleni, ara: سيلينيوم  
...
**sente** *sto (100)* ← fra:cent, eng:cent-, spa:cien, por:cem, rus:сто (sto), hin:शत (śat), ben:শত (śôt) + jpn:パーセント (pasēnto), kor:퍼센트 (peosenteu), may:persen  
...
**sere** *seria, szereg* ← eng:series, fra:série, spa:serie, rus:серия (seriya), tur:seri + hin:सिलसिला (silsilā), ara:(silsila), tur:silsile, swa:silisili, fas: سلسله‎ (selsele) + zho:系列 (xìliè)  
...
**serve** *służyć (służba)* ← eng:fra:service, por:serviço, rus:сервис (servis), tur:servis, hin:(sevâ)  
**sesam** *sezam* ← eng:sesame, rus:сезам (sezam), spa:sésamo, ara:(simsim), swa:simsim, tur:susam  
**sexe** *seks (stosunek płciowy; kochać się, uprawiać seks)* ← eng:sex, fra:sexe, spa:por:sexo, rus:секс (seks), tur:seks, hin:सेक्स (seks), jpn:セックス (sekkusu), kor:섹스 (sekseu)  
...
**sigare** *papieros (cygar)* ← eng:fra:cigarette, spa:cigarillo, por:cigarro, rus:сигарета (sigarteta), ara:(sījāra), zho:雪茄 (xǔejiā), wuu:雪茄 (xi'gá), hin:सिगरेट (sigreṭ), ben:সিগারেট (śigareṭ), swa:tur:sigara, amh:ሲጃራ (siǧara)  
...
**sine** *znak, sygnał* ← eng:sign, spa:señal, por:sinal, fra:signe  
**singa** *lew* ← may:singa, hin:सिंघ (singh), ben:সিংহ (singh), tam:சிங்கம் (sinkam), tha:สิง (sing), zho:狮 (shī), jpn:獅子 (shishi) + swa:simba  
**sir** *sekret (chować, kryć)* ← ara: سِرّ (sirr), hin:सेर (ser), may:sir, swa:siri, hau:ful:asiri, yor:àṣírí, tur:sır, fas:(serr)  
...
**sixe** *sześć (6)* ← eng:fra:six, spa:por:seis, deu:sechs, rus:шесть (shest’), fas: شِش‎ (šeš) + ara:ستة‎ (sitta), swa:sita, hau:shidà  
...
**sore** *zamek (zapięcie)* ← zho:锁 (suǒ), yue:鎖 (so2), wuu:鎖 (su2), jpn:錠 (jō), khm:សោ (sao) + spa:cierre, fra:serrure + hun:zár  
...
**sponje** *gąbka* ← eng:sponge, spa:por:esponja, ara:إسفنج (ʾisfanj), fas:اسفنج‎ (esfanj), hin:स्पंज (spanja), jpn:スポンジ (suponji), may:spon, swa:sponji  
**sporte** *sport, lekkoatletyka* ← eng:deu:fra:sport, spa:deporte, por:esporte, rus:спорт (sport), jpn:スポーツ (supōtsu), kor:스포츠 (seupocheu), hin:स्पोर्ट (sporṭ), swa:spoti, tur:spor  
...
**su** *mieć (partykuła posiadania)* ← eng:'s, spa:su, por:seu,sua  
**sual** *pytać (pytanie)* ← ara: سؤال (su'āl), fas: سؤال‎ (so'âl), hin:सवाल (savāl), ben:সওয়াল (śôwal), may:soal, swa:swali, tur:sual + khm:សួរ (suə)  
**suane** *kwaśny* ← zho:酸 (suān), yue:酸 (syun1), wuu:酸 (soe1), jpn:酸 (san), kor:산 (san), vie:toan  
**suba** *ranek, rano, poranek* ← ara:(ṣabāḥ), tur:sabah, fas:(sobh), urd:(subah), hin:सुबह (subah), swa:asubuhi, hau:asuba  
**sube** *spód* ← eng:fra:spa:por:may:sub-, rus:суб- (sub-)  
**sude** *południe* ← deu:Süden, fra:sud, spa:sur, por:sul, eng:south, rus:зюйд (zyuyd)  
**sue** ** ← scr:hin: सु- (su-), ben:সু- (śu-) + ltn:eng:fra:su- + min:媠 (súi)  
**suede** *pot* ← eng:sweat, spa:sudor, por:suor, fra:sueur, san:स्वेद (sveda)  
**suge** *szybki, prędki* ← zho:速 (sù), yue:速 (cuk4)), jpn:速 (soku), kor:속 (sok), vie:tốc  
...
**suke** *wesoły, ucieszony* ← hin:सुखी (sukhī), jpn:好き (suki), tha:สุข (suk) + jpn:好く (suku), may: suka  
**sulfe** *siarka* ← eng:sulfur, fra:soufre, spa:azufre, por:enxofre, swa:sulfuri  
...
**sum** *suma (zsumować, sumować, dodać, dodawać)* ← eng:sum, spa:suma, por:soma, fra:somme, deu:Summe, rus:сумма (summa)  
**supe** *zupa* ← spa:sopa, eng: soup, fra: soupe, deu: Suppe, swa: supu, rus:суп (sup), may:sup, jpn:スープ (sūpu)  
**supre** *górny* ← eng:super, fra:super, spa:por:sobre, ita:sopra, jpn:スーパー (sūpā)  
**suprize** *zaskoczenie* ← eng:surprise, tur:sürpriz, fas:(surpris), rus::сюрприз (siurpriz), por:surpresa, spa:sorpresa  
**sus** *lukrecja* ← ara: سُوس (sus), spa:alcazus, por:alcaçuz, swa:susi  
**susan** *lilia* ← ara: سَوْسَن‎ (sawsan), spa:azucena + eng:Susan, por:Susana, fra:Suzanne, pol:Zuzana, rus:Сусанна (Susanna)  
**sute** *szyć* ← hin:सीना (sīnā), rus:шить (šit') + fra:eng:suture, por:spa:sutura  
...
**ta** *do, dopóki, dla* ← eng:to + hin:-तक (-tak) + fas: تا‎ (tâ)  
...
**talium** *tal* ← eng:thallium, fra:thallium, spa:talio, por:tálio, rus:таллий, zho:铊 (tā), jpn:タリウム, kor:탈륨, vie:tali, hin:थैलियम, ben:থ্যালিয়াম, may:tallium, swa:tali, ara: ثاليوم  
**tamar** *daktyl* ← por:tamara, ara:(tamar)  
**tame** *chciwy (żądny)* ← ara: طَمَّاع‎ (ṭammāʿ), zho:贪 (tān), kor:탐욕 (tamyok), vie:tham  
...
**tantalium** *tantal* ← eng:tantalum, fra:tantale, spa:tántalo, por:tântalo, rus:тантал, zho:钽 (tǎn), jpn:タンタル, kor:탄탈, vie:tantali, hin:टाण्टलम, ben:ট্যান্টালাম, may:tantalum, swa:tantali, ara: تنتالم  
**tanur** *piec (piekarnik)* ← ara: تَنُّور‎ (tannūr), fas: تنور (tannūr), hin:तनूर (tanūr), ben:তন্দুর (tôndur), swa:tanuri, tur:tandır + eng:tandoor  
**tape** *zatyczka (korek, szpunt; zatkać, ztykać, blokować, hamować)* ← spa:tur:tapa, por:tampa, ell:τάπα (tapa), bul:тапа (tapa), eng:tap  
**tarif** *opłata, taryfa* ← eng:tariff, spa:por:tarifa, deu:fra:tur:tarif, ara:(taʿrīf), rus:тариф (tarif), hin:टैरिफ़ (ṭairif)  
**tas** *danie* ← ara: طَاس (ṭās), swa:tasa, tur:tas, fra:tasse, spa:taza, rus:таз + hin:तश्तरी (tashtarī)  
**tate** *dotyczyć* ← eng:fra:tact, spa:tacto, por:tato  
**tatike** *taktyka, strategia* ← por:tática, ita:tattica, eng:tactic, rus:тактика (taktika), deu:Taktik  
**tato** *tatuaż* ← sam:tah:tatau, haw:kākau, may:tgl:tato, eng:tattoo, fra:tatouage, spa:tatuaje, por:tatuagem, rus:тату (tatu)  
**tave** *patelnia* ← hin:तवा (tavā), tur:tava, fas:(tābe)  
**taxe** *podatek, opłata* ← eng:tax, por:taxa, spa:tasa, hin:टैक्स (ṭEks)  
**taze** *świeży* ← fas: تازه (tâze), hin:ताज़ा (tāzā), ben:তাজা (taja), tur:taze, ara: طَازَج (ṭāzaj)  
...
**tehnium** *technet* ← eng:technetium, fra:technétium, spa:tecnetio, por:tecnécio, rus:технеций, zho:锝 (dé), jpn:テクネチウム, kor:테크네튬, vie:tecnexi, hin:टेक्निशियम, ben:টেকনিসিয়াম, may:teknetium, swa:tekineti, ara: تكنيتيوم  
**tel** *dystans* ← eng:spa:por:may:tele-, fra:télé-, rus:теле- (tele-)  
**telurium** *tellur* ← eng:tellurium, fra:tellure, spa:telurio, por:telúrio, rus:теллур, zho:碲 (dì), jpn:テルル, kor:텔루르, vie:telu, hin:टेलुरियम, ben:টেলুরিয়াম, may:telurium, swa:teluri, ara: تيلوريوم  
...
**tenesium** *tenesyn, tennessine* ← eng:fra:por:may:tennessine, spa:teneso, rus:теннессин, jpn:テネシン, kor:우눈셉튬  
**tense** ** ← eng:tense, fra:tendu, spa:por:tenso  
**tente** *kusić, nakłonić, nakłaniać* ← eng:tempt, fra:tenter, spa:por:tentar  
**teoria** *teoria* ← eng:theory, spa:teoría, por:teoria, fra:téorie, rus:теория (teoriya), fas:تئوری‎ (teori), may:teori  
**tepe** *taśma* ← eng:tape, hin:टेप (ṭep), swa:tepu, jpn:テープ (tēpu), kor:테이프 (teipeu), tur:teyp  
**tera** *tera-* ← eng:fra:spa:por:may:tur:tera-, rus:тера- (tera-), jpn:テラ (tera), kor:테라- (tera-)  
**terbium** *terb* ← eng:terbium, fra:terbium, spa:terbio, por:térbio, rus:тербий, zho:铽 (tè), jpn:テルビウム, kor:테르븀, 2터븀, vie:tecbi, hin:टर्बियम, ben:টার্বিয়াম, may:terbium, swa:taribi, ara: تربيوم  
**terce** *skośny (ukośny, pochyły)* ← spa:torcido, por:torto, hin:तिरछा (tirachha), ben:তেরছা (tērachā), pan:तिरकस (tirakasa)  
...
**tire** *strzelać (strzelić)* ← fra:tirer, spa:por:tirar + fas: تیر (tir), hin:तीर (tīr), ben:তীর (tir)  
**titanium** *tytan* ← eng:titanium, fra:titane, spa:titanio, por:titânio, rus:титан, zho:钛 (tài), jpn:チタン, kor:타이타늄, vie:titan, hin:टाइटानियम, ben:টাইটেনিয়াম, may:titanium, swa:titani, ara: تيتانيوم  
**tix** *ćsi* ← rus:тишина (tišina) + eng:shh, fra:chut, rus:ш-ш-ш, zho:噓 (xū), jpn:しーっ (shīt), kor:쉿 (swit), tur:sus  
**tize** *intensywny (zależnie od kontekstu: szybki, żywy, ostry, mocny, krótki)* ← fas: تیز (tiz), hin:तेज़ (tez), tur:tez  
**tolere** *tolerować* ← eng:tolerate, spa:por:tolerar, fra:tolérer, deu:tolerieren  
**tomato** *pomidor* ← eng:tomato, fra:por:spa:tomate, deu:Tomate, rus:томат (tomat), jpn:トマト (tomato), kor:토마토 (tomato), hin:टमाटर (ṭamāṭar), ben:টম্যাটো (ṭamyāṭo), may:tomat, tur:domates  
**tone** *ton, dźwięk, nuta, tonacja* ← eng:tone, swa:kitone, rus:тон (ton), deu:Ton, spa:tono  
**tong** *beczka* ← zho:桶 (tǒng), kor:통 (tong), vie:thùng, may:tong, khm:តុង (tong), tha:ถัง (tǎng), fas: تنگ‎ (tong) + fra:tonneau, spa:tonel, ned:ton  
**tore** *wieża* ← eng:tower, fra:tour, spa:por:torre, deu:Turm, hin:टावर (ṭāvar) + jpn:塔 (tō), zho:塔 (tǎ)  
**torium** *tor* ← eng:thorium, fra:thorium, spa:torio, por:tório, rus:торий, zho:钍 (tǔ), jpn:トリウム, kor:토륨, vie:thori, hin:थोरियम, ben:থোরিয়াম, may:torium, swa:thori, ara: ثوريوم  
...
**trompe** *róg* ← spa:por:trompa, eng:trumpet, fra:trompette, jpn:ランペット (torampetto), kor:트럼펫 (teureompet), tur:trompet, swa:tarumbeta  
**truke** *sztuczka (podstęp, oszustwo)* ← eng:trick, deu:Trick, fra:truc, spa:truco, por:truque, hun:trükk, rus:трюк (tr’uk)  
**tu** *ty, ciebie* ← fra:por:spa:tu, hin:तू (tū), rus:ты (ty)  
...
**tuhe** *pluć* ← hin: थूकना (thūknā), zho: 吐 (tǔ), tur:tükürmek  
**tul** *narzędzie* ← eng: tool, kor: 툴 (tul), jpn: ツール (tsūru), Zulu: ithuluzi  
**tulium** *tul* ← eng:thulium, fra:thulium, spa:tulio, por:túlio, rus:тулий, zho:铥 (diū), jpn:ツリウム, kor:툴륨, vie:tuli, hin:थुलियम, ben:থুলিয়াম, may:tulium, swa:thuri, ara: ثليوم  
...
**tunge** *ból (cierpienie; cierpieć)* ← zho:痛 (tòng), yue:痛 (tung3), kor:통 (tong)  
...
**uranium** *uran* ← eng:uranium, fra:uranium, spa:uranio, por:urânio, rus:уран, jpn:ウラン, kor:우라늄, vie:urani (uran), hin:युरेनियम, ben:ইউরেনিয়াম, may:uranium, swa:urani, ara: يورانيوم  
...
**vacin** *szczepionka* ← eng:vaccine, por:vacina, rus:вакцина (vakcina), hin:वैक्सीन (vaiksīn), jpn:ワクチン (wakuchin), may:vaksin  
...
**vakile** *reprezentować* ← ara: وكيل‎ (wakīl), hin:वकील (vakīl), ben:উকিল (ukil), swa:wakili, fas: وکیل‎ (vakil)  
**vale** *wartość* ← eng:value, spa:por:valor, fra:valeur  
...
**van:** *las (zagajnik)* ← hin:वन (van), ben:বন (bôn), may:jav:wana, pnb:ਵਣ (vaṇ), tam:வனம் (vaṉam), kan:ವನ (vana)  
**vanadium** *wanad* ← eng:vanadium, fra:vanadium, spa:vanadio, por:vanádio, rus:ванадий, zho:钒 (fán), jpn:バナジウム, kor:바나듐, vie:vanađi, hin:वनेडियम, ben:ভ্যানাডিয়াম, may:vanadium, swa:vanadi, ara: فناديوم  
**vanila** *wanilia* ← eng:vanilla, spa:vainilla, por:baunilha, fra:vanille, rus:ваниль (vanil’), yue:云呢拿 (wan4 ni1 laa4-2), jpn:バニラ (banira), kor:바닐라 (banilla), vie:vani, tur:vanilya  
**vare** *różny (różnorodny)* ← eng:various, spa:vario, por:vário  
...
**vate** *przedmiot (obiekt)* ← hin:वस्तु (vastu), ben:বস্তু (bôstu), pan:ਵਸਤੁ (vastu), tha:วัสดุ (wạttu), mya:ဝတ္ထု (wathtu), khm:វត្ថុ (vŏəttho) + vie:vật, wuu:物 (veq5), zho:物 (wù), yue:物 (mat6), jpn:物 (butsu)  
**vava** *płakać, łkać* ← eng:wah-wah, fra:ouin ouin, spa:por:buá buá, ben:ওয়া ওয়া (oā-oā), zho:哇哇 (wāwā), yue:哇哇 (waa1waa1), vie:oa oa, may:owe-owe  
**vaxe** *prać, umyć, myć* ← eng:wash, deu:waschen, zho:洗 (xǐ)  
...
**vere** *prawdziwy (rzeczywisty, szczery)* ← eng:very, ita:vero, rus:верный (verniy), spa:verdadero, por:verdadeiro, deu:wahr, fra:vrai  
**verme** *robak* ← eng:worm, fra:ver, spa:por:verme + jpn:ワーム (wāmu)  
**verse** ** ← eng:versus, fra:verse, spa:por:versar + rus:версия (versiya), may:versi  
**veruke** *brodawka* ← eng:verruca, fra:verrue, spa:por:verruga  
**vespe** *pszczoła lub osa* ← spa:avispa, por:ita:vespa, eng:wasp, deu:Wespe  
**veste** *zachód (zachodni)* ← eng:west, deu:West, fra:ouest, spa:por:oeste, rus:вест (vest)  
...
**vide** *widzieć (patrzeć)* ← rus:видеть (videt’), ita:vedere, spa:por:ver, pol:widzieć, eng:vide  
...
**viki** *wiki* ← eng:fra:spa:por:may:wiki, tur:viki, ara:وِيكي‎ (wikī), fas:ویکی‎ (viki), hin:विकि (viki), ben:উইকি (uiki), zho:维基 (wéijī), yue:維基 (wai4 gei1), jpn:ウィキ (wiki), kor:위키 (wiki)  
...
**viole** *skrzypce* ← eng:violin, fra:violon, spa:violín, por:violino, may:biola, hin:वायलिन (vāylin), jpn:バイオリン (baiorin), kor:바이올린 (baiollin) + rus:виолончель (violončel’)  
**violete** *fioletowy* ← eng:por:fra:violet, spa:violeta, deu:violett, rus:фиолетовый (fioletovyy), jpn:バイオレット (baioretto), kor:보라 (bola)  
...
**vote** *głos (głosować)* ← eng:vote, spa:por:voto, hin:वोट (voṭ), rus:вотум (votum)  
...
**xam:** *wieczór* ← fas: شام‎ (šâm), hin:शाम (śām), ben:শাম (śam), tur:akşam  
...
**xante** *spokojny* ← hin:शांति (shānti), ben:শান্তি (shānti), pan:ਸ਼ਾਂਤੀ (shāntī), mar:शांत (shānta), tel:శాంతి (shānti), guj:શાંતિ (shānti), khm:សន្តិ (sɑnte’), eng:por:shanti, rus:шанти (šanti), jpn:シャンティ (shanti)  
**xara** *piła* ← alb:sharrë + spa:sierra, por:serra + आरा (ārā) + ara: مِنْشَار‎ (minšār), fas: منشار‎ (menšâr)  
...
**xe** *rzecz* ← ara: شيء (šayʾ), tur:şey, fas: شیء‎ (šeyʼ) + zho:事 (shì), yue:事 (si6), vie:sự  
**xefe** *szef, kierownik* ← fra:chef, por:chefe, gal:xefe, spa:jefe, rus:шеф (šef), eng:chief, swa:chifu, jpn:チーフ (chīfu), + ara:(šeyx)  
**xehal** *sytuacja (stan)* ← zho:事态 (shìtài), jpn:事態 (jitai), eng:state of affairs, fra:état des choses  
...
**xiu** *mały; mało, trochę, nieco* ← zho:小 (xiǎo), yue:小 (siu2), jpn:小 (shō), kor:소 (so), vie:tiểu  
...
**yom** *dzień* ← ara: يَوْم‎ (yawm), hin:यौम (yaum), may:yaum  
**yon** *jon* ← eng:fra:spa:ion, rus:ион (ion), tur:iyon  
...
**yterbium** *iterb* ← eng:ytterbium, fra:ytterbium, spa:iterbio, por:itérbio, rus:иттербий, zho:镱 (yì), jpn:イッテルビウム, kor:이테르븀, vie:ytecbi, hin:यिट्टरबियम, ben:ইটারবিয়াম, may:iterbium, swa:yitebi, ara: يتربيوم  
**ytrium** *itr* ← eng:yttrium, fra:yttrium, spa:itrio, por:itrio, rus:иттрий, zho:钇 (yǐ), jpn:イットリウム, kor:이트륨, vie:ytri, hin:इत्रियम, ben:ইটরিয়াম, may:itrium, swa:yitri, ara: يتريوم  
**yuge** *jarzmo* ← eng:yoke, spa:yugo, por:jugo, fas:  یوغ‎ (yuğ), yue:軛 (aak1), vie:ách  
**zai** *istnieć (być obecnym)* ← zho:在 (zài), jpn:在 (zai), vie:tại  
**zaitun** *oliwka* ← ara:(zaitūn), spa:aceituna, may:zaitun, swa:zaituni, hin:urd:(zaitūn)  
**zalime** *złośliwy, okrutny* ← ara:(ẓālim), tur:zalim, urd:hin:(zālim), fas:(zālem), swa:dhalimu  
**zaman** *czas (epoka, era)* ← ara: زَمَن‎ (zaman), swa:zamani, may:jam(an), tur:zaman, yor:samaani + hin:समय (samay), ben:সময় (sômyô)  
**zanger** *rzemieślnik* ← zho:匠 (jiàng), tha:ช่าง (jang), khm:ជាង (ciəng)  
...
**zoe** *animal* ← eng:fra:spa:por:may:tur:zoo-, rus:зоо- (zoo-) + zho:兽 (shòu), yue:獸 (sau3), jpn:獣 (jū), kor:수 (su)  
...
**zukam** *przeziębienie, katar* ← ara:زُكَام‎ (zukām), hin:ज़ुकाम (zukām) + zho:感(冒) (gǎn(mào)), jpn:感(冒) (kan(bō)), kor:감(기) (gam(gi)), vie:cảm  
...
**• konike** *wspólny* ← eng:common, spa:común, por:comum, fra:commun, rus:коммунальный (kommunal’nyy)  
**• kopiaje** *kopia, replika* ← eng:copy, fra:copie, spa:por:copia, rus:копия (kopiya), hin:कापी (kāpī), tur:kopya, may:kopi, zho:拷貝 (kǎobèi), jpn:コピー (kopī)  
