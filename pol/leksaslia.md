...
**jangoxute** *sztuka walki* ← zho:武术 (wǔshù), jpn:武術 (bujutsu), vie:võ thuật, kor:무술 (musul), eng:martial art  
...
**kame** *pożądanie, żadza* ← hin:काम (kām), tha:กาม (gaam), eng:kama  
...
**kate** *ciąć* ← eng:cut, ara:(qaṭa’a), hin:काटना (kāṭnā), ben:কাটা (kata), swa:kata, vie:cắt, zho:割 (gē), yue:割 (got3), wuu:割 (ga’), jpn:割 (katsu)  
...
**lave** *stary (sędziwy, wiekowy)* ← zho:老 (lǎo), yue:老 (lau2), wuu:老 (lau3), jpn:老 (rō), vie:lão  
...
**laze** *śmieć, odpadek* ← zho:垃圾 (lājī)  
...
**lile** *mały; mało, trochę, nieco* ← eng:little  
...
**xau** *niewiele (mało)* ← zho:少 (shǎo), yue:少 (siu2), jpn:少 (shō), kor:소 (so)  
