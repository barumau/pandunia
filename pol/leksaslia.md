...
**aha** *rozumieć, pojmować* ← rus:ага (aha), kor: 아하 (aha), eng: uh-huh, pol:aha + ara: آه (ʾāh)  
...
**ajila** *popędzić, popędzać, pośpieszyć, pośpieszać, ponaglić, ponaglać* ← ara:عجل (ʿajila), tur:acele, swa:ajila, fas:عجله  (ajaleh), hin:जल्द (jald)  
...
**amen** ** ← heb: אָמֵן‎, (ʾāmēn), ara: آمین‎, (āmīna), swa:amina, amini, tur:amin + ell:ἀμήν (ámén), eng:deu:fra:pol:spa:amen, zho:阿门 (āmén), kor:아멘 (amen), jpn:アーメン (āmen), vie:a-men  
...
**ben** *dziecko, potomek* ← ara: ابن (ibn, bint), heb:בן (ben), בת (bat) swa:bin  
...
**bu!** *bu!* ← eng:boo, fra:bouh, por:spa:bu, rus:бу (bu), kor:부 (bu)  
...
**bujete** *budżet* ← eng:fra:budget, deu:Budget, rus:бюджет (b’udzhet), tur:bütçe, hin:बजट (bajaṭ), ben:বাজেট (bajeṭ), may:bajet, jpn:バジェット (bajetto)  
...
**cin** *rodzic (matka lub ojciec)* ← zho:親 (qīn), yue:親 (can), wuu:親 (qin), jpn:親 (sin), kor:친 (chin)  
...
**darja** *stopień, poziom, ranga, klasa* ← ara:(daraja), hin:दर्जा (darjā), swa:daraja, tur:derece, fas:(dareje), may:derajat  
...
**fong** *pszczoła lub osa* ← zho:蜂 (fēng), yue:蜂 (fung1), wuu:蜂 (fon1), kor:봉 (bong), vie:ong, tha:ผึ้ง (pʉ̂ng), lao:ເຜິ້ງ (phœng)  
...
**jelosi** *zazdrosny* ← eng:jealous, spa:celoso, fra:jaloux  
...
**jiang ja** *rzemieślnik* ← zho:匠 (jiàng), yue:匠 (zoeng6), tha:ช่าง (jang), khm:ជាង (ciəng)  
...
**jun** *młody* ← fra:jeune, spa:joven, por:jovem, fas: جوان‎ (javân), hin:जवान (javān) + kor:젊다 (jeomda)  
...
**kivi** *owoc kiwi* ← eng:fra:spa:may:swa:kiwi, por:quivi, jpn:キーウィ (kīwi), kor:키위 (kiwi), hin:कीवी (kīvī), tur:kivi  
...
**kuku** *kukułka* ← eng:cuckoo, fra:coucou, spa:por:cuco, rus:кукушка (kukushka), jpn:郭公  (kakkō), zho:布谷鸟 (bùgǔniǎo)  
...
**makan** *masło* ← hin:मक्खन (makkhan), ben:মাখন (makhôn), pan:ਮੱਖਣ (makhaṇa), mar:माखण (mākhaṇ), guj:માખણ (mākhaṇ)  
...
**Marse** *Mars* ← eng:fra:tur:may:Mars, spa:por:Marte, rus:Марс (Mars)  
...
**men** ** ← eng:men, deu:man + zho:们 (men), yue:們 (mun4) + (tumen) hin:तुम (tum), rom:tumen  
**mena** *makaron* ← zho:面 (miàn), may:mie, jpn:麺 (men), tha:หมี่ (mii), khm:មី (mi)  
...
**mi** *ja, mnie* ← eng:fra:spa:por:me,hindi:मैं (mẽ), swa:mimi  
...
**mima** ** ← eng:fra:mime, por:mímico, rus:мим (mim)  
...
**mira plate** *lustro* ← eng:mirror, fra:miroir, ara:mirʾāh, arz:mirāya  
...
**mise** *wysłać (wyemitować)* ← eng:emit, spa:remitir, por:emitir, fra:émettre  
...
**multi** *wiele* ← por:muito, eng:fra:spa:multi-, rus:мульти- (mulʹti-)  
...
**rapide** *szybki, prędki* ← spa:por:rápido, eng:rapid, fra:rapide  
...
**romanse** *miłość romantyczna* ← fra:eng:spa:por:romance, rus:роман (roman), tur:romans, may:roman, jpn:ロマンス (romansu), kor:로맨스 (romaenseu)  
**rose** *rosa* ← fra:rosée, spa:rocío, rus:роса (rosa)  
**roste** *piec* ← fra:rôtir, eng:roast, deu:rösten, ita:arrostare  
...
**sabe** *wiedzieć* ← spa:por:saber, fra:savoir, eng:savvy, pcm:sabi  
...
**sene** *wiek* ← ara: سِنّ‎ (sinn), hin:सिन (sin) + spa:por:sene + zho:岁 (suì), yue:歲 (seoi3), kor:세  (-se), jpn:歳 (-sai)  
...
**si** *być* ← zho:是 (shì), yue:是 (si4) + spa:por:ser  
**sian** *niebieskozielony (cyjan)* ← eng:cyan, spa:cian, rus:циан (tsian), ara:سيان (sayan), hin:क्यान (kyāna), jpn:シアン (shian), may:sian  
...
**silis** *krzem* ← eng:silicon, fra:silicium, spa:silicio, por:silício, rus:кремний, vie:silic, hin:सिलिकॉन, ben:সিলিকন, may:silikon, swa:silikoni, ara: سيلكون  
...
**siu** *szyć* ← hin:सीना (sīnā), ben:স্যূত (syūta), mar:शिवणे (śivṇe), guj:સીવવું (sīvvũ), rus:шить (šit'), eng:sew  
...
**sui** *woda* ← zho:水 (shuǐ), jpn:水 (sui), kor:수 (su), vie:thuỷ + tur:su  
...
**tese** *argument, teza* ← eng:thesis, fra:thèse, spa:tesis  
**teste** *test, wyzwanie, próba* ← eng:fra:test, rus: тест (test), por:teste, tur:test  
...
**tu** *ty, ciebie* ← fra:por:tu, spa:tú, rus:ты (ty), hin:तू (tū), ben:তুই (tui)  
...
**volfe** *wilk* ← deu:ned:eng:wolf, rus:волк (volk)  
...
**xau** *niewiele (mało, nieliczność)* ← zho:少 (shǎo), yue:少 (siu2), jpn:少 (shō), kor:소 (so)  
**xava** *deszcz* ← por:chuva + eng:shower, deu:Schauer + jpn:シャワー (shawā), hin:शावर (śāvar)  
...
**ya** *on, ona, ono* ← hin:यह (yah) + may:ia + ibo:ya, kon:ya + zho:伊 (yī), vie:y  
...
**zukam** *przeziębienie, katar* ← ara:زُكَام‎ (zukām), fas:زکام‎ (zukâm), hin:ज़ुकाम (zukāma)  
