...
Thing-words can be put together also with action-words.

**yem de meza** - eating table (dinner table)  
**yem sabzi** - vegetable eating  
**yem sabzi ren** - vegetable eating person (a vegetarian)

In summary, content words name and describe things. In order to do something more, they need the help of _function words_.

--------------------------------------------------------------------------------

# Function words

Function words help to form complete phrases from content words.

## Personal pronouns and sentence structures

Personal pronouns are the most important function words because they help to create the subject and the predicate, which are necessary parts of a complete sentence.
...
A pronoun functions as the subject of the sentence. The word or words, which follow the pronoun, function as the predicate.
...
**mi yem sabzi ren.** - I am a vegetarian.  
**ta un yem de meza.** - It is a dinner table.

### Predicate of action

When an action-word begins the predicate, it becomes active and the predicate becomes a predicate of action.
...
**ti vide tara.** - You see the stars.
...
The reflexive pronoun **se** is used for all persons, so it corresponds to English _myself, yourself, himself, herself, itself, ourselves_ and _themselves_ all at once.

It helps content words to function as the subject.

**sole se tara.** - The sun is a star.  
**un ren se sundar.** - One person is beautiful.  
**du ren se vide tara.** - Two people look at the stars.  
**sabzi yem ren se yem sabzi.** - Vegetarians eat vegetables.

**se** is necessary, like the next two phrases show.

**ren se yem sabzi.** - A person eats vegetables.  
**ren yem sabzi** - a person-eating vegetable!
...
### Particle of negation: no

The word **no** is used for denying something. It affects always the next word.

**mi vide ti.** - I greet you.  
...
One way to express when something happens is to add a particle of time in the sentence.

**mi yem la.** - I ate already.  
**mi yem gang.** - I just ate.  
**mi yem sun.** - I eat soon.  
