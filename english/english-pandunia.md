...
beef   : mumu nama  
beer   : bir  
begin (commence)   : kaici  
Belarus   : belarus  
Belgium   : belgi  
believe (faith, creed)   : cin  
Belize   : belize  
bell pepper   : tcili  
belly (abdomen)   : fubu  
below (under)   : na cia  
...
bottle   : botol  
bottom   : tal  
bow instrument (violin, etc.)   : titcin  
...
champion   : campion  
channel   : kanal  
chaos (disorder, turmoil)   : xaos  
chapter (section)   : sura  
chat (informal conversation)   : tcat  
chat room   : tcat kamar  
check (to examine)   : tcek  
checkers   : dama  
cheese   : tcis  
chemical   : kimi  
chemistry   : kimi logi  
...
connection (relationship)   : guanci  
consonant   : konson  
...
for (in order to)   : por  
forbid (don't!)   : mat  
foreign country   : wai gok  
forenoon   : suba den  
forest (jungle)   : djangal  
forget   : bul  
fork   : forka  
form (shape)   : forma  
...
mouse   : mucu  
mouth   : boka  
MSG (monosodium glutamate)   : mitcin  
much (many, lots)   : poli  
mud (mire)   : poto  
mummy   : mumia  
muscle   : muskul  
...
part (fraction)   : fen  
party (festival)   : festa  
pascal   : paskal  
pass (go by, go past)   : pas  
pass (transfer, hand over)   : pasa  
...
star   : tara  
state   : stat  
state (condition, situation, status)   : hal  
steal (theft)   : tcuri  
still (yet)   : hai  
stone   : batu  
stop   : stop  
...
strike (punch)   : darba  
strong (force)   : bal  
student (pupil)   : darsa ban  
substitute (vice-)   : vis  
subway (metro)   : tunel tren  
suck   : cup  
Sudan   : sudan  
sugar   : sukar  
suggest (propose)   : teyan  
sum (total)   : sum  
sun   : surya  
...
taiga   : taiga  
tail   : dum  
Tanakh (Jewish Bible)   : tanax  
tank (container)   : tank  
Tanzania   : tanzania  
tap (stopper)   : tap  
tape   : tep  
taste (sense the flavor)   : gusta  
tattoo   : tatu  
taxi   : taksi  
tea   : tca  
tea bowl   : tca wan  
...
two (2)   : du  
type (category)   : tip  
typewriter   : kitab macin  
tyrant   : tiran  
##u  
Ukraine   : ukrayina  
umbrella (parasol)   : tcatar  
under (below)   : cia  
