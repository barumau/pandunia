...
A modifier can modify also another modifier. For example **dai** (big) and **lil** (little) can be used as intensifying adverbs.

> **dai ren** - big person  
> **lil ren** - little person  
> **sundar ren** - beautiful person

> **dai sundar ren** - very beautiful person  
...
4. **do** - destination, end or purpose: to, till, until, for, then
