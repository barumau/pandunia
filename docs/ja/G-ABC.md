...
- **b** = [b]
- **c** = [tʃ]  
 <!-- _C_ is pronounced always like _ch_ in _church_.-->
- **d** = [d]
- **f** = [f]
- **g** = [g]  
...
_c_, _q_, _w_ はそれぞれ _c_, _k_, and _v_ と読んでも構いませんし、_h_ を含む組み合わせについては、_h_ を無視して発音しても構いません。
...
固有名詞や滅多に使用されない一般的な語彙は、ふつうの語彙よりもやや複雑です。
