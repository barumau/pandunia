...
# Le regole basilari del pandunia
...
4. **Indicatori di classe grammaticale**

    Il pandunia è una lingua agglutinante,
    e le sue parole sono composte da una radice e da un indicatore di classe grammaticale.
    Gli indicatori di classe grammaticale sono vocali finali che indicano chiaramente la parte del discorso della parola.

    Gli aggettivi terminano con una consonante + *i*,
    gli avverbi terminano con una consonante + *o*,
    e i verbi terminano con una consonante + *a* o *u*.
    I sostantivi possono avere qualsiasi altra desinenza, come *-e*, *-ia* o qualsiasi consonante.

    Questo sistema coerente è un fattore chiave della chiarezza grammaticale del pandunia,
    in quanto permette di derivare facilmente nuove parole da un'unica radice.

    [Per sapere di più!](G-PoS.md)
...
6.  **Sostantivi**
    ...
    I sostantivi non hanno una desinenza obbligatoria,
    ma di solito terminano in *-e*, due vocali o una consonante.

    [Per sapere di più!](G-N.md)
...
8.  **Aggettivi**
    ...
    *rapidi loge* ~ *loge rapidi*  
    ...
    [Per sapere di più!](G-ADJ.md)

9.  **Avverbi**

    L'avverbio precede il verbo che modifica.
    *tu rapido loga.*
    – Tu parli velocemente.

    [Per sapere di più!](G-ADV.md)
...
10. **Verbi**
    ...
    [Per sapere di più!](G-V.md)

11. **Ordine delle parole**
...
10. **Costruzione delle parole**
    ...
    *postekase*
    ...
    La vocale di collegamento, *-o-*, può essere inserita tra gli elementi soprattutto nelle parole composte che derivano dalla lingua greca.
