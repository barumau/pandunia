...
**baxe** *mówić (komunikować; język, komunikacja)* ← hin:भाषा (bhāṣā), urd:(bhāṣā), ben:ভাষা (bhaṣa), pnb:ਭਾਸ਼ਾ (bhāshā), tel:భాష (bhāṣa), tam:பாசை (pāsai), tha:ภาษา (phasa), may:bahasa, jav:basa  
...
**be** *być poddanym, doświadczyć, doświadczać (ubierniający czasownik)* ← zho:被 (bèi)  
...
**bia** *życie organiczne* ← eng:deu:fra:spa:por:pol:may:swa:tur:bio-, rus:био- (bio-)  
...
**bude** *uświadomienie, świadomość; oświecenie, bodhi* ← san:बोधि (bodhi), hin:बुद्धि (buddhi), jpn:菩提 (bodai), zho:菩提 (pútí), mon:бодь (bodʹ), kor:보리 (bori), vie:Bụt, tha:โพธิ (potí)  
...
**code** *jebać, kopulować* ← ben:চোদা (coda), hin:चोदना (codnā)  
...
**danke** *dziękować (dzięki)* ← eng:thank, deu:Danke, + hin:धन्यवाद (dhanyavād)  
...
**dua** *modlitwa (pomodlić się, modlić się)* ← ara: دُعَاء‏  (duʿāʾ), hin:दुआ (duā), swa:tur:dua, may:doa + zho:祈祷 (dǎo), jpn:禱 (tō), kor:도 (do)  
...
**duce** *prysznic* ← fra:douche, spa:por:ducha, deu:Dusche, rus:душ (duš), ara: دوش (dūš), may:dus, tur:duş  
...
**gel** *żel, galareta* ← eng:gel, fra:gelée, rus:желе (žele), tur:jel, hin:जेल (jel), kor:젤 (jel), zho:啫哩 (zhělī), vie:chất gien  
**gelose** *zazdrosny* ← eng:jealous, spa:celoso, fra:jaloux  
...
**heme** *krew* ← eng:spa:por:vie:may:hemo-, fra:hémo-, rus:гемо- (hemo-)  
...
**higabe** *welon (woalka)* ← ara:(ḥijāb), fas:(hejâb), swa:hijabu, hau:hijabi, hin:हिजाब (hijāb), ben:হিজাব (hijab), eng:por:hijab, fra:hidjab, spa:hiyab, rus:хиджаб (xidžab)  
...
**huse** *miły, przyjemny, uroczy* ← fas: خوش‎ (xoš), hin:ख़ुश (xuś), ben:খুশি (khuśi), tur:hoş, eng:cushy  
...
**insale** *nadzieja, życzenie* ← ara:إِنْ شَاءَ ٱللّٰه‎ (ʾin šāʾa llāh), fas:ان‌شاءالله (enšâ'allâh), tur:inşallah, may:insya allah, spa:ojalá, por:oxalá, eng:inshallah, rus:иншаллах (inšallax), ben:ইনশাআল্লাহ্ (inśaallah), zho:印沙安拉 (yìnshā'ānlā)  
...
**kar** *wóz, wózek* ← hin:गाड़ी (gāṛī), swa:gari, fas:(gâri), eng:car, por:spa:carro, deu:Karre, tel:(kāru)  
...
**karibe** *bliski* ← ara:fas:urd:(qarīb), swa:karibu, tur:takribi  
...
**karme** *praca, zjęcie, zadanie* ← may:karya, hin:कर्म (karma), urd:(karm), pnb:ਕਰਮ (karm), kan:tam:tel:(karma), eng:deu:fra:spa:por:karma, khm:កម្ម (kam), mya:ကံ (kam), tha:กรรม (kam), rus:карма (karma)   
...
**kece** *uprzejmy* ← zho:客气 (kèqì), yue:客氣 (haak3 hei3), wuu:客氣 (khaq qi4)  
...
**kile** *tysiąc (kilo-)* ← eng:fra:spa:por:may:tur:kilo-, rus:кило- (kilo-), jpn:キロ- (kiro-), kor:킬로- (killo-)  
...
**kuge** *płakać, łkać* ← zho:哭 (kū), yue:哭 (huk1), vie:khóc  
...
**lase** *pozostawiać (pozostawić)* ← fra:laisser, lâcher, ita:lasciare, deu:lassen  
...
**morte** *martwy, nieżywy, zabity* ← por:morto, fra:mort, spa:muerto, fas:(morde), urd:(murda), hin:मृत (mrta), rus:мёртвый (myortvïy), + may:mati, + ara:(mawt), amh:ሞት (mot)  
...
**norme** *normalny, standardowy* ← eng:spa:por:fra:deu:normal, rus:норма́льный (normálʹnyj), fas:نرمال‎ (normâl)  
...
**nove** *dziewięć (9)* ← por:nove, spa:nueve, fra:neuf, hin:नौ (nau), ben:নয় (nôy)  
...
**okeye** *okej, spoko, akceptowalny* ← eng:okay, spa:tur:may:okey, por:OK, rus:окей (okej), ara:أُوكِي‎‎‎ (ʾokey), hin:ओके (oke), zho:OK (ōukèi), jpn:オーケー (ōkē)  
**okosui** *łza* ← tam:கண்ணீர் (kaṇṇīr), mal:കണ്ണുനീർ (kaṇṇunīr), tel:(kannīru), kor:눈물 (nunmul), vie:nước mắt, may:air mata, tha:น้ำตา  
**okse** *tlen* ← eng:oxygen, fra:oxygène, spa:oxígeno, por:oxigénio, rus:кислород, vie:oxy, oxi, hin:ऑक्सीजन, ben:অক্সিজেন, may:oksigen, swa:oksijeni, ara: أكسجين  
...
**pizin** *pidżin, język pomocniczy* ← eng:spa:por:fra:pidgin, rus:пиджин (pidzhin), swa:pijini, zho:皮欽語 (píqīnyǔ), jpn:ピジン (pijin)  
...
**reste** *pozostałość (reszta; zostać, zostawać)* ← fra:reste, eng:deu:Rest, pol:reszta, spa:por:resto  
...
**sabe** *powód (przyczyna; spowodować, powodować)* ← heb:(sibá), hau:sabo;sababi, kon:sambu, ara:urd:(sabab), tur:sebep, may:sebab, swa:sababu  
...
**salam** *pozdrowienie (pozdrowić, pozdrawiać)* ← ara:(salām), swa:salamu, may:selamat, hin:सलाम (salām), ben: সালাম (salam), zho:萨拉姆 (sàlāmǔ), jpn:サラーム (sarāmu), kor:살람 (sallam), vie:xa lam, rus:салям (salyam)  
**sale** *zdrowy* ← fra:spa:por:salubre + ara: سَلَامَة‎ (salāma) + tur:sağlık  
...
**sibai** *porażka (niepowodzenie, klapa, przegrana, strata, porażka)* ← zho:失败 (shībài), jpn:失敗 (shippai), kor:실패 (šilpæ), vie:thất bại  
...
**sirope** *syrop* ← ara:(šarāb), por:xarope, eng:syrup, tur:şurup, jpn:シロップ (shiroppu), swa:shira  
**sis** *rożen (szpikulec)* ← tur:şiş + eng:shish-, rus:шиш- (šiš-)  
**sise** *sześć (6)* ← eng:fra:six, spa:por:seis, deu:sechs, rus:шесть (shest’), ara:ستة‎ (sitta)  
...
**skale** *wspinać się (wspiąć się)* ← spa:por:escalar + fra:escalier + eng:scale, deu:Skale, rus:шкала (škala)   
...
**sur** *początek* ← ara: شُرُوع‎ (šurūʿ), fas: شروع (šoru') , hin:शुरू (śurū), ben:শুরু (śuru) + zho:始 (shǐ), jpn:始 (kaishi), kor:시 (shi)  
...
**suso** *ćsi* ← eng:shh, fra:chut, rus:ш-ш-ш, zho:噓 (xū), jpn:しーっ (shīt), kor:쉿 (swit), tur:sus  
**sute** *szyć* ← hin:सीना (sīnā), rus:шить (šit'), eng:sew  
**sute** *umiejętność (kompetencja)* ← zho:术 (shù), yue:術 (seot6), jpn:術 (jutsu), kor:술 (sul)  
...
**tekse** *tkać (pleść)* ← spa:tejer, por:tecer, fra:tisser, eng:textile  
...
**tokse** *trucizna (toksyna; toksyczny, trujący)* ← eng:toxic, fra:toxique, spa:por:tóxico, rus:токсичний (toksicniy), may:toksik + zho:毒 (dú), yue:毒 (duk6), wuu:毒 (do’), jpn:毒 (doku/toku), kor:독 (dok), vie:độc  
...
**ure** *wiwatować; hura* ← rus:ура (ura), ita:urrà, deu:spa:hurra, fra:hourra, eng:hurrah, may:hore, fas:(hurâ)  
...
**vase** *prać, umyć, myć* ← eng:wash, deu:waschen, zho:洗 (xǐ)  
**vasurse** *szop pracz* ← zho:浣熊, jpn:洗熊, ita:orsetto lavatore, deu:Waschbär, heb:דביבון רוחץ  
...
**xenseng** *mistrz (sensei)* ← jpn:先生 (sensei), may:sinse, zho:先生 (xiānshēng), eng:sensei  
...
**zage** *przebudzony, przytomny* ← hin:जागना (jāgnā), ben:জাগা (jaga), pan:ਜਾਗਣਾ (jāgṇā), mar:जागणे (j̈āgṇe), guj:જાગવું (jāgvũ), may:jaga  
**zaitun** *oliwka* ← ara:(zaitūn), spa:aceituna, may:zaitun, swa:zaituni, hin:urd:(zaitūn)  
**zake** *kurtka* ← eng:jacket, zho:夹克 (jiākè), rus:жакет (žaket), deu:Jacke, por:jaqueta  
...
**zampe** *skoczyć, skakać* ← eng:jump, jpn:ジャンプ (janpu), kor:점프 (jŏmp), ben:ঝাঁপ (jhãpô), ass:জাঁপ (zãp)  
**zamul** *czapetka kuminowa* ← hin:जामुन (jāmun), eng:jambul, por:jambolão, ara:جَمُّون (jammūn), swa:zambarau  
**zane** ** ← rus:знать (znat’), hin:जानना (jānnā), ben:জানা (jana)  
**zanel** *okno* ← por:janela, ben:জানালা (janala), may:jendela + tam:சன்னல் (sannal), nya:zenera, kon:nêla  
...
**zau** *jęczmień* ← hin:जौ (jau), ben:যব (jôb), mar:जव (jav), guj:જવ (jav), fas: جو‎ (jow)  
**zaye** *obecny, teraźniejszy, aktualny, bieżący, współczesny* ← zho:在 (zài), jpn:在 (zai), vie:tại  
**zebe** *kieszeń* ← hin:जेब (jeb), pnb:ਜੇਬ (jeb), urd:(jeb), tel:(jēbu), ara:(jayb), tur:cep, wol:jiba  
**zebra** *zebra* ← eng:por:tur:zebra, spa:cebra, rus:зебра (zebra), hin:ज़ेब्रा (zebrā), jpn:ゼブラ (zebura)  
**zeinisme** *dźinizm, dżinizm* ← hin:mar:जैन (jain), tha:เชน (chen), eng:jainism, fra:jaïnisme, rus:джайнизм (džaynizm)  
**zeke** *pożyczyć* ← zho:借 (jiè), yue:借 (ze3), wuu:借 (jia2), jpn:借 (shaku), kor:적 (jeok) + eng:check  
**zekogete** *pożyczać (pożyczyć)* ← zho:借 (jiè), yue:借 (ze3), jpn:借 (shaku), kor:적 (jeok) + eng:check  
**zeng** *walka, wojna* ← zho:爭 (zhēng), vie:tranh, kor:전쟁 (jeonjaeng), tur:kur:ceng, fas:urd:(jang), hin:जंग (jang)  
**zengosute** *sztuka walki* ← zho:武术 (wǔshù), jpn:武術 (bujutsu), vie:võ thuật, kor:무술 (musul), eng:martial art  
**zere** *zero, nic, żaden* ← ara: صِفْر‎ (ṣifr), swa:sifuri, hin:सिफ़र (sifar), eng:por:zero, fra:zéro, spa:cero  
...
**zin** *prawdziwy (rzeczywisty, szczery)* ← zho:真 (zhēn), yue:真 (zan1), jpn:真 (shin), kor:진 (jin), tha:จริง (jing), kyr:tat:чын (çın) + eng:genuine  
...
**zinze** *imbir* ← tam:இஞ்சி (inji), eng:ginger, ara:(zanjabīl), tur:zencefil, fra:gingembre  
...
**ziraf** *żyrafa* ← ara:(zarāfa), eng:fra:giraffe, por:girafa, spa:jirafa, rus:жираф (žiraf), may:jerapah, tur:zürafa, kor:지라프 (jirapeu), hin: जिराफ़ (jirāf), ben:জরৈফ (jôrôph)  
**zire** *kumin (kmin)* ← ben:জিরা (zīra), hin:ज़ीरा (zīrā), tam:சீரகம் (sīrakam), swa:mjira, fas:(zire), zho:孜然 (zīrán), eng:jeera  
...
**zive** *życie* ← hin:mar:जीव (jīv), ben:জীউ (jiu), tel:జీవము (jīvamu), may:jiwa, tha:ชีวิต  (chiwit), mya:ဇီဝ (jiwa), khm:ជីវិត (jĭvit), rus:живой (živoy), pol:żywy  
...
**• novi** *nowy* ← eng:new, neo-, fra:nouveau, spa:nuevo, por:novo, rus:новый (novyy), hin:नव (nav)  
...
**• yuder** *sędzia* ← eng:judge, fra:juge, spa:juez, por:juiz, hin:जज (jaj), ben:জজ (jôj), swa:jaji + rus:суд (sud)  
**• zamia** *kolekcja, zbiór; zgromadzenie, zebranie* ← ara:(jamʿiyya), hau:jam'iyya, swa:jamii, tur:camia  
