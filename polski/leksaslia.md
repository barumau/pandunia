...
|**analis**|analiza|eng:analysis, fra:analyse, por:análise, spa:análisis, rus:анализ (analiz), tur:analiz|
...
|**antonam**|antonim|eng:deu:antonym, fra:antonyme, spa:por:antónimo, rus:антоним (antonim), may:tur:antonim|
...
|**ate**|jabłko cukrowe|fra:atte, por:ata, ben:আতা (ata), tgl:atis, som:aat|
...
|**badan**|ciało|ara:(badan), hin:बदन (badan), fas:urd:(badan), tur:beden, eng:body|
...
|**ban**|czas; okazja|kor:번 (beon), vie:bận, jpn:番 (ban), zho:遍 (biàn), + hin:बार (bār), urd:fas:(bār), ben:বার (bar)|
...
|**baw**|magazyn, dziennik, gazeta|zho:报 (bào), vie:báo, + tha: ป่าว (bpàao)|
|**bax**|język; komunikacja|hin:भाषा (bhāṣā), urd:(bhāṣā), ben:ভাষা (bhaṣa), pnb:ਭਾਸ਼ਾ (bhāshā), tel:భాష (bhāṣa), tam:பாசை (pāsai), tha:ภาษา (phasa), may:bahasa, jav:basa|
...
|**bon rupi**|przystojny, atrakcyjny, ładny|zho:好看 (hǎokàn), eng:good-looking|
...
|**botol**|butelka|eng:bottle, may:botol|
|**boton**|guzik|eng:button, spa:botón, por:botão, fra:bouton, jpn:ボタン (botan), tgl:butones, hin:बटन (baṭan), urd:(baṭan), ben;বোতাম (botam)|
...
|**bubul**|bańka|eng:bubble, hun:buborék, hin:बुल्ला (bullā), tgl:bula, fra:bulle, pnb:ਬੁਲਬੁਲਾ (bulabulā)|
...
|**bum**|pośladki, pupa, tyłek, zadek|eng:bum, por:bumbum|
|**bunduke**|pistolet, strzelba, ręczna broń palna|ara:(bunduqiyya), hin:बंदूक (bandūk), swa:bunduki|
|**bung**|brzuch|vie:bụng, khm:ពុង (pung), tha:พุง (pung)|
...
|**buton**|klawisz, przycisk, przełącznik|eng:button, hin:बटन (baṭan), ben:বোতাম (botam), jpn:ボタン (botan), kor:버튼 (beoteun)|
...
|**cay**|herbata|zho: 茶 (chá), jpn: (cha), tur:çay, swa:chai, rus:чай (čay), hin:चाय (cāy), ara:(šāy)|
|**ceng**|warstwa (poziom, piętro, kondygnacja)|zho:层 (céng), yue:層 (cang4), kor:층 (chŭng), vie:tầng|
...
|**cis**|ser|eng: cheese, zho: 起司 (qǐsī), swa: chizi, jpn:チーズ (chīzu), kor:치즈 (chijeu)|
...
|**day**|duży|yue:大 (daai), zho:大 (dá), vie:đại, jpn:(dai,tai), kor:대— (dae-)|
...
|**destin**|przeznaczenie, los|eng:destination, destiny, fra:destin, spa:por:destino|
...
|**dux**|prysznic|fra: douche, deu:Dusche, tur:duş, rus:душ (duš), ara:(duš), spa:por:ducha|
|**e**|i, oraz|fra:et, por:e, zho:和 (hé)|
|**egal**|prawy, sprawiedliwy, słuszny, uczciwy, fair|fra:égal, spa:por:igual, eng:equal|
...
|**gar**|jeśli, jeżeli; przypuścić, przypuszczać, złożyć, zakładać, przyjąć, przyjmowa|fas:urd:اگر‎‎ (agar), hin:अगर (agar), tur:eğer, + yue:假 (gaa1), wuu:假 (ga)|
...
|**gey**|gejowski (homoseksualny)|eng:fra:spa:gay, por:guei|
...
|**gon**|kąt|hin:कोण (koṇ), tel:(kōnamu), swa:kona, eng:corner, hau:kwana|
|**goton**|bawełna|ara:(quṭun), spa:algodón, por:algodão, fra:coton, eng:cotton|
|**graf**|opis, przedstawienie; wykres|eng:graphic, fra:graphique|
...
|**hakim**|wyrok|ara:(qāḍin), hau:alƙali, fas:(qāzi), eng:qadi, swa:kadhi|
...
|**harabi**|zły, zrujnowany, zepsuty|ara:fas:urd:(xarāb), tur:harap, hin:ख़राब (xarāb), ben:খারাপ (kharap)|
...
|**hatar**|zagrożenie, niebezpieczeństwo|ara:(xaṭar), fas:(xatar), urd:(xatra), hin:ख़तरा (xatrā), swa:hatari, tur:muhatara|
|**hawe**|wiatr|hin:हवा (havā), urd:(havā), pnb:ਹਵਾ (hawā), + ara:(hawāʾ), fas:(havā), tur:hava, may:hawa, som:hawo, swa:hewa, ben:হাওয়া (haowa)|
|**hay**|wciąż, nadal|zho:还 (hai)|
|**hay**|życie|ara:حياة‎ (ḥaya), swa:uhai, hin:हयात (hayāt), may:hayat|
...
|**jangal**|las, dżungla, zagajnik|hin:जंगल (jangal), ben:জঙ্গল (jônggôl), urd:(jangal), por:jângal, eng:jungle, rus: джу́нгли (džúngli), deu:Dschungel|
...
|**kanon**|działo|eng:cannon, spa:cañón, zho:加农 (jiānóng), jpn:(kyanon), kor:캐넌 (kaeneon)|
...
|**kar**|wóz, wózek|eng:car, por:spa:carro, deu:Karre, tel:(kāru), + hin:गाड़ी (gāṛī), swa:gari|
...
|**kay**|otwarty, niezamknięty|zho:开 (kāi), vie:-khai-|
...
|**kupe**|kubek|fra:coupe, tur:kupa, ara:(kūb), spa:copa, eng:cup, hin:कप (kap), jpn:コップ (koppu), kor:컵 (keop)|
|**kupol**|kopuła|fas:(koppe), ara:(qubba), tur:kubbe, may:kubah, rus:купол (kupol), spa:cúpula, deu:Kuppel|
...
|**lanten**|latarnia|eng:lantern, hin:लालटेन (lālṭen), jpn:ランタン (rantan), kor:랜턴 (raenteon), + zho:灯笼 (dēnglóng), vie:đèn lồng, may:tanglung|
...
|**lew**|już (skończona czynność)|tha:แล้ว /lɛːw/, zho:了 (le), wuu:了 (lə'), hak:了 (le), yue:了 (liu)|
...
|**lil**|mały; mało, trochę, nieco|eng:little|
...
|**lon**|dyskusja, debata, dyskurs|zho:论 (lùn), jpn:論 (ron), vie:luận, kor:논 (non)|
|**lona**|debatować, prowadzić dyskurs|zho:论 (lùn), yue:論 (lœn6), kor:론 (ron), jpn:論 (ron), vie:luận|
...
|**lung**|orientalny smok|zho:龙 (lóng), yue:龍 (lung4), vie:rồng,long, kor:용 (yong), 룡 (ryong), jon:竜 (ryū)|
...
|**marmar**|marmur|hin:संगमरमर (saṅgmarmar), spa:marmól, por:mármore, Rus:мрамор (mramor), may:marmer, Tur:mermer|
...
|**max**|bardziej|spa:mas, por:mais, eng: max-|
|**maxin**|maszyna|fra: machine, eng: machine, deu: Maschine, may: mesin|
|**maxor**|większościowy, wiodący, główny|fra: majeur, eng: major, spa: mayor|
...
|**mey**|każdy, wszyscy|zho:每 (měi), wuu:每 (me), vie:mọi, kor:매 (mae)|
...
|**moke**|drewno|zho:木 (mù), yue:木 (muk), vie:mục, jpn:木 (-moku), kor:목 (mok)|
...
|**mon**|tylko|ell:μόνος (monos), eng:deu:fra:por:spa:mono-|
...
|**motokar**|samochód (automobil)|eng:motorcar, sna:motokari, sot:motokara, swa:motokaa, zul:imoto, hau:mota|
...
|**mul**|początek|hin:मूल (mūl), may:tgl:mula, khm:មូល (mul)|
...
|**naw**|dziewięć (9)|hin:नौ (nau), urd:(nau)|
...
|**nol**|zero, nic, żaden|rus:ноль (nol'), may:nol, deu:null, eng:null|
...
|**nur**|światło, oświetlenie|ara:fas:(nūr), swa:nuru|
...
|**petre**|kamień|hin:पत्थर (patthar), urd:(patthar), ita:pietra, por:pedra, spa:piedra|
...
|**pir**|ogień|eng:fra:pyro-, por:spa:piro-, rus:пиро- (piro-)|
...
|**pol**|wiele|ell:πολλοί (polloí), eng:fra:deu:poly-, spa:por:poli-, rus:поли- (poli-)|
...
|**pul**|kwiat|hin:फूल (phul), ben:ফুল (phul)|
|**pulmon**|płuco|spa:pulmón, fra:poumon, por:pulmão, eng:pulmonic|
|**pulte**|most|hin:पुल (pul), ben:পুল (pul), urd:(pul), fas:(pol), por:ponte, fra:pont, spa:puente|
...
|**rize**|korzeń|ell:ρίζα (riza), eng:fra:rhizo-, por:spa:rizo-, rus:ризо- (rizo-)|
...
|**salade**|sałatka|fra:salade, end:may:salad, deu:Salat, rus:салат (salat), tur:salata, fas:urd:(salād), hin:सलाद (salād), yue:沙律 (saa1 leot62),  zho:沙拉 (shālā), por:salada, spa:ensalado, kor:샐러드 (saelleodeu), jpn:サラダ (sarada), tha:สลัด (salat), khm:សាលាដ (saalaat)|
...
|**samude**|może|khm:សមុទ្រ (saʾmot), tha:สมุทร (samut), hin:समुद्र (samudra), urd:(samandar), may:samudra, ben:সমুদ্র (sômudr), guj:સમુદ્ર (samudra), tel:సముద్రము (samudramu), mya:သမုဒ္ဒရာ (samuddara)|
...
|**sekse**|płeć|eng:sex, fra:sexe, spa:por:sexo|
|**sekuri**|bezpieczny|eng:secure, deu:sicher, spa:por:seguro|
|**sel**|komórka (biologia)|may:sel, fas:sellul, tha:เซลล์ (seel), swa:seli, tgl:selula, eng:cell, fra:cellule, spa:célula|
|**sem**|siedem (7)|rus:семь (semʹ)|
...
|**silsil**|łańcuch|hin:सिलसिला (silsilā), ara:(silsila), tur:silsile, swa:silisili|
...
|**supris**|zaskoczenie|eng:surprise, tur:sürpriz, fas:(surpris), rus::сюрприз (siurpriz), por:surpresa, spa:sorpresa|
...
|**tambur**|bęben|swa:sna:kon:ngoma, nya:ng'oma, + zho:鼓 (gǔ)|
|**tan**|sam, osobiście|hin:mar:तन (tan), fas:urd:(tan), taj:тан (tan), tha:ตน (ton), vie:thân, yue:親 (can3)|
|**tanke**|zbiornik (pojemnik, rezerwuar)|eng:tank, hin:टंकी (ṭaṅkī), swa:tangi, spa:tanque, jpn:タンク (tanku), tgl:tangke|
...
|**tataw**|tatuaż|sam:tah:tatau, haw:kākau, may:tato, eng:tattoo, fra:tatouage, spa:tatuaje, rus:тату (tatu)|
...
|**tin**|trzy (3)|hin:तीन (tīn), ben:তিন (tin), urd:(tīn)|
...
|**wal**|mur, ściana|eng:wall, rus:вал (val), por:valo|
...
|**win**|zwycięstwo, wygrana|eng:win, deu:gewinnen|
...
|**xaman**|szaman|rus:шаман (šaman), eng:shaman|
|**xan**|góra, wzgórze|zho: 山 (shān), kor: 산 (san), vie:sơn|
...
|**xatan**|diabeł, szatan|ara:(šayṭān), hin:शैतान (śaitān), tur:şeytan, fas:(šaytān), swa:Shetani, eng:fra:deu:vie:Satan, spa:Satán, por:Satã, rus:Сатана (Satana), zho:撒但 (Sādàn), tha:ซาตาน (satan), kor:사탄 (satan), jpn:サタン (satan), may:Setan|
...
|**xey**|rzecz|ara:(šayʾ), tur:şey, + zho:事 (shì), yue:事 (si6)|
|**xibay**|porażka (niepowodzenie, klapa)|zho:失败 (shībài), jpn:失敗 (shippai), kor:실패 (šilpæ), vie:thất bại|
...
|**xix**|ćsi|eng:shh, zho: (xū), rus:ш-ш-ш, tur:sus|
...
|**xow**|pokaz, ekspozycja, wystawa|eng:deu:fra:spa:por:show, rus:шоу (šou), tur:şov, swa:shoo, tha:โชว์ (choo), kor:쇼 (syo), jpn:ショー (shō), zho:秀 (xiù)|
|**xudu**|powinien|eng:should|
|**xukar**|cukier|ara:(sukkar), swa:sukari, por:açúcar, spa:azúcar, Hin:शक्कर (śakkar), ben:শর্করা (śôrkôra), tur:şeker, Tam:சக்கரை (cakkarai)|
...
|**ziran**|kumin, kmin|ben:জিরা (zīra), hin:ज़ीरा (zīrā), tam:சீரகம் (sīrakam), swa:mjira, fas:(zire), zho:孜然 (zīrán)|
