...
|**atlanti mare**|Ocean Atlantycki|eng:Atlantic, spa:Atlántico, por:Atlântico, rus:Атлантический океан (Atlanticheskyy okean), swa:Atlantiki|
...
|**barya**|blokować, hamować|eng:bar|
...
|**bawe**|skarb; skrabiec|zho:宝 (bǎo), kor:보 (bo), vie:bảo, jpn:宝 (hō)|
...
|**daymare**|ocean|vie:đại dương, kor:대양 (daeyang), jpn:大洋 (taiyō), zho:大洋 (dàyáng), tha:มหาสมุทร (mahasamut), hin:महासागर (mahāsāgar)|
...
|**dowe**|fasola lub groch, roślina strączkowa|zho:豆 (dòu), yue:豆 (dau6), wuu:豆 (deu3), jpn:豆 (tō), kor:두 (du), vie:đậu|
...
|**eskulta**|rzeźbić|eng:sculpt, spa:esculpir, fra:sculpter|
...
|**feya**|latać, lecieć|zho:飞 (fēi), yue:飛 (fei1), wuu:飛 (fi1), jpn:飛 (hi), kor:비 (bi), vie:bay|
...
|**filia**|zamiłowanie (-filia)|eng:fra:philia, por:spa:filia, rus:филия (filiya)|
...
|**ganputawe**|rodzynka|kor:건포도 (geonpodo), zho:葡萄干 (pútáogān)|
...
|**garda**|chronić, strzec,  osłaniać, bronić|eng:guard, spa:por:guardar, fra:garder|
...
|**gida**|sterować|eng:guide, spa:por:guiar + ara:قَادَ‎ (qāda)|
...
|**gowa**|iść (przemieścić się)|eng:go + zho:去 (qù), jpn:行 (kou)|
...
|**gundarme**|cnota (moralność)|tha:คุณธรรม (gunnadam), hin: urd: tam: tel: mya: may:|
...
|**jengxute**|sztuka walki|zho:武术 (wǔshù), jpn:武術 (bujutsu), vie:võ thuật, kor:무술 (musul), eng:martial art|
...
|**jive**|życie organiczne|hin:mar:जीव (jīv), ben:জীউ (jiu), pan:ਜੀਓ (jīo), guj:જીવ (jīv), may:jiwa, tha:ชีว (chiiu)|
...
|**kabawe**|bawół domowy|spa:carabao, may:kerbau, jav:kebo, khm:ក្របី (krɑbəy)|
...
|**karlekse**|czasownik|hin:क्रिया (kriyā), ben:ক্রিয়া (kriya), tel:క్రియ (kriya), khm:កិរិយា (keriyaa), tha:กริยา (grì-yaa), may:kata kerja|
|**karote**|marchew|eng:carrot, fra:carotte, deu:Karotte, swa:karoti, may:karot|
...
|**lida**|prowadzić, dowodzić, kierować|eng:lead, por:liderar|
...
|**loge**|mowa; słowo|ell:λόγος (logos), eng:-logue, fas:(loğat), ara:(luğa), hin:लुग़त (luġat), swa:lugha, tur:lügat, may:logat|
...
|**mare**|może|ita:mare, spa:por:mar, fra:mer, deu:Meer, rus:море (more), pol:morze|
...
|**molia**|mielić|zho:磨 (mò), fra:moulin, spa:molino|
...
|**mono**|tylko|ell:μόνος (monos), eng:deu:fra:por:spa:mono-|
...
|**namlekse**|rzeczownik|zho:名词 (míngcí), yue:名詞 (ming4 ci4), jpn:名詞 (meishi), kor:명사 (myeongsa), hin:नाम (nām), fra:nom, spa:nombre, por:nome, rus:имя (imya), ara:(ism), per:(esm), swa:nomino|
...
|**pantalone**|spodnie, pantalony, portki|spa:pantalón, fra:pantalon, ara:بنطلون‎ (banṭalōn), hin:पैंट  (paiṇṭ)|
...
|**pawe**|pistolet, strzelba, ręczna broń palna|zho:炮 (pâo), yue:炮 (paau3), vie:pháo, kor:포 (po), mon:буу (buu)|
...
|**petre**|skała (kamień)|hin:पत्थर (patthar), urd:(patthar), ita:pietra, por:pedra, spa:piedra, fra:pierre|
...
|**plus (pluso)**|też, również|eng:fra:plus, rus:плюс (pl’us)|
...
|**putawe**|winogrono|zho:葡萄 (pútáo), yue:葡萄 (pou4 tou4), wuu:葡萄 (bu dau3), jpn:葡萄 (budō), kor:포도 (podo), vie:bồ đào|
...
|**repe**|powtarzanie, powtórka|eng:rep(etition), spa:repetición, + vie:lặp|
...
|**tatawe**|tatuaż|sam:tah:tatau, haw:kākau, may:tato, eng:tattoo, fra:tatouage, spa:tatuaje, rus:тату (tatu)|
...
|**tawe**|patelnia|hin:तवा (tavā), tur:tava, fas:(tābe)|
...
|**towale**|ręcznik|eng:towel, spa:toalla, por:toalha, hin:तौलिया (tauliyā), ben:তোয়ালে (toyale), tgl:tuwalya, jpn:タオル (taoru)|
...
|**vokale**|samogłoska|spa:vocal, por:vogal, may:vokal|
|**vote**|głos|eng:vote, spa:por:voto, hin:वोट (voṭ), rus:вотум (votum)|
|**vulve**|srom|fra:vulve, eng:por:spa:tur:vulva, rus:вульва (vul’va)|
|**wada**|obiecać, angażować się|ara:وعد‎ m (waʿd), tur:vaat, fas:وعده‎ (va'deh), hin:वादा (vādā)|
|**waf (wafe)**|pies|eng:woof, spa:guau, rus:гав (gav), tur:hav, zho:汪 (wāng), jpn:ワン (wan)|
|**wale**|mur, ściana|eng:wall, rus:вал (val), por:valo|
|**wane**|wola (chęć, pragnienie)|eng:want, kor:원하다 (wonhada)|
|**warise**|spadek, dziedzictwo, spuścizna, zapis|may:waris, ara:(wariþ), swa:urithi, tur:varis,miras|
|**warke**|kartka (dokument)|ara:(waraqa), hau:warƙa, tur:varak, fas:(varaqe), taj:варақа (varaqa), swa:waraka, + mya:အရွက် (arwak)|
|**wase**|oaza|ara:(wāḥa), tur:vaha, fas:(vāhe), spa:oasis|
|**waw**|wow!, łoł!, jej!|zho:哇 (wā), eng:wow|
|**waxa**|prać, umyć, myć|eng:wash, deu:waschen, zho:洗 (xǐ)|
|**waydexi**|zagraniczny|hin:(videśī), tel:(vidēśi), zho:外国的 (wàiguóde)|
|**waye**|zęwnętrzny|zho:外 (wài)|
|**weki**|przebudzony, przytomny|eng:awake, deu:wach|
|**weste**|zachód|eng:west, deu:West, fra:ouest, spa:por:oeste, rus:вест (vest)|
|**wi**|tamten (tamten)|hin:वह (wo), ben:ওই (oi)|
...
|**wile**|przyszłość|eng:will + wuu:未来 (víle), zho:未来 (wèilái), kor:미래 (miræ), jpn:未来 (mirai)|
|**wine**|zwycięstwo, wygrana|eng:win, deu:gewinnen|
|**winge**|skrzydło|eng:wing, deu:Schwinge|
...
|**xawi**|niewiele (mało)|zho:少 (shǎo), yue:少 (siu2), jpn:少 (shō), kor:소 (so)|
...
|**xindawistia**|shintoizm, sintoizm|jpn:神道 (shintō), kor:신도 (sindo), zho:神道 (shéndào)|
...
|**xixo**|ćsi|eng:shh, zho: (xū), rus:ш-ш-ш, tur:sus|
...
|**xowe**|pokaz, ekspozycja, wystawa|eng:deu:fra:spa:por:show, rus:шоу (šou), tur:şov, swa:shoo, tha:โชว์ (choo), kor:쇼 (syo), jpn:ショー (shō), zho:秀 (xiù)|
...
|**xuxe**|zostawić, zostawiać|zho:休息 (xiūxí), kor:휴식 (hyusig)|
...
|**zipa**|zamknąć zamkiem błyskawicznym|eng:zip|
|**ziper**|zamek błyskawiczny|eng:zipper, ben:জিপার (jipar), hin:ज़िपर (zipar), jpn:ジッパー (jippā), kor:지퍼 (jipeo), tha:ซิป (síp), fas:urd:(zip)|
