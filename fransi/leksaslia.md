...
|**analis**|analyse|eng:analysis, fra:analyse, por:análise, spa:análisis, rus:анализ (analiz), tur:analiz|
...
|**badan**|corps|ara:(badan), hin:बदन (badan), fas:urd:(badan), tur:beden, eng:body|
...
|**bol**|ball|eng:ball, spa:por:may:tgl:bola, tha:บอล (bɔl), jpn:ボール (bōru), kor:볼 (bol), khm:បាល់ (bal), ben:বল (bôl), deu:Ball, fra:boule,balle|
...
|**boton**|bouton|eng:button, spa:botón, por:botão, fra:bouton, jpn:ボタン (botan), tgl:butones, hin:बटन (baṭan), urd:(baṭan), ben;বোতাম (botam)|
...
|**cay**|thé|zho: 茶 (chá), jpn: (cha), tur:çay, swa:chai, rus:чай (čay), hin:चाय (cāy), ara:(šāy)|
|**cerni**|noir|rus:чёрный (čornyy), pol:czarny|
|**cis**|fromage|eng: cheese, zho: 起司 (qǐsī), swa: chizi, jpn:チーズ (chīzu), kor:치즈 (chijeu)|
...
|**destin**|destin (destination)|eng:destination, destiny, fra:destin, spa:por:destino|
...
|**dul**|deux|kor:둘 (dul), ben:দুই (dui), may:dua, + eng:fra:por:spa:dual|
...
|**emos**|émotion|eng;emotion, fra:émotion, spa:emoción, por;emoção, rus:эмоция (emociya), ind:emosi, tgl:emosyon|
...
|**esten**|étain|spa:estaño, por:estanho, fra:étain, ita:stagno, eng:tin|
|**fase**|face (facette)|eng:fra:por:face, spa:faz, deu:Facette|
|**fata**|faire|ita:fare, fra:faire, por:fazer, + ara:(faʿala), + swa:kufanya|
...
|**gar**|si|fas:urd:اگر‎‎ (agar), hin:अगर (agar), tur:eğer, + yue:假 (gaa1), wuu:假 (ga)|
...
|**gol**|but|por:spa:gol, eng:goal, jpn:ゴール (gōru), kor:골 (gol), hin:गोल (gola), tel:గోలు (gōlu), rus:гол (gol)|
...
|**hay**|vie|ara:حياة‎ (ḥaya), swa:uhai, hin:हयात (hayāt), may:hayat|
...
|**jinse**|genre (espèc)|ara:urd:(jins), fas:(jens), swa:jinsi, tur:cins, por:gênero, eng:gender|
...
|**kance**|verre|hin:काँच (kānc), ben:কাঁচ (kãcô), mar:काच (kāc), may:may:kaca, tel:గాజు (gāju)|
...
|**kupe**|coupe (tasse, verre)|fra:coupe, tur:kupa, ara:(kūb), spa:copa, eng:cup, hin:कप (kap), jpn:コップ (koppu), kor:컵 (keop)|
...
|**marmar**|marbre|hin:संगमरमर (saṅgmarmar), spa:marmól, por:mármore, Rus:мрамор (mramor), may:marmer, Tur:mermer|
...
|**max**|plus|spa:mas, por:mais, eng: max-|
...
|**megam**|nuage|hin:मेघ (megh), ben:মেঘ (megh), tam:மேகம் (mēgam), tel:మేఘము (mēghamu), may:mega, tha:เมฆ (mek)|
...
|**nili**|blue|ben:নীল (nīl), hin:नीला (nīlā), urd:(nīlā), tam:நீலம் (nīlam)|
...
|**pul**|fleur|hin:फूल (phul), ben:ফুল (phul)|
...
|**reloje**|horloge|spa:reloj. por:relógio. fra:horloge. ita:orologio. msa:ind:arloji.|
...
|**rize**|racine|ell:ρίζα (riza), eng:fra:rhizo-, por:spa:rizo-, rus:ризо- (rizo-)|
...
|**sekse**|sexe|eng:sex, fra:sexe, spa:por:sexo|
...
|**sihate**|santé|ara:صحة (siha), hin:सेहत (sehata), ben:সুস্থ (sustha), pan:ਸਿਹਤ (sihata), tur:sıhhat, may:sihat|
...
|**vokal**|voyelle|spa:vocal, por:vogal, may:vokal|
|**vulve**|vulve|fra:vulve, eng:por:spa:tur:vulva, rus:вульва (vul’va)|
|**wal**|mur|eng:wall, rus:вал (val), por:valo|
|**wolfe**|loup|deu:ned:eng:wolf, rus:волк (volk)|
|**xatan**|Satan|ara:(šayṭān), hin:शैतान (śaitān), tur:şeytan, fas:(šaytān), swa:Shetani, eng:fra:deu:vie:Satan, spa:Satán, por:Satã, rus:Сатана (Satana), zho:撒但 (Sādàn), tha:ซาตาน (satan), kor:사탄 (satan), jpn:サタン (satan), may:Setan|
|**xaw**|peu|zho:少 (shǎo), yue:少 (siu2), jpn:少 (shō), kor:소 (so)|
|**xef**|chef|fra:chef, por:chefe, gal:xefe, spa:jefe, rus:шеф (šef), eng:chief, swa:chifu, jpn:チーフ (chīfu), + ara:(šeyx)|
|**xey**|chose|ara:(šayʾ), tur:şey, + zho:事 (shì), yue:事 (si6)|
|**xeyohal**|situation (état de choses)|zho:事态 (shìtài), jpn:事態 (jitai), eng:state of affairs, fra:état des choses|
